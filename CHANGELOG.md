...
### Documentation
- 1033 guides updated across de, en, es, fr, it, pl, pt
...
### Features
- **account:** add e-invoicing billing guides (bank details, VAT rate) (#293)
...
### Features
- **ai endpoints:** new guide about batch mode (#57)
- **compute:** update to add tabs and add cli (#30)
