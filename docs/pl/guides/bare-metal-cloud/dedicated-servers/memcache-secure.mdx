...
description: Zabezpiecz usługę Memcached na serwerze dedykowanym OVHcloud, aby zapobiec nadużyciom i atakom DDoS.
...
- [Jak zabezpieczyć serwer dedykowany](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server)
- [Konfiguracja zapory iptables na serwerze dedykowanym z systemem Linux](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable)
