...
- A [dedicated server](/links/bare-metal/bare-metal) with Windows Server installed
...
![VM Configuration](/images/guides/bare-metal-cloud/dedicated-servers/activate-windows-vm-hyperv/vm-conf.png)
