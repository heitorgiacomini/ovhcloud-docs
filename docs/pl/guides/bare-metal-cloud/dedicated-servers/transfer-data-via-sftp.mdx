...
Będziesz potrzebował adresu IP Twojego serwera, który odnajdziesz w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, oraz nazwy konta użytkownika, którego będziesz używał do logowania SSH. Zapoznaj się z naszymi przewodnikami "Pierwsze kroki", jeśli chcesz otrzymać więcej informacji:
...
<img className="thumbnail" alt="tryb ratunkowy SFTP zdalnej lokalizacji" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_03.png" loading="lazy" />
...
<img className="thumbnail" alt="zdalna strona sftp" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Postęp transferu SFTP" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_02.png" loading="lazy" />
