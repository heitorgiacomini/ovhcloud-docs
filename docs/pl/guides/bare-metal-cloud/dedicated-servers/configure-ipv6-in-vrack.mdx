...
<img className="thumbnail" alt="strona konfiguracji" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Konfiguracja IPv6 w sieci vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="zarządzanie vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="włączanie SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/702.png" loading="lazy" />
...
<img className="thumbnail" alt="api post dodaj blok" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/post-ipv6.png" loading="lazy" />
...
<img className="thumbnail" alt="GET podsieci mostkowanej w sieci vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-05.png" loading="lazy" />
...
<img className="thumbnail" alt="GET podsieci mostkowanej w sieci vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-06.png" loading="lazy" />
...
<img className="thumbnail" alt="Wywołanie API POST włącz SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-07.png" loading="lazy" />
...
<img className="thumbnail" alt="Konfiguracja IPv6 w sieci vRack dla trybu routowanego" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/routed-mode-20240513.png" loading="lazy" />
...
<img className="thumbnail" alt="wybór vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="kontynuuj" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/800.png" loading="lazy" />

Utworzono routowaną podsieć `2001:41d0:abcd::ef10::/60` osiągalną przez next-hop `2001:41d0:abcd::ef00::2`.

<img className="thumbnail" alt="kontynuuj" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/801.png" loading="lazy" />
...
<img className="thumbnail" alt="kontynuuj" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-02.png" loading="lazy" />
...
<img className="thumbnail" alt="obraz" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-08.png" loading="lazy" />
