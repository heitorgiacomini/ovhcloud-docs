...
description: Dowiedz się, jak skonfigurować nowe hasło dla konta użytkownika w systemie operacyjnym GNU/Linux w trybie rescue OVHcloud
...
:::info
Aby uzyskać dostęp do serwera, z którym łączysz się za pomocą klucza SSH, zapoznaj się z naszym przewodnikiem "[Jak zamienić parę kluczy SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)".
...
- [Użyj trybu ratunkowego na serwerze VPS](/guides/bare-metal-cloud/virtual-private-servers/rescue)
...
Pamiętaj, aby podczas restartu serwera z poziomu <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> użyć trybu uruchamiania **normalnego** Twojego serwera.
...
[Tworzenie i używanie kluczy SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Tryb ratunkowy dla serwera dedykowanego](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)

[Tryb ratunkowy dla serwera VPS](/guides/bare-metal-cloud/virtual-private-servers/rescue)

[Konfigurowanie kont użytkowników i dostępu root na serwerze](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds)
