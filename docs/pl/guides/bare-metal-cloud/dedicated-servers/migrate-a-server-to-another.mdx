...
description: Przenieś dane i konfigurację ze starego serwera dedykowanego OVHcloud na nowy za pomocą rsync.
...
Oddajemy w Twojej ręce niniejszy przewodnik, którego celem jest pomoc w jak najlepszym wykonywaniu bieżących zadań. W przypadku problemów z administrowaniem, użytkowaniem czy zabezpieczeniem serwera rekomendujemy skorzystanie z usług [wyspecjalizowanej firmy](https://partner.ovhcloud.com/pl/directory/). Więcej informacji znajduje się w sekcji “Sprawdź również”.
:::
...
- Najprostszym sposobem jest użycie odpowiedniego oprogramowania, takiego jak [SFTP](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp).
- Inną możliwością jest [synchronizacja obu serwerów ze sobą](/guides/bare-metal-cloud/dedicated-servers/how-to-copy-data-from-one-dedicated-server-to-another-using-rsync).
...
Aby uzyskać więcej informacji, zapoznaj się z przewodnikiem dotyczącym [Korzystanie z Backup Storage na serwerze dedykowanym](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage#korzystanie-z-backup-storage).
...
Jeśli reputacja Twoich adresów IP jest ważna, zalecamy korzystanie z adresów [Additional IP](https://www.ovhcloud.com/pl/network/additional-ip/), które możesz zachować w przypadku migracji.

Po otrzymaniu tych adresów IP wystarczy je przenieść na nowy serwer.
W tym celu zapoznaj się z naszym przewodnikiem: [Przenieś Additional IP](/guides/bare-metal-cloud/dedicated-servers/move-failover-ip).
...
Więcej informacji znajdziesz w naszej dokumentacji dotyczącej domeny i DNS.
...
- [Wprowadzenie do SSH dla serwerów dedykowanych](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)
- [Pierwsze kroki z serwerem dedykowanym OVHcloud](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server)
