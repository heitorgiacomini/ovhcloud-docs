...
description: Dowiedz się, jak skonfigurować sieć na Proxmox VE
...
- An [OVHcloud dedicated server](https://www.ovhcloud.com/pl/bare-metal/)
- One or more [Additional IP addresses](https://www.ovhcloud.com/pl/network/additional-ip/)
...
* A [server compatible with vRack](https://www.ovhcloud.com/pl/bare-metal/)
* A [vRack service](https://www.ovhcloud.com/pl/network/vrack/)
