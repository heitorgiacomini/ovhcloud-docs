...
<Tabs>
  <Tab label="W panelu klienta">
    Zaloguj się do <ManagerLink to="/">Panelu client OVHcloud</ManagerLink>, przejdź do sekcji <code className="action">Bare Metal Cloud</code> i wybierz Twój serwer w części <code className="action">Serwery dedykowane</code>.
...
:::info
W przypadku wszystkich systemów operacyjnych i dystrybucji skonfiguruj wirtualną maszynę za pomocą wirtualnego adresu MAC utworzonego w  <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
