...
description: Sprawdź stan kontrolera RAID sprzętowego i monitoruj stan dysków twardych na serwerze dedykowanym OVHcloud.
...
- a [dedicated server](https://www.ovhcloud.com/pl/bare-metal/) with a hardware RAID configuration
