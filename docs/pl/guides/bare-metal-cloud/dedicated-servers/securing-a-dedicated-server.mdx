...
description: "Zastosuj najlepsze praktyki bezpieczeństwa na serwerze dedykowanym OVHcloud: aktualizacje, zapora, SSH i monitorowanie."
...
Jeśli skonfigurujesz Twój pierwszy serwer dedykowany OVHcloud, zapoznaj się [z przewodnikiem dotyczącym uruchomienia serwer dedykowany](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).
:::
...
Więcej informacji na temat iptables znajdziesz w naszym [przewodniku](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).
...
Więcej informacji o naszych rozwiązaniach do przechowywania kopii zapasowych znajdziesz w [przewodniku](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage).

## Sprawdź również

[Konfiguracja firewalla w systemie Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)
