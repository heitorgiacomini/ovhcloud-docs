...
description: Skonfiguruj RAID programowy na serwerze dedykowanym OVHcloud z systemem Windows Server.
...
Po zalogowaniu kliknij prawym przyciskiem myszy przycisk w menu <code className="action">Start</code> i otwórz <code className="action">Uruchom</code>.

<img className="thumbnail" alt="Software mirror Windows" src="/images/bare-metal-cloud/dedicated-servers/raid-soft-windows/raid-soft-windows-01.png" loading="lazy" />

Wpisz `cmd` i kliknij <code className="action">OK</code>.

<img className="thumbnail" alt="Software mirror Windows" src="/images/bare-metal-cloud/dedicated-servers/raid-soft-windows/raid-soft-windows-02.png" loading="lazy" />
...
W tym przykładzie `Disk 1` to dysk zapasowy, który został zainstalowany w celu zastąpienia wadliwego `Disk M0`, który wcześniej został [fizycznie usunięty](/guides/bare-metal-cloud/dedicated-servers/disk-replacement).
...
- Konfiguracja RAID programowego na serwerze dedykowanym
