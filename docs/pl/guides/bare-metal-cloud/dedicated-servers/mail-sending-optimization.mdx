...
Możesz oczywiście pójść o krok dalej i skonfigurować rekord SPF dla określonej nazwy domeny lub użyć adresu IPv6. Aby lepiej zrozumieć rekord SPF, zapoznaj się z przewodnikiem dotyczącym [konfiguracji rekordu SPF](/guides/web-cloud/domains/dns-zone-spf).
...
Więcej informacji znajdziesz w przewodniku dotyczącym [konfiguracji rekordu DKIM](/guides/web-cloud/domains/dns-zone-dkim).
...
Więcej informacji zawiera przewodnik dotyczący [konfigurowania rekordu DMARC](/guides/web-cloud/domains/dns-zone-dmarc).
...
Jeśli Twoje serwery DNS są zarządzane przez OVHcloud, zapoznaj się z naszym przewodnikiem [dotyczącym edycji strefy DNS OVHcloud w Panelu klienta](/guides/web-cloud/domains/dns-zone-edit).
...
Aby skonfigurować ścieżkę rewersu DNS w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, zapoznaj się z [naszym przewodnikiem](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns).
...
[Zwiększ bezpieczeństwo e-maili za pomocą rekordu DKIM](/guides/web-cloud/domains/dns-zone-dkim)

[Zwiększ bezpieczeństwo e-maili za pomocą rekordu SPF](/guides/web-cloud/domains/dns-zone-spf)

[Zwiększ bezpieczeństwo e-maili za pomocą rekordu DMARC](/guides/web-cloud/domains/dns-zone-dmarc)
