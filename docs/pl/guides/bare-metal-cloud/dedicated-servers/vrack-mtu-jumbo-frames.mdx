...
description: Skonfiguruj Jumbo Frames (MTU 9000) w sieci OVHcloud vRack, aby zoptymalizować przepustowość między serwerami dedykowanymi.
...
- [Konfiguracja vRack na serwerach dedykowanych](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server)
- [Konfiguracja bloku IP w sieci vRack na serwerze dedykowanym](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack)
