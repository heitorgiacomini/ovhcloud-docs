...
description: Zmień hasło root na serwerze dedykowanym OVHcloud z systemem Linux za pomocą trybu rescue lub SSH.
...
Szczegółowe instrukcje na ten temat można znaleźć w przewodniku "[Pierwsze kroki z SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)".
...
- [Zabezpiecz serwer VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps)
:::
