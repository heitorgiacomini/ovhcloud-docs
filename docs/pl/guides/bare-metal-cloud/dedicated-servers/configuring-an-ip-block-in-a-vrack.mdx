...
<img className="thumbnail" alt="sprawdzenie drugiego interfejsu sieciowego" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-1.png" loading="lazy" />

Następnie musimy sprawdzić właściwości:

<img className="thumbnail" alt="właściwości drugiego interfejsu sieciowego" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-2.png" loading="lazy" />

<img className="thumbnail" alt="właściwości drugiego interfejsu sieciowego" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-3.png" loading="lazy" />
