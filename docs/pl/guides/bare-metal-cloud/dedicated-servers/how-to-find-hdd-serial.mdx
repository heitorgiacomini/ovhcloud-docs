...
description: Znajdź numer seryjny dysku twardego lub SSD na serwerze dedykowanym OVHcloud za pomocą wiersza poleceń.
...
Szczegółowy opis poleceń oraz sposobu testowania dysków twardych znajdziesz w tym [przewodniku (kontroler RAID LSI)](/guides/bare-metal-cloud/dedicated-servers/raid-hard).
...
Możesz skorzystać z [tego przewodnika (kontroler RAID LSI)](/guides/bare-metal-cloud/dedicated-servers/raid-hard), aby określić, który dysk twardy odpowiada oznaczonemu urządzeniu “sg”.
...
- [Jak wymienić dysk na serwerze dedykowanym](/guides/bare-metal-cloud/dedicated-servers/disk-replacement)
