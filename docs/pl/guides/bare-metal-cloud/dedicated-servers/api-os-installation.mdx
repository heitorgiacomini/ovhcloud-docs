...
Fully automating OS installation or reinstallation on a [dedicated server](https://www.ovhcloud.com/pl/bare-metal/) with the [OVHcloud API](/guides/manage-and-operate/api/first-steps) can be interesting in various situations.
