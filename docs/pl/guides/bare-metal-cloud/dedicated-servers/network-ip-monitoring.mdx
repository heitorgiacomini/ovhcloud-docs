...
Po pierwsze, zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i wybierz kartę <code className="action">Bare Metal Cloud</code>. Wybierz odpowiedni serwer z rozwijanego menu <code className="action">Serwery dedykowane</code>.
