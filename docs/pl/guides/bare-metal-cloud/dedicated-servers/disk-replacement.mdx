...
description: Dowiedz się, jak zidentyfikować uszkodzony dysk i zamówić wymianę dysku na serwerze dedykowanym OVHcloud.
...
Jeśli posiadasz serwer z programową macierzą RAID, zapoznaj się z przewodnikiem [“Software RAID”](/guides/bare-metal-cloud/dedicated-servers/raid-soft), aby odnaleźć dyski zainstalowane na Twoim serwerze.
...
Jeśli posiadasz serwer ze sprzętową macierzą RAID, zapoznaj się z przewodnikiem [“Hardware RAID” - EN](/guides/bare-metal-cloud/dedicated-servers/raid-hard) i zastosuj procedurę dotyczącą Twojego typu kontrolera RAID, aby odnaleźć ścieżki dostępu do Twoich dysków.
...
W przypadku dysku NVMe konieczne jest uruchomienie serwera w trybie [Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) i zainstalować narzędzie `nvme-cli`.
...
:::info
Ten typ wymiany jest możliwy tylko w przypadku [serwerów dedykowanych](https://www.ovhcloud.com/pl/bare-metal/) z kartą RAID.
:::
...
Jeśli posiadasz serwer z programową macierzą RAID, uruchom ręcznie ponowną synchronizację dysków. Więcej informacji na ten temat znajdziesz w dokumentacji [“Software RAID”](/guides/bare-metal-cloud/dedicated-servers/raid-soft).

## Sprawdź również

[Programowa macierz RAID](/guides/bare-metal-cloud/dedicated-servers/raid-soft)

[Sprzętowa macierz RAID - EN](/guides/bare-metal-cloud/dedicated-servers/raid-hard)

[Trybu Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
