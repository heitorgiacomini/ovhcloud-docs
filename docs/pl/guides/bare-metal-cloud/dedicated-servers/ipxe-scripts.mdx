...
description: Dowiedz się, jak API OVHcloud pozwala na skonfigurowanie spersonalizowanego skryptu PXE do uruchamiania serwera
...
W <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> można wybrać tryb bootowania spośród wstępnie zdefiniowanych trybów: dysk główny lub rescue.
Za pośrednictwem [API OVHcloud](https://eu.api.ovh.com/) możesz również zdefiniować własne skrypty.
...
W każdej chwili możesz ponownie przełączyć się na dysk lub na tryb Rescue w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> (zapoznaj się z naszym przewodnikiem "[Włącz i użyj trybu Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)") lub przez [API OVHcloud](https://eu.api.ovh.com/).
...
[Restart serwera dedykowanego](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server#reboot)
