...
Więcej informacji znajdziesz w przewodniku dotyczącym [bezpieczeństwa serwera dedykowanego](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server).
...
Więcej informacji na temat dostępu do tego narzędzia znajdziesz w [tym przewodniku](/guides/bare-metal-cloud/dedicated-servers/ipmi).  
:::
