...
description: Przeprowadź diagnostykę sprzętu na serwerze dedykowanym OVHcloud w trybie rescue, aby zidentyfikować awarie dysków, pamięci RAM lub procesora.
...
- Uruchomienie serwera w [trybie Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
...
- [Jak przywrócić bazę danych w trybie rescue](/guides/bare-metal-cloud/dedicated-servers/restore-bdd-rescue)
- [Jak zaktualizować firmware BMC na serwerze dedykowanym](/guides/bare-metal-cloud/dedicated-servers/bmc-fw-update)
