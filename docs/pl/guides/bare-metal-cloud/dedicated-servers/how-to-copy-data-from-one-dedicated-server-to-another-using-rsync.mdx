...
description: Dowiedz się, jak w prosty sposób kopiować dane z serwera na inny serwer za pomocą rsync
...
- [Jak przesyłać i pobierać dane przez SFTP na serwerze dedykowanym](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp)
- [Jak zmigrować dane na nowy serwer dedykowany](/guides/bare-metal-cloud/dedicated-servers/migrate-a-server-to-another)
