...
description: Dowiedz się, jakie informacje będą wyświetlane i udostępniane w momencie uruchomienia wewnętrznej ochrony Anti-Hack OVHcloud na Twoim serwerze.
...
- Masz dostęp do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.

## Informacje o Anti-Hack

### Dedicated Server

Gdy ochrona Anti-Hack zostanie uruchomiona na Twoim Dedicated Server, w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> pojawi się komunikat: "*Twój serwer został zaatakowany. Prosimy o kontakt z naszym zespołem wsparcia technicznego w celu uzyskania instrukcji dotyczących dalszego postępowania.*"
...
<img className="thumbnail" alt="Informacje o Anti-Hack dla Dedicated Server" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-service.png" loading="lazy" />
...
<img className="thumbnail" alt="Informacje o Anti-Hack dla VPS" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-vps.png" loading="lazy" />
