...
<br/>Zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. W części <code className="action">Bare Metal Cloud</code> wybierz serwer z <code className="action">Serwery dedykowane</code> i kliknij zakładkę <code className="action">IPMI</code> (1).
