...
:::info
Otrzymasz automatyczny e-mail z danymi do logowania SSH, w celu uzyskania dostępu do trybu Rescue. Prosimy o oczekiwanie na wiadomość e-mail przed kontynuowaniem jakichkolwiek działań. E-mail ten jest również dostępny w Twoim <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. Aby ją znaleźć, kliknij na nazwę powiązaną z Twoim identyfikatorem OVHcloud na pasku menu w prawym górnym rogu, następnie wybierz <code className="action">E-maile dotyczące usługi</code>.
...
[Zastąp parę kluczy SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)
