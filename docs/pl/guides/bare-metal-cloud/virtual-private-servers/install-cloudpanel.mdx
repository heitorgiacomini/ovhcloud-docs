...
- A [VPS](/links/bare-metal/vps) or a [Dedicated Server](/links/bare-metal/bare-metal) with a [recommended configuration](https://www.cloudpanel.io/docs/v2/requirements/) in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
