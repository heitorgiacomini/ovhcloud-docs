...
W <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> lub w API OVHcloud zainstaluj wybraną aplikację. Zapoznaj się również z naszym przewodnikiem Pierwsze kroki [z serwerem VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
