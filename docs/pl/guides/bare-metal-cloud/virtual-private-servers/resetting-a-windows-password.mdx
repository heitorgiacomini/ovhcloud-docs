...
description: Dowiedz się, jak zresetować hasło do konta administratora Windows na serwerze VPS lub instancji Public Cloud w trybie Rescue OVHcloud
...
- [Instancja Public Cloud](/guides/public-cloud/compute/put-an-instance-in-rescue-mode)

### Etap 2: montowanie partycji systemu

Połącz się ze swoim serwerem przez SSH. (W razie potrzeby skorzystaj z naszego [przewodnika wprowadzającego SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction).)

Połączenie z serwerem można również otworzyć za pomocą [KVM (VPS)](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps) lub [konsoli VNC (instancja Public Cloud)](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#accessvnc).
...
<img className="thumbnail" alt="administratorów" src="/images/bare-metal-cloud/virtual-private-servers/resetting-a-windows-password/adminpw_win.png" loading="lazy" />
