...
description: Dowiedz się, jak dodać adresy Additional IP do konfiguracji VPS
...
:::warning
Adresy Additional IP są aktualnie niedostępne dla prywatnych serwerów wirtualnych w [Local Zones](https://www.ovhcloud.com/pl/lp/vps-localzone/).
:::
...
<Tabs>
  ...
  <Tab label="cPanel">
    ...
    **Etap 1: dostęp do sekcji zarządzania adresami IP w usłudze WHM**
    ...
    W Panelu klienta WHM kliknij <code className="action">IP Functions</code> i wybierz <code className="action">Add a New IP Address</code> w menu po lewej stronie.
    ...
    **Etap 2: dodawanie informacji o adresach Additional IP**
    ...
    Wybierz `255.255.255.255` jako maskę podsieci, a następnie kliknij <code className="action">Submit</code>.
    ...
    **Etap 3: weryfikacja aktualnej konfiguracji IP**
    ...
    Wróć do sekcji <code className="action">IP Functions</code>, kliknij <code className="action">Show or Delete Current IP Addresses</code>, aby sprawdzić, czy adres Additional IP został poprawnie dodany.
  ...
  <Tab label="Plesk">
    ...
    **Etap 1: dostęp do interfejsu zarządzania IP Plesk**
    ...
    W panelu sterowania Plesk wybierz <code className="action">Tools & Settings</code> na pasku bocznym po lewej stronie.
    
    <img className="thumbnail" alt="dostęp do zarządzania adresami IP" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/pleskip1.png" loading="lazy" />
    
    Kliknij <code className="action">IP Addresses</code> w sekcji **Tools & Resources**.
    ...
    **Etap 2: dodawanie informacji o adresach Additional IP**
    ...
    W polu "IP address and subnet mask" wpisz adres Additional IP w postaci `xxx.xxx.xxx.xxx/32`, a następnie kliknij przycisk <code className="action">OK</code>.
  ...
  <Tab label="Windows Server">
    ...
    **Etap 1: sprawdź konfigurację sieci**
    ...
    Kliknij prawym przyciskiem myszy przycisk <code className="action">Start Menu</code> i otwórz <code className="action">Run</code>.
    ...
    **Etap 2: zmień właściwości IPv4**
    ...
    1. Przejdź do menu <code className="action">Start</code>, następnie <code className="action">Control Panel</code>, <code className="action">Network and Internet</code>, <code className="action">Network and Sharing Centre</code> oraz <code className="action">Change Adapter Settings</code> na pasku po lewej stronie.
    2. Kliknij prawym przyciskiem myszy <code className="action">Ethernet</code>;
    3. Kliknij <code className="action">Properties</code>;
    4. Wybierz <code className="action">Internet Protocol Version 4 (TCP/IPv4)</code>, następnie kliknij <code className="action">Properties</code>;
    5. Kliknij przycisk <code className="action">Use the following IP address</code> i wpisz główny adres IP Twojego serwera, maskę podsieci oraz bramę domyślną, które uzyskasz za pomocą polecenia <code className="action">ipconfig</code> powyżej. W polu "Preferred DNS Server" wpisz `213.186.33.99`.
    ...
    **Etap 3: dodaj adres Additional IP do zaawansowanych ustawień TCP/IP**
    ...
    W nowym oknie kliknij <code className="action">Add...</code> pod "IP addresses". Wpisz adres Additional IP i maskę podsieci (255.255.255.255).
    
    <img className="thumbnail" alt="sekcja zaawansowanych ustawień TCP/IP" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/configure-additional-ip.png" loading="lazy" />
    
    Potwierdź klikając <code className="action">Add</code>.
    ...
    Po zakończeniu kliknij <code className="action">OK</code>, aby zastosować konfigurację.
