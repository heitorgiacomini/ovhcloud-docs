...
description: Dowiedz się, jak zabezpieczyć serwer korzystając z iptables
...
Więcej informacji znajdziesz w przewodniku dotyczącym [bezpieczeństwa serwera VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps).
...
<img className="thumbnail" alt="wersja-iptables" src="/images/bare-metal-cloud/virtual-private-servers/firewall-Linux-iptable/step2-version-iptables.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Check-Current-iptables" src="/images/bare-metal-cloud/virtual-private-servers/firewall-Linux-iptable/Check-Current-iptables.PNG" loading="lazy" />
...
Więcej informacji na temat dostępu do tego narzędzia znajdziesz w [tym przewodniku](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps).  
:::
...
<img className="thumbnail" alt="line-numbers" src="/images/bare-metal-cloud/virtual-private-servers/firewall-Linux-iptable/Step7-all-rules.PNG" loading="lazy" />
