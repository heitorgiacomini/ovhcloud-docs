---
title: Maintenance operations for Analytics
description: Find out how your cluster is maintained
...
OVHcloud Analytics services allow you to focus on building and deploying cloud applications while OVHcloud takes care of the infrastructure and maintenance.

**This guide explains how your analytics service schedules and performs maintenance operations.**
...
<Api version="v1" section="/cloud" method="GET" route={"/1.0/cloud/project/\{serviceName\}/database/opensearch/\{productId\}/maintenance"} />


<img className="thumbnail" alt="Choose Maintenance" src="/images/public-cloud/data-analytics/analytics/information-04-maintenances/maintenancesql.png" loading="lazy" />
...
<img className="thumbnail" alt="Choose Maintenance" src="/images/public-cloud/data-analytics/analytics/information-04-maintenances/maintenancesql2.png" loading="lazy" />

You can also decide to preemptively apply some operations, using this API endpoint:

<Api version="v1" section="/cloud" method="POST" route={"/1.0/cloud/project/\{serviceName\}/database/opensearch/\{productId\}/maintenance/\{maintenanceId\}/apply"} />
