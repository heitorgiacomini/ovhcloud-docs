...
description: Find out how to customize the Kube-proxy configuration on an OVHcloud Managed Kubernetes cluster
...
<img className="thumbnail" alt="Log in to the API Explorer" src="/images/public-cloud/containers-orchestration/managed-kubernetes/customizing-kubeproxy/kubernetes-quickstart-api-ovh-com-001.png" loading="lazy" />
...
<img className="thumbnail" alt="Kubernetes section of the API Explorer" src="/images/public-cloud/containers-orchestration/managed-kubernetes/customizing-kubeproxy/kubernetes-quickstart-api-ovh-com-002.png" loading="lazy" />
...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-kubernetes/customizing-kubeproxy/api-rights.png" loading="lazy" />
...
<img className="thumbnail" alt="Copy paste service name" src="/images/public-cloud/containers-orchestration/managed-kubernetes/customizing-kubeproxy/get-service-name.png" loading="lazy" />
