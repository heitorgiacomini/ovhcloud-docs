...
description: Find out how to set-up and configure sticky sessions/session Affinity based on Nginx Ingress on OVHcloud Managed Kubernetes
...
![Sticky session on Kubernetes schema](/images/public-cloud/containers-orchestration/managed-kubernetes/sticky-session-nginx-ingress/sticky-session-schema.png)
