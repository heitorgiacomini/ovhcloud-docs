...
description: Connect to your Public Cloud Databases for PostgreSQL using the PHP programming language
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Connect to PostgreSQL with CLI](/guides/public-cloud/databases/postgresql-connect-cli).
