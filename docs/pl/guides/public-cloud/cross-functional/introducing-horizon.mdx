...
- Utworzenie [Projekt Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) na Twoim koncie OVHcloud.
- **[Opcjonalnie od września 2023]** Użytkownik [OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) utworzony w Twoim projekcie. Etap ten jest opcjonalny, ponieważ wdrożyliśmy logowanie jednokrotne (SSO: *Single Sign-On*) między Panelem klienta OVHcloud a Horizon.
...
* Aby zalogować się za pomocą określonego użytkownika OpenStack: otwórz stronę logowania w witrynie [Horizon](https://horizon.cloud.ovh.net/auth/login/) i wprowadź wcześniej utworzone [identyfikatory OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user), a następnie kliknij przycisk <code className="action">Connect</code>.
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/region2021.png" loading="lazy" />

### Menu boczne po lewej stronie

W tym menu możesz szybko przejść do projektu i różnych związanych z nim funkcji.

<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/leftmenu2021.png" loading="lazy" />
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/quotas2021.png" loading="lazy" />
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/usagesummary2021.png" loading="lazy" />
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/usage2021.png" loading="lazy" />
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/csv2021.png" loading="lazy" />
...
<img className="thumbnail" alt="objętość" src="/images/public-cloud/cross-functional/introducing-horizon/volumes2021.png" loading="lazy" />

##### **Network**

Wyświetl listę i administruj sieciami oraz grupami zabezpieczeń. 

<img className="thumbnail" alt="network" src="/images/public-cloud/cross-functional/introducing-horizon/network2021.png" loading="lazy" />
...
<img className="thumbnail" alt="orkiestracja" src="/images/public-cloud/cross-functional/introducing-horizon/orchestration2021.png" loading="lazy" />
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/introducing-horizon/username2021.png" loading="lazy" />
