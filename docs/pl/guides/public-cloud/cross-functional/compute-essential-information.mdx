...
description: Poznaj podstawowe pojęcia, które mogą być przydatne podczas uruchamiania aplikacji w środowisku Public Cloud
...
- [Otwórz konto OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation)
- [Utwórz Twój pierwszy projekt Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Poznaj interfejs Public Cloud](/guides/public-cloud/cross-functional/public-cloud-interface-walk-me)
- [Utwórz pierwszą instancję](/guides/public-cloud/compute/getting-started)
- [Zarządzanie limitami](/guides/public-cloud/cross-functional/increasing-public-cloud-quota)
...
<img className="thumbnail" alt="Public Cloud geolokalizacja" src="/images/public-cloud/cross-functional/00-essential-info-to-get-started-on-public-cloud/geolocation.png" loading="lazy" />
...
Aby rozpocząć korzystanie z usługi, najpierw musisz mieć [konto klienta OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation).

Następnie [utwórz projekt Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project). Projekt to środowisko, które będziesz musiał określić jako kontekst.
...
Ponieważ Twój sposób płatności jest zarejestrowany, zostanie wykorzystany do pobrania kwoty obliczonej dla Twojego [fakturowania na koniec miesiąca](/guides/public-cloud/cross-functional/analyze-billing). Obliczenia te dokonuje się na podstawie czasu wykorzystania każdego zasobu, w zależności od ceny zasobów.
...
<br/>Kwoty te są przyznawane według lokalizacji (region w rozumieniu OpenStack). Możliwe jest zatem, że osiągniesz maksymalny poziom zasobów projektu i [zwiększ limity](/guides/public-cloud/cross-functional/increasing-public-cloud-quota).
...
- Jeśli chcesz korzystać z interfejsu API OpenStack lub Amazon S3 lub interfejsu Horizon, musisz [utworzyć w tym celu użytkowników](/guides/public-cloud/cross-functional/create-and-delete-a-user). Użytkownicy mogą ewentualnie mieć ograniczone prawa, aby zabezpieczyć zakres działania.
- Jeśli nie potrzebujesz dostępu do API lub interfejsu Horizon, możesz [dołączyć do Twojego projektu inne konto klienta OVHcloud](/guides/public-cloud/cross-functional/delegate-projects).
...
|---|---|
|[FAQ](/guides/public-cloud/cross-functional/faq-pci)|Najczęstsze pytania dotyczące usługi Public Cloud.|
|[Słowniczek](/guides/public-cloud/cross-functional/introduction-about-instances)|Koncepcje i definicje, które będą potrzebne, aby iść naprzód.|
...
|Dokumentacja|Szczegóły|
|---|---|
|[Utwórz pierwszą instancję](/guides/public-cloud/compute/getting-started)|Pierwszy przewodnik dotyczący uruchomienia serwera cloud w Panelu klienta OVHcloud.|
|[Korzystanie z klucza SSH](/guides/public-cloud/compute/creating-ssh-keys)| Aby zalogować się do instancji Linux, zapoznaj się z tym przewodnikiem dotyczącym korzystania z tej instancji.|
|[Konfiguracja prywatnej sieci](/guides/public-cloud/network-services/vrack)|W OVHcloud prywatne sieci opierają się na technologii vRack. Niniejszy przewodnik pomaga Ci w uruchomieniu tej usługi.|
|[Przypisz dodatkowy dysk do instancji](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance)|Niniejszy przewodnik wyjaśnia, jak dodać przestrzeń dyskową do Twojej pierwszej instancji.|
|[Dostęp do interfejsu Horizon](/guides/public-cloud/cross-functional/introducing-horizon)|Interfejs Horizon OpenStack pozwala na wykonywanie niektórych zaawansowanych operacji.|
|[Utwórz klaster Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/create-cluster) (EN)|Niniejszy przewodnik ułatwi Ci realizację pierwszego klastra Kubernetes.|
|[Konfiguracja Additional IP](/guides/public-cloud/network-services/configure-additional-ip)|Adresy Additional IP pozwalają na przełączanie ruchu z jednej instancji na inną. Niniejszy przewodnik wyjaśnia, jak to skonfigurować.|
|[Korzystanie z interfejsu Horizon](/guides/public-cloud/cross-functional/introducing-horizon)|Horizon to klasyczny interfejs OpenStack, a ten przewodnik wyjaśni, jak uzyskać do niego dostęp.|
|[Instalacja CLI OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)|OpenStack może być również używany w wierszu poleceń. Oto jak zainstalować narzędzia.|
