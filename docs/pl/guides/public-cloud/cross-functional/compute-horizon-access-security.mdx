...
<img className="thumbnail" alt="horizon - dostęp API" src="/images/public-cloud/cross-functional/access-and-security-in-horizon/api_access.png" loading="lazy" />
...
<img className="thumbnail" alt="horyzont - grupy bezpieczeństwa" src="/images/public-cloud/cross-functional/access-and-security-in-horizon/security_groups.png" loading="lazy" />
