...
description: Dowiedz się, jak używać tokenów za pomocą API Keystone
...
Aby zalogować się do interfejsu Horizon i pobrać plik, zapoznaj się [z tym przewodnikiem](/guides/public-cloud/cross-functional/introducing-horizon).
