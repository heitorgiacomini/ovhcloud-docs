...
- Utworzenie użytkownika OpenStack. Informacje na ten temat znajdziesz [w tym przewodniku](/guides/public-cloud/cross-functional/create-and-delete-a-user).
- Przygotowanie środowiska do korzystania z OpenStack. Informacje na ten temat znajdziesz w tym przewodniku: [Przygotowanie środowiska do korzystania z API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
...
Jak wskazano w [tym przewodniku](/guides/public-cloud/cross-functional/create-and-delete-a-user), hasło jest widoczne tylko raz, podczas jego tworzenia.
