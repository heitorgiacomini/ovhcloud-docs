...
description: Dowiedz się, jak tworzyć i wykorzystywać tokeny OpenStack do realizacji Twoich operacji
...
- Aby wyeksportować zmienne środowiskowe, zapoznaj się z tym przewodnikiem: [Zmienne środowiskowe OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables).

## W praktyce

### Etap 1: pobierz i utwórz plik OpenRC

Kliknij <code className="action">Użytkownicy i role</code> w sekcji **Ustawienia**, a następnie przycisk <code className="action">...</code> po prawej stronie użytkownika OpenStack.<br/>
Pobierz plik OpenRC tego użytkownika i podaj region, w którym chcesz wykonywać operacje.

<img className="thumbnail" alt="pobierz plik openRC" src="/images/public-cloud/cross-functional/using-openstack-tokens-for-multiple-calls/openrc.png" loading="lazy" />
