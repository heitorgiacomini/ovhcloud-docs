...
description: Przeniesienie adresu Additional IP
...
W menu po lewej stronie przejdź do sekcji **Sieć**, a następnie otwórz część <code className="action">Publiczne adresy IP</code>. Kliknij kartę <code className="action">Additional IP</code>.

W tym przykładzie adres Additional IP przekierowany na "Instance_A" zostanie przeniesiony na "Instance_B".

Kliknij <code className="action">...</code> w linii Additional IP i wybierz <code className="action">Zmień powiązaną</code> instancję.

<img className="thumbnail" alt="migracja IP" src="/images/public-cloud/network-services/additional-ip-migrate/migrateip_01.png" loading="lazy" />

Kliknij rozwijane menu, aby wybrać docelową instancję z listy.

<img className="thumbnail" alt="migracja IP" src="/images/public-cloud/network-services/additional-ip-migrate/migrateip_02.png" loading="lazy" />

Zatwierdź klikając przycisk <code className="action">Dołącz</code>.
...
<img className="thumbnail" alt="migracja IP" src="/images/public-cloud/network-services/additional-ip-migrate/migrateip_03.png" loading="lazy" />
...
[Konfiguracja Additional IP](/guides/public-cloud/network-services/configure-additional-ip)

[Importowanie adresu Additional IP](/guides/public-cloud/network-services/import-additional-ip)
