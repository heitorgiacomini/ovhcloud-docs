...
<ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> to w pełni wizualny interfejs, idealnie nadający się do zarządzania wieloma VLAN. Będziesz również miał możliwość dostosowania prywatnego zakresu adresów IP, który domyślnie znajduje się w 10.1.0.0/16.
...
Zwróć się do [tego przewodnika](/guides/public-cloud/cross-functional/introducing-horizon), aby zapoznać się z Horizon.
...
Do tego potrzebujesz wybrać odpowiedni dostawcę i zasób terraform. Znajdziesz więcej informacji w naszym przewodniku dotyczącym [używania Terraform z OVHcloud](/guides/manage-and-operate/terraform/at-ovhcloud).
...
Zostaniesz przekierowany na inną stronę, aby potwierdzić zamówienie. Ustawienie vRacka w Twoim koncie zajmie kilka minut.
    ...
    <img className="thumbnail" alt="dodaj projekt do vrack" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
<Tabs>
  <Tab label="Przez Panelu klienta OVHcloud">
    ...
    <img className="thumbnail" alt="Tworzenie VLAN" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Kliknij przycisk <code className="action">Utwórz prywatną sieć</code>. Ta strona pozwala dostosować wiele ustawień.
    ...
    <img className="thumbnail" alt="Wybierz region" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

W następnym kroku przedstawione są różne Opcje:
    
    <img className="thumbnail" alt="Tworzenie sieci" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
W polu **Nazwa prywatnej sieci** ustaw nazwę swojej prywatnej sieci.
    ...
    **Opcje bramy sieciowej**
    ...
    - **Przypisz Gateway i połącz się z prywatną siecią**: Wybierz tę opcję, jeśli zamierzasz tworzyć instancje z prywatną siecią. Aby uzyskać więcej informacji, zapoznaj się z poniższymi przewodnikami: [Tworzenie prywatnej sieci z bramą](/guides/public-cloud/network-services/create-private-network-gateway) i [Tworzenie i łączenie się ze swoją pierwszą instancją Public Cloud](/guides/public-cloud/compute/getting-started).
...
<Tabs>
  <Tab label="Przez Panelu klienta OVHcloud">
    Jeśli potrzebujesz pomocy, najpierw przejrzyj ten przewodnik: [Tworzenie instancji w Panelu klienta OVHcloud](/guides/public-cloud/compute/getting-started). Przy tworzeniu instancji możesz wybrać, w kroku 5, tryb sieciowy, a następnie prywatną sieć, do której chcesz dołączyć swoją instancję.
    
    <img className="thumbnail" alt="dołączenie nowej instancji" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/network-selection.png" loading="lazy" />
...
<Tabs>
  <Tab label="Przez Panelu klienta OVHcloud">
    ...
    <img className="thumbnail" alt="szczegóły instancji" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/instance_details.png" loading="lazy" />
...
Otworzy się pulpit instancji. Kliknij przycisk <code className="action">⁝</code> w oknie "Sieć", obok "Sieci prywatne", i wybierz <code className="action">Przypisz sieć</code>.
    ...
    <img className="thumbnail" alt="dołącz sieć" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />
...
W oknie dialogowym, które się pojawi, wybierz prywatną sieć (siec(y)) do dołączenia do swojej instancji i kliknij <code className="action">Zatwierdź</code>.
    ...
    <img className="thumbnail" alt="dołącz sieć" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="Przez APIv6 OVHcloud">
...
Musisz wypełnić co najmniej następujące pola:
  ...
  <Tab label="Przez Horizon">
    ...
    <img className="thumbnail" alt="połączenie Horizon" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />

Wybierz `Compute` i następnie `Instances` z menu.
    
    <img className="thumbnail" alt="instancje Horizon Compute" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon2.png" loading="lazy" />
...
**Dodawanie prywatnego interfejsu**
    ...
    <img className="thumbnail" alt="dołącz interfejs Horizon" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon3.png" loading="lazy" />

Wybierz swój interfejs i potwierdź.
    
    <img className="thumbnail" alt="dołącz interfejs Horizon" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon4.png" loading="lazy" />
...
Ta akcja jest wymagana tylko wtedy, gdy chcesz izolować swój serwer w vRacku (sieci prywatnej), lub jeśli chcesz usunąć go z jednej lub więcej VLAN.
    ...
    <img className="thumbnail" alt="odłącz interfejs Horizon" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon5.png" loading="lazy" />

Wybierz swój interfejs i potwierdź.
    
    <img className="thumbnail" alt="odłącz interfejs Horizon" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon6.png" loading="lazy" />
  </Tab>
  <Tab label="Przez OpenStack CLI">
