...
:::info
Aktualnie usługi Floating IP i Gateway nie obsługują IPv6. IPv6 można używać tylko z instancjami w [trybie publicznym](/guides/public-cloud/network-services/concepts#publicmode).
