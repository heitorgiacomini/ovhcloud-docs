...
A [Gateway](https://www.ovhcloud.com/pl/public-cloud/gateway/) offers a secure outbound connection method from your private network instances or the ability to use Floating IPs with your instance or Load Balancer for service exposition.
...
Learn more about Gateway and its scenarios on our [dedicated page](https://www.ovhcloud.com/pl/public-cloud/gateway/).
