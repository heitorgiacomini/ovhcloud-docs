...
description: Find out how to configure the Public Cloud Load Balancer
...
- A [private network](/guides/public-cloud/network-services/vrack) configured in your project
...
>
> You can read more about it on our dedicated [Concepts page](/guides/public-cloud/network-services/additional-ip-vs-floating-ip).
