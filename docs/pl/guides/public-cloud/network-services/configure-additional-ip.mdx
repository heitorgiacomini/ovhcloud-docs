...
:::info
Ten artykuł dotyczy konfiguracji adresów Additional IPv4 w interfejsie publicznym. Możesz również skonfigurować adresy IPv6 dla instancji Public Cloud, korzystając z [tego przewodnika](/guides/public-cloud/network-services/ipv6-configuration).
...
- [Konfiguracja bloku IP w sieci vRack w instancji Public Cloud (EN)](/guides/public-cloud/network-services/configure-ip-block-vrack-instance).
- [Konfiguracja bloku IPv6 w sieci vRack (EN)](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack).
...
<Tabs>
  ...
  <Tab label="Plesk">
    ...
    **Krok 1: dostęp do interfejsu zarządzania adresami IP Plesk**
    ...
    <img className="thumbnail" alt="dostęp do zarządzania adresami IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip1.png" loading="lazy" />
...
Kliknij <code className="action">IP Addresses</code> pod **Tools & Resources**.
    ...
    **Krok 2: dodaj dodatkowe informacje IP**
    ...
    <img className="thumbnail" alt="dodaj informacje IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip2-2.png" loading="lazy" />
...
Wprowadź adres Additional IP w formie `xxx.xxx.xxx.xxx/32` w polu "IP address and subnet mask", a następnie kliknij <code className="action">OK</code>.
    ...
    <img className="thumbnail" alt="dodaj informacje IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip3-3.png" loading="lazy" />

**Krok 3: sprawdź aktualną konfigurację IP**
    
    W sekcji "IP Addresses" sprawdź, czy adres Additional IP został poprawnie dodany.
    
    <img className="thumbnail" alt="aktualna konfiguracja IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip4-4.png" loading="lazy" />
  </Tab>
...
Aby pobrać aktualną konfigurację IP, wprowadź `ipconfig` w wierszu poleceń.
    ...
    <img className="thumbnail" alt="sprawdź główną konfigurację IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image1-1.png" loading="lazy" />
...
**Krok 2: zmień właściwości IPv4**
    ...
    <img className="thumbnail" alt="zmień konfigurację IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image2.png" loading="lazy" />
...
W oknie Właściwości IPv4 wybierz <code className="action">Użyj następującego adresu IP</code>. Wpisz adres IP, który otrzymałeś w pierwszym etapie, po czym kliknij <code className="action">Zaawansowane</code>.
    ...
    **Krok 3: dodaj adres Additional IP do zaawansowanych ustawień TCP/IP**
    ...
    <img className="thumbnail" alt="sekcja konfiguracji zaawansowanej" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image4-4.png" loading="lazy" />

Potwierdź klikając <code className="action">Dodaj</code>.
    
    <img className="thumbnail" alt="Konfiguracja migracji IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image5-5.png" loading="lazy" />
...
**Krok 4: uruchom ponownie interfejs sieciowy**
    ...
    <img className="thumbnail" alt="dezaktywacja sieci" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image6.png" loading="lazy" />

Aby go ponownie uruchomić, kliknij prawym przyciskiem myszy, a następnie wybierz <code className="action">Aktywuj</code>.
    
    <img className="thumbnail" alt="aktywacja sieci" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image7.png" loading="lazy" />
...
**Krok 5: sprawdź nową konfigurację sieci**
    ...
    <img className="thumbnail" alt="sprawdź aktualną konfigurację sieci" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image8-8.png" loading="lazy" />
  </Tab>
</Tabs>
...
Aby przetestować połączenie, wystarczy wysłać ping na adres Additional IP z zewnątrz. Jeśli odpowiada w trybie Rescue, prawdopodobnie oznacza to, że wystąpił błąd w konfiguracji. Jeśli jednak adres IP nadal nie działa, poinformuj o tym zespół pomocy technicznej OVHcloud, wysyłając zgłoszenie serwisowe w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.

## Sprawdź również

[Importuj Additional IP](/guides/public-cloud/network-services/import-additional-ip)

[Przenieś Additional IP](/guides/public-cloud/network-services/migrate-additional-ip)
