...
If you encounter any difficulties performing these actions, please contact a [specialist service provider](https://partner.ovhcloud.com/pl/directory/) and/or discuss the issue with our community. You can find more information in the [Go further](#gofurther) section of this guide.
...
- [Additional IP address](https://www.ovhcloud.com/pl/network/additional-ip/) for ensuring network failover and high availability setup
