...
- Posiadanie [instancji Public Cloud](/guides/public-cloud/compute/getting-started#configuration) typu *flex*
- [Utworzenie dostępu do interfejsu Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
