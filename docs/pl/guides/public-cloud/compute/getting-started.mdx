...
- Jeśli instancja musi być podłączona do nowej sieci prywatnej (OVHcloud [vRack](https://www.ovhcloud.com/pl/network/vrack/)), należy pamiętać, że usługa vRack jest tworzona automatycznie podczas tworzenia projektu Public Cloud. Żadne wcześniejsze działanie nie jest zatem wymagane. Więcej informacji znajdziesz w [przewodniku dotyczącym usługi vRack Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack).
