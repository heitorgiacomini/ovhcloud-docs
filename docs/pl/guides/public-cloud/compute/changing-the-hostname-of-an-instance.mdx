...
description: Dowiedz się, jak zmienić hostname instancji Public Cloud
...
Moduł Cloud-init pozwala na skonfigurowanie [instancji Public Cloud](https://www.ovhcloud.com/pl/public-cloud/) podczas jej tworzenia oraz podczas każdego restartu. Jeśli chcesz ponownie skonfigurować hostname, na przykład na skutek błędu podczas tworzenia instancji lub aby zmienić konfigurację serwera mailowego, musisz wyłączyć moduł Cloud-init, który zajmuje się konfiguracją hostname, aby nie został on przywrócony. 
...
* Utworzenie [instancji Public Cloud](/guides/public-cloud/compute/getting-started)
* [Połączenie przez SSH](/guides/public-cloud/compute/getting-started#connect-instance) (sudo) z instancją
