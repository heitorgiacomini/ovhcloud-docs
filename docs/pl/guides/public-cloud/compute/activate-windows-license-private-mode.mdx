...
description: Dowiedz się, jak aktywować licencję Windows na instancji w trybie prywatnym
...
- Posiadanie [projektu Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Utworzenie użytkownika OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)

Zalecamy zapoznanie się z przewodnikiem  "[Dostęp do interfejsu Horizon](/guides/public-cloud/cross-functional/introducing-horizon)" w celu zapoznania się z programem Horizon.
...
Zaloguj się do interfejsu [Horizon](https://horizon.cloud.ovh.net/auth/login/), postępując zgodnie z instrukcjami zawartymi w [pierwszej części tego przewodnika](/guides/public-cloud/network-services/vrack#interfejs-horizon).

Zaloguj się do Twojego obszaru pracy:

<img className="thumbnail" alt="region" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon1.png" loading="lazy" />

Następnie przejdź do <code className="action">Compute</code>, następnie <code className="action">Instances</code>:

<img className="thumbnail" alt="compute i instance" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon2.png" loading="lazy" />

Aby dodać interfejs, w kolumnie "Actions" kliknij strzałkę umożliwiającą dostęp do operacji, które można wykonać na instancji. Następnie kliknij <code className="action">Attach Interface</code>:

<img className="thumbnail" alt="interfejs" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon3.png" loading="lazy" />

Wybierz interfejs i zatwierdź:

<img className="thumbnail" alt="interfejs select" src="/images/public-cloud/compute/activate-windows-license-private-mode/attachinterfacehorizon.png" loading="lazy" />
...
Po zalogowaniu się do instancji Windows kliknij menu <code className="action">Start</code>, a następnie ikonę <code className="action">Windows PowerShell</code>.
...
<img className="thumbnail" alt="aktywacja klucza windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="aktywacja klucza windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />

## Sprawdź również

[Dowiedz się, jak naprawić klucz aktywacyjny systemu Windows Server](/guides/bare-metal-cloud/dedicated-servers/windows-key).
