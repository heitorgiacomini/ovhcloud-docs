...
- Jeśli chcesz przygotować środowisko do korzystania z [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform), musisz przygotować środowisko.
...
- Przygotuj środowisko, jeśli chcesz korzystać z [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform)
...
Otwórz [połączenie SSH z Twoją instancją](/guides/public-cloud/compute/getting-started#connect-instance), następnie użyj poniższej komendy, aby wyświetlić powiązane dyski.
...
<Tabs>
  <Tab label="Linux">
    Otwórz [połączenie SSH z Twoją instancją](/guides/public-cloud/compute/getting-started#krok-3-tworzenie-instancji), a następnie wpisz poniższe polecenie, aby wyświetlić powiązane dyski.
