...
- Utworzenie instancji Public Cloud w [Panelu klienta OVHcloud](/guides/public-cloud/compute/getting-started) lub w [interfejsie Horizon](/guides/public-cloud/compute/create-instance-in-horizon).
- [Utworzenie klucza SSH](/guides/public-cloud/compute/creating-ssh-keys).
...
- Attach Interface: ta opcja pozwala na dodanie jednego lub kilku prywatnych interfejsów do Twojej instancji za pośrednictwem sieci VLAN. Więcej informacji znajdziesz w [tej części](/guides/public-cloud/network-services/vrack#dodawanie-prywatnego-interfejsu) odpowiedniego przewodnika.
- Detach Interface: ta opcja służy do odłączenia interfejsu związanego z instancją. Więcej informacji znajdziesz w [tej części](/guides/public-cloud/network-services/vrack#usuwanie-prywatnego-interfejsu) odpowiedniego przewodnika.
...
Więcej informacji znajdziesz [w tym przewodniku](/guides/public-cloud/compute/getting-started#user-mgmt).
