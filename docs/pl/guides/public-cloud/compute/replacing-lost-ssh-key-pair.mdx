...
description: Dowiedz się, jak przywrócić dostęp do serwera, zastępując parę kluczy SSH nową parą w przypadku utraty klucza prywatnego
...
- [Instancja Public Cloud](https://www.ovhcloud.com/pl/public-cloud/compute/) na koncie OVHcloud
...
Utwórz nową parę kluczy SSH na Twoim lokalnym urządzeniu, postępując zgodnie z instrukcjami z pierwszej części [przewodnika dotyczącego tworzenia klucza SSH](/guides/public-cloud/compute/creating-ssh-keys).

### Etap 2: dostęp do instancji w trybie Rescue

Postępuj zgodnie z instrukcjami zawartymi w [Przewodniku po trybie ratunkowym](/guides/public-cloud/compute/put-an-instance-in-rescue-mode), aby uruchomić instancję w trybie ratunkowym, połączyć się z nią i zamontować partycje.
...
Uruchom ponownie instancję w trybie "normalnym" z poziomu <ManagerLink to="/">panelu klienta OVHcloud</ManagerLink>. W razie potrzeby skorzystaj z instrukcji zawartych w [Przewodniku o trybie ratunkowym](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
