...
- [Utworzenie instancji w Panelu klienta OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Dostęp administratora](/guides/public-cloud/compute/getting-started#connect-instance)
