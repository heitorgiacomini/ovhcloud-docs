...
- Wolumen [Block storage](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance) utworzony w Twoim projekcie [Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
