...
description: Dowiedz się, jak wdrożyć aplikacje zainstalowane na Twoich instancjach Public Cloud
...
- Instancja [Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) na Twoim koncie OVHcloud.
...
Za pomocą <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> / API lub interfejsu OpenStack Horizon / API zainstaluj wybraną aplikację na swojej instancji Public Cloud.
...
1. Zaloguj się do [konsoli API](https://eu.api.ovh.com/)
