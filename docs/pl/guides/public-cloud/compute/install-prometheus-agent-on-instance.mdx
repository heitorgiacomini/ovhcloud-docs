...
- [Instancja utworzona za pomocą Panelu klienta OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
- [Dostęp administracyjny do instancji](/guides/public-cloud/compute/getting-started).
