...
Kliknij <code className="action">Instancje</code> w menu po lewej stronie w zakładce **Compute**. Następnie kliknij przycisk <code className="action">Utwórz instancję</code> i wybierz kompatybilną instancję GPU:
...
Następnie wykonaj pozostałe etapy zgodnie z instrukcjami zawartymi w [tym przewodniku](/guides/public-cloud/compute/getting-started#create-instance). Może to potrwać kilka minut.
...
Dołącz do naszej społeczności użytkowników: [https://community.ovh.com/en/](https://community.ovh.com/en/).