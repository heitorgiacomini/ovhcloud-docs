...
description: Test prędkości dysków
...
- Posiadanie [instancji Public Cloud](https://www.ovhcloud.com/pl/public-cloud/compute/).
...
Aby przetestować prędkość dodatkowego dysku, podmontuj go. Aby uzyskać więcej informacji, zapoznaj się z [przewodnikiem](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance#windows).
