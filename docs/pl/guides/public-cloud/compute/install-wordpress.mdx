...
description: Dowiedz się, jak korzystać z instancji Public Cloud do hostowania stron WordPress
...
- Posiadanie zainstalowanej [instancji Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) z systemem Debian lub Ubuntu
...
Otwórz przeglądarkę internetową i zaloguj się do strony WordPress wprowadzając adres IP Twojej instancji (lub nazwę domeny, jeśli już [podłączyłeś ją do instancji](/guides/web-cloud/domains/dns-zone-edit)). Wybierz język na pierwszej stronie.
