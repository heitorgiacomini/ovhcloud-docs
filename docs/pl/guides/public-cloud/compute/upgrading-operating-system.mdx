...
description: Dowiedz się, jak zaktualizować system operacyjny pod koniec życia
...
Dlatego przed postępuniem zgodnie z instrukcjami, OVHcloud zdecydowanie zaleca, aby [zapisać Twoją instancję](/guides/public-cloud/compute/save-an-instance) i wykonać szczegółowe testy aplikacji, aby upewnić się, że działają one na nowej wersji systemu operacyjnego.
:::
...
- Dostęp [administratora do serwera](/guides/public-cloud/compute/getting-started#connect-instance)
- Wykonanie [kopii zapasowej instancji](/guides/public-cloud/compute/save-an-instance)
...
Sprawdź, czy Twoje aplikacje działają zgodnie z planem. W przypadku problemu zalecamy [przywrócenie kopii zapasowej](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) przed aktualizacją.
