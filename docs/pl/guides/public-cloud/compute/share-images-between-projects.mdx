...
description: Dowiedz się, jak współdzielić obrazy między projektami Public Cloud za pomocą OpenStack
lastUpdated: 2025-04-01
---

## Wprowadzenie

Czasami może być konieczne współdzielenie obrazu [Instance Backup](/guides/public-cloud/compute/save-an-instance) lub obrazu [Volume Backup](/guides/public-cloud/compute/volume-backup) między kilkoma projektami Public Cloud.
...
Więcej informacji znajdziesz w oficjalnej [dokumentacji OpenStack](https://docs.openstack.org/image-guide/share-images.html).
...
:::info
Niniejszy przewodnik odnosi się do korzystania z [klienta wiersza poleceń OpenStack](https://docs.openstack.org/python-openstackclient/latest/).
:::
