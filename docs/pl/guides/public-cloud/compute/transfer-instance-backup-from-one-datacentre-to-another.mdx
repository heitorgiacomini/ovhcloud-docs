...
Może być konieczne przeniesienie [instancji Public Cloud](https://www.ovhcloud.com/pl/public-cloud/compute/) z jednego regionu OpenStack do innego. Ponieważ wolisz migrować do nowego dostępnego regionu OpenStack lub chcesz migrować z OVHcloud Labs na Public Cloud.
...
- CLI OpenStack. Zapoznaj się z przewodnikiem "[Jak przygotować środowisko do korzystania z API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)".
...
Będziesz również potrzebował [instancji Public Cloud](https://www.ovhcloud.com/pl/public-cloud/compute/) na koncie OVHcloud.

## W praktyce

:::info
Jeśli chcesz utworzyć kopię zapasową za pomocą OpenStack, skorzystaj z tej dedykowanej instrukcji, jak [zrobić kopię zapasową instancji.](/guides/public-cloud/compute/save-an-instance).
:::
...
:::info
Jeśli chcesz ponownie utworzyć swoją instancję z tego backupu, postępuj zgodnie z naszym przewodnikiem "[Używanie kopii zapasowych instancji do tworzenia lub przywracania instancji](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup)".
:::
