...
description: Dowiedz się, jak skonfigurować dodatkowe klucze SSH dla kont użytkowników i dodać je do instancji Public Cloud
...
Ten przewodnik ułatwi Ci realizację bieżących zadań. Niemniej jednak w przypadku problemów zalecamy skontaktowanie się z [wyspecjalizowanym dostawcą](https://partner.ovhcloud.com/pl/directory/) lub skontaktowanie się z [naszą społecznością](https://community.ovhcloud.com/community/en).
:::


## Wymagania początkowe

- [Instancja Public Cloud](https://www.ovhcloud.com/pl/public-cloud/) na koncie OVHcloud
- [Dostęp administracyjny do instancji za pośrednictwem SSH](/guides/public-cloud/compute/creating-ssh-keys#login-linux)
...
Jeśli to konieczne, skorzystaj z naszego [przewodnika dotyczącego kluczy SSH](/guides/public-cloud/compute/creating-ssh-keys), aby utworzyć nową parę kluczy SSH.  
Znajdziesz tam również informacje dotyczące [zarządzania wieloma kluczami](/guides/public-cloud/compute/creating-ssh-keys#multiplekeys) na Twojej lokalnej stacji roboczej, jeśli wymaga tego instalacja.

### Etap 2: konfiguracja nowego konta użytkownika

[Zaloguj się do instancji](/guides/public-cloud/compute/getting-started#connect-instance) i zastosuj poniższe polecenia, aby utworzyć nowe konto użytkownika oraz katalog `.ssh`:
...
Więcej informacji na temat uprawnień użytkowników i powiązanych z nimi tematów można znaleźć w [Przewodniku o koncie użytkownika](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
Więcej informacji na temat używania kluczy SSH z instancjami Public Cloud znajdziesz w [przewodniku dotyczącym kluczy SSH](/guides/public-cloud/compute/creating-ssh-keys).

## Sprawdź również

[Jak tworzyć instancje Public Cloud](/guides/public-cloud/compute/getting-started)
