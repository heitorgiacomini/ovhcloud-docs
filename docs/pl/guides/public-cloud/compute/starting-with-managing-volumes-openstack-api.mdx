...
- [Przygotowanie środowiska do korzystania z API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) poprzez instalację Python-cinderclient oraz python-novaclient
