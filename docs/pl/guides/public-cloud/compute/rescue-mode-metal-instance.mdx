---
title: Uruchamianie instancji Metal w trybie awaryjnym - (EN)
description: Find out how to activate the rescue mode environment on a Metal Instance
...
:::info
This guide applies only to Metal instances. To access rescue mode for all other instance types, follow [this main guide](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
:::
...
- A [Public Cloud Metal instance](/guides/public-cloud/compute/getting-started) in your project

## Instructions

Before following these steps, it’s recommended that you first complete the following:

- [Preparing the environment to use the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
