...
Dostęp do interfejsu [Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user). Wybierz region, w którym chcesz utworzyć grupę zabezpieczeń, klikając przycisk w lewym górnym rogu.
