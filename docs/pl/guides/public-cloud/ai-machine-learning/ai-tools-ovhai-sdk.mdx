...
description: Simplify AI Solutions management with the ovhai Python SDK
...
The token used to create the client can be created via the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> (UI), from the AI Dashboard.
