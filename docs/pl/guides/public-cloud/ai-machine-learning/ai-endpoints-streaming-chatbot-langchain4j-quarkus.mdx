...
In this tutorial, you'll learn how to use **[LangChain4j](https://github.com/langchain4j/langchain4j)** with **[Quarkus](https://github.com/quarkusio/quarkus)** to create a chatbot that streams LLM-generated responses using **[AI Endpoints](https://www.ovhcloud.com/pl/public-cloud/ai-endpoints/)**.
...
- **[AI Endpoints](https://www.ovhcloud.com/pl/public-cloud/ai-endpoints/)**: A serverless platform by OVHcloud providing easy access to a variety of world-renowned AI models including Mistral, LLaMA, and more. This platform is designed to be simple, secure, and intuitive, with data privacy as a top priority.
...
In just a few steps, you have created your own **streaming AI chatbot** powered by [LangChain4j](https://github.com/langchain4j/langchain4j), [Quarkus](https://github.com/quarkusio/quarkus), and [OVHcloud AI Endpoints](https://www.ovhcloud.com/pl/public-cloud/ai-endpoints/).
