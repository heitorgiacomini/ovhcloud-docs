...
description: How to deploy a Streamlit app to classify marine mammal sounds
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-03-streamlit-sounds-classification/overview-streamlit-sounds.png" loading="lazy" />
...
:::info
Here you will use your trained model, then save it in an Object Container. Click [here](/guides/public-cloud/ai-machine-learning/ai-cli-data) to learn more about Object Storage.
:::
...
- You can imagine deploying an AI model with an other tool: **Gradio**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-gradio-sketch-recognition).
- Another way to create an AI Deploy app is to use **Flask**! [Here it is](/guides/public-cloud/ai-machine-learning/ai-deploy-web-service-yolov5).
