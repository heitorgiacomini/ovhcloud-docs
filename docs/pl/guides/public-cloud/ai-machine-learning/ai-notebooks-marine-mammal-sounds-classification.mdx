...
description: How to classify sounds with AI
...
- Two [Object Storage containers](/guides/storage-and-backup/object-storage/pcs-create-container) to store the data and the model
- Your own dataset
...
You need to attach a volume if your data is in your OVHcloud Object Storage and you want to use it during your experiment. For more information on data, volumes and permissions, see [our guide on data](/guides/public-cloud/ai-machine-learning/ai-cli-access-data).
...
If you want to launch it with the CLI, choose the [volume](/guides/public-cloud/ai-machine-learning/ai-cli-access-data) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
...
- If you want to train your model, please check out this [AI Training tutorial](/guides/public-cloud/ai-machine-learning/ai-training-train-marine_mammal_sound).
- If you want to deploy a **Streamlit** app in order to classify marine mammal sounds using your model, please check out this [notebook](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-sounds-classification).
- You can also compare two methods for audio classification task by following this [tutorial](/guides/public-cloud/ai-machine-learning/ai-training-models-comparaison-wandb).
