...
description: Understand the scaling strategies (static scaling vs autoscaling) of AI Deploy and learn how to use them
...
- The **OVHcloud AI CLI** (`ovhai`) installed. For installation instructions, see [how to install ovhai](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
<Tabs>
  <Tab label="Using the Control Panel (UI)">
    ...
    <img className="thumbnail" alt="Set static scaling on AI Deploy via UI" src="/images/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/set-static-scaling.png" loading="lazy" />
  </Tab>
...
<Tabs>
  <Tab label="Using the Control Panel (UI)">
    ...
    <img className="thumbnail" alt="Set autoscaling on AI Deploy via UI" src="/images/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/set-autoscaling.png" loading="lazy" />
  </Tab>
  <Tab label="Using ovhai CLI">
...
<Tabs>
  <Tab label="Using the Control Panel (UI)">
    ...
    <img className="thumbnail" alt="Enable custom autoscaling on AI Deploy via UI" src="/images/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/set-custom-autoscaling.png" loading="lazy" />
  </Tab>
  <Tab label="Using ovhai CLI">
...
<Tabs>
  <Tab label="Using the Control Panel (UI)">
    ...
    <img className="thumbnail" alt="Update application scaling step 2" src="/images/public-cloud/ai-machine-learning/deploy-guide-04-scaling-strategies/update-autoscaling-2.png" loading="lazy" />
  </Tab>
  <Tab label="Using ovhai CLI">
