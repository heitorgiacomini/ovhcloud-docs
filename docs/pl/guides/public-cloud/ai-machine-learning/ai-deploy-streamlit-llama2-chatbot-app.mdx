...
description: How to build and deploy a LLaMA 2 chatbot application using Streamlit
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-15-streamlit-chatbot-llama-v2/llama_app_overview.png" loading="lazy" />
...
- Discover how to [fine-tune LLaMA 2 on your own dataset](/guides/public-cloud/ai-machine-learning/ai-notebooks-tuto-fine-tune-llama-v2)
- Create a voice chatbot with [Speech to Text](/guides/public-cloud/ai-machine-learning/ai-notebooks-speech-to-text-recognition)
