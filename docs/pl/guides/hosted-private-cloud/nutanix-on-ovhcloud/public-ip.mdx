---
title: Dodaj publiczny adres IP do nowej VM (EN)
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and add a Additional IP address to your [vRack](https://www.ovhcloud.com/pl/network/vrack/).
