...
description: Presentation of various advanced tools available for the Nutanix on OVHcloud offer
...
In the top right-hand corner of the **Prism Central** interface, click <code className="action">Username</code>, then <code className="action">REST API Explorer</code>.

<img className="thumbnail" alt="Display RESTAPI commands 01" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/09-advanced-tools/Displayrestapicmds-01.png" loading="lazy" />

The list of command groups is displayed on the left.

Click <code className="action">List operations</code> to the right of one of the command groups to display all possible commands in that group.

<img className="thumbnail" alt="Display RESTAPI commands 02" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/09-advanced-tools/Displayrestapicmds-02.png" loading="lazy" />

Click <code className="action">Expand operations</code> to list the syntax for a particular command.

<img className="thumbnail" alt="Display RESTAPI commands 03" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/09-advanced-tools/Displayrestapicmds-03.png" loading="lazy" />

<img className="thumbnail" alt="Display RESTAPI commands 04" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/09-advanced-tools/Displayrestapicmds-04.png" loading="lazy" />
...
You can install Linux from pre-installed images, and you can customise the configuration with cloud-init, which uses the yaml file format. To import images into a Nutanix cluster, you can refer to our guide on [importing ISO images](/guides/hosted-private-cloud/nutanix-on-ovhcloud/image-import).
