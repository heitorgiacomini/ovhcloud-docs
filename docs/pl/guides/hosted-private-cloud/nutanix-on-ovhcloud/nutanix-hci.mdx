...
description: Presentation of the Nutanix hyperconvergence solution
...
Click <code className="action">View Details</code> for more information about storage.
...
<img className="thumbnail" alt="Storage" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/03-nutanix-hci/StorageDetail.PNG" loading="lazy" />

Click on the <code className="action">Hardware</code> menu to view the details of the storage per node, as well as the number of disks allocated per node.
...
Click <code className="action">Diagrams</code> for a graphical summary as shown below.
