...
description: Find out how to manage users, configure their access rights, and assign OpenStack roles on your Bare Metal Pod SecNumCloud via Keycloak
...
- Having read the [Getting started with your Bare Metal Pod SecNumCloud](/guides/hosted-private-cloud/baremetal-pod/snc-getting-started) guide
