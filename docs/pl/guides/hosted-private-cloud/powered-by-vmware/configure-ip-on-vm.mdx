---
title: Konfiguracja adresu IP na maszynie wirtualnej (EN)
description: Dowiedz się, jak skonfigurować adres IP na maszynie wirtualnej
...
<Tabs>
  <Tab label="IPv4">
    ...
    <img className="thumbnail" alt="Configuration on the OVHcloud Network" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/01config_ip_ovh_network.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="Advanced configuration on the OVH Network" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/02config_ip_ovh_network_advanced.png" loading="lazy" />
  </Tab>
  <Tab label="IPv6">
    :::warning
...
<img className="thumbnail" alt="VMNetwork" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/03vmnetwork.png" loading="lazy" />

<Tabs>
  <Tab label="Linux IPv4">
    Here is an example of a configuration on the Debian distribution:
    
    <img className="thumbnail" alt="IP Interface" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/config_ip_interfaces.png" loading="lazy" />
  ...
  <Tab label="Windows IPv4">
    ...
    <img className="thumbnail" alt="Windows Configuration" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/config_ip_windows.png" loading="lazy" />
  ...
  <Tab label="Linux IPv6">
    ...
    <img className="thumbnail" alt="IPv6 Interface" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/config_ip_interfaces_v6.png" loading="lazy" />
  ...
  <Tab label="Windows IPv6">
    ...
    <img className="thumbnail" alt="Windows IPv6 Configuration" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/config_ip_windows_v6.png" loading="lazy" />
...
- A VLAN interface (10 to 20 by default and linked to the vRack, you can create more by consulting [this guide](/guides/hosted-private-cloud/powered-by-vmware/create-vlan)).

- A VxLAN interface (vxw-dvs, etc.).

In your virtual machine settings, you can use a VLAN or a VxLAN:

<img className="thumbnail" alt="VLAN for SDDC" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/04vlanBis.png" loading="lazy" />

<img className="thumbnail" alt="VLAN for SDDC" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/05vlan.png" loading="lazy" />

<img className="thumbnail" alt="VXLAN on the Private Cloud" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/06vxlan.png" loading="lazy" />

#### Linux

Here is a configuration example on a Debian operating system:

<img className="thumbnail" alt="Private IP address on Linux" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/linux_private.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Configure a public IP address on Windows" src="/images/hosted-private-cloud/powered-by-vmware/configure-ip-on-vm/windows_private.PNG" loading="lazy" />
