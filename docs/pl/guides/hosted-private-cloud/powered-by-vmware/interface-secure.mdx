...
Pamiętaj, że uprawnienie to można przyznać także innym użytkownikom za pośrednictwem Panelu klienta OVHcloud. W razie takiej potrzeby skorzystaj z dokumentacji [Prezentacja Panelu klienta Private Cloud OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud).
...
- link umożliwiający zatwierdzenie operacji (pamiętaj, że jeśli Twój telefon nie jest podłączony do sieci z [autoryzowanym IP](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#bezpieczenstwo), strona się nie wyświetli).
