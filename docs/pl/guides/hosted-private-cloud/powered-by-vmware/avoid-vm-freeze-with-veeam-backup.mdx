...
description: Dowiedz się, jak wdrożyć rozwiązanie, które pozwala uniknąć blokady wirtualnej maszyny za pomocą mechanizmu VMware DRS
...
Aby wdrożyć to rozwiązanie, kliknij na odpowiedni klaster, przejdź do zakładki <code className="action">Configure</code>, następnie sekcji <code className="action">VM/Host Rules</code>.
