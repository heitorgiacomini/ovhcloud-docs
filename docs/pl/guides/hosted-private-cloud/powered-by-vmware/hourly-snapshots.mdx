...
description: Dowiedz się, jak działają snapshoty godzinowe OVHcloud
...
* Posiadanie [infrastruktury Private Cloud](https://www.ovhcloud.com/pl/enterprise/products/hosted-private-cloud/) na koncie OVHcloud.
...
<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot01.png" loading="lazy" />

Utwórz folder, do którego później skopiujesz pliki do przywrócenia.

<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot02.png" loading="lazy" />
...
<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot03.png" loading="lazy" />

Pliki są już dostępne. Wystarczy dodać tę maszynę do **inwentarza**, klikając plik `.vmx`, a następnie <code className="action">register VM</code> powyżej.

<img className="thumbnail" alt="snapshot" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot04.png" loading="lazy" />
...
Zalecamy użycie pełnego rozwiązania do tworzenia kopii zapasowych, takiego jak usługa [Veeam Backup](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service) lub inny system realizujący kopię zapasową wirtualnych maszyn.
