...
- Dostęp do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> lub [interfejsu administracyjnego usług przez API](https://eu.api.ovh.com/).

## W praktyce

:::tip
E-maile wysłane przez OVHcloud są również dostępne w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.<br/>
...
Zaloguj się do Twojego <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> za pomocą konta administratora.
...
<img className="thumbnail" alt="zmiana harmonogramu" src="/images/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling/maintenance-date-edition01.png" loading="lazy" />
...
<img className="thumbnail" alt="zmiana harmonogramu" src="/images/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling/maintenance-date-edition02.png" loading="lazy" />
