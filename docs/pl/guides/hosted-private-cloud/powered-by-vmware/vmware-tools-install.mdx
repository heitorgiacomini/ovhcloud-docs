...
description: Dowiedz się, jak wykonać instalację VMware Tools na wirtualnej maszynie
...
<img className="thumbnail" alt="Linux" src="/images/hosted-private-cloud/powered-by-vmware/vmware-tools-install/tools.png" loading="lazy" />
...
<img className="thumbnail" alt="Windows" src="/images/hosted-private-cloud/powered-by-vmware/vmware-tools-install/windows.jpg" loading="lazy" />
