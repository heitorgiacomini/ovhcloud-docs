...
description: Dowiedz się, jak ponownie zarejestrować wirtualne maszyny w nowej usłudze w starych datastore
...
- Posiadanie aktywnego identyfikatora użytkownika (utworzonego w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>)

## W praktyce

W [interfejsie vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion) umieść widok <code className="action">Storage</code>.

<img className="thumbnail" alt="przestrzeń dyskowa" src="/images/hosted-private-cloud/powered-by-vmware/vmware-register-vmx/register-vmx-01.png" loading="lazy" />

Wybierz datastore z listy.

<img className="thumbnail" alt="wybierz datastore" src="/images/hosted-private-cloud/powered-by-vmware/vmware-register-vmx/register-vmx-02.png" loading="lazy" />

W folderach tego datastore wybierz plik `.vmx` i kliknij <code className="action">Register VM</code>.
...
Uzupełnij wymagane informacje i kliknij <code className="action">Finish</code>.
...
Sprawdź parametry swoich wirtualnych maszyn (nazwa, [portgroup](/guides/hosted-private-cloud/powered-by-vmware/create-vlan), itp..) klikając prawym przyciskiem myszy na każdym z nich, a następnie wybierając <code className="action">Edit Settings</code>.

<img className="thumbnail" alt="zmień ustawienia" src="/images/hosted-private-cloud/powered-by-vmware/vmware-register-vmx/register-vmx-06.png" loading="lazy" />

W przypadku błędu konfiguracji wyświetli się komunikat błędu podczas włączania VM.

Możesz włączyć ponownie wirtualną maszynę klikając prawym przyciskiem myszy, a następnie klikając <code className="action">Power On</code>
