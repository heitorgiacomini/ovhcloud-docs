...
- Dostęp do [interfejsu vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion)
...
- Utworzenie maszyny wirtualnej z pliku ISO obecnego w centrum danych. Możesz [załadować ISO do datastore](/guides/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload)
- Możesz także wdrożyć maszynę wirtualną na podstawie posiadanego szablonu lub też za pomocą [szablonu OVH](/guides/hosted-private-cloud/powered-by-vmware/ovf-template)
