...
description: Discover how to set up Zerto Virtual Replication between your Private Cloud platforms
...
For instructions for cross platforms set up, please see our guide on [using Zerto between OVHcloud and a third party platform](/guides/hosted-private-cloud/powered-by-vmware/zerto-virtual-replication-customer-to-ovh).

**Discover how to set up Zerto Virtual Replication between your Hosted Private Cloud platforms.**

## Requirements 

- 2 [Hosted Private Cloud](https://www.ovhcloud.com/pl-pl/hosted-private-cloud/vmware/prices/) platform environments on 2 different hosts.
...
Select **Between two OVHcloud Private Cloud solutions** then click <code className="action">Activate Zerto DRP</code>.
...
From <code className="action">Actions</code>, select <code className="action">Create VPG</code>
...
You can keep the default values for the other settings. Click <code className="action">NEXT</code>.
...
If it is not necessary, you can click <code className="action">NEXT</code>.
...
Long term retention is disabled, click <code className="action">NEXT</code>.
...
The last screen summarizes the settings for the new VPG. If everything is OK, click <code className="action">DONE</code>.
...
From the interface, click on the bottom right button <code className="action">FAILOVER</code> (the toggle is by default on **TEST**).
...
The summary screen is displayed. If everything is OK, you can start the test by clicking <code className="action">START FAILOVER TEST</code>.
...
Confirm the end of the test by clicking <code className="action">STOP</code>.
...
The summary screen is displayed. If everything is OK, you can start the test by clicking <code className="action">START FAILOVER</code>.
...
Confirm with <code className="action">START FAILOVER</code>.
...
Validate with <code className="action">COMMIT</code>.
