...
Aplikacje te muszą wcześniej uzyskać autoryzację poprzez politykę dostępu do vCenter, którą możesz skonfigurować w [Panelu klienta](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#bezpieczenstwo).
