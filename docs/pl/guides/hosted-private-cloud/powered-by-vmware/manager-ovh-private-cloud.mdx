...
- Dostęp do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i przejście do sekcji <code className="action">Serwer</code>, a następnie <code className="action">Private Cloud</code>
...
W sekcji <code className="action">Private Cloud</code> znajdującej się w części <code className="action">Serwer</code> <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> masz dostęp do ogólnego podglądu infrastruktury Private Cloud:

<img className="thumbnail" alt="Informacje ogólne" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel1.png" loading="lazy" />
...
<img className="thumbnail" alt="Informacje ogólne" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel2.png" loading="lazy" />
...
<img className="thumbnail" alt="Opcje" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel3.png" loading="lazy" />
...
<img className="thumbnail" alt="Opcje" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel4.png" loading="lazy" />
...
<img className="thumbnail" alt="Użytkownicy" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel6.png" loading="lazy" />
...
<img className="thumbnail" alt="Droits utilisateur par datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel7.png" loading="lazy" />
...
<img className="thumbnail" alt="Paramètres de sécurité" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel8.png" loading="lazy" />
...
Więcej szczegółów na temat tej opcji znajdziesz w [tym przewodniku](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt).

#### Operacje

W tej karcie znajdziesz operacje trwające w Twojej infrastrukturze:

<img className="thumbnail" alt="Operacje" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel9.png" loading="lazy" />
...
<img className="thumbnail" alt="Licence SPLA Windows" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel10.png" loading="lazy" />
...
<img className="thumbnail" alt="Vue Datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel11.png" loading="lazy" />
...
<img className="thumbnail" alt="Magazyny danych" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel13.png" loading="lazy" />
...
Więcej informacji na temat tego rozwiązania znajdziesz w tym [przewodniku](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service).
