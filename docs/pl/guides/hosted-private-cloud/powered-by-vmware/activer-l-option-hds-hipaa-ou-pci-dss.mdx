...
- Dostęp do<ManagerLink to="/">Panelu klienta</ManagerLink>, sekcja <code className="action">Dedykowane</code>

## W praktyce

### Upewnić się, że opcja bezpieczeństwa jest aktywna.

Aby dostosować swoją chmurę prywatną do certyfikacji HDS lub PCI DSS, należy aktywować jedną z odpowiednich opcji bezpieczeństwa. Aby sprawdzić jej stan, zaloguj się do swojego <ManagerLink to="/">panelu klienta OVHcloud</ManagerLink> i przejdź do sekcji „Dedykowane”. Kliknij opcję <code className="action">Private Cloud</code>, a następnie wybierz odpowiednią usługę. 
...
<img className="thumbnail" alt="hdspcidsscompliance" src="/images/hosted-private-cloud/powered-by-vmware/activer-l-option-hds-hipaa-ou-pci-dss/HomeSDDCManager.PNG" loading="lazy" />
