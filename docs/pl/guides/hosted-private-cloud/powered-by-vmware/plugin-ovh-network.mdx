...
<img className="thumbnail" alt="Informacje o adresach IP i blokach" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_02.png" loading="lazy" />
...
:::info
Ten proces konfiguracji jest również dostępny w Twoim <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.  
