...
- Posiadanie aktywnego identyfikatora użytkownika <ManagerLink to="/">utworzonego w Panelu klienta OVHcloud</ManagerLink>
...
<img className="thumbnail" alt="VM Network - VM Network różne strefy i PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vmnetwork-vmnetwork-diff-geo-diff-pcc.png" loading="lazy" />

**Połącz 1 vRack VM Network i 1 vRack vDC w różnych strefach geograficznych w ramach usługi Hosted Private Cloud.**

<img className="thumbnail" alt="VM Network - vDC różne strefy i PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vmnetwork-vdc-diff-geo-diff-pcc.png" loading="lazy" />
...
<img className="thumbnail" alt="vDC - vDC różne strefy i PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vdc-vdc-diff-geo-diff-pcc.png" loading="lazy" />

**Połączenie 1 vRack vDC i 1 vRack vDC w ramach tej samej usługi Hosted Private Cloud.**

<img className="thumbnail" alt="vDC - vDC, nawet PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vdc-vdc-same-pcc.png" loading="lazy" />

**Wszystkie sieci vDC należące do tej samej usługi Hosted Private Cloud dzielą ten sam vRack VM Network.**

<img className="thumbnail" alt="VM Network współdzielony na PCC" src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/all-vdc-share-same-vmnetwork.png" loading="lazy" />
...
<img className="thumbnail" alt="vDC - vDC tej samej strefy i różnych PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vdc-vdc-same-zone-diff-pcc.png" loading="lazy" />
...
<img className="thumbnail" alt="VM Network - VM Network ten sam obszar i różne PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vmnetwork-vmnetwork-same-geo-diff-pcc.png" loading="lazy" />

**Połącz 1 vRack VM Network i 1 vRack vDC w tej samej strefie geograficznej w różnych rozwiązaniach Hosted Private Cloud.**

<img className="thumbnail" alt="VM Network - vDC strefa i różne PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vmnetwork-vdc-same-geo-diff-pcc.png" loading="lazy" />
...
<img className="thumbnail" alt="VM Network - vDC strefa i PCC " src="/images/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud/vmnetwork-vdc-same-geo-same-pcc.png" loading="lazy" />
