...
description: Dowiedz się, jak uruchomić SDK vSphere i jak z niego korzystać
...
Tutaj korzystamy z maszyny wirtualnej zainstalowanej w systemie Debian 9 i wdrożonej z [szablonów udostępnionych w Twojej usłudze Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
Tutaj korzystamy z maszyny wirtualnej zainstalowanej w systemie Ubuntu 18.04 i wdrożonej z [szablonów udostępnionych w Twojej usłudze Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
Po przeczytaniu warunków zaakceptuj je i kliknij <code className="action">Enter</code>, aby kontynuować.

Następnie zostaną zainstalowane pozostałe moduły. Kliknij <code className="action">Enter</code>, aby kontynuować instalację.
