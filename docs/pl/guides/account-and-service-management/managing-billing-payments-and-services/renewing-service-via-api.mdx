...
description: Dowiedz się, jak odnawiać usługi przy użyciu API OVHcloud
...
- Zalogowanie do [API OVHcloud](https://eu.api.ovh.com/)
- Utworzenie [danych identyfikacyjnych dla API OVH](/guides/manage-and-operate/api/first-steps)
