...
Możesz w każdym momencie odnaleźć Twoje zamówienie na stronie <ManagerLink to="/#/billing/orders">Moje zamówienia</ManagerLink>, jak wyjaśniono poniżej.
...
Możesz również wyświetlić zamówienie w formacie HTML, klikając <code className="action">...</code> z prawej strony Twojego zamówienia, a następnie wybierając polecenie <code className="action">Wyświetl zamówienie w formacie HTML</code>.
...
Po wygenerowaniu formularza zamówienia możesz śledzić zamówienie na stronie <ManagerLink to="/#/billing/orders">Moje zamówienia</ManagerLink>:

* Kliknij przycisk <code className="action">...</code> po prawej stronie Twojego zamówienia.
...
Jeśli kryteria kwalifikujące do prawa odstąpienia od umowy są spełnione, możesz skorzystać z prawa odstąpienia od umowy bezpośrednio na stronie <ManagerLink to="/#/billing/orders">Moje zamówienia</ManagerLink>:
