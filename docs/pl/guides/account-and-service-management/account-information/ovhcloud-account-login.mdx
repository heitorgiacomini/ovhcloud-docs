...
Przejdź <ManagerLink to="/">do strony uwierzytelniania OVHcloud</ManagerLink>, podaj identyfikator klienta (lub główny adres e-mail) i hasło.
...
Należy postępować zgodnie z tą [procedurą](https://www.ovh.pl/cgi-bin/pl/procedure/procedureChangeEmail.cgi), aby Twoja tożsamość została zweryfikowana.
