...
2. Kliknij <code className="action">File</code> na pasku menu, a następnie <code className="action">Save As</code>.
3. Na liście rozwijanej "Save as type" wybierz **Outlook Message Format - Unicode (.msg)**.
4. Wybierz lokalizację na komputerze (np. Pulpit) i kliknij <code className="action">Save</code>.
...
2. Wybierz <code className="action">Save as</code>, a następnie <code className="action">Save as EML</code>.
3. Wybierz lokalizację na komputerze i kliknij <code className="action">Save</code>.
...
2. Wybierz <code className="action">Save As</code>.
3. Wiadomość zostanie zapisana jako plik `.eml`. Wybierz lokalizację na komputerze i kliknij <code className="action">Save</code>.
...
2. Na pasku menu kliknij <code className="action">File</code> > <code className="action">Save As</code>.
3. Wybierz format **Raw Message Source**, wybierz lokalizację na komputerze i kliknij <code className="action">Save</code>.
...
3. Wybierz <code className="action">View</code> > <code className="action">View message source</code>.
...
1. Zaznacz phishingową wiadomość e-mail w skrzynce odbiorczej.
2. Kliknij <code className="action">More</code> (lub ikonę **⋮**) na pasku narzędzi.
3. Wybierz <code className="action">Download (.eml)</code>.
...
1. Zaznacz phishingową wiadomość e-mail w skrzynce odbiorczej.
2. Kliknij <code className="action">More</code> na pasku narzędzi.
3. Wybierz <code className="action">Show Original</code>. Surowa zawartość wiadomości e-mail otworzy się w nowej karcie przeglądarki.
...
3. Wybierz <code className="action">Download message</code>.
...
[Zabezpiecz swoje konto OVHcloud za pomocą uwierzytelniania dwuetapowego](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa)

[Zabezpiecz swoje konto OVHcloud i zarządzaj swoimi danymi osobowymi](/guides/account-and-service-management/account-information/all-about-username)
