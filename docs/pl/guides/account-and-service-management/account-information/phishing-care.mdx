...
description: Jak rozpoznać wiadomość e-mail typu phishing i co zrobić, jeśli klikniesz w fałszywy link?
...
Najpierw sprawdź, czy otrzymana wiadomość e-mail jest również widoczna na stronie <ManagerLink to="/#/communication">Moje wiadomości</ManagerLink>. Znajdziesz tam kopie wszystkich oficjalnych wiadomości wysłanych przez OVHcloud.
...
<img className="thumbnail" alt="Różnica między wiadomością e-mail od OVHcloud a phishingową" src="/images/account-and-service-management/account-information/phishing-care/EN-legit-and-phishing-email.png" loading="lazy" />
...
<summary>**Lista oficjalnych domen OVHcloud** (kliknij, aby wyświetlić)</summary>
...
<summary>**Wskazówki dotyczące weryfikacji podejrzanego linku** (kliknij, aby wyświetlić)</summary>
...
OVHcloud **nigdy** nie wyśle Ci linku przez SMS. Wiadomości SMS, które wysyłamy, są zazwyczaj związane z [uwierzytelnianiem dwuetapowym w Twoim Panelu klienta OVHcloud](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
<img className="thumbnail" alt="Fałszywa wiadomość SMS" src="/images/account-and-service-management/account-information/phishing-care/sms-phishing.png" loading="lazy" />
...
<summary>**Outlook dla Windows**</summary>


Istnieją dwie wersje programu Outlook dla Windows: **klasyczny Outlook** i **nowy Outlook**. Aby je rozróżnić, wpisz "Outlook" w pasku wyszukiwania systemu Windows. Klasyczna wersja wyświetla adnotację *"(klasyczny)"*, natomiast nowy Outlook nie ma specjalnego oznaczenia.

<img className="thumbnail" alt="Outlook Windows - identyfikacja wersji" src="/images/account-and-service-management/account-information/phishing-care/outlook-windows-identify01.png" loading="lazy" />

**Klasyczny Outlook:**

1. Zaznacz phishingową wiadomość e-mail w skrzynce odbiorczej (nie otwieraj jej).
2. Kliknij <code className="action">Plik</code> na pasku menu, a następnie <code className="action">Zapisz jako</code>.
3. Na liście rozwijanej "Zapisz jako" wybierz **Outlook Message Format - Unicode (.msg)**.
4. Wybierz lokalizację na komputerze (np. Pulpit) i kliknij <code className="action">Zapisz</code>.
...
2. Wybierz <code className="action">Zapisz jako</code>.
3. Wiadomość zostanie zapisana jako plik `.eml`. Wybierz lokalizację na komputerze i kliknij <code className="action">Zapisz</code>.
...
2. Na pasku menu kliknij <code className="action">Plik</code> > <code className="action">Zapisz jako</code>.
3. Wybierz format **Raw Message Source**, wybierz lokalizację na komputerze i kliknij <code className="action">Zapisz</code>.
...
3. Wybierz <code className="action">Widok</code> > <code className="action">Wyświetl źródło wiadomości</code>.
...
<summary>**Roundcube (OVHcloud Webmail)**</summary>


1. Zaznacz phishingową wiadomość e-mail w skrzynce odbiorczej.
2. Kliknij <code className="action">Więcej</code> (lub ikonę **⋮**) na pasku narzędzi.
3. Wybierz <code className="action">Pobierz (.eml)</code>.
...
<summary>**Zimbra (OVHcloud Webmail)**</summary>


1. Zaznacz phishingową wiadomość e-mail w skrzynce odbiorczej.
2. Kliknij <code className="action">Więcej</code> na pasku narzędzi.
3. Wybierz <code className="action">Pokaż oryginał</code>. Surowa zawartość wiadomości e-mail otworzy się w nowej karcie przeglądarki.
...
3. Wybierz <code className="action">Pobierz wiadomość</code>.
...
<summary>**Jeśli podałeś(-aś) numer swojej karty kredytowej na fałszywej stronie internetowej**</summary>
...
<summary>**Jeśli podałeś(-aś) swoje hasło OVHcloud na fałszywej stronie internetowej**</summary>


Przejdź na stronę <ManagerLink to="/#/account/useraccount/security">Bezpieczeństwo</ManagerLink> i zmień hasło.

W naszym przewodniku [Zmiana hasła do konta](/guides/account-and-service-management/account-information/manage-ovh-password) znajdziesz instrukcje zmiany hasła za pomocą Panelu klienta OVHcloud, a także nasze zalecenia dotyczące generowania silnego hasła i zapisywania go w menedżerze haseł.

Zdecydowanie zalecamy włączenie [uwierzytelniania dwuetapowego](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) w celu trwałego zabezpieczenia konta.
...
[Ustawianie i zarządzanie hasłem do konta](/guides/account-and-service-management/account-information/manage-ovh-password)

[Zabezpieczanie konta OVHcloud za pomocą uwierzytelniania dwuetapowego](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa)

[Zabezpieczanie konta OVHcloud i zarządzanie danymi osobowymi](/guides/account-and-service-management/account-information/all-about-username)
