...
Na stronie <ManagerLink to="/#/account/useraccount/security">Bezpieczeństwo konta</ManagerLink> kliknij <code className="action">Włącz weryfikację dwuetapową</code>.
...
Przejdź do <ManagerLink to="/">strony uwierzytelniania w Panelu klienta OVHcloud</ManagerLink> i wpisz swój identyfikator (lub główny adres e-mail) oraz hasło.
...
Aby usunąć urządzenie, przejdź na stronę <ManagerLink to="/#/account/useraccount/security">Bezpieczeństwo konta</ManagerLink> i kliknij <code className="action">...</code> po prawej stronie Twojego urządzenia do usunięcia, a następnie wybierz <code className="action">Usuń</code>.
...
Najpierw przejdź do <ManagerLink to="/">strony uwierzytelniania w Panelu klienta OVHcloud</ManagerLink>.
