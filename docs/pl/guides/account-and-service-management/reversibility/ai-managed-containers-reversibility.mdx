...
| **Function** | **Description** | **Available formats** | **Migration model** | **Available documentation** |
| --- | --- | --- | --- | --- |
| Infrastructure as a Code | Automated deployment via Terraform modules specific to OVHcloud | NA | **Inbound**: Adapt scripts <br />

**Outbound**: Rewrite Terraform configurations required | [Terraform](https://registry.terraform.io/providers/ovh/ovh/latest/docs) |
