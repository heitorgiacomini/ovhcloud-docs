...
- Consult the guide [First steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) to familiarize yourself with the use of OVHcloud APIv6.
...
<Api version="v1" section="/ipLoadbalancing" method="GET" route={"/ipLoadbalancing/\\{serviceName\\}/vrack/network/\\{vrackNetworkId\\}"} />
<Api version="v1" section="/ipLoadbalancing" method="PUT" route={"/ipLoadbalancing/\\{serviceName\\}/vrack/network/\\{vrackNetworkId\\}"} />
