...
You can order an additional zone from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. In the <code className="action">Network</code> section, under <code className="action">Network services</code>, click on <code className="action">Load Balancer</code>.
