...
![IPv4 output address of your OVHcloud Load Balancer service](/images/guides/network/load-balancer/create-headers/iplb_service.png)
...
### Correcting the source IP in the logs <a id="ip-source-logs"></a>
...
![Configuration of HTTP headers of a Frontend via ovh manager API](/images/guides/network/load-balancer/create-headers/add_headers.png)

Click on the `Update` button after configuring the headers, then on `Deploy zone: YOUR ZONE` to apply the changes in the concerned zone.
...
![Configuration of HTTP headers of a Frontend](/images/guides/network/load-balancer/create-headers/add_headers_with_api.png)
