...
description: Dowiedz się, jak zarządzać limitem transferu w usłudze CDN
...
Jeśli potrzebujesz dodatkowego transferu, możesz zamówić go bezpośrednio w <ManagerLink to="/">Panelu klienta</ManagerLink>:

<img className="thumbnail" alt="Dodatnie limitu transferu" src="/images/network/content-delivery-network-infrastructure/quota/add_quota.png" loading="lazy" />

Zapoznaj się z cennikiem pakietów transferu na [stronie WWW OVH](https://www.ovhcloud.com/pl/network/cdn/).
...
<img className="thumbnail" alt="Zużycie limitu transferu" src="/images/network/content-delivery-network-infrastructure/quota/quota_used.png" loading="lazy" />
