...
description: Find out how to resolve the most common errors associated with setting up OVHcloud Connect
...
For more information, please read the [technical capabilities and limitations of the OVHcloud Connect solution](/guides/network/ovhcloud-connect/occ-limits)
