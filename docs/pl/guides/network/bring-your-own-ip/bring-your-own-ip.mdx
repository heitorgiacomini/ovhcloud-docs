...
The [Bring Your Own IP (BYOIP)](https://www.ovhcloud.com/pl/network/byoip/) feature allows you to use IP addresses ranges that you already own, as Additional IPs directly on the OVHcloud network and products.

These IP addresses will be imported in the form of a /24 IP block size and will behave like a regular OVHcloud [Additional IP](https://www.ovhcloud.com/pl/bare-metal/ip/) block product.
...
To choose a region, please refer to the list of available regions accessible on [this page](https://www.ovhcloud.com/pl/network/byoip/).
