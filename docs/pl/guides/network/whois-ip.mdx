...
description: Dowiedz się, jak ustalić, czy adres IP jest zarządzany, dostarczany i/lub przypisany do usługi OVHcloud za pośrednictwem strony ICANN
...
Po wpisaniu adresu IP kliknij niebieski przycisk <code className="action">Lookup</code>.
