...
:::warning
Jeśli korzystasz z rozwiązania "Web Cloud Databases"/"Prywatny SQL", pamiętaj, aby autoryzować swój adres IP, korzystając z przewodnika dotyczącego [konfiguracji serwera bazy danych](/guides/web-cloud/databases/db-configure-optimise-database-server#gerer-vos-acces).
