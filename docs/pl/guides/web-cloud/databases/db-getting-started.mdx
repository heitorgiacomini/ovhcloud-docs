...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/hosting">Hosting</ManagerLink>, następnie wybierz odpowiedni hosting WWW.
...
Jeśli chcesz zmienić uprawnienia istniejącego użytkownika, zapoznaj się z przewodnikiem "[Web Cloud Databases - Zmiana uprawnień użytkownika](/guides/web-cloud/databases/db-modify-users-rights)".
...
Aby zaimportować bazę danych, zapoznaj się z przewodnikiem "[Przywracanie i importowanie bazy danych na serwer baz danych](/guides/web-cloud/databases/db-restore-import-database)".
...
W tym celu zapoznaj się z przypadkami szczególnymi w przewodniku "[Web Cloud Databases - Jak autoryzować adres IP?](/guides/web-cloud/databases/db-authorise-ip-mask)", aby włączyć lub wyłączyć dostęp hostingów WWW OVHcloud do Web Cloud Databases.
...
Aby uzyskać dostęp do logów rozwiązania Web Cloud Databases, zapoznaj się z przewodnikiem "[Web Cloud Databases - Jak pobrać logi?](/guides/web-cloud/databases/db-retrieve-logs)".

## Sprawdź również

[Tworzenie baz danych i użytkowników na serwerze baz danych](/guides/web-cloud/databases/db-create-databases-users)

[Logowanie do bazy danych serwera baz danych](/guides/web-cloud/databases/db-connecting-database-server)

[Tworzenie kopii zapasowej i eksport bazy danych na serwerze baz danych](/guides/web-cloud/databases/db-backup-export-database-server)

[Przywracanie i importowanie bazy danych na serwer baz danych](/guides/web-cloud/databases/db-restore-import-database)
