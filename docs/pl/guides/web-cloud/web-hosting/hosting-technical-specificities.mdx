...
description: Zapoznaj się z różnego rodzaju informacjami technicznymi dotyczącymi hostingu WWW
...
- Posiadanie kompatybilnego [hostingu WWW](https://www.ovhcloud.com/pl/web-hosting/)
...
- Jeśli napotkasz błąd dostępu "Uwierzytelnienie połączenia 530 się nie powiodło" podczas logowania do przestrzeni dyskowej FTP: Upewnij się, że informacje dotyczące dostępu do przestrzeni FTP są poprawne. W tym celu zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i przejdź do sekcji <code className="action">Web Cloud</code>. W lewej kolumnie kliknij <code className="action">Hosting</code>, a następnie wybierz odpowiedni hosting. Na stronie, która się wyświetli kliknij zakładkę <code className="action">FTP - SSH</code>.
...
Więcej informacji na ten temat znajdziesz w naszym przewodniku "[Logowanie do przestrzeni dyskowej FTP hostingu WWW](/guides/web-cloud/web-hosting/ftp-connection)".
...
|Oferty|Darmowy hosting|Starter|Perso|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|---|
|Maksymalna liczba wysyłanych wiadomości na godzinę i na usługę|10|20|100|100|200|2000|2000|2000|2000|

</Region>

<Region zones={['ca', 'apac']}>

|Oferty|Starter|Perso|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|
|Maksymalna liczba wysyłanych wiadomości na godzinę i na usługę|20|100|100|200|2000|2000|2000|2000|
...
- [Monitorowanie i zarządzanie automatycznymi wiadomościami e-mail na Twoim hostingu](/guides/web-cloud/web-hosting/mail-function-script-records);
- [Przykłady zastosowania - Porady w związku z włamaniem na Twojej stronie WWW](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked).
...
Aby uzyskać więcej informacji, zapoznaj się ze szczegółami naszych [ofert hostingu WWW](https://www.ovhcloud.com/pl/web-hosting/) oraz przewodnikiem "[Pierwsze kroki z Twoją ofertą Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)".
...
Tylko serwery baz danych [Web Cloud Databases](https://www.ovhcloud.com/pl/web-cloud/databases/) umożliwiają łączenie się z nimi serwerom zewnętrznym. Autoryzacja adresu IP zewnętrznego serwera na serwerze baz danych. W razie potrzeby sprawdź przewodnik "[Pierwsze kroki z usługą Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)".
...
Aby uzyskać więcej informacji na temat zarządzania bazami danych i łączenia się z interfejsem *phpMyAdmin*, zapoznaj się z przewodnikiem "[Tworzenie bazy danych na hostingu www OVHcloud](/guides/web-cloud/web-hosting/sql-create-database)".
...
Więcej szczegółów na ten temat znajdziesz w przewodniku "[Hosting WWW: środowisko, wersja PHP, ".ovhconfig"](/guides/web-cloud/web-hosting/configure-your-web-hosting)"
...
Po zalogowaniu się do hostingu przez SSH ruch wychodzący zostanie zablokowany ze względów bezpieczeństwa. Zalecamy więc korzystanie ze skryptów PHP. Aby uzyskać więcej informacji, zapoznaj się z [przewodnikiem SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting). Instrukcja "[PHP manual](https://www.php.net/manual/en/function.system.php)" zawiera informacje dotyczące wykonywania poleceń.
...
Znajdź i sprawdź biblioteki, języki i wersje dostępne dla Twojego hostingu na tej stronie: [https://webhosting-infos.hosting.ovh.net](https://webhosting-infos.hosting.ovh.net)

<Region zones={['eu']}>
Aby zapoznać się ze szczegółami technicznymi usługi Cloud Web, przejdź na stronę: [https://cloudweb-infos.hosting.ovh.net/](https://cloudweb-infos.hosting.ovh.net/).
</Region>
...
Dowiedz się, jak [zalogować się do przestrzeni dyskowej FTP Twojego hostingu](/guides/web-cloud/web-hosting/ftp-connection) lub [przywrócić przestrzeń dyskową FTP Twojego hostingu](/guides/web-cloud/web-hosting/ftp-save-and-backup) w naszej dokumentacji.
...
W przypadku baz danych współdzielonych (zawartych w Twojej ofercie hostingu WWW) lub serwerów baz danych (Web Cloud Databases), oferowanych w Gravelines (GRA), we Francji i Beauharnois (BHS) w Kanadzie, tworzenie kopii zapasowych baz jest wykonywane codziennie. Kopie zapasowe są dostępne (w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> lub [API OVHcloud](https://eu.api.ovh.com/)). Kopie zapasowe są również przechowywane na innej infrastrukturze. Dane są kopiowane w centrum danych zlokalizowanym w Strasburgu (SBG). Czas przechowywania kopii zapasowych to 30 dni.

Dowiedz się, jak [Pobrać kopię zapasową bazy danych hostingu WWW](/guides/web-cloud/web-hosting/sql-database-export) znaleźć w naszej dokumentacji.
...
[Przywracanie przestrzeni dyskowej FTP na hostingu WWW](/guides/web-cloud/web-hosting/ftp-save-and-backup)
