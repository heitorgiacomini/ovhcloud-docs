...
<Region zones={['eu']}>
- Posiadanie [hostingu WWW](https://www.ovhcloud.com/pl/web-hosting/) (poza ofertami "Hosting darmowy" i "Start 10M").
</Region>
