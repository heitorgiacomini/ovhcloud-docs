...
:::tip
Aby zainstalować moduł WordPress **automatycznie** z poziomu <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, zapoznaj się z naszą dokumentacją dotyczącą [instalacji modułu za pomocą jednego kliknięcia](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
...
- *Database Name*: nazwa ta została zdefiniowana podczas tworzenia bazy danych w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
