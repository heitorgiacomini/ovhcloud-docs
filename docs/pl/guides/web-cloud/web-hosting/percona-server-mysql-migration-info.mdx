...
description: Poznaj zalety migracji z MySQL na Percona Server dla MySQL
...
- Posiadanie [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/) z powiązaną współdzieloną bazą danych OVHcloud (MySQL).
