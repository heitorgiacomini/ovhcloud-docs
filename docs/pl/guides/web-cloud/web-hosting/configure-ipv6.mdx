...
Aby sprawdzić, czy Twoja strona WWW używa już adresu IPv6, użyj strony [test-ipv6.run](https://test-ipv6.run/domain-checker). Dowiedz się, czy Twoja strona WWW odpowiada na ten nowy protokół IP. Jeśli tak nie jest, przejdź do opisu w naszym przewodniku.
