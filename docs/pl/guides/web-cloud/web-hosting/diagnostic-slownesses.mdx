...
description: Dowiedz się, skąd pochodzą opóźnienia Twojej strony WWW i jak je rozwiązać
...
Aby poznać klaster i filer, w których znajduje się Twoje hostingowanie współdzielone, zapoznaj się z naszym przewodnikiem "[Hosting www - Poznaj klaster i syn](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer)".
...
Umieść w katalogu głównym Twojej strony WWW[przestrzeń dyskowa FTP Twojego hostingu](/guides/web-cloud/web-hosting/ftp-connection) plik, który nazwiesz `phpinfo.php`.
...
Zaloguj się do bazy danych, postępując zgodnie z **etap 3** w przewodniku [dotyczącym tworzenia wspólnej bazy danych](/guides/web-cloud/web-hosting/sql-create-database).

Jeśli korzystasz z bazy danych w ofercie **Web Cloud Databases**, zapoznaj się z naszym przewodnikiem [dotyczącym połączenia z bazą danych w usłudze Web Cloud Databases](/guides/web-cloud/databases/db-connecting-database-server).
...
:::warning
Jeśli wystąpi błąd, zapoznaj się z naszą dokumentacją dotyczącą [błędów występujących w bazie danych](/guides/web-cloud/web-hosting/diagnosis-database-errors). Następnie skorzystaj z powyższego przewodnika, aby poprawić Twoją sytuację, po czym spróbuj ponownie zalogować się do bazy danych.
...
Sprawdź framework PHP, wersję PHP i środowisko wykonawcze używane na Twoim hostingu. Zapoznaj się z naszym przewodnikiem dotyczącym [konfiguracji Twojego hostingu](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Aby porównać dostępne wersje PHP w zależności od używanego środowiska uruchomieniowego, sprawdź **etap 2** w przewodniku dotyczącym [konfiguracji wersji PHP na Twoim hostingu](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Aby przeanalizować połączenia wychodzące z Twojego hostingu, sprawdź logi **OUT** tego hostingu. Zapoznaj się z naszą dokumentacją dotyczącą [sprawdzanie logów hostingu](/guides/web-cloud/web-hosting/logs-and-statistics).
...
Aby przeprowadzić tę operację, zapoznaj się z logami **WEB** Twojego hostingu w dokumentacji dotyczącej hostingu [sprawdź logi](/guides/web-cloud/web-hosting/logs-and-statistics).
...
<img className="thumbnail" alt="Analiza sieci Firefox" src="/images/assets/screens/other/browsers/diagnostic-tools/F12.png" loading="lazy" />
:::
...
:::info
OVHcloud oferuje kilka [oferty CDN](https://www.ovhcloud.com/pl/web-hosting/options/). Jeśli chcesz korzystać z tej usługi lub ją włączyć dla Twojego hostingu, zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, a następnie zapoznaj się z naszym przewodnikiem dotyczącym [korzystania z usługi CDN OVHcloud](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
...
Zapoznaj się z naszym przewodnikiem dotyczącym [optymalizacji wydajności dla Twojej strony internetowej](/guides/web-cloud/web-hosting/optimise-your-website-performance).
