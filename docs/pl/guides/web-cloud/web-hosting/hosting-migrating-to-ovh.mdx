...
Zamówienie możesz również złożyć w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. Po zalogowaniu wykonaj następujące instrukcje:
