...
:::warning
Przed zmianą hasła do bazy danych na Twojej stronie WWW z poziomu <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, zaktualizuj plik konfiguracyjny Twojej strony WWW, aby połączył się z bazą danych za pomocą nowego hasła.
