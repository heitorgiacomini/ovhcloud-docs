...
- Logowanie przez SSH do hostingu (zapoznaj się z naszym przewodnikiem [Korzystanie z dostępu SSH do hostingu](/guides/web-cloud/web-hosting/ssh-on-webhosting)

## W praktyce

### Tworzenie zgłoszenia

Po zalogowaniu się przez [SSH na Twoim hostingu](/guides/web-cloud/web-hosting/ssh-on-webhosting) utwórz katalog główny depozytów SVN, a następnie wpłata.
...
Zapoznaj się z przewodnikiem [Tworzenie kluczy SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys#create-ssh-key).
...
Informacje te znajdziesz również w przewodniku [Korzystanie z dostępu SSH do hostingu](/guides/web-cloud/web-hosting/ssh-on-webhosting).
:::
