...
Przejdź do Panelu <ManagerLink to="/">klienta OVHcloud</ManagerLink>. Kliknij kartę <code className="action">Web Cloud</code>, a następnie <code className="action">Hosting</code>.
