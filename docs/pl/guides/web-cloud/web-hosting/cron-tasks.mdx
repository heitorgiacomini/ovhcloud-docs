...
<Tabs>
  ...
  <Tab label="Krok 2">
    ...
    Aby utworzyć zadanie CRON, kliknij przycisk <code className="action">Dodaj zadanie</code> po prawej stronie.
  </Tab>
  <Tab label="Krok 3">
  ...
  <Tab label="Krok 5">
    Podsumowanie zawiera informacje o skonfigurowanych parametrach, w tym notację *crontab* częstotliwości wykonywania. Jeśli wszystko jest poprawne, kliknij <code className="action">Zatwierdź</code>.
...
W logach twojego hostingu WWW, które są dostępne w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, zobaczysz kategorię logów zatytułowaną "CRON".
