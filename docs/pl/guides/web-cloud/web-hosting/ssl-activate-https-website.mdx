...
description: Dowiedz się, jak aktywować certyfikat SSL na Twojej stronie WWW poprzez HTTPS
...
- Posiadanie [certyfikatu SSL](https://www.ovhcloud.com/pl/web-hosting/options/ssl/) zainstalowanego na [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/).
...
Aby aktywować certyfikat SSL na Twoim hostingu lub sprawdzić, czy certyfikat SSL jest już zainstalowany na Twojej stronie WWW, zapoznaj się z naszym przewodnikiem: "[Zarządzanie certyfikatem SSL na Twoim hostingu](/guides/web-cloud/web-hosting/ssl-on-webhosting)".
...
Gdy tylko nazwa domeny posiada [aktywny certyfikat SSL za pośrednictwem hostingu](/guides/web-cloud/web-hosting/ssl-on-webhosting) i strona internetowa jest gotowa do przełączenia na *HTTPS*, można to zrobić.

:::warning
Przed rozpoczęciem jakichkolwiek działań zalecamy wykonanie pełnej kopii zapasowej Twojej strony WWW. Kopia zapasowa powinna zawierać nie tylko pliki obecne na [przestrzeni dyskowej FTP](/guides/web-cloud/web-hosting/ftp-save-and-backup), ale także pliki [bazy danych](/guides/web-cloud/web-hosting/sql-database-export), jeśli strona internetowa używa bazy.
...
[Zarządzanie certyfikatem SSL na Twoim hostingu](/guides/web-cloud/web-hosting/ssl-on-webhosting)
