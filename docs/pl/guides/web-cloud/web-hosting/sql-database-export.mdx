...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/hosting">Hosting</ManagerLink> i wybierz odpowiedni hosting WWW.
...
<Tabs>
  ...
  <Tab label="Krok 3">
    Kliknij przycisk <code className="action">...</code> po prawej stronie bazy danych, którą chcesz skopiować, a następnie kliknij <code className="action">Utwórz kopię zapasową</code>.
...
<Tabs>
  ...
  <Tab label="Krok 3">
    Kliknij przycisk <code className="action">...</code> po prawej stronie odpowiedniej bazy danych, a następnie kliknij <code className="action">Przywróć kopię zapasową</code>.
  ...
  <Tab label="Krok 4">
    Aby pobrać kopię zapasową, kliknij przycisk <code className="action">...</code> po prawej stronie kopii, którą chcesz pobrać, a następnie kliknij <code className="action">Pobierz kopię zapasową</code>. Zaakceptuj, po czym odczekaj, aż kopia zapasowa zostanie pobrana.
...
<Tabs>
  ...
  <Tab label="Krok 3">
    Kliknij przycisk <code className="action">...</code> po prawej stronie odpowiedniej bazy danych, a następnie <code className="action">Dostęp do phpMyAdmin</code>.
