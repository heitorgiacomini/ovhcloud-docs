...
<Region zones={['eu']}>
- Posiadanie oferty [hostingu](https://www.ovhcloud.com/pl/web-hosting/) (nie dotyczy hostingu Cloud Web).
</Region>
...
- Status "konserwacji" pojawia się w Twoim <ManagerLink to="/#/web/hosting">Panelu klienta OVHcloud</ManagerLink>.
...
Możesz odnaleźć te informacje w naszym przewodniku ["Logowanie do przestrzeni dyskowej FTP hostingu"](/guides/web-cloud/web-hosting/ftp-connection).
