...
description: Dowiedz się, jak zmienić hasło administratora Twojego CMS bezpośrednio w interfejsie zarządzania CMS lub za pomocą narzędzia phpMyAdmin w Panelu klienta OVHcloud
...
- Posiadanie [hostingu WWW](https://www.ovhcloud.com/pl/web-hosting/) umożliwiającego instalację modułu za pomocą 1 kliknięcia.
- Utworzenie modułu za pomocą 1 kliknięcia na Twoim hostingu (jeśli jeszcze tego nie przeprowadziłeś, postępuj zgodnie z instrukcjami zawartymi w tym [przewodniku](/guides/web-cloud/web-hosting/cms-install-1-click-modules)).
...
Nie masz dostępu do interfejsu administracyjnego CMS lub nie możesz użyć funkcji "Nie pamiętasz hasła", ponieważ powiązany adres e-mail jest niedostępny? Użyj narzędzia phpMyAdmin w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, aby zresetować hasło bezpośrednio z bazy danych.

Zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i wybierz opcję <code className="action">Web Cloud</code>. Kliknij pozycję <code className="action">Hosting</code> i wybierz odpowiednią ofertę. W zakładce <code className="action">Bazy danych</code> znajdź bazę danych używaną przez Twój CMS, kliknij przycisk <code className="action">...</code>, a następnie <code className="action">Dostęp do phpMyAdmin</code>.
