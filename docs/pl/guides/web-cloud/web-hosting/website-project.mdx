...
<Tabs>
  <Tab label="Skorzystaj z oferty CMS">
    ...
    Po zalogowaniu się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i za pomocą hostingu możesz szybko zainstalować systemy CMS *WordPress*, *Joomla!*, *PrestaShop* i *Drupal*.
...
- Jeśli nie przypisałeś domeny podczas zamawiania hostingu i chcesz skorzystać z opcji "adres(y) e-mail zawarty(e) w twoim hostingu", przeprowadź tę operację ręcznie w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
...
Aby sprawdzić i/lub zmienić powiązanie między Twoją domeną a stroną internetową znajdującą się na Twoim hostingu, **skorzystaj z poniższych przewodników w kolejności:**
...
- [Jak przypisać domenę do istniejącej strony internetowej?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website): Ten przewodnik wyjaśnia, jak dodać domenę do strony internetowej znajdującej się na Twoim hostingu. Może również pomóc w sprawdzeniu, czy deklaracja Twojej domeny na stronie internetowej znajdującej się na Twoim hostingu jest poprawna. W razie potrzeby możesz ją zmienić i następnie dokonać odpowiednich zmian na aktywnej strefie DNS Twojej domeny.
...
- **W celu powiązania Twojej domeny z Twoim hostingu:** Skorzystaj wyłącznie z przewodników "[Lista adresów IP klastrów i hostingów WWW](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip)" i "[Jak przypisać domenę do istniejącej strony internetowej?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website)" wymienionych powyżej, aby uzyskać adres IP Twojego hostingu, a następnie poprawnie zadeklarować Twoją domenę na stronie internetowej znajdującej się na Twoim hostingu. Następnie skontaktuj się z organizacją zarządzającą aktywną strefą DNS Twojej domeny, aby skierować ją do Twojego hostingu.
