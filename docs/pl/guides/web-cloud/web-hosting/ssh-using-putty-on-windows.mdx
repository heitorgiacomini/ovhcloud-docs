...
Będzie Ci potrzebna nazwa klastra Twojego hostingu WWW znajdująca się w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> oraz nazwa użytkownika FTP i hasło. Więcej informacji na temat tej metody dostępu można znaleźć w [przewodniku](/guides/web-cloud/web-hosting/ftp-connection).
...
Będzie Ci potrzebny adres IP Twojego serwera, który znajdziesz w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> oraz nazwa konta użytkownika, którego chcesz użyć podczas tej sesji logowania. Zapoznaj się z naszymi przewodnikami "Pierwsze kroki", jeśli chcesz otrzymać więcej informacji:
...
- [Jak zastąpić parę kluczy SSH w instancji Public Cloud](/guides/public-cloud/compute/replacing-lost-ssh-key-pair)
...
[Jak tworzyć klucze SSH przy użyciu OpenSSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Jak tworzyć klucze SSH za pomocą OpenSSH dla instancji Public Cloud](/guides/public-cloud/compute/creating-ssh-keys)
