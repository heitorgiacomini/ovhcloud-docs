...
1. Zaloguj się do swojego <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, przejdź do <code className="action">Web Cloud</code> i kliknij swój hosting webowy.
