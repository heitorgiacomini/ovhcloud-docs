...
:::info
Po kliknięciu przycisku <code className="action">Zatwierdź</code> utworzenie bazy danych może potrwać do **15 minut**. Odśwież stronę internetową <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, jeśli baza danych nie wyświetla się automatycznie w tabeli zawierającej listę Twoich baz danych.
