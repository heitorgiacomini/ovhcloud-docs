...
- Domena (wraz z subdomeną, jeśli jest potrzebna), która zostanie użyta na Twojej stronie WWW powinna zostać zadeklarowana jako [MultiSite](/guides/web-cloud/web-hosting/multisites-configure-multisite) na Twoim hostingu OVHcloud.
...
Zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i wybierz <code className="action">Web Cloud</code>. Kliknij przycisk <code className="action">Hosting</code>, wybierz ofertę hostingu, na której chcesz zainstalować "moduł za 1 kliknięciem", następnie kliknij zakładkę <code className="action">Moduły CMS</code>.
...
W zakładce <code className="action">Moduły CMS</code> Twojego hostingu kliknij przycisk <code className="action">Dodaj moduł CMS</code>, aby dodać nowy "moduł za 1 kliknięciem".
...
Jeśli Twoja domena nie jest na liście, przejdź do zakładki <code className="action">MultiSite</code>, aby ją dodać. Zapoznaj się z naszym przewodnikiem [Jak rozdzielić hosting WWW na kilka stron](/guides/web-cloud/web-hosting/multisites-configure-multisite), jeśli potrzebujesz.
...
Aby przeprowadzić tę metodę instalacji, upewnij się, że pole <code className="action">Instalacja w trybie zaawansowanym</code> jest zaznaczone, następnie kliknij przycisk <code className="action">Dalej</code>:

W celu przeprowadzenia tej instalacji upewnij się, że pole wyboru <code className="action">Instalacja w trybie zaawansowanym</code> jest zaznaczone, po czym kliknij przycisk <code className="action">Dalej</code>:
...
Dane do logowania do bazy danych zawartej w pakiecie hostingowym znajdziesz w [przewodniku](/guides/web-cloud/web-hosting/sql-create-database).

Dane do logowania do bazy danych utworzonej na instancji Web Cloud Databases znajdują się w [przewodniku](/guides/web-cloud/databases/db-getting-started).
...
- *Port*: systematycznie wpisz numer **3306** (port domyślny) dla bazy danych zawartej w Twoim hostingu. W przypadku bazy danych na instancji Cloud Databases, zapoznaj się z [tym przewodnikiem](/guides/web-cloud/databases/db-getting-started).

- *Nazwa użytkownika*: nazwa bazy danych jest identyczna, jeśli korzystasz z bazy danych zawartej w Twoim hostingu.
W przypadku baz danych utworzonych w ramach usługi Web Cloud Databases, zapoznaj się z informacjami podanymi w [tym przewodniku](/guides/web-cloud/databases/db-getting-started).
...
- *domena:* domena, z którą chcesz zainstalować CMS-a. Jeśli potrzebujesz pomocy, zapoznaj się z naszym przewodnikiem [Jak rozdzielić swój hosting na kilka stron](/guides/web-cloud/web-hosting/multisites-configure-multisite).
...
[Porównanie rozwiązań CMS](https://www.ovhcloud.com/pl/web-hosting/uc-cms-comparison/).
...
Poznaj ofertę [Cloud Databases](https://www.ovhcloud.com/pl/web-cloud/databases/).
