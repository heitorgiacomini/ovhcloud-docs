...
<Tabs>
  ...
  <Tab label="Krok 2">
    Na stronie, która się wyświetli, znajdź sekcję **Opcja CDN**. Kliknij <code className="action">...</code> po prawej stronie, a następnie <code className="action">Zamów CDN</code> lub <code className="action">Włącz opcję</code>, jeśli opcja CDN jest już zawarta w Twoim hostingu.
...
<Tabs>
  ...
  <Tab label="Krok 3">
    ...
    Następnie kliknij przycisk <code className="action">⁝</code> po prawej stronie nazwy domeny lub poddomeny, a następnie kliknij <code className="action">Aktywuj CDN</code>.

    <img className="thumbnail" alt="Opcje przypisanych domen" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/my-websites/associated-domains-options-cdn-disabled.png" loading="lazy" />
  </Tab>
  <Tab label="Krok 4">
    W otwartej się karcie kliknij przycisk <code className="action">Zatwierdź</code>, aby włączyć CDN.

    <img className="thumbnail" alt="GeoCache" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/my-websites/cdn-activation.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Krok 3">
    ...
    Następnie kliknij przycisk <code className="action">⁝</code> po prawej stronie nazwy domeny lub poddomeny, a następnie kliknij <code className="action">Opróżnij CDN</code>.
...
<Tabs>
  ...
  <Tab label="Krok 3">
    ...
    Następnie kliknij przycisk <code className="action">⁝</code> po prawej stronie nazwy domeny lub poddomeny, a następnie kliknij <code className="action">Zmień CDN</code>.
...
<Tabs>
  ...
  <Tab label="Krok 4">
    ...
    - **Czyszczenie zaawansowane**: Spersonalizuj wyczyszczenie, wybierając elementy pamięci cache, które chcesz opróżnić: cała strona, folder, URI, rozszerzenie plików lub za pomocą regularnych ustawień. 
       ...
       W zakładce <code className="action">Moje strony</code> kliknij przycisk <code className="action">⁝</code> obok nazwy domeny lub poddomeny, a następnie kliknij <code className="action">Opróżnij CDN</code>. 
...
Zmiana ta jest wykonywana automatycznie, jeśli aktywna strefa DNS Twojej domeny jest zarządzana również z poziomu <ManagerLink to="/">konto OVHcloud</ManagerLink> zawierającego Twój hosting.
...
<Tabs>
  ...
  <Tab label="Krok 2">
    Znajdź sekcję **Opcja CDN**. Kliknij <code className="action">...</code> po prawej stronie, a następnie <code className="action">Rezygnacja z GeoCache</code>.
