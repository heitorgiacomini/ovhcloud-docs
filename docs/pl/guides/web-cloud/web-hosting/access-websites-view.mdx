...
Zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, a następnie przejdź do sekcji <code className="action">Web Cloud</code>. W lewym menu kliknij <code className="action">Strony WWW</code>. Pojawi się tabela z listą wszystkich Twoich stron WWW i ich głównymi informacjami.
