...
Jeśli osiągnąłeś już maksymalną liczbę baz danych dozwoloną w Twoim [hostingu](https://www.ovhcloud.com/pl/web-hosting/), usuń bazę danych zidentyfikowaną w [etapie 1](#step1) **PRZED** utworzeniem nowego modułu za pomocą 1 kliknięcia.
