...
:::info
Jeśli po wykonaniu tej operacji Twoja strona WWW nie wyświetla się poprawnie, zapoznaj się z przewodnikami OVHcloud dotyczącymi hostingu współdzielonego w sekcji [Diagnostyka](/guides/web-cloud/web-hosting/landing-page-web-hosting).
...
<Tabs>
  ...
  <Tab label="Krok 3">
    W przeciwnym razie przejdź do karty <code className="action">Moje strony</code>. Zanotuj nazwę `Katalog główny` widoczną w wierszu odpowiedniego serwisu internetowego: jest to katalog, w którym znajdują się pliki tworzące Twój moduł za 1 kliknięciem na serwerze FTP.
  </Tab>
</Tabs>

Zaloguj się do [przestrzeni FTP Twojego hostingu](/guides/web-cloud/web-hosting/ftp-connection). Otwórz `Katalog główny` znajdujący się w zakładce <code className="action">Moje strony</code> i wyszukaj plik konfiguracyjny Twojego modułu:
