...
description: Dowiedz się, jak uniknąć typowych błędów dotyczących zabezpieczania strony WWW za pomocą certyfikatu SSL
...
:::info
Niektóre strony WWW korzystają z sieci [Content Delivery Network (CDN)](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn) do hostowania na przykład bibliotek *Javascript* (takich jak *JQuery*). 
