...
description: Dowiedz się, jak zmienić adres URL dostępu do Twojej strony za pomocą mod_rewrite za pomocą pliku .htaccess
...
Aby edytować (lub utworzyć) katalogi, zaloguj się do przestrzeni FTP Twojego hostingu. W razie potrzeby skorzystaj z przewodnika "[Dostęp do przestrzeni dyskowej](/guides/web-cloud/web-hosting/ftp-connection)".
...
Zapoznaj się z naszym przewodnikiem dotyczącym [konfiguracji strony podpiętej w opcji MultiSite na hostingu](/guides/web-cloud/web-hosting/multisites-configure-multisite), jeśli chcesz uzyskać więcej informacji na ten temat.
...
Jeśli nie posiadasz certyfikatu SSL, zapoznaj się z naszym przewodnikiem dotyczącym [zarządzania certyfikatem SSL na hostingu OVHcloud](/guides/web-cloud/web-hosting/ssl-on-webhosting).
...
[Zablokować dostęp do mojej strony www dla niektórych adresów IP przez plik .htaccess](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website)
