...
:::info
Tylko hosting WWW **Pro**, **Performance**, **Agency**, **Agency Plus** lub **Agency Max** umożliwia aktywację kilku użytkowników FTP i połączenie przez SSH.
...
:::info
Dane te otrzymasz w wiadomości e-mail potwierdzającej instalację hostingu podczas jego rejestracji. Są one dostępne w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
...
Do tego dostępu konieczne są zaawansowane umiejętności techniczne oraz oferta [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/) **Pro**, **Performance**, **Agency**, **Agency Plus** lub **Agency Max**.
