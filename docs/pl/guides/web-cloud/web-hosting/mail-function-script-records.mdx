...
:::info
Niniejszy przewodnik dotyczy głównie wiadomości e-mail wysyłanych ze skryptów zlokalizowanych na Twoim [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/) przy użyciu funkcji "mail()" PHP.

Jeśli chcesz zarządzać kontami e-mail zawartymi w Twojej ofercie MX Plan lub w ofercie [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/), zapoznaj się z naszą dokumentacją dotyczącą [E-maili współdzielonych - MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/overview).
:::
...
<Tabs>
  ...
  <Tab label="Krok 3">
    Na tej stronie możesz monitorować i zarządzać automatycznymi wiadomościami e-mail wysyłanymi z Twojego [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/).
    
    <img className="thumbnail" alt="Strona Skrypty e-mail hostingu" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/email-scripts/tab.png" loading="lazy" />
    ...
    Aby wykonać pożądaną akcję, kliknij odpowiedni przycisk, a następnie <code className="action">Zatwierdź</code>. W niektórych przypadkach pożądana akcja może wymagać kilku minut, aby być w pełni skuteczna.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Krok 3">
    Kliknij <code className="action">Odblokuj wysyłkę</code> i poczekaj kilka minut, aż usługa wysyłki będzie ponownie aktywna.
  </Tab>
</Tabs>
...
- Przeanalizuj [logi swojego hostingu](/guides/web-cloud/web-hosting/logs-and-statistics), aby zidentyfikować luki w bezpieczeństwie i zainfekowane pliki.
...
Jednak zachęcamy do kontaktu z [wyspecjalizowanym dostawcą](https://partner.ovhcloud.com/pl/directory/) w przypadku napotkania trudności. Niestety nie będziemy w stanie udzielić Ci wsparcia. Więcej informacji znajdziesz w sekcji [«Sprawdź również»](#go-further) niniejszego przewodnika.
:::
...
:::warning
Wiadomości e-mail wysyłane za pomocą skryptu korzystającego z konfiguracji SMTP nie będą mogły być zarządzane i śledzone z Twojego <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
:::

:::info
Jeśli używasz adresu e-mail OVHcloud i tylko w tym przypadku, możesz również używać `SMTPSecure` *«starttls»* lub *«tls»* z `Port` **587**. Jednak `SMTPSecure` *«ssl»* z `Port` **465** pozostaje konfiguracją preferowaną na naszej infrastrukturze.
:::

## Sprawdź również <a name="go-further"></a>

[Sprawdź logi swojego hostingu](/guides/web-cloud/web-hosting/logs-and-statistics)

[Popraw błąd «403 Forbidden» wyświetlany na Twojej stronie](/guides/web-cloud/web-hosting/diagnostic-403-forbidden)

[Przywróć przestrzeń dyskową FTP Twojego hostingu](/guides/web-cloud/web-hosting/ftp-save-and-backup)
...
Jeśli chcesz otrzymywać wsparcie w zakresie konfiguracji i użytkowania Twoich rozwiązań OVHcloud, sprawdź nasze [oferty pomocy](https://www.ovhcloud.com/pl/support-levels/).
