...
Monitorowanie i zarządzanie automatycznymi wiadomościami e-mail na Twoim hostingu odbywa się z poziomu <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. 
...
- samodzielnie wyłączyłeś funkcję z <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
...
:::warning
E-maile wysyłane za pomocą skryptu wykorzystującego konfigurację SMTP nie mogą być zarządzane i monitorowane za pomocą <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
