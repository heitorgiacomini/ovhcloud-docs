...
description: Dowiedz się, jak utworzyć pierwszą stronę internetową na Darmowy hosting
...
- Posiadanie [hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/) lub bezpłatnego [Darmowy hosting](https://www.ovhcloud.com/pl/domains/free-web-hosting/)
...
<body>
    <h1>Witamy na mojej stronie osobistej</h1>
    <h2>Szybkie i proste tworzenie strony WWW</h2>
    <p>OVHcloud oferuje darmowy hosting dla każdej zarejestrowanej domeny.</p>
</body>
```
...
Internet to przede wszystkim medium wizualne. W tej części zobaczymy, jak wstawić obrazy do treści. Oferta Darmowy hosting oferuje przestrzeń dyskową 100 MB. To wystarczy dla Twoich stron HTML i CSS, ale może być to ograniczone, jeśli chcesz umieścić dużo obrazów na swojej stronie. W tym przypadku zalecamy wybranie [oferty hostingu OVHcloud](https://www.ovhcloud.com/pl/web-hosting/) umożliwiającej szybsze przechowywanie danych.
...
**Przykład**: jeśli każdy z twoich obrazów waży 1 MB, będziesz ograniczony do mniej niż 100 obrazów na darmowym hostingu. Jeśli uda ci się zmniejszyć ich rozmiar do 50kb-200kb, będziesz mógł wyświetlić ich nawet kilka tysięcy na swojej stronie.
...
<img className="thumbnail" alt="Drzewo plików i folderów" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-1.png" loading="lazy" />

Weźmy przykład pliku w formacie *PNG*. Umieść go w katalogu "images":

<img className="thumbnail" alt="Drzewo plików i folderów z obrazem" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Wynik kodu HTML w przeglądarce" src="/images/assets/screens/other/browsers/web-pages/create-your-personal-webpage-3-pl.png" loading="lazy" />
...
<img className="thumbnail" alt="Umieszczenie pliku CSS" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-4.png" loading="lazy" />
...
<img className="thumbnail" alt="Model pudełka CSS" src="/images/assets/schemas/web-hosting/create-your-personal-webpage-5.png" loading="lazy" />
...
Aby Twoje strony WWW były widoczne dla wszystkich użytkowników, należy je umieścić na hostingu (należy aktywować hosting zgodnie [z instrukcjami zawartymi w tym przewodniku](/guides/web-cloud/web-hosting/activate-start10m)).
...
Aby umieszczać pliki na Twoim hostingu, zapoznaj się z przewodnikiem dotyczącym [korzystania z FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).
