...
<Tabs>
  <Tab label="Krok 1">
    ...
    <img className="thumbnail" alt="Hosting WWW" src="/images/assets/screens/control-panel/product-selection/web-cloud/hosting-plans.png" loading="lazy" />
  </Tab>
  <Tab label="Krok 2">
    Na stronie, która się wyświetli, kliknij zakładkę <code className="action">Statystyki i logi</code>. Przewiń w dół strony, na której znajduje się grafika związana z korzystaniem z hostingu.
  </Tab>
  <Tab label="Krok 3">
    Wybierz **typ** informacji oraz **okres** wyświetlanych danych.
    
    <img className="thumbnail" alt="Wykres statystyk infrastruktury" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png" loading="lazy" />
...
**Dostęp do bazy danych za pośrednictwem narzędzia phpMyAdmin:** zapoznaj się z dedykowaną sekcją w naszym przewodniku "[Zarządzanie bazą danych w hostingu WWW](/guides/web-cloud/web-hosting/sql-create-database)".
