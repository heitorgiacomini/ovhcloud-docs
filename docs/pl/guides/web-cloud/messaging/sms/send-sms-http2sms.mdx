...
description: Dowiedz się, jak wysyłać wiadomości SMS za pomocą narzędzia Wget i zapytań HTTP bezpośrednio z paska adresu przeglądarki internetowej
...
- Utworzenie użytkownika SMS w Panelu klienta OVHcloud lub bezpośrednio przez interfejs API. W tym celu zapoznaj się z następującym przewodnikiem: [Informacje o użytkownikach wiadomości SMS](/guides/web-cloud/messaging/sms/sms-users)
- Posiadanie konta SMS OVHcloud z zasileniami SMS

## W praktyce

Wysyłanie wiadomości SMS odbywa się przez zapytanie HTTPS oraz uzupełnienie obowiązkowych pól (a w stosownych przypadkach także opcjonalnych) pod następującym adresem: [https://www.ovh.com/cgi-bin/sms/http2sms.cgi?](https://www.ovh.com/cgi-bin/sms/http2sms.cgi?).
...
<img className="thumbnail" alt="Lista znaków SMS" src="/images/web-cloud/messaging/sms/send-sms-http2sms/smsauthorizedcharacters.png" loading="lazy" />
