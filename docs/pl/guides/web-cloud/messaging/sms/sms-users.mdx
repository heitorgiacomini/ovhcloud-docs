...
description: Dowiedz się, jak tworzyć, konfigurować i zarządzać użytkownikami API do wysyłania wiadomości SMS, w tym uprawnieniami i ograniczeniami
...
Kliknij kartę <code className="action">Użytkownicy API</code>. Aby dodać użytkownika, kliknij przycisk <code className="action">Działania</code>, a następnie <code className="action">Dodaj</code>.
...
Limitami możesz zarządzać z poziomu karty <code className="action">Użytkownicy API</code>. Obok wybranego użytkownika kliknij pozycję <code className="action">...</code>, a następnie <code className="action">Limity</code>.
...
Konfigurację progu dla użytkownika przeprowadza się z tego samego menu, klikając pozycję <code className="action">...</code>, a następnie <code className="action">Próg</code>.
...
Aby aktywować funkcję, po prawej stronie użytkownika kliknij pozycję <code className="action">...</code>, a następnie <code className="action">Ograniczenia</code>.
...
Aby uzyskać więcej informacji na temat funkcji http2sms, przeczytaj przewodnik [Wysyłanie wiadomości SMS z adresu URL](/guides/web-cloud/messaging/sms/send-sms-http2sms).

### Etap 5: Określanie adresu URL wywołania zwrotnego

Aby monitorować potwierdzenia odbioru wiadomości SMS (Delivery reporting lub DLR), można określić adres URL wywołania zwrotnego, po prawej stronie użytkownika klikając pozycję <code className="action">...</code>, a następnie <code className="action">Wywołanie zwrotne</code>.
