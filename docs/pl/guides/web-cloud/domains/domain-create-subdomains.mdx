...
- Posiadanie co najmniej jednej [nazwy domeny](https://www.ovhcloud.com/pl/domains/);
- Dysponowanie aktywną strefą DNS dla Twojej nazwy domeny. W razie potrzeby sprawdź przewodnik "[Utwórz strefę DNS OVHcloud](/guides/web-cloud/domains/dns-zone-create)";
- Wystarczające uprawnienia dotyczące wszystkich usług. Więcej informacji znajdziesz w naszym przewodniku [Zarządzanie kontaktami dla usług OVHcloud](/guides/account-and-service-management/account-information/managing-contacts).
...
<summary>Co składa się na nazwę domeny?</summary>
...
<summary>Co to jest subdomena?</summary>

[Nazwa domeny](https://www.ovhcloud.com/pl/domains/) może być powiązana z kilkoma rodzajami usług (e-mail, strona internetowa, etc.).
...
- *dns1.example.com* i *dns2.example.com* do personalizacji serwerów DNS za pomocą [GLUE records](/guides/web-cloud/domains/glue-registry);
...
Wszystkie [nazwy domen](https://www.ovhcloud.com/pl/domains/) potrzebują do działania **strefy DNS**. Strefa DNS zawiera informacje techniczne nazywane *rekordami DNS*. Jest, w pewnym sensie, centrum ruchu wskazówek.

Więcej informacji o strefach DNS znajdziesz w przewodniku "[Tworzenie strefy DNS OVHcloud](/guides/web-cloud/domains/dns-zone-create)" i "[Edycja strefy DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit)".
...
1 : Aby ustalić, gdzie znajduje się aktywna strefa DNS nazwy domeny zarejestrowanej w OVHcloud, skorzystaj z naszego przewodnika "[Modyfikacja serwerów DNS nazwy domeny OVHcloud](/guides/web-cloud/domains/dns-server-edit)".

2: Jeśli Twoja nazwa domeny nie jest zarejestrowana w OVHcloud, skontaktuj się z *aktualnym operatorem* Twojej nazwy domeny, aby dowiedzieć się, gdzie hostowana jest aktywna strefa DNS. Aby wykonać transfer nazwy domeny do OVHcloud, zapoznaj się z naszym [przewodnikiem](/guides/web-cloud/domains/transfer-incoming-generic-domain).
...
Aby dodać subdomeny do aktywnej strefy DNS Twojej nazwy domeny, zapoznaj się z naszym przewodnikiem "[Edycja strefy DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit)".
...
Podobnie jak w przypadku nazwy domeny, aby zezwolić subdomenie na wyświetlanie zawartości folderu "docelowego" zadeklarowanego dla strony internetowej w ramach planu hostingowego, należy zalogować się do <ManagerLink to="/">panelu klienta OVHcloud</ManagerLink> i wybrać opcję <code className="action">Web Cloud</code>. Kliknij <code className="action">Hosting</code> w lewej kolumnie, wybierz plan hostingowy, w ramach którego znajduje się Twoja strona internetowa, a następnie wybierz zakładkę <code className="action">Moje strony</code>.

W tym miejscu autoryzujesz swoją subdomenę do dostępu do swojej strony internetowej w ramach planu hostingowego.

Aby uzyskać więcej informacji na temat konfiguracji domeny lub subdomeny w ramach planu hostingowego, zapoznaj się z naszym przewodnikiem "[Jak przypisać nazwę domeny do istniejącej strony internetowej ?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website)". Procedura jest taka sama zarówno dla nazw domen, jak i subdomen.
...
Aby odblokować tworzenie spersonalizowanych adresów e-mail Exchange z subdomeną, zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i wybierz <code className="action">Web Cloud</code>. W kolumnie po lewej stronie kliknij <code className="action">Microsoft</code>, a następnie <code className="action">Exchange</code>. Następnie wybierz platformę Exchange, której chcesz używać ze swoją subdomeną. Na stronie, która się wyświetli przejdź do zakładki <code className="action">Przypisane domeny</code>, następnie kliknij przycisk <code className="action">Dodaj domenę</code> po prawej stronie.
...
- [Dodaj rekord CNAME, aby zweryfikować domenę w usłudze e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-dns-cname)
...
Aby odblokować tworzenie spersonalizowanych adresów E-mail Pro z subdomeną, zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i wybierz <code className="action">Web Cloud</code>. Kliknij <code className="action">E-maile Pro</code>, a następnie wybierz platformę E-mail Pro, której chcesz używać ze swoją subdomeną. Na stronie, która się wyświetli przejdź do zakładki <code className="action">Przypisane domeny</code>, następnie kliknij przycisk <code className="action">Dodaj domenę</code> po prawej stronie.
...
- [Dodaj nazwę domeny do platformy e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain)
- [Dodaj rekord CNAME, aby zweryfikować nazwę domeny w usłudze e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-dns-cname)
...
[Modyfikacja serwerów DNS nazwy domeny OVHcloud](/guides/web-cloud/domains/dns-server-edit)
...
[Dodaj rekord CNAME, aby potwierdzić nazwę domeny w usłudze e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-dns-cname)
