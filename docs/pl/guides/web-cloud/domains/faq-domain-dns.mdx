...
Następnie możesz zarządzać swoją nazwą domeny, logując się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
...
Po zamówieniu nazwy IDN wyświetlają się w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> w formacie **xn--**.

Mimo że Twoja nazwa domeny jest wyświetlana w [notacji międzynarodowej (IDN)](https://en.wikipedia.org/wiki/Internationalized_domain_name) w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, będzie funkcjonować i wyświetlać się normalnie w innych miejscach. Adres Twojej strony internetowej będzie wyświetlany zgodnie z żądaniem. Adresy e-mail również będą wyświetlane Twoim kontaktom zgodnie z oczekiwaniami.
...
:::tip
Wszystkie szczegóły znajdziesz w naszym przewodniku "[Jak odnawiać usługi OVHcloud](/guides/account-and-service-management/managing-billing-payments-and-services/automatic-renewal)".
...
Wykonaj [procedurę odzyskania kontaktu](https://www.ovh.pl/cgi-bin/pl/procedure/procedureChangeContacts.cgi), aby Twoja nazwa domeny była w pełni zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. W ten sposób nie będziesz musiał kontaktować się z osobą, która wcześniej zarządzała Twoją nazwą domeny.
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web-domains/domain">Domeny</ManagerLink>, następnie wybierz odpowiednią nazwę domeny.
...
:::tip
Jeśli nie otrzymałeś tego e-maila, sprawdź folder spam lub przejdź na stronę <ManagerLink to="/#/account/useraccount/dashboard">Moje konto</ManagerLink>, następnie kliknij zakładkę <code className="action">Otrzymane e-maile</code>.
...
Jeśli zakładka nie pojawia się w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, oznacza to, że opcja "GLUE" jest niedostępna dla Twojej nazwy domeny.
...
W <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> ten komunikat wskazuje jedynie, że strefa DNS utworzona dla Twojej nazwy domeny nie jest jej aktywną strefą DNS.
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web-domains/domain">Domeny</ManagerLink>, a następnie sprawdź, czy odpowiednia nazwa domeny jest wyświetlana.
  ...
  <Tab label="Krok 2">
    **Przypadek 1** — Nazwa domeny nie pojawia się na liście:
    ...
    - Nazwa domeny jest zarejestrowana w OVHcloud: Możesz wykonać [procedurę odzyskania kontaktu](https://www.ovh.pl/cgi-bin/pl/procedure/procedureChangeContacts.cgi), aby Twoja nazwa domeny była zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
    - Nazwa domeny nie jest zarejestrowana w OVHcloud: Możesz wykonać [transfer przychodzący](/guides/web-cloud/domains/transfer-incoming-generic-domain) do OVHcloud, aby Twoja nazwa domeny była zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
    ...
    **Przypadek 2** — Nazwa domeny pojawia się na liście:
    ...
    Możesz następnie wykonać [procedurę odzyskania kontaktu](https://www.ovh.pl/cgi-bin/pl/procedure/procedureChangeContacts.cgi), aby Twoja nazwa domeny była w pełni zarządzana w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
  </Tab>
</Tabs>
...
[FAQ dotyczący hostingu](/guides/web-cloud/web-hosting/faq)
