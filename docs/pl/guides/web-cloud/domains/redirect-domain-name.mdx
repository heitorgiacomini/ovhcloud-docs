...
- **Z poziomu <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>**, w którym asystent konfiguracji pozwala na ustawienie przekierowania.
...
Uwaga: przekierowanie utworzone w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> nie pozwala na przekierowanie adresu URL `https://` na inną nazwę domeny lub adres URL.
...
Oprócz przekierowań wskazujących na rekordy DNS typu A, AAAA i CNAME, w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> dostępne są 3 opcje przekierowania.
