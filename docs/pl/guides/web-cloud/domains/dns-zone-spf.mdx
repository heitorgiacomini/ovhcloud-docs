...
Aby dodać rekord SPF w konfiguracji OVHcloud Twojej nazwy domeny, zaloguj się do <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. Kliknij <code className="action">Domeny</code>, następnie wybierz nazwę domeny i przejdź do zakładki <code className="action">Strefa DNS</code>.
