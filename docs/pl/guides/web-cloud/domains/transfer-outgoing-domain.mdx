...
description: Dowiedz się, jak wykonać transfer nazwy domeny z OVHcloud do wybranego operatora
...
- Posiadanie [nazwy domeny zarejestrowanej](https://www.ovhcloud.com/pl/domains/) w OVHcloud
...
:::info
Jeśli jesteś **abonentem** nazwy domeny, ale zarządzanie nią w Panelu klienta OVHcloud jest niedostępne, zarówno poprzez własny dostęp, jak i poprzez kontakt administracyjny nazwy domeny, zapoznaj się z [tym przewodnikiem](/guides/account-and-service-management/account-information/managing-contacts).
...
<Tabs>
  ...
  <Tab label="Krok 2">
    W zakładce <code className="action">Informacje ogólne</code> znajdziesz suwak `Ochrona przed transferem` pod **Bezpieczeństwo**. Domyślnie ochrona ta jest <code className="action">Aktywne</code>.
    ...
    <img className="thumbnail" alt="ochrona włączona" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/protection-against-domain-name-transfert-enabled.png" loading="lazy" />
  </Tab>
  <Tab label="Krok 3">
    Kliknij kursor i potwierdź w oknie, które się wyświetli, że chcesz usunąć tę ochronę. Odczekaj kilka minut, aż stan się <code className="action">Wyłączone</code>.
    ...
    Ponadto, jeśli pojawi się komunikat: "**AUTH/INFO code : Authcode is not managed by OVHcloud, contact the registry to claim it**", co oznacza, że kod transferu Twojej nazwy domeny nie będzie możliwy do pobrania za pośrednictwem <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
    
    W obu przypadkach sprawdź, czy jesteś kontaktem **administrator** nazwy domeny korzystając z naszego przewodnika do [zarządzanie kontaktami](/guides/account-and-service-management/account-information/managing-contacts), a następnie sprawdź, czy rozszerzenie Twojej nazwy domeny pozwala na odblokowanie w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
    ...
    <img className="thumbnail" alt="dezaktywacja" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/protection-against-domain-name-transfert-deactivating.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Krok 2">
    W zakładce <code className="action">Informacje ogólne</code>, kliknij przycisk <code className="action">AUTH/INFO</code> znajdujący się obok przycisku <code className="action">Ochrona przed transferem</code>. Jeśli to konieczne, odśwież stronę.
...
[Transfer nazwy domeny.co.uk wychodzący](/guides/web-cloud/domains/transfer-outgoing-couk)
