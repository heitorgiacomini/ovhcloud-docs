...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/zone">Strefy DNS</ManagerLink>, następnie wybierz odpowiednią nazwę domeny, której użyłeś do utworzenia hostów w [kroku 3](#step3).
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/zone">Strefy DNS</ManagerLink>, następnie wybierz odpowiednią nazwę domeny, dla której spersonalizowałeś serwery DNS.
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web-domains/domain">Domeny</ManagerLink>, następnie wybierz *nazwę domeny, dla której chcesz spersonalizować serwery DNS*.
