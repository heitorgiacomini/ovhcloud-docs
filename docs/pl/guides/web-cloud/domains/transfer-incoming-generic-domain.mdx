...
:::tip
Aby uzyskać informacje na temat cennika transferu nazwy domeny w zależności od jej rozszerzenia, wprowadź nazwę domeny, którą chcesz przenieść na naszą stronę [www.ovhcloud.com/pl/domains/tld/](https://www.ovhcloud.com/pl/domains/tld/) następnie postępuj zgodnie z instrukcjami zawartymi w tym przewodniku.
...
:::warning
Dokładna procedura transferu nazwy domeny może się różnić, w szczególności w przypadku niektórych **TLD** kodu kraju (**ccTLD**, takich jak .pl, .lu, .hk, .ro, .be, .lt, .dk, .at, .fi, itp.) oraz niektórych specjalnych **TLD** (.am, .fm, itp.). W zależności od rozszerzenia Twojej nazwy domeny, mogą być konieczne dodatkowe wymagania. Zalecamy sprawdzenie w pierwszej kolejności informacji wyświetlanych dla danego rozszerzenia na naszej stronie internetowej: [https://www.ovhcloud.com/pl/domains/tld/](https://www.ovhcloud.com/pl/domains/tld/).
...
**W pierwszym kroku sprawdź, czy informacje związane z nazwą domeny są aktualne.** Od momentu wdrożenia RODO bardzo mało danych widocznych w bazie « [Whois](https://www.ovhcloud.com/pl/domains/whois/) ». Sugerujemy zatem sprawdzenie informacji dotyczących Twojej nazwy domeny u aktualnego operatora.
...
:::info
Jeśli nie wiesz, który operator jest odpowiedzialny za Twoją nazwę domeny, możesz podać informacje dotyczące jej tożsamości w wierszach "Registrar", które pojawią się w wyniku wyszukiwania narzędzia [Whois](https://www.ovhcloud.com/pl/domains/whois/).
...
Po odblokowaniu Twojej nazwy domeny i uzyskanym kodzie możesz zamówić transfer nazwy domeny do OVHcloud z [naszej strony](https://www.ovhcloud.com/pl/domains/). Wprowadź nazwę Twojej nazwy domeny, po czym postępuj zgodnie z kolejnymi instrukcjami.
