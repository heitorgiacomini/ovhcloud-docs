...
- Zalogowanie się do swojego <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/zone">Strefy DNS</ManagerLink>, a następnie w przycisk <code className="action">Zamów</code>.
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/zone">Strefy DNS</ManagerLink>, następnie wybierz odpowiednią poddomenę.
