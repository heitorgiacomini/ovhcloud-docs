---
title: Transfer nazwy domeny GoDaddy do OVHcloud
description: Dowiedz się więcej o transferze nazwy domeny z systemu GoDaddy do OVHcloud
...
Transfer nazwy domeny GoDaddy wymaga zastosowania określonej procedury.

**Dowiedz się, jak wykonać transfer nazwy domeny GoDaddy do OVHcloud**
...
- Nazwa domeny jest zarejestrowana u operatora GoDaddy.
...
### Etap 1 - Odblokowanie nazwy domeny w GoDaddy

Blokada nazwy domeny chroni ją przed nieautoryzowanym transferem.
GoDaddy włącza tę domyślną ochronę. Aby przenieść nazwę domeny do OVHcloud, musisz ją wyłączyć.
...
Przed rozpoczęciem procedury transferu nazwy domeny OVHcloud poprosi o podanie kodu autoryzacyjnego lub "Auth code". Możesz go uzyskać, otwierając stronę Twojego portfolio <code className="action">Domeny</code> w GoDaddy.
...
### Etap 3 - Rozpocznij transfer nazwy domeny do OVHcloud
