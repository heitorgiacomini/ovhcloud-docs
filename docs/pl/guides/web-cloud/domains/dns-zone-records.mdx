...
<Tabs>
  <Tab label="MX">
    **M**ail e**X**changer <br/><br/>
    ...
    Istnieje prawdopodobieństwo, że Twój dostawca poczty e-mail dysponuje kilkoma serwerami e-mail: należy utworzyć kilka pól MX. Zapoznaj się z naszą dokumentacją "[Dodaj pole MX do konfiguracji nazwy domeny](/guides/web-cloud/domains/dns-zone-mx)".
