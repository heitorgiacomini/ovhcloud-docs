...
description: Dowiedz się więcej o transferze nazwy domeny z systemu Hostinger do OVHcloud
...
W przypadku nazw domen zarejestrowanych w Hostingerze możesz zarządzać statusem blokady Twojej nazwy domeny otwierając sekcję <code className="action">Domeny</code> i wybierając nazwę domeny, którą chcesz przenieść.
...
Aby zapoznać się ze zmianą abonenta nazwy domeny, zapoznaj się z tym [przewodnikiem](/guides/web-cloud/domains/trade-domain).
