...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web-domains/domain">Domeny</ManagerLink>, następnie wybierz nazwę domeny, która jest dotyczy.
...
Dla niektórych rozszerzeń (np.: .fr, .it, .es), administrator domeny może bezpośrednio wejść do swojego <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i zmienić adres e-mail kontaktu właściciela, postępując zgodnie z krokami opisanymi w kroku 2 tej strony.
...
<Tabs>
  <Tab label="Krok 1">
    Przejdź na stronę <ManagerLink to="/#/web/ongoing-operations">Operacje w Toku</ManagerLink>, a następnie znajdź odpowiednią nazwę domeny na wyświetlonej liście.
