...
- Posiadanie pakietu MX Plan Jest ona dostępna przez: ofertę [hostingu WWW Cloud](https://www.ovhcloud.com/pl/web-hosting/) lub ofertę MX Plan zamówioną oddzielnie.
...
:::info
Delegacja na koncie e-mail wyświetla się w <ManagerLink to="/">odpowiednim panelu klienta</ManagerLink>. W tej sytuacji możliwe będą jedynie zmiany wskazane w sekcji [Cel](#objective) niniejszego przewodnika.
