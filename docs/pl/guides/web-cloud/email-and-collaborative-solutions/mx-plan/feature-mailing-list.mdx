...
description: Z tego przewodnika dowiesz się, jak korzystać z list mailingowych
...
- Posiadanie usługi kont e-mail w postaci co najmniej pakietu MX Plan 100 lub [hostingu WWW](https://www.ovhcloud.com/pl/web-hosting/) obsługującego listy mailingowe.
...
Przejdź do karty <code className="action">Listy mailingowe</code> w Twojej usłudze e-mail.
...
Aby utworzyć nową listę mailingową, kliknij polecenie <code className="action">Dodaj listę mailingową</code>.
...
Aby zmodyfikować opcje listy mailingowej, kliknij przycisk <code className="action">...</code> po prawej stronie listy. Teraz można zaktualizować opcje, usunąć listę mailingową lub udostępnić listę jej abonentów przez e-mail.
...
|---|---|
|Kliknij polecenie <code className="action">Dodaj abonenta</code> po prawej stronie.|Kliknij polecenie <code className="action">Usuń za pomocą pliku</code> po prawej stronie.|
...
- ręczne wprowadzenie adresów po kliknięciu polecenia <code className="action">Dodaj adres e-mail</code>.
...
Kliknij polecenie <code className="action">Eksport abonentów do pliku CSV</code>, aby wyprodukować plik CSV zawierający listę wszystkich abonentów. Ta opcja nie jest dostępna w naszym przypadku, ponieważ nie dodano żadnego abonenta.
...
|---|---|
|Kliknij polecenie <code className="action">Dodaj moderatora</code> po prawej stronie.|Kliknij polecenie <code className="action">Usuń za pomocą pliku</code> po prawej stronie.|
