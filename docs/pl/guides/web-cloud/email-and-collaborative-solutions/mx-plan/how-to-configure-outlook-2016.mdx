...
<Tabs>
  ...
  <Tab label="Krok 5">
    ...
    <Region zones={['eu']}>
    - **Serwer**: imap.mail.ovh.net **lub** ssl0.ovh.net
    - Port: **993**
    - Metoda szyfrowania: **SSL/TLS**
    </Region>
    
    <Region zones={['ca', 'apac']}>
    - **Serwer**: imap.mail.ovh.ca
    - Port: **993**
    - Metoda szyfrowania: **SSL/TLS**
    </Region>
...
- **Serwer poczty przychodzącej**: imap.mail.ovh.net **lub** ssl0.ovh.net
- **Serwer poczty wychodzącej (SMTP)**: smtp.mail.ovh.net **lub** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Typ konta**: wybierz IMAP
- **Serwer poczty przychodzącej**: imap.mail.ovh.ca
- **Serwer poczty wychodzącej (SMTP)**: smtp.mail.ovh.ca
</Region>
...
Okno jest podzielone na dwie części, **Poczta przychodząca** i **Poczta wychodząca**. Kliknij część, którą chcesz zmienić.
    ...
    Znajdź tę cyfrę w Twoim <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, w sekcji <code className="action">Web Cloud</code>, a następnie <code className="action">E-mail Pro</code>. Nazwa serwera jest widoczna w ramce **Logowanie** zakładki <code className="action">Informacje ogólne</code>.
...
<Tabs>
  <Tab label="Konfiguracja IMAP">
    ...
    <Region zones={['ca', 'apac']}>
    - **Serwer (przychodzący)**: imap.mail.ovh.ca.
    - **Nazwa użytkownika**: wpisz pełny adres e-mail.
    - **Hasło**: wpisz hasło do adresu e-mail.
    - **Port**: 993.
    - **Typ zabezpieczeń**: SSL/TLS.
  ...
  <Tab label="Konfiguracja POP">
    ...
    <Region zones={['ca', 'apac']}>
    - **Serwer (przychodzący)**: pop.mail.ovh.ca.
    - **Nazwa użytkownika**: wpisz pełny adres e-mail.
    - **Hasło**: wpisz hasło do adresu e-mail.
    - **Port**: 995.
    - **Typ zabezpieczeń**: SSL/TLS.
...
<Region zones={['ca', 'apac']}>
- **Serwer (wychodzący)**: smtp.mail.ovh.ca.
- **Nazwa użytkownika**: wpisz pełny adres e-mail.
- **Hasło**: wpisz hasło do adresu e-mail.
- **Port**: 465.
- **Typ zabezpieczeń**: SSL/TLS.
