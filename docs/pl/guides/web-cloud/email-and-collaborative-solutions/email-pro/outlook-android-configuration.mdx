...
Kliknij <ManagerLink to="/#/web/email_pro">ten link</ManagerLink>, aby uzyskać dostęp do sekcji <code className="action">E-mail Pro</code>. Nazwa serwera jest widoczna w ramce **Połączenie** w zakładce <code className="action">Informacje ogólne</code>.
