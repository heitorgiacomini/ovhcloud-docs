...
Aby skonfigurować adres e-mail Pro w klasycznym Outlooku, zapoznaj się z naszym przewodnikiem "[E-mail Pro - Skonfigurowanie konta e-mail w klasycznym Outlooku dla Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration)".
...
Kliknij <ManagerLink to="/#/web/email_pro">ten link</ManagerLink>, aby uzyskać dostęp do sekcji <code className="action">E-mail Pro</code>.
