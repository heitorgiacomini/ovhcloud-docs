...
Aby przeprowadzić migrację z użyciem pliku lub wielu plików, zapoznaj się z sekcjami "Migracja z użyciem pliku" i "Migracja z użyciem wielu plików (tryb projektu)" w naszym przewodniku "[Migracja kont e-mail za pomocą OVHcloud Mail Migrator](/guides/web-cloud/email-and-collaborative-solutions/migrating/omm-migrate-email-account-to-ovhcloud)".
...
Aby usunąć adres e-mail MX Plan (na przykład: `contact@mydomain.ovh`), zapoznaj się z naszym przewodnikiem "[Usuń konto e-mail](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/delete-email-account)".
