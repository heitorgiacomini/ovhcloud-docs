...
description: Dowiedz się, jak rozpocząć korzystanie z oferty Zimbra z poziomu Panelu klienta OVHcloud
...
- Posiadanie [domeny OVHcloud](https://www.ovhcloud.com/pl/domains/).
...
Jeśli dodajesz wiele domen do swojej usługi Zimbra, pomocne może być pogrupowanie ich w "organizację". W usłudze Zimbra kliknij <code className="action">Organisation</code>.
...
Aby utworzyć organizację, kliknij przycisk <code className="action">Dodaj organizację</code>. Ustaw `Nazwa` organizacji oraz `Znak organizacji`, przy czym ten ostatni jest krótkim opisem organizacji pozwalającym na odnalezienie Cię podczas filtrowania wyświetlania nazw domen i kont e-mail Twojej usługi Zimbra.
...
Z zakładek <code className="action">Organizacja</code>, <code className="action">Domena</code> i <code className="action">Konta e-mail</code>, klikając na etykietę organizacji, utworzysz filtr, który wyświetli tylko elementy powiązane z tą organizacją.
...
:::warning
Aby zapewnić optymalne działanie, jeśli używasz tej samej nazwy domeny między ofertami OVHcloud [Exchange](https://www.ovhcloud.com/pl/emails/hosted-exchange/), [E-mail Pro](https://www.ovhcloud.com/pl/emails/email-pro/) i Zimbra, konieczne jest skonfigurowanie domeny jako `non-authoritative`. Aby dowiedzieć się, jak skonfigurować nieautorytatywną domenę na platformie Exchange lub E-mail Pro, zapoznaj się z naszym przewodnikiem [Dodaj domenę na platformie e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain).
...
Aby dodać domenę do Twojej usługi Zimbra, kliknij w zakładkę <code className="action">Domena</code>, następnie kliknij <code className="action">Dodaj domenę</code>.
...
Kliknij przycisk <code className="action">Potwierdź</code>, aby dokończyć dodawanie domeny i rozpocząć proces konfiguracji.
  </Tab>
  <Tab label="Domena zewnętrzna">
    ...
    Kliknij na <code className="action">Potwierdź</code>
...
W zakładce <code className="action">Domena</code> Twojej usługi Zimbra kliknij na ikonę "&#8285;" z prawej strony odpowiedniej domeny, aby wyświetlić opcje.
...
- Kliknij przycisk <code className="action">Konfiguruj</code>, aby zmienić organizację przypisaną do Twojej domeny.
- Kliknij <code className="action">Raporty diagnostyczne</code>, aby wyświetlić interfejs diagnostyczny dla rekordów DNS domeny. Należy upewnić się, że żaden alert nie jest wyświetlany dla każdego z rekordów DNS wymienionych w zakładkach. Postępuj zgodnie z instrukcjami wyświetlanymi w każdej zakładce z alertem, aby skonfigurować rekordy DNS:
...
Adresami e-mail usługi Zimbra można zarządzać w zakładce <code className="action">Konta e-mail</code>. W tabeli wyświetla się lista kont e-mail obecnych w Twojej usłudze oraz 3 informacje dla każdego z nich:
...
Na górze tej strony znajduje się również link do [Webmail](https://www.ovhcloud.com/pl/mail/), dzięki któremu będziesz mógł połączyć się bezpośrednio z zawartością Twojego konta e-mail z poziomu przeglądarki internetowej.
...
Aby utworzyć konto e-mail w Twojej usłudze Zimbra, kliknij zakładkę <code className="action">Konta e-mail</code>, a następnie <code className="action">Utwórz konto</code>.
...
Kliknij na <code className="action">Potwierdź</code>, aby rozpocząć zakładanie konta.
...
- Zaloguj się do [webmail](https://www.ovhcloud.com/pl/mail/) w przeglądarce internetowej i wprowadź swój adres e-mail oraz hasło. Więcej informacji znajdziesz na naszej stronie "[Korzystanie z poczty Zimbra](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra)".
- Skonfiguruj program pocztowy na swoim komputerze, smartfonie lub tablecie. Odwiedź naszą stronę "[Konfiguracja konta e-mail Zimbra w programie pocztowym](/guides/web-cloud/email-and-collaborative-solutions/zimbra/mail-apps)".

### Przekierowania <a name="redirections"></a>

Aby utworzyć przekierowanie na adres e-mail Zimbra, zaloguj się do [webmail](https://www.ovhcloud.com/pl/mail/).
...
<Tabs>
  ...
  <Tab label="Etap 3">
    ...
    - Kliknij na <code className="action">+ Dodaj akcję</code> (Add an action) poniżej, a następnie wybierz `Przechowuj w skrzynce odbiorczej` (Keep in Inbox).
...
- Kliknij przycisk &#9881; w prawym górnym rogu Twojego okna poczty webmail, następnie kliknij <code className="action">Parametry</code>.
...
- Kliknij przycisk <code className="action">Zapisz</code>, aby dokończyć uruchamianie komunikatu urlopowego.
...
[Konfiguracja konta e-mail Zimbra w programie pocztowym](/guides/web-cloud/email-and-collaborative-solutions/zimbra/mail-apps)
