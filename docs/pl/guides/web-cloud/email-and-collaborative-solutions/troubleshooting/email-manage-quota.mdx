...
W <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> przejdź do sekcji <code className="action">Web Cloud</code> i postępuj zgodnie z instrukcjami zawartymi w Twojej ofercie:
...
<ZoneTabs>
  <Tab label="MX Plan">
    Rozmiar konta MX Plan może wynosić od 2,5 MB do 5 GB. Jeśli pojemność jest wysycona i mniejsza niż 5 GB, możesz zmienić jej pojemność poprzez <ManagerLink to="/">Panel klienta OVHcloud</ManagerLink>.<br/>
...
<Region zones={['ca']}>
- protokół IMAP w ofercie **MXplan**;
- protokół MAPI w sprawie oferty **Exchange** dla Outlook Windows;
- protokół EWS w sprawie oferty **Exchange** dla Outlook macOS.
</Region>
...
<ZoneTabs>
  ...
  <Tab label="E-mail Pro" availableIn={['eu']}>
    ...
    - [Poczta na urządzeniu z systemem Windows 10](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration) (zawarte w systemie Windows)<br/>
    ...
    - [Mail](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration) (zawarte w macOS)<br/>
    - [Outlook](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration)<br/>
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/email-pro/thunderbird-macos-configuration) (za darmo)<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/thunderbird-windows-configuration) (za darmo)<br/><br/>>
