...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Wyodrębnianie pliku eml z OWA" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa02.mp4" />
