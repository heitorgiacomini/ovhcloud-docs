...
description: Dowiedz się, jak zamówić i zarządzać usługą Office 365 Reseller (CSP2) w OVHcloud
...
- **Link bezpośredni:** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Kliknij na <code className="action">Zamów</code>, aby sfinalizować.
...
Ikona <i className="icons-pen"></i>  pozwala na zmianę całkowitej liczby licencji w abonamencie. Ikona <i className="icons-bin"></i>  pozwala na anulowanie subskrypcji oraz wszystkich licencji.
