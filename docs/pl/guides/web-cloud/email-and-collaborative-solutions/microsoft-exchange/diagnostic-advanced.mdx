...
description: Dowiedz się, jak przeprowadzić automatyczną diagnostykę błędów na kontach Exchange
...
- Aktualizacja w [płatności](/guides/account-and-service-management/managing-billing-payments-and-services/invoice-management#pay-bills) tej usługi i powiązanej domeny
...
<img className="thumbnail" alt="Diagnostyka Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/img_4450.png" loading="lazy" />

Kliknij kartę <code className="action">Diagnostyka</code> i wybierz odpowiednie konto Exchange z rozwijanego menu. Wprowadź hasło do konta w odpowiednim polu, po czym kliknij <code className="action">Rozpocznij diagnostykę</code>.

<img className="thumbnail" alt="Diagnostyka Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/img_4451.png" loading="lazy" />

Procedura diagnostyczna zajmie około 3 do 10 minut. Oto przykład:

<img className="thumbnail" alt="Diagnostyka Exchange" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/diagnostic-advanced/img_4471.png" loading="lazy" />

Strona wyników proponuje dwa działania, aby kontynuować:

- <code className="action">Nowa diagnoza</code>: rozpoczyna kolejną diagnostykę.

- <code className="action">Utwórz zgłoszenie</code>: pozwala utworzyć zgłoszenie w naszym dziale pomocy technicznej. Zgłoszenie zawiera wyniki diagnostyki.
...
Możesz to sprawdzić w zakładce <code className="action">Konta e-mail</code> w Twojej usłudze Exchange. Konto będzie zawierać oznaczenie `SPAM` w kolumnie "Status" tabeli.

Zapoznaj się z naszym przewodnikiem [Co zrobić w przypadku blokady konta ze względu na spam?](/guides/web-cloud/email-and-collaborative-solutions/troubleshooting/locked-for-spam) aby umożliwić naszym zespołom bezpieczeństwa ponowne uruchomienie konta.
...
Aby ponownie włączyć abonament, wystarczy zmienić jego konfigurację [częstotliwość płatności](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/manage-billing-exchange#periodicity) w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>.

### Konto zostało zablokowane z powodu polityki bezpieczeństwa

Jeśli w <ManagerLink to="/">Panelu klienta aktywowana jest polityka bezpieczeństwa</ManagerLink>, konto może zostać tymczasowo zablokowane.
...
Aby uzyskać więcej informacji na temat tej funkcji, zapoznaj się z naszym [przewodnikiem dotyczącym polityki bezpieczeństwa](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/security-policy).

### Logowanie do webmaila nie powiodło się. <a name="password"></a>

Może to być spowodowane wpisaniem nieprawidłowego hasła do konta. Sprawdź najpierw, czy hasło jest poprawne. Zaloguj się do interfejsu [Webmail](/guides/web-cloud/email-and-collaborative-solutions/using-the-outlook-web-app-webmail/email-owa), następnie zrestartuj diagnostykę.

W razie potrzeby możesz zmienić hasło do wybranego konta w zakładce <code className="action">Konta e-mail</code> w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>. Jeśli problem się powtórzy, utwórz zgłoszenie.
...
Możesz sprawdzić te parametry w [strefie DNS Twojej domeny](/guides/web-cloud/domains/dns-zone-edit).
