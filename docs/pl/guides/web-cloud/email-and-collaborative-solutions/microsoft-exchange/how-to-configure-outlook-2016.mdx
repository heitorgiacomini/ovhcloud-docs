...
Zalecamy sprawdzenie konfiguracji nazwy domeny skonfigurowanej w Twojej usłudze Exchange w Twoim <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, zakładka <code className="action">Przypisane domeny</code>, następnie kolumna <code className="action">Diagnostyka</code> w tabeli.
