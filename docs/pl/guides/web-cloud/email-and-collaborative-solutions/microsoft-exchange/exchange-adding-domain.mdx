...
Licencje Outlook możesz wykupić w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, a licencje Office 365 — na stronie [Microsoft 365](https://www.ovhcloud.com/pl/collaborative-tools/microsoft-365/). Zalecamy skorzystanie z jednego z tych rozwiązań, jeśli chcesz używać programu pocztowego Outlook lub innych programów Office.
