...
description: Dowiedz się, jak dodać łącznik do wysyłki SMTP do platformy Exchange OVHcloud
...
Następnie zaloguj się do API OVHcloud za pomocą danych identyfikacyjnych. Skorzystaj z naszego przewodnika [Pierwsze kroki z API OVHcloud](/guides/manage-and-operate/api/first-steps).
...
Kliknij przycisk <code className="action">Execute</code>, aby rozpocząć wywołanie API.
...
[Edycja strefy DNS OVH.](/guides/web-cloud/domains/dns-zone-edit)
