...
Zapoznaj się z tym przewodnikiem, aby uzyskać więcej informacji: [Backup Agent - Bare Metal recovery with Veeam Backup Agent](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/agent-bare-metal-recovery).
