...
- Co najmniej jeden serwer Bare Metal z zainstalowaną Aplikacją Backup. Aby uzyskać więcej informacji, zapoznaj się z naszym przewodnikiem "[Jak skonfigurować pierwsze kopie zapasowe](/guides/storage-and-backup/backup-agent/first-configuration)".
...
Musisz pobrać agenta ze swojego <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink> i zainstalować go na swoim nowym systemie operacyjnym.
