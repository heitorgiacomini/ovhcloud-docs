...
description: Pierwsze kroki z API Swift
...
Ten adres URL składa się z punktu zakończenia dostępnego w [interfejsie Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security), nazwy kontenera i nazwy obiektu (w tym prefiksu).
