...
The S3 Object storage classes benefit from [enhanced features to better manage your data](https://www.ovhcloud.com/pl/public-cloud/object-storage/).
...
Object Storage is billed according to the storage space used, with a granularity of 1GiB. To ensure readability, the price is displayed per GiB/month, but the billing granularity is per GiB/hour. View pricing on [this page](https://www.ovhcloud.com/pl/public-cloud/prices/).
...
In a 3-AZ region, Object Storage billing is done following a staircase approach with different volume tiers. View pricing on [this page](https://www.ovhcloud.com/pl/public-cloud/prices/).
