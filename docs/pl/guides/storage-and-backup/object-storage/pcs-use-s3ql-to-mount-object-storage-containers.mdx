...
description: Montowanie kontenera obiektów za pomocą S3QL
...
- [Configure user](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- [Add storage space](/guides/storage-and-backup/object-storage/pcs-create-container)
...
You can follow this guide below in order to retrieve it: [Access and Security in Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security)
