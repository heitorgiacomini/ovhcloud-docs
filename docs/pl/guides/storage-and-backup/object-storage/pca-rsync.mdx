...
description: Dowiedz się, jak uzyskać dostęp do Twoich archiwów Public Cloud za pomocą Rsync
...
Za pomocą tego [przewodnika](/guides/public-cloud/cross-functional/create-and-delete-a-user) możesz wygenerować identyfikator klienta i hasło OpenStack.
