...
description: Umieszczenie kontenera Object Storage za domeną
...
- [Dodanie przestrzeni dyskowej](/guides/storage-and-backup/object-storage/pcs-create-container) (EN)
- Domena
