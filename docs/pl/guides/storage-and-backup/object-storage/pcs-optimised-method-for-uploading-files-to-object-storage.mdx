...
- [Przygotowanie środowiska do korzystania z API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) za pomoca klienta python-swiftclient
