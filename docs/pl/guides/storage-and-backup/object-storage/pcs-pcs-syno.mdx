...
- [Zapewnienie dostępu do interfejsu Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user#tworzenie-uzytkownika-openstack)
...
- [Pobranie zmiennych środowiskowych OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#etap-1-zgromadzenie-zmiennych)
