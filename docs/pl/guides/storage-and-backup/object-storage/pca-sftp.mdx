...
## ID OpenStack
Login i hasło OpenStack możesz wygenerować postępując zgodnie z informacjami zawartymi w tym [przewodniku](/guides/public-cloud/cross-functional/create-and-delete-a-user).
