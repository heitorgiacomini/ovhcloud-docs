...
description: Find here the main swift commands to manage your object containers
...
See the [Curl command memo](/guides/storage-and-backup/object-storage/pcs-curl-commands-memo) documentation for the manifest upload.
:::
...
:::info
In this example, the LargeObject was uploaded in SLO mode.
Please refer to the [Curl Command Memo](/guides/storage-and-backup/object-storage/pcs-curl-commands-memo) documentation for the manifest upload.
:::
