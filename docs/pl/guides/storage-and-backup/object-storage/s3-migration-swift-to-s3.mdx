...
- For your source container: we recommand using your OpenStack user and associated rclone config file from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. Follow the steps in [this guide](/guides/storage-and-backup/object-storage/pcs-sync-rclone-object-storage) to access the config file associated to your OpenStack user.
