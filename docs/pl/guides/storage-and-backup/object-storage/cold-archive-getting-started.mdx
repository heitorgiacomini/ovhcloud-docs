...
description: This guide shows you how to manage your data with Cold Archive
...
To learn more about this storage class, see our guide "[Choosing the right storage class for your needs](/guides/storage-and-backup/object-storage/s3-choosing-the-right-storage-class-for-your-needs)".
...
As explained in detail in the [Cold Archive FAQ](/guides/storage-and-backup/object-storage/cold-archive-faq), there are two ways of consuming Cold Archive:
...
- [Getting started with Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage#using-aws-cli)
- `awscli` version >= 1.16.62

## Instructions

:::info
You can find the Cold Archive v1 presentation and workflow [here](/guides/storage-and-backup/object-storage/cold-archive-overview).
:::
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud Control Panel">
    Click the <code className="action">⋮</code> button then select <code className="action">Archive</code>
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud Control Panel">
    Click the <code className="action">⋮</code> button then select <code className="action">Restore</code>.
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud Control Panel">
    Click on the <code className="action">⋮</code>, then select <code className="action">Delete</code>.
