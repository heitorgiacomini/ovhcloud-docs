...
description: Find here the technical limits of the Object Storage offer
...
Discover how to maximize your performance with [this guide](/guides/storage-and-backup/object-storage/s3-performance-optimization).
...
| **Maximum lifecycle rules** | 1,000 | Understanding [lifecycle rules](/guides/storage-and-backup/object-storage/s3-bucket-lifecycle) |
| **Maximum replication rules** | 1,000 | Understanding [bucket replication](/guides/storage-and-backup/object-storage/s3-asynchronous-replication) |
| **Maximum bucket tags** | 50 | - |
| **Maximum object tags** | 10 | - |
| **Maximum number of versions per object** | 100,000 | Beyond this value, a 403 error is returned with MaxVersionsReached code. Understanding [object versioning](/guides/storage-and-backup/object-storage/s3-versioning) |
...
Read our guide on [Object Storage - Compatibility](/guides/storage-and-backup/object-storage/s3-s3-compliancy).
