...
description: FAQ dotyczący rozwiązania Entreprise File Storage
...
Tak, usługa ta jest dostępna bezpośrednio w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, w sekcji <code className="action">Bare Metal Cloud</code>, następnie <code className="action">Storage i Backup</code>.
