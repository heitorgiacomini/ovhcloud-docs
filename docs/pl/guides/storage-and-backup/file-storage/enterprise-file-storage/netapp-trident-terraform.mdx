...
description: Dowiedz się, jak wykorzystać moduł Terraform do wdrożenia stosu infrastruktury dla NetApp Trident CSI z Enterprise File Storage oraz Managed Kubernetes Service
...
<img className="thumbnail" alt="Architektura modułu Terraform" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-terraform/terraform-module-architecture.png" loading="lazy" />
...
| Wymagana brama | Klaster MKS wymaga bramy, aby uzyskać dostęp do OVHcloud API |
...
Postępuj zgodnie z przewodnikiem [Pierwsze kroki z OVHcloud API](/guides/manage-and-operate/api/first-steps/), aby wygenerować swój token API.
...
Po wdrożeniu infrastruktury za pomocą tego modułu skonfiguruj Trident CSI tak, aby korzystał z Enterprise File Storage. Postępuj zgodnie z przewodnikiem [Pierwsze kroki z Trident CSI](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/), aby uzyskać szczegółowe instrukcje.
...
- [Pierwsze kroki z Trident CSI](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/)
- [Zarządzanie Enterprise File Storage za pomocą dostawcy OVHcloud Terraform](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-terraform/)
...
Jeśli potrzebujesz szkolenia lub pomocy technicznej w celu wdrożenia naszych rozwiązań, skontaktuj się z przedstawicielem handlowym lub przejdź na stronę [Professional Services](/links/professional-services), aby uzyskać wycenę i poprosić o spersonalizowaną analizę projektu od naszych ekspertów z zespołu Professional Services.
