...
description: Dowiedz się, jak migrować dane z jednego NAS-HA do innego za pomocą zasobu NFS.
...
- Uruchomienie usługi NAS-HA przed jej rozpoczęciem zgodnie z instrukcją [montowania usługi NAS-HA przy użyciu protokołu NFS](/guides/storage-and-backup/file-storage/ha-nas/nas-nfs).
