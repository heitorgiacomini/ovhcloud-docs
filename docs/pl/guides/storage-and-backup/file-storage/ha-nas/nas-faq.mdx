...
Tak, ta przestrzeń jest dostępna w <ManagerLink to="/">Panelu klienta OVHcloud</ManagerLink>, w rubryce <code className="action">Bare Metal Cloud</code>, następnie <code className="action">NAS i CDN</code>.
...
W każdej chwili możesz również tworzyć ręczne snapshoty, przechowywać je bez ograniczeń czasowych lub je usuwać. Funkcja ta jest dostępna w Panelu <ManagerLink to="/">klienta OVHcloud</ManagerLink> lub za pośrednictwem [następującego wywołania API](https://eu.api.ovh.com/):
