...
- a facility to ensure fields suits the [LDP naming conventions](/guides/manage-and-operate/observability/logs-data-platform/field-naming-conventions).
...
* Fields are types using the [LDP naming convention](/guides/manage-and-operate/observability/logs-data-platform/field-naming-conventions): `manager.age` is renamed `manager_age_int`
