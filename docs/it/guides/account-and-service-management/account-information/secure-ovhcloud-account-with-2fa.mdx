...
description: Come rendere più sicuro il tuo account OVHcloud attivando la doppia autenticazione (2FA)
...
- Aver letto i [consigli su come gestire la password di accesso al tuo account](/guides/account-and-service-management/account-information/manage-ovh-password).
...
- **Link diretto:** <ManagerLink to="/#/account/useraccount/security">Sicurezza</ManagerLink>
...
Nella pagina <ManagerLink to="/#/account/useraccount/security">Sicurezza dell'account</ManagerLink>, clicca su <code className="action">Attiva l'autenticazione a due fattori</code>.

**Clicca sulla scheda corrispondente al metodo che preferisci:**

<Tabs>
  <Tab label="SMS">
    Scegli il metodo SMS e clicca su <code className="action">Continua</code>.
...
L’autenticazione a due fattori è attiva. ed è possibile aggiungere altri numeri.
  ...
  <Tab label="Applicazione Mobile">
    Scegli il metodo applicazione mobile e clicca su <code className="action">Continua</code>.
...
Viene generato un codice QR, scansionalo tramite l’applicazione OTP. Se l’applicazione OTP non dispone di questa opzione, clicca su <code className="action">Mostra il codice segreto</code> per visualizzare il codice da inserire nell’applicazione OTP.<br/>
...
L’autenticazione a due fattori è attiva.
  ...
  <Tab label="Chiave di sicurezza">
    Seleziona il metodo con chiave di sicurezza e clicca su <code className="action">Continua</code>.
...
Accedi alla <ManagerLink to="/">pagina di accesso allo Spazio Cliente OVHcloud</ManagerLink> e inserisci identificativo (o indirizzo email principale) e password.

Nella schermata di login viene visualizzato l’ultimo metodo di autenticazione a due fattori utilizzato o inserito. Per utilizzarne un altro, clicca sul pulsante <code className="action">Prova un altro metodo</code>.
...
Per rimuovere un dispositivo, accedi alla pagina <ManagerLink to="/#/account/useraccount/security">Sicurezza dell'account</ManagerLink> e clicca sui <code className="action">...</code> a destra del dispositivo da rimuovere e poi su <code className="action">Eliminare</code>.
...
Verrà inviato un codice di conferma finale per il dispositivo da rimuovere. Inserisci il codice nella finestra che si apre e clicca su <code className="action">Conferma</code> per completare l’eliminazione.
...
Una volta eliminati tutti i dispositivi, disattiva i codici di sicurezza cliccando sul pulsante <code className="action">Disattiva i codici 2FA</code>.
...
Per prima cosa, accedi alla <ManagerLink to="/">pagina di autenticazione dello Spazio Cliente OVHcloud</ManagerLink>.

Inserisci identificativo cliente OVHcloud e password per accedere alla fase di doppia autenticazione. Clicca sul pulsante <code className="action">Non ho più accesso al cellulare, alla chiave di sicurezza U2F o ai codici di backup</code>.<br/>
Se non vedi questo pulsante, clicca sul pulsante <code className="action">Prova un altro metodo</code> e poi su <code className="action">Non ho più accesso al cellulare, alla chiave di sicurezza U2F o ai codici di backup</code>.
...
<summary>Elenco dei giustificativi</summary>
