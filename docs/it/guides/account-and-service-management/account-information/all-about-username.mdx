...
description: "Scopri come ottimizzare la sicurezza del tuo account OVHcloud, gestire le tue informazioni personali e delegare l'accesso al tuo account."
...
- Aver creato [il tuo account OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation)
...
- **Link diretto:** <ManagerLink to="/#/account/useraccount/infos">Il mio profilo</ManagerLink>
- **Percorso di navigazione:** Clicca sul tuo nome in alto a destra > <code className="action">Accedere al mio account</code> > <code className="action">Modifica il tuo profilo</code>

---
{/* CP-NAV-END:account-profile */}

:::info
In caso di difficoltà di connessione al tuo account, consulta la sezione "[Non riesco a connettermi](/guides/account-and-service-management/account-information/ovhcloud-account-login#login-failure)" della nostra guida [Accedere allo Spazio Cliente OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-login).
...
La sicurezza dei tuoi servizi e dati dipende dall'efficacia della tua password. La password deve essere **complessa, unica e rinnovata regolarmente**.

Per maggiori informazioni sulle password, consulta la guida [Modificare la password del tuo account](/guides/account-and-service-management/account-information/manage-ovh-password).

#### Salva la password

Se non l'hai ancora fatto, salva la password in un [gestore di password](/guides/account-and-service-management/account-information/manage-ovh-password#utilizza-un-software-per-la-gestione-di-password).

:::info
I software **KeePass** e **Bitwarden** sono gestori di password gratuiti e open source.
...
Per inserire questo indirizzo email di recupero, accedi al tuo <ManagerLink to="/#/account/useraccount/infos">profilo utente</ManagerLink>.
...
Evita di utilizzare indirizzi email associati a un dominio che gestisci direttamente dal tuo Spazio Cliente. In caso di interruzione di questo dominio, non riceverai più le nostre notifiche. In questo caso, segui [le procedure indicate in questa guida](/guides/account-and-service-management/account-information/ovhcloud-account-login#invalid-email).
...
Per maggiori informazioni, consulta la nostra guida [Proteggere un account OVHcloud con la doppia autenticazione](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
È possibile modificare le informazioni del tuo account. Accedi al tuo <ManagerLink to="/#/account/useraccount/infos">profilo utente</ManagerLink>.

Modifica le informazioni e clicca su <code className="action">Salva le modifiche</code>.
...
Per modificare l’indirizzo che hai inserito come contatto principale, è necessario confermare la nuova email inserendo il codice ricevuto all’indirizzo del contatto principale attuale. Una volta ricevuto il codice, clicca sul pulsante <code className="action">Ho ricevuto il codice di conferma</code>.

<img className="thumbnail" alt="identificativo cliente" src="/images/account-and-service-management/account-information/all-about-username/nichandle07.png" loading="lazy" />

Inserisci il codice nel campo `Codice di conferma` e conferma l'operazione.

<img className="thumbnail" alt="identificativo cliente" src="/images/account-and-service-management/account-information/all-about-username/nichandle08.png" loading="lazy" />
...
<img className="thumbnail" alt="identificativo cliente" src="/images/account-and-service-management/account-information/all-about-username/nichandle09.png" loading="lazy" />

Una volta inseriti tutti i dati, clicca sul pulsante <code className="action">Conferma</code>.
...
- la propria password;
- la propria doppia autenticazione.

Come utente principale dell'account, mantieni il controllo degli utenti e dei loro diritti.

Per maggiori informazioni, consulta la [guida sulla gestione degli utenti](/guides/account-and-service-management/account-information/ovhcloud-users-management).

#### Gestisci i contatti

È possibile delegare la gestione amministrativa **o** tecnica **o** di fatturazione di uno o più servizi del tuo account a un altro account OVHcloud. Per saperne di più, consulta [la guida sulla gestione dei contatti](/guides/account-and-service-management/account-information/managing-contacts).

### Che fare in caso di sospetta usurpazione d’identità?

Se ricevi una email che indica un accesso sconosciuto al tuo Spazio Cliente, ti consigliamo di [modificare immediatamente la password del tuo account](/guides/account-and-service-management/account-information/manage-ovh-password#modifica-la-password) e di [proteggerlo tramite l’attivazione della doppia autenticazione](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
[Modifica la password del tuo account](/guides/account-and-service-management/account-information/manage-ovh-password)
...
[Se la connessione allo Spazio Cliente non funziona](/guides/account-and-service-management/account-information/ovhcloud-account-login#login-failure)
