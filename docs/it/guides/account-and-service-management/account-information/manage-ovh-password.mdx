...
description: Come definire, modificare e gestire la tua password dallo Spazio Cliente
...
Per maggiori informazioni sulla sicurezza delle password, consulta la sezione [Per saperne di più](/guides/account-and-service-management/account-information/manage-ovh-password#per-saperne-di-piu) di questa guida.
...
- Nella pagina <ManagerLink to="/#/account/useraccount/security">Sicurezza dell'account</ManagerLink>, clicca sul pulsante <code className="action">Modificare</code> in corrispondenza della voce “Password”.
...
- A questo punto compare un messaggio che conferma che l’operazione eseguita è andata a buon fine. Clicca su <code className="action">Continua</code> per essere reindirizzato alla pagina di login. Inserisci l’identificativo e la nuova password.

<a name="lost-password"></a>

#### Se non ricordi più la password

- Nella pagina di accesso allo Spazio Cliente clicca su <code className="action">Non ricordi identificativo o password?</code>.
...
- Inserisci l’identificativo cliente o l’indirizzo email principale associato all’account OVHcloud e clicca su <code className="action">Invia</code>.
