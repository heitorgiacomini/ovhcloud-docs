...
Per creare un account OVHcloud, accedi a <ManagerLink to="/">questa pagina</ManagerLink> e clicca su <code className="action">Crea un account</code>.
...
Successivamente inserisci il tuo indirizzo email e crea una password di accesso all’account OVHcloud.
