...
description: Scopri come rinnovare un servizio utilizzando l’API OVHcloud
...
- Disporre delle [credenziali di accesso per connettersi alle API - EN](/guides/manage-and-operate/api/first-steps)

## Procedura

Per utilizzare l'[API di rinnovo](https://api.ovh.com/console/#/service/&#123;serviceId&#125;/renew#GET), è necessario avere il `serviceId`. Puoi ottenere questo dato con l’API `serviceInfos`, come nel seguente esempio:
...
* `renewPeriod`: una durata di rinnovo (formattata ISO 8601)
