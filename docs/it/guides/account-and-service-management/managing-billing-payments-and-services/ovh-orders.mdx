...
* Clicca sul pulsante <code className="action">...</code> davanti al tuo ordine.
* Seleziona <code className="action">Stato dell'ordini</code>. Il controllo dell'ordine può essere visualizzato anche cliccando sullo stato dell'ordine nella colonna `Stato`.
