...
description: Explanation of the different types of billing (hourly and monthly) on the Hosted Private Cloud solution
...
In your vSphere client, you can order resources (hosts and datastores) by the hour, via the <code className="action">Add OVH Host</code> and <code className="action">Add OVH Storage</code> tabs.
...
If you keep a Premier range host billed on an hourly basis for an entire month, the hourly price for the resource, as shown on [this page](https://www.ovhcloud.com/it/enterprise/products/hosted-private-cloud/hosts/), will be applied. The hourly cost is no longer included in the monthly price.

#### Ordering a Host via the vSphere Client

On your vSphere client, go to the <code className="action">Add OVH Host</code> tab, and you will see the different types of hosts compatible with your infrastructure.
...
<img className="thumbnail" alt="host history" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_start.png" loading="lazy" />

By clicking <code className="action">Next</code>, you will land on the summary and confirmation request for your order.

<img className="thumbnail" alt="command summary" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_recap.png" loading="lazy" />

Click <code className="action">Next</code> again, and the command will be executed. You can then click on the <code className="action">Finish</code> button to return to the first page of this tab.

<img className="thumbnail" alt="command validated" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_finish.png" loading="lazy" />

#### Ordering a Datastore via the vSphere Client

The procedure for ordering a datastore is similar to that for ordering a host.

Go to your vSphere client, then click on the <code className="action">Add OVH Storage</code> tab. You will find a list of datastores compatible with your infrastructure, their size, real-time availability and hourly rates.

<img className="thumbnail" alt="datastore command" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_datastore_start.png" loading="lazy" />
...
You can order monthly resources via the OVHcloud Control Panel, in the <code className="action">datacentre</code> tab of your Hosted Private Cloud.
...
In the OVHcloud Control Panel, you can order a host by clicking the <code className="action">Order host</code> button. A window will open, giving you the choice of hosts in your infrastructure, with CPU/RAM resources and the monthly price ex. VAT.

You can order several at once.

<img className="thumbnail" alt="host command" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_manager.png" loading="lazy" />

By clicking <code className="action">Next</code>, you will have a summary of the order, and will be asked to accept the terms of use for the service.

<img className="thumbnail" alt="host command confirmation" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_manager_confirm.png" loading="lazy" />
...
In the OVHcloud Control Panel, the different types of datastore will be displayed in the window that opens, by clicking on <code className="action">Order a datastore</code>.

<img className="thumbnail" alt="datastore command" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_datastore_manager.png" loading="lazy" />

Then confirmation.

<img className="thumbnail" alt="datastore order confirmation" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_datastore_manager_confirm.png" loading="lazy" />
...
From your OVHcloud Control Panel, you can activate SPLA licenses in order to [deploy Windows virtual machines with an OVHcloud license](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).

After clicking the <code className="action">Activate SPLA</code> button, the following window will open:

<img className="thumbnail" alt="activate SPLA" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-activate_spla.png" loading="lazy" />
...
Billing is based on the pricing table available on [this page](https://www.ovhcloud.com/it/enterprise/products/hosted-private-cloud/images-licenses/). 
...
Activation is done on the button available in the <code className="action">Backup</code> tab. You will need to confirm the activation in the window that opens.

<img className="thumbnail" alt="activate Veeam" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-activate_veeam.png" loading="lazy" />
