...
description: Come gestire le ACL di un volume Enterprise File Storage utilizzando le API OVHcloud
...
- Essere connesso alla pagina delle [API OVHcloud](https://eu.api.ovh.com/)
...
Tutte le rotte API utilizzate per questa guida sono disponibili nella sezione */storage*: [https://api.ovh.com/console/#/storage](https://api.ovh.com/console/#/storage).
...
| `NetAppShareACLRule.accessTo` | Yes | Indirizzo IP o intervallo di indirizzi IP in notazione CIDR. |
