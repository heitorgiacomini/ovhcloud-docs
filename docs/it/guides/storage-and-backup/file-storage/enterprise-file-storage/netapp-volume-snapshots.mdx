...
description: Come gestire gli Snapshot di un volume Enterprise File Storage utilizzando le API OVHcloud
...
Tutte le API utilizzate per questa guida sono disponibili nella sezione */storage*: [https://api.ovh.com/console/#/storage](https://api.ovh.com/console/#/storage).
...
| `serviceName` | Yes | ID del servizio |
| `shareId` | Yes | ID del volume |
| `NetAppShareSnapshot.description` |  | Descrizione dello Snapshot |
| `NetAppShareSnapshot.name` |  | Nome dello Snapshot |
...
| `serviceName` | Yes | ID del servizio |
| `shareId` | Yes | ID del volume |
| `snapshotId` | Yes | ID dello snapshot |
