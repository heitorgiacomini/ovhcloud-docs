...
description: Distribuisci NetApp Trident CSI su OVHcloud Enterprise File Storage per gestire volumi e snapshot in Kubernetes
...
- Un servizio [Enterprise File Storage](https://www.ovhcloud.com/it/storage-solutions/enterprise-file-storage/) nel proprio account OVHcloud
- Un cluster [OVHcloud Managed Kubernetes](https://www.ovhcloud.com/it/public-cloud/kubernetes/)
- Un [vRack](https://www.ovhcloud.com/it/network/vrack/) con [vRack Services](/guides/network/vrack-services/global) configurato
- Conoscenza delle [API OVHcloud](/guides/manage-and-operate/api/first-steps) e/o della [CLI OVHcloud](/guides/manage-and-operate/cli/getting-started)
...
<img className="thumbnail" alt="Schema dei prerequisiti Trident" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/trident_efs_requirements.excalidraw.png" loading="lazy" />
...
[Enterprise File Storage - Configurazione della rete privata](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-network-config)

[Enterprise File Storage - Connettere un'istanza Public Cloud a un volume EFS tramite la rete privata vRack](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-pci-connection-via-vrack)

[Gestione degli account di servizio OVHcloud tramite l'API](/guides/manage-and-operate/api/manage-service-account)
