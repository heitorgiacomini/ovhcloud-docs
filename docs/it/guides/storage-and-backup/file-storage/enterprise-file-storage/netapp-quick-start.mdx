...
description: Iniziare a utilizzare la soluzione Enterprise File Storage con le API OVHcloud
...
- Saper [eseguire il mount di un NAS tramite NFS](/guides/storage-and-backup/file-storage/ha-nas/nas-nfs)
