...
description: FAQ sulla soluzione Entreprise File Storage
...
Sì, il servizio è direttamente accessibile dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, nella sezione <code className="action">Bare Metal Cloud</code>, poi <code className="action">Storage e Backup</code>.
