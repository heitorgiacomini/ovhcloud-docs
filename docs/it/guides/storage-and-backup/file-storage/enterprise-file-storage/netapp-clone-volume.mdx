...
:::info
È possibile creare un volume e uno Snapshot di tipo `manual` tramite l'[API OVHcloud](https://eu.api.ovh.com/) o dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
