...
description: "Scopri i principi di funzionamento dell'offerta Enterprise File Storage"
...
L'account OVHcloud è di default il contatto amministratore, tecnico e di fatturazione del servizio. Per maggiori informazioni consulta la nostra guida "[Gestire i contatti dei propri servizi"](/guides/account-and-service-management/account-information/managing-contacts).
...
Per maggiori informazioni consulta la guida ["Gestire i volumi"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volumes).
...
Per maggiori informazioni, consulta la guida ["Gestire le ACL di un volume"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-acl).
...
Per maggiori informazioni, consulta la guida ["Gestire gli Snapshot di un volume"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-snapshots).
