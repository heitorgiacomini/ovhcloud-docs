...
Sì, questo spazio è accessibile dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, sezione <code className="action">Bare Metal Cloud</code>, poi <code className="action">NAS e CDN</code>.
...
In qualsiasi momento è inoltre possibile creare Snapshot manuali, conservarli senza limite di durata o eliminarli. Questa funzionalità è disponibile nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> o tramite [API](https://eu.api.ovh.com/):
