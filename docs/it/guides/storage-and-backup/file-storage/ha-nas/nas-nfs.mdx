...
description: Come connettersi al tuo NAS-HA utilizzando una condivisione NFS
...
- [Aver creato una partizione sul tuo servizio con il protocollo NFS attivo](/guides/storage-and-backup/file-storage/ha-nas/nas-get-started#partition)
- [Avere un record ACL per l'indirizzo IP del server](/guides/storage-and-backup/file-storage/ha-nas/nas-get-started#addaccess)
...
Ti ricordiamo inoltre il **nome interno** e **l'indirizzo IP** del tuo servizio NAS-HA, che troverai nell'email ricevuta dopo l'installazione o nel tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
...
Nell'interfaccia di amministrazione Proxmox, clicca su <code className="action">Storage</code> nel menu verticale.

<img className="thumbnail" alt="proxmox" src="/images/storage-and-backup/file-storage/ha-nas/nas-nfs/proxmox1.png" loading="lazy" />

Clicca sul pulsante <code className="action">Add</code> e seleziona <code className="action">NFS</code>.
...
Clicca su <code className="action">Add</code> per montare la tua partizione.

### VMware ESXI

Dall'interfaccia di amministrazione VMware ESXI, clicca su <code className="action">Storage</code> nel menu a sinistra.

Clicca sul pulsante <code className="action">New datastore</code> per aprire l'assistente.

<img className="thumbnail" alt="ESXI" src="/images/storage-and-backup/file-storage/ha-nas/nas-nfs/esxi1.png" loading="lazy" />

Nella nuova finestra, seleziona <code className="action">Mount NFS datastore</code> e clicca su <code className="action">Next</code>.
...
Clicca su <code className="action">Next</code>. Clicca su <code className="action">Finish</code> nell'ultimo step.
