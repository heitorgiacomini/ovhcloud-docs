---
title: Object Storage Swift - Sincronizzazione dei contenitori di oggetti (EN)
...
- [An environment that is ready to use the OpenStack API with the Swift client](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
- [OpenStack environment variables set](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
