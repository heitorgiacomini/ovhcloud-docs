...
- [Creare un utente per accedere a Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user#crea-un-utente-openstack)
...
- [Impostare le variabili d'ambiente OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#step-1-recupera-le-variabili)
