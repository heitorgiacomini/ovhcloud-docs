...
description: Configura la cancellazione automatica dei tuoi oggetti
...
- [Prepara il tuo ambiente di sviluppo per utilizzare l'API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
- [Imposta le variabili d'ambiente OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
