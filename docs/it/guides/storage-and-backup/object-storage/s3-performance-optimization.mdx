...
description: This guide walks you through various methods to optimise the performance of your Object Storage buckets, including using byte range fetches, multipart uploads and other methods
...
<img className="thumbnail" alt="Schema 1" src="/images/storage-and-backup/object-storage/s3-performance-optimization/sharding1.png" loading="lazy" />
...
- An [OVHcloud bucket](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) created
...
:::info
**Did you know?**
When you use a high level command to upload an object using the `cp` command, the AWS CLI automatically does a multipart-upload. To better optimise the default configuration values for multipart uploads (multipart_threshold, multipart_chunksize), you can consult [this article](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) and see the table explaining how to configure the AWS CLI.
:::
...
:::warning
Part numbers can range from 1 to 10,000 inclusive. You can check the technical limitations [here](/guides/storage-and-backup/object-storage/s3-limitations).
:::
...
To customize the default value on the AWS CLI, consult [this guide](/guides/storage-and-backup/object-storage/s3-optimise-the-sending-of-your-files).
...
<img className="thumbnail" alt="Schema 2" src="/images/storage-and-backup/object-storage/s3-performance-optimization/sharding2.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 3" src="/images/storage-and-backup/object-storage/s3-performance-optimization/sharding3.png" loading="lazy" />
...
<img className="thumbnail" alt="Schema 4" src="/images/storage-and-backup/object-storage/s3-performance-optimization/sharding4.png" loading="lazy" />
