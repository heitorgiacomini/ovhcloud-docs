...
You can restore an object in the Cold Archive storage class by using the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, OVHcloud APIs or by using the Amazon S3 REST API or CLI. 
