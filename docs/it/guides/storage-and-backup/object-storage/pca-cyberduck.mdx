...
description: Come configurare Cyberduck per gestire il tuo Public Cloud Archive
...
- Disporre delle credenziali utente (*OS_USERNAME*) e progetto (*OS_PROJECT_NAME* o *OS_TENANT_NAME*) è possibile scaricare il file "OpenRC" nel menu [Users and Roles](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#step-1-recupera-le-variabili) dallo <ManagerLink to="/">Spazio Cliente Public Cloud OVHcloud</ManagerLink>.
- Disporre della password utente OpenStack

Per modificare la password utente OpenStack, consulta [questa guida](/guides/public-cloud/cross-functional/create-and-delete-a-user).
...
Clicca su <code className="action">Connetti</code>. Una volta effettuato l'accesso, visualizzerai i dati relativi a cartelle e file.
