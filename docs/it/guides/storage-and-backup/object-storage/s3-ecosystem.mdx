...
| **Cohesity, Veritas NetBackup**  | Compatible - Certified | Officially supported, details can be found on [NetBackup Support Page - Compatibility Matrix](https://www.veritas.com/support/en_US/dpp.NetBackup)  | [Guide](/guides/storage-and-backup/object-storage/s3-cohesity-netbackup) | Coming Soon |
...
|**Velereo** | Compatible | N/A | [Guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/backup-restore-cluster-cloudcasa) |
