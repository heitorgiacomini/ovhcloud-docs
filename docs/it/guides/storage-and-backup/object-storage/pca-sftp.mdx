...
description: Come gestire il tuo servizio Public Cloud Archive
...
Per generare il tuo login e password OpenStack, consulta questa [guida](/guides/public-cloud/cross-functional/create-and-delete-a-user).
