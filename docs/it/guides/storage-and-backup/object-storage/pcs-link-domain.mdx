...
description: Configura un dominio su un container del tuo Object Storage
...
- [Aggiungi storage al tuo Cloud](/guides/storage-and-backup/object-storage/pcs-create-container)
- un dominio
