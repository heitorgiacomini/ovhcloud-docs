---
title: Object Storage - Utilizza Object Storage con Nextcloud (EN)
...
Click on your profile at the top right and then on <code className="action">Apps</code>.
...
Select the <code className="action">Disabled Apps</code> in the left panel.

Locate the **External storage support** application and click <code className="action">Enable</code>
...
Click on your avatar at the top right then on <code className="action">Settings</code>.
...
11. <code className="action">Validate</code>
...
Open the <code className="action">Files</code> application, select the <code className="action">External storage</code> menu then your <code className="action">bucket</code>.
