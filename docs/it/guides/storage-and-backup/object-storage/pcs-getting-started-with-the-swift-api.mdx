...
description: "Come utilizzare l'API Swift"
...
- [Preparare l'ambiente di sviluppo per utilizzare l'API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) installando python-swiftclient
...
Questo URL è composto da un punto terminale, disponibile dall'[interfaccia Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security), dal nome del container e dal nome del tuo oggetto (incluso il prefisso).
