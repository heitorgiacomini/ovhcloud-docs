...
description: Scopri come accedere ai tuoi archivi Public Cloud con Rsync
...
Per generare l'identificativo cliente e la password OpenStack, consulta questa [guida](/guides/public-cloud/cross-functional/create-and-delete-a-user).

### TenantName

Il TenantName corrisponde al nome del tuo progetto Horizon. Per ottenere il TenantName, accedi all'interfaccia web OpenStack: [https://horizon.cloud.ovh.net/](https://horizon.cloud.ovh.net/).
