...
- Un server Bare Metal su cui è installato Backup Agent. Consulta la nostra guida "[Come configurare la prima copia di backup](/guides/storage-and-backup/backup-agent/first-configuration)" per ulteriori informazioni.
...
Devi scaricare l'agente dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e installarlo sul tuo nuovo sistema operativo.
