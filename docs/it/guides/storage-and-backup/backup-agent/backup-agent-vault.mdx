...
Per trovare i tuoi Vaults, clicca su <ManagerLink to="/#/bmc-backup-agent-baremetal/service">questo link</ManagerLink> per accedere alla sezione <code className="action">Backup Agent</code>, poi clicca sull'etichetta <code className="action">Vaults</code>.
