...
description: Presentazione delle funzionalità e dei vantaggi del prodotto Backup Agent
...
Scoprite come navigare nella VSPC tramite [questa guida](/guides/storage-and-backup/backup-agent/vspc-presentation).
...
- L'archiviazione si basa sulla tecnologia [OVHcloud Object Storage](https://www.ovhcloud.com/it/public-cloud/object-storage/) che è ospitata nei datacenter OVHcloud.
