...
Per visualizzare e rimuovere le chiavi è possibile utilizzare il [portale API](https://eu.api.ovh.com/) o lo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>:
