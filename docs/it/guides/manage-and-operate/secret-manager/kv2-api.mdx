...
You can access the OKMS domain Swagger UI by clicking on the link in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, in your OKMS domain dashboard.

![swagger](/images/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/swagger.png)
...
![public-swagger-ui](/images/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/public-swagger-ui.png)
...
![firefox-cert-manager](/images/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/firefox-cert-manager.png)
...
- Go to the `Your certificates` tab. Click `Import` and select your `client.p12` file.
- You will be prompted to enter the password you used during the PKCS#12 file creation.
- After entering the password, your certificate will be imported and ready for use.

![chromium-cert-manager](/images/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/chromium-cert-manager.png)
...
![certificate-identification](/images/guides/manage-and-operate/secret-manager/secret-manager-kv2-api/firefox-identify-with-certificate.png)
