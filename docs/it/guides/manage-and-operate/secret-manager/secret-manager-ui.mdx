...
The Secret Manager is accessible from the `Identity, Security & Operations` menu in the `Security` section.

![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-onboarding.png)

To create a secret, click directly on the `Create a secret` button.
...
![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-creation.png)
...
![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-dashboard.png)
...
To do this, click on `Display the value` in the secret dashboard.

A side panel opens with the content of the most recent version of the secret.

![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-content.png)
...
![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-versions.png)
...
![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-multi-domaine.png)
...
![Secret Manager](/images/guides/manage-and-operate/secret-manager/secret-manager-ui/Secret-multi-domaine-2.png)
...
- A [REST API](/guides/manage-and-operate/secret-manager/rest-api) similar to OVHcloud's standard APIs.
- A [Hashicorp Vault KV2 compliant API](/guides/manage-and-operate/secret-manager/kv2-api) providing compatibility with applications already compatible with Hashicorp Vault KV2.
