...
description: "Scopri come scegliere e configurare i frontend del tuo servizio Load Balancer OVHcloud, per l'utilizzo con il protocollo HTTP/2."
...
- Un servizio [Load Balancer OVHcloud](https://www.ovhcloud.com/it/network/load-balancer/);
