...
description: "Questa guida ti mostra come determinare se un indirizzo IP è gestito, fornito e/o associato a un servizio OVHcloud tramite il sito dell'ICANN"
...
Una volta inserito l’indirizzo IP, clicca sul pulsante blu <code className="action">Lookup</code>.
