---
title: Documentazione di OVHgateway (EN)
...
You can use this guide: [OVHgateway replacement](/guides/hosted-private-cloud/nutanix-on-ovhcloud/software-gateway-replacement).
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and open the management section of your [vRack](https://www.ovhcloud.com/it/network/vrack/). Verify the Additional IP address used by the Nutanix Cluster.
