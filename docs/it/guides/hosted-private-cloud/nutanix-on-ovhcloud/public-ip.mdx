...
description: Find out how to use a public IP on a Ubuntu VM, created via API
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and add an Additional IP address to your [vRack](https://www.ovh.it/soluzioni/vrack/).
...
For [vRack](https://www.ovh.it/soluzioni/vrack/) purposes, the first, penultimate, and last addresses in any given IP block are always reserved for the network address, network gateway, and network broadcast respectively. This means that the first usable address is the second address in the block, as shown below:
...
Connect to Prism Central and go to <code className="action">Compute & Storage</code>, then <code className="action">Images</code>.

Click on the <code className="action">Add Image</code> button.

<img className="thumbnail" alt="clic add image" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image.png" loading="lazy" />

Paste the URL of a compatible cloud image, for example:

`https://cloud-images.ubuntu.com/focal/current/focal-server-cloudimg-amd64.img`

Click on <code className="action">Upload file</code> then <code className="action">Next</code>.

<img className="thumbnail" alt="clic add image" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image2.png" loading="lazy" />

Select <code className="action">Place image directly on clusters</code>, then select your cluster and <code className="action">Save</code>.

<img className="thumbnail" alt="clic add image" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/24-add-public-ip-on-vm/add-image3.png" loading="lazy" />
