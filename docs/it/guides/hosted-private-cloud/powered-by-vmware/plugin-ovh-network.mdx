...
description: Scopri come utilizzare il plugin OVHcloud Network con la soluzione Private Cloud
...
Accedi all’interfaccia vSphere e seleziona il tuo datacenter nel menu a sinistra. Posizionati nella scheda <code className="action">Configure</code> e, sotto “OVHcloud” nella colonna di navigazione a sinistra, clicca sulla voce <code className="action">Network</code> per visualizzare la sezione “Network summary”.

<img className="thumbnail" alt="Network summary" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Informazioni degli IP e blocchi" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_02.png" loading="lazy" />
...
In seguito è possibile personalizzare il “reverse” dell’indirizzo IP in questa tabella (ad esempio, durante la configurazione di un server di posta). Clicca sui tre puntini verticali a sinistra dell’indirizzo IP e seleziona <code className="action">Edit Reverse</code>.

<img className="thumbnail" alt="Pulsante Edit Reverse" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_03.png" loading="lazy" />

Inserisci il “reverse” e clicca su <code className="action">Confirm</code>: il nuovo valore apparirà nella tabella.

:::info
Questo processo di configurazione è disponibile anche nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. 
