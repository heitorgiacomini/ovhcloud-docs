...
- A [Public VCF as-a-Service](https://www.ovhcloud.com/it/lp/vmware-vcd-evolution/) on OVHcloud solution.
- Being the technical administrator of the managed [VMware vSphere on OVHcloud](https://www.ovhcloud.com/it/hosted-private-cloud/vmware/) infrastructure.
