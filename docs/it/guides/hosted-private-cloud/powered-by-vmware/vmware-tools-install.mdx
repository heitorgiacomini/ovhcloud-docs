...
description: Come installare VMware Tools su Linux e Windows
...
Per montare il disco dei VMware tools dal client Web Vsphere, clicca con il tasto destro della VM, poi clicca su <code className="action">Guest OS</code> e infine su <code className="action">Install VMware Tools</code>. 

<img className="thumbnail" alt="install VMware Tools" src="/images/hosted-private-cloud/powered-by-vmware/vmware-tools-install/tools.png" loading="lazy" />
