...
<img className="thumbnail" alt="VPN-SPN rules" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-Elligibility-Rules-2.svg" loading="lazy" />

* VPN-SPN can be attached to 1 or several vRack.
* Nx VPN-SPN can be attached to Nx vRack.

<img className="thumbnail" alt="VPN-SPN on same vRack" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-Elligibility-Rules-1.svg" loading="lazy" />
...
<img className="thumbnail" alt="Example IP configuration OCC" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-SPN-VPN-Routing-v0.svg" loading="lazy" />
