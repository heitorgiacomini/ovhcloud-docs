...
- Avere accesso all’[interfaccia vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion)
...
<img className="thumbnail" alt="Deploy di una VM" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm01.png" loading="lazy" />

Per creare una macchina virtuale è possibile scegliere tra diverse opzioni:

- da un file ISO, disponibile nel datastore (per importarlo, consulta [questa guida](/guides/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload))
- da un template personale o [fornito da OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template)
...
<img className="thumbnail" alt="Scelta della modalità di creazione" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm02.png" loading="lazy" />
...
<img className="thumbnail" alt="Localizzazione della macchina virtuale" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm03.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta delle risorse" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm04.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta dello storage" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm05.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta della compatibilità" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm06.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta del Guest OS" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm07.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta della rete" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm08.png" loading="lazy" />
...
<img className="thumbnail" alt="Scelta del file ISO" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm09.png" loading="lazy" />
...
<img className="thumbnail" alt="Connettere ISO" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm10.png" loading="lazy" />
...
<img className="thumbnail" alt="Riepilogo VM" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm11.png" loading="lazy" />
...
<img className="thumbnail" alt="Avvio VM" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm12.png" loading="lazy" />
