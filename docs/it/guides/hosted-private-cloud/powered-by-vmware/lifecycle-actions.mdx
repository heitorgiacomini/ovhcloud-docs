---
title: Ciclo di vita di VMware on OVHcloud - Determinare le azioni da intraprendere (EN)
...
- a [Hosted Private Cloud solution powered by VMware](https://www.ovhcloud.com/it/enterprise/products/hosted-private-cloud/)
...
Start by adding new datastores, using our guide on [adding storage](/guides/hosted-private-cloud/powered-by-vmware/how-to-add-storage).
...
Finally, delete your old datastores by following our guide on [deleting a datastore](/guides/hosted-private-cloud/powered-by-vmware/delete-datastore).
...
Start by adding new datastores by following the guide on [adding storage](/guides/hosted-private-cloud/powered-by-vmware/how-to-add-storage).
...
To complete your migration, you can follow this guide: [Migrate to a new infrastructure](/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc).
...
<img className="thumbnail" alt="control panel - retrieving vsphere version" src="/images/hosted-private-cloud/powered-by-vmware/lifecycle-actions/manager-version-vsphere.png" loading="lazy" />
...
<img className="thumbnail" alt="vSphere - data recovery" src="/images/hosted-private-cloud/powered-by-vmware/lifecycle-actions/vsphere-version-nsx-v.png" loading="lazy" />
