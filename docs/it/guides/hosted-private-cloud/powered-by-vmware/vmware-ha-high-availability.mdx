...
È necessario disattivarlo per effettuare operazioni di aggiornamento, ad esempio, con [l’update manager](/guides/hosted-private-cloud/powered-by-vmware/use-vmware-update-manager). In questo caso specifico, l’host è isolato.

<img className="thumbnail" alt="Attivazione HA" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="guasto dell’host" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="isolamento di host" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="database con PDL" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="database con APD" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Monitoraggio delle VM

Il monitoraggio delle macchine virtuali è disponibile dopo l’installazione dei [VMware tools](/guides/hosted-private-cloud/powered-by-vmware/vmware-tools-install).
...
<img className="thumbnail" alt="Monitoraggio delle MV" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
