...
description: Come funziona lo Snapshot orario OVHcloud
...
I file sono presenti adesso, è sufficiente aggiungere questa macchina nel tuo **inventario** cliccando sul file `.vmx` e poi sul <code className="action">register VM</code> in alto.
...
Ti consigliamo di utilizzare una soluzione completa di backup, come il servizio [Veeam Backup](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service) o qualsiasi altro sistema che effettui un backup completo delle tue macchine virtuali.
