...
- il token
- un link che consente di confermare l’operazione (attenzione: se l’indirizzo IP della rete a cui è connesso il telefono [non è autorizzato](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#sicurezza), la pagina non verrà visualizzata).
...
<img className="thumbnail" alt="Conferma dell’operazione" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
<img className="thumbnail" alt="token operation" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />

A questo punto gli utenti che dispongono del permesso **token validator** riceveranno un SMS di questo tipo:

<img className="thumbnail" alt="Secondo SMS" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/SMS2.png" loading="lazy" />
...
<img className="thumbnail" alt="Modifica la password" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Definisci la password" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Password dimenticata" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />
...
<img className="thumbnail" alt="Informazioni utente" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Token e password" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
