...
:::info
Per conoscere gli indirizzi IP riservati al tuo blocco e il relativo utilizzo, consulta la nostra guida sul [plugin OVHcloud Network](/guides/hosted-private-cloud/powered-by-vmware/plugin-ovh-network).
...
È possibile seguire la migrazione del blocco IP dal tuo<ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> nella sezione<code className="action">Hosted Private Cloud</code> > <code className="action">Private Cloud</code>. Clicca sul tuo servizio Hosted Private Cloud, quindi sulla scheda <code className="action">Operazioni</code>.
