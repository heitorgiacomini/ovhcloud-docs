...
With [OVHcloud vRack](https://www.ovhcloud.com/it/network/vrack/), you can create up to 4,000 VLANs, which allows you to replicate your current IP address plan without any re-IP.
...
For internet-exposed services, allocate additional public IPs or use the [Bring Your Own IP (BYOIP)](https://www.ovhcloud.com/it/network/byoip/) feature to retain your existing IP addresses.
...
For higher bandwidth and lower latency, you can subscribe to [OVHcloud Connect](https://www.ovhcloud.com/it/network/ovhcloud-connect/), which provides an MPLS-like link between your on-prem infrastructure and your OVHcloud tenant.

With [OVHcloud Connect](https://www.ovhcloud.com/it/network/ovhcloud-connect/), latency is controlled, and you can choose the bandwidth you need, from 200 Mbps up to several Gbps.
...
Move VMs to target storage using [Storage vMotion](/guides/hosted-private-cloud/powered-by-vmware/storage-vmotion) and configure backup jobs in [OVHcloud Object Storage](https://www.ovhcloud.com/it/public-cloud/object-storage/) to protect your workloads.
...
1. **Define Backup Storage:**
    - Use OVHcloud **[S3*-compatible Object Storage](https://www.ovhcloud.com/it/public-cloud/object-storage/)** as a backup repository for scalability and cost efficiency.
...
- [Veeam Managed Backup](https://www.ovhcloud.com/it/hosted-private-cloud/vmware/veeam-managed-backup/): A fully managed backup solution by OVHcloud.
- [Zerto for VMware on OVHcloud](https://www.ovhcloud.com/it/hosted-private-cloud/vmware/zerto/): Disaster recovery and replication across regions.
