...
<img className="thumbnail" alt="Scansione codice QR" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/scanQRcode.png" loading="lazy" />
...
<img className="thumbnail" alt="Connessione 2FA" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/2FAtoken.png" loading="lazy" />
...
Queste applicazioni devono essere precedentemente autorizzate attraverso una politica di accesso al vCenter che può essere configurata nello [Spazio Cliente](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#sicurezza).
