...
description: Gestire la ripartizione del carico con la funzione DRS
...
Se la funzione DRS non è già attiva nel tuo cluster, selezionalo e poi clicca sulla scheda <code className="action">Configura</code>.

Clicca sul menu <code className="action">Servizi</code> e poi sul sottomenu <code className="action">vSphere DRS</code>.

Clicca su <code className="action">Modifica</code> e attiva il cursore `vSphere DRS` per attivare la funzionalità DRS.

<img className="thumbnail" alt="Attivazione di ACE" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="automazione DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="opzioni aggiuntive DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="opzioni avanzate drs" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### Le regole DRS

Per la gestione delle regole VM/host clicca sulla scheda `Configura`.

<img className="thumbnail" alt="regole drs" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
La quarta regola, “Da macchine virtuali a macchine virtuali” è spiegata nella nostra guida sulla funzione [funzione HA](/guides/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability).

<img className="thumbnail" alt="creazione regole drs" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
