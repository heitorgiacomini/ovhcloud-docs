...
- A [Hosted Private Cloud VMware on OVHcloud](https://www.ovhcloud.com/it/hosted-private-cloud/vmware/) offer.
...
- You must have sufficient IAM rights with your OVHcloud service account and Hosted Private Cloud KMS resources. See the following guides:
    ...
    - [IAM for VMware on OVHcloud - How to enable IAM](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-activation).
    - [IAM for VMware on OVHcloud - How to create an IAM vSphere role](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-role).
    - [IAM for VMware on OVHcloud - How to associate a vSphere role and a user with an IAM policy](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-role-policy).
...
:::warning
Think carefully about the dependencies of your infrastructure on the key server. For more information, see [Guide 2 - HPC - Enable VM encryption with OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt).
...
- [Guide 5 - HPC - Enabling VM encryption with an external KMS](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt)

For this option, we will use a **Standard Key Provider** in vSphere.

<img className="thumbnail" alt="Standard Key Provider" src="/images/hosted-private-cloud/powered-by-vmware/vmware-overall-vm-encrypt/key_provider.png" loading="lazy" />
...
- [Guide 2 - HPC - Enable VM encryption with OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt)
...
- [Guide 2 - HPC - Enable VM encryption with OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#activation-okms)
...
- [Guide 2 - HPC - Enable VM encryption with OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#add-okms)
...
- [Guide 2 - HPC - Enable VM encryption with OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#activation-encryption) 

If you have a few gray areas on all the steps to follow, from the order up to the activation of VM encryption, use the [guide 2 summary](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#summary) 
...
<img className="thumbnail" alt="Native Key Provider" src="/images/hosted-private-cloud/powered-by-vmware/vmware-overall-vm-encrypt/key_provider_native.png" loading="lazy" />

This guide will detail the steps you need to follow:

- [Guide 4 - HPC - Enabling VM encryption with a vNKP](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt-vnkp) 
...
If you require training or technical support to implement your migration with Public VCF as-a-Service, please contact your TAM or [click here](https://www.ovhcloud.com/it/professional-services/) to get a quote and request a custom analysis of your project from our Professional Services team experts.
