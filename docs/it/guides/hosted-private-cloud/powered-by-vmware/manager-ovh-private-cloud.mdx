...
- Essere connesso allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, sezione <code className="action">Hosted Private Cloud</code> > <code className="action">Private Cloud</code>.
...
Accedendo alla sezione <code className="action">Hosted Private Cloud</code> > <code className="action">Private Cloud</code> del tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, visualizzi le informazioni relative alla tua piattaforma:

<img className="thumbnail" alt="Informazioni generali" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel1.png" loading="lazy" />
...
<img className="thumbnail" alt="Informazioni generali" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel2.png" loading="lazy" />
...
<img className="thumbnail" alt="Opzioni" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel3.png" loading="lazy" />
...
<img className="thumbnail" alt="Opzioni" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel4.png" loading="lazy" />

Per maggiori dettagli sulla rescissione di un servizio Private Cloud, consulta la nostra guida [Disattivare una soluzione Private Cloud](/guides/account-and-service-management/managing-billing-payments-and-services/cancel-private-cloud).
...
<img className="thumbnail" alt="Utenti" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel6.png" loading="lazy" />
...
<img className="thumbnail" alt="Permessi utente per datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel7.png" loading="lazy" />
...
<img className="thumbnail" alt="Parametri di sicurezza" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel8.png" loading="lazy" />
...
Per maggiori dettagli su questa opzione consulta [questa guida](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt).

#### Operazioni

In questa scheda vengono mostrate le operazioni in corso sulla tua infrastruttura:

<img className="thumbnail" alt="Operazioni" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel9.png" loading="lazy" />
...
<img className="thumbnail" alt="Licenza SPLA Windows" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel10.png" loading="lazy" />
...
<img className="thumbnail" alt="Informazioni datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel11.png" loading="lazy" />
...
<img className="thumbnail" alt="Host" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel12.png" loading="lazy" />
...
<img className="thumbnail" alt="Datastore" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel13.png" loading="lazy" />
...
Per maggiori informazioni su questa opzione, consulta [questa guida](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service).
