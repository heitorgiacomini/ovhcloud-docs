...
Questa operazione è disponibile nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Accedi alla sezione Private Cloud, seleziona il servizio in questione e clicca sulla scheda <code className="action">Sicurezza</code>: compare una tabella che mostra gli indirizzi IP autorizzati o bloccati. Per aggiungerne di nuovi, clicca sul pulsante <code className="action">Aggiungi IP</code> a destra:

<img className="thumbnail" alt="Aggiunta di IP" src="/images/hosted-private-cloud/powered-by-vmware/vsphere-access-security-advices/adding_ip.png" loading="lazy" />

### Crea utenti specifici

Consigliamo vivamente di creare un accesso personale per ogni utente che ha bisogno di connettersi all’infrastruttura. Anche questa operazione è disponibile nello <ManagerLink to="/">Spazio Cliente</ManagerLink>: accedi alla scheda <code className="action">Utenti</code> e clicca sul pulsante <code className="action">Crea un utente</code>.

<img className="thumbnail" alt="Utenti" src="/images/hosted-private-cloud/powered-by-vmware/vsphere-access-security-advices/users.png" loading="lazy" />
...
<img className="thumbnail" alt="Modifica dei parametri degli utenti" src="/images/hosted-private-cloud/powered-by-vmware/vsphere-access-security-advices/users_edit.png" loading="lazy" />
...
Questa operazione è disponibile nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Accedi alla sezione Private Cloud, seleziona la scheda <code className="action">Sicurezza</code> e clicca sul pulsante <code className="action">Modifica la durata di una sessione </code> a destra.

<img className="thumbnail" alt="Scadenza della sessione" src="/images/hosted-private-cloud/powered-by-vmware/vsphere-access-security-advices/security-expiration.png" loading="lazy" />

A questo punto, inserisci il numero di minuti di validità di una sessione.

<img className="thumbnail" alt="Scadenza della sessione" src="/images/hosted-private-cloud/powered-by-vmware/vsphere-access-security-advices/expiration.png" loading="lazy" />
