...
Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and click on the <code className="action">Hosted Private Cloud</code> tab.
...
<img className="thumbnail" alt="Enable IAM" src="/images/hosted-private-cloud/powered-by-vmware/vmware-iam-activation/iam_enable_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Enable IAM" src="/images/hosted-private-cloud/powered-by-vmware/vmware-iam-activation/iam_enable_3.png" loading="lazy" />
...
You can now follow the guide [IAM for VMware on OVHcloud - How to create an IAM vSphere role](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-role).
