...
description: Come implementare una soluzione che eviti il blocco di una VM con il meccanismo DRS di VMware
...
- Attiva l'opzione [Veeam Backup Managed](https://www.ovhcloud.com/it/enterprise/products/hosted-private-cloud/veeam-backup-managed/).
...
Per applicare questa soluzione, clicca sul cluster corrispondente, clicca sulla scheda <code className="action">Configure</code> e seleziona <code className="action">VM/Host Rules</code>.
