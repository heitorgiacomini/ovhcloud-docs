...
description: Ricostruisci la configurazione del mirror RAID software su un server dedicato Windows dopo la sostituzione di un disco
...
Una volta connesso, clicca con il tasto destro sul pulsante <code className="action">Inizia</code> e apri <code className="action">Esegui</code>.
...
Inserisci `cmd` e clicca su <code className="action">OK</code>.
...
In questo esempio, il `Disk 1` è un disco sostitutivo installato per sostituire il `Disk M0` difettoso che era stato precedentemente [fisicamente rimosso](/guides/bare-metal-cloud/dedicated-servers/disk-replacement).
