...
Per maggiori informazioni, consulta la nostra guida sulla [sicurezza di un server dedicato](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server).
...
Per maggiori informazioni sull'accesso a questo tool, consulta [questa guida](/guides/bare-metal-cloud/dedicated-servers/ipmi).  
:::
