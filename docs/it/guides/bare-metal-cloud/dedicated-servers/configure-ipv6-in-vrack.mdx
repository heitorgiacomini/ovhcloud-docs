...
<img className="thumbnail" alt="pagina di configurazione" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurare un IPv6 in un vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="gestione vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="selezione vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="abilitazione SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/702.png" loading="lazy" />
...
- Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
...
<img className="thumbnail" alt="Configurare un IPv6 in un vRack per la modalità instradata" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/routed-mode-20240513.png" loading="lazy" />
...
<img className="thumbnail" alt="selezione vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="continua" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/800.png" loading="lazy" />

La subnet instradata `2001:41d0:abcd::ef10::/60` è raggiungibile tramite il next hop `2001:41d0:abcd::ef00::2`.

<img className="thumbnail" alt="continua" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/801.png" loading="lazy" />
...
<img className="thumbnail" alt="continua" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-02.png" loading="lazy" />
