...
description: Attiva OVHcloud Link Aggregation sul tuo server SLES 15
...
- [Aver configurato il NIC handle per la funzionalità OVHcloud Link Aggregation dallo Spazio Cliente OVHcloud](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager)
...
Clicca sulla scheda <code className="action">IPMI</code> (1) e poi sul pulsante <code className="action">Da un applet Java (KVM)</code> (2).
...
[Configurare l'aggregazione dei link OLA nel tuo Spazio Cliente](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager).

[Come configurare il NIC handle per aggregare i link OVHcloud su Debian 9](/guides/bare-metal-cloud/dedicated-servers/ola-enable-debian9).

[Come configurare il tuo NIC handle per aggregare i link OVHcloud con Windows Server 2019](/guides/bare-metal-cloud/dedicated-servers/ola-enable-w2k19).
