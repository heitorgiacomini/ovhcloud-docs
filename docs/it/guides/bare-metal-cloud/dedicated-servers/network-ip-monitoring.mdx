...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e seleziona la scheda <code className="action">Bare Metal Cloud</code>. Seleziona il server nel menu a tendina **Server dedicati**.
