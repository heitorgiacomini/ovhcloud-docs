...
* Due o più [server compatibili con la vRack](https://www.ovhcloud.com/it/bare-metal/)
* Accesso amministrativo (sudo) al server tramite SSH (Linux) o RDP (Windows)
* Accesso allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>
* Il range di indirizzi IP privati scelto
* Aver completato la [guida di configurazione della vRack](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server)
...
[Configurare due o più server dedicati nella vRack](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server)
