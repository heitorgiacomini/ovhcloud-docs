...
description: Scopri il servizio Bare Metal 3-AZ, che offre massima disponibilità e ridondanza tra tre datacenter
lastUpdated: 2025-06-04
---

## Obiettivo

OVHcloud propone il suo servizio Bare Metal nella [Region 3-AZ](https://www.ovhcloud.com/it/about-us/global-infrastructure/expansion-regions-az/), un'evoluzione significativa nella strategia di regionalizzazione dell'azienda. Disponibile nell'area metropolitana di Parigi, questo servizio rappresenta un nuovo standard del settore in termini di affidabilità e performance dei server Bare Metal.
...
Clicca sulla scheda <code className="action">3-AZ Clusters</code>.
...
Clicca sulla scheda <code className="action">Nodi</code> per aprire la lista dei server del cluster.
...
Cliccando sul nome di un server/nodo in questa lista si apre la scheda <code className="action">Informazioni generali</code> del server. Per maggiori informazioni, consulta la nostra guida:

[Come iniziare con un server dedicato](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server)
