...
<img className="thumbnail" alt="verificare la seconda interfaccia di rete" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-1.png" loading="lazy" />
