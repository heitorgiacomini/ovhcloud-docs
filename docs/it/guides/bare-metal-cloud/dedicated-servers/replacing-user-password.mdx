...
:::info
Per recuperare l'accesso a un server al quale ti connetti con una chiave SSH, consulta la nostra guida "[Come sostituire una coppia di chiavi SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)".
...
Utilizza la modalità di avvio **normal** del tuo server quando lo riavvii dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
