...
description: Come configurare la rete su Proxmox VE
...
- An [OVHcloud dedicated server](https://www.ovhcloud.com/it/bare-metal/)
- One or more [Additional IP addresses](https://www.ovhcloud.com/it/network/additional-ip/)
...
* A [server compatible with vRack](https://www.ovhcloud.com/it/bare-metal/)
* A [vRack service](https://www.ovhcloud.com/it/network/vrack/)
