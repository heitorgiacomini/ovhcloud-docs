...
description: Installa una chiave SSH OVHcloud sul tuo server dedicato per concedere un accesso amministrativo sicuro ai team di supporto OVHcloud
...
- Avere [accesso in SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) (sudo)
