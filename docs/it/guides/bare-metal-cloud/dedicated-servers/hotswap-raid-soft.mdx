...
description: Sostituisci un disco difettoso su un server dedicato con RAID software senza interruzione grazie alla procedura di hot-swap
...
A questo punto il disco malfunzionante è pronto per essere sostituito da un tecnico nel datacenter e, a intervento ultimato, non resta che risincronizzare il RAID. Per effettuare questa operazione, consulta la guida [Configurare un RAID software](/guides/bare-metal-cloud/dedicated-servers/raid-soft).
...
[Come configurare il software RAID di un server](/guides/bare-metal-cloud/dedicated-servers/raid-soft)

[OVHcloud API and Storage](/guides/bare-metal-cloud/dedicated-servers/partitioning-ovh)

[Hot Swap - RAID Hardware](/guides/bare-metal-cloud/dedicated-servers/hotswap-raid-hard)

[Gestire il RAID Hardware](/guides/bare-metal-cloud/dedicated-servers/raid-hard) (in inglese)
