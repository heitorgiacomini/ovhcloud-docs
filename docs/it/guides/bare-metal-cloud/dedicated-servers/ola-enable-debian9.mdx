...
Se la configurazione di rete del tuo sistema utilizza invece `Netplan`, fai riferimento a [questa guida](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-netplan).
...
<br/>Per attivare il tool accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Nella sezione <code className="action">Bare Metal Cloud</code>, seleziona il tuo server tra <code className="action">Server dedicati</code> e clicca sulla scheda <code className="action">IPMI</code> (1).
