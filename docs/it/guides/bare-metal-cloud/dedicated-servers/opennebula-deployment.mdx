...
### Step 1 - Setting up your OVHcloud infrastructure <a id="infrastructure_provisioning"></a>
...
Finally, from the OVHcloud Control Panel, open the `Network` section, then select `Public IP Addresses` under **Public Network**. Once you have reached the IP management interface, click on the `Order IPs` button near the top of the page. Choose the IP version, then **select the vRack your servers are attached to**, and the region where those servers are hosted.
...
![Network](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/opennebula_network.png)
...
#### Bare Metal network settings <a id="bare_metal_network_settings"></a>

From your OVHcloud Control Panel, navigate to `Bare Metal Cloud` section, then select `Dedicated servers`. Open both management pages for your dedicated servers, and collect the highlighted parameters :

![dedicated servers administration page](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/bare_metal_network.png)
...
![dedicated servers ip address](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/bare_metal_ip_address.png)
...
### Step 3 - Configure and deploy the Hosted Cloud OVHcloud repository <a id="initial_setup"></a>
...
![user guide template 1](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_template_1.png)

![user guide template 2](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_template_2.png)

### Start a new virtual server

Based on the imported template, create a new virtual server instance.

![user guide create vm 1](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_1.png)

![user guide create vm 2](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_2.png)

![user guide create vm 3](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_3.png)

You can adjust disk storage capacity, CPU and RAM allocation during this setup phase.

![user guide create vm 4](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_4.png)

![user guide create vm 5](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_5.png)

![user guide create vm 6](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_6.png)
...
![user guide create vm 7](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_7.png)

![user guide create vm 8](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_8.png)
...
![user guide check vm 1](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_1.png)

![user guide check vm 2](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_2.png)

Run your virtual server console to validate the deployment.

![user guide check vm 3](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_3.png)

![user guide check vm 4](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_4.png)
...
![user guide hotplug 1](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_1.png)

![user guide hotplug 2](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_2.png)

![user guide hotplug 3](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_3.png)

![user guide hotplug 4](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_4.png)

### Destroy virtual server

Finally, as a cleanup step, terminate the virtual server by clicking the red "Trash can" icon.

![user guide terminate 1](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_terminate_1.png)

![user guide terminate 2](/images/guides/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_terminate_2.png)
