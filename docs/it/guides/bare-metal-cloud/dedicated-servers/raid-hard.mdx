...
description: Verifica lo stato del tuo controller RAID hardware e monitora la salute dei dischi rigidi sul tuo server dedicato OVHcloud.
...
- a [dedicated server](https://www.ovhcloud.com/it/bare-metal/) with a hardware RAID configuration
