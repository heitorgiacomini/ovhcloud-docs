...
description: Esegui diagnostiche hardware sul tuo server dedicato OVHcloud in modalità rescue per identificare guasti a disco, RAM o CPU.
...
- Aver riavviato il server in [Rescue mode](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
