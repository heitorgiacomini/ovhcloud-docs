...
<Tabs>
  <Tab label="Dallo Spazio Cliente OVHcloud">
    Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, clicca su <code className="action">Bare Metal Cloud</code> e seleziona il tuo server nella sezione <code className="action">Server dedicati</code>.
...
:::info
Per tutti i sistemi operativi e le distribuzioni, è necessario configurare la propria macchina virtuale con l'indirizzo MAC virtuale creato nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
