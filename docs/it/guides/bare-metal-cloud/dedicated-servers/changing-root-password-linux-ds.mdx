...
description: "Gestisci gli account utente, l'accesso sudo e la connessione root su un server dedicato GNU/Linux per un'amministrazione sicura"
...
Per maggiori informazioni su questo argomento, consulta la nostra guida "[Iniziare a utilizzare SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)".
