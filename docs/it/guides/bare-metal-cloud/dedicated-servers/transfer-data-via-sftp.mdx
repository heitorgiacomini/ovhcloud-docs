...
È necessario inserire l’indirizzo IP del server indicato nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e il nome dell’account utente da utilizzare per la connessione SSH. Per maggiori informazioni, consulta le nostre guide "Primi passi":
...
<img className="thumbnail" alt="modalità rescue sftp del sito remoto" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_03.png" loading="lazy" />
...
<img className="thumbnail" alt="sito remoto sftp" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_01.png" loading="lazy" />
...
<img className="thumbnail" alt="stato di avanzamento del trasferimento sftp" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_02.png" loading="lazy" />
