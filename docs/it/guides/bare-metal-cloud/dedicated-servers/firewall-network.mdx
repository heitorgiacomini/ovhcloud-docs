...
:::info
Per maggiori informazioni sulla soluzione Anti-DDoS, [clicca qui](https://www.ovhcloud.com/it/security/anti-ddos/).
...
- Un servizio OVHcloud esposto su un indirizzo IP pubblico dedicato ([Server Dedicato](https://www.ovhcloud.com/it/bare-metal/), [VPS](https://www.ovhcloud.com/it/vps/), [istanza Public Cloud](https://www.ovhcloud.com/it/public-cloud/), [Hosted Private Cloud](https://www.ovhcloud.com/it/hosted-private-cloud/vmware/), [Additional IP](https://www.ovhcloud.com/it/network/additional-ip/), ecc.)
...
<img className="thumbnail" alt="filtrare i servizi" src="/images/bare-metal-cloud/dedicated-servers/firewall-network/selectservice_cut_new.png" loading="lazy" />

Clicca poi sul pulsante <code className="action">⁝</code> a destra dell'IPv4 interessato e seleziona <code className="action">Configurare Edge Network Firewall</code> (oppure clicca sull'icona di stato nella colonna **Edge Firewall**).

<img className="thumbnail" alt="Attivazione di Edge Network Firewall" src="/images/bare-metal-cloud/dedicated-servers/firewall-network/firewall_config_new.png" loading="lazy" />
...
Per maggiori informazioni, consulta le seguenti guide: [Configurazione del firewall su Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win) e [Configurazione del firewall su Linux con iptables](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).

:::


**Per aggiungere una regola**, clicca sul pulsante <code className="action">+ Aggiungere una regola</code>, in alto a sinistra nella pagina.

| ![add-rule-btn](/images/bare-metal-cloud/dedicated-servers/firewall-network/enf_add_rule_new.png) |
|:--:|
| Clicca su <code className="action">+ Aggiungere una regola</code>. |
...
|:--|
| - Una priorità (da 0 a 19, dove 0 rappresenta la prima regola da applicare, seguita dalle altre) <br/> - Un'azione (<code className="action">Accettare</code> o <code className="action">Rifiutare</code>) <br/> - Il protocollo <br/> - L'indirizzo IP sorgente (facoltativo) |
...
<img className="thumbnail" alt="Esempio di configurazione" src="/images/bare-metal-cloud/dedicated-servers/firewall-network/exemple.png" loading="lazy" />
...
Per una panoramica dettagliata degli attacchi rilevati e dei risultati delle attività del Scrubbing Center, ti invitiamo a consultare la nostra guida sul [Network Security Dashboard](/guides/bare-metal-cloud/dedicated-servers/network-security-dashboard).
...
- [Proteggere un server GAME con il firewall applicativo](/guides/bare-metal-cloud/dedicated-servers/firewall-game-ddos)
