...
description: Questa guida ti mostra come ripristinare la password di un account Windows Administrator su un VPS o un’istanza Public Cloud in Rescue mode
...
Accedi al tuo server in SSH. (se necessario, consulta la nostra [guida introduttiva SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction).)

È inoltre possibile aprire una connessione al server utilizzando [KVM (VPS)](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps) o la [console VNC (istanza Public Cloud)](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#accessvnc).
...
<img className="thumbnail" alt="amministratore" src="/images/bare-metal-cloud/virtual-private-servers/resetting-a-windows-password/adminpw_win.png" loading="lazy" />
