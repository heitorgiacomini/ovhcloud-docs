...
description: Come implementare applicazioni preinstallate sul tuo VPS
...
Dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> o tramite le API OVHcloud, puoi installare l'applicazione che preferisci. Consulta la guida Iniziare [a utilizzare un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
...
Puoi ordinare la licenza Plesk per il tuo VPS dallo [Spazio Cliente OVHcloud](https://www.ovh.com/manager/dedicated/#/configuration/license/order).
