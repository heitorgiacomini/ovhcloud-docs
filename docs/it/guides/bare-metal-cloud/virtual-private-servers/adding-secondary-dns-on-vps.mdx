...
- Se il dominio è gestito da OVHcloud come registrar **e** utilizza i server DNS di OVHcloud, aggiungi il record TXT nella sezione <code className="action">Web Cloud</code> del tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Segui le istruzioni descritte nella guida [Modificare la zona DNS](/guides/web-cloud/domains/dns-zone-edit) di un dominio.
