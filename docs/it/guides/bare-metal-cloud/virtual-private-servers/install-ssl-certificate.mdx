...
description: Questa guida ti mostra come installare un certificato SSL su un VPS di OVHcloud
...
- Disporre di una soluzione [VPS](https://www.ovhcloud.com/it/vps/)
...
1. Scarica un client SSH come [PuTTY](/guides/web-cloud/web-hosting/ssh-using-putty-on-windows) o utilizza il terminale integrato del sistema operativo.
