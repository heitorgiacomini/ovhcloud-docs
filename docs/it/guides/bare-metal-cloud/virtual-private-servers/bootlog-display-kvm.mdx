...
description: Come diagnosticare un VPS consultando i log di avvio (boot logs)
...
In caso di difficoltà nell'effettuare queste azioni, contatta un fornitore di servizi specializzato e/o contatta la nostra Community di utenti [https://community.ovh.com/en/](https://community.ovh.com/en/). OVHcloud non potrà fornirti assistenza tecnica al riguardo.
:::
...
Avvia il riavvio del server in modalità Rescue dallo Spazio Cliente. Se necessario, consulta la nostra [guida sulla modalità Rescue](/guides/bare-metal-cloud/virtual-private-servers/rescue).
...
Una volta effettuate le modifiche, riavvia il tuo VPS in modalità normale dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. I log di boot devono apparire durante l'utilizzo della [console KVM](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps).

## Per saperne di più

[Utilizzare KVM sui VPS](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps)
