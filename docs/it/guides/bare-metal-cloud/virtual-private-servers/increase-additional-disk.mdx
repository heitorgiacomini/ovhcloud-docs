...
description: Scopri come aumentare la dimensione di un volume aggiuntivo e aumentare la sua partizione principale
...
- Un [disco aggiuntivo](/guides/bare-metal-cloud/virtual-private-servers/config-additional-disk) configurato sul VPS.
...
Negli step successivi è necessario aver configurato un disco aggiuntivo seguendo le indicazioni di [questa guida](/guides/bare-metal-cloud/virtual-private-servers/config-additional-disk).

### Modifica la dimensione del disco <a name="extend"></a>

Nella scheda <code className="action">Home page</code>, nella sezione **La tua configurazione**, clicca su <code className="action">...</code> accanto all’opzione `Dischi aggiuntivi` e poi clicca su <code className="action">Aumenta la capacità del disco</code>.
...
Seleziona la nuova dimensione del disco nella nuova finestra e clicca su <code className="action">Aumenta</code>.
...
L'aumento di capacità del disco richiederà alcuni minuti dopo la conferma del pagamento. Puoi verificare lo stato di avanzamento della procedura nella scheda <code className="action">Dischi aggiuntivi</code>: se visualizzi la nuova dimensione selezionata, il disco è pronto.
...
Una volta connesso, clicca con il tasto destro sul pulsante <code className="action">Menu Inizia</code> e apri la <code className="action">Gestisci i dischi</code>.
...
Il [disco esteso](#extend) mostra la capacità aggiuntiva sotto forma di spazio non allocato. Fai click con il tasto destro sul volume del tuo disco aggiuntivo e seleziona <code className="action">Estendi il volume</code> nel menu contestuale.
...
Se necessario, è possibile modificare lo spazio disco in questo step. Clicca su <code className="action">Avanti</code>.
