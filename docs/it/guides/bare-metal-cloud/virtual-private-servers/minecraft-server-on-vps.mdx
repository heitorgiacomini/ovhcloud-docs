...
description: Come installare il tuo server Minecraft
...
<br/>
Si raccomanda di ordinare un nuovo VPS o di reinstallarne uno esistente dal vostro <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, utilizzando l'ultima versione disponibile di Ubuntu o Debian. Si prega di fare riferimento alla nostra guida "[Iniziare a utilizzare un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps#reinstallvps)" se necessario.

Una volta installato il sistema operativo, accedi al tuo VPS in SSH come descritto nella guida "[Iniziare a utilizzare un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps#reinstallvps)".
...
Ti vengono richieste diverse informazioni è sufficiente premere il tasto <code className="action">Entrata</code> per confermarli.
...
<br/>Sul [sito ufficiale di Minecraft](https://minecraft.net/download/server), clicca con il tasto destro sul link di download e seleziona <code className="action">Copia l'indirizzo del link</code>.

<img className="thumbnail" alt="Download del server" src="/images/bare-metal-cloud/virtual-private-servers/minecraft-server-on-vps/jar_file_download.png" loading="lazy" />
...
Per staccarti dalla `shell` (e mantenerla in corso di esecuzione), clicca su <code className="action">Ctrl</code>, poi su <code className="action">a</code> e poi su <code className="action">d</code> sulla tastiera.
...
Premi anche <code className="action">Ctrl</code>, poi <code className="action">a</code>, poi <code className="action">n</code> sulla tastiera.
...
<img className="thumbnail" alt="Connessione al server" src="/images/bare-metal-cloud/virtual-private-servers/minecraft-server-on-vps/login_minecraft.png" loading="lazy" />
...
<img className="thumbnail" alt="Informazioni sul server" src="/images/bare-metal-cloud/virtual-private-servers/minecraft-server-on-vps/minecraft_server_login.png" loading="lazy" />
