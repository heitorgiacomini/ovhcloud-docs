...
description: Scopri come configurare e inviare SMS direttamente da qualsiasi indirizzo e-mail utilizzando la funzionalità email2sms di OVHcloud
...
Puoi consultare la guida che segue per qualsiasi dettaglio sugli utenti SMS: [Tutte le informazioni sugli utenti SMS](/guides/web-cloud/messaging/sms/sms-users)
...
<img className="thumbnail" alt="Lista dei caratteri SMS" src="/images/web-cloud/messaging/sms/send-sms-email/smsauthorizedcharacters.png" loading="lazy" />
