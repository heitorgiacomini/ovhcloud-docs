...
Clicca sulla scheda <code className="action">Utenti API</code>. Per aggiungere un utente, clicca sul pulsante <code className="action">Azioni</code> e poi su <code className="action">Aggiungi</code>.
...
È possibile gestire le quote dalla scheda <code className="action">Utente API</code>. Clicca sui tre puntini <code className="action">...</code> in corrispondenza dell’utente API e seleziona <code className="action">Quota</code>.
...
Per configurare un limite a un utente clicca sui tre puntini <code className="action">...</code> e poi su <code className="action">Limite</code>.
...
Per farlo, clicca sui tre puntini <code className="action">...</code> a destra dell’utente e poi su <code className="action">Restrizioni</code>.
...
Per realizzare un follow-up personalizzato degli avvisi di ricevimento via SMS (Delivery reporting o DLR), è possibile specificare un URL chiamato Callback. Per farlo, clicca sui tre puntini <code className="action">...</code> a destra in corrispondenza dell'utente e poi su <code className="action">Callback</code>.
...
Per maggiori informazioni sull'utilizzo delle API OVHcloud, consulta la nostra guida [Iniziare a utilizzare le API OVHcloud](/guides/manage-and-operate/api/first-steps).
