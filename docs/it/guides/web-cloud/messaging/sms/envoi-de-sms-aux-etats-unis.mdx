...
- Avere accesso alle [API OVHcloud](https://eu.api.ovh.com/) (solo per il metodo di invio via API)
...
Clicca sulla scheda <code className="action">Messaggio e campagna</code> e poi su <code className="action">Gestisci gli SMS</code>.

Clicca su <code className="action">Gestisci i modelli</code>.
...
Nella nuova pagina, clicca su <code className="action">Azione</code> e poi su <code className="action">Aggiungi</code>.
...
Accedi alla pagina [https://api.ovh.com/](https://eu.api.ovh.com/) e poi utilizza l’API seguente:
...
Per conoscere i codici PTT, consulta [questa guida](/guides/web-cloud/messaging/sms/sms-users#step-5-specifica-un-url-di-callback).
