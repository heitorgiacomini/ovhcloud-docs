...
<ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink> del tuo Spazio Cliente OVHcloud, seleziona il tuo account SMS, poi la scheda <code className="action">Messaggio e campagna</code> > <code className="action">Gestisci gli SMS</code> > <code className="action">Storico invii</code> o <code className="action">SMS ricevuti</code>. Puoi filtrare lo storico per data, mittente, destinatario o messaggio. Lo storico viene conservato per 6 mesi e può essere esportato in formato CSV per analisi.

Per maggiori dettagli, consulta la guida "[Gestire lo storico degli SMS](/guides/web-cloud/messaging/sms/sms-history)".
...
Per gli **utenti API**, <ManagerLink to="/#/telecom/sms">accedi alla sezione SMS</ManagerLink>, seleziona il tuo account, poi <code className="action">Utenti API</code>. Clicca su <code className="action">...</code> > <code className="action">Limite</code> per l'utente interessato e configura:
...
Per maggiori dettagli, consulta la guida "[Tutto sugli utenti SMS](/guides/web-cloud/messaging/sms/sms-users)".
...
<ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink> del tuo Spazio Cliente OVHcloud, seleziona il tuo account SMS, poi clicca su <code className="action">Invia un SMS</code>. Compila i seguenti campi:
...
Per maggiori dettagli, consulta la guida "[Inviare SMS dallo Spazio Cliente OVHcloud](/guides/web-cloud/messaging/sms/send-sms-control-panel)".
...
Per maggiori dettagli, consulta la guida "[Inviare SMS tramite URL - http2sms](/guides/web-cloud/messaging/sms/send-sms-http2sms)".
...
Per maggiori dettagli, consulta la guida "[Inviare SMS da un indirizzo e-mail](/guides/web-cloud/messaging/sms/send-sms-email)".
...
<ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink> del tuo Spazio Cliente OVHcloud, seleziona il tuo account SMS, poi clicca su <code className="action">Invia un SMS</code>. I passaggi sono:
...
<ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink> del tuo Spazio Cliente OVHcloud, seleziona il tuo account SMS, poi vai su <code className="action">Contatti</code> > <code className="action">Crea una lista di contatti</code>. Puoi:
...
Le rubriche SMS offrono una gestione dei contatti più completa (nome, cognome, numero). <ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink>, seleziona il tuo account SMS, poi vai su <code className="action">Contatti</code> > <code className="action">Rubrica</code>. Puoi:
...
Per maggiori dettagli, consulta la guida "[Gestire le rubriche SMS](/guides/web-cloud/messaging/sms/sms-address-books)".
...
Per maggiori dettagli, consulta la guida "[Tutto sui mittenti SMS](/guides/web-cloud/messaging/sms/sms-senders)".
...
<ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink> del tuo Spazio Cliente OVHcloud, seleziona il tuo account SMS, poi clicca sulla scheda <code className="action">Mittenti</code>. Clicca su <code className="action">Azioni</code> > <code className="action">Aggiungi</code> e scegli "Aggiungere mittenti manualmente". Compila i seguenti campi:
...
Quando un destinatario risponde "STOP" a uno dei tuoi SMS, il suo numero viene automaticamente aggiunto a una blacklist da OVHcloud. Gli SMS futuri inviati a questo numero dal tuo account verranno bloccati. Puoi consultare e gestire questa blacklist dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, scheda <code className="action">Opzioni</code> > <code className="action">Gestisci i destinatari inseriti nella blacklist</code>. Puoi:
...
Gli utenti API SMS consentono di delegare l'invio di SMS tramite l'API o la funzione http2sms senza esporre le credenziali del proprio account OVHcloud. <ManagerLink to="/#/telecom/sms">Accedi alla sezione SMS</ManagerLink> del tuo Spazio Cliente OVHcloud, seleziona il tuo account SMS, poi clicca su <code className="action">Utenti API</code>. Aggiungi un nuovo utente definendo un identificativo e una password. A ogni utente possono essere assegnati:
...
Per maggiori dettagli, consulta la guida "[Inviare SMS con l'API OVHcloud in PHP](/guides/web-cloud/messaging/sms/send-sms-api-php)".
