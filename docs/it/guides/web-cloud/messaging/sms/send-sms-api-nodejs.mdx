...
<img className="thumbnail" alt="creazione dei token" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2462.jpg" loading="lazy" />
...
<img className="thumbnail" alt="recupero dei token" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2463.jpg" loading="lazy" />
