...
description: Scopri come configurare un ambiente di sviluppo Java e inviare il tuo primo SMS passo dopo passo utilizzando l’API RESTful OVHcloud
...
In questa guida verranno chiamati due metodi.
...
<img className="thumbnail" alt="recupero dei token" src="/images/web-cloud/messaging/sms/send-sms-api-java/img_2480.jpg" loading="lazy" />
...
Se il tuo SMS ha carattere pubblicitario, puoi inviare SMS solamente dalle 8:00 alle 20:00, dal lunedì al sabato.
