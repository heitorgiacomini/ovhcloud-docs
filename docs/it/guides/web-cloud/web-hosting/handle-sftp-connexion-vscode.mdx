...
Prima di lavorare sul progetto, scaricalo nella cartella locale creata in precedenza. Per prima cosa, assicurati che il file "sftp.json" sia configurato correttamente. Le informazioni utili sono disponibili nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Nella sezione <code className="action">Web Cloud</code>, clicca su <code className="action">Hosting</code>. Seleziona l’hosting interessato e clicca sulla scheda <code className="action">FTP - SSH</code>.
