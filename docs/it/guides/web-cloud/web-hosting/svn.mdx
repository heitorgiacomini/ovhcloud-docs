...
- Connettersi in SSH al tuo hosting Web (consulta la nostra guida [Utilizzare l'accesso SSH al tuo hosting Web](/guides/web-cloud/web-hosting/ssh-on-webhosting))

## Procedura

### Creazione del deposito

Una volta connesso in [SSH al tuo hosting](/guides/web-cloud/web-hosting/ssh-on-webhosting), crea la directory di root dei depositi SVN e poi la deposizione.
...
Segui la guida [Creare chiavi SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys#create-ssh-key).
...
Per maggiori informazioni, consulta la guida [Utilizzare l'accesso SSH di un hosting Web](/guides/web-cloud/web-hosting/ssh-on-webhosting).
:::
...
Per Subversion esiste una documentazione molto buona in inglese: [http://svnbook.red-bean.com/en/1.5/index.html](http://svnbook.red-bean.com/en/1.5/index.html)
