...
Non hai più accesso all'interfaccia di gestione del CMS o non puoi utilizzare la funzionalità "Password dimenticata" perché l'indirizzo email associato non è raggiungibile? Utilizza phpMyAdmin dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> per reimpostare la password direttamente dal database.
