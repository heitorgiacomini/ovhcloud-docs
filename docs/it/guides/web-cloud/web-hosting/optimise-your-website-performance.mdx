...
description: "Guida all'ottimizzazione delle performance del tuo sito"
...
- Un [dominio](https://www.ovhcloud.com/it/domains/)per accedere al tuo sito
...
Ti forniamo alcuni consigli su quale soluzione Hosting Web utilizzare per i CMS sopraelencati in questa [pagina](https://www.ovhcloud.com/it/web-hosting/).

Per maggiori informazioni clicca [qui](https://www.ovhcloud.com/it/web-hosting/uc-best-web-hosting/).
...
Per configurare una nuova versione di PHP, consulta [questa guida](/guides/web-cloud/web-hosting/configure-your-web-hosting).

Per passare all’uso di PHP-FPM nella versione _stabile_o per ottenere informazioni sulle opzioni più avanzate del tuo Web hosting, consulta [questa guida](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Puoi accedere ai tuoi log, alle statistiche e ai grafici direttamente dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>).
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    Clicca sul pulsante <code className="action">Visualizza le statistiche</code> per accedere alle statistiche di visita del sito Web o su <code className="action">Visualizza i log</code> per consultare i log disponibili per il tuo hosting Web.
...
1. Clicca su <code className="action">Hosting</code> nella colonna di sinistra e seleziona l’hosting Web in questione.
2. Nella nuova pagina, clicca sulla scheda <code className="action">Statistiche e log</code>. Sfoglia fino in fondo alla pagina in cui si trova il grafico associato all’utilizzo dell’hosting.
...
Per essere sicuro che il tuo piano di hosting sia adatto alle esigenze del tuo CMS, puoi confrontare i nostri servizi in [questa pagina](https://www.ovhcloud.com/it/web-hosting/).
...
**Come accedere al database tramite phpMyAdmin:** Per accedere al database tramite phpMyAdmin, segui la procedura dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>:

- Clicca sul tuo dominio nella sezione <code className="action">Hosting</code>
- Vai alla scheda <code className="action">Database</code>
- Clicca sui tre puntini<code className="action">...</code> a destra del database per accedere a phpMyAdmin.
...
[Consulta l'offerta Web Cloud Databases sul nostro sito](https://www.ovhcloud.com/it/web-cloud/databases/).

## Per saperne di più 

[Modificare la configurazione di un hosting Web](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Gestisci un database dal tuo hosting condiviso](/guides/web-cloud/web-hosting/sql-create-database)

[Inziare a utilizzare Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
