...
Per creare un nuovo database accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, seleziona il tuo servizio nella sezione <code className="action">Hosting</code>, clicca sulla scheda <code className="action">Database</code> e poi sul pulsante <code className="action">Crea un database</code>. 
