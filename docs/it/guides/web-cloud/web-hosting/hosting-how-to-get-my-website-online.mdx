...
description: Questa guida ti mostra come pubblicare un sito su un hosting Web OVHcloud
...
- **migrare in OVHcloud un sito Web esistente**: questa soluzione può risultare un’operazione delicata, soprattutto se eseguita su servizi in produzione per cui non è possibile un’interruzione di servizio. Per aiutarti in questa procedura, ti invitiamo a consultare in anticipo questa documentazione: [Migrare un sito e un servizio di posta in OVHcloud](/guides/web-cloud/web-hosting/hosting-migrating-to-ovh).
...
Prima di iniziare, assicurati di avere a disposizione i file del sito da installare. In caso di migrazione di un sito già esistente, contatta il tuo precedente provider per recuperarli.
...
> [success]
>
> Se, dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, non hai ancora dichiarato il tuo sito web sull'hosting web, consulta [questa guida](/guides/web-cloud/web-hosting/multisites-configure-multisite).
>
> Se, dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, non hai ancora associato il tuo nome di dominio a un sito web presente sull'hosting web, consulta [questa guida](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website).
...
<Tabs>
  ...
  <Tab label="Passaggio 2">
    Seleziona la scheda <code className="action">I miei siti</code>. Nella tabella che appare, per il sito web desiderato, guarda la <code className="action">Cartella di root</code> che appare.
...
<Tabs>
  ...
  <Tab label="Passaggio 2">
    Seleziona la scheda <code className="action">Database</code>.
  ...
  <Tab label="Passaggio 3">
    Clicca su <code className="action">Crea un database</code> o, se non compare, su <code className="action">Azioni</code> > <code className="action">Crea un database</code>. Inserisci le informazioni richieste.
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    Clicca su <code className="action">...</code> in corrispondenza del tuo database e poi su <code className="action">Importa un file</code>.
  </Tab>
</Tabs>
