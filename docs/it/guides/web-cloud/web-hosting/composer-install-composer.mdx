...
description: Questa guida ti mostra come installare e fare i primi passi su Composer
...
- Disporre di una [soluzione di hosting Web](https://www.ovhcloud.com/it/web-hosting/) con accesso SSH

## Procedura

Accedi in SSH al tuo hosting condiviso utilizzando la nostra guida su [l'utilizzo dell'SSH con il tuo hosting Web OVHcloud](/guides/web-cloud/web-hosting/ssh-on-webhosting).
