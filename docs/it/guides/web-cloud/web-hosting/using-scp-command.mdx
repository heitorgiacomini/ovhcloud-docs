...
Questa guida ti mostra in modo dettagliato le funzionalità disponibili con il comando `scp`. Per maggiori informazioni, contatta la nostra [Community di utenti](https://community.ovhcloud.com/community/en).

### Step 1 - Recupera gli accessi SSH del tuo hosting Web

Per recuperare gli accessi SSH del tuo hosting Web, consulta la nostra guida "[Utilizzare l’accesso SSH del tuo hosting Web](/guides/web-cloud/web-hosting/ssh-on-webhosting)".
...
- `ssh.cluster0XX.hosting.ovh.net`: sostituisci gli `XX` con il numero del cluster in cui si trova il tuo hosting Web. In caso di necessità, consulta la nostra guida "[Utilizzare l’accesso SSH del proprio hosting Web](/guides/web-cloud/web-hosting/ssh-on-webhosting)" per recuperare questa informazione.
...
Per verificare che alcuni contenuti presenti in locale sul tuo computer siano stati copiati sul tuo hosting Web, [accedi allo spazio di storage FTP del tuo hosting Web](/guides/web-cloud/web-hosting/ftp-connection) e clicca sulla cartella di destinazione in cui i contenuti devono essere copiati.
...
[Utilizzare l’accesso SSH del proprio hosting Web](/guides/web-cloud/web-hosting/ssh-on-webhosting)

[Accedere allo spazio di storage FTP dell’hosting Web](/guides/web-cloud/web-hosting/ftp-connection)
