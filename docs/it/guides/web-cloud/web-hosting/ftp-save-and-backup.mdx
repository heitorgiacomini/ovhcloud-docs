...
- In base al metodo utilizzato, disporre dell’accesso alla gestione della soluzione di hosting Web dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> o della password FTP per accedere allo spazio di storage 
...
- Lo stato di "manutenzione" compare nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Nella sezione <code className="action">Web Cloud</code>, clicca sul tuo servizio nella sezione <code className="action">Hosting</code> e poi sulla scheda <code className="action">Informazioni generali</code>.
