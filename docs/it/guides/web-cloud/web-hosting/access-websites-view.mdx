...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e clicca su <code className="action">Web Cloud</code>. Nel menu a sinistra, clicca su <code className="action">Siti Internet</code>. Visualizzi una tabella con tutti i tuoi siti Web e le informazioni principali.
