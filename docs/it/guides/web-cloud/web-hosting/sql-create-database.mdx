...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e clicca sulla sezione <code className="action">Web Cloud</code>. Clicca su <code className="action">Hosting</code> nella colonna a sinistra, scegli l’offerta di hosting su cui vuoi creare un database e poi clicca sulla scheda <code className="action">Database</code>.
...
:::info
Cliccando su <code className="action">Conferma</code>, la creazione del database potrebbe richiedere fino a **15 minuti**. Ricarica la pagina Web del tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> se il database non compare automaticamente nella tabella che elenca i tuoi database.
...
Se necessario, per recuperare queste informazioni di connessione, accedi al tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e clicca sulla sezione <code className="action">Web Cloud</code>. Clicca su <code className="action">Hosting</code> nella colonna a sinistra, scegli l’offerta di hosting su cui vuoi recuperare le informazioni di connessione al tuo database e poi clicca sulla scheda <code className="action">Database</code>.
...
Per verificare gli Snapshot disponibili e la data e l’ora della loro creazione, accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e clicca su <code className="action">Web Cloud</code>. Clicca su <code className="action">Hosting</code> nella colonna a sinistra, scegli l’offerta di hosting su cui vuoi consultare gli Snapshot disponibili per il tuo database e poi clicca sulla scheda <code className="action">Database</code>. Nella tabella visualizzata, fare clic sul simbolo accanto al cerchio verde. È inoltre possibile scaricare ogni backup di un database da questa interfaccia. Per maggiori informazioni al riguardo, consulta la nostra guida "[Recuperare il backup del database di un hosting Web](/guides/web-cloud/web-hosting/sql-database-export)".
