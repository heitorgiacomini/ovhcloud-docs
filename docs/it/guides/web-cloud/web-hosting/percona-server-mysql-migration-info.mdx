...
description: Scopri i vantaggi della migrazione da MySQL a Percona Server per MySQL
...
- Disporre di una soluzione di [hosting Web OVHcloud](https://www.ovhcloud.com/it/web-hosting/) con un database condiviso OVHcloud (MySQL) associato.
