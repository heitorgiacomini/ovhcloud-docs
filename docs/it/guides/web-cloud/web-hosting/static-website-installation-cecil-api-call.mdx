...
description: "Come aggiungere una chiamata verso un'API esterna dalla tua pagina Web statica"
lastUpdated: 2023-01-16
---

## Obiettivo

Questa guida ti mostra come utilizzare il generatore del sito [Cecil](https://cecil.app) per visualizzare il contenuto di una pagina dinamica. Il tutto chiamando un'API per recuperare e visualizzare le informazioni su una pagina generata via **Cecil**.
...
- Aver installato e configurato l'applicazione **Cecil** sul tuo hosting (consulta [la nostra guida sull'installazione e la configurazione di Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil))
...
Prepara il tuo ambiente di sviluppo accedendo in SSH sul tuo hosting Web e consulta la guida [Installare e configurare Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil) per installare la tua applicazione **Cecil** in una directory dedicata.
...
In questa guida utilizzeremo un'API fornita dal sito [OpenWeather](https://openweathermap.org/). In questo modo è possibile conoscere le informazioni meteorologiche in base al nome di una città.

Crea un account su [https://home.openweathermap.org/users/sign_up](https://home.openweathermap.org/users/sign_up)<br/>
...
<img className="thumbnail" alt="Cecil layouts directory including uncompressed files" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil-api-call05.png" loading="lazy" />
...
Sostituisci il valore della variabile `apiKey` con la chiave recuperata precedentemente sul sito [OpenWeather](https://openweathermap.org/)
...
<img className="thumbnail" alt="Page updated" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil-api-call08.png" loading="lazy" />
...
- Alcune API da testare sul tuo sito Web
    - [API Numbers](http://numbersapi.com/#42)
    - [NASA](https://api.nasa.gov/)
    - [News API](https://newsapi.org/)
    - [Polygon.io](https://polygon.io/)
    - una lista di [API pubbliche](https://github.com/public-api-lists/public-api-lists)
- I [comandi Cecil](https://cecil.app/documentation/commands/).
