...
Accedi al tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e seleziona <code className="action">Web Cloud</code>. Clicca su <code className="action">Hosting</code>, seleziona l'offerta di hosting su cui vuoi installare un "modulo in 1 click" e clicca sulla scheda <code className="action">CMS in 1 click</code>.
...
Per recuperare le credenziali di accesso al database creato su un'istanza Web Cloud Databases, consulta [questa guida](/guides/web-cloud/databases/db-getting-started).
...
- *Porta*: inserisci sistematicamente il numero **3306** (porta di default) per un database incluso con il tuo hosting Web. Per creare un database su un'istanza Web Cloud, consulta [questa guida](/guides/web-cloud/databases/db-getting-started).

- *Username*: è identico al nome del database se utilizzi un database incluso con il tuo hosting Web.
Per i database creati su un'offerta Web Cloud Database, consulta le informazioni indicate in [questa guida](/guides/web-cloud/databases/db-getting-started).
