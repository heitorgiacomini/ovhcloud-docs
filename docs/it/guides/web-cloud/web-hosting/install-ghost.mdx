...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, seleziona il tuo servizio Cloud Web nella sezione <code className="action">Hosting</code> nel menu a sinistra  e clicca sulla scheda <code className="action">Programma di esecuzione</code>.
...
Una volta inserite tutte le informazioni, clicca su <code className="action">Conferma</code>. Per maggiori informazioni sui motori di esecuzione, consulta la nostra guida [Gestire i motori di esecuzione di un hosting Cloud Web](/guides/web-cloud/web-hosting/manage-runtime-software-applications).
...
Per riavviare il daemon Node.js, torna allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Apri la scheda <code className="action">Multisito</code>, clicca sul pulsante <code className="action">...</code> a destra in corrispondenza del tuo dominio e seleziona <code className="action">Riavvia</code>.
