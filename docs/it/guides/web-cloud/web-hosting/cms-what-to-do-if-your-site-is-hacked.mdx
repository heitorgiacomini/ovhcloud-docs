...
description: Scopri i nostri consigli per riparare il tuo sito Web pirata
...
- [Modifica la password di accesso al tuo identificativo cliente OVHcloud](/guides/account-and-service-management/account-information/manage-ovh-password).
- [Rendere sicuro l'accesso allo Spazio Cliente OVHcloud con doppia autenticazione](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
- [Modificare la password di accesso allo spazio di storage FTP del tuo hosting Web](/guides/web-cloud/web-hosting/ftp-change-password).
- [Modifica la password di accesso al tuo database](/guides/web-cloud/web-hosting/sql-change-password).

Consigliamo inoltre di utilizzare un [gestore di password](/guides/account-and-service-management/account-information/manage-ovh-password#utilizza-un-software-per-la-gestione-di-password).
...
Utilizza la nostra guida su [le statistiche e i log del tuo hosting Web](/guides/web-cloud/web-hosting/logs-and-statistics) per ricercare gli elementi malevoli iniettati nel tuo sito Web. Trovi le informazioni nei log "web". 
...
Se sei assolutamente sicuro che si tratti di un IP malevolo, puoi bloccarlo all'accesso al tuo hosting seguendo la nostra guida sulle [restrizioni di accesso tramite il file ".htaccess"](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website).
...
- [Ripristinare lo spazio di storage FTP del tuo hosting Web](/guides/web-cloud/web-hosting/ftp-save-and-backup)
- [Recupera il backup SQL del tuo database](/guides/web-cloud/web-hosting/sql-database-export)
- [Importare il backup SQL nel tuo database](/guides/web-cloud/web-hosting/sql-importing-mysql-database)
...
Se il tuo hosting è "disattivato", i robot di ripristino automatico disponibili nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> saranno disattivati.
...
Per riattivare l'hosting Web, segui le istruzioni riportate nello Step 4 di questa [guida](/guides/web-cloud/web-hosting/diagnostic-403-forbidden).
...
Per accedere allo spazio di storage del tuo hosting, consulta la nostra guida (/guides/web-cloud/web-hosting/ftp-connection) sull'argomento.
...
Per maggiori informazioni sui permessi "CHMOD", consulta la sezione "Informazioni utili" del nostro [tutorial sull'utilizzo del client FTP Filezilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide#useful-information).
...
Proteggi i tuoi form di contatto con l'ausilio di un sistema di tipo "Captcha" per evitare che i robot malevoli emettano SPAM attraverso questo mezzo. Se la funzione "mail()" di PHP è stata bloccata sul tuo hosting, consulta [la nostra guida](/guides/web-cloud/web-hosting/mail-function-script-records) su questo argomento per risolvere il blocco.

Consulta anche la nostra guida su [come proteggere il tuo sito Web](/guides/web-cloud/web-hosting/secure-your-website), per ridurre al minimo il rischio di un'altra pirateria.

## Per saperne di più <a name="go-further"></a>

[Accedere allo spazio di storage del tuo hosting Web](/guides/web-cloud/web-hosting/ftp-connection)

[Modifica la configurazione di un hosting Web](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Attiva il firewall applicativo](/guides/web-cloud/web-hosting/multisites-activating-application-firewall)

[Ottimizza le performance del tuo sito](/guides/web-cloud/web-hosting/optimise-your-website-performance)
