...
<Tabs>
  ...
  <Tab label="Passaggio 2">
    Nella nuova pagina, individua la voce **Opzione CDN**. Clicca sui tre puntini <code className="action">...</code> a destra e poi su <code className="action">Ordina una CDN</code> o <code className="action">Attiva l’opzione</code> se l’opzione CDN è già inclusa nel tuo hosting.
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    ...
    Fai quindi clic sul pulsante <code className="action">⁝</code> a destra del nome del dominio o sottodominio desiderato, quindi su <code className="action">Attiva la CDN</code>.

    <img className="thumbnail" alt="Opzioni domini associati" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/my-websites/associated-domains-options-cdn-disabled.png" loading="lazy" />
  </Tab>
  <Tab label="Passaggio 4">
    Nella finestra che si apre, clicca su <code className="action">Conferma</code> per attivare il CDN.
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    ...
    Fai quindi clic sul pulsante <code className="action">⁝</code> a destra del nome del dominio o sottodominio desiderato, quindi su <code className="action">Pulisci il CDN</code>.
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    ...
    Fai quindi clic sul pulsante <code className="action">⁝</code> a destra del nome del dominio o sottodominio desiderato, quindi su <code className="action">Modifica il CDN</code>.
...
<Tabs>
  ...
  <Tab label="Passaggio 4">
    ...
    - **Purga avanzata**: Personalizza lo spurgo scegliendo gli elementi della cache da svuotare: tutto il sito, una cartella, un'URI, un'estensione di file o tramite un'espressione regolare personalizzata. 
       ...
       Nella scheda <code className="action">I miei siti</code>, clicca sul pulsante <code className="action">⁝</code> a destra del nome di dominio o sottodominio interessato e quindi su <code className="action">Pulisci il CDN</code>.
...
<Tabs>
  ...
  <Tab label="Passaggio 2">
    Individua la voce **Opzione CDN**. Clicca sui tre puntini <code className="action">...</code> e poi su <code className="action">Disattiva la CDN</code>.
