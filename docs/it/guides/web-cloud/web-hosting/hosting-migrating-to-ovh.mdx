...
Una volta scelta la soluzione di hosting, se non sei ancora cliente OVHcloud, clicca su <code className="action">Ordine</code> nelle precedenti pagine commerciali. Segui gli step dell'ordine **senza richiedere il trasferimento del tuo dominio** (questa operazione verrà eseguita nello step 10 di questa guida).
