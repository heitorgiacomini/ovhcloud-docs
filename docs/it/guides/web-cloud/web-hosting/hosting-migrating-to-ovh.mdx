...
oppure accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Una volta effettuato l’accesso, segui queste istruzioni:

- Accedi alla scheda <code className="action">Web Cloud</code>.
- In alto a sinistra dell’interfaccia, clicca sul pulsante <code className="action">Ordinare</code> e poi su <code className="action">Hosting</code>.
...
- Consulta la guida Per maggiori informazioni sui parametri di configurazione [Gestisci le email MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities#2-utilizza-il-software-che-preferisci). e i link alle guide personalizzate per i principali client di posta.
