...
<Region zones={['eu']}>
- Disporre di una soluzione di [hosting Web](https://www.ovhcloud.com/it/web-hosting/) attiva (escluse le offerte "Hosting gratuito" e "Start10m").
</Region>
...
Inoltre, se il dominio è già registrato in OVHcloud o se esiste già una zona DNS in un altro <ManagerLink to="/">account OVHcloud</ManagerLink> rispetto al dominio, consulta la nostra documentazione "[Gestire i contatti dei servizi](/guides/account-and-service-management/account-information/managing-contacts)" per recuperarne la gestione.
