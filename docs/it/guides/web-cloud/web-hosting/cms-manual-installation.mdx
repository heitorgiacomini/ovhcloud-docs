...
description: Questa guida ti mostra come installare manualmente un CMS sul tuo hosting
...
- Sito ufficiale di [WordPress](https://wordpress.com/)
...
- Sito ufficiale di [Joomla!](https://www.joomla.org/)
...
- Sito ufficiale di [Drupal](https://www.drupal.org/)
...
- Sito ufficiale di [PrestaShop](https://www.prestashop.com/)
...
- Sito ufficiale di [Pico](https://picocms.org/)
...
- Sito ufficiale di [Grav](https://getgrav.org/)
...
- Sito ufficiale di [Typo3](https://typo3.com/)
...
- Sito ufficiale di [SPIP](https://www.spip.net/en_rubrique25.html)
...
Consulta la nostra documentazione che descrive [come creare un sito web sull'hosting](/guides/web-cloud/web-hosting/multisites-configure-multisite) per definire la directory radice da utilizzare con il tuo CMS.
...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> nella sezione <code className="action">Web Cloud</code> e seleziona la tua soluzione di hosting Web nella sezione <code className="action">Hosting</code>.<br/>
Nel riquadro <code className="action">Informazioni generali</code> sulla tua destra, clicca su <code className="action">IPv4</code> e seleziona l'indirizzo IP del tuo hosting Web.

Se la zona DNS attiva del tuo dominio è gestita dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, compara l'indirizzo IP del tuo hosting con quello presente nella zona DNS del tuo dominio, consultando la nostra documentazione sulle [zone DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit).

:::warning
Se hai attivato le opzioni <code className="action">CDN</code> o <code className="action">IP del paese</code> con il tuo dominio, utilizza l'indirizzo IP adattato seguendo la procedura descritta nella guida che contiene [tutti gli indirizzi IP dei nostri hosting condivisi](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip).
...
- Recupera [le informazioni necessarie per accedere allo spazio FTP del tuo hosting web](/guides/web-cloud/web-hosting/ftp-connection#step-1-recupera-i-dati-necessari-a-effettuare-laccesso).
- Recupera gli accessi al database della tua offerta di hosting Web se esiste già, o creane una utilizzando la nostra [guida](/guides/web-cloud/web-hosting/sql-create-database).

#### 1.3 - Installare il client FTP gratuito "FileZilla"

Se non utilizzi già un client FTP, puoi utilizzare Filezilla. Per maggiori informazioni, consulta la guida scaricare gratuitamente il link di download e una guida all'utilizzo nella nostra guida su [utilizzare FileZilla con la tua soluzione di hosting OVHcloud](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).

:::info
Ci sono altri client FTP che puoi utilizzare come, ad esempio, Cyberduck. Per maggiori informazioni, consulta la nostra documentazione relativa all'[utilizzo di Cyberduck con la tua soluzione di hosting OVHcloud](/guides/web-cloud/web-hosting/ftp-cyberduck-user-guide-on-mac).
...
Per funzionare correttamente, la maggior parte dei CMS ha bisogno di un database. Le nostre offerte di [hosting web](https://www.ovhcloud.com/it/web-hosting/) ne contengono, ad eccezione di [Hosting gratuito](https://www.ovhcloud.com/it/domains/free-web-hosting/).

</Region>

<Region zones={['ca','apac']}>

Per funzionare correttamente, la maggior parte dei CMS ha bisogno di un database. Le nostre offerte di [hosting web](https://www.ovhcloud.com/it/web-hosting/) ne contengono.

</Region>

Utilizza la nostra documentazione per [creare un database dalla tua offerta di hosting web](/guides/web-cloud/web-hosting/sql-create-database).

Se disponi di un'offerta Web Cloud Databases in MySQL o MariaDB e desideri utilizzarla per installare manualmente il tuo CMS, consulta la nostra guida sulla [creazione di un database su un servizio Web Cloud Databases](/guides/web-cloud/databases/db-create-databases-users#crea-un-database).
...
Se il CMS è identico a quello da installare, puoi utilizzare [questa guida](/guides/web-cloud/web-hosting/sql-change-password#step-3-modifica-la-password-del-database-del-tuo-sito-nel-file-di-configurazione) per identificare i file di configurazione nel tuo [spazio di storage FTP](/guides/web-cloud/web-hosting/ftp-connection).
...
- Per connetterti al tuo database associato alla tua offerta di hosting Web, consulta [questa guida](/guides/web-cloud/web-hosting/sql-create-database#accedi-allinterfaccia-phpmyadmin).
...
Configura la versione di PHP sul tuo hosting Web consultando la nostra guida su [modifica della versione PHP di un hosting Web](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Una volta che i file decomprimono la cartella "**CMS**", [collegati in FTP al tuo spazio di archiviazione](/guides/web-cloud/web-hosting/ftp-connection) con l'aiuto del [client FTP FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide) e copia i file contenuti nella cartella "**CMS**" nella "cartella root" definita sul tuo hosting durante lo [step 1](#step1) di questa guida.
...
Per connetterti in SSH al tuo hosting, consulta la nostra guida sulla [connessione in SSH da un hosting condiviso OVHcloud](/guides/web-cloud/web-hosting/ssh-on-webhosting).
...
- [Completare l'installazione di Wordpress](/guides/web-cloud/web-hosting/cms-manual-installation-wordpress)
- [Completare l'installazione di Joomla!](/guides/web-cloud/web-hosting/cms-manual-installation-joomla)
- [Completare l'installazione di Drupal](/guides/web-cloud/web-hosting/cms-manual-installation-drupal)
- [Completare l'installazione di PrestaShop](/guides/web-cloud/web-hosting/cms-manual-installation-prestashop)
- [Completare l'installazione di Pico](/guides/web-cloud/web-hosting/cms-manual-installation-pico)
- [Completare l'installazione di Grav](/guides/web-cloud/web-hosting/cms-manual-installation-grav)
- [Completare l'installazione di Typo3](/guides/web-cloud/web-hosting/cms-manual-installation-typo3)
- [Completare l'installazione di SPIP](/guides/web-cloud/web-hosting/cms-manual-installation-spip)
...
[Pubblicare un sito Internet su un hosting Web](/guides/web-cloud/web-hosting/hosting-how-to-get-my-website-online)
