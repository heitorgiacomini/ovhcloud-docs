...
Per verificare se il tuo sito Web utilizza già un indirizzo IPv6, utilizza il sito [test-ipv6.run](https://test-ipv6.run/domain-checker). Ti dirà se il tuo sito Web risponde a questo nuovo protocollo IP. In caso contrario, prosegui nella lettura della guida.
