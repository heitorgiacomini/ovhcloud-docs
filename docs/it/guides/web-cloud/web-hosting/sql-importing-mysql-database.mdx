...
Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, seleziona il tuo servizio nella sezione <code className="action">Hosting</code> e clicca sulla scheda <code className="action">Database</code>.
...
Per recuperare il link di accesso a phpMyAdmin accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, seleziona il tuo servizio nella sezione <code className="action">Hosting</code> e clicca sulla scheda <code className="action">Database</code>.
