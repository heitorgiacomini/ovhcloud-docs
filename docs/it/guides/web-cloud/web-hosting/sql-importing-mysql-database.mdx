...
- **ripristinare lo stato di una data precedente**: questa soluzione permette di ripristinare il contenuto dei tuoi database grazie ai backup presenti nel tool di backup OVHcloud. Non richiede particolari competenze tecniche ed è disponibile direttamente nello <ManagerLink to="/">Spazio Cliente</ManagerLink>.

- **file di backup**: questa soluzione permette di importare i dati del tuo file di backup in uno dei tuoi database ed è disponibile direttamente nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
...
<Tabs>
  ...
  <Tab label="Passaggio 2">
    Nella pagina che appare, clicca sulla scheda <code className="action">Database</code>.
  </Tab>
  <Tab label="Passaggio 3">
    Clicca sui tre puntini in corrispondenza del database da ripristinare e seleziona <code className="action">Ripristina un backup</code>. Ti ricordiamo che scegliendo questa opzione il contenuto del database verrà sostituito con quello del backup.
    ...
    Verranno elencati tutti i backup disponibili per il database selezionato. Clicca sui tre puntini in corrispondenza del backup da ripristinare e seleziona <code className="action">Ripristina il backup</code>.
  </Tab>
  <Tab label="Passaggio 4">
    Verifica la correttezza delle informazioni e clicca su <code className="action">Conferma</code> per avviare l'operazione. Attendi il completamento del processo.
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    Clicca sui tre puntini in corrispondenza del database in cui vuoi importare i dati e seleziona <code className="action">Importa un file</code>.
...
<Tabs>
  ...
  <Tab label="Passaggio 3">
    Clicca sui tre puntini in corrispondenza del database di cui vuoi importare il backup e seleziona <code className="action">Accedi a phpMyAdmin</code>.
