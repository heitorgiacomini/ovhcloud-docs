...
:::info
Una volta completati gli step precedenti e se la zona DNS attiva del dominio è completamente gestita nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, il record di tipo A nella zona DNS del dominio verrà modificato automaticamente. Per verificare che l'indirizzo IP sia stato aggiornato correttamente, consulta la guida su [modifica della zona DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit).
