...
:::info
Il nuovo database acquistato non è abilitato per impostazione predefinita. Ricordati di attivarla. Per farlo, accedi al tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, sezione <code className="action">Web Cloud</code>.
...
- Per creare un database che sarà presente su un server "Web Cloud Databases": consulta la nostra guida "[Creare un database su un server Web Cloud Databases](/guides/web-cloud/databases/db-create-databases-users)".
