...
- di un database presente su un server [Web Cloud Databases](https://www.ovhcloud.com/it/web-cloud/databases/) (incluso con i nostri [hosting](https://www.ovhcloud.com/it/web-hosting/) **Performance**, **Agency**, **Agency Plus** e **Agency Max** o [ordinato separatamente](https://www.ovhcloud.com/it/web-cloud/databases/)).
