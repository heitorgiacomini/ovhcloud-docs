...
description: "Questa guida ti mostra come proteggere una directory o l'accesso alla gestione del tuo sito Web tramite un'autenticazione con i file .htaccess e .htpasswd"
...
utilizzando due file di configurazione (HTTP) Apache da inserire nello [spazio FTP](/guides/web-cloud/web-hosting/ftp-connection) del tuo hosting Web: 
...
- Disporre delle credenziali di accesso a [spazio FTP del tuo hosting](/guides/web-cloud/web-hosting/ftp-connection)
...
Se utilizzi un CMS Wordpress, OVHcloud mette a disposizione anche una guida su come [utilizzare il file htaccess con WordPress](/guides/web-cloud/web-hosting/htaccess-how-to-protect-wordpress).
...
Per farlo, contatta la nostra [Community di utenti](https://community.ovhcloud.com/community/en) o i nostri [partner OVHcloud](https://partner.ovhcloud.com/it/directory/).
:::
...
Per modificare la versione di PHP sui tuoi siti Web, consulta la nostra guida "[Hosting Web : ambiente, versione PHP, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting)".
...
Accedi a [lo spazio di storage FTP](/guides/web-cloud/web-hosting/ftp-connection) del tuo hosting Web. Apri la ["cartella di root"](/guides/web-cloud/web-hosting/multisites-configure-multisite) verso cui punta il tuo dominio.
...
Clicca sulla cartella root in cui hai creato il file "crypt.php". Clicca su <code className="action">Modifica</code> e inserisci queste righe:
...
Se disponi di un hosting **Pro**, **Performance**, **Agency**, **Agency Plus** o **Agency Max**, collegati in [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting) al tuo hosting Web. Scendete nella "**directory**" dove si trova il vostro script "crypt.php".
...
:::warning
Per motivi di sicurezza, si raccomanda l'utilizzo di SSH. Tuttavia, se disponi di un'offerta **Starter**, **Personale** o **Startup** sulle quali l'SSH non è disponibile, puoi anche eseguire il file "crypt.php" tramite il tuo browser Web.
...
- `your_ftp_login`: il login FTP che utilizzi per accedere al tuo spazio di archiviazione FTP. Per recuperare il tuo login FTP, consulta la nostra guida sulla [connessione al tuo spazio FTP](/guides/web-cloud/web-hosting/ftp-connection).
...
[Accedere allo spazio FTP del tuo hosting Web](/guides/web-cloud/web-hosting/ftp-connection)

[Tutorial - Operazioni realizzabili con un file ".htaccess"](/guides/web-cloud/web-hosting/htaccess-what-else-can-you-do)

[Bloccare l'accesso al mio sito per alcuni indirizzi IP tramite un file.htaccess](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website)

[Riscrivere l'URL di accesso al mio sito grazie al mod_rewrite via file.htaccess](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)
