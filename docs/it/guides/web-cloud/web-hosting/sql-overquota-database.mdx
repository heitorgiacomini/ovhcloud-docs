...
Se il tuo database è presente su una soluzione [Web Cloud Databases](https://www.ovhcloud.com/it/web-cloud/databases/), consulta la nostra guida "[Web Cloud Databases - Accedere al tuo database](/guides/web-cloud/databases/db-connecting-database-server)", quindi passa direttamente allo [step 1.2](#step1.2) della presente guida.
...
È possibile duplicare il contenuto del database OVHcloud direttamente verso un altro database grazie a una funzionalità disponibile nello <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Per farlo, consulta la nostra guida "[Duplicare il contenuto di un database in un altro](/guides/web-cloud/web-hosting/copy-database)".
...
- [Iniziare a utilizzare l'offerta Web Cloud Databasess](/guides/web-cloud/databases/db-getting-started)
- [Importare il tuo database precedente nella tua offerta Web Cloud Databases](/guides/web-cloud/databases/db-restore-import-database)
