...
description: Come creare la tua prima pagina Web su un hosting gratuito
...
Questa guida ti mostra come creare la prima pagina di un sito Web su un Hosting gratuito offerto gratuitamente con l'acquisto di un dominio OVHcloud.

**Scropire come creare la tua prima pagina Web su un Hosting gratuito**
...
- Disporre di un piano di [hosting Web OVHcloud](https://www.ovhcloud.com/it/web-hosting/) o di un [Hosting gratuito](https://www.ovhcloud.com/it/domains/free-web-hosting/)
...
<body>
    <h1>Benvenuto sulla mia pagina personale</h1>
    <h2>Crea rapidamente e facilmente il tuo sito Web</h2>
    <p>OVHcloud offre gratuitamente l'Hosting gratuito per ogni dominio acquistato.</p>
</body>
```
...
**Esempio**: se le vostre immagini pesano ciascuna 1 MB, sarete limitati a meno di 100 immagini sul vostro hosting gratuito. Se riuscite a ridurne la dimensione a un valore compreso tra 50kb e 200kb, potrete visualizzarne fino a diverse migliaia sulla vostra pagina web.
...
<img className="thumbnail" alt="Arborescenza file e cartelle" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-1.png" loading="lazy" />

Prendiamo un file in formato *PNG*. Inseriscilo nella directory "images":

<img className="thumbnail" alt="Arborescenza file e cartelle con immagine" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Risultato del codice HTML sul browser" src="/images/assets/screens/other/browsers/web-pages/create-your-personal-webpage-3-it.png" loading="lazy" />
...
<img className="thumbnail" alt="Posizionamento file CSS" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-4.png" loading="lazy" />
...
<img className="thumbnail" alt="Modello della scatola CSS" src="/images/assets/schemas/web-hosting/create-your-personal-webpage-5.png" loading="lazy" />
...
Per rendere visibili le tue pagine e quindi il tuo sito, è necessario depositarle sul tuo hosting (è necessario attivare il tuo hosting [come indicato in questa guida](/guides/web-cloud/web-hosting/activate-start10m)).
...
Per salvare i tuoi file sul tuo hosting, consulta la guida sull'[utilizzo di FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).
