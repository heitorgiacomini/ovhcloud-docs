...
- Disporre di una soluzione di [hosting Web OVHcloud](https://www.ovhcloud.com/it/web-hosting/), ad eccezione di una [soluzione di hosting Cloud Web](https://www.ovhcloud.com/it/web-hosting/cloud-web-offer/).
...
- **Dallo Spazio Cliente OVHcloud**. Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e seleziona <code className="action">Web Cloud</code>. Nella colonna di sinistra, clicca su <code className="action">Hosting</code> e seleziona l’hosting Web interessato. Nella scheda <code className="action">Informazioni generali</code>, individua la versione sotto *Versione PHP*. 
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e clicca su <code className="action">Web Cloud</code>.
...
Crea un file ".ovhconfig" contenente la versione di PHP desiderata per il sito web o i siti web interessati. Segui le operazioni descritte nella sezione "[3.3 - Modifica il contenuto del file ".ovhconfig"](#update-ovhconfig)" di questa guida, se necessario. Quando caricherai il file ".ovhconfig" sul tuo [spazio di storage FTP](/guides/web-cloud/web-hosting/ftp-connection), fallo nella cartella radice dove si trovano i file che compongono il sito web interessato. Trova la cartella radice del tuo sito web dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> nell'onghetta <code className="action">Multisito</code> dell'hosting interessato.

Consulta la nostra guida che dettaglia come [configurare un sito web su un'hosting web](/guides/web-cloud/web-hosting/multisites-configure-multisite) se necessario.
