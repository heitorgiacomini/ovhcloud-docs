...
Per modificare i diritti di un utente esistente, consulta la guida "[Web Cloud Databases - Modificare i diritti di un utente](/guides/web-cloud/databases/db-modify-users-rights)".
...
Per importare un database, consulta la guida "[Ripristinare e importare un database sul server di database](/guides/web-cloud/databases/db-restore-import-database)".
...
Per farlo, consulta i casi particolari nella guida "[Web Cloud Databases - Come autorizzare un indirizzo IP?](/guides/web-cloud/databases/db-authorise-ip-mask)" per attivare o disattivare l'accesso degli hosting Web OVHcloud al tuo Web Cloud Databases.
...
Per accedere ai log della soluzione Web Cloud Databases, consulta la guida "[Web Cloud Databases - Come recuperare i log?](/guides/web-cloud/databases/db-retrieve-logs)".

## Per saperne di più

[Creare database e utenti sul server di database](/guides/web-cloud/databases/db-create-databases-users)

[Connettersi al database del server di database](/guides/web-cloud/databases/db-connecting-database-server)

[Salvare ed esportare un database sul server di database](/guides/web-cloud/databases/db-backup-export-database-server)

[Ripristinare e importare un database sul server di database](/guides/web-cloud/databases/db-restore-import-database)

[Configurare il server di database](/guides/web-cloud/databases/db-configure-optimise-database-server)
