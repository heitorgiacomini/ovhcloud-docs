...
Per verificarlo, recupera l'indirizzo IP pubblico del tuo punto di accesso a Internet, quindi consulta la sezione **Autorizzare un indirizzo IP** di [questa guida](/guides/web-cloud/databases/db-getting-started).
...
Per maggiori informazioni su Logs Data Platform, consulta la nostra guida [Introduzione a Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction) (EN).
...
Se necessario, consulta le nostre guide "[Introduzione a Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction)" (EN) e "[Iniziare rapidamente con Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start)" (EN).
  </Tab>
...
[Primi passi con il tuo Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
