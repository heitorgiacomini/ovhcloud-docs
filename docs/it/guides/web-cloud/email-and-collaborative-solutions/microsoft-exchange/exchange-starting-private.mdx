...
description: Come configurare il tuo server Private Exchange
...
- Aver ordinato una [soluzione Private Exchange OVHcloud](https://www.ovhcloud.com/it/emails/private-exchange/).
...
Per consultare questa email dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, clicca sul tuo profilo in alto a destra e poi su <code className="action">Email de servizio</code> e cerca l’email che ha come oggetto:

> **[xx-11111-ovh] Il tuo servizio Private Exchange 20\_xxx\_ è in consegna!**
...
Clicca sul link indicato nell’email ricevuta, e poi passa allo [Step 2](#step-2-avvia-la-piattaforma) qui sotto.

### Step 2: avvia la piattaforma

Dopo aver cliccato sul link indicato nell’email allo [Step 1](#step-1-ricevi-lemail-di-configurazione-della-tua-piattaforma), sarai reindirizzato alla pagina di configurazione:
...
Compila i campi seguendo queste indicazioni:

- **Nome del server**: nel menu a tendina, seleziona il sottodominio associato al tuo dominio. Nel campo vuoto, inserisci il dominio che vuoi associare.
...
> **ORDER #1111111 - Domain Control Validation for exchange.tuodominio.com**

Copia il codice presente nell’email e clicca sul link di conferma del certificato SSL.

Incolla il codice nell’apposita casella, all’interno della finestra che appare, e poi clicca su <code className="action">Next</code>.
...
Un messaggio ti informa se il codice inserito è valido. In caso affermativo, clicca su <code className="action">Close window</code>.

### Step 5: finalizzazione della consegna
...
> **[xx-11111-ovh] Il tuo servizio Private Exchange 20\_xxx\_ è pronto!**

Per aggiungere un dominio alla tua piattaforma e configurare gli account, consulta la nostra guida [“Aggiungere un dominio su Exchange”](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain).
