...
Dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, seleziona la sezione <code className="action">Web Cloud</code> e segui le indicazioni fornite:
...
<ZoneTabs>
  <Tab label="MX Plan">
    La capacità di un account MX Plan può variare da 2,5 MB a 5 GB. In caso di saturazione e capacità inferiore a 5 GB, è possibile modificarne la capacità tramite lo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.<br/>
...
<Region zones={['ca']}>
- protocollo IMAP sull'offerta **MXplan**;
- protocollo MAPI sull'offerta **Exchange** per Outlook Windows
- il protocollo EWS sull'offerta **Exchange** per Outlook macOS.
</Region>
...
Configurazione di un account MX Plan su **macOS**:<br/><br/>
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    ...
    - [Posta su Windows 10](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration) (incluso con Windows)<br/>
...
Configurazione di un account Email Pro su **macOS**:<br/><br/>
    - [Mail](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration) (incluso con macOS)<br/>
