...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Estrarre un file eml da OWA" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa02.mp4" />
