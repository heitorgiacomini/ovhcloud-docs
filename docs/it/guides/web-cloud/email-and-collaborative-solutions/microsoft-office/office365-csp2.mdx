...
description: Come attivare e gestire un servizio Office 365 Reseller (CSP2) in OVHcloud
...
- **Link diretto:** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Clicca su <code className="action">Ordina</code> per finalizzare
...
L'icona <i className="icons-pen"></i> permette di modificare il numero totale di licenze dell'abbonamento. L'icona <i className="icons-bin"></i>  permette di rescindere l'abbonamento e tutte le sue licenze.
