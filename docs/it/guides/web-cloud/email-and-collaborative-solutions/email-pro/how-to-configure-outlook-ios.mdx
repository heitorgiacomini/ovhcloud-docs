...
Clicca su <ManagerLink to="/#/web/email_pro">questo link</ManagerLink> per accedere alla sezione <code className="action">Email Pro</code>. Il nome del server è visibile nel riquadro **Connessione** della scheda <code className="action">Informazioni generali</code>.
