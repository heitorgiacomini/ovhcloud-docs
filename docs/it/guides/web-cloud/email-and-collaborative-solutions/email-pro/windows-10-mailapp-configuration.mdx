...
Per configurare il tuo indirizzo email Pro su Outlook classico, consulta la nostra guida "[Email Pro - Configurare un account email su Outlook classico per Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration)".
...
Clicca su <ManagerLink to="/#/web/email_pro">questo link</ManagerLink> per accedere alla sezione <code className="action">Email Pro</code>.
