...
<ZoneTabs>
  ...
  <Tab label="Zimbra Mail" availableIn={['eu']}>
    ...
    2. È possibile ordinare un account Zimbra dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> o direttamente da [ovhcloud.com](https://www.ovhcloud.com/it/mail/).
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    ...
    2. È possibile ordinare un account Email Pro dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> o direttamente da [ovhcloud.com](https://www.ovhcloud.com/it/mail/).
...
:::info
**Suggerimenti**: se non riesci ad accedere alla tua Webmail, è possibile che la tua password sia errata. Verifica la tua password e, se necessario, modificala dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> prima di effettuare nuovamente il login.
...
Per seguire la procedura, puoi consultare le nostre guide disponibili [qui](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan).

<ZoneTabs>
  <Tab label="Email e Zimbra Mail" availableIn={['eu']}>
    **Computer Windows**
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    **Computer Windows**
    - [Outlook per Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration).
    - [Thunderbird per Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-thunderbird).
    - [Posta per Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration).
    
    **Computer Apple Mac**
    - [Outlook per macOS](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-macos-configuration).
    - [Mail per macOS](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration).
    - [Thunderbird per macOS](/guides/web-cloud/email-and-collaborative-solutions/email-pro/thunderbird-macos-configuration).
  ...
  <Tab label="Microsoft Exchange" availableIn={['eu', 'ca']}>
    **Computer Windows**
    ...
    - [Thunderbird per Windows](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-thunderbird-windows).
...
Per farlo, accedi al tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, clicca su <code className="action">Web Cloud</code> e clicca su <code className="action">MX Plan</code>. Seleziona il dominio interessato, clicca sulla scheda <code className="action">Email</code> e poi nella colonna `Filtri` clicca sull’icona "Gestisci i filtri dell’account".
...
**Consigli e suggerimenti**: Se imposti un filtro sulla ricezione di SPAM, è probabile che alcune email legittime vengano considerate come SPAM. Queste email vengono chiamate "falsi positivi". In tal caso, ti invitiamo a creare una richiesta di assistenza dal tuo <ManagerLink to="/">Spazio Cliente</ManagerLink> per informarci. In questo modo potremo fare il necessario per fare in modo che queste email non vengano considerate come SPAM anche in futuro.
