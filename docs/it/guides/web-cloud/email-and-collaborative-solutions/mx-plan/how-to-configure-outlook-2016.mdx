...
<Tabs>
  ...
  <Tab label="Passo 5">
    ...
    <Region zones={['eu']}>
    - **Server**: imap.mail.ovh.net **o** ssl0.ovh.net
    - Porta: **993**
    ...
    <Region zones={['eu']}>
    - **Server**: smtp.mail.ovh.net **o** ssl0.ovh.net
    - Porta: **465**
    - Metodo di crittografia: **SSL/TLS**
    </Region>
...
**Indirizzo di posta**: lascia il tuo indirizzo e-mail completo.

Informazioni sul server

<Region zones={['eu']}>
- **Tipo di account**: seleziona IMAP
- **Server di posta in entrata**: imap.mail.ovh.net **o** ssl0.ovh.net
- **Server di posta in uscita (SMTP)**: smtp.mail.ovh.net **o** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Tipo di account**: seleziona IMAP
- **Server di posta in entrata**: imap.mail.ovh.ca
- **Server di posta in uscita (SMTP)**: smtp.mail.ovh.ca
</Region>
...
La finestra è divisa in due parti, **Posta in arrivo** e **Posta in uscita**. Clicca sulla parte che desideri modificare.
    ...
    Trova questo numero nel tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>, nella sezione <code className="action">Web Cloud</code> quindi <code className="action">Email Pro</code>. Il nome del server è visibile nel riquadro **Connessione** della scheda <code className="action">Informazioni generali</code>.
...
<Tabs>
  <Tab label="Configurazione IMAP">
    <Region zones={['eu']}>
    - **Server (entrante)**: imap.mail.ovh.net **o** ssl0.ovh.net.
    ...
    <Region zones={['ca', 'apac']}>
    - **Server (entrante)**: imap.mail.ovh.ca.
    - **Nome utente**: inserisci l'indirizzo e-mail **completo**.
    - **Password**: inserisci la password dell'indirizzo e-mail.
    - **Porta**: 993.
    - **Tipo di sicurezza**: SSL/TLS.
  ...
  <Tab label="Configurazione POP">
    <Region zones={['eu']}>
    - **Server (entrante)**: pop.mail.ovh.net **o** ssl0.ovh.net.
    - **Nome utente**: inserisci l'indirizzo e-mail **completo**.
    - **Password**: inserisci la password dell'indirizzo e-mail.
    - **Porta**: 995.
    - **Tipo di sicurezza**: SSL/TLS.
    ...
    <Region zones={['ca', 'apac']}>
    - **Server (entrante)**: pop.mail.ovh.ca.
    - **Nome utente**: inserisci l'indirizzo e-mail **completo**.
    - **Password**: inserisci la password dell'indirizzo e-mail.
    - **Porta**: 995.
    - **Tipo di sicurezza**: SSL/TLS.
...
<Region zones={['eu']}>
- **Server (uscita)**: smtp.mail.ovh.net **o** ssl0.ovh.net.
- **Nome utente**: inserisci l'indirizzo e-mail **completo**.
- **Password**: inserisci la password dell'indirizzo e-mail.
- **Porta**: 465.
- **Tipo di sicurezza**: SSL/TLS.
...
<Region zones={['ca', 'apac']}>
- **Server (uscita)**: smtp.mail.ovh.ca.
- **Nome utente**: inserisci l'indirizzo e-mail **completo**.
- **Password**: inserisci la password dell'indirizzo e-mail.
- **Porta**: 465.
- **Tipo di sicurezza**: SSL/TLS.
