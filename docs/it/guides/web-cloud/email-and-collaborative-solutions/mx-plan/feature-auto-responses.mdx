...
- Disporre di una soluzione MX Plan. Puoi effettuare questa operazione scegliendo tra una soluzione di [hosting Web](https://www.ovhcloud.com/it/web-hosting/) o l’offerta MX Plan ordinata separatamente.
