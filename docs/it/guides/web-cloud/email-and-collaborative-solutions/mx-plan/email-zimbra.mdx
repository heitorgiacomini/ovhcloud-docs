...
Accedi alla pagina [Webmail](https://www.ovhcloud.com/it/mail/). Inserisci il tuo indirizzo e-mail e la password e clicca su <code className="action">Invia</code>.

<img className="thumbnail" alt="Zimbra - connessione" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/ovhcloud-login-webmail.png" loading="lazy" />

Verrai reindirizzato all'interfaccia Zimbra.

<img className="thumbnail" alt="Zimbra - interfaccia" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-01.png" loading="lazy" />
...
<Tabs>
  <Tab label="Menu superiore">
    ...
    <img className="thumbnail" alt="Zimbra - menu superiore" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-02.png" loading="lazy" />
  </Tab>
  <Tab label="Colonna sinistra">
    ...
    <img className="thumbnail" alt="Zimbra - struttura" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-03.png" loading="lazy" />
  </Tab>
  <Tab label="Finestra centrale">
...
<img className="thumbnail" alt="Zimbra - cartelle" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-05.png" loading="lazy" />
...
Per creare una nuova cartella, fare clic sul pulsante <code className="action">+ Aggiungi una cartella</code> nella parte inferiore della colonna.

È inoltre possibile creare una sottocartella facendo clic con il pulsante destro del mouse sulla cartella desiderata e scegliendo <code className="action">Crea sottocartella</code>. 
...
<img className="thumbnail" alt="Zimbra - Cartelle" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-06.png" loading="lazy" />

:::info
**Tipo di visualizzazione**

La visualizzazione dei messaggi di posta elettronica è disponibile in una forma modificabile. Per farlo, clicca sul pulsante <code className="action">Visualizza</code> in alto a destra.
:::


È possibile ordinare e visualizzare le email in base a determinati criteri facendo clic sul filtro esistente (di default, <code className="action">Data</code>) in cima all'elenco delle email.
...
<img className="thumbnail" alt="Zimbra - azioni" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-07.png" loading="lazy" />
...
<Tabs>
  <Tab label="Ricerca semplice">
    ...
    <img className="thumbnail" alt="Zimbra - ricerca semplice" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-08.png" loading="lazy" />
  </Tab>
  <Tab label="Ricerca avanzata">
    ...
    <img className="thumbnail" alt="Zimbra - ricerca avanzata" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-09.png" loading="lazy" />
  </Tab>
</Tabs>
...
1. **Eliminazione di un'e-mail**: Quando visualizzi un'e-mail nella posta in arrivo o in uno dei cartelle e fai clic su <code className="action">elimina</code>, questa verrà spostata di default nel cestino.
2. **Svuota il cestino**: Quando fai clic su <code className="action">Svuota il cestino</code> o elimini un'e-mail da lì, l'e-mail non apparirà più nel cestino e entrerà nel periodo di conservazione di 30 giorni.
3. **Accedi al ripristino**: Per ripristinare un'e-mail eliminata dal cestino entro 30 giorni, fai clic con il tasto destro su <code className="action">Cestino</code>, quindi fai clic su <code className="action">Ripristina la posta eliminata</code>.
4. **Scegli le e-mail da ripristinare**: Da questa finestra puoi visualizzare le e-mail che sono state svuotate dal cestino. Seleziona l'e-mail o le e-mail che desideri ripristinare. Fai clic su <code className="action">Avanti</code>, scegli la cartella in cui desideri ripristinare le e-mail e fai clic su <code className="action">Salva</code>.

<img className="thumbnail" alt="Zimbra - ricerca semplice" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-restore.png" loading="lazy" />

### Scrivi un’email <a name="email-writing"></a>

Per scrivere una nuova email, clicca sul pulsante <code className="action">Nuovo Messaggio</code> (1) in alto a sinistra della finestra Zimbra.

<img className="thumbnail" alt="Zimbra - scrivere una e-mail" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-10.png" loading="lazy" />

<Tabs>
  <Tab label="Intestazione">
    ...
    - **A**: il/i destinatario/i della tua email. Clicca su <code className="action">A</code> per accedere alla tua [rubrica contatti](#contacts) e selezionare i destinatari.<br/>
    - **Cc**: fare clic su <code className="action">Cc/Ccn</code> a destra del campo <code className="action">A</code> per visualizzare il campo. La copia in formato cartaceo è un campo di destinazione che consente di inviare la propria e-mail in copia a persone che si desidera includere in un ciclo continuo senza che vengano considerate come destinatari diretti dell'e-mail (a differenza dei destinatari del campo "**A**").<br/>
    - **CCn**: clicca su <code className="action">Cc/Ccn</code> in corrispondenza del campo <code className="action">A</code> per visualizzare il campo. La copia in carbonio invisibile è un campo destinatario che permette di trasmettere un’email senza che gli altri destinatari vedano la persona o le persone in "**Ccn**".<br/>
    - **Oggetto**: titolo dell’email, primo elemento visibile alla ricezione prima di aprire l’email.<br/>
    - <code className="action">...</code>: situato a destra del campo <code className="action">Da</code>, ti dà accesso a 3 opzioni:<br/>
    ...
    <img className="thumbnail" alt="Zimbra - intestazione" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-11.png" loading="lazy" />
  </Tab>
  <Tab label="Testo dell’email">
    Per scrivere il corpo dell’email, nella parte inferiore della finestra è disponibile una barra degli strumenti HTML. In questo modo è possibile scrivere le email con il layout di pagina direttamente dal browser. Inoltre, il pulsante <code className="action">&lt; ></code> (all'estrema destra della barra degli strumenti) apre una finestra in cui è possibile incollare un messaggio e-mail prescritto da uno strumento esterno.
    
    <img className="thumbnail" alt="Zimbra - corpo" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-12.png" loading="lazy" />
  </Tab>
</Tabs>


Dopo aver scritto l’email, prima di cliccare su <code className="action">Invia</code>, puoi allegare un allegato cliccando sull’icona a graffetta accanto al pulsante <code className="action">Invia</code>.

<img className="thumbnail" alt="Zimbra - allegato" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-13.png" loading="lazy" />

:::tip[Success]
**Annulla un invio**

Se è stata selezionata l'opzione `Annulla invio` nella sezione "**Scrittura di email**" delle preferenze Zimbra, è possibile fare clic su <code className="action">ANNULLA</code> per annullare l'invio.
Questo pulsante rimane disponibile per circa 5 secondi.

<img className="thumbnail" alt="Zimbra - annullare un invio" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-cancel-email.png" loading="lazy" />
:::
...
<img className="thumbnail" alt="Zimbra - preferenze" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-14.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Visualizzazione email">
    ...
    - **Riquadro anteprima**: selezionare uno dei 3 layout per visualizzare le cartelle e le e-mail. Questa opzione riprende le scelte che trovi sul pulsante <code className="action">Mostra</code> quando visualizzi le tue email.
...
<img className="thumbnail" alt="Zimbra - contatti" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-15.png" loading="lazy" />

Per creare un nuovo contatto, clicca sul pulsante <code className="action">Nuovo contatto</code> in alto nella colonna di sinistra.
...
e clicca su <code className="action">Salva</code>.

<img className="thumbnail" alt="Zimbra - nuovo contatto" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-16.png" loading="lazy" />
...
Per creare una nuova cartella, fare clic sul pulsante <code className="action">+ Aggiungi una cartella</code> nella parte inferiore della colonna sinistra.

È inoltre possibile creare una sottocartella facendo clic con il pulsante destro del mouse sulla cartella desiderata e scegliendo <code className="action">Crea sottocartella</code>. Le cartelle "Contatti via e-mail" e "Cestino" non consentono la creazione di sottocartelle.

Per spostare un contatto in una delle cartelle, selezionarlo nella colonna centrale e fare clic sul pulsante <code className="action">Sposta</code> nella finestra del contatto visualizzata a destra. Seleziona la cartella che vuoi assegnare al contatto.

<img className="thumbnail" alt="Zimbra - cartelle dei contatti" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-17.png" loading="lazy" />
...
Per assegnare un contatto a uno degli elenchi, selezionare il contatto nella colonna centrale e quindi nella finestra visualizzata a destra fare clic su <code className="action">Assegna a elenchi</code>. Seleziona la lista o le liste che vuoi assegnare al contatto. In alternativa, digitare il nome di un nuovo elenco e fare clic su <code className="action">Aggiungi</code>.

<img className="thumbnail" alt="Zimbra - elenchi" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-list.png" loading="lazy" />
...
<Tabs>
  <Tab label="Importa i Contatti">
    ...
    Fare clic su <code className="action">Importa</code> per aprire la finestra di importazione. Il pulsante `Browse...` ti permette di andare a recuperare il file che contiene i tuoi contatti in formato ".csv" o ".vcf". <br/><br/>
    <img className="thumbnail" alt="Zimbra - Importa" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-19.png" loading="lazy" />
  </Tab>
  <Tab label="Esporta i Contatti">
    ...
    Clicca su <code className="action">Esporta</code> per aprire la finestra di esportazione. Seleziona il tipo di file da esportare e clicca su <code className="action">Esporta adesso</code>.<br/><br/>
    <img className="thumbnail" alt="Zimbra - Esportare" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-20.png" loading="lazy" />
  </Tab>
</Tabs>
...
- **(1)**: Per creare un calendario, posiziona il cursore su `Mie agende` nella colonna di sinistra e clicca sul pulsante `+`. Inserisci un nome e definisci un colore, poi clicca su <code className="action">Salva</code>

È inoltre possibile creare calendari secondari.

- **(2)**: Per creare un calendario secondario, spostare il cursore sul calendario per il quale si desidera crearne uno, quindi fare clic con il pulsante destro del mouse per visualizzare il menu a discesa. Clicca su `Aggiungi sottocalendario`. Inserisci un nome e definisci un colore, poi clicca su <code className="action">Salva</code>
...
- **(1)**: Clicca su <code className="action">Nuovo evento</code> nell’angolo in alto a sinistra.
- **(2)**: Fare clic sull'intervallo di tempo del calendario in cui si desidera aggiungere un evento. Per un’aggiunta semplificata, è sufficiente definire un titolo per l’evento e un luogo e cliccare su <code className="action">Salva</code>. Per aggiungere maggiori dettagli sul tuo evento, clicca su <code className="action">Aggiungi altri dettagli</code>
...
- **Attrezzatura**: cliccando su <code className="action">Mostra l’attrezzatura</code>, visualizzi questa linea per definire un’attrezzatura condivisa da utilizzare per il tuo evento.
...
Una volta definito l’evento, clicca su <code className="action">Registra</code>.
...
- **(1)**: Per creare un'attività, clicca sul pulsante <code className="action">...</code> e poi su <code className="action">Nuova impegno</code> o semplicemente sul pulsante <code className="action">+</code> accanto alla lista delle attività.

- **(2)**: Per creare una nuova lista di attività, clicca sul pulsante <code className="action">...</code> e poi su <code className="action">Crea elenco...</code>.
...
Clicca su <code className="action">Salva</code> per completare la creazione dell’operazione.
...
Clicca sull’icona <code className="action">Valigetta</code> nella barra superiore per accedere allo spazio di archiviazione. Potrete depositare i vostri file e condividerli.

1. Nella colonna a sinistra sono riportate le cartelle del tuo spazio di archiviazione.

    - Per creare una nuova cartella, clicca su <code className="action">+ Aggiungi una cartella</code> in fondo alla colonna. Inserisci il nome che ti interessa e conferma cliccando su <code className="action">Invio</code>.
    - Per creare una sottocartella, clicca con il tasto destro su una delle cartelle e seleziona <code className="action">Crea sottocartella</code>. Inserisci il nome che ti interessa e conferma cliccando su <code className="action">Invio</code>.
...
1. Clicca su <code className="action">Scarica</code> (Upload) nella colonna di sinistra.
2. Nella finestra Esplora file, seleziona il file o i file da caricare sullo spazio di archiviazione.
3. Clicca su <code className="action">Apri</code> per caricare gli elementi nel tuo spazio di archiviazione.
...
<Tabs>
  <Tab label="Condividi un file">
    1. Seleziona il file da condividere e clicca su <code className="action">Altro...</code>.
    2. Clicca su <code className="action">Condividi...</code>.
    3. Inserisci l’indirizzo email dell’ospite e clicca su <code className="action">Aggiungi</code>. È possibile aggiungere più indirizzi email.
    4. Seleziona i diritti che vuoi assegnare all'ospite.
    5. Clicca su <code className="action">Salva</code> per completare la condivisione.
  ...
  <Tab label="Condividi una cartella">
    1. Clicca con il tasto destro sulla cartella che vuoi condividere e poi clicca su <code className="action">Condividi...</code>.
    2. Inserisci l’indirizzo email dell’ospite e clicca su <code className="action">Aggiungi</code>. È possibile aggiungere più indirizzi email.
    3. Seleziona i diritti che vuoi assegnare all'ospite.
    4. Clicca su <code className="action">Salva</code> per completare la condivisione.
...
- Clicca sull'icona <code className="action">Valigetta</code> nella barra superiore per accedere allo spazio di archiviazione.
- Seleziona il file che desideri modificare.
- Nella barra superiore, clicca su <code className="action">Modifica</code>.
...
<img className="thumbnail" alt="Zimbra - filtri" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-filters.png" loading="lazy" />
...
Per accedere alla creazione dei filtri, clicca sull’icona a forma di ingranaggio in alto a destra e poi su <code className="action">Impostazioni</code> e infine su <code className="action">Filtri</code> nella colonna di sinistra.

<img className="thumbnail" alt="Zimbra - creare un filtro" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-21.png" loading="lazy" />

Se esistono dei filtri, visualizzerai la lista secondo il loro ordine di applicazione:

- **(1)** Per visualizzare l'anteprima di ogni filtro, clicca sul pulsante <code className="action">...</code> a destra del filtro e seleziona <code className="action">Dettagli</code>. Il pulsante <code className="action">Esegui</code> consente di avviare l'azione impostata per questo filtro.
...
Clicca sul pulsante <code className="action">+ Aggiungi un filtro</code> per avviare la creazione. Per impostazione predefinita, viene visualizzata la finestra della modalità semplice. È possibile passare alla modalità avanzata facendo clic su <code className="action">Avanzate</code> per disporre di tutti gli operatori di confronto. Per maggiori informazioni, consulta la sezione "[Come configurare i filtri](#filters-howto)".

<Tabs>
  <Tab label="Modalità semplice">
    <img className="thumbnail" alt="Zimbra - filtri - modalità singola" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-22.png" loading="lazy" />
  </Tab>
  <Tab label="Modalità avanzata">
    <img className="thumbnail" alt="Zimbra - filtri - modalità avanzata" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-23.png" loading="lazy" />
  </Tab>
</Tabs>
...
- Clicca sul pulsante <code className="action">⚙</code> nell'angolo in alto a destra della finestra del webmail.
- Clicca su <code className="action">Impostazioni</code>.
- Clicca sulla sezione <code className="action">Filtri</code> dalla finestra delle impostazioni.
- Clicca sul pulsante <code className="action">Aggiungi un filtro</code>.
    ...
    - Nella riga successiva, seleziona <code className="action">A</code> (To), lascia <code className="action">contiene</code> (contains), e inserisci l'indirizzo email a cui sei connesso nel campo a destra.
    ...
    - Clicca su <code className="action">+ Aggiungi un'azione</code> (Add an action) più in basso, quindi seleziona `Mantieni nella casella di posta` (Keep in Inbox).
    - Clicca su <code className="action">Salva</code> nella finestra del filtro e anche in quella delle impostazioni.
...
Per accedere all’impostazione di delega, clicca sull’icona a forma di ingranaggio in alto a destra e poi su <code className="action">Impostazioni</code> e infine su <code className="action">Scrittura di email</code> nella colonna di sinistra.
...
**(1) Delegati**. Per delegare il tuo account email a un altro account, clicca su <code className="action">Aggiungi delegati</code>.
...
Clicca sull’icona a forma di ingranaggio in alto a destra e poi su <code className="action">Impostazioni</code> e infine su <code className="action">Firme</code> nella colonna di sinistra.
...
Per accedere alla gestione della tua risposta automatica, clicca sull’icona a forma di ingranaggio in alto a destra e seleziona <code className="action">Impostazioni</code> > <code className="action">Fuori ufficio</code>.
...
- Il pulsante <code className="action">Inviami un messaggio di esempio</code> consente di visualizzare in anteprima la risposta automatica nella Posta in arrivo.
...
[Iniziare a utilizzare MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities)

[Modificare la password di un indirizzo email MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-change-password)
