...
Per effettuare una migrazione per file o multipli, consulta le sezioni "Migrazione per file" e "Realizzare e seguire una migrazione multipla (modalità progetto)" della nostra guida "[Migrare account email tramite OVHcloud Mail Migrator](/guides/web-cloud/email-and-collaborative-solutions/migrating/omm-migrate-email-account-to-ovhcloud)".
...
Per eliminare l’indirizzo email MX Plan (esempio: `contact@mydomain.ovh`), consulta la nostra guida "[Eliminare un account email](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/delete-email-account)".
...
[Configurare un indirizzo email Zimbra su un client di posta](/guides/web-cloud/email-and-collaborative-solutions/zimbra/mail-apps)
