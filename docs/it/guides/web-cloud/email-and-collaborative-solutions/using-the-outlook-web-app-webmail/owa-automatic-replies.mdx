...
<Region zones={['ca']}>
- Aver installato una soluzione email OVHcloud [Exchange](https://www.ovhcloud.com/it/emails/hosted-exchange/)
</Region>
...
[Concedere autorizzazioni di accesso a un account Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation)
