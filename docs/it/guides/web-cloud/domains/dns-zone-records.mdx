...
<Tabs>
  <Tab label="MX">
    **M**ail e**X**changer <br/><br/>
    ...
    È probabile che il tuo provider di posta disponga di diversi server di posta: è necessario creare diversi record MX. Consulta la nostra guida [Aggiungere un record MX alla configurazione di un nome di dominio](/guides/web-cloud/domains/dns-zone-mx).
