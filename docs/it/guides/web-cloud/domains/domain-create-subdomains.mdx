...
Proprio come per un nome di dominio, per autorizzare un sottodominio a visualizzare il contenuto di una directory "target" dichiarata per un sito web presente su un hosting web, accedi all'<ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> e seleziona <code className="action">Web Cloud</code>. Clicca su <code className="action">Hosting</code> nella colonna di sinistra, seleziona l'hosting interessato dove si trova il tuo sito web, quindi scegli la scheda <code className="action">I miei siti</code>.

Da qui potrai autorizzare l'accesso del tuo sottodominio al tuo sito web presente sul tuo hosting web.

Per maggiori dettagli sulla configurazione di un dominio o di un sottodominio su un hosting web, consulta la nostra guida "[Come associare un nome a dominio a un sito web esistente ?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website)". Che si tratti di un nome a dominio o di un sottodominio, la procedura è la stessa.
