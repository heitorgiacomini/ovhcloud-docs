...
description: Questa guida ti mostra come effettuare il trasferimento di un nome di dominio OVHcloud verso un altro provider
...
<Tabs>
  ...
  <Tab label="Step 2">
    Nella scheda <code className="action">Informazioni generali</code>, visualizza il cursore `Protezione contro il trasferimento` sotto **Sicurezza**, impostato su <code className="action">Attiva</code> di default.
    ...
    <img className="thumbnail" alt="protezione attivata" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/protection-against-domain-name-transfert-enabled.png" loading="lazy" />
  </Tab>
  <Tab label="Step 3">
    Clicca sul cursore e conferma nella nuova finestra che vuoi eliminare questa protezione. Attendi qualche minuto prima che lo stato passi alla <code className="action">Disattivazione</code>.
    ...
    Inoltre, se visualizzi il messaggio: "**AUTH/INFO code : Authcode is not managed by OVHcloud, contact the registry to claim it**", significa che il codice di trasferimento del tuo nome di dominio non può essere recuperato dal tuo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
    
    In entrambi i casi, verifica di essere il contatto **amministratore** del nome di dominio utilizzando la nostra guida sulla [gestione dei contatti](/guides/account-and-service-management/account-information/managing-contacts) e verifica che l'estensione del tuo nome di dominio permetta lo sblocco dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
    ...
    <img className="thumbnail" alt="disattivazione protezione" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/protection-against-domain-name-transfert-deactivating.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Step 2">
    Nella scheda <code className="action">Informazioni generali</code>, clicca su <code className="action">AUTH/INFO</code> accanto alla voce <code className="action">Protezione contro il trasferimento</code>. Se necessario, aggiorna la pagina.
...
[Trasferimento di nome di dominio.co.uk in uscita](/guides/web-cloud/domains/transfer-outgoing-couk)
