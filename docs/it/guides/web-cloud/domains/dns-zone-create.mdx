...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina <ManagerLink to="/#/web/zone">Zone DNS</ManagerLink>, quindi sul pulsante <code className="action">Ordina</code>.
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina <ManagerLink to="/#/web/zone">Zone DNS</ManagerLink>, poi scegli il dominio interessato.
