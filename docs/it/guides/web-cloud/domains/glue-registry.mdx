...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina <ManagerLink to="/#/web/zone">Zone DNS</ManagerLink>, poi seleziona il dominio che hai utilizzato per creare gli host nella [parte 3](#step3).
...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina <ManagerLink to="/#/web/zone">Zone DNS</ManagerLink>, poi seleziona il dominio per il quale hai personalizzato i server DNS.
...
<Tabs>
  <Tab label="Step 1">
    Accedi alla pagina <ManagerLink to="/#/web-domains/domain">Domini</ManagerLink>, poi seleziona *il dominio per il quale desideri personalizzare i server DNS*.
