...
:::info
La creazione / modifica / eliminazione di una zona DNS dallo <ManagerLink to="/#/web/zone">Spazio Cliente OVHcloud</ManagerLink> è totalmente gratuita.
...
<Tabs>
  <Tab label="Passaggio 1">
    Accedi alla pagina <ManagerLink to="/#/billing/autorenew/services">Le mie offerte e servizi</ManagerLink>, poi clicca sul pulsante <code className="action">...</code> a destra della zona DNS che desideri annullare, quindi su <code className="action">Disattivare il servizio</code>.
