...
Per aggiungere un record SPF alla configurazione di OVHcloud del tuo nome di dominio, accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Clicca su <code className="action">Domini</code> e poi sulla scheda <code className="action">Zona DNS</code>.
...
Per modificare il record SPF nella configurazione di OVHcloud del tuo nome di dominio, accedi allo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Clicca su <code className="action">Domini</code> e poi sulla scheda <code className="action">Zona DNS</code>.
