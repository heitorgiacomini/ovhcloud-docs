...
- **Dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>**, dove un assistente di configurazione permette di impostare il reindirizzamento.
...
Attenzione: un reindirizzamento creato dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> non permette di reindirizzare un URL in `https://` verso un altro dominio o un altro URL.
...
Oltre ai reindirizzamenti di "puntamento" verso i record DNS A, AAAA e CNAME, sono disponibili 3 opzioni di reindirizzamento dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>.
