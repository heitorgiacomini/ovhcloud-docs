---
title: Operational Best Practices with Public Cloud Databases for MongoDB
description: Best practice to operate an OVHcloud managed MongoDB
...
- **OVHcloud Built-in Monitoring Tools:**
    - [Metrics tab](/guides/public-cloud/databases/mongodb-monitoring): Provides comprehensive monitoring dashboards.

- **OVHcloud MongoDB Prometheus Endpoint:**
    - [Prometheus metrics](/guides/public-cloud/databases/service-metrics-with-prometheus): Fetch service metrics with Prometheus.
...
- **Third-Party Tools:**
    ...
    - [Hatchet](/guides/public-cloud/databases/mongodb-why-mongodb): Parses the logs to help you identify slow queries.
...
- **OVHcloud Automated Backup Solutions:**
    - [OVHcloud Automated Backup](/guides/public-cloud/databases/backups).
    - [OVHcloud Restore Backup](/guides/public-cloud/databases/restore-backup)
- **Snapshot-based Backups**
    - [mongodump and mongorestore](/guides/public-cloud/databases/mongodb-howto-backup-restore): Regular snapshots of the data.
...
- [Network Security](/guides/public-cloud/databases/mongodb-manage-control-panel):
...
- [**User Management**](/guides/public-cloud/databases/mongodb-manage-control-panel):
...
- [**Use Appropriate Indexes:**](/guides/public-cloud/databases/mongodb-developer-best-practices) Create indexes to support query patterns and Regularly review and optimize indexes.
