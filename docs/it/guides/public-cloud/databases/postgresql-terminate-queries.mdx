...
description: This guide explains how to detect and terminate specific sessions via the OVHcloud Control Panel and Command Line Interface (CLI)
...
Click the <code className="action">Queries in progress</code> tab.
...
In the table list, find the session you want to terminate then click the <code className="action">...</code> button at the end of the line. You will be able to terminate the session and related backend process directly.

<img className="thumbnail" alt="Terminate button" src="/images/public-cloud/databases/postgresql-11-terminate-queries/postgresql-11-terminate.png" loading="lazy" />
...
Please refer to this [guide](/guides/public-cloud/databases/postgresql-connect-cli) to find out how to connect to your database using `psql`.
