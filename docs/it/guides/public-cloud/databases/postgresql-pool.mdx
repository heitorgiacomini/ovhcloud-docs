...
description: Create and use connection pools in your Public Cloud Databases for PostgreSQL
...
Click on <code className="action">Databases</code> in the left-hand navigation bar and select your PostgreSQL instance, then select the <code className="action">Pools</code> tab.
Click on <code className="action">Add a pool</code>, and fill the form.
...
<img className="thumbnail" alt="Add a pool" src="/images/public-cloud/databases/postgresql-08-pool/postgresql_08_pool-20220411131919759.png" loading="lazy" />

:::info
You can edit, delete and access information about the pool by clicking on <code className="action">...</code> to the right of the pool.
...
Click on <code className="action">Information</code>, then collect the required information.

<img className="thumbnail" alt="Pool informations" src="/images/public-cloud/databases/postgresql-08-pool/postgresql_08_pool-2022041113491326.png" loading="lazy" />
