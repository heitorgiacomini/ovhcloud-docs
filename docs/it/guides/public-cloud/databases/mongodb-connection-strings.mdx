...
- A MongoDB instance running on your OVHcloud Public Cloud Databases ([this guide](/guides/public-cloud/databases/getting-started) can help you to meet this requirement)
...
<img className="thumbnail" alt="Copy SRV URI from the OVHcloud manager" src="/images/public-cloud/databases/mongodb-10-connection-strings/copy-srv-ovhcloud-control-panel.png" loading="lazy" />
...
<img className="thumbnail" alt="Connect from MongoDB Compass" src="/images/public-cloud/databases/mongodb-10-connection-strings/connect-compass.png" loading="lazy" />

MongoDB Compass establishes the connection and you should now be able to explore your databases.

<img className="thumbnail" alt="MongoDB Compass is connected" src="/images/public-cloud/databases/mongodb-10-connection-strings/compass-connected.png" loading="lazy" />
...
<img className="thumbnail" alt="Add node from OVHcloud Control Panel" src="/images/public-cloud/databases/mongodb-10-connection-strings/add-node-ovhcloud-control-panel.png" loading="lazy" />
...
<img className="thumbnail" alt="MongoDB Compass connection info 4 nodes" src="/images/public-cloud/databases/mongodb-10-connection-strings/compass-connection-info-4-nodes.png" loading="lazy" />
...
<img className="thumbnail" alt="Remove node from OVHcloud Control Panel" src="/images/public-cloud/databases/mongodb-10-connection-strings/remove-node-ovhcloud-control-panel.png" loading="lazy" />
...
<img className="thumbnail" alt="MongoDB Compass connection info 4 nodes" src="/images/public-cloud/databases/mongodb-10-connection-strings/compass-connection-info-3-nodes.png" loading="lazy" />
