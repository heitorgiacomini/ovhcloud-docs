---
title: Fetch service metrics with Prometheus for Public Cloud Databases
description: Find out how to setup a Prometheus exporter for your Public Cloud databases service
...
- A [Public Cloud databases service](https://www.ovhcloud.com/it/public-cloud/databases/) up and running,
