...
description: Come utilizzare i token via API Keystone
...
Per connetterti a Horizon e scaricare il file, consulta [questa guida](/guides/public-cloud/cross-functional/introducing-horizon).
