...
Se non hai più bisogno di un [progetto Public Cloud](https://www.ovhcloud.com/it/public-cloud/), è possibile eliminarlo direttamente dallo Spazio Cliente <ManagerLink to="/">OVHcloud</ManagerLink>.
...
<img className="thumbnail" alt="elimina il progetto" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject1.png" loading="lazy" />
...
<img className="thumbnail" alt="elimina il progetto" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject2.png" loading="lazy" />
