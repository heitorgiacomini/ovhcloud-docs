...
- Aver creato un utente OpenStack. A questo proposito, consulta [l’apposita guida](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- Aver preparato l’ambiente di sviluppo per utilizzare l’API OpenStack. A questo proposito, consulta questa guida: [Preparare l’ambiente per utilizzare l’API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
...
Nel menu di sinistra, sotto la rubrica **Impostazioni**, clicca su <code className="action">Utenti e ruoli</code>. Poi clicca sui <code className="action">...</code> a destra del tuo utente e seleziona <code className="action">Scarica il file RC di Openstack</code>.

<img className="thumbnail" alt="openstack-variables" src="/images/public-cloud/cross-functional/loading-openstack-environment-variables/download_rc_file.png" loading="lazy" />
...
Come indicato in [questa guida](/guides/public-cloud/cross-functional/create-and-delete-a-user), la password è visibile una sola volta, cioè al momento della sua creazione.
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/loading-openstack-environment-variables/pciopenstackvariables2.png" loading="lazy" />
