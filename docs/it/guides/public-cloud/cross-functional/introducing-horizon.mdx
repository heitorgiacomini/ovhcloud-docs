...
- Disporre di un [progetto Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) nel tuo account OVHcloud.
- **[Facoltativo da settembre 2023]** Un utente [OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) creato nel tuo progetto. Questo step è facoltativo in quanto abbiamo eseguito un’autenticazione unica (SSO: *Single Sign-On*) tra lo Spazio Cliente OVHcloud e Horizon.
...
<img className="thumbnail" alt="volume" src="/images/public-cloud/cross-functional/introducing-horizon/volumes2021.png" loading="lazy" />
...
<img className="thumbnail" alt="orchestrazione" src="/images/public-cloud/cross-functional/introducing-horizon/orchestration2021.png" loading="lazy" />
