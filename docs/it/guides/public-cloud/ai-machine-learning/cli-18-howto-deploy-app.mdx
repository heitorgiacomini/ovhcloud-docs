...
description: Learn how to run an AI Deploy app using the CLI
lastUpdated: 2024-05-29
---

## Objective

This guide covers the submission of [**apps**](/guides/public-cloud/ai-machine-learning/ai-deploy-getting-started) through the [**ovhai CLI**](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
- A working `ovhai` CLI. See [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client)
...
:::info
More information about adding and managing public & private registries can be found [here](/guides/public-cloud/ai-machine-learning/ai-manage-registries).
:::
...
For more information about **static and automatic scaling strategies**, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-apps-deployments).
...
Using tokens can help you share your app securely. More information about creating, managing and using tokens can be found [here](/guides/public-cloud/ai-machine-learning/ai-deploy-tokens). 
...
To know more about the CLI and available commands to interact with your app check out the [overview of `ovhai`](/guides/public-cloud/ai-machine-learning/ai-cli-overview).
