...
description: How to deploy and call an API for spam classification using FastAPI
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-08-fastapi-spam-classifier/overview-spam-classifier.png" loading="lazy" />
...
- You also should have followed the tutorial [AI Notebooks - Tutorial - Build your spam classifier](/guides/public-cloud/ai-machine-learning/ai-notebooks-spam-classifier). Find the code on the [GitHub repository](https://github.com/ovh/ai-training-examples/blob/main/notebooks/natural-language-processing/text-classification/miniconda/spam-classifier/notebook-spam-classifier.ipynb). You will be able to understand the creation of the spam classification model.
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-08-fastapi-spam-classifier/get-method-fastapi.png" loading="lazy" />
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-08-fastapi-spam-classifier/docs-fastapi.png" loading="lazy" />
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-08-fastapi-spam-classifier/post-method-fastapi.png" loading="lazy" />

To get the result of the prediction, click on the `Execute` button.

<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-08-fastapi-spam-classifier/prediction-message-fastapi.png" loading="lazy" />

Congratulations! You have obtained the result of the prediction with the **label** and the **confidence score**.

## Go further

- You can imagine deploying an AI model with an other tool: **Gradio**. Read this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-gradio-sketch-recognition).
- Another way to create an AI Deploy app is to use **Streamlit**! [Follow this tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-eda-iris).
