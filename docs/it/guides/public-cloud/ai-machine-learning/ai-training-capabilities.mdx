...
description: Find out about current features, capabilities and limitations of AI Training
...
AI Training is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
You are also able to check it from the OVHcloud Control Panel in your job information by clicking the <code className="action">Go to Graph Dashboard</code> button.
...
However, by default, your AI Training job will automatically shut down after **7 consecutive days of being in a RUNNING state**. You can also enable **Automatic Restart** to have it restart every 7 days, or contact [our support](https://help.ovhcloud.com/csm?id=csm_get_help) to extend this period to **28 days**.
:::
...
Learn how to build and use your custom Docker image in this [tutorial](/guides/public-cloud/ai-machine-learning/ai-training-build-use-custom-image).
...
Browse the full [AI Training documentation](/guides/public-cloud/ai-machine-learning/overview) to further understand the main concepts and get started.
