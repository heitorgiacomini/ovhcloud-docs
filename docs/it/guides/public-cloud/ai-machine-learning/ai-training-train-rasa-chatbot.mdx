...
description: Understand how simple it is to train a chatbot with AI Training
...
Deployment will be performed in the second part of the tutorial which you can find here: [How to deploy a chatbot](/guides/public-cloud/ai-machine-learning/ai-deploy-rasa-chatbot).
...
If you want to create a Rasa chatbot with a notebook, please follow this tutorial: [Create and train a Rasa chatbot](/guides/public-cloud/ai-machine-learning/ai-notebooks-create-rasa-chatbot).
...
If you want to know more about data storage concept, read this guide: [Create an object container](/guides/storage-and-backup/object-storage/pcs-create-container). 
...
For more explanation about the CLI command for AI Training, please read this guide: [CLI Reference](/guides/public-cloud/ai-machine-learning/ai-cli-overview).
...
<img className="thumbnail" alt="image" src="/images/public-cloud/ai-machine-learning/training-tuto-07-train-rasa-chatbot/discussion.png" loading="lazy" />
...
More explanations are here: [CLI Reference](/guides/public-cloud/ai-machine-learning/ai-cli-overview).
...
[How to create and train a rasa chatbot](/guides/public-cloud/ai-machine-learning/ai-notebooks-create-rasa-chatbot)

If you want to deploy your model created with the chatbot, you can follow this tutorial. 

[How to deploy a chatbot](/guides/public-cloud/ai-machine-learning/ai-deploy-rasa-chatbot)
