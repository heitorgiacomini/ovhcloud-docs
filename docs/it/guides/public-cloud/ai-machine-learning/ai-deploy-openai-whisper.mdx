...
description: How to deploy OpenAI’s Whisper Speech Recognition Model
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-17-streamlit-whisper/speech-to-text.png" loading="lazy" />
...
- A [user for AI Deploy & Object Storage](/guides/public-cloud/ai-machine-learning/ai-users)
...
You can create your Object Storage bucket using either the UI (OVHcloud Control Panel) or the `ovhai` CLI, which can be downloaded [here](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).

<Tabs>
  <Tab label="Using the Control Panel (UI)">
    If you do not feel comfortable with commands, this method may be more intuitive.
    
    First, go to the <code className="action">Public Cloud</code> section of the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
...
To do this, you will need [Docker](https://www.docker.com/get-started), either installed directly on your computer, or using a Debian Docker Instance, available on the <ManagerLink to="/">Public Cloud</ManagerLink>.
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-17-streamlit-whisper/whisper-app-overview.png" loading="lazy" />
...
You could also combine your transcripts with an LLM. Learn how to [Deploy LLaMA 2 on AI Deploy](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-llama2-chatbot-app).
