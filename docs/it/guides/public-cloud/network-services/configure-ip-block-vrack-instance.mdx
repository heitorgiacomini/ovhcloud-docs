...
As well as private IP addressing, the [vRack](https://www.ovhcloud.com/it/network/vrack/) also lets you route public IP traffic through your server's [vRack](https://www.ovhcloud.com/it/network/vrack/) port using a public IP address block.
...
- A [vRack](https://www.ovhcloud.com/it/network/vrack/) service activated in your account
