...
- Un volume [Block Storage](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance) creato nel tuo progetto [Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
