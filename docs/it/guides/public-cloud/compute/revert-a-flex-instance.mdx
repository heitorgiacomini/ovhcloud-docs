...
- Disporre di un'[istanza Public Cloud OVHcloud](/guides/public-cloud/compute/getting-started#configuration) di tipo *flex*
- [Crea un accesso all'interfaccia Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
