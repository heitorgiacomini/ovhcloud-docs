...
description: Scopri le funzionalità, le capacità e i limiti attuali delle istanze Local Zones
lastUpdated: 2026-01-16
---

## Obiettivo

Le istanze Local Zones sono un'estensione delle [regioni](https://www.ovhcloud.com/it/public-cloud/regions-availability/) che avvicinano i servizi OVHcloud a luoghi specifici, offrendo latenza ridotta e performance migliorate per le applicazioni.
