...
description: Scopri come condividere immagini tra progetti Public Cloud con OpenStack
lastUpdated: 2025-04-01
---

## Obiettivo

In alcuni casi potrebbe essere necessario condividere un’immagine [Instance Backup](/guides/public-cloud/compute/save-an-instance) o un’immagine [Volume Backup](/guides/public-cloud/compute/volume-backup) tra più progetti Public Cloud.
...
Per maggiori informazioni, consulta la [documentazione ufficiale OpenStack](https://docs.openstack.org/image-guide/share-images.html).
...
- [Preparare l’ambiente di sviluppo all’API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
