...
Segui gli step rimanenti, come descritto in [questa guida](/guides/public-cloud/compute/getting-started#create-instance). Questo processo potrebbe richiedere alcuni minuti.
