...
- Attach Interface: questa opzione permette di aggiungere una o più interfacce private alla tua istanza tramite la VLAN. Per maggiori informazioni, consulta [questa sezione](/guides/public-cloud/network-services/vrack#adding-a-private-interface) della guida.
- Detach Interface: questa opzione si usa per staccare un'interfaccia associata a un'istanza. Per maggiori informazioni, consulta [questa sezione](/guides/public-cloud/network-services/vrack#removing-a-private-interface) della guida.
