...
- Aver creato un'istanza Public Cloud dallo [Spazio Cliente OVHcloud](/guides/public-cloud/compute/getting-started) o tramite l'[interfaccia Horizon](/guides/public-cloud/compute/create-instance-in-horizon).
- [Aver creato una chiave SSH](/guides/public-cloud/compute/creating-ssh-keys).
...
- Attach Interface: questa opzione permette di aggiungere una o più interfacce private alla tua istanza tramite la VLAN. Per maggiori informazioni, consulta [questa sezione](/guides/public-cloud/network-services/vrack#aggiunta-di-uninterfaccia-privata) della guida.
- Detach Interface: questa opzione si usa per staccare un'interfaccia associata a un'istanza. Per maggiori informazioni, consulta [questa sezione](/guides/public-cloud/network-services/vrack#elimina-uninterfaccia-privata) della guida.
...
Per maggiori informazioni, consulta [questa guida](/guides/public-cloud/compute/getting-started#user-mgmt).
