...
description: Come condividere un oggetto senza fornire informazioni personali
...
- Aver [preparato l’ambiente per utilizzare l’API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
