...
description: Come aggiornare un sistema operativo alla fine del ciclo di vita
...
Pertanto, prima di seguire questo tutorial, OVHcloud raccomanda vivamente di [salvare l'istanza](/guides/public-cloud/compute/save-an-instance) e di effettuare test approfonditi sulle applicazioni, per assicurarti che funzionino sulla nuova versione del sistema operativo.
:::
...
- Avere un [accesso amministratore al server](/guides/public-cloud/compute/getting-started#connect-instance)
- Aver effettuato [un backup della tua istanza](/guides/public-cloud/compute/save-an-instance)
...
Verifica che le tue applicazioni funzionino come previsto. In caso di problemi, ti consigliamo di [ripristinare il backup](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) prima dell'aggiornamento.
