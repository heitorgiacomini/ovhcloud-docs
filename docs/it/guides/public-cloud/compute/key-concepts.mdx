...
description: "Scopri i fondamenti del Public Cloud Compute: funzionamento delle istanze, famiglie e dimensioni disponibili, distribuzioni multi-AZ, gestione delle immagini, sicurezza SSH, meccanismi di backup, rete pubblica/privata e vantaggi dei Savings Plans."
...
Le istanze Public Cloud di OVHcloud sono distribuite su [più centri dati in tutto il mondo](https://www.ovhcloud.com/it/about-us/global-infrastructure/regions/), garantendo un'elevata disponibilità e vicinanza ai tuoi utenti. Esempi di regioni:
...
:::info
**Buona pratica**: Per i carichi di lavoro critici, privilegia un [deploy multi-AZ](/guides/public-cloud/cross-functional/deployments-modes-reference-architecture) per garantire resilienza e continuità del servizio.
:::
...
Per ulteriori dettagli sulla configurazione delle reti Public Cloud, consulta la guida ufficiale [OVHcloud sulle reti](/guides/public-cloud/network-services/concepts).
...
I Savings Plans ti aiutano ad ottimizzare il tuo budget mantenendo le prestazioni e l'affidabilità del tuo ambiente cloud. Per ulteriori informazioni, consulta la guida ufficiale [OVHcloud sui Savings Plans](/guides/public-cloud/cross-functional/savings-plans).
...
- [Come creare un'istanza Public Cloud e accedervi](/guides/public-cloud/compute/getting-started)
- [Gestisci le tue istanze Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance)
- [Avvia un'istanza su un volume avviabile](/guides/public-cloud/compute/start-instance-on-attached-volume)
- [Metti in sospensione o sospendi un'istanza](/guides/public-cloud/compute/suspend-or-pause-an-instance)
