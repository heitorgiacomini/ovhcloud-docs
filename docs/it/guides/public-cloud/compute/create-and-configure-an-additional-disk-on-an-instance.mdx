...
- Se si desidera preparare l'ambiente per l'utilizzo di [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform), è necessario prepararlo.

**Questa guida ti mostra come creare un disco aggiuntivo e configurarlo sulla tua istanza.**

## Prerequisiti

- Disporre di un'istanza [Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) nel proprio account OVHcloud
- Avere un accesso amministratore (sudo) alla tua istanza via SSH
- Prepara l'ambiente per utilizzare [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform)
...
<summary>**Classic - 500 IOPS garantiti**</summary>
...
<Tabs>
  <Tab label="Dallo Spazio Cliente OVHcloud">
    Apri <code className="action">Block Storage</code> nel menu a sinistra sotto **Storage & Backup**.
    
    In questa sezione, clicca sul pulsante <code className="action">Crea un volume</code>.
    
    <img className="thumbnail" alt="seleziona il progetto" src="/images/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance/avolume01.png" loading="lazy" />

Seguire i passaggi di configurazione per selezionare le opzioni relative a posizione, tipo, crittografia e capacità del disco. Inserisci un nome per il volume e conferma cliccando su <code className="action">Crea il volume</code>.
...
A destra del volume, clicca sul pulsante <code className="action">...</code> e seleziona <code className="action">Associa all’istanza</code>.
...
Nella nuova finestra, seleziona un’istanza dalla lista e clicca su <code className="action">Conferma</code> per associare il disco.
...
Il processo di associazione del disco all'istanza sta per iniziare. L'operazione potrebbe richiedere alcuni minuti.
  ...
  <Tab label="Tramite l'interfaccia Horizon">
    Accedi alla sezione a tendina <code className="action">Volumes</code>, clicca su <code className="action">Volumes</code> e poi su <code className="action">Create Volume</code>.
...
Inserisci il campo <code className="action">Volume Name</code> e seleziona il tipo di volume che desideri. Clicca su <code className="action">Create Volume</code>.
...
Per associare questo volume a un'istanza, sulla linea del volume, clicca su la freccia accanto a <code className="action">Edit Volume</code>. Clicca su <code className="action">Manage Attachments</code>
...
Seleziona l’istanza a cui vuoi associare il tuo volume e clicca su <code className="action">Attach Volume</code>.
...
Apri una [connessione SSH alla tua istanza](/guides/public-cloud/compute/getting-started#connect-instance) e utilizza il comando qui sotto per visualizzare i dischi associati.
...
Una volta connesso, clicca con il tasto destro sul pulsante <code className="action">Inizia</code> e apri la <code className="action">Gestisci i dischi</code>.
...
<img className="thumbnail" alt="volume sconosciuto" src="/images/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance/disk-management-01.png" loading="lazy" />
...
Se il disco è indicato come offline, è probabile che sia dovuto alla politica applicata all'istanza. Per risolvere il problema clicca con il tasto destro sul disco e seleziona <code className="action">online</code>.
...
Clicca di nuovo sul tasto destro e seleziona questa volta <code className="action">Inizia il disco</code>.
...
Quindi, selezionare <code className="action">MBR</code> se il disco aggiuntivo è inferiore a 2TB, o <code className="action">GPT</code> se è superiore a 2TB, quindi fare clic su <code className="action">OK</code>.
...
Fai un click con il tasto destro sul pulsante <code className="action">Inizia</code> e apri <code className="action">Esegui</code>.
...
<img className="thumbnail" alt="run promo" src="/images/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance/run-prompt.png" loading="lazy" />
...
Nello strumento <code className="action">Gestione disco</code>, clicca con il tasto destro sul nuovo disco e seleziona <code className="action">Nuovo volume semplice...</code>.
...
Clicca su <code className="action">Avanti</code> per specificare la dimensione del volume. Di default deve essere il massimo. Clicca su <code className="action">Avanti</code> per continuare
...
Lascia la nuova lettera del lettore di default o scegline un'altra, poi clicca su <code className="action">Seguente</code>.
...
Nell'ultima finestra, clicca su <code className="action">Terminer</code> per formattare il disco.
...
<Tabs>
  <Tab label="Con Linux">
    Apri una [connessione SSH alla tua istanza](/guides/public-cloud/compute/getting-started#step-3-crea-unistanza) e utilizza il comando qui sotto per visualizzare i dischi associati.
  ...
  <Tab label="Con Windows">
    Installa una connessione RDP (Remote Desktop) con la tua istanza Windows.
    
    Una volta connesso, clicca con il tasto destro sul menu <code className="action">Avviare</code> e apri la <code className="action">Gestione disco</code>.
    
    <img className="thumbnail" alt="gestione dei dischi" src="/images/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance/start-menu.png" loading="lazy" />

Fai click con il tasto destro sul volume che vuoi smontare e selezionare <code className="action">Cambia lettera e percorso di unità...</code>.
...
Clicca su <code className="action">Rimuovi</code> per rimuovere il disco.
...
Clicca su <code className="action">Sì</code> per confermare l'eliminazione della lettera del disco.
...
<Tabs>
  <Tab label="Dallo Spazio Cliente OVHcloud">
    Accedi alla sezione <code className="action">Public Cloud</code> dello Spazio Cliente e clicca su <code className="action">Block Storage</code> nel menu a sinistra sotto **Storage e Backup**.
    
    Clicca sui <code className="action">...</code> in corrispondenza del volume corrispondente e seleziona <code className="action">Scollega dall'istanza</code>.
...
Clicca su <code className="action">Conferma</code> nella finestra che appare per avviare il processo.
