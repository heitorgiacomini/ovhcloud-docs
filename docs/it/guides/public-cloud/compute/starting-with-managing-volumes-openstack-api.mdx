...
- [Preparare l'ambiente per utilizzare l'API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) installando python-cinderclient e python-novaclient
...
:::info
Puoi consultare anche la documentazione del client Openstack direttamente [sul sito OpenStack](https://docs.openstack.org/python-openstackclient/latest/).
:::
