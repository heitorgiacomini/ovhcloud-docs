...
description: "Come attivare una licenza Windows su un'istanza in modalità privata"
...
- Disporre di un [progetto Public Cloud OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Aver creato un utente OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)

Per familiarizzare con Horizon, consulta la guida [Accedere all'interfaccia Horizon](/guides/public-cloud/cross-functional/introducing-horizon).
...
Accedi all'interfaccia [Horizon](https://horizon.cloud.ovh.net/auth/login/) utilizzando il metodo indicato nella [prima parte di questa guida](/guides/public-cloud/network-services/vrack#interfaccia-horizon).
...
Clicca su <code className="action">Compute</code> e poi su <code className="action">Instances</code>:

<img className="thumbnail" alt="host e istanza" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon2.png" loading="lazy" />

Per aggiungere un'interfaccia, nella colonna "Actions",  clicca sulla freccia che permette di accedere alle azioni sull'istanza. Clicca su <code className="action">Attach Interface</code>:
...
<img className="thumbnail" alt="interfaccia select" src="/images/public-cloud/compute/activate-windows-license-private-mode/attachinterfacehorizon.png" loading="lazy" />
...
Una volta connesso alla tua istanza Windows, clicca sul menu <code className="action">Avviare</code> e poi sull'icona del <code className="action">Windows PowerShell</code>.
...
<img className="thumbnail" alt="attivazione chiave windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="attivazione chiave windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />

## Per saperne di più

[Scoprite come correggere la Product Key di Windows Server](/guides/bare-metal-cloud/dedicated-servers/windows-key).
