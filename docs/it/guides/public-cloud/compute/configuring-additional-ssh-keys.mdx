...
- [Accesso amministrativo all’istanza via SSH](/guides/public-cloud/compute/creating-ssh-keys#login-linux)
...
Se necessario, utilizza la nostra [guida sulle chiavi SSH](/guides/public-cloud/compute/creating-ssh-keys) per creare una nuova coppia di chiavi SSH.  
Se necessario, è possibile trovare informazioni su [gestione di più chiavi](/guides/public-cloud/compute/creating-ssh-keys#multiplekeys) anche sulla workstation locale.

### Step 2: configura un nuovo account utente

[Accedi alla tua istanza](/guides/public-cloud/compute/getting-started#connect-instance) e utilizza i seguenti comandi per creare un nuovo account utente e una cartella `.ssh`:
...
[Accedi alla tua istanza](/guides/public-cloud/compute/getting-started#connect-instance) e apri il file `authorized_keys` nella cartella personale del nuovo utente con il tuo editor di testo preferito (`nano` in questo esempio):
...
Per saperne di più sull'utilizzo delle chiavi SSH con le istanze Public Cloud, consulta la [guida sulle chiavi SSH](/guides/public-cloud/compute/creating-ssh-keys).

## Per saperne di più

[Creare istanze Public Cloud](/guides/public-cloud/compute/getting-started)
