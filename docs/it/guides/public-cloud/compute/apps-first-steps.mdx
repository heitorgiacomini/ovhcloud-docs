...
description: Scopri come creare applicazioni preinstallate sulle tue istanze Public Cloud
...
- Un'[istanza Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) nel tuo account OVHcloud.
...
Utilizzando lo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink> / API o l'API di OpenStack Horizon, installa l'applicazione scelta sulla tua istanza Public Cloud.
...
1. Accedi alla [console API](https://eu.api.ovh.com/)
...
Se il tuo dominio è registrato in OVHcloud, consulta [questa guida](/guides/web-cloud/domains/dns-zone-edit).
...
<summary>Puoi utilizzare i tuoi server DNS?</summary>


Si', puoi. Assicurati di creare record GLUE con il tuo Registrar Ad esempio, se vuoi "ns1.mydomain.com" e "ns2.mydomain.com", devi configurare i record "GLUE" perché entrambi puntino sull'indirizzo IP del tuo server. Se il tuo dominio è registrato con OVHcloud, segui [questa guida](/guides/web-cloud/domains/glue-registry#step-1-aggiungi-i-record-glue). Ti ricordiamo che la creazione potrebbe richiedere 24 ore.
...
<summary>Perché impostare la password di root?</summary>
...
<summary>Dov'è la mia licenza per cPanel?</summary>
...
<summary>Dov'è la mia licenza Plesk?</summary>
