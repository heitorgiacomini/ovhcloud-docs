...
- [Aver creato un’istanza dallo Spazio Cliente OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Avere accesso amministratore](/guides/public-cloud/compute/getting-started#connect-instance)
