...
description: "Scopri come ridimensionare il file system di un'istanza Public Cloud o di un VPS con FreeBSD 12"
 ...
 * Aver installato di recente l'istanza/il VPS o [averne ridimensionato il volume](/guides/public-cloud/compute/resize-of-an-instance)
