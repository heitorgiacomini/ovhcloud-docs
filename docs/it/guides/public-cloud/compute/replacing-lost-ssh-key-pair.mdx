...
description: "Scopri come ripristinare l'accesso al server sostituendo una coppia di chiavi SSH con una nuova in caso di perdita della chiave privata"
...
- Un’ [istanza Public Cloud](https://www.ovhcloud.com/it/public-cloud/compute/) nel tuo account OVHcloud
...
Crea una nuova coppia di chiavi SSH sul tuo dispositivo locale, seguendo le istruzioni contenute nella prima parte della [guida alla creazione di una chiave SSH](/guides/public-cloud/compute/creating-ssh-keys).

### Step 2: accedi all’istanza in modalità Rescue

Segui gli step della [guida del Rescue mode](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) per riavviare l’istanza in Rescue mode, connetterti e montare le tue partizioni.
...
Riavvia l’istanza in modalità "normale" dallo <ManagerLink to="/">Spazio Cliente OVHcloud</ManagerLink>. Se necessario, consulta le istruzioni nella [guida sulla modalità rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
