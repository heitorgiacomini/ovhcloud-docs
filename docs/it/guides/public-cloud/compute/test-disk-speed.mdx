...
description: Esegui un test della velocità dei tuoi dischi
...
- Disporre di una [istanza Public Cloud](https://www.ovhcloud.com/it/public-cloud/compute/)
...
Per testare la velocità di un disco aggiuntivo, è necessario montarlo. Per maggiori informazioni, consulta questa [guida](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance#con-windows)
