...
description: Scopri come modificare le risorse dell’istanza per adattarle a un aumento dell’attività
...
- Un [utente OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- Disporre di un [ambiente OpenStack predisposto per la CLI](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
- Aver definito le [variabili d’ambiente OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
...
[Ridimensionare un’istanza Public Cloud dallo Spazio Cliente OVHcloud](/guides/public-cloud/compute/resize-instance-manager)
