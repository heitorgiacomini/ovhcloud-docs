...
description: Learn how to deploy Kubernetes operator written in Golang on OVHcloud Managed Kubernetes and the Operator SDK
...
![Operator diagram](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-go-operator/operator.png)
...
![Hello world from Nginx](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-go-operator/hello-world.png)
...
In order to create a private registry, you can follow the [how to create an OVHcloud private registry](/guides/public-cloud/containers-orchestration/managed-private-registry/creation) tutorial.
