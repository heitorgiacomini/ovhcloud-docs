...
description: Find out how to install Jenkins on OVHcloud Managed Kubernetes
...
<img className="thumbnail" alt="Jenkins login" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-jenkins/installing-jenkins-01.png" loading="lazy" />
