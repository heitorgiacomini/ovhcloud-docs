...
description: Adapt your Inotify parameters for your deployments which need specific Inotify parameters
...
- Your Kubeconfig is exported into your terminal following this guide : [Configuring Kubectl](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-kubectl)
