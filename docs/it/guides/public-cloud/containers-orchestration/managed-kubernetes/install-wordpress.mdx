...
description: Find out how to install WordPress on OVHcloud Managed Kubernetes
lastUpdated: 2021-12-17
---

In this tutorial, we will guide you through the installation of [WordPress](https://wordpress.org/) on your OVHcloud Managed Kubernetes Service.
...
<img className="thumbnail" alt="Installing WordPress" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-wordpress/installing-wordpress-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Installing WordPress" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-wordpress/installing-wordpress-02.png" loading="lazy" />

<img className="thumbnail" alt="Installing WordPress" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-wordpress/installing-wordpress-03.png" loading="lazy" />
