...
description: Torne as ligacoes para o seu website seguras
...
:::info
- Ter encomendado um serviço [SSL Gateway](/guides/web-cloud/ssl-gateway/order).
...
- Ligue-se ao seu <ManagerLink to="/">Espaço Cliente</ManagerLink>.
- Clique de seguida na secção <code className="action">Sunrise</code>.

<img className="thumbnail" alt="bouton sunrise" src="/images/web-cloud/ssl-gateway/use-ssl-gateway/4.PNG" loading="lazy" />

- Clique de seguida em <code className="action">SSL Gateway</code> para poder consultar o serviço.
...
- Clique em <code className="action">+ Domínio</code> para poder adicionar um domínio ou subdomínio.
...
Faça a sua escolha e depois clique de seguida em <code className="action">Adicionar</code> para validar a sua escolha.
...
- Clique em <code className="action">+ Servidor</code> para poder adicionar um endereço IP e uma porta correspondente ao servidor que aloja o seu website.
...
Faça a sua escolha e depois clique de seguida em <code className="action">Adicionar</code> para a validar.
