...
Se precisar de alterar as permissões de um utilizador existente, consulte o nosso guia "[Web Cloud Databases - Alterar as permissões de um utilizador](/guides/web-cloud/databases/db-modify-users-rights)".
...
Para importar uma base de dados, consulte o nosso guia "[Restaurar e importar uma base de dados no servidor de bases de dados](/guides/web-cloud/databases/db-restore-import-database)".
...
Para isso, consulte os casos particulares do nosso guia "[Web Cloud Databases - Como autorizar um endereço IP?](/guides/web-cloud/databases/db-authorise-ip-mask)" para ativar ou desativar o acesso dos alojamentos web da OVHcloud ao Web Cloud Databases.
...
Para aceder aos logs da solução Web Cloud Databases, consulte o nosso guia "[Web Cloud Databases - Como obter os logs?](/guides/web-cloud/databases/db-retrieve-logs)".

## Quer saber mais?

[Criar bases de dados e utilizadores no servidor de bases de dados](/guides/web-cloud/databases/db-create-databases-users)

[Conectar-se à base de dados do servidor de bases de dados](/guides/web-cloud/databases/db-connecting-database-server)

[Guardar e exportar uma base de dados no servidor de bases de dados](/guides/web-cloud/databases/db-backup-export-database-server)
