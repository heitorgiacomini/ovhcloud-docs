...
- Os serviços Web Cloud Databases Web Hosting (também conhecidos como serviços SQLP Privado), instâncias SGBD dedicadas acessíveis através da rede Web Hosting ([ver os anúncios](/guides/web-cloud/databases/db-eos-eol)).
- Os serviços SharedSQL Web Hosting, bases de dados MySQL disponíveis através da rede Web Hosting ([ver os anúncios](/guides/web-cloud/web-hosting/sql-eos-eol)).
