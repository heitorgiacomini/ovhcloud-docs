...
Para aceder aos logs da sua solução Web Cloud Databases, consulte o nosso guia "[Web Cloud Databases - Como recuperar os logs](/guides/web-cloud/databases/db-retrieve-logs)".
