...
Para exportar a sua base de dados diretamente a partir do phpMyAdmin, é necessário conectar-se primeiro. Para tal, consulte o guia "[Conexão a uma base de dados](/guides/web-cloud/databases/db-connecting-database-server)".
