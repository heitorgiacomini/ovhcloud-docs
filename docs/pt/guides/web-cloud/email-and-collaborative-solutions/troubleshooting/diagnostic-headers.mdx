...
description: Saiba como obter o cabeçalho de um e-mail ou extrair um ficheiro .eml a partir do seu cliente de e-mail, webmail ou aplicação externa
...
- O campo `Received-SPF` apresenta o resultado do controlo [SPF](/guides/web-cloud/domains/dns-zone-spf) efetuado sobre o nome de domínio do remetente. O argumento `client-ip` permite obter o endereço IP do servidor que enviou o e-mail.
<pre class="bgwhite"><code>
...
<img className="thumbnail" alt="Outlook Windows - identificar a versão" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/outlook-windows-identify01.png" loading="lazy" />

**Outlook clássico:**

1. Faça duplo clique no e-mail para o abrir numa janela separada.
2. Na nova janela, clique em <code className="action">Ficheiro</code> no canto superior esquerdo.
3. Selecione <code className="action">Informações</code> à esquerda e clique em <code className="action">Propriedades</code>.
4. O cabeçalho completo do e-mail aparece no quadro inferior. Selecione o texto na íntegra e copie-o para um ficheiro.

<img className="thumbnail" alt="Cabeçalho completo no Outlook" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/classic-outlook-01.png" loading="lazy" />

**Novo Outlook:**

1. Abra o e-mail que pretende.
2. Faça **clique com o botão direito** no e-mail.
3. Selecione <code className="action">Ver</code> e depois <code className="action">Ver detalhes da mensagem</code>.
...
<img className="thumbnail" alt="Cabeçalho completo no Outlook" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/new-outlook-01.png" loading="lazy" />
...
2. Clique em <code className="action">Ficheiro</code> na barra de menus.
3. Clique em <code className="action">Guardar como</code>.
4. No menu pendente "Guardar com o tipo", selecione **Formato de Mensagem do Outlook - Unicode (.msg)**. Escolha uma localização no seu computador (por exemplo, o Ambiente de Trabalho) e clique em <code className="action">Guardar</code>.
...
<img className="thumbnail" alt="Guardar msg no Outlook" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/classic-outlook-02.png" loading="lazy" />

**Novo Outlook:**

1. Na lista de mensagens, faça **clique com o botão direito** no e-mail.
2. Selecione <code className="action">Guardar como</code> e depois <code className="action">Guardar como ficheiro EML</code>.
3. Escolha uma localização no seu computador e clique em <code className="action">Guardar</code>.

<img className="thumbnail" alt="Guardar um ficheiro EML no Novo Outlook" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/new-outlook-02.png" loading="lazy" />
...
<img className="thumbnail" alt="Cabeçalho completo no Thunderbird" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/thunderbird-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Cabeçalho completo no Mail do macOS" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/mailmacos-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Guardar um eml a partir do Mail do macOS" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/mailmacos-02.png" loading="lazy" />
...
1. Selecione o e-mail que pretende.
2. Clique no botão <code className="action">... Mais</code> e depois em <code className="action">&lt; > Ver código-fonte</code>.
3. Abre-se uma nova janela com o cabeçalho completo do e-mail. Selecione o texto na íntegra e copie-o para um ficheiro.

<img className="thumbnail" alt="Ver código-fonte no Roundcube" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/roundcube01.png" loading="lazy" />

##### **Obter o ficheiro .eml**

1. Selecione o e-mail que pretende.
2. Clique no botão <code className="action">... Mais</code> e depois em <code className="action">Transferir (.eml)</code>.

<img className="thumbnail" alt="Transferir ficheiro eml no Roundcube" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/roundcube02.png" loading="lazy" />
...
2. Clique **na seta** à direita de <code className="action">Responder a todos</code> e depois em <code className="action">Ver detalhes da mensagem</code>.
3. Abre-se uma nova janela com o cabeçalho completo do e-mail, o que lhe permite transferi-lo.

<img className="thumbnail" alt="Detalhes da mensagem no OWA" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa01.png" loading="lazy" />
...
1. Clique em <code className="action">(+) Novo</code> para criar um novo e-mail.
2. Selecione o e-mail que deseja extrair e arraste-o para o conteúdo da nova mensagem.
3. Clique na seta para baixo junto ao anexo gerado e depois em <code className="action">Transferir</code> para guardar o ficheiro no seu computador.

<video className="thumbnail" autoPlay loop muted playsInline aria-label="Extrair um ficheiro eml a partir do OWA" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa02.mp4" />
...
1. Selecione o e-mail que pretende.
2. Clique em <code className="action">Mais</code> na barra de ações e selecione <code className="action">Mostrar original</code>.
3. Abre-se uma nova janela com o cabeçalho completo e o conteúdo bruto do e-mail.

<img className="thumbnail" alt="Detalhes da mensagem no Zimbra" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/zimbra-01.png" loading="lazy" />
...
2. Clique nos 3 pontos verticais à direita e em <code className="action">Mostrar mensagem original</code>.
3. Abre-se uma nova janela com o cabeçalho completo do e-mail.

<img className="thumbnail" alt="Mostrar a origem da mensagem no Gmail" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/gmail01.png" loading="lazy" />

##### **Obter o ficheiro .eml**

1. Selecione o e-mail em causa.
2. Clique nos 3 pontos verticais à direita e selecione <code className="action">Transferir mensagem</code>.
