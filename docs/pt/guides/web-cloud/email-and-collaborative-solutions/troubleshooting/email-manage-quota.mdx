...
- **Link direto:** <ManagerLink to="/#/web/web/email_domain">MX Plan</ManagerLink>
...
- **Link direto:** <ManagerLink to="/#/web/email_pro">E-mail Pro</ManagerLink>
...
- **Link direto:** <ManagerLink to="/#/web/exchange">Exchange</ManagerLink>
...
Na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, aceda à secção <code className="action">Web Cloud</code> e siga as instruções indicadas na oferta:
...
<ZoneTabs>
  <Tab label="MX Plan">
    A capacidade de uma conta MX Plan pode variar entre 2,5 MB e 5 GB. Se estiver saturado e a sua capacidade for inferior a 5GB, pode alterar a sua capacidade através da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.<br/>
...
<Region zones={['ca']}>
- o protocolo IMAP sobre a oferta **MXplan**;
- o protocolo MAPI sobre a oferta **Exchange** para o Outlook Windows;
- o protocolo EWS sobre a oferta **Exchange** para o Outlook macOS.
</Region>
...
Configuração de uma conta MX plan em **macOS**:<br/><br/>
  ...
  <Tab label="E-mail Pro" availableIn={['eu']}>
    ...
    - [Endereço do Windows 10](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration) (English) (incluído com Windows)<br/>
...
Configuração de uma conta E-mail Pro em **macOS**:<br/><br/>
    - [Mail](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration) (incluído com macOS)<br/>
  ...
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/thunderbird-windows-configuration) (gratuito)<br/><br/>
