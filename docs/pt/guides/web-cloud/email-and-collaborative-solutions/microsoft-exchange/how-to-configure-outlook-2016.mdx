...
Recomendamos que verifique a configuração do nome de domínio configurado no seu serviço Exchange no seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, separador <code className="action">Domínios associados</code>, depois coluna <code className="action">Diagnóstico</code> da tabela.
