...
description: Descubra como configurar o seu servidor Private Exchange.
...
- Ter encomendado uma [solução Private Exchange OVHcloud](https://www.ovhcloud.com/pt/emails/private-exchange/).
...
### Etapa 1: receção do e-mail de configuração da sua plataforma
...
Para consultar este e-mail a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, clique no seu perfil, no topo da página à direita, e depois em <code className="action">E-mails de serviço</code> e pesquise o e-mail com o assunto:

> **\[xx-11111-ovh] O seu serviço Private Exchange 20\_xxx\_ será entregue em breve!**
...
Após ter clicado no link de e-mail na [etapa 1](#etapa-1-rececao-do-e-mail-de-configuracao-da-sua-plataforma), deve identificar-se na página exibida.
...
Preencha os campos de acordo com as seguintes indicações:

- **Nome do seu servidor**: no menu pendente, escolha o subdomínio associado ao seu nome de domínio. No campo livre, introduza o nome de domínio que deseja associar.
...
Cole o código na caixa correspondente da janela exibida e clique em <code className="action">Next</code>.
...
Surgirá uma mensagem a informar se o código inserido é válido. Se for o caso, clique em <code className="action">Close window</code>.

### Etapa 5: finalização da entrega
...
> **\[xx-11111-ovh] O seu serviço Private Exchange 20\_xxx\_ está pronto!**

Para adicionar o primeiro nome de domínio à sua plataforma e configurar as contas, consulte o nosso guia ["Adicionar um domínio ao serviço Exchange"](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain)

## Quer saber mais? <a name="go-further"></a>

[Editar uma zona DNS](/guides/web-cloud/domains/dns-zone-edit)

[Adicionar um nome de domínio ao serviço Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain)
