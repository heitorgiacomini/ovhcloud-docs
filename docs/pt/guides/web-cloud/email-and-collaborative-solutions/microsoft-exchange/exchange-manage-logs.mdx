...
:::info
Para mais detalhes sobre Logs Data Platform, consulte o nosso guia de introdução a [Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/introduction).
...
<Tabs>
  ...
  <Tab label="Caso n.º 2">
    **Subscrever a um novo fluxo de dados na sua solução Logs Data Platform**
    ...
    Consulte os nossos guias [Introduction to Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/introduction) e [Quick start for Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start) para realizar esta ação.
