...
Para isso, clique no serviço Hosted Exchange em causa na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e, a seguir, no separador <code className="action">Contas de e-mail</code>. A tabela apresenta as contas que estão configuradas ou prestes a serem configuradas no seu serviço.
...
A OVHcloud oferece, a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, licenças Outlook como opção com a sua conta de e-mail Exchange.
...
Agora que o seu serviço Hosted Exchange está configurado e funcional, pode implementar as funcionalidades colaborativas inerentes ao serviço na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Estas funções permitem-lhe criar recursos (salas de reunião, equipas, etc.) e grupos, entre outros.

Para ativar estas diferentes funções, selecione o serviço Hosted Exchange na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e escolha entre os separadores que aparecem a ação a efetuar.
...
[Delegar permissões numa conta de e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation)
