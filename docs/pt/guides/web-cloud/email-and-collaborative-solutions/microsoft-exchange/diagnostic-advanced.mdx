...
Para reativar a subscrição, basta reconfigurar a [periodicidade de faturação](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/manage-billing-exchange#periodicity) na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.

### A conta está bloqueada pela política de segurança

Se uma política de segurança estiver ativa na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, a conta pode ser temporariamente bloqueada.
...
Se necessário, pode alterar a palavra-passe da conta em causa no separador <code className="action">Contas de e-mail</code> na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Se o problema persistir, crie um pedido de assistência.
