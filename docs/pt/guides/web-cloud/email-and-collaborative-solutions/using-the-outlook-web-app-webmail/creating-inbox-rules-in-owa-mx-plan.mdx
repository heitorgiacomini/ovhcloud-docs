...
<Region zones={['ca']}>
- uma solução de e-mail OVHcloud já configurada (**MX Plan**, disponível como parte dos nossos [planos Web Hosting](https://www.ovhcloud.com/pt/web-hosting/) ou encomendada separadamente como solução autónoma; [**Hosted Exchange**](https://www.ovhcloud.com/pt/emails/hosted-exchange/))
- credenciais de login para o endereço de e-mail que deseja configurar
</Region>

<Region zones={['apac']}>
- uma solução de e-mail OVHcloud já configurada (**MX Plan**, disponível como parte dos nossos [planos Web Hosting](https://www.ovhcloud.com/pt/web-hosting/) ou encomendada separadamente como solução autónoma)
- credenciais de login para o endereço de e-mail que deseja configurar
</Region>
