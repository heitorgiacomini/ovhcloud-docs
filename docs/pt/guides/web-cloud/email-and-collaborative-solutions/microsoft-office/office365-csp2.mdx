...
description: Saiba como subscrever e administrar um serviço Office 365 Revendedores (CSP2) na OVHcloud
...
- **Ligação direta:** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Clique em <code className="action">Encomendar</code> para finalizar.
...
O ícone <i className="icons-pen"></i>  permite modificar o número total de licenças da assinatura. O ícone <i className="icons-bin"></i>  permite cancelar a assinatura e todas as licenças.
