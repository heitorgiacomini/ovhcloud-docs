...
<Region zones={['ca']}>
Deseja migrar os seus endereços de e-mail presentes numa plataforma Exchange para outra plataforma Exchange ou MX Plan. Neste guia, poderá encontrar um processo de migração em duas fases:
</Region>

1. **Configurar a plataforma de destino**.
2. **Migrar as contas de e-mail** da sua plataforma atual para a nova.

<video className="thumbnail" autoPlay loop muted playsInline aria-label="email-migração" src="/images/web-cloud/email-and-collaborative-solutions/migrating/migration-platform/migration_platform01.mp4" />
...
<Region zones={['ca']}>
Para migrar uma solução MX Plan para uma plataforma Exchange, sugerimos que siga o nosso guia [Migrar um endereço de e-mail MX Plan para uma conta Exchange](/guides/web-cloud/email-and-collaborative-solutions/migrating/migration-control-panel).
</Region>
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="email-migração" src="/images/web-cloud/email-and-collaborative-solutions/migrating/migration-platform/migration_platform03.mp4" />
...
- [Delegação de direitos](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation) 
