---
title: E-mail Pro - Configure sua conta de e-mail no Outlook para macOS
description: Saiba como configurar uma conta E-mail Pro no Outlook para Mac
...
Clique <ManagerLink to="/#/web/email_pro">neste link</ManagerLink> para aceder à secção <code className="action">E-mail Pro</code>. O nome do servidor está visível na tabela **Ligação** do separador <code className="action">Informações gerais</code>.
...
A OVHcloud também disponibiliza uma aplicação web que tem [funcionalidades de colaboração](https://www.ovhcloud.com/pt/emails/) e está disponível no endereço [Webmail](https://www.ovhcloud.com/pt/mail/). Para aceder, só precisa dos dados de acesso do seu endereço de e-mail.
