...
Clique <ManagerLink to="/#/web/email_pro">neste link</ManagerLink> para aceder à secção <code className="action">E-mail Pro</code>. O nome do servidor é apresentado na zona **Ligação** do separador <code className="action">Informações gerais</code>.
