...
Para configurar o seu endereço de e-mail Pro no Outlook clássico, consulte o nosso guia "[E-mail Pro - Configurar uma conta de e-mail no Outlook clássico para Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration)".
...
Clique <ManagerLink to="/#/web/email_pro">neste link</ManagerLink> para aceder à secção <code className="action">E-mail Pro</code>.
