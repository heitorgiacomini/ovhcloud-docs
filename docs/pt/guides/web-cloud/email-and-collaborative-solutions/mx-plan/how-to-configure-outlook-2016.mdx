...
<Tabs>
  ...
  <Tab label="Passo 5">
    ...
    <Region zones={['eu']}>
    - **Servidor**: imap.mail.ovh.net **ou** ssl0.ovh.net
    - Porta: **993**
...
<Region zones={['eu']}>
- **Tipo de conta**: selecione IMAP
- **Servidor de correio entrante**: imap.mail.ovh.net **ou** ssl0.ovh.net
- **Servidor de correio saínte (SMTP)**: smtp.mail.ovh.net **ou** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Tipo de conta**: selecione IMAP
- **Servidor de correio entrante**: imap.mail.ovh.ca
- **Servidor de correio saínte (SMTP)**: smtp.mail.ovh.ca
</Region>
...
A janela está dividida em duas partes, **Correio de entrada** e **Correio de saída**. Clique na parte que deseja modificar.
    ...
    Encontre este número no seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, na rubrica <code className="action">Web Cloud</code> depois <code className="action">E-mail Pro</code>. O nome do servidor é visível no quadro **Ligação** do separador <code className="action">Informações gerais</code>.
...
<Tabs>
  <Tab label="Configuração IMAP">
    <Region zones={['eu']}>
    - **Servidor (entrante)**: imap.mail.ovh.net **ou** ssl0.ovh.net.
  ...
  <Tab label="Configuração POP">
    <Region zones={['eu']}>
    - **Servidor (entrante)**: pop.mail.ovh.net **ou** ssl0.ovh.net.
    - **Nome de utilizador**: introduza o endereço de e-mail **completo**.
    - **Palavra-passe**: introduza a palavra-passe do endereço de e-mail.
    - **Porto**: 995.
    - **Tipo de segurança**: SSL/TLS.
...
<Region zones={['eu']}>
- **Servidor (saínte)**: smtp.mail.ovh.net **ou** ssl0.ovh.net.
- **Nome de utilizador**: introduza o endereço de e-mail **completo**.
- **Palavra-passe**: introduza a palavra-passe do endereço de e-mail.
- **Porto**: 465.
- **Tipo de segurança**: SSL/TLS.
...
<Region zones={['ca', 'apac']}>
- **Servidor (saínte)**: smtp.mail.ovh.ca.
- **Nome de utilizador**: introduza o endereço de e-mail **completo**.
- **Palavra-passe**: introduza a palavra-passe do endereço de e-mail.
- **Porto**: 465.
- **Tipo de segurança**: SSL/TLS.
