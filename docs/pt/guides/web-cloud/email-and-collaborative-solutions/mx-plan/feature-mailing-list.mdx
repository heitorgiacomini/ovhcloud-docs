...
description: Neste guia, fique a saber como usar as mailing lists
...
Vá ao separador <code className="action">mailing lists</code> do seu serviço de e-mail.
...
Para criar uma nova mailing list, clique em <code className="action">Adicionar uma mailing list</code>.
...
Para alterar as opções da mailing list, clique em <code className="action">...</code> do lado direito. Pode então atualizar as opções, eliminar a mailing list ou partilhar a lista dos subscritores por e-mail.
...
|---|---|
|Clique em <code className="action">Adicionar subscritores</code> do lado direito.|Clique em <code className="action">Eliminar através de um ficheiro</code> do lado direito.|
...
- a introdução manual de endereços, clicando em <code className="action">Adicionar um endereço de e-mail</code>;
...
Clique em <code className="action">Exportar os subscritores para CSV</code> para criar um ficheiro CSV com todos os seus subscritores. Esta opção não está disponível no nosso caso porque nenhum subscritor foi adicionado.
...
|---|---|
|Clique em <code className="action">Adicionar moderadores</code> do lado direito.|Clique em <code className="action">Eliminar através de um ficheiro</code> do lado direito.|
