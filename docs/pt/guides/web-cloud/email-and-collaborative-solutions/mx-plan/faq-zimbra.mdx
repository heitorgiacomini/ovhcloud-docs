...
Consulte a nossa página « [Configurar o seu endereço de e-mail Zimbra num programa de correio eletrónico](/guides/web-cloud/email-and-collaborative-solutions/zimbra/mail-apps) ».
...
1. Inicie sessão na sua <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>.
