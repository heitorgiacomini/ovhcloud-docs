...
- You must be logged in to <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, in the `Telecom` section, then `SMS`.
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, and go to the `Telecom` section. Next, select `SMS`.

Click on the SMS account concerned, and select the `Contacts` tab, then `Address book`.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook01.png)

Click `Add an address book`, and give it a name.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook2.png)
...
Select the `Actions` button, and click `Add`.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook3.png)

You will access a window that enables you to enter the contact details.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook4.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook-spreadsheet1.png)
...
![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook-spreadsheet2.png)
...
Go back to the OVHcloud Control Panel, select the `Actions` button, and click `Import`.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook5.png)

A pop-up window will appear. Next, click `Contact file` to select your .csv file, then confirm.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook6.png)
...
To delete an address book, click `Delete address book` after you have selected it in the dropdown menu (1).

To edit or delete a contact, click `...` in the Actions column (4) across from the contact concerned. You will then see a menu offering you these choices.

![phonebook](/images/guides/web-cloud/messaging/sms/sms-address-books/smsphonebook7.png)
