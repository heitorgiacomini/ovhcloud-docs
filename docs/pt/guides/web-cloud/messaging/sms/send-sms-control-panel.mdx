...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then select `Telecom`. Next, click `SMS` and your SMS account.

The "Send an SMS" field is the first item available in the list of actions.

![send sms control panel](/images/guides/web-cloud/messaging/sms/send-sms-control-panel/sms-send-control-panel01E.png)
...
![send sms control panel](/images/guides/web-cloud/messaging/sms/send-sms-control-panel/sms-send-control-panel02E.png)
...
![send sms control panel](/images/guides/web-cloud/messaging/sms/send-sms-control-panel/sms-send-control-panel03E.png)
...
![List of authorised SMS characters](/images/guides/web-cloud/messaging/sms/send-sms-control-panel/smsauthorizedcharacters.png)

#### Advanced options

![send sms control panel](/images/guides/web-cloud/messaging/sms/send-sms-control-panel/sms-send-control-panel-advanced.png)
