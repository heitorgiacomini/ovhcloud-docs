...
Refer to our guide on [Managing SMS address books](/guides/web-cloud/messaging/sms/sms-address-books) to find out more.
...
To do this, you can refer to the [section on choosing an SMS sender, in our guide on sending SMS messages via the OVHcloud Control Panel.](/guides/web-cloud/messaging/sms/send-sms-control-panel#step-3-choose-an-sms-sender)
...
To send a unit SMS message via the OVHcloud Control Panel, you can refer to [this guide](/guides/web-cloud/messaging/sms/send-sms-control-panel).
...
See [our guide on managing your SMS history](/guides/web-cloud/messaging/sms/sms-history).
