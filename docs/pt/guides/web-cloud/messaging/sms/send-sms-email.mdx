...
To optimise the inclusion of certain special characters, enable "plain text mode" in your email client, as per the screenshot below in Microsoft Outlook:
 ...
 ![email2sms](/images/guides/web-cloud/messaging/sms/send-sms-email/plaintext01.png)
:::
...
![email2sms](/images/guides/web-cloud/messaging/sms/send-sms-email/send-sms-through-email1.png)
...
![email2sms](/images/guides/web-cloud/messaging/sms/send-sms-email/send-sms-through-email3.png)
...
![email2sms](/images/guides/web-cloud/messaging/sms/send-sms-email/send-sms-through-email4.png)

If any sending errors occur, they will be listed in the report, as per the example below:

![email2sms](/images/guides/web-cloud/messaging/sms/send-sms-email/send-sms-through-email5.png)
...
![List of authorised SMS characters](/images/guides/web-cloud/messaging/sms/send-sms-email/smsauthorizedcharacters.png)
