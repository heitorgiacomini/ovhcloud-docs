...
[Sending SMS messages via the OVHcloud Control Panel](/guides/web-cloud/messaging/sms/send-sms-control-panel#step-2-compose-your-sms-message)
:::
...
To enable automatic re-crediting, log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then go to the `Telecom` tab. Next, click on the `SMS` section in the services bar. Choose the SMS account you would like to enable automatic re-credit for.

Go to the `Options` menu (1), then `Automatic re-credit` (2).

![credit sms](/images/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms/smscredit01.png)

Then click `Edit` in the "Manage options" section.

![credit sms](/images/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms/smscredit02.png)
...
- Click `Confirm` to apply the settings.

![credit sms](/images/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms/smscredit03.png)
...
In your OVHcloud Control Panel, choose one of your SMS accounts and click `Transfer Credits` from the `Home` tab.

![sms credits transfer](/images/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms/credit-transfer01.png)
...
Click `Send` to execute the transfer. This one is immediate.

![sms credits transfer](/images/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms/credit-transfer02.png)
