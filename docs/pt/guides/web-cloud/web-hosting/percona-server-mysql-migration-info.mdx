...
description: Descubra as vantagens da migração de MySQL para Percona Server para MySQL
...
- Ter um plano de [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/) com uma base de dados partilhada OVHcloud (MySQL) associada.
