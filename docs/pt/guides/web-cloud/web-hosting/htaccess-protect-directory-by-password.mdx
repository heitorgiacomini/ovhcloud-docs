...
description: Descruba como proteger um diretório ou o acesso à administração do seu website através de uma autenticação com os ficheiros .htaccess e .htpasswd
...
Isto utilizando dois ficheiros de configuração (HTTP) Apache que pretende colocar no [espaço FTP](/guides/web-cloud/web-hosting/ftp-connection) do seu alojamento Web: 
...
- Dispor de credenciais de acesso ao [espaço FTP do seu alojamento](/guides/web-cloud/web-hosting/ftp-connection).
...
Se utilizar um CMS Wordpress, a OVHcloud também disponibiliza um tutorial sobre como [utilizar o ficheiro htaccess com WordPress](/guides/web-cloud/web-hosting/htaccess-how-to-protect-wordpress).
...
Para isso, contacte a nossa [comunidade de utilizadores](https://community.ovhcloud.com/community/en) ou os nossos [parceiros OVHcloud](https://partner.ovhcloud.com/pt/directory/).
:::
...
Para alterar a versão de PHP dos seus websites no seu alojamento web, consulte consulte o guia "[Alojamento web : ambiente, versão PHP, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting)".
...
Ligue-se ao [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection) do seu alojamento web. Abra a ["pasta raiz"](/guides/web-cloud/web-hosting/multisites-configure-multisite) para a qual aponta o seu domínio.
...
Volte para a pasta raiz onde criou o ficheiro "crypt.php". Clique em <code className="action">Editer</code> e coloque as seguintes linhas:
...
Se dispõe de um alojamento **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max**, aceda em [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting) ao seu alojamento web. Desça à "**pasta raiz**" onde está o script "crypt.php".
...
:::warning
Por razões de segurança, recomenda-se a utilização de SSH. No entanto, se dispõe de uma oferta **Starter**, **Perso** ou **Startup** em que o SSH está indisponível, também pode executar o ficheiro "crypt.php" através do seu browser.
...
- `your_ftp_login`: o login FTP que utiliza para se ligar ao seu espaço de armazenamento FTP. Para obter o seu login FTP, consulte o nosso guia sobre a [ligação ao seu espaço FTP](/guides/web-cloud/web-hosting/ftp-connection).
...
[Aceder ao espaço FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-connection)

[Tutorial - Operações realizáveis com um ficheiro ".htaccess"](/guides/web-cloud/web-hosting/htaccess-what-else-can-you-do)

[Bloquear o acesso ao meu website para determinados endereços IP através de um ficheiro .htaccess](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website)

[Reescrever o URL de acesso ao meu website graças ao mod_rewrite através do ficheiro .htaccess](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)
