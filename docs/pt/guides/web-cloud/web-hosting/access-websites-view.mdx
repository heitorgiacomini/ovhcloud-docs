...
Aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e aceda à secção <code className="action">Web Cloud</code>. No menu à esquerda, clique em <code className="action">Websites</code>. Aparecerá uma tabela com o conjunto dos seus websites e as suas principais informações.
