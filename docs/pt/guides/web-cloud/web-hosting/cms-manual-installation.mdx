...
Para obter o endereço IP da sua oferta de alojamento web, aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> na parte <code className="action">Web Cloud</code> e selecione a sua oferta de alojamento web na secção <code className="action">Alojamentos</code>.<br/>
...
Se a zona DNS ativa do seu domínio for gerida no seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, compare o endereço IP do seu alojamento com o endereço IP presente na zona DNS do seu domínio, através da nossa documentação sobre as [zonas DNS da OVHcloud](/guides/web-cloud/domains/dns-zone-edit).
...
A maioria dos CMS precisam de uma base de dados para funcionar. As nossas ofertas de [alojamento web](https://www.ovhcloud.com/pt/web-hosting/) incluem-no, com exceção de [alojamento gratuito](https://www.ovhcloud.com/pt/domains/free-web-hosting/).

</Region>

<Region zones={['ca','apac']}>

A maioria dos CMS precisam de uma base de dados para funcionar. As nossas ofertas de [alojamento web](https://www.ovhcloud.com/pt/web-hosting/) incluem-no.
...
Se tiver à sua disposição uma oferta Web Cloud Databases em MySQL ou MariaDB e pretender utilizá-la para instalar manualmente o seu CMS, consulte o nosso manual sobre a [criação de uma base de dados num serviço Web Cloud Databases](/guides/web-cloud/databases/db-create-databases-users#criar-uma-base-de-dados).
...
- Para aceder a uma base de dados presente numa Web Cloud Databases, consulte [este guia](/guides/web-cloud/databases/db-connecting-database-server).
