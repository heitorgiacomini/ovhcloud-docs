...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Clique no botão <code className="action">...</code> à direita da base de dados a salvaguardar e, a seguir, em <code className="action">Criar uma cópia de segurança</code>.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Clique no botão <code className="action">...</code> à direita da base de dados em causa e depois em <code className="action">Restaurar um backup</code>.
  ...
  <Tab label="Etapa 4">
    Para descarregar um backup, clique no botão <code className="action">...</code> à direita daquele que deseja recuperar e, a seguir, em <code className="action">Transferir backup</code>. Aceite e espere enquanto o backup é descarregado.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Clique no botão <code className="action">...</code> à direita da base de dados em causa e depois em <code className="action">Aceder ao phpMyAdmin</code>.
...
#### 2 - Descarregar o script no espaço de armazenamento FTP
...
#### 4 - Recuperar o backup a partir do espaço de armazenamento FTP
...
[Tutorial - O que fazer quando a minha base de dados estiver cheia?](/guides/web-cloud/web-hosting/sql-overquota-database)
