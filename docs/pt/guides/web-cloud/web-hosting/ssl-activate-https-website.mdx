...
description: Saiba como passar o seu website em HTTPS após ter ativado um certificado SSL
...
- Dispor de um [certificado SSL](https://www.ovhcloud.com/pt/web-hosting/options/ssl/) instalado no seu [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/).
...
Para ativar um certificado SSL no alojamento web ou verificar se já está instalado um certificado SSL no site, consulte o guia: "[Gerir um certificado SSL no alojamento web](/guides/web-cloud/web-hosting/ssl-on-webhosting)".
...
Assim que o seu nome de domínio tiver um [certificado SSL ativo através do seu alojamento web](/guides/web-cloud/web-hosting/ssl-on-webhosting) e o seu site estiver pronto para passar para *HTTPS*, pode ativá-lo.

:::warning
Antes de começar, recomendamos que guarde um backup completo do website. Esta cópia de segurança deve conter não só os ficheiros presentes no [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-save-and-backup), mas também os ficheiros de [base de dados](/guides/web-cloud/web-hosting/sql-database-export) se o website utilizar uma.
