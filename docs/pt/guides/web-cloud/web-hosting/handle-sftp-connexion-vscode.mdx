...
<Tabs>
  ...
  <Tab label="Etapa 2">
    No separador <code className="action">FTP - SSH</code>, o nome do host (`host`) é visível sob a menção `Servidor FTP e SFTP`.
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    No separador <code className="action">FTP - SSH</code>, localize o nome de utilizador na coluna `Nome de utilizador` do quadro.
  </Tab>
</Tabs>
...
[Utilizar o acesso SSH do alojamento web](/guides/web-cloud/web-hosting/ssh-on-webhosting). Lembre-se de que, para utilizar o SSH, deve dispor de um [plano de alojamento web](https://www.ovhcloud.com/pt/web-hosting/) **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max**.
