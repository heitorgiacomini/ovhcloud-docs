...
O **SFTP** utiliza, tal como o SSH, a porta 22 predefinida em vez da porta 21. Se utiliza um serviço de alojamento Cloud Web, deve utilizar a porta que se apresenta na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. A porta 22 é desativada por segurança em SSH e em SFTP para os alojamentos Cloud Web.
...
Para isso, volte ao separador FTP-SSH` do seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> tal como indicado na [primeira parte](#part-1) deste guia.
...
Verifique as suas credenciais para assegurar que não é introduzido nenhum erro. Se necessário, pode [alterar a palavra-passe do acesso FTP](/guides/web-cloud/web-hosting/ftp-change-password) do seu alojamento web diretamente na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
Verifique este último em relação ao nome do host declarado na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
