...
Se pretende criar uma nova base de dados na OVHcloud, aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e clique em <code className="action">Alojamentos</code>. De seguida, selecione o nome do alojamento correspondente e clique no separador <code className="action">Base de dados</code>.
