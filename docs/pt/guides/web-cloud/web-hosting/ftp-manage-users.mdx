...
:::info
Este guia só é válido para os alojamentos web do tipo **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max**. Apenas estas ofertas permitem a ativação de vários utilizadores FTP.
