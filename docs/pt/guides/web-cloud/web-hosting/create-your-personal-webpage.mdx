...
description: Saiba como criar a primeira página num Alojamento gratuito
...
- Ter um serviço de [alojamento web da OVHcloud](https://www.ovhcloud.com/pt/web-hosting/) ou um [Alojamento gratuito](https://www.ovhcloud.com/pt/domains/free-web-hosting/)
...
<body>
    <h1>Bem-vindo à minha página pessoal</h1>
    <h2>Crie de forma rápida e fácil o seu website</h2>
    <p>A OVHcloud propõe-lhe, na sua oferta Alojamento gratuito, gratuitamente um alojamento para qualquer compra de um nome de domínio.</p>
</body>
```
...
**Exemplo**: se as suas imagens pesarem 1 MB cada, estará limitado a menos de 100 imagens no seu alojamento gratuito. Se conseguir reduzir o tamanho das imagens para entre 50kb e 200kb, poderá apresentar até vários milhares delas na sua página Web.
...
<img className="thumbnail" alt="Arborescência de ficheiros e pastas" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-1.png" loading="lazy" />

Consideremos o caso de um ficheiro em formato *PNG*. Coloque-o no diretório "imagens":

<img className="thumbnail" alt="Arborescência de ficheiros e pastas com imagem" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Resultado do código HTML no browser" src="/images/assets/screens/other/browsers/web-pages/create-your-personal-webpage-3-pt.png" loading="lazy" />
...
<img className="thumbnail" alt="Colocação do ficheiro CSS" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-4.png" loading="lazy" />
...
<img className="thumbnail" alt="Modelo de caixa CSS" src="/images/assets/schemas/web-hosting/create-your-personal-webpage-5.png" loading="lazy" />
...
Para que as suas páginas e, portanto, o seu site, sejam visíveis para todos, deve colocá-las no seu alojamento (deve ativar o alojamento [como indicado neste guia](/guides/web-cloud/web-hosting/activate-start10m)).
...
Para transferir os seus ficheiros para o seu alojamento, consulte o manual sobre a [utilização do FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).
