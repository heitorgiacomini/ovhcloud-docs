...
description: Identifique a origem da lentidão do seu website e descubra como resolver esta situação
...
Para conhecer o cluster e o filer onde se encontra o seu alojamento partilhado, consulte o nosso guia "[Alojamento web - Como conhecer o seu cluster e o seu filer](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer)".
...
Coloque na raiz do seu website no [espaço de armazenamento FTP do seu alojamento partilhado](/guides/web-cloud/web-hosting/ftp-connection) um ficheiro que denominará `phpinfo.php`.
...
Aceda à sua base de dados seguindo *** o etapa 3** do nosso manual sobre a [criação de uma base de dados partilhada](/guides/web-cloud/web-hosting/sql-create-database).

Se utiliza uma base de dados numa oferta **Web Cloud Databases**, consulte o nosso guia sobre [a ligação à sua base de dados presente numa oferta Web Cloud Databases](/guides/web-cloud/databases/db-connecting-database-server).
...
:::warning
Se encontrar um erro, consulte o nosso manual sobre os [erros comuns encontrados com uma base de dados](/guides/web-cloud/web-hosting/diagnosis-database-errors). De seguida, altere a sua situação usando o guia acima para tentar novamente aceder à base de dados.
...
Verifique o motor PHP, a versão PHP e o ambiente de execução utilizados no seu alojamento web, através do nosso guia sobre a [configuração do seu alojamento web](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Para comparar as versões de PHP disponíveis em função do ambiente de execução utilizado, consulte ***a etapa 2** do guia sobre a [configuração da versão PHP no seu alojamento](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Para analisar as ligações de saída do seu alojamento, consulte os logs **OUT** deste último. Pode consultar o nosso manual sobre [a consulta dos logs do seu alojamento](/guides/web-cloud/web-hosting/logs-and-statistics).
...
Para realizar esta ação, consulte os logs **WEB** do seu alojamento web através do nosso manual sobre [como consultar os logs do seu alojamento](/guides/web-cloud/web-hosting/logs-and-statistics).
...
<img className="thumbnail" alt="Análise de rede Firefox" src="/images/assets/screens/other/browsers/diagnostic-tools/F12.png" loading="lazy" />
:::
...
:::info
A OVHcloud oferece várias [ofertas CDN](https://www.ovhcloud.com/pt/web-hosting/options/). Se pretender utilizá-los ou ativar um para o seu alojamento web, aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e consulte o nosso guia sobre [utilização do CDN OVHcloud](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
...
Consulte o nosso guia sobre a [otimização das performances para o seu website](/guides/web-cloud/web-hosting/optimise-your-website-performance).

Pode encontrar pistas de otimização para o seu site analisando-o em [gtmetrix.com](https://gtmetrix.com) (este site não está associado à OVHcloud).
