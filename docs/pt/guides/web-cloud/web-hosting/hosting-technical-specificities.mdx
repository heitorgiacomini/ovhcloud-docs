---
title: Especificidades técnicas relacionadas com os alojamentos web
description: Saiba neste guia diferentes informações e especificidades técnicas relacionadas com os alojamentos Web
...
- Ter um serviço de [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/) compatível.
...
Encontre mais informações sobre este assumpto no nosso guia "[Ligar-se ao espaço de armazenamento FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-connection)".
...
|Ofertas|Alojamento gratuito|Starter|Perso|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|---|
|Quantidade máxima de envio de e-mails por hora e por serviço|10|20|100|100|200|2000|2000|2000|2000|

</Region>

<Region zones={['ca', 'apac']}>

|Ofertas|Starter|Perso|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|
|Quantidade máxima de envio de e-mails por hora e por serviço|20|100|100|200|2000|2000|2000|2000|
...
- [Seguir e gerir os e-mails automatizados do alojamento web](/guides/web-cloud/web-hosting/mail-function-script-records);
- [Casos práticos - Dicas sobre como hackear o seu website](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked).
...
Para saber mais, consulte os detalhes dos nossos [planos de alojamento web](https://www.ovhcloud.com/pt/web-hosting/) e o nosso guia "[Primeiros passos com a sua oferta Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)".
...
Para mais informações sobre a gestão das bases de dados e sobre a ligação à interface *phpMyAdmin*, consulte o guia "[Criar uma base de dados num alojamento web](/guides/web-cloud/web-hosting/sql-create-database)".
...
Encontre mais pormenores sobre este assumpto no nosso guia "[Alojamento Web: ambiente, versão PHP, ".ovhconfig"](/guides/web-cloud/web-hosting/configure-your-web-hosting)"
...
Encontre e verifique as bibliotecas, linguagens e versões disponíveis para o seu alojamento web a partir desta página: [https://webhosting-infos.hosting.ovh.net](https://webhosting-infos.hosting.ovh.net)

<Region zones={['eu']}>
Para conhecer as especificidades técnicas do serviço Cloud Web, aceda a esta página: [https://cloudweb-infos.hosting.ovh.net/](https://cloudweb-infos.hosting.ovh.net/).
</Region>
...
Descubra como [aceder ao espaço de armazenamento FTP do seu alojamento web](/guides/web-cloud/web-hosting/ftp-connection) ou [restaurar o espaço de armazenamento FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-save-and-backup) nas nossas documentações.
...
[Ligar-se ao espaço de armazenamento FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-connection)

[Passar o seu website em HTTPS graças ao SSL](/guides/web-cloud/web-hosting/ssl-activate-https-website)

[Otimização das performances do seu site](/guides/web-cloud/web-hosting/optimise-your-website-performance)

[Restaurar o espaço de armazenamento FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-save-and-backup)
