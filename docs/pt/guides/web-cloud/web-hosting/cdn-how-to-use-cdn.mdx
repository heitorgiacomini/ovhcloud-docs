...
<Tabs>
  ...
  <Tab label="Etapa 2">
    Na página que se abrir, localize a menção **Opção CDN**. Clique em <code className="action">...</code> à direita e, a seguir, em <code className="action">Encomendar um CDN</code> ou <code className="action">Ativar a opção</code> se a opção CDN já estiver incluída no seu alojamento.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    Em seguida, clique no botão <code className="action">⁝</code> à direita do nome de domínio ou subdomínio relevante e, depois, em <code className="action">Ativar o CDN</code>.
  ...
  <Tab label="Etapa 4">
    Na janela que se abre, clique em <code className="action">Validar</code> para ativar o CDN.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    Em seguida, clique no botão <code className="action">⁝</code> à direita do nome de domínio ou subdomínio relevante e, depois, em <code className="action">Limpar o CDN</code>.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    Em seguida, clique no botão <code className="action">⁝</code> à direita do nome de domínio ou subdomínio relevante e, depois, em <code className="action">Modificar o CDN</code>.
...
<Tabs>
  ...
  <Tab label="Etapa 4">
    ...
    - **Purga avançada**: Personalize a sua purga escolhendo os elementos da cache a esvaziar: todo o site, pasta, URI, extensão de ficheiros ou através de uma expressão personalizada e regular. 
       ...
       A partir do separador <code className="action">Meus sites</code>, clique no botão <code className="action">⁝</code> à direita do nome de domínio ou subdomínio relevante e, em seguida, em <code className="action">Limpar o CDN</code>.
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    Localize a menção **Opção CDN**. Clique em <code className="action">...</code> à direita e depois em <code className="action">Eliminar CDN</code>.
