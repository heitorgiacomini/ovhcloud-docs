...
description: Saiba como instalar e dar os primeiros passos em Composer
...
- Ter um [serviço de alojamento web](https://www.ovhcloud.com/pt/web-hosting/) com acesso SSH.

## Instruções

Ligue-se ao seu alojamento partilhado através de SSH através do nosso manual sobre [a utilização do SSH com o seu alojamento web partilhado OVHcloud](/guides/web-cloud/web-hosting/ssh-on-webhosting).
