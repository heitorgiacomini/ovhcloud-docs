...
Vai precisar do endereço IP do seu servidor que encontrará na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, assim como do nome da conta de utilizador que deseja utilizar para esta sessão de ligação. Não hesite em consultar os nossos manuais "Primeiros passos" se deseja obter mais pormenores sobre este assumpto:
