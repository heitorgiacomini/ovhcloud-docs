...
description: Saiba como adicionar uma chamada a uma API externa a partir da sua página web estática
...
- Ter instalado e configurado a aplicação **Cecil** no seu alojamento (consulte o nosso tutorial sobre [a instalação e a configuração do Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil)).
...
Prepare o seu ambiente ligando-se através de SSH ao seu alojamento web e adira ao tutorial "[Instalar e configurar Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil)" para instalar a sua aplicação **Cecil** num diretório dedicado.
...
Crie uma conta em [https://home.openweathermap.org/users/sign_up](https://home.openweathermap.org/users/sign_up)<br/>
...
<img className="thumbnail" alt="Teste nova página" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil-api-call02.png" loading="lazy" />
...
<img className="thumbnail" alt="layouts diretory" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil-api-call03.png" loading="lazy" />
...
<img className="thumbnail" alt="Cecil layouts diretory including uncompressed files" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil-api-call05.png" loading="lazy" />
...
<img className="thumbnail" alt="Selet a new city" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil-api-call07.png" loading="lazy" />
