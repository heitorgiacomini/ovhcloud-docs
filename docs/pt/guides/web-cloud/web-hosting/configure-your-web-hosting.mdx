...
As ofertas de [alojamento web da OVHcloud](https://www.ovhcloud.com/pt/web-hosting/) permitem alojar o site que quiser, desde que seja compatível com a [configuração das nossas infraestruturas partilhadas](https://webhosting-infos.hosting.ovh.net).
...
- a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> ;
...
Em resumo, alterar a configuração do seu alojamento web a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> ou modificar os valores presentes no ficheiro ".ovhconfig" equivale a realizar a mesma operação.
...
<Region zones={['eu']}>
- Dispor de um serviço de [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/), com exceção de um [serviço de alojamento Cloud Web](https://www.ovhcloud.com/pt/web-hosting/cloud-web-offer/).
</Region>
<Region zones={['ca', 'apac']}>
- Dispor de um serviço de [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/).
</Region>
...
- Consulte a [documentação oficial PHP](http://php.net/manual/en/appendices.php) para obter mais informações sobre as migrações da versão.
...
- **Através da Área de Cliente OVHcloud**. Aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e aceda à secção <code className="action">Web Cloud</code>. Na coluna da esquerda, clique em <code className="action">Alojamentos</code> e escolha o alojamento web em causa. No separador <code className="action">Informações gerais</code>, localize a versão abaixo de *Versão global de PHP*. 
...
De seguida, coloque-o online no seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection) e ligue-o para o seu endereço/URL completo.
...
Consulte o guia "[Ativação da firewall da aplicação](/guides/web-cloud/web-hosting/multisites-activating-application-firewall)" para mais informações sobre o assumpto.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    À direita da entrada **Versão global de PHP**, localizada quase no centro da página, clique no botão <code className="action">...</code> e, a seguir, em <code className="action">Alterar configuração</code>.
...
Aparecerá uma janela com duas opções possíveis. Selecione a que corresponde à ação que deseja realizar e clique em ‘Seguinte`.
...
Clique em <code className="action">Validar</code> para aplicar a alteração. Aguarde alguns instantes até que ela se realize.
...
Quanto à palavra-passe do utilizador FTP, consulte as instruções descritas no manual "[Alterar a palavra-passe de um utilizador FTP](/guides/web-cloud/web-hosting/ftp-change-password)" se necessário.
  </Tab>
</Tabs>
...
|app.engine.version|Permite definir [a versão de PHP](#php-versions) utilizada pelo alojamento entre [as que a OVHcloud propõe](https://www.ovhcloud.com/pt/web-hosting/uc-programming-language/). Insira a versão da sua escolha (adequada ao ambiente de execução que escolheu utilizar).|
|http.firewall|Permite ativar ou desativar a [firewall fornecida com os alojamentos web da OVHcloud](https://www.ovhcloud.com/pt/web-hosting/options/). Introduza **security** para a ativar ou **none** para a desativar.|
...
Depois de" alterado o ficheiro ".ovhconfig, transfira-o para o seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection). Para isso, volte a ligar-se ao seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection) e coloque-se na raiz do seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection) (que pode ser simbolizado por um "/"). Carregue o ficheiro ".ovhconfig" que acabou de modificar no seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection). Se o ficheiro já existir, substitua-o.
...
Crie um ficheiro ".ovhconfig" contendo a versão de PHP desejada para o(s) sítio(s) web em questão. Utilize as manipulações descritas na parte "[3.3 - Modificar o conteúdo do ficheiro ".ovhconfig"](#update-ovhconfig)" deste guia, se necessário. Quando fizer o upload do ficheiro ".ovhconfig" para o seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection), faça-o na pasta raiz onde se encontram os ficheiros que compõem o sítio web em questão. Encontre a pasta raiz do seu sítio web a partir do seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> no separador <code className="action">Multisite</code> do alojamento em questão.

Consulte o nosso guia detalhado sobre como [configurar um sítio web num alojamento web](/guides/web-cloud/web-hosting/multisites-configure-multisite), se necessário.
...
[Ligar-se ao espaço de armazenamento do alojamento web](/guides/web-cloud/web-hosting/ftp-connection)
