...
- de uma base de dados presente num servidor [Web Cloud Databases](https://www.ovhcloud.com/pt/web-cloud/databases/) (incluída nos nossos [alojamentos](https://www.ovhcloud.com/pt/web-hosting/) **Performance**, **Agency**, **Agency Plus** e **Agency Max** ou [encomendada em separado](https://www.ovhcloud.com/pt/web-cloud/databases/)).
...
<details>
<summary>A partir de uma base de dados Start SQL</summary>
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    Clique no separador <code className="action">Bases de dados</code>. A tabela lista as bases de dados criadas no seu plano de alojamento web.
  ...
  <Tab label="Etapa 3">
    Clique no botão <code className="action">...</code> à direita da linha correspondente à base de dados cujo conteúdo pretende copiar e selecione <code className="action">Copiar a base de dados</code>.
  ...
  <Tab label="Etapa 4">
    ...
    - Para uma base de dados num servidor Web Cloud Databases: siga o nosso guia "[Criar uma base de dados num servidor Web Cloud Databases](/guides/web-cloud/databases/db-create-databases-users)".

    :::
    
    - **Escolha 1 - Copiar para uma base Start SQL**: selecione <code className="action">Copiar para uma base de dados</code> e escolha a base de dados de destino na lista suspensa.
    - **Escolha 2 - Copiar para um servidor Web Cloud Databases**: selecione <code className="action">Copiar para um Web Cloud Databases</code>. Aparecem duas listas suspensas. Clique na primeira para selecionar a solução Web Cloud Databases e na segunda para escolher a base de dados de destino.
  </Tab>
  <Tab label="Etapa 5">
  ...
  <Tab label="Etapa 6">
    ...
    <img className="thumbnail" alt="Operações em curso" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/databases/copy-db-tool-ongoing-tasks.png" loading="lazy" />
  </Tab>
</Tabs>
...
<details>
<summary>A partir de um servidor Web Cloud Databases</summary>
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    Clique no separador <code className="action">Bases de dados</code>. A lista das bases de dados presentes no servidor Web Cloud Databases é apresentada.
...
<details>
<summary>Não aparece nenhuma base de dados na lista</summary>
...
<details>
<summary>Já tem uma ação em curso</summary>
...
<details>
<summary>A base de dados de destino não contém espaço suficiente</summary>
...
<details>
<summary>As bases de dados de origem e de destino são incompatíveis</summary>
