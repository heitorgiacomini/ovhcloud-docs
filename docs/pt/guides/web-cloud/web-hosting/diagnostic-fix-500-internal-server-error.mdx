...
Se pretender ter acesso a estes detalhes, poderá aceder ao seu site através de uma [ligação ssh](/guides/web-cloud/web-hosting/ssh-on-webhosting) a partir da fórmula de alojamento [Pro](https://www.ovhcloud.com/pt/web-hosting/) ou superior.
