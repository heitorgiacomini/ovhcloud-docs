...
<Region zones={['eu']}>
- Ter um [alojamento web](https://www.ovhcloud.com/pt/web-hosting/) (não funciona com um alojamento Cloud Web).
</Region>
...
- O estado "manutenção" aparece na sua <ManagerLink to="/#/web/hosting">Área de Cliente OVHcloud</ManagerLink>.
...
Pode consultar estas informações no nosso manual ["Aceder ao espaço de armazenamento FTP do alojamento web"](/guides/web-cloud/web-hosting/ftp-connection).

Caso não tenha a palavra-passe do utilizador FTP, consulte o manual ["Alterar a palavra-passe de um utilizador FTP"](/guides/web-cloud/web-hosting/ftp-change-password).
