...
description: Saiba como migrar o seu website de um alojamento partilhado para um VPS OVHcloud
...
- Ter um [plano de alojamento web](https://www.ovhcloud.com/pt/web-hosting/) ativo.
- Ter subscrito um [VPS](https://www.ovhcloud.com/pt/vps/) presente na sua conta OVHcloud.
...
Este guia fornece as instruções necessárias para realizar as operações mais habituais. Se encontrar dificuldades, recomendamos que recorra a um [fornecedor especializado](https://partner.ovhcloud.com/pt/directory/). Não poderemos proporcionar-lhe assistência técnica. Para mais informações, consulte a secção ["Quer saber mais?"](#go-further) deste guia.
:::
...
Se utilizar o WordPress, siga o nosso guia "[Faça o backup do seu site WordPress](/guides/web-cloud/web-hosting/how-to-backup-your-wordpress)" para saber como efetuar a cópia de segurança de ficheiros e da base de dados do seu website WordPress e, em seguida, prossiga para [etapa 2](#step2).

#### Etapa 1.1 - Ligar-se ao espaço de armazenamento FTP do seu alojamento web

Siga as etapas do nosso guia "[Aceder ao espaço de armazenamento FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-connection)" para se ligar ao espaço de armazenamento FTP do seu alojamento web.
...
Se pretender migrar a base de dados para o VPS, siga as etapas do nosso guia "[Recuperar a cópia de segurança da base de dados de um alojamento web](/guides/web-cloud/web-hosting/sql-database-export)" para salvaguardar a sua base de dados.

### Etapa 2 - Configurar o seu VPS <a name="step2"></a>

:::info
Se ainda não tiver VPS, aceda a [página do produto VPS OVHcloud](https://www.ovhcloud.com/pt/vps/) para adquirir um VPS. Certifique-se de que escolhe um VPS que corresponde às necessidades do seu website em termos de recursos (RAM, CPU, armazenamento, etc.) e às especificações técnicas do seu CMS. Se não está familiarizado com os VPS, consulte o guia "[Primeiros passos com um VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)".
:::


#### Etapa 2.1 - Aceder ao VPS

Consulte a secção "Ligar-se ao seu VPS" do guia "[Primeiros passos com um VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)" para se ligar ao seu VPS.
...
Para instalar este ambiente web, consulte o guia "[Instalar um ambiente de desenvolvimento web num VPS ou num servidor dedicado](/guides/bare-metal-cloud/virtual-private-servers/install-env-web-dev-on-vps)".
...
Siga o nosso [guia de utilização do FileZilla](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp) e introduza os seguintes detalhes:
...
- Crie uma pasta `site` em `/home/debian/` (clicar com o botão direito → <code className="action">Criar um diretório</code>), depois abra-a.
...
Conecte-se ao VPS em SSH consultando a secção "Conectar-se ao seu VPS" do nosso guia "[Primeiros passos com um VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)".
...
1. Conecte-se ao VPS em SSH consultando a secção "Conectar-se ao seu VPS" do nosso guia "[Primeiros passos com um VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)".
...
Para uma lista completa das boas práticas de segurança, consulte o guia "[Proteger um VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps)".
