...
Pode obter informações sobre como atualizar o PHP [neste guia](/guides/web-cloud/web-hosting/configure-your-web-hosting).

Para mudar para a utilização do PHP-FPM na versão _estável_ ou para obter detalhes sobre opções mais avançadas do seu alojamento web, consulte [este guia](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Pode aceder aos seus logs, estatísticas e gráficos diretamente a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
1. Clique em <code className="action">Alojamento</code> na coluna da esquerda e, em seguida, selecione o alojamento web correspondente.
2. Na página que se abrir, clique no separador <code className="action">Estatísticas e logs</code>. Desloque-se até à parte inferior da página onde se encontra o gráfico relativo à utilização do seu alojamento.
3. Selecione o **tipo** de informação bem como o **período** dos dados apresentados.

<img className="thumbnail" alt="gráficos" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png" loading="lazy" />
...
**Como aceder à base de dados via phpMyAdmin:** Para aceder à sua base de dados via phpMyAdmin, siga o procedimento disponibilizado na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>:

- Clique no seu domínio na secção <code className="action">Alojamento</code>.
- Aceda ao separador <code className="action">Base de dados</code>.
- Clique nos 3 pontos<code className="action">...</code> à direita da sua base de dados para aceder a phpMyAdmin.
...
[Alterar a configuração de um plano de alojamento web](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Gestão de uma base de dados num pacote de alojamento web](/guides/web-cloud/web-hosting/sql-create-database)
