...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    <img className="thumbnail" alt="Gráfico de estatísticas de utilização da infraestrutura" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png" loading="lazy" />
...
**Como aceder à base de dados via phpMyAdmin:** consulte a secção dedicada no nosso guia «[Gestão de uma base de dados num pacote de alojamento web](/guides/web-cloud/web-hosting/sql-create-database)».
