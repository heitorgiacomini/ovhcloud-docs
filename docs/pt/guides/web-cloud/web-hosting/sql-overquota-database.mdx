...
Se a base de dados estiver presente numa solução [Web Cloud Databases](https://www.ovhcloud.com/pt/web-cloud/databases/), consulte o guia "[Web Cloud Databases - Ligar-se à base de dados](/guides/web-cloud/databases/db-connecting-database-server)" e, em seguida, passe diretamente para a [etapa 1.2](#step1.2) deste guia.
...
É possível duplicar o conteúdo da sua base de dados OVHcloud diretamente para outra das suas bases de dados OVHcloud graças a uma funcionalidade presente na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Para isso, consulte o guia "[Duplicar o conteúdo de uma base de dados noutra](/guides/web-cloud/web-hosting/copy-database)".
...
- [Primeiros passos com a oferta Web Cloud Databasess](/guides/web-cloud/databases/db-getting-started)
- [Importar a sua antiga base de dados para o serviço Web Cloud Databasess](/guides/web-cloud/databases/db-restore-import-database)
