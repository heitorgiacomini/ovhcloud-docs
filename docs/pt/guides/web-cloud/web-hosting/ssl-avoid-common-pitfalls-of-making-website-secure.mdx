...
description: Descubra como evitar os erros comuns de segurança do seu website com o SSL
...
- Dispor de um [alojamento web OVHcloud](https://www.ovhcloud.com/pt/web-hosting/).
...
:::info
Alguns websites utilizam [Content Delivery Network (CDN)](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn) para alojar, por exemplo, bibliotecas *Javascript* (como *JQuery*). 
