...
description: Saiba como utilizar o comando Secure Copy Protocol (SCP) em SSH para copiar ficheiros de ou para o seu alojamento web
...
Este guia explica de forma não exaustiva as funcionalidades disponíveis com o comando `scp`. Não hesite em trocar impressões com nossa [comunidade de utilizadores](https://community.ovhcloud.com/community/en). se desejar aprofundar os seus conhecimentos sobre esta encomenda.

### Etapa 1 - Recuperar os acessos SSH do seu alojamento web

Para encontrar os acessos SSH do seu alojamento web, consulte o guia "[Utilizar o acesso SSH do alojamento web](/guides/web-cloud/web-hosting/ssh-on-webhosting)".
...
- `ssh.cluster0XX.hosting.ovh.net`: substitua os `XX` pelo número do cluster onde se encontra o seu alojamento web. Se necessário, consulte o guia "[Utilizar o acesso SSH do alojamento web](/guides/web-cloud/web-hosting/ssh-on-webhosting)" para encontrar esta informação.
...
Para verificar se algum conteúdo presente localmente no seu computador foi copiado para o alojamento web, pode [aceder ao espaço de armazenamento FTP do alojamento web](/guides/web-cloud/web-hosting/ftp-connection) e, de seguida, dirigir-se ao diretório de destino onde o conteúdo é suposto ser copiado.
...
[Utilizar o acesso SSH do alojamento web](/guides/web-cloud/web-hosting/ssh-on-webhosting)

[Ligar-se ao espaço de armazenamento FTP do seu alojamento web](/guides/web-cloud/web-hosting/ftp-connection)
