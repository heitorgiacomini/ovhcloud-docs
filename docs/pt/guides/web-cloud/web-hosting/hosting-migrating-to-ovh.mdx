...
Também pode efetuar a encomenda a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Uma vez ligado, siga as instruções seguintes:

- Aceda ao separador <code className="action">Web Cloud</code>.
- No canto superior esquerdo da interface, clique no botão <code className="action">Encomendar</code> e, a seguir, em <code className="action">Alojamento</code>.
