...
Depois de escolher a oferta de alojamento, se ainda não é cliente da OVHcloud, clique no botão <code className="action">Encomendar</code> presente nas páginas comerciais acima. Siga os passos da encomenda **sem solicitar a transferência do seu nome de domínio** (esta ação será realizada na etapa 10 deste manual).
