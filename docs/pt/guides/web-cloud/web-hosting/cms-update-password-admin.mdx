...
Já não tem acesso à interface de administração do CMS ou não pode utilizar a funcionalidade "Esqueceu-se da Palavra-passe" porque o endereço de e-mail associado está inacessível? Utilize o phpMyAdmin a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> para repor a palavra-passe diretamente a partir da base de dados.
