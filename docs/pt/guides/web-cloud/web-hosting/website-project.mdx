...
<Tabs>
  <Tab label="Utilizar um CMS">
    ...
    Depois de aceder à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e o alojamento web alojado, poderá instalar rapidamente os CMS *WordPress*, *Joomla!*, *PrestaShop* e *Drupal*.
...
- Se não tiver associado um domínio durante a encomenda do seu alojamento web e pretender beneficiar da opção "endereço(s) de e-mail incluído(s) com o seu alojamento web", deverá efetuar a operação manualmente a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
Para verificar e/ou modificar a ligação entre o seu nome de domínio e o seu site web presente no seu alojamento web, **consulte os seguintes guias por ordem:**
...
- [Como associar um nome de domínio a um site web existente?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website): Este guia explica como adicionar um nome de domínio a um site web presente no seu alojamento web. Pode também ajudá-lo a verificar se a declaração do seu nome de domínio no site web presente no seu alojamento web está correta. Se necessário, poderá modificá-la e depois fazer o necessário no nível da zona DNS ativa do seu nome de domínio.
...
- **Para a ligação entre o seu nome de domínio e o seu alojamento web**: Consulte apenas os guias "[Lista dos endereços IP dos clusters e alojamentos web](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip)" e "[Como associar um nome de domínio a um site web existente?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website)" mencionados acima para recuperar o endereço IP do seu alojamento web, depois declare corretamente o seu nome de domínio no site web presente no seu alojamento web. Contacte depois a entidade que gere a zona DNS ativa do seu nome de domínio para que este aponte para o seu alojamento web.
