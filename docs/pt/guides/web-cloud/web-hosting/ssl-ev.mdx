...
description: Saiba como encomendar e instalar um certificado SSL Sectigo EV no seu alojamento Web OVHcloud
...
<Tabs>
  ...
  <Tab label="Etapa 4">
    Na nova janela que se abrir, selecione o domínio ou subdomínio em causa através do menu pendente e clique em <code className="action">Validar</code> para ser reencaminhado para a nota de encomenda do seu certificado SSL Sectigo EV.
...
Clique em <code className="action">Continuar</code> depois de **todos os elementos** estarem corretamente inseridos.
...
Se ainda não encomendou o seu nome de domínio e o alojamento associado, aceda à nossa [página inicial da OVHcloud](https://www.ovhcloud.com/pt/), introduza um nome de domínio no **formulário de pesquisa previsto para este efeito** e clique em <code className="action">Pesquisar</code> para iniciar a sua encomenda.
...
Selecione as suas escolhas de instalação de <code className="action">módulo em 1 clique</code> e <code className="action">CDN</code>, e desça no final da página até à secção <code className="action">Torne o seu website seguro com os nossos certificados SSL</code>.
 
<img className="thumbnail" alt="SSL EV order" src="/images/assets/screens/website/order/ssl-ev-selection.png" loading="lazy" />

Escolha <code className="action">Sectigo EV SSL</code> e depois clique em <code className="action">Seguinte</code>.
...
Clique em <code className="action">Seguinte</code> depois de **todos os elementos** estarem corretamente inseridos.
...
Para garantir que a troca de e-mail com Sectigo é efetuada corretamente, verifique também a validade do endereço de e-mail indicado no formulário aquando da encomenda do SSL Sectigo EV, bem como o endereço de e-mail associado ao seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
Também recomendamos que **não** ative ou deixe ativo o [firewall](/guides/web-cloud/web-hosting/multisites-activating-application-firewall), disponível com os nossos alojamentos web, durante toda a duração da instalação do seu certificado SSL Sectigo EV.
...
Só precisa de [atualizar o seu website em HTTPS](/guides/web-cloud/web-hosting/ssl-activate-https-website) para utilizar plenamente o seu certificado SSL Sectigo EV.
...
[Passar o seu website em HTTPS](/guides/web-cloud/web-hosting/ssl-activate-https-website)
