...
description: "Descubra como repor o seu site online quando apresenta uma página \"403 forbidden\""
...
- Dispor dos [dados de acesso](/guides/web-cloud/web-hosting/ftp-connection) ao espaço FTP de armazenamento do seu alojamento.
...
Se a página **"403 forbidden"** surgiu na sequência de uma modificação do seu website, [restaure todo ou parte do espaço de armazenamento FTP do seu alojamento](/guides/web-cloud/web-hosting/ftp-save-and-backup) numa data anterior.
...
- Altere todas as suas palavras-passe locais, nomeadamente as dos seus endereços de e-mail, respeitando as **boas práticas** definidas no [presente guia](/guides/account-and-service-management/account-information/manage-ovh-password).

- Altere as palavras-passe do conjunto dos seus serviços OVHcloud, nomeadamente as da sua [base de dados](/guides/web-cloud/web-hosting/sql-change-password) e do acesso ao seu [espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-change-password).

:::warning
Antes de alterar a palavra-passe da base de dados do seu website a partir do seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, atualize o ficheiro de configuração do seu website para que se ligue à base de dados com a nova palavra-passe.
...
Para restaurar todo ou parte do seu espaço de armazenamento FTP, consulte o [nosso guia](/guides/web-cloud/web-hosting/ftp-save-and-backup) sobre o assumpto.
...
Para identificar estas falhas de segurança, analise os ["logs web"](/guides/web-cloud/web-hosting/logs-and-statistics) do seu alojamento web ou recorra a um [fornecedor especializado](https://partner.ovhcloud.com/pt/directory/) para realizar uma auditoria de segurança dos seus websites.
...
:::tip
Para mais informações sobre os [passos 2 e 3](#step-2) anteriores, consulte o nosso manual sobre [ações a realizar em caso de pirataria do seu website](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked).
...
:::info
Para instalar o software **FileZilla** para manipular os ficheiros do seu website, siga as instruções deste [tutorial](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).

:::


Abra o FileZilla e depois [ligue-se ao seu espaço de armazenamento FTP](/guides/web-cloud/web-hosting/ftp-connection). A seguir, clique em <code className="action">Servidor</code> na barra de menu e depois em <code className="action">Indicar comando personalizado</code> (o título pode ser diferente segundo a versão do FileZilla que utiliza):
...
[Piratagem do seu website WordPress: conselhos e casos práticos](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked)

[Partilhado: ativação da firewall](/guides/web-cloud/web-hosting/multisites-activating-application-firewall)

[Mudar a versão de PHP do alojamento web](/guides/web-cloud/web-hosting/configure-your-web-hosting)
