...
:::info
Apenas os alojamentos web **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max** permitem a ativação de vários utilizadores FTP e dispõem de ligações em SSH.
...
:::info
Estes elementos foram-lhe enviados por e-mail após a subscrição do seu alojamento web. Estão disponíveis a partir do seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
Este tipo de acesso requer conhecimentos técnicos avançados, bem como uma oferta de [alojamento web da OVHcloud](https://www.ovhcloud.com/pt/web-hosting/) **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max**.
