...
Para adicionar um registo SPF na configuração da OVHcloud do seu nome de domínio, aceda à Área de <ManagerLink to="/">Cliente OVHcloud</ManagerLink>. Selecione <code className="action">Domínios</code>, clique no nome de domínio pretendido e aceda ao separador <code className="action">Zona DNS</code>.
...
Para alterar o registo SPF na configuração OVHcloud do seu nome de domínio, aceda à Área de <ManagerLink to="/">Cliente OVHcloud</ManagerLink>. Selecione <code className="action">Domínios</code>, clique no nome de domínio pretendido e aceda ao separador <code className="action">Zona DNS</code>.
