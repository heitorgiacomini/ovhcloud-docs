...
description: Descubra o papel de uma zona DNS e os registos que contém para um domínio
...
Para uma melhor compreensão do conjunto, recomendamos que consulte previamente o nosso guia "[Saber tudo sobre os servidores DNS](/guides/web-cloud/domains/dns-server-general-information)".
...
Para obter mais informações, consulte a nossa página web explicando [como funciona um servidor DNS](https://www.ovhcloud.com/pt/domains/dns-server/).
...
Consulte o nosso manual sobre [os registos DNS](/guides/web-cloud/domains/dns-zone-records) para mais informações sobre os diferentes tipos de registos mencionados acima. Nele encontrará elementos que lhe permitirão, por exemplo, compreender melhor a [edição de uma zona DNS da OVHcloud](/guides/web-cloud/domains/dns-zone-edit).
...
Para os e-mails, a zona DNS indica que os pedidos DNS realizados para os endereços de e-mail em *@domain.tld* devem ser enviados para o servidor *mx1.mail.ovh.ca* em prioridade. Se este demorar muito tempo a responder ou estiver indisponível, o pedido será então reenviado para o servidor *mx2.mail.ovh.ca* e assim por diante até ao último servidor declarado *mx3.mail.ovh.ca*.
