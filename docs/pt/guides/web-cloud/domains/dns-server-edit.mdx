...
3. Tenha o cuidado de não misturar um grupo de servidores DNS da OVHcloud com outro grupo de servidores DNS da OVHcloud. Na OVHcloud, os grupos de servidores DNS são identificáveis através do número presente nos nomes dos servidores. Dois servidores DNS da OVHcloud fazem parte de um mesmo grupo de servidores DNS quando partilham o mesmo número.

<Region zones={['eu']}>

Por exemplo, *dns19.ovh.net* e *ns19.ovh.net* correspondem a um grupo de servidores DNS da OVHcloud, andam de mãos dadas e são sincronizados. Fazem parte do mesmo grupo porque partilham o mesmo número.

</Region>

<Region zones={['ca', 'apac']}>

Por exemplo, *dnsXX.ovh.ca* e *nsXX.ovh.ca* correspondem a um grupo de servidores DNS da OVHcloud, andam de mãos dadas e são sincronizados (por exemplo, *dns10.ovh.ca* e *ns10.ovh.ca*). Fazem parte do mesmo grupo porque partilham o mesmo número. Os servidores exatos atribuídos ao seu nome de domínio são indicados na Área de Cliente OVHcloud.
...
Por exemplo: pretende declarar os servidores DNS *ns1.dns-server.tld*, *dnsXX.ovh.ca* e *nsXX.ovh.ca* para o seu nome de domínio. Deverá verificar se os três registos do tipo "NS" seguintes estão presentes nas 3 zonas DNS alojadas nestes 3 servidores DNS:
...
- O *registo* que gere a sua extensão de nome de domínio (por exemplo, o registo das extensões em *.fr*) deve ser informado da alteração DNS efetuada do lado da OVHcloud. Acompanhe o progresso desta operação na página <ManagerLink to="/#/web/ongoing-operations">Operações em curso</ManagerLink>.
