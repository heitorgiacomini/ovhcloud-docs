...
<Tabs>
  ...
  <Tab label="Passo 3">
    ...
    Além disso, se encontrar a mensagem: "**AUTH/INFO code : Authcode is not managed by OVHcloud, contact the registry to claim it**" significa que o código de transferência do seu nome de domínio não pode ser recuperado através do seu <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
    
    Em ambos os casos, verifique se é o contacto **administrador** do nome de domínio através do nosso guia sobre a [gestão dos contactos](/guides/account-and-service-management/account-information/managing-contacts) e verifique se a extensão do seu nome de domínio permite um desbloqueio a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
