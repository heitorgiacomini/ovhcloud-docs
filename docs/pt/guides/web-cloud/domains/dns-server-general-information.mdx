...
description: Descubra o papel dos servidores DNS, o que eles contêm e como funcionam com um domínio
...
Eles permitem a utilização de [nomes de domínio](https://www.ovhcloud.com/pt/domains/) para aceder ao seu website preferido sem ser obrigado a reter o endereço IP do servidor onde está alojado este website.
...
Consulte o nosso guia "[Alterar os servidores DNS de um nome de domínio OVHcloud](/guides/web-cloud/domains/dns-server-edit)" se precisar de realizar esta ação para um nome de domínio registado na OVHcloud.
...
:::tip[Success]
- Para mais informações sobre as zonas DNS, consulte o guia "[Saber tudo sobre a zona DNS](/guides/web-cloud/domains/dns-zone-general-information)".
- Consulte o nosso guia sobre [Saber tudo sobre os registos DNS](/guides/web-cloud/domains/dns-zone-records) para uma melhor compreensão do conjunto.
...
[Alterar uma zona DNS da OVHcloud](/guides/web-cloud/domains/dns-zone-edit).
