...
Poderá depois administrar o seu nome de domínio acedendo à sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
Uma vez subscritos, os IDN aparecem na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> no formato **xn--**.

Mesmo que o seu nome de domínio seja apresentado em [notação internacionalizada (IDN)](https://pt.wikipedia.org/wiki/Nome_de_dom%C3%ADnio_internacionalizado) na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, funcionará e será apresentado de forma normal noutros locais. O endereço do seu website será apresentado tal como o solicitou. Os seus endereços e-mail também serão apresentados como deseja junto dos seus correspondentes.
...
:::tip
Consulte todos os detalhes no nosso manual "[Como renovar os meus serviços OVHcloud](/guides/account-and-service-management/managing-billing-payments-and-services/automatic-renewal)".
...
Efetue um [procedimento de recuperação de contactos](https://www.ovh.pt/cgi-bin/pt/procedure/procedureChangeContacts.cgi) para que o seu nome de domínio seja integralmente gerido na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Assim, já não precisará de contactar a pessoa que geria anteriormente o seu nome de domínio.
...
:::tip
Se não recebeu este e-mail, verifique o seu correio indesejado ou aceda à página <ManagerLink to="/#/account/useraccount/dashboard">A minha conta</ManagerLink> e clique no separador <code className="action">E-mails recebidos</code>.
...
Se o separador não aparece na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, é porque a opção "GLUE" não está disponível para o seu nome de domínio.
...
Na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, esta mensagem indica unicamente que a zona DNS criada para o seu nome de domínio não é a sua zona DNS ativa.
...
<Tabs>
  <Tab label="Passo 1">
    Aceda à página <ManagerLink to="/#/web-domains/domain">Nomes de domínio</ManagerLink> e verifique se o nome de domínio em questão aparece.
...
[Alojamento web - FAQ](/guides/web-cloud/web-hosting/faq)
