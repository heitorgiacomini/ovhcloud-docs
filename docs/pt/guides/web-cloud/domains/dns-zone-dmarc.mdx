...
O registo **D**omain-based **M**essage **A**uthentication, **R**eporting, and **C**onformance (DMARC) é um mecanismo de segurança de e-mail. Baseia-se no resultado das verificações [SPF](/guides/web-cloud/domains/dns-zone-spf) e [DKIM](/guides/web-cloud/domains/dns-zone-dkim).
...
- Um dos mecanismos de autenticação, [SPF](/guides/web-cloud/domains/dns-zone-spf) e/ou [DKIM](/guides/web-cloud/domains/dns-zone-dkim) deve estar configurado na zona DNS do nome de domínio da oferta de e-mail.
...
O DMARC consulta os mecanismos de autenticação [SPF](/guides/web-cloud/domains/dns-zone-spf) e [DKIM](/guides/web-cloud/domains/dns-zone-dkim) para verificar os e-mails recebidos.<br/>
...
Pode adicionar o registo DMARC à sua zona DNS a partir da Área de Cliente OVHcloud. Para isso, aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e aceda à secção <code className="action">Web Cloud</code>. Na coluna da esquerda, selecione o nome de domínio correspondente na secção <code className="action">Nomes de domínio</code> e, em seguida, clique no separador <code className="action">Zona DNS</code> para aceder à zona DNS.

Depois de apresentar a zona DNS, clique no botão <code className="action">Adicionar uma entrada</code> e, a seguir, em « Campos de e-mail » <code className="action">DMARC</code>.
...
Pode adicionar o registo TXT à sua zona DNS a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e, a seguir, aceda à secção <code className="action">Web Cloud</code>. Clique em <code className="action">Nomes de domínio</code> e escolha o domínio em causa. De seguida, clique no separador <code className="action">Zona DNS</code>.

Depois de apresentar a zona DNS, clique no botão <code className="action">Adicionar uma entrada</code> e, a seguir, em « Campos » <code className="action">TXT</code>.
