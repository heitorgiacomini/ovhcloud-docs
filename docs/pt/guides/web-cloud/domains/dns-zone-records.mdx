...
<Tabs>
  <Tab label="MX">
    **M**ail e**X**changer <br/><br/>
    Associe um nome de domínio a um servidor de e-mail.
    ...
    É provável que o seu fornecedor de e-mail disponha de vários servidores de e-mail: assim, devem ser criados vários campos MX. Consulte o nosso manual "[Adicionar um campo MX à configuração do nome de domínio](/guides/web-cloud/domains/dns-zone-mx)".
