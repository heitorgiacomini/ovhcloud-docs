...
Tal como para um nome de domínio e para autorizar um subdomínio a apresentar o conteúdo de uma pasta *de destino* presente num alojamento web, aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e selecione <code className="action">Web Cloud</code>. Clique em <code className="action">Alojamentos</code> na coluna da esquerda, selecione o serviço em causa onde se encontra o seu website e escolha o separador <code className="action">Multisite</code>.

É aqui que autoriza o acesso do seu subdomínio ao seu alojamento web onde se encontra o seu website.

Para mais informações sobre a configuração de um nome de domínio ou subdomínio num alojamento web, consulte o guia "[Partilhar o alojamento entre vários sites](/guides/web-cloud/web-hosting/multisites-configure-multisite)". Quer se trate de um nome de domínio ou de um subdomínio, o procedimento é o mesmo.
