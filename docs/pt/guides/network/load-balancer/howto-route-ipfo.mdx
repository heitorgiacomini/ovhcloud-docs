...
You can define dedicated Additional IPs via the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> by navigating to the `Network` section, then `Load Balancer`.
