...
description: Descubra como escolher e configurar os front-ends do seu serviço Load Balancer OVHcloud, para utilização com o protocolo HTTP/2
...
- Um serviço [Load Balancer OVHcloud](https://www.ovhcloud.com/pt/network/load-balancer/);
...
- Acesso à [API OVHcloud](https://eu.api.ovh.com/).
