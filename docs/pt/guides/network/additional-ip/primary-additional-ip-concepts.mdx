...
- **Configuration**: IPv4 and IPv6 addresses configuration details, such as address, prefix size, or default gateway, can be found within the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, usually in the `Network` tab of the given product.
