...
description: Descubra as boas práticas de configuração de um domínio na CDN da OVH
...
- Possuir a solução [Content Delivery Network (CDN) da OVH](https://www.ovhcloud.com/pt/network/cdn/).
- Ter acesso à gestão da zona DNS do seu nome de domínio.
- Ter acesso à <ManagerLink to="/">Área de Cliente OVH</ManagerLink>.
...
Para isso, aceda à <ManagerLink to="/">Área de Cliente OVH</ManagerLink>, na janela <code className="action">Serviços Dedicados</code> selecione a opção <code className="action">NAS e CDN</code>.

A seguir, clique em <code className="action">Adicionar domínio à CDN</code>.
...
<img className="thumbnail" alt="Adicionar um subdomínio à CDN" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Adicionar um backend" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Nome da imagem" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png" loading="lazy" />
