...
Para criar uma conta OVHcloud, vá a <ManagerLink to="/">esta página</ManagerLink> e clique em <code className="action">Criar uma conta</code>.
...
**Dica: Use um gestor de palavras-passe**
