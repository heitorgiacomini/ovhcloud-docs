...
description: Como identificar um e-mail de phishing e o que fazer se clicar num link fraudulento?
...
Em primeiro lugar, verifique se o e-mail que recebeu também está visível na página <ManagerLink to="/#/communication">As minhas mensagens</ManagerLink>. Ali encontrará cópias dos e-mails oficiais enviados pela OVHcloud.
...
<img className="thumbnail" alt="Diferença entre e-mail OVHcloud e e-mail de phishing" src="/images/account-and-service-management/account-information/phishing-care/EN-legit-and-phishing-email.png" loading="lazy" />
...
<summary>**Lista de nomes de domínios OVHcloud legítimos** (clique para exibir)</summary>
...
<summary>**Dicas para verificar um link suspeito** (clique para exibir)</summary>
...
A OVHcloud **nunca** enviará um link por SMS. Os SMS que enviamos estão normalmente relacionados com a [autenticação de dois fatores na sua área de cliente](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
<img className="thumbnail" alt="Outlook Windows - identificar a versão" src="/images/account-and-service-management/account-information/phishing-care/outlook-windows-identify01.png" loading="lazy" />

**Outlook clássico:**

1. Selecione o e-mail de phishing na sua caixa de entrada (não o abra).
2. Clique em <code className="action">Ficheiro</code> na barra de menus e depois em <code className="action">Guardar como</code>.
3. No menu pendente "Tipo de ficheiro", selecione **Formato de mensagem do Outlook - Unicode (.msg)**.
4. Escolha uma localização no seu computador (por exemplo, o Ambiente de Trabalho) e clique em <code className="action">Guardar</code>.
...
2. Selecione <code className="action">Guardar como</code> e depois escolha <code className="action">Guardar como ficheiro EML</code>.
...
2. Selecione <code className="action">Guardar como</code>.
3. O e-mail será guardado como ficheiro `.eml`. Escolha uma localização no seu computador e clique em <code className="action">Guardar</code>.
...
2. Na barra de menus, clique em <code className="action">Ficheiro</code> > <code className="action">Guardar como</code>.
3. Escolha o formato **Código fonte da mensagem**, selecione uma localização no seu computador e clique em <code className="action">Guardar</code>.
...
3. Selecione <code className="action">Ver</code> > <code className="action">Ver origem da mensagem</code>.
...
1. Selecione o e-mail de phishing na sua caixa de entrada.
2. Clique em <code className="action">Mais</code> (ou no ícone **...**) na barra de ferramentas.
3. Selecione <code className="action">Transferir (.eml)</code>.
...
1. Selecione o e-mail de phishing na sua caixa de entrada.
2. Clique em <code className="action">Mais</code> na barra de ferramentas.
3. Selecione <code className="action">Ver original</code>. O conteúdo em bruto do e-mail será aberto num novo separador do navegador.
...
3. Selecione <code className="action">Transferir mensagem</code>.
...
<summary>**Se introduziu o número do seu cartão bancário num site fraudulento**</summary>
...
<summary>**Se introduziu a sua palavra-passe OVHcloud num site fraudulento**</summary>


Aceda à página <ManagerLink to="/#/account/useraccount/security">Segurança</ManagerLink> e altere imediatamente a sua palavra-passe.<br/>

Encontrará, no nosso guia "[Alterar a palavra-passe da sua conta](/guides/account-and-service-management/account-information/manage-ovh-password)", o método para alterar a sua palavra-passe a partir da sua área de cliente, bem como as nossas recomendações para gerar uma palavra-passe eficaz e armazená-la num gestor de palavras-passe.

Recomendamos fortemente que ative também a [autenticação de dois fatores](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) para proteger de forma duradoura a sua conta.
...
[Proteger a conta OVHcloud com a autenticação de dois fatores](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa)
