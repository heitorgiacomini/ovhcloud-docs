...
description: Saiba como definir ou alterar os contactos (gestores) dos serviços OVHcloud
...
:::info
OVHcloud disponibiliza um sistema de gestão de [política de acesso IAM](/guides/account-and-service-management/account-information/iam-policy-ui) que permite delegar acessos a outras contas de clientes.  
...
<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_scheme.png" loading="lazy" />
...
- O antigo e o novo contacto de faturação devem ter os pagamentos em dia.
...
- **Ligação direta:** <ManagerLink to="/#/account/contacts/services">Gestão dos contactos</ManagerLink>
- **Caminho de navegação:** Clique no seu nome no canto superior direito > <code className="action">Contactos</code>
...
Abra a página <ManagerLink to="/#/account/contacts/services">Gestão dos contactos</ManagerLink>.

<img className="thumbnail" alt="Gestão de contactos" src="/images/assets/screens/control-panel/product-selection/right-menu/my-contacts.png" loading="lazy" />
...
<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_02.png" loading="lazy" />

### Alterar contactos (gestores) de um serviço

Na página de gestão dos contactos, clique em <code className="action">...</code> à direita do serviço a alterar e, a seguir, em <code className="action">Modificar os contactos</code>. Faça as alterações desejadas e, a seguir, clique em <code className="action">Validar</code>.

<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_03.png" loading="lazy" />

<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_04.png" loading="lazy" />
...
Para gerir os pedidos em curso, clique no separador <code className="action">Os meus pedidos</code>. Aqui pode aceitar ou recusar um pedido.

<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_05.png" loading="lazy" />
...
Se um dos contactos não tiver recebido o e-mail, é possível que o endereço associado ao perfil não esteja atualizado. Como tal, o utilizador deverá verificar o endereço de e-mail indicado perfil. Se necessário, pode modificá-lo e solicitar o reenvio do e-mail. Para isso, basta clicar em <code className="action">Reenviar o pedido</code>.

<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_06.png" loading="lazy" />

Se apenas um dos contactos confirmar a alteração, será mostrada uma mensagem para informar que o pedido precisa de ser confirmado por outro utilizador. A confirmação dos utilizadores pode demorar alguns minutos até ser atualizada na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.

<img className="thumbnail" alt="Gestão de contactos" src="/images/account-and-service-management/account-information/managing-contacts/managing_contacts_007.png" loading="lazy" />
...
:::warning
Desaconselhamos que dê a qualquer terceiro as credenciais de acesso à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
Se o seu domínio não estiver associado ao seu alojamento e pretender confiar as operações necessárias ao webmaster, também deverá ter o direito de "[contacto técnico](#gestion_des_contacts)" na [zona DNS](/guides/web-cloud/domains/dns-zone-edit) do seu nome de domínio.

O direito "[contacto técnico](#gestion_des_contacts)" não permite modificar os contactos de administrador ou faturação de um serviço. Ele não dará ao seu webmaster os acessos às suas faturas ou encomendas, à renovação dos seus serviços ou aos seus métodos de pagamento. Também não lhe permitirá efetuar a [transferência da gestão do seu nome de domínio](/guides/web-cloud/domains/transfer-outgoing-domain) para outro alojador ou [mudar o seu titular](/guides/web-cloud/domains/trade-domain).
...
### Caso específico de um titular de domínio

Aquando da encomenda de um serviço OVHcloud, definiu um titular para este. Se não tiver acesso às contas OVHcloud associadas ao serviço que pretende recuperar, o titular poderá ceder a titularidade de um domínio a um terceiro, ou recuperar a administração do domínio, através dos seguintes procedimentos:

[Mudar o titular de um serviço](https://www.ovh.pt/cgi-bin/pt/procedure/procedureChangeOwner.cgi)

[Modificar os contactos administrativo, faturação e técnico do seu nome de domínio](https://www.ovh.pt/cgi-bin/pt/procedure/procedureChangeContacts.cgi)
