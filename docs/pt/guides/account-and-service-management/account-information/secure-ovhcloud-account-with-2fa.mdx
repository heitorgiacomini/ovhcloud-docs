...
Na página <ManagerLink to="/#/account/useraccount/security">Segurança da conta</ManagerLink>, clique em <code className="action">Ativar a dupla autenticação</code>.
...
Aceda à <ManagerLink to="/">página de autenticação da Área de Cliente OVHcloud</ManagerLink> e introduza o seu identificador (ou o seu endereço de e-mail principal) e a palavra-passe.
...
Para eliminar um periférico, aceda à página <ManagerLink to="/#/account/useraccount/security">Segurança da conta</ManagerLink> e clique nos <code className="action">...</code> à direita do seu periférico a eliminar e, em seguida, em <code className="action">Eliminar</code>.
...
Em primeiro lugar, aceda a <ManagerLink to="/">a página de autenticação na Área de Cliente OVHcloud</ManagerLink>.
