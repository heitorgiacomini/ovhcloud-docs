...
description: Aprenda a definir, alterar e gerir a palavra-passe da sua Área de Cliente OVHcloud
...
Para ficar a saber mais, consulte a secção [Quer saber mais?](/guides/account-and-service-management/account-information/manage-ovh-password#quer-saber-mais) na parte de baixo deste guia.
...
- Na página <ManagerLink to="/#/account/useraccount/security">Segurança da conta</ManagerLink>, clique em <code className="action">Alterar</code> à direita de "Palavra-passe".
...
- Surge então uma mensagem que lhe indica o êxito da operação. Clique no botão <code className="action">Continuar</code> na zona inferior desta mensagem para ser encaminhado para a página de identificação. Introduza então a sua ID de utilizador e a sua nova palavra-passe.

<a name="lost-password"></a>

#### Se não se lembrar da sua palavra-passe atual

- Clique em <code className="action">ID de utilizador ou palavra-passe esquecida?</code> ao aceder à janela de identificação da sua Área de Cliente OVHcloud.
...
- Introduza a sua ID de utilizador ou o endereço de e-mail principal associado à sua conta OVHcloud, e clique em <code className="action">Enviar</code>.
