...
To access our SAP pre-installation wizard, go to the `SAP Features Hub` section of the `Hosted Private Cloud` menu, available from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.

![sap-features-hub](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/sap-features-hub.png)
...
![sap-preinstallation-wizard](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/start-wizard.png)
...
![sap-preinstallation-wizard-step-1](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-1.png)
...
![sap-preinstallation-wizard-step-2](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-2.png)

### Step 3

Provide the SAP system identifiers (SIDs) and passwords that will be used during the installation.

![sap-preinstallation-wizard-step-3](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-3.png)
...
![sap-preinstallation-wizard-step-4](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-4.png)
...
![sap-preinstallation-wizard-step-5](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-5.png)
...
![sap-preinstallation-wizard-step-6-network-settings](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-6_1.png)

</Tab>
<Tab label="SAP HANA">

![sap-preinstallation-wizard-step-6-sap-hana](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-6_2.png)

</Tab>
<Tab label="SAP Application Servers">

![sap-preinstallation-wizard-step-6-sap-application](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-6_3.png)
...
![sap-preinstallation-wizard-step-7](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-7.png)
...
![sap-preinstallation-wizard-step-8](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/step-8.png)

After validating the information, you will be redirected to the pre-installation tracking page. You can also find the list of all your pre-installation tasks and their details in the `SAP Feature Hub` section in the `Hosted Private Cloud` menu, `List of pre-installations`.

![installation_report](/images/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-preinstallation-wizard/installation_report.png)
