---
title: Adicionar um endereço IP público a uma nova VM (EN)
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and add an Additional IP address to your [vRack](https://www.ovhcloud.com/pt/network/vrack/).
