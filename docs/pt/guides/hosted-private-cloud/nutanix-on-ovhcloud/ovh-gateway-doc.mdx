...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and open the management section of your [vRack](https://www.ovhcloud.com/pt/network/vrack/). Verify the Additional IP address used by the Nutanix Cluster.
