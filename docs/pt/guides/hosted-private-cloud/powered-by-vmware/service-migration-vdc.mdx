...
- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> (`VMware` in the `Hosted Private Cloud` section)
...
![decision tree](/images/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc/tree.png)
...
<a id="selectdatastores"></a>
#### Step 1.3 Select your datastores (storage) <a id="introduction"></a>
...
![add a Virtual Datacenter](/images/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc/add-vDC.gif)
...
<a id="preparevdcvmwarecontext"></a>
...
![NSX IP Migration](/images/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc/MoveIPNextHop.png)
...
2. Navigate to a `Host`.
3. Right click the `Host`.
4. Navigate to `Maintenance Mode`.
