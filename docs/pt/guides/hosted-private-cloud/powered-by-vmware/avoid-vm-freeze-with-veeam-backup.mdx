...
description: Saiba como implementar uma solução para evitar o bloqueio através do mecanismo VMware DRS
...
- Ativar a opção [Veeam Backup Managed](https://www.ovhcloud.com/pt/enterprise/products/hosted-private-cloud/veeam-backup-managed/).
...
Para implementar esta solução, clique no cluster apropriado, aceda ao separador <code className="action">Configure</code> e depois à secção <code className="action">VM/Host Rules</code>.
