...
description: Utilização e implementação do SDK vSphere
...
Aqui, iremos utilizar uma VM instalada em Debian 9, implementada através dos [templates disponibilizados no seu Hosted Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
Aqui, iremos utilizar uma VM instalada em Ubuntu 18.04, implementada através dos [templates disponibilizados no seu Hosted Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
Após ter lido as condições, aceite-as e continue clicando em <code className="action">Enter</code>.

Após a instalação, outros módulos serão instalados. Clique em <code className="action">Enter</code> para continuar a instalação.
