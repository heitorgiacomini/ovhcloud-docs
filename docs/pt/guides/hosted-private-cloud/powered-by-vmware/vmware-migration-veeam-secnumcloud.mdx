...
- For internet-facing services, request additional public IPs or use the [BYOIP feature](https://www.ovhcloud.com/pt/network/byoip/).
...
If you need higher performance and lower latency, you can optionally use [OVHcloud Connect](https://www.ovhcloud.com/pt/network/ovhcloud-connect/).
