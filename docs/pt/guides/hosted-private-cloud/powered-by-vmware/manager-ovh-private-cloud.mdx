...
- Estar ligado à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> e aceder à secção <code className="action">Hosted Private Cloud</code> e, depois, <code className="action">Private Cloud</code>.
...
Depois de aceder à secção  <code className="action">Hosted Private Cloud</code> e <code className="action">Private Cloud</code> da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, visualizará um panorama geral da sua Private Cloud:

<img className="thumbnail" alt="Informações gerais" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel1.png" loading="lazy" />
...
<img className="thumbnail" alt="Informações gerais" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel2.png" loading="lazy" />
...
<img className="thumbnail" alt="Opções" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel3.png" loading="lazy" />
...
<img className="thumbnail" alt="Opções" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel4.png" loading="lazy" />

Para mais informações sobre o cancelamento de um serviço Private Cloud, consulte [este guia](/guides/account-and-service-management/managing-billing-payments-and-services/cancel-private-cloud).
...
<img className="thumbnail" alt="Utilizadores" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel6.png" loading="lazy" />
...
<img className="thumbnail" alt="Permissões do utilizador por datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel7.png" loading="lazy" />
...
<img className="thumbnail" alt="Parâmetros de segurança" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel8.png" loading="lazy" />
...
Encontrará mais informações sobre essa opção [neste guia](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt).

#### Operações

Neste separador, encontrará as operações em curso na sua infraestrutura:

<img className="thumbnail" alt="Operações" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel9.png" loading="lazy" />
...
<img className="thumbnail" alt="Licença SPLA Windows" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel10.png" loading="lazy" />
...
<img className="thumbnail" alt="Panorama Datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel11.png" loading="lazy" />
...
Para mais informações acerca desta opção, consulte [este guia](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service).
