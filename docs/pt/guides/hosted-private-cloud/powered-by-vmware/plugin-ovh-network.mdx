...
description: Saiba como utilizar o plugin OVHcloud Network no serviço Hosted Private Cloud
...
<img className="thumbnail" alt="Informação sobre IP e blocos" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Botão Edit Reverse" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_03.png" loading="lazy" />
...
:::info
Este processo de configuração também é acessível na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. 
