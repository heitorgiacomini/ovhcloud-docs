...
- Um servidor Bare Metal no qual o Backup Agent está instalado. Consulte o nosso guia "[Como configurar a sua primeira cópia de segurança](/guides/storage-and-backup/backup-agent/first-configuration)" para mais informações.
...
Tem de transferir o agente a partir do seu <ManagerLink to="/">área de cliente OVHcloud</ManagerLink> e instalá-lo no seu novo sistema operativo.
