...
description: Descubra como funciona o sistema de Vault e a localização dos seus dados de backup
...
- Ter adquirido um serviço Backup Agent no momento da compra do seu servidor Bare Metal ou posteriormente através do menu <code className="action">Backup Agent</code> no seu espaço cliente.
...
Isto baseia-se nos nossos buckets Object Storage, que pode encontrar [aqui](https://www.ovhcloud.com/pt/public-cloud/object-storage/).

Para encontrar os seus Vaults, clique <ManagerLink to="/#/bmc-backup-agent-baremetal/service">neste link</ManagerLink> para aceder à secção <code className="action">Backup Agent</code> e, de seguida, clique no separador <code className="action">Vaults</code>.

<img className="thumbnail" alt="Lista de Vaults do Backup Agent" src="/images/storage-and-backup/backup-agent/backup-agent-vault/01-backup-agent-vault-list.png" loading="lazy" />
...
<img className="thumbnail" alt="Casos de utilização do Vault do Backup Agent" src="/images/storage-and-backup/backup-agent/backup-agent-vault/01-backup-agent-vault-use-cases.png" loading="lazy" />
