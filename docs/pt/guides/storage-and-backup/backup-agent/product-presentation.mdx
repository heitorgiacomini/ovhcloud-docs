...
description: Apresentação das funcionalidades e vantagens do produto Backup Agent
...
Descubra como navegar na VSPC através [deste guia](/guides/storage-and-backup/backup-agent/vspc-presentation).
...
- O armazenamento baseia-se na tecnologia [OVHcloud Object Storage](https://www.ovhcloud.com/pt/public-cloud/object-storage/) que está alojada nos datacenters da OVHcloud.
