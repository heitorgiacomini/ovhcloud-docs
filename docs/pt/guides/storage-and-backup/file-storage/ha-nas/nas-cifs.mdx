...
description: Configurar e montar um NAS-HA através do protocolo CIFS
...
- Uma oferta [NAS-HA](https://www.ovhcloud.com/pt/storage-solutions/nas-ha/).

## Instruções

### Configuração para Microsoft Windows

- **Windows Server 2008**: clique no menu <code className="action">Start</code> > <code className="action">All the programs</code> > <code className="action">Accessories</code> > <code className="action">Command prompt</code>.
- **Windows Server 2012**: clique no ícone <code className="action">Windows PowerShell</code> na barra de tarefas.
- **Windows Server 2016/2019/2022/2025**: clique no menu <code className="action">Start</code> e, a seguir, no ícone do <code className="action">Windows PowerShell</code>.
...
[NAS - Perguntas Frequentes](/guides/storage-and-backup/file-storage/ha-nas/nas-faq)
