...
Oui, cet espace est accessible depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, rubrique <code className="action">Bare Metal Cloud</code> puis <code className="action">NAS et CDN</code>.
...
Vous pouvez aussi, à tout moment, créer des snapshots manuels, les conserver sans limitation de durée ou les supprimer. Cette fonctionnalité est disponible au sein de votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> ou via l'appel [API](https://eu.api.ovh.com/) suivant :
