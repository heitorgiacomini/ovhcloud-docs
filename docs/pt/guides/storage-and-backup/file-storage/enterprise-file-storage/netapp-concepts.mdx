...
description: Descubra os princípios de funcionamento da oferta Enterprise File Storage
...
A conta OVHcloud é, por predefinição, o contacto administrador, técnico e de faturação do serviço. Encontre mais informações no nosso guia "[Gerir os contactos dos seus serviços](/guides/account-and-service-management/account-information/managing-contacts)".
...
Encontre mais informações no guia ["Gerir os seus volumes"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volumes).
...
Encontre mais informações no guia ["Gerir as ACL de um volume"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-acl).
...
Encontre mais informações no guia ["Gerir as snapshots de um volume"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-snapshots).
