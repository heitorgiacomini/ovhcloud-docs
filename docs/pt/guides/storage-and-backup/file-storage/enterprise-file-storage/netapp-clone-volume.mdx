...
:::info
Pode criar um volume e uma snapshot de tipo "manual" graças à [API OVHcloud](https://eu.api.ovh.com/) ou a partir do seu <ManagerLink to="/">espaço cliente OVHcloud</ManagerLink>.
