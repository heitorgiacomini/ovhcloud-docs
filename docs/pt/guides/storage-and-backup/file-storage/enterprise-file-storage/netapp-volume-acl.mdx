...
description: Saiba como gerir os ACL de um volume Enterprise File Storage através das API OVHcloud
...
Todas as rotas API utilizadas para este guia estão disponíveis na secção */armazenamento*: [https://api.ovh.com/console/#/storage](https://api.ovh.com/console/#/storage).
