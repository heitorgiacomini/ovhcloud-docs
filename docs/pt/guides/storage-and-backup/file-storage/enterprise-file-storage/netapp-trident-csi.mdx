...
description: Implemente o NetApp Trident CSI no OVHcloud Enterprise File Storage para gerir volumes e snapshots no Kubernetes
...
- Um serviço [Enterprise File Storage](https://www.ovhcloud.com/pt/storage-solutions/enterprise-file-storage/) na sua conta OVHcloud
- Um cluster [OVHcloud Managed Kubernetes](https://www.ovhcloud.com/pt/public-cloud/kubernetes/)
- Um [vRack](https://www.ovhcloud.com/pt/network/vrack/) com [vRack Services](/guides/network/vrack-services/global) configurado
- Conhecimento das [API OVHcloud](/guides/manage-and-operate/api/first-steps) e/ou da [CLI OVHcloud](/guides/manage-and-operate/cli/getting-started)
...
<img className="thumbnail" alt="Esquema dos pré-requisitos Trident" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/trident_efs_requirements.excalidraw.png" loading="lazy" />
...
[Enterprise File Storage - Configuração da rede privada](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-network-config)

[Enterprise File Storage - Ligar uma instância Public Cloud a um volume EFS através da rede privada vRack](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-pci-connection-via-vrack)

[Gestão de contas de serviço OVHcloud através da API](/guides/manage-and-operate/api/manage-service-account)
