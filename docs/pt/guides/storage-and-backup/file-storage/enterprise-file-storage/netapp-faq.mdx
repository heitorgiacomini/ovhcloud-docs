...
description: FAQ sobre a solução Entreprise File Storage
...
Sim, este serviço está diretamente acessível a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, na secção <code className="action">Bare Metal Cloud</code> e depois <code className="action">Armazenamento e Backup</code>.
