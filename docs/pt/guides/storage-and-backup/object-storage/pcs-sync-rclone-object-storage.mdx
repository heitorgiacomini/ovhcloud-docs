...
description: This guide explains how to sync object storage via your OVHcloud Control Panel
...
- You need to have created an *Object Storage* container (you can create one from the Control Panel or from [Horizon](/guides/storage-and-backup/object-storage/pcs-create-container))
...
To do this, when you are on the OpenStack users page in your Control Panel, click on <code className="action">...</code> to the right of the user and then <code className="action">Download an Rclone configuration file</code>.
