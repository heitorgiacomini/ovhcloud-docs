...
description: Saiba como aceder aos seus arquivos Public Cloud com Rsync
...
Para poder gerar o seu identificador e a sua palavra-passe OpenStack, utilize este [guia](/guides/public-cloud/cross-functional/create-and-delete-a-user).

### TenantName

O TenantName corresponde ao nome do seu projeto Horizon. Para obter o TenantName, deve ligar-se à interface web OpenStack: [https://horizon.cloud.ovh.net/](https://horizon.cloud.ovh.net/).
