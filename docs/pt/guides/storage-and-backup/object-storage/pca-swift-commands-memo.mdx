...
description: Find here the main swift commands to manage your Public Cloud Archive object containers
...
See the [Curl command memo](/guides/storage-and-backup/object-storage/pca-curl-commands-memo) documentation for the manifest upload.
:::
