...
description: This guide explains how to encrypt your server-side objects with SSE-C or SSE-OMK
...
- **[Enabling Virtual Machine Encryption (VM Encrypt) - OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt)**: practical guide on enabling VM encryption using KMS capabilities.
- **[Enabling virtual machine encryption with vSphere Native Key Provider - OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt-vnkp)**: detailed instructions on using KMS in conjunction with the vSphere Native Key Provider for VM encryption.
...
:::info
**Note:** If you want to enable SSE-OMK encryption at bucket creation, see our [Object Storage - Getting started with Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) guide.
...
<Tabs>
  ...
  <Tab label="Via the OVHcloud Control Panel">
    Click on <code className="action">Object Storage</code> under `Storage & Backup` in the left-hand menu.  Select the Object Storage bucket you want to manage, and in the information panel, click on <code className="action">Enable encryption</code>.
...
Click on the <code className="action">Enable</code> button.
