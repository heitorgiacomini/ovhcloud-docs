...
description: Saiba como associar um domínio a um container.
...
- Consulte o guia [Criação de container de armazenamento](/guides/storage-and-backup/object-storage/pcs-create-container)
- Um domínio
