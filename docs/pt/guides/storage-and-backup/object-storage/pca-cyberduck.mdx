...
description: Saiba como configurar o Cyberduck para gerir o seu Public Cloud Archive
...
- Ter os dados de utilizador (*OS_USERNAME*) e os projetos (*OS_PROJECT_NAME* ou *OS_TENANT_NAME*) disponíveis para o descarregar o ficheiro "OpenRC" no menu [Users and Roles](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#etapa-1-recuperar-as-variaveis) da sua <ManagerLink to="/">Área de Cliente Public Cloud da OVHcloud</ManagerLink>.
- Ter a palavra-passe de utilizador OpenStack.

Se já não conhece a sua palavra-passe de utilizador OpenStack, pode alterá-la através [deste manual](/guides/public-cloud/cross-functional/create-and-delete-a-user).
...
A seguir, clique em <code className="action">Connecter</code>. Uma vez ligado, terá acesso à arborescência das suas pastas e ficheiros.
