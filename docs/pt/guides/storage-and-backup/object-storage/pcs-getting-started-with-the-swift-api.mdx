...
description: Os primeiros passos com a API swift
...
Este URL é composto por um ponto de terminação, disponível a partir da [interface Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security), do nome do seu container e do nome do seu objeto (incluindo o prefixo).
