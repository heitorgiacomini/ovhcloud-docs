...
description: Testar a velocidade dos discos
...
Para testar a velocidade de um disco adicional, deve montá-lo. Para mais informações, consulte este [manual](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance#em-windows)
