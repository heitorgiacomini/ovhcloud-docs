...
- Dispor de uma [instância Public Cloud da OVHcloud](/guides/public-cloud/compute/getting-started#configuration) do tipo *flex*.
- [Criar um acesso à interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon).
