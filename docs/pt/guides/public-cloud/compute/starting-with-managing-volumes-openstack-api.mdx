...
- [Preparar o ambiente para utilizar a API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) instalando pithon-cinderclient e python-novaclient
...
:::info
Também pode consultar a documentação do cliente Openstack diretamente [no site OpenStack](https://docs.openstack.org/python-openstackclient/latest/).
:::
