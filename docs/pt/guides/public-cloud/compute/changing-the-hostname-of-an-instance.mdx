...
description: Saiba como modificar o hostname de uma instância Public Cloud
...
- Ter criado uma [instância Public Cloud](/guides/public-cloud/compute/getting-started).
- [Estar ligado através do protocolo SSH](/guides/public-cloud/compute/getting-started) (sudo) à instância.
