...
description: Saiba como implementar aplicações pré-instaladas nas suas instâncias Public Cloud
...
- Uma [instância Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) na sua conta OVHcloud.
...
Utilizando a <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> / API ou a API do OpenStack Horizon, instale a aplicação que escolheu na sua instância Public Cloud.
...
1. Ligue-se à [consola API](https://eu.api.ovh.com/)
...
> Chamada API
<Api version="v1" section="/cloud" method="POST" route={"/cloud/project/\{serviceName\}/instance/\{instanceId\}/applicationAccess"} />>> >
>
> Parâmetros
>
>> serviceName *
...
Se o seu domínio estiver registado na OVHcloud, pode seguir [este guia](/guides/web-cloud/domains/dns-zone-edit).
...
<ol start="2">
  <li>Talvez tenha de esperar 24 horas até que os dois registos se propaguem completamente. Pode sempre verificá-lo com <a href="https://mxtoolbox.com/DnsLookup.aspx">mxtoolbox</a></li>
...
<summary>Porquê definir a password root?</summary>
...
<summary>Onde está a minha licença para o cPanel?</summary>
...
<summary>Onde está a minha licença Plesk?</summary>
