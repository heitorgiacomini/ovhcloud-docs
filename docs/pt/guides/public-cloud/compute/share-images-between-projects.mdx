...
Pode ser necessário partilhar uma imagem [Instance backup](/guides/public-cloud/compute/save-an-instance) ou uma imagem [Volume backup](/guides/public-cloud/compute/volume-backup) entre vários projetos Public Cloud.
...
- [Preparar o ambiente para a utilização da API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
