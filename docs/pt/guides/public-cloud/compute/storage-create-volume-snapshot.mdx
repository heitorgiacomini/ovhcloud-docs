...
- Um volume [Block Storage](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance) criado no seu projeto [Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
