...
- Se pretender preparar o ambiente para utilizar o [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform), deverá preparar o ambiente.
...
- Preparar o ambiente se deseja utilizar [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform).
...
Abra uma [ligação SSH à sua instância](/guides/public-cloud/compute/getting-started#connect-instance) e utilize o comando abaixo para listar os discos ligados.
...
<Tabs>
  <Tab label="Em Linux">
    Abra uma [ligação SSH à sua instância](/guides/public-cloud/compute/getting-started#etapa-3-criacao-de-uma-instancia) e utilize o comando abaixo para listar os discos ligados.
