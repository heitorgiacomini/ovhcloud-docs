...
description: Descubra como ativar uma licença Windows numa instância em modo privado
...
- [Ter criado um utilizador OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)

Recomendamos que consulte o guia "[Aceder à interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon)" para se familiarizar com o Horizon.
...
Ligue-se à interface [Horizon](https://horizon.cloud.ovh.net/auth/login/) de acordo com o método indicado na [primeira parte deste guia](/guides/public-cloud/network-services/vrack#interface-horizon).

Ligue-se bem à sua zona de trabalho:

<img className="thumbnail" alt="região" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon1.png" loading="lazy" />

Selecione <code className="action">Compute</code> e, a seguir, <code className="action">Instances</code>:

<img className="thumbnail" alt="computação e instância" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon2.png" loading="lazy" />

Para adicionar uma interface, na coluna "Actions", clique na seta que permite aceder às ações possíveis na instância. A seguir, clique em <code className="action">Attach Interface</code>:

<img className="thumbnail" alt="adicionar interface" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon3.png" loading="lazy" />

Selecione a sua interface e valide:

<img className="thumbnail" alt="interface select" src="/images/public-cloud/compute/activate-windows-license-private-mode/attachinterfacehorizon.png" loading="lazy" />
...
Depois de aceder à instância Windows, clique no menu <code className="action">Iniciar</code> e, a seguir, no ícone do <code className="action">Windows PowerShell</code>.
...
<img className="thumbnail" alt="ativação da chave windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="ativação da chave windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />

## Quer saber mais?

[Saiba como alterar a chave de produto do Windows Server](/guides/bare-metal-cloud/dedicated-servers/windows-key).
