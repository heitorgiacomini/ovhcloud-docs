...
- Attach Interface: esta opção permite adicionar uma ou várias interfaces privadas à sua instância através da VLAN. Para mais informações, consulte [esta parte](/guides/public-cloud/network-services/vrack#adding-a-private-interface) do guia correspondente.
- Detach Interface: esta opção é utilizada para separar uma interface associada a uma instância. Para mais informações, consulte [esta parte](/guides/public-cloud/network-services/vrack#removing-a-private-interface) do guia correspondente.
