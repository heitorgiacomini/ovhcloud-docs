...
- Ter criado uma instância Public Cloud a partir da [Área de Cliente OVHcloud](/guides/public-cloud/compute/getting-started) ou através da [interface Horizon](/guides/public-cloud/compute/create-instance-in-horizon).
- [Ter criado uma chave SSH](/guides/public-cloud/compute/creating-ssh-keys).
...
- Attach Interface: esta opção permite adicionar uma ou várias interfaces privadas à sua instância através da VLAN. Para mais informações, consulte [esta parte](/guides/public-cloud/network-services/vrack#adicao-de-uma-interface-privada) do guia correspondente.
- Detach Interface: esta opção é utilizada para separar uma interface associada a uma instância. Para mais informações, consulte [esta parte](/guides/public-cloud/network-services/vrack#eliminacao-de-uma-interface-privada) do guia correspondente.
...
Para mais informações, consulte [este guia](/guides/public-cloud/compute/getting-started#user-mgmt).
