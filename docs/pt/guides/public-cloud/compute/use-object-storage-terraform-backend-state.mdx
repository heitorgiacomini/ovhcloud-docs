...
description: Find out how to use an OVHcloud Object Storage as a Terraform Backend to store your Terraform state
...
- You should have installed Terraform CLI, version 0.12.x minimum, on your machine. You can install it by following the [detailed installation instructions](https://www.terraform.io/docs/cli/index.html) or with the tool [tfenv](https://github.com/tfutils/tfenv).
...
<img className="thumbnail" alt="Terraform" src="/images/public-cloud/compute/use-object-storage-terraform-backend-state/terraform.png" loading="lazy" />
...
<img className="thumbnail" alt="Terraform state schema" src="/images/public-cloud/compute/use-object-storage-terraform-backend-state/schema.png" loading="lazy" />
...
First, you need to have an Object Storage container. If you don't already have one, you can follow the [Getting started with Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) tutorial.
...
<img className="thumbnail" alt="terraform state container in OVHcloud Object Storage" src="/images/public-cloud/compute/use-object-storage-terraform-backend-state/object_storage.png" loading="lazy" />
