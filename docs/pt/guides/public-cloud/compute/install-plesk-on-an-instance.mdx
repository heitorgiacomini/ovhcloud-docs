...
- [Ter criado uma instância a partir da Área de Cliente OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
- [Dispor de um acesso de administrador](/guides/public-cloud/compute/getting-started#connect-instance).
