...
description: Saiba como atualizar um sistema operativo em fim de vida
...
Assim, antes de seguir este tutorial, a OVHcloud recomenda-lhe vivamente que [guarde a sua instância](/guides/public-cloud/compute/save-an-instance) e que efetue testes aprofundados das suas aplicações, de forma a garantir que estas funcionem na nova versão do sistema operativo.
:::
...
- Dispor de um [acesso de administrador ao servidor](/guides/public-cloud/compute/getting-started#connect-instance)
- Ter efetuado [um backup da sua instância](/guides/public-cloud/compute/save-an-instance)
...
Verifique que as suas aplicações funcionam como previsto. Em caso de problema, recomendamos que [restaure o backup](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) efetuado antes da atualização.
...
:::info
Se encontrar dificuldades, encontrará respostas às suas questões no website [Fedora Docs](https://docs.fedoraproject.org/en-US/quick-docs/dnf-system-upgrade/).
:::
