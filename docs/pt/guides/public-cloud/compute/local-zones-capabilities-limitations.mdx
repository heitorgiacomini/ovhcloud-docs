...
description: Descubra as funcionalidades, capacidades e limites atuais das instâncias Local Zones
lastUpdated: 2026-01-16
---

## Objetivo

As instâncias Local Zones são uma extensão das [regiões](https://www.ovhcloud.com/pt/public-cloud/regions-availability/) que aproximam os serviços da OVHcloud de locais específicos, oferecendo uma latência reduzida e performances melhoradas para as aplicações.
