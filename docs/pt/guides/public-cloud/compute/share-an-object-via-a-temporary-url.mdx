...
description: Saiba como partilhar um objeto sem fornecer dados pessoais
...
- [Ter preparado o ambiente para usar a API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
