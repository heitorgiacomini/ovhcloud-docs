...
- Dispor de um [projeto Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) na sua conta OVHcloud.
- [Ter acesso à interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon). 
...
Para começar, aceda à interface Horizon. Se precisar de ajuda para realizar esta operação, consulte o [nosso manual](/guides/public-cloud/cross-functional/introducing-horizon).
...
Para mais informações sobre a criação de uma chave SSH, consulte [este manual](/guides/public-cloud/compute/getting-started#create-ssh).


<Tabs>
  <Tab label="+ Create Key Pair">
    Para criar um par de chaves, clique no botão <code className="action">+ Create Key Pair</code>. Tenha em conta que, com esta opção, devem ser tomadas etapas adicionais antes de se poder ligar à instância, sobretudo se utilizar o software PuTTY para se ligar à sua instância. Consulte [esta secção](/guides/public-cloud/compute/getting-started#connect-instance) no respetivo guia.
