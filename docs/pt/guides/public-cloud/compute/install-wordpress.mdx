...
description: Saiba como utilizar uma instância Public Cloud para alojar websites WordPress
...
- Ter uma [instância Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) com Debian ou Ubuntu instalado.
...
Abra um navegador Web e ligue-se ao site WordPress introduzindo o endereço IP da sua instância (ou o nome de domínio se já tiver [ligado um à instância](/guides/web-cloud/domains/dns-zone-edit)). Escolha uma língua na primeira página.
