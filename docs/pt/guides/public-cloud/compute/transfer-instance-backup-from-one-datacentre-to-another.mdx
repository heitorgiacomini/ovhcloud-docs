...
Poderá ser necessário mover a sua [instância Public Cloud](https://www.ovhcloud.com/pt/public-cloud/compute/) de uma região OpenStack para outra. Ou porque prefere migrar para uma nova região OpenStack disponível ou porque pretende migrar do OVHcloud Labs para o Public Cloud.
...
- CLI OpenStack. Consulte o nosso guia « [Como preparar o ambiente para utilizar a API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) ».
...
:::info
Se precisar criar um backup com OpenStack, consulte esta guia dedicada sobre como [fazer backup de uma instância.](/guides/public-cloud/compute/save-an-instance).
:::
...
:::warning
Se a instância utilizar uma imagem do Windows, deverá adicionar propriedades específicas. Caso contrário, quando criar a instância através da Área de Cliente OVHcloud, não será possível associar um "flavor" de tipo win-x-x. Este tipo de flavor, e apenas este, permite a autenticação junto do [KMS OVHcloud](/guides/manage-and-operate/kms/quick-start).
:::
...
:::info
Se desejar recriar a sua instância a partir deste backup, siga o nosso guia "[Utilizar cópias de segurança de instâncias para criar ou restaurar uma instância](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup)".
:::
