...
description: Descubra como fazer evoluir os recursos da sua instância para fazer face a uma atividade acrescida
...
- Um [utilizador OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- Ter um [ambiente OpenStack preparado para CLI](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
- Ter definido as [variáveis de ambiente do OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
...
Aquando de um redimensionamento, a instância é interrompida durante toda a duração da operação. Por isso, antes de realizar esta operação, recomendamos que guarde a sua instância e interrompa todos os processos em execução. Encontre mais informações sobre os métodos de backup no [guia dedicado](/guides/public-cloud/compute/save-an-instance).
...
[Redimensionar uma instância Public Cloud através da Área de Cliente OVHcloud](/guides/public-cloud/compute/resize-instance-manager)
