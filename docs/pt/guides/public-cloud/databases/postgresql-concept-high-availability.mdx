...
description: Learn the concepts of high-availability for PostgreSQL offers
...
<img className="thumbnail" alt="Public Cloud Databases for PostgreSQL cluster" src="/images/public-cloud/databases/postgresql-09-concept-high-availability/postgresql-cluster.png" loading="lazy" />
...
You can find more information on their official page : [https://github.com/aiven/pghoard](https://github.com/aiven/pghoard).
