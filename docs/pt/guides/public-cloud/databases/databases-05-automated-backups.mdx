...
description: Discover the automated backup methods for each engine
...
<Api version="v1" section="/cloud" method="POST" route={"/cloud/project/\{serviceName\}/database/\{engine\}/"} />
