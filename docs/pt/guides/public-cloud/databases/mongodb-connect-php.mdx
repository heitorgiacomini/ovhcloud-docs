...
description: Connect to your Public Cloud Databases for MongoDB using the PHP programming language
...
<img className="thumbnail" alt="PHP Drivers" src="/images/public-cloud/databases/mongodb-04-connect-php/php_mongodb_driver.png" loading="lazy" />
...
As shown in the code, we use the **MongoDB\Driver\Manager**. Use the official PHP documentation for exhaustive documentation : [https://www.php.net/manual/en/set.mongodb.php](https://www.php.net/manual/en/set.mongodb.php).
