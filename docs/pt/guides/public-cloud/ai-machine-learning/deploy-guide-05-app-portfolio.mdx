...
description: A collection of AI apps that can be easily deployed with AI Deploy
...
:::info
You will find all the **codes** and **documentation** needed to deploy each app [here](/guides/public-cloud/ai-machine-learning/overview).
:::
