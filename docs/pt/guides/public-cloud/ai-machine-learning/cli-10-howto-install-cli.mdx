...
description: Learn how to install the CLI to interact with AI Tools
...
-   **AI Training activated** for your account, see [how to submit a job Step 2](/guides/public-cloud/ai-machine-learning/ai-training-submit-job)
-   a user for AI Tools, see [how to create a user](/guides/public-cloud/ai-machine-learning/ai-users)
...
The documentation of the CLI is available at [CLI documentation](/guides/public-cloud/ai-machine-learning/ai-cli-overview).
