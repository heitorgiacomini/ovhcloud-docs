---
title: AI Deploy - Tutorial - Create an application to play rock paper scissors with YoloV8 (EN)
description: How to build an application based on the computer vision with YoloV8
...
- You have created a [user for AI Deploy](/guides/public-cloud/ai-machine-learning/ai-users).
...
:::warning
**Warning**
The shared registry of AI Deploy should only be used for testing purpose. Please consider attaching your own Docker registry. More information about this can be found [here](/guides/public-cloud/ai-machine-learning/ai-manage-registries). The images pushed to this registry are for AI Tools workloads only, and will not be accessible for external uses.
:::
