...
description: Tutorial about how to debug your jobs
...
-   The [OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installed

## Instructions

### What is an AI Training job and how to run one?

All steps for starting and working on AI Training are described in the [AI Training - Getting Started](/guides/public-cloud/ai-machine-learning/ai-training-submit-job) guide.
...
A lot of options and sub-commands are available in the ovhai CLI tool. This is the recommended means of interaction with AI Solutions. To install it, follow the [CLI Installation guide](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
For more information about AI Training billing and pricing examples, please check the [AI Training - Billing and lifecycle](/guides/public-cloud/ai-machine-learning/ai-training-billing-lifecycle) guide.
