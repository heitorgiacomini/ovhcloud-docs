...
description: How to integrate conversational memory into your chatbot using AI Endpoints and LangChain’s memory modules
...
<img className="thumbnail" alt="Comparaison between chatbot with and without memory" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-09-chatbot-memory-langchain/chatbot-with-without-memory-langchain.png" loading="lazy" />
...
If you would like to find out more, take a look at the following article on [memory chatbot with LangChain4j](/guides/public-cloud/ai-machine-learning/ai-endpoints-memory-chatbot-langchain4j).
