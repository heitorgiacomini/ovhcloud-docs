...
description: Understand how to create  and train a chatbot with AI Notebooks
...
- A [user for AI Notebooks](/guides/public-cloud/ai-machine-learning/ai-users)
...
Here is the reference to install the CLI: [CLI Installation](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).

The token is now created. Don't forget to save the token to use it later.

Now, if you already have trained some Rasa models with AI Training by following [our tutorial](/guides/public-cloud/ai-machine-learning/ai-training-train-rasa-chatbot), you already have created a container with your trained models. You can skip the next part and go directly [here](#visualstudiocode).
...
<img className="thumbnail" alt="image" src="/images/public-cloud/ai-machine-learning/notebook-tuto-10-create-chatbot/conversation.png" loading="lazy" />
...
[How to train a chatbot with docker and AI Training](/guides/public-cloud/ai-machine-learning/ai-training-train-rasa-chatbot)
