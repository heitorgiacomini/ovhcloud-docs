...
description: Find out how to manage traffic with Istio on OVHcloud Managed Kubernetes
...
<img className="thumbnail" alt="Bookinfo architecture" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/bookinfo-architecture.png" loading="lazy" />
...
<img className="thumbnail" alt="A/B Testing - At every refresh you will see that stars change alternatively between back (`v2`) and red (`v3`)" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/ab-testing-001.png" loading="lazy" />
...
<img className="thumbnail" alt="Canary Release v1 to v2 progressing release" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/canary-schema.png" loading="lazy" />
...
<img className="thumbnail" alt="Canary Testing - all traffic to v1" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/canary-testing-001.png" loading="lazy" />
...
<img className="thumbnail" alt="Canary Testing - one tenth of times we get v2" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/canary-testing-002.png" loading="lazy" />
...
<img className="thumbnail" alt="Rolling Deployment" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/rolling-deployment-001.png" loading="lazy" />
...
<img className="thumbnail" alt="Rolling deployment - At this moment traffic will be equally split between the two releases of `reviews`" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/rolling-deployment-002.png" loading="lazy" />
...
<img className="thumbnail" alt="Rolling deployment - And now the `v2` of `reviews` receives all the traffic" src="/images/public-cloud/containers-orchestration/managed-kubernetes/traffic-management-with-istio/rolling-deployment-003.png" loading="lazy" />
