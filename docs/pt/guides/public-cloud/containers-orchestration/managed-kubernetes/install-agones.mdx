...
description: Find out how to install Agones on OVHcloud Managed Kubernetes
...
<img className="thumbnail" alt="Agones on OVHcloud Managed Kubernetes" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-001-small.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Online gaming matchmaking and game server assignation" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-002-small.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Online gaming matchmaking and game server assignation with Agones" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-003-small.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Multiplayer menu" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-005.png" loading="lazy" />

And you are ready to play!

<img className="thumbnail" alt="Let's frag" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-agones/agones-006.png" loading="lazy" />
