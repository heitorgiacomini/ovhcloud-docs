...
description: Learn how to deploy Kubernetes operator on OVHcloud Managed Kubernetes with Helm and the Operator SDK
...
![Operator diagram](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-helm-operator/operator.png)
...
![Hello world from Nginx](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-helm-operator/hello-world.png)
