...
description: Find out how to collect metrics from VPS, Public Cloud instances or baremetal servers with Prometheus on an OVHcloud Managed Kubernetes Service
...
<img className="thumbnail" alt="Prometheus static target" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/prom_targets_static.png" loading="lazy" />
...
<img className="thumbnail" alt="Add user description" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/add_user_1.png" loading="lazy" />

<img className="thumbnail" alt="Add user role" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/add_user_2.png" loading="lazy" />
...
Retrieve your OpenStack user info from the command-line tool (refer to the [Setting OpenStack environment variables](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables) guide) for the region you want to scrape.

This example uses the GRA11 region.

<img className="thumbnail" alt="Download OpenStack configuration file" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/download_openrc.png" loading="lazy" />
...
<img className="thumbnail" alt="Prometheus OpenStack targets" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/prom_targets_openstack.png" loading="lazy" />
...
<img className="thumbnail" alt="Create script credentials" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/ovh_creds.png" loading="lazy" />
...
<img className="thumbnail" alt="Prometheus OVHcloud targets" src="/images/public-cloud/containers-orchestration/managed-kubernetes/monitoring-pci-instances-prometheus/prom_targets_ovhcloud.png" loading="lazy" />
