...
description: Find out how to secure your OVHcloud Managed Kubernetes and deploy Kyverno for policy management
...
![Kyverno, the cop in a Kubernetes cluster](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-kyverno/kyverno-cop.png)
