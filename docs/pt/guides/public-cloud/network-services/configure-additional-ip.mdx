...
:::info
Este artigo diz respeito à configuração de endereços Additional IPv4 numa interface pública. Também pode configurar endereços IPv6 nas suas instâncias Public Cloud utilizando [este manual](/guides/public-cloud/network-services/ipv6-configuration).
...
- [Configurar um bloco IP num vRack numa instância Public Cloud (EN)](/guides/public-cloud/network-services/configure-ip-block-vrack-instance).
- [Configurar um bloco IPv6 num vRack (EN)](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack).
...
<Tabs>
  ...
  <Tab label="Plesk">
    ...
    **Etapa 1: aceder à gestão de IP do Plesk**
    ...
    <img className="thumbnail" alt="acesso à gestão dos endereços IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip1.png" loading="lazy" />
...
Clique em <code className="action">IP Addresses</code> sob **Tools & Resources**.
    ...
    **Etapa 2: adicionar informações IP suplementares**
    ...
    <img className="thumbnail" alt="adicionar informações IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip2-2.png" loading="lazy" />
...
Introduza o seu endereço Additional IP sob a forma `xxx.xxx.xxx.xxx/32` no campo "IP address and subnet mask", e clique em <code className="action">OK</code>.
    ...
    <img className="thumbnail" alt="adicionar informações IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip3-3.png" loading="lazy" />
...
**Etapa 3: verificar a configuração IP atual**
    ...
    <img className="thumbnail" alt="configuração IP atual" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip4-4.png" loading="lazy" />
  </Tab>
...
Para obter a configuração IP atual, introduza `ipconfig` no prompt de comandos.
    ...
    <img className="thumbnail" alt="verificar a configuração IP principal" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image1-1.png" loading="lazy" />
...
**Etapa 2: modificar as propriedades IPv4**
    ...
    <img className="thumbnail" alt="alterar a configuração IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image2.png" loading="lazy" />
...
Na janela Propriedades IPv4, selecione <code className="action">Utilizar o seguinte endereço IP</code>. Introduza o endereço IP que recuperou na primeira etapa e clique em <code className="action">Avançado</code>.
    ...
    **Etapa 3: adicionar o endereço Additional IP nos Parâmetros TCP/IP avançados**
    ...
    <img className="thumbnail" alt="secção de configuração avançada" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image4-4.png" loading="lazy" />

Confirme ao clicar em <code className="action">Adicionar</code>.
    
    <img className="thumbnail" alt="Configuração da migração IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image5-5.png" loading="lazy" />
...
**Etapa 4: reiniciar a interface de rede**
    ...
    <img className="thumbnail" alt="desativação da rede" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image6.png" loading="lazy" />

Para a reiniciar, clique com o botão direito e selecione a opção <code className="action">Ativar</code>.
    
    <img className="thumbnail" alt="ativação da rede" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image7.png" loading="lazy" />
...
**Etapa 5: verificar a nova configuração de rede**
    ...
    <img className="thumbnail" alt="verificar a configuração de rede atual" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image8-8.png" loading="lazy" />
  </Tab>
</Tabs>
...
Em primeiro lugar, reinicie a sua instância com a ajuda do sistema operativo da instância ou da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Se ainda não consegue estabelecer uma ligação entre a rede pública e o seu Additional IP e suspeitar de um problema de rede, deve reiniciar a instância em [modo rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode). De seguida, pode configurar o endereço Additional IP diretamente na instância.
...
Para testar a ligação, basta enviar um ping ao seu endereço Additional IP a partir do exterior. Se ele responder em modo de rescue, isso provavelmente significa que existe um erro de configuração. No entanto, se o IP ainda não funcionar, queira informar as nossas equipas de suporte criando um ticket de assistência a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.

## Quer saber mais?

[Importar um Additional IP](/guides/public-cloud/network-services/import-additional-ip)

[Migrar um Additional IP](/guides/public-cloud/network-services/migrate-additional-ip)
