...
description: Saiba como ativar e gerir um serviço vRack Public Cloud com a ajuda do OpenStack CLI
lastUpdated: 2025-01-13
---

## Objetivo

O [vRack](https://www.ovhcloud.com/pt/network/vrack/) é uma rede privada que lhe permite configurar o direcionamento entre vários servidores dedicados OVHcloud. Mas permite-lhe também adicionar [instâncias Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) à sua rede privada a fim de criar uma infraestrutura de recursos físicos e virtuais.

**Este guia tem como objetivo acompanhá-lo na configuração das suas instâncias Public Cloud graças ao OpenStack CLI**

## Requisitos

- Dispor de um [projeto Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- Ter acesso à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>
- Um [utilizador OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) (opcional)
...
:::info
Isto não se aplica aos projetos recém-criados que são agora entregues automaticamente com um vRack. Para visualizar o vRack após a criação do projeto, aceda ao menu <code className="action">Network</code> no separador à esquerda. Clique em <code className="action">Rede privada vRack</code> para consultar o(s) vRack(s).
...
No menu à esquerda do ecrã, clique no botão <code className="action">Adicionar um serviço</code> (ícone do carrinho de compras). Utilize o filtro no topo da página ou desloque-se para baixo para encontrar o serviço <code className="action">vRack</code>.
...
Depois de ativado, o serviço será apresentado na Área de Cliente, na secção <code className="action">Network</code> > <code className="action">Rede Privada vRack</code>. Sob a designação « pn-xxxxx ».

Na lista dos serviços elegíveis, selecione o projeto que deseja adicionar ao vRack e clique no botão <code className="action">Adicionar</code>.

<img className="thumbnail" alt="Adicionar o projeto" src="/images/public-cloud/network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### A partir das APIv6 OVHcloud

Para ativar e gerir um vRack a partir das APIv6 OVHcloud, clique [aqui](/guides/public-cloud/network-services/vrack-apiv6#step-1-activating-and-managing-a-vrack) (EN), para consultar o guia específico deste método.
...
Tenha em atenção as seguintes informações, como indicado no [guia de utilização da API Nova](/guides/public-cloud/compute/starting-with-nova):
...
[Configuração do vRack Public Cloud a partir das APIv6 OVHcloud](/guides/public-cloud/network-services/vrack-apiv6) (EN).

[Servidores dedicados - Criar várias VLAN no vRack](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack).
