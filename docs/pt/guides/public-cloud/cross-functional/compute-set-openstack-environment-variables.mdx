...
- Ter criado um utilizador OpenStack. Consulte [o respetivo guia](/guides/public-cloud/cross-functional/create-and-delete-a-user).
- Ter preparado o ambiente para usar o OpenStack. Para isso, consulte o seguinte guia: [Preparar o ambiente para utilizar a API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
...
No menu à esquerda, na rubrica **Parâmetros**, clique em <code className="action">Utilizadores & Funções</code>. A seguir, clique nas <code className="action">...</code> do lado direito do seu utilizador, e selecione <code className="action">Transferir o ficheiro RC do OpenStack</code>.
...
Como indicado em [este guia](/guides/public-cloud/cross-functional/create-and-delete-a-user), a palavra-passe só é visível uma vez, no momento da sua criação.
