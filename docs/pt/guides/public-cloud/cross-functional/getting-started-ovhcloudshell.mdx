...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and click on the OVHcloud `Shell button` to launch the terminal.

![Cloudshell button](/images/guides/public-cloud/cross-functional/getting-started-ovhcloudshell/OVHcloud_Shell.png)
