...
Quando já não precisa de um [projeto Public Cloud](https://www.ovhcloud.com/pt/public-cloud/), pode eliminá-lo diretamente na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
...
<img className="thumbnail" alt="eliminar o projeto" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject1.png" loading="lazy" />
...
<img className="thumbnail" alt="eliminar o projeto" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject2.png" loading="lazy" />
