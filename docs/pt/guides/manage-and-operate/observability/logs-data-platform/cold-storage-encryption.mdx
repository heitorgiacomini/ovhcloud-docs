...
description: Secure your Cold Stored logs by encrypting them with your PGP public key
lastUpdated: 2023-03-10
---

## Objective

With the [Cold Storage feature](/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage) you can generate daily archives for your log streams.
...
- A stream with cold storage enabled. You can follow this [Cold Storage tutorial](/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage) to set it up.
...
In the home page of your Logs Data Platform service, in the bottom left you will find a `Configuration` panel. In this panel, in the `PGP encryption keys` line, click the <code className="action">...</code> button and then <code className="action">Edit</code>:

<img className="thumbnail" alt="Home page" src="/images/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/home.png" loading="lazy" />
...
<img className="thumbnail" alt="PGP keys home page" src="/images/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/pgp_home.png" loading="lazy" />

To register your PGP public key into your Logs Data Platform account, click on the <code className="action">Add a PGP encryption key</code> button.
...
<img className="thumbnail" alt="Add a new PGP key" src="/images/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/add_key.png" loading="lazy" />
...
For this, go to the `Data Stream` tab, pick the stream for which you want cold storage encryption, click the <code className="action">...</code> button and then click<code className="action">Edit</code>.

- Ensure the `Enable long-term storage` option is checked. You can refer to the [Cold Storage feature](/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage) documentation to know about each of its fields.
...
<img className="thumbnail" alt="Update stream configuration" src="/images/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/update_stream.png" loading="lazy" />
...
In the `Data Stream` tab, you can see how many archives exist for each stream. On a stream on which you have some archives, click the<code className="action">...</code> button and then click <code className="action">Archives</code>.

<img className="thumbnail" alt="List archives" src="/images/manage-and-operate/observability/logs-data-platform/archive-cold-storage-encryption/archives.png" loading="lazy" />
...
Once your encrypted archives are available, you can retrieve them [following this tutorial](/guides/manage-and-operate/observability/logs-data-platform/archive-cold-storage#retrieving-the-archives).
