...
For that, log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and access the administration console `Identity, Security & Operations`. Click on `Key Management Service`, then on `Generate an access certificate`.

![Create a certificate](/images/guides/manage-and-operate/kms/okms-certificate-management/create_certificat_01.png)
...
![Create a certificate](/images/guides/manage-and-operate/kms/okms-certificate-management/create_certificat_02.png)

##### **With a CSR:**

If you own your own private key, it's possible to use it with a CSR.

![Create a certificate](/images/guides/manage-and-operate/kms/okms-certificate-management/create_certificat_03.png)
...
![Create a certificate](/images/guides/manage-and-operate/kms/okms-certificate-management/create_certificat_04.png)
...
![Create a certificate](/images/guides/manage-and-operate/kms/okms-certificate-management/create_certificat_05.png)

Finally it's possible to download the public key of the certificate from the dashboard.

![Create a certificate](/images/guides/manage-and-operate/kms/okms-certificate-management/create_certificat_06.png)
