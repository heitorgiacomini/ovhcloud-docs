---
title: Desinstalar o monitoring RTM v2 num servidor dedicado
description: Remova o sistema de monitoring RTM v2 obsoleto do seu servidor dedicado OVHcloud em CentOS, Debian, Fedora ou Ubuntu
