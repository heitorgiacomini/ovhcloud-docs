...
- [Ter configurado o seu NIC para a funcionalidade OVHcloud Link Aggregation a partir da Área de Cliente OVHcloud](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager)
...
A seguir, clique no separador <code className="action">IPMI</code> (1) e no botão <code className="action">A partir de applet Java (KVM)</code> (2).
...
[Configurar a agregação das ligações OLA na sua Área de Cliente](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager).

[Como configurar o seu NIC para a agregação de ligações OVHcloud em Debian 9](/guides/bare-metal-cloud/dedicated-servers/ola-enable-debian9).

[Como configurar o seu NIC para a agregação de ligações OVHcloud em Windows Server 2019](/guides/bare-metal-cloud/dedicated-servers/ola-enable-w2k19).
