...
:::info
Se o seu servidor pertence à linha de produtos **Eco**, consulte [este guia](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server-eco).
...
:::info
Certos sistemas operativos ou plataformas proprietárias, como o Plesk ou o Windows, requerem licenças que geram custos suplementares. Pode comprar licenças [junto da OVHcloud](https://www.ovhcloud.com/pt/bare-metal/os/) ou junto de um revendedor externo. De seguida, deverá aplicar a sua licença no sistema operativo ou através da Área de <ManagerLink to="/">Cliente OVHcloud</ManagerLink>.
...
- [Se tiver armazenado anteriormente](/guides/bare-metal-cloud/dedicated-servers/import-keys-control-panel) uma chave pública na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, selecione a chave pretendida no menu pendente `Chave(s) SSH a pré-instalar`.
...
Introduza a sua palavra-passe atual e prima "Enter". Introduza a nova frase secreta e introduza-a novamente no seguinte prompt para a confirmar.
...
Pode ativar ou desativar o monitoring de um servidor dedicado a partir do separador <code className="action">Informações gerais</code> da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. A opção situa - se na secção `Estado dos serviços`.
...
Para mais informações, consulte o nosso manual "[Utilização do IPMI com servidores dedicados](/guides/bare-metal-cloud/dedicated-servers/ipmi)".
