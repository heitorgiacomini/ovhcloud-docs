...
:::info
O vRack suporta o roteamento público IPv4 e IPv6 com blocos de endereços Additional IP. Pode encontrar as instruções sobre a configuração de blocos IPv4 neste guia: [Configurar um bloco IP no vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
...
- Um serviço [vRack](https://www.ovhcloud.com/pt/network/vrack/) ativo na sua conta
- Um [servidor compatível com vRack](https://www.ovhcloud.com/pt/network/vrack/) ligado à sua rede vRack
...
:::warning
Esta funcionalidade pode estar limitada ou indisponível nos servidores da [gama **Eco**](https://eco.ovhcloud.com/pt/about/).

Consulte a nossa [página de comparação dos servidores Eco](https://eco.ovhcloud.com/pt/compare/) para obter mais informações.
...
<summary>Solicitar um novo bloco Additional IPv6</summary>
...
<img className="thumbnail" alt="página de configuração" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurar um IPv6 num vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="gestão do vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="seleção do vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="ativar SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/702.png" loading="lazy" />
...
<summary>Através da APIv6 (método alternativo)</summary>
...
<summary>Durante a encomenda de um Additional IP</summary>
...
- Ligue-se à <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>.
...
- Na coluna "IP público e largura de banda", clique no botão <code className="action">Gerir</code> correspondente ao vRack pretendido.
...
- No quadro da região em causa, clique em <code className="action">Modificar a largura de banda</code>.
- Selecione a opção pretendida no painel da direita e clique em <code className="action">Encomendar</code> para validar.
...
<summary>Configuração IP estática</summary>
...
<summary>Configuração IP automática (SLAAC)</summary>
...
<img className="thumbnail" alt="Configurar um IPv6 num vRack para o modo encaminhado" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/routed-mode-20240513.png" loading="lazy" />
...
Após adicionar o Additional IP ao seu vRack, pode gerir a sub-rede encaminhada clicando no botão <code className="action">Adicionar uma sub-rede</code>.

<img className="thumbnail" alt="seleção vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/600.png" loading="lazy" />
...
<summary>Configuração IP estática de um host (recomendado)</summary>
...
<summary>Configuração IP automática (SLAAC) para um host</summary>
...
<summary>Configuração da sub-rede encaminhada num host e dentro de uma máquina virtual</summary>
...
<summary>Configuração de uma sub-rede encaminhada dentro de uma VM</summary>
...
<summary>Local, num host</summary>
...
<summary>A partir de um host remoto</summary>
