...
Pode ir mais longe configurando o registo SPF para um domínio específico ou utilizando o endereço IPv6. Para compreender melhor o registo SPF, consulte o nosso manual sobre a [configuração de um registo SPF](/guides/web-cloud/domains/dns-zone-spf).
...
Para mais informações, consulte o nosso guia sobre a [configuração de um registo DKIM](/guides/web-cloud/domains/dns-zone-dkim).
...
Para obter mais informações, consulte o nosso manual sobre a [configuração de um registo DMARC](/guides/web-cloud/domains/dns-zone-dmarc).
...
Se os seus servidores DNS são geridos pela OVHcloud, consulte o nosso guia sobre [a edição de uma zona DNS da OVHcloud através da Área de Cliente](/guides/web-cloud/domains/dns-zone-edit).

Depois de alterar a zona DNS do domínio, é necessário aguardar 24 horas até que as alterações sejam efetivas.

Para configurar o caminho da reverse DNS no <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> queira consultar [o nosso manual dedicado](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns).
...
[Melhorar a segurança dos e-mails através de um registo DKIM](/guides/web-cloud/domains/dns-zone-dkim)

[Melhorar a segurança dos e-mails através de um registo SPF](/guides/web-cloud/domains/dns-zone-spf)

[Melhorar a segurança dos e-mails através de um registo DMARC](/guides/web-cloud/domains/dns-zone-dmarc)
