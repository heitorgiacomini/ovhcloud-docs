---
title: Configurar um endereço IPv6 numa máquina virtual (EN)
...
We have provided you with this guide to help you with common tasks. However, we recommend contacting a [specialist provider](https://partner.ovhcloud.com/pt/directory/) if you experience any difficulties or doubts when it comes to managing, using or securing your server. You can find more information in the “Go further” section of this guide.
...
- A [dedicated server](https://www.ovhcloud.com/pt/bare-metal/) with an IPv6 block (/64) or (/56) in your OVHcloud account.
