...
<br/>Para o fazer, aceda à <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Na secção <code className="action">Bare Metal Cloud</code>, selecione o seu servidor em <code className="action">Servidores dedicados</code> e clique no separador <code className="action">IPMI</code> (1).
