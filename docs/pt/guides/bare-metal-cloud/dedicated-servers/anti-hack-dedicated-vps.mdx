...
description: Descubra as informações visíveis e fornecidas quando a proteção Anti-Hack interna da OVHcloud é ativada.
...
- acesso à <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>

## Informações Anti-Hack

### Servidor dedicado

Quando a proteção Anti-Hack é ativada no seu Servidor dedicado, é apresentada uma mensagem na sua <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>: "*O seu servidor foi comprometido. Contacte a nossa equipa de assistência técnica para obter instruções sobre os próximos passos.*"
...
<img className="thumbnail" alt="informações antihack SD" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-service.png" loading="lazy" />
...
<img className="thumbnail" alt="informações antihack VPS" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-vps.png" loading="lazy" />
