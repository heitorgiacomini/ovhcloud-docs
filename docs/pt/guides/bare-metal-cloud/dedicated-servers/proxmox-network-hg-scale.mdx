...
description: Saiba como configurar a rede em Proxmox VE
...
- An [OVHcloud dedicated server](https://www.ovhcloud.com/pt/bare-metal/)
- One or more [Additional IP addresses](https://www.ovhcloud.com/pt/network/additional-ip/)
...
* A [server compatible with vRack](https://www.ovhcloud.com/pt/bare-metal/)
* A [vRack service](https://www.ovhcloud.com/pt/network/vrack/)
