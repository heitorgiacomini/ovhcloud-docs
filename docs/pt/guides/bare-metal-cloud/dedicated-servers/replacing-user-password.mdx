...
:::info
Para recuperar o acesso a um servidor ao qual se liga com uma chave SSH, consulte o nosso guia "[Como substituir um par de chaves SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)".
...
Lembre-se de utilizar o modo de arranque **normal** do seu servidor quando o reiniciar a partir da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
