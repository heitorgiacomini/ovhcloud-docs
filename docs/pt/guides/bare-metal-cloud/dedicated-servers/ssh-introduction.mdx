...
Os identificadores iniciais (identificador e palavra-passe) são-lhe transmitidos por e-mail após uma instalação ou uma reinstalação do servidor a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>.
