---
title: Substituição a quente num servidor dedicado em RAID por software
description: Substitua um disco com defeito num servidor dedicado em RAID por software sem interrupção graças ao procedimento de hot-swap
...
O disco danificado já pode ser substituído por um técnico do datacenter. Uma vez a operação efetuada, só terá de voltar a sincronizar o RAID. Para isso, consulte a seguinte documentação: [RAID software](/guides/bare-metal-cloud/dedicated-servers/raid-soft).
