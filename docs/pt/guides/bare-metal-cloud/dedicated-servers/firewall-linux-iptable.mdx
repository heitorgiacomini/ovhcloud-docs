...
Para mais informações, consulte o nosso manual sobre a [segurança de um servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server).
...
Para mais informações sobre o acesso a esta ferramenta, consulte [este guia](/guides/bare-metal-cloud/dedicated-servers/ipmi).  
:::
