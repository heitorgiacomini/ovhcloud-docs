...
description: Faça a gestão das contas de utilizadores, do acesso sudo e da ligação root num servidor dedicado GNU/Linux para uma administração segura
...
Para obter instruções mais detalhadas sobre este assumpto, consulte o guia "[Primeiros passos com SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)".
...
- [Tornar seguro um servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server)
- [Tornar seguro um VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps)
:::
