...
description: Saiba como restaurar o acesso ao servidor em caso de perda da sua chave privada, gerando um novo par de chaves SSH
...
Se [utilizar chaves SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys) para se ligar ao seu servidor, a perda da sua chave SSH privada poderá implicar a perda total de acesso ao seu servidor.

No entanto, pode ligar-se ao seu servidor através do [modo rescue OVHcloud](/guides/bare-metal-cloud/dedicated-servers/rescue-mode), graças a uma password provisória que lhe permitirá modificar os seus ficheiros.
...
Crie um novo par de chaves SSH no seu ambiente de trabalho, tal como descrito na primeira parte do manual ["Criar chaves SSH"](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys).
...
- [Modo rescue servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
- [VPS em modo de rescue](/guides/bare-metal-cloud/virtual-private-servers/rescue)
...
Volte para o modo de arranque "normal" e reinicie o servidor na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. Consulte o guia ["Ativar e utilizar o modo rescue"](#step2), se necessário.
