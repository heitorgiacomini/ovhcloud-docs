...
description: Execute diagnósticos de hardware no seu servidor dedicado OVHcloud em modo rescue para identificar falhas de disco, RAM ou CPU.
...
- Reiniciar o servidor em [Modo Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode).
