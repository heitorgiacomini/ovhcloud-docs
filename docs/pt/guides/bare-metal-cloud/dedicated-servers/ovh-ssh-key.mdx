---
title: Instalar uma chave SSH OVHcloud num servidor dedicado
description: Instale uma chave SSH OVHcloud no seu servidor dedicado para conceder um acesso administrativo seguro às equipas de suporte OVHcloud
...
- Estar [ligado ao servidor usando o protocolo SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) (acesso root).
...
Consulte o guia [Introdução ao SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction).
