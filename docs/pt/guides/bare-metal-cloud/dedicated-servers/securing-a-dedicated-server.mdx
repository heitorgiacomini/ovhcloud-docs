...
description: "Aplique as medidas de segurança essenciais no seu servidor dedicado: reforço SSH, configuração da firewall e monitorização"
...
Se configurar o primeiro servidor dedicado da OVHcloud, recomendamos que consulte primeiro o nosso manual sobre [a implementação de um servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).
:::
...
Para mais informações sobre iptables, consulte o nosso [guia dedicado](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).
...
Para saber mais sobre as nossas soluções de armazenamento, consulte o nosso [manual](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage) sobre armazenamento.

## Quer saber mais?

[Configurar a firewall em Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)
