...
<img className="thumbnail" alt="verificar a segunda interface de rede" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-1.png" loading="lazy" />
...
<img className="thumbnail" alt="desativar rede" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-6.png" loading="lazy" />

Em seguida, realizamos o processo de ativação:

<img className="thumbnail" alt="ativar rede" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-7.png" loading="lazy" />
