---
title: Configurar a firewall do Windows num servidor dedicado
description: Configure a firewall integrada do Windows no seu servidor dedicado para controlar o tráfego de rede de entrada e de saída.
