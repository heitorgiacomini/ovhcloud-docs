---
title: Encontrar o número de série de um disco num servidor dedicado
description: Recupere o número de série de um disco rígido no seu servidor dedicado para o identificar durante um pedido de substituição
...
Para informações pormenorizadas sobre estes comandos e a forma de testar os discos rígidos, consulte este [manual](/guides/bare-metal-cloud/dedicated-servers/raid-hard) (versão em inglês).
...
Pode recorrer a [este manual](/guides/bare-metal-cloud/dedicated-servers/raid-hard) (versão em inglês) para determinar que disco rígido corresponde a que periférico “sg”.
