...
description: Descubra o serviço Bare Metal 3-AZ, que oferece uma alta disponibilidade e uma redundância inigualáveis entre três datacenters
lastUpdated: 2025-06-04
---

## Objetivo

A OVHcloud propõe o seu serviço Bare Metal na [região 3-AZ](https://www.ovhcloud.com/pt/about-us/global-infrastructure/expansion-regions-az/), uma evolução significativa na estratégia de regionalização da empresa. Este serviço, disponível na região de Paris, constitui um novo standard do sector em matéria de fiabilidade e de desempenho dos servidores Bare Metal.
...
Passe para o separador <code className="action">Clusters 3-AZ</code>.
...
Clique no separador <code className="action">Nós</code> para abrir a lista de servidores do cluster.
...
Ao clicar no nome de um servidor/nó desta lista, abre-se o separador <code className="action">Informações gerais</code> do servidor. Pode encontrar mais informações na secção Área de Cliente no nosso manual:

[Como começar com um servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server)
