...
description: Verifique o estado do seu controlador RAID de hardware e monitorize a saúde dos discos rígidos no seu servidor dedicado OVHcloud.
...
- a [dedicated server](https://www.ovhcloud.com/pt/bare-metal/) with a hardware RAID configuration
