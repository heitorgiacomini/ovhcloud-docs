...
Na <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, é possível especificar um modo de boot entre uma lista predefinida: disco principal ou rescue.
Através da [API OVHcloud](https://eu.api.ovh.com/), pode também definir scripts personalizados.
...
Pode alternar de novo entre o disco ou o modo rescue a partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> (consulte o nosso guia "[Ativar e utilizar o modo rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)") ou através da [API OVHcloud](https://eu.api.ovh.com/).
...
[Reinicialização do seu servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server#reboot)
