...
Vai precisar do endereço IP do seu servidor que pode encontrar na sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>, assim como do nome da conta de utilizador a utilizar para a ligação SSH. Não hesite em consultar os nossos manuais "Primeiros passos" se deseja obter mais pormenores sobre este assumpto:
...
<img className="thumbnail" alt="Modo de rescue sftp do local remoto" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_03.png" loading="lazy" />
...
<img className="thumbnail" alt="site remoto sftp" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Progresso da transferência sftp" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_02.png" loading="lazy" />
