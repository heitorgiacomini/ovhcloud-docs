...
description: Saiba como encontrar erros num sistema de ficheiros em modo rescue
...
Lance um reboot ao servidor em modo rescue a partir da Área de Cliente. Caso seja necessário, consulte o nosso [manual sobre o modo rescue](/guides/bare-metal-cloud/virtual-private-servers/rescue).
