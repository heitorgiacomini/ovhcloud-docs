...
Se configurar o primeiro VPS da OVHcloud, recomendamos que consulte primeiro o nosso manual sobre [a implementação de um VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
:::


Os exemplos abaixo pressupõem que está ligado enquanto [utilizador com autorizações elevadas](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
- [Como criar e utilizar chaves de autenticação para ligações SSH aos servidores OVHcloud](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)
...
:::warning
Se estiver configurado um firewall no seu sistema operativo (UFW ou iptables), terá de ajustar as suas definições para autorizar o tráfego na nova porta antes de reiniciar o serviço. Se estiver a utilizar o iptables, consulte este guia: [Configurar a firewall em Linux com iptables](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable). Se não estiver configurado nenhum firewall por predefinição, reinicie o serviço.
:::
...
Lembre-se de que deve indicar a nova porta a cada pedido de [ligação SSH ao seu servidor](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction):
...
Se você estiver bloqueado fora do seu sistema, pode usar o nosso ambiente [modo rescue](/guides/bare-metal-cloud/virtual-private-servers/rescue) para anular as suas alterações.

### Criar um utilizador com direitos restritos <a name="createuser"></a>

Em geral, as tarefas que não exijam privilégios root devem ser realizadas através de um utilizador standard. Para mais informações consulte [este guia](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
Para mais informações sobre iptables, consulte o nosso [guia dedicado](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable).
...
Consulte o guia "[Configurar a Network Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network)" se desejar ativá-la.
...
Na [página do produto](https://www.ovhcloud.com/pt/vps/options/) e nos respetivos [guias](/guides/bare-metal-cloud/virtual-private-servers/overview), poderá encontrar todas as informações sobre as soluções de backup disponíveis para o seu serviço.

## Quer saber mais?

[VPS: primeira utilização](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) 

[Criar e utilizar chaves SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Configurar a firewall em Windows](/guides/bare-metal-cloud/virtual-private-servers/activate-port-firewall-soft-win)

[Configurar a firewall em Linux com iptables](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable)
