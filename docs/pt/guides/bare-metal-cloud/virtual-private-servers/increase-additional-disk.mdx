...
description: Descubra como aumentar o tamanho de um volume adicional e aumentar a sua partição principal
...
- Um [disco adicional](/guides/bare-metal-cloud/virtual-private-servers/config-additional-disk) configurado no VPS.
...
Os passos abaixo sugerem que configurou um disco adicional seguindo as instruções [deste manual](/guides/bare-metal-cloud/virtual-private-servers/config-additional-disk).

### Modificar o tamanho do disco <a name="extend"></a>

No separador <code className="action">Página Inicial</code>, na secção **A sua configuração**, clique em <code className="action">...</code> ao lado da opção `Discos adicionais` e, a seguir, clique em <code className="action">Aumentar o tamanho do disco</code>.
...
Escolha o novo tamanho de disco na nova janela e clique em <code className="action">Aumentar</code>.
...
O aumento da capacidade do disco demorará alguns minutos após a validação do pagamento. Pode verificar o progresso no separador <code className="action">Discos adicionais</code>: se o novo tamanho escolhido for apresentado, o disco está pronto.
...
Uma vez ligado, clique com o botão <code className="action">Menu Iniciar</code> e abra a <code className="action">Gestão dos discos</code>.
...
O [disco ampliado](#extend) apresenta a capacidade adicional sob a forma de espaço não atribuído. Faça um clique com o botão direito sobre o volume do seu disco adicional e selecione <code className="action">Expanda o volume</code> no menu contextual.
...
Pode alterar o espaço de disco nesta etapa, se necessário. Clique em <code className="action">Seguinte</code>.
