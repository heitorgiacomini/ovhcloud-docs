...
- Se o domínio é gerido pela OVHcloud como registar **e** utiliza os servidores DNS da OVHcloud, adicione o registo TXT à secção <code className="action">Web Cloud</code> da sua <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink>. De seguida, siga as instruções descritas no nosso manual "[Editar a zona DNS](/guides/web-cloud/domains/dns-zone-edit)".
