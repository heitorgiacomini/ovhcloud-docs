...
description: Saiba como implementar aplicações pré-instaladas no seu VPS
...
A partir da <ManagerLink to="/">Área de Cliente OVHcloud</ManagerLink> ou das API OVHcloud, instale a aplicação que desejar. Também pode consultar o nosso guia [VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps): primeira utilização.
