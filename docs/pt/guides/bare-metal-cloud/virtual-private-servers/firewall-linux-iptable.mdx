...
description: Saiba como proteger um servidor com iptables
...
Para mais informações, consulte o nosso manual sobre a [segurança de um VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps).
...
<img className="thumbnail" alt="versão-iptables" src="/images/bare-metal-cloud/virtual-private-servers/firewall-Linux-iptable/step2-version-iptables.PNG" loading="lazy" />
...
Para mais informações sobre o acesso a esta ferramenta, consulte [este guia](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps).  
:::
