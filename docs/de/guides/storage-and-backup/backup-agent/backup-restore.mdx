...
Lesen Sie diese Anleitung für weitere Informationen: [Backup Agent - Bare Metal Recovery mit Veeam Backup Agent](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/agent-bare-metal-recovery).
