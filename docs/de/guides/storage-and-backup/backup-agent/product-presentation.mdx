...
description: Übersicht über die Funktionen und Vorteile des Backup Agent Produkts
...
Erfahren Sie, wie Sie die VSPC-Oberfläche durchsuchen können in [dieser Anleitung](/guides/storage-and-backup/backup-agent/vspc-presentation).
...
<img className="thumbnail" alt="Backup Agent Funktionsdiagramm" src="/images/storage-and-backup/backup-agent/backup-agent-product-presentation/01-backup-agent-diagram.png" loading="lazy" />

Beachten Sie, dass:

- Die VSPC-Infrastruktur in den OVHcloud Rechenzentrumn gehostet wird und keine Daten an Veeam-Server sendet.
- Der Speicher basiert auf der [OVHcloud Object Storage](https://www.ovhcloud.com/de/public-cloud/object-storage/), in OVHcloud Rechenzentrumn gehostet.
