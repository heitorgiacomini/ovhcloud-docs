...
description: Erfahren Sie, wie Sie potenzielle Probleme im Zusammenhang mit dem Backup Agent beheben können
...
- Mindestens ein Bare Metal-Server mit installiertem Backup Agent. Lesen Sie unsere Anleitung "[So konfigurieren Sie Ihr erstes Backup](/guides/storage-and-backup/backup-agent/first-configuration)", um weitere Informationen zu erhalten.
...
<summary>Mein Backup Agent kann sich nicht mit dem Server verbinden.</summary>
...
<summary>Ihr Server kann den Backup Agent auf meinem Server nicht installieren.</summary>
...
<summary>Mein Agent kann nicht sichern. Ich erhalte die Fehlermeldung: "Failed to perform Backup. Neither blksnap nor veeamsnap module was found."</summary>
...
<summary>Mein Agent kann nicht sichern. Ich erhalte den Fehler: `POSIX: Failed to create or open file [/.veeamsnapstorage/veeamsnapstore`</summary>
...
<summary>Ich kann keine manuelle Sicherung starten.</summary>


[Setzen Sie sich mit dem OVHcloud Support in Verbindung](https://help.ovhcloud.com/csm?id=csm_get_help), um dies zu untersuchen. Stellen Sie sicher, dass Sie Protokolle und Screenshots bereitstellen.
...
<summary>Mein Backup ist fehlerhaft, wie kann ich das Problem sehen?</summary>
...
<summary>Die Speichernutzung wurde nach dem Entfernen eines Agents nicht aktualisiert.</summary>
...
<summary>Ich möchte das Passwort für den Zugriff auf die Veeam Service Provider Console (VSPC) ändern.</summary>
...
<summary>Ich habe meinen Server reinstalliert. Wie installiere ich den Backup Agent erneut?</summary>


Sie müssen den Agent von Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> herunterladen und auf Ihrem neuen Betriebssystem installieren.
...
<Tabs>
  <Tab label="Windows">
    ...
    **Protokolle exportieren**
    ...
    2. Gehen Sie zum Menü <code className="action">Help</code> > <code className="action">Export Logs</code>.
    3. Wählen Sie das Zielverzeichnis für das Protokollarchiv aus.
    4. Klicken Sie auf <code className="action">Export</code>, um das Archiv zu erstellen.
