...
Ja, das ist in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> im Bereich <code className="action">Bare Metal Cloud</code> und dann <code className="action">NAS und CDN</code> möglich.
...
Sie können auch jederzeit manuelle Snapshots erstellen, zeitlich unbegrenzt speichern oder löschen. Diese Funktion ist in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder über folgenden [API-Aufruf](https://eu.api.ovh.com/) verfügbar:
