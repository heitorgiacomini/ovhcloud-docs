...
description: Erfahren Sie hier, wie Sie Ihre Daten über eine NFS-Freigabe von einem HA-NAS auf ein anderes migrieren.
...
- Sie haben Ihr NAS bereits gemountet, nach [dieser Anleitung](/guides/storage-and-backup/file-storage/ha-nas/nas-nfs).
