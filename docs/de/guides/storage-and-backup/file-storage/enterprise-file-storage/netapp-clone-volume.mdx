...
:::info
Sie können ein Volume und einen Snapshot vom Typ `Manual` über die [OVHcloud API](https://eu.api.ovh.com/) oder über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> erstellen.
