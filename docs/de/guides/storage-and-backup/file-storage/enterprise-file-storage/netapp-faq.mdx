...
description: FAQ zum Enterprise File Storage Dienst
...
Ja, diese Dienstleistung ist direkt über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> erreichbar, im Bereich <code className="action">Bare Metal Cloud</code>, dann <code className="action">Storage und Backup</code>.
