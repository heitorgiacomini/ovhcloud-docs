...
description: Erfahren Sie hier, wie Sie Snapshots eines Enterprise File Storage Volumes mit der OVHcloud API verwalten
...
| `serviceName` | Yes | Service ID |
| `shareId` | Yes | Volume ID |
| `NetAppShareSnapshot.description` |  | Snapshot Beschreibung |
