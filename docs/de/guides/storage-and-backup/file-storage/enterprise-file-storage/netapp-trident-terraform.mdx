...
description: Erfahren Sie, wie Sie mit einem Terraform-Modul den Infrastruktur-Stack für NetApp Trident CSI mit Enterprise File Storage und Managed Kubernetes Service bereitstellen
...
<img className="thumbnail" alt="Architektur des Terraform-Moduls" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-terraform/terraform-module-architecture.png" loading="lazy" />
...
| Gateway erforderlich | Der MKS-Cluster benötigt ein Gateway, um die OVHcloud API zu erreichen |
...
Folgen Sie der Anleitung [Erste Schritte mit den OVHcloud APIs](/guides/manage-and-operate/api/first-steps/), um Ihr API-Token zu generieren.
...
- [Erste Schritte mit Trident CSI](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/)
- [Enterprise File Storage mit dem OVHcloud Terraform Provider verwalten](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-terraform/)
...
Wenn Sie Schulungen oder technische Unterstützung bei der Implementierung unserer Lösungen benötigen, wenden Sie sich an Ihren Vertriebsmitarbeiter oder besuchen Sie die Seite [Professional Services](/links/professional-services), um einen Kostenvoranschlag zu erhalten und eine persönliche Analyse Ihres Projekts durch unsere Experten des Professional Services Teams anzufordern.
