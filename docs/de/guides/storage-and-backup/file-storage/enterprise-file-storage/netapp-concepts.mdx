...
description: Erfahren Sie hier die Funktionsweise des Angebots Enterprise File Storage
...
Der OVHcloud Kunden-Account ist standardmäßig der Admin-, Tech- und Rechnungskontakt des Dienstes. Weitere Informationen finden Sie in unserer Anleitung zur [Kontaktverwaltung Ihrer Dienste](/guides/account-and-service-management/account-information/managing-contacts).
...
Weitere Informationen finden Sie in der Anleitung "[Volumes verwalten](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volumes)".
...
Weitere Informationen finden Sie in der Anleitung ["Volumes verwalten"](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-acl).
...
Weitere Informationen finden Sie in der Anleitung "[Snapshots eines Volumes verwalten](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-snapshots)".
