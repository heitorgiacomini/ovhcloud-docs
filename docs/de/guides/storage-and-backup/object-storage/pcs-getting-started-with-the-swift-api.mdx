...
description: Erfahren Sie hier, wie Sie die Swift API verwenden
...
- [Vorbereitung der Umgebung für die Verwendung der OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) durch Installation des *python-swiftclient*
- [Laden der OpenStack Umgebungsvariablen](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
...
Diese URL besteht einem API-Zugriffspunkt, den Sie im [Horizon Interface](/guides/public-cloud/cross-functional/compute-horizon-access-security) abrufen können, sowie aus dem Namen des Containers und des gewünschten Objekts (einschließlich Präfix).
