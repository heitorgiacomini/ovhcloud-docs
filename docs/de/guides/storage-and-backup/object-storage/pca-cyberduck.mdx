...
description: Erfahren Sie hier, wie Sie Cyberduck konfigurieren, um Ihre Public Cloud Archive verwalten zu können
...
- Sie verfügen über Ihre Benutzer- (*OS_USERNAME*) und Projekt-Kennungen (*OS_PROJECT_NAME* oder *OS_TENANT_NAME*), die Sie [erhalten können](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#schritt-nr-1-die-variablen-wieder-erhalten), indem Sie die Datei "OpenRC" im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> herunterladen.
- Sie haben Ihr OpenStack-Benutzerpasswort.

Wenn Sie Ihr OpenStack-Benutzerpasswort nicht mehr kennen, können Sie es mithilfe [dieser Anleitung](/guides/public-cloud/cross-functional/create-and-delete-a-user) ändern.
...
Klicken Sie dann auf <code className="action">Connect</code>. Sobald Sie eingeloggt sind, haben Sie Zugriff auf die Ordnerstruktur Ihrer Dateien.
...
[Erste Schritte mit der Swift API](/guides/storage-and-backup/object-storage/pcs-getting-started-with-the-swift-api)
