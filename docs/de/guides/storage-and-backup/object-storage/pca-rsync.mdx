...
description: Erfahren Sie hier, wie Sie mit Rsync auf Ihre Public Cloud Archive zugreifen
...
Mithilfe dieser [Anleitung](/guides/public-cloud/cross-functional/create-and-delete-a-user) können Sie Ihre OpenStack-Kennung und Ihr Passwort erstellen.

### TenantName

Der TenantName entspricht dem Namen Ihres Horizon-Projekts. Um den TenantName zu erhalten, loggen Sie sich im OpenStack Webinterface ein: [https://horizon.cloud.ovh.net/](https://horizon.cloud.ovh.net/).

Nach dem Login ist der TenantName oben auf der Seite sichtbar.

<img className="thumbnail" alt="cPanel" src="/images/storage-and-backup/object-storage/pca-rsync/image1.png" loading="lazy" />
