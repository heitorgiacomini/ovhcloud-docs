...
description: Erfahren Sie hier, wie Sie ein Synology NAS mit einem Container synchronisieren
...
- [Erstellung von Object Storage Containern](/guides/storage-and-backup/object-storage/pcs-create-container)
- [Einen Zugang zu Horizon einrichten](/guides/public-cloud/cross-functional/create-and-delete-a-user#erstellung-eines-openstack-benutzers)
