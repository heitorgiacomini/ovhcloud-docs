---
title: Cloud Archive Swift - Set up an Access Control List on Public Cloud Archive (EN)
description: Here are the concepts for implementing ACLs on Public Cloud Archive
...
- [OpenStack users](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- [Preparing the environment to use the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) by installing python-swiftclient
- [Loading the OpenStack environment variables](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
...
![Creating new users](/images/storage-and-backup/object-storage/pca-acl/create-users.png)
...
![Other user](/images/storage-and-backup/object-storage/pca-acl/other-user.png)
