...
You can access the details of the Offsite Replication pricing on the global Object Storage [pricing page](https://www.ovhcloud.com/de/public-cloud/prices/). It is billed according to the storage space used, with a granularity of 1 GiB. To ensure readability, the price is displayed per GiB/month, but the billing granularity is per GiB/hour.
