...
description: Erfahren Sie hier, wie Sie Ihre Archive freigeben
...
- *Unfreeze* über python-swiftclient:
    - [Umgebung für die Verwendung der OpenStack-API vorbereiten](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) indem python-swiftclient installiert wird.
...
Klicken Sie im linken Menü auf <code className="action">Cloud Archive</code>.

Um das Archiv freizugeben, klicken Sie auf den Button <code className="action">...</code> rechts und dann auf <code className="action">Unfreeze</code>, um den Vorgang zu starten.

<img className="thumbnail" alt="Unfreeze" src="/images/storage-and-backup/object-storage/pca-unlock/unfreeze.png" loading="lazy" />

Sobald der Prozess läuft, werden Datum und Uhrzeit der Verfügbarkeit Ihres Archivs in der Spalte `Verfügbarkeit` angezeigt.

<img className="thumbnail" alt="Frist" src="/images/storage-and-backup/object-storage/pca-unlock/unfreeze_result.png" loading="lazy" />

Ihre Datei wird nach Ablauf dieser Frist zum Download verfügbar sein. Sie können dann den Download direkt im Browser oder über einen [Swift/SFTP/SCP Client](/guides/storage-and-backup/object-storage/pca-sftp) ausführen.
