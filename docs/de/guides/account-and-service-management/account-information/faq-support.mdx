...
Wenn Sie einen Ausfall auf Ihrem Dienst feststellen und bereits bestätigt haben, dass dieser aktiv und verlängert ist, besuchen Sie diese Seite, um aktuelle Störungsbehebungen auf unseren Infrastrukturen zu prüfen: [https://www.status-ovhcloud.com/](https://www.status-ovhcloud.com/).
...
Um den Support-Level für Ihre Kundenkennung zu ermitteln, öffnen Sie die Seite <ManagerLink to="/#/account/useraccount/dashboard">Mein Account</ManagerLink>. Der Support-Level wird rechts neben **Support** angezeigt. Wenn Sie keinen kostenpflichtigen Support abonniert haben, hat Ihr Kunden-Account den Support-Level Standard.
...
Die Behörde wird Sie daraufhin kontaktieren und die Anzeige gemeinsam mit Ihnen aufnehmen. Sobald Sie Anzeige erstattet haben, senden Sie uns bitte eine Kopie der Anzeige zu. Wir können dann interne Schritte einleiten.
