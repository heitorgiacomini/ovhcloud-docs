...
Um den Support-Level für Ihre Kundenkennung zu ermitteln, öffnen Sie die Seite <ManagerLink to="/#/account/useraccount/dashboard">Mein Account</ManagerLink>. Der Support-Level wird rechts neben **Support** angezeigt. Wenn Sie keinen kostenpflichtigen Support abonniert haben, ht Ihr Kunden-Account den Support-Level Standard.
