...
Auf der Seite <ManagerLink to="/#/iam/identities/users">IAM-Identitäten</ManagerLink>, klicken Sie auf <code className="action">Nutzer hinzufügen</code>.
...
Der Benutzer kann sich von nun an mit dieser Kennung im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> einloggen. 
