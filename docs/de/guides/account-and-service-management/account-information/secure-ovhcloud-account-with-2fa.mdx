...
Klicken Sie auf der Seite <ManagerLink to="/#/account/useraccount/security">Kontosicherheit</ManagerLink> auf <code className="action">Die Zwei-Faktor-Authentifizierung aktivieren</code>.
...
Gehen Sie auf die <ManagerLink to="/">Authentifizierungsseite im OVHcloud Kundencenter</ManagerLink> und geben Sie Ihre Kundenkennung (oder Ihre Haupt-E-Mail-Adresse) und Ihr Passwort ein.
...
Um ein Gerät zu entfernen, gehen Sie zur Seite <ManagerLink to="/#/account/useraccount/security">Kontosicherheit</ManagerLink> und klicken Sie auf die <code className="action">...</code> rechts vom zu löschenden Gerät und dann auf <code className="action">Löschen</code>.
...
Gehen Sie zunächst auf <ManagerLink to="/">die Authentifizierungsseite des OVHcloud Kundencenters</ManagerLink>.
