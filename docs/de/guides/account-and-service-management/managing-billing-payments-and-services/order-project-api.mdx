...
description: Hier erfahren Sie, wie Sie Ihr Public Cloud Projekt mit der OVHcloud API bestellen.
...
- Sie haben einen [gültigen](/guides/account-and-service-management/managing-billing-payments-and-services/manage-payment-methods) und in Ihrem OVHcloud Account gespeicherten Zahlungsmodus.
- Sie müssen mit der [Funktionsweise der OVHcloud APIv6 vertraut sein](/guides/manage-and-operate/api/first-steps).

## In der praktischen Anwendung

Verbinden Sie sich mit dem [OVHcloud API](https://eu.api.ovh.com/)-Interface und folgen Sie den nachstehenden Schritten.
