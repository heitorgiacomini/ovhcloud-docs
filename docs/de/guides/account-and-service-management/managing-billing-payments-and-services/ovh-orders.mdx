...
Wenn Sie eine Bestellung aufgeben, können Sie diese über Ihr <ManagerLink to="/#/billing/orders">OVHcloud Kundencenter</ManagerLink> verfolgen und sie bearbeiten.
...
Sie können Ihren Bestellschein jederzeit auf der Seite <ManagerLink to="/#/billing/orders">Meine Bestellungen</ManagerLink> einsehen, wie unten erläutert.
...
Nach Erstellung Ihres Bestellscheins können Sie Ihre Bestellung über die Seite <ManagerLink to="/#/billing/orders">Meine Bestellungen</ManagerLink> verfolgen:

- Klicken Sie auf den Button <code className="action">...</code> rechts neben Ihrer Bestellung.
...
Wenn die Voraussetzungen für das Widerrufsrecht erfüllt sind, kann es direkt über die Seite <ManagerLink to="/#/billing/orders">Meine Bestellungen</ManagerLink> ausgeübt werden:
