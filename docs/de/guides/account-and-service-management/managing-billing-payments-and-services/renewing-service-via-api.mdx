...
description: So verlängern Sie Ihre Dienste über die OVHcloud API
...
- Sie sind in der [OVHcloud API](https://eu.api.ovh.com/) eingeloggt.
- Sie haben Ihre [Zugangsdaten für die OVHcloud API eingerichtet - EN](/guides/manage-and-operate/api/first-steps).
