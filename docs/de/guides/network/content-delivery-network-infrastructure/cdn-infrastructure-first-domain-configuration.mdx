...
description: Hier erfahren Sie, wie Sie eine Domain im OVH CDN konfigurieren.
...
- Sie nutzen das [OVH Content Delivery Network (CDN)](https://www.ovhcloud.com/de/network/cdn/).
...
Gehen Sie dazu im <ManagerLink to="/">OVHcloud Kundencenter </ManagerLink> in den Bereich <code className="action">Dedicated</code> und dann auf <code className="action">NAS und CDN</code>.

Klicken Sie auf <code className="action">Eine Domain zum CDN hinzufügen</code>:

<img className="thumbnail" alt="CDN Kundencenter" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png" loading="lazy" />

Im ersten Schritt können Sie die Subdomain auswählen, die Sie zum CDN hinzufügen möchten:

<img className="thumbnail" alt="Subdomain zum CDN hinzufügen" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Backend hinzufügen" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png" loading="lazy" />
...
<img className="thumbnail" alt="CNAME-Eintrag" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png" loading="lazy" />
