...
description: So funktionieren Traffic-Limits in Ihrem CDN
...
- Sie sind in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> eingeloggt.
...
Wenn Sie zusätzliches Quota benötigen, können Sie dieses direkt über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> bestellen.

<img className="thumbnail" alt="Quota hinzufügen" src="/images/network/content-delivery-network-infrastructure/quota/add_quota.png" loading="lazy" />

Die Preise für das Quota finden Sie auf der zugehörigen [Webseite](https://www.ovhcloud.com/de/network/cdn/).
...
<img className="thumbnail" alt="Quota-Verbrauch" src="/images/network/content-delivery-network-infrastructure/quota/quota_used.png" loading="lazy" />
