...
![General diagram of blue-green architecture](/images/guides/network/load-balancer/case-blue-green/scheme.png)
...
![Add a new HTTP farm dedicated to infrastructure A](/images/guides/network/load-balancer/case-blue-green/ferme1.png)
...
![Add a new server to the farm HTTP A](/images/guides/network/load-balancer/case-blue-green/serveur1.png)

![Enter the HTTP A server's configuration](/images/guides/network/load-balancer/case-blue-green/server1.png)
...
![Add a new HTTP farm dedicated to infrastructure B](/images/guides/network/load-balancer/case-blue-green/ferme2.png)

![Create a second farm dedicated to infrastructure B](/images/guides/network/load-balancer/case-blue-green/backend2.png)
...
![Add a new server to the farm HTTP B](/images/guides/network/load-balancer/case-blue-green/serveur2.png)

![Enter the HTTP B server's configuration](/images/guides/network/load-balancer/case-blue-green/server2.png)
...
![Farm configuration](/images/guides/network/load-balancer/case-blue-green/farms.png)
...
![Adding a front-end dedicated to production, a blue front-end](/images/guides/network/load-balancer/case-blue-green/frontend1.png)

![Enter the blue front-end's configuration](/images/guides/network/load-balancer/case-blue-green/fblue.png)
...
![Add the green front-end, dedicated to development](/images/guides/network/load-balancer/case-blue-green/frontend2.png)

![Enter the green front-end's configuration](/images/guides/network/load-balancer/case-blue-green/fgreen.png)
...
![Apply your changes to the zone](/images/guides/network/load-balancer/case-blue-green/deploy.png)
...
![Result after updating front-ends](/images/guides/network/load-balancer/case-blue-green/switch.png)
