...
- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, or 
...
![Modify a farm](/images/guides/network/load-balancer/create-stickiness/farm_edit-2022.png)

In the `Advanced settings` section, you will be able to access the `Track session` section:

![Modifying connection tracking](/images/guides/network/load-balancer/create-stickiness/tracking_session-2022.png)
...
![Apply a Load Balancer configuration](/images/guides/network/load-balancer/create-stickiness/apply_configuration-2022.png)
