...
description: Erfahren Sie, wie Sie die Frontends Ihres OVHcloud Load Balancers für die Verwendung mit dem HTTP/2-Protokoll auswählen und konfigurieren können
...
- Sie haben einen [OVHcloud Load Balancer](https://www.ovhcloud.com/de/network/load-balancer/).
