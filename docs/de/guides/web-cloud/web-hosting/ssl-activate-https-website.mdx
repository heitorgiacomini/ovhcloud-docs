...
description: Erfahren Sie hier, wie Sie Ihre Website auf HTTPS umstellen, nachdem Sie ein SSL-Zertifikat aktiviert haben
...
- Auf Ihrem [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) ist ein [SSL-Zertifikat](https://www.ovhcloud.com/de/web-hosting/options/ssl) installiert.
...
Um ein SSL-Zertifikat für Ihr Webhosting zu aktivieren oder zu überprüfen, ob bereits ein SSL-Zertifikat für Ihre Website installiert ist, lesen Sie unsere Anleitung: „[SSL-Zertifikat auf einem Webhosting verwalten](/guides/web-cloud/web-hosting/ssl-on-webhosting)“.
...
Sobald Ihr Domainname über [ein aktives SSL-Zertifikat auf Ihrem Webhosting](/guides/web-cloud/web-hosting/ssl-on-webhosting) verfügt und Ihre Website bereit ist, auf *HTTPS* umgestellt zu werden, können Sie dies aktivieren.

:::warning
Bevor Sie mit der Durchführung von Maßnahmen beginnen, empfehlen wir Ihnen, ein vollständiges Backup Ihrer Website zu erstellen. Dieses Backup muss nicht nur die Dateien auf dem [FTP-Speicherplatz](/guides/web-cloud/web-hosting/ftp-save-and-backup), sondern auch die Dateien der [Datenbank](/guides/web-cloud/web-hosting/sql-database-export) enthalten, wenn die Website eine solche verwendet.
