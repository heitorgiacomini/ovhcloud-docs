...
:::info
Nur die Webhosting-Angebote **Pro**, **Performance**, **Agency**, **Agency Plus** und **Agency Max** erlauben die Aktivierung mehrerer FTP-Benutzer und verfügen über SSH-Verbindungen.
...
Für die Nutzung dieses Zugriffstyps sind fortgeschrittene Kenntnisse sowie ein [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) **Pro**, **Performance**, **Agency**, **Agency Plus** oder **Agency Max** erforderlich.
