...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Wenn Sie über nur eine Datenbank in diesem Teil Ihres Kundencenters und keine [Web Cloud Databases](https://www.ovhcloud.com/de/web-cloud/databases/) Lösung verfügen, können Sie davon ausgehen, dass es sich um die Datenbank Ihrer Website handelt.
  </Tab>
  <Tab label="Schritt 3">
...
Wenn Sie die maximale Anzahl an Datenbanken erreicht haben, die in Ihrem [Webhosting](https://www.ovhcloud.com/de/web-hosting/) zulässig ist, müssen Sie **ZUERST** die im [ersten Schritt](#step1) identifizierte Datenbank löschen, um ein neues 1-Klick-Modul erstellen zu können.
