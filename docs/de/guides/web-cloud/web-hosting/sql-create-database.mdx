...
Loggen Sie sich in Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein und wählen Sie im Bereich <code className="action">Web Cloud</code> links unter <code className="action">Hosting-Pakete</code> das betreffende Hosting aus. Gehen Sie dann auf den Tab <code className="action">Datenbanken</code>.
...
Geben Sie die erforderlichen Informationen ein und klicken Sie auf <code className="action">Weiter</code>.
...
:::info
Wenn Sie auf <code className="action">Bestätigen</code> klicken, wird die Erstellung der Datenbank bis zu **15 Minuten** dauern. Laden Sie die Seite des <ManagerLink to="/">OVHcloud Kundencenters</ManagerLink> neu, wenn die Datenbank nicht automatisch in der Tabelle mit den Datenbanken erscheint.
...
Um diese Verbindungsinformationen einzusehen, loggen Sie sich in Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein und gehen Sie in den Bereich <code className="action">Web Cloud</code>. Klicken Sie in der linken Spalte auf <code className="action">Hosting-Pakete</code>, wählen Sie das betreffende Hosting aus, und klicken Sie auf den Tab <code className="action">Datenbanken</code>.
...
OVHcloud stellt Ihnen ein Online-Tool für das Datenbankmanagement zur Verfügung: phpMyAdmin. Loggen Sie sich in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein und gehen Sie in den Bereich <code className="action">Web Cloud</code>. Klicken Sie in der linken Spalte auf <code className="action">Hosting-Pakete</code>, wählen Sie das betreffende Hosting aus, und klicken Sie dann auf den Tab <code className="action">Datenbanken</code>.
...
Geben Sie die Zugangsdaten für Ihre Datenbank ein und klicken Sie auf <code className="action">Log in</code>.
