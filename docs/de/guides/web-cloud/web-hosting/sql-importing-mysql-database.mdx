...
Loggen Sie sich hierfür im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein, klicken Sie auf <code className="action">Hosting-Pakete</code> und wählen Sie das betreffende Hosting aus. Gehen Sie dann auf den Tab <code className="action">Datenbanken</code>.
...
Loggen Sie sich auf phpMyAdmin ein, um den Import durchzuführen. Loggen Sie sich hierfür zunächst im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein, klicken Sie auf <code className="action">Hosting-Pakete</code> und wählen Sie das betreffende Hosting aus. Gehen Sie dann auf den Tab <code className="action">Datenbanken</code>.
