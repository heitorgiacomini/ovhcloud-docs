...
- Sie verfügen über ein [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) mit einer Datenbank.
- Sie haben Zugriff auf das Backup, das Sie in Ihre Datenbanken importieren möchten.
- Sie benötigen je nach der verwendeten Import-Methode Zugriff auf das OVHcloud Kundencenter oder die Login-Daten, um sich mit der Datenbank zu verbinden.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Klicken Sie auf die drei Punkte rechts neben der Datenbank, die Sie wiederherstellen möchten, und wählen Sie <code className="action">Backup wiederherstellen</code>. Bitte beachten Sie, dass der aktuelle Inhalt der Datenbank durch den Inhalt des ausgewählten Backups ersetzt wird.
    ...
    Es werden Ihnen nun alle verfügbaren Backups der ausgewählten Datenbank angezeigt. Klicken Sie auf die drei Punkte rechts neben dem Backup, das Sie wiederherstellen möchten, und gehen Sie dann auf <code className="action">Backup wiederherstellen</code>.
  </Tab>
  <Tab label="Schritt 4">
    Vergewissern Sie sich, dass die Informationen im angezeigten Fenster korrekt sind, und klicken Sie dann auf <code className="action">Bestätigen</code>. Warten Sie, bis die Wiederherstellung abgeschlossen ist.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Klicken Sie auf die drei Punkte rechts neben der Datenbank, in die Sie die Daten importieren möchten, und wählen Sie dann <code className="action">Datei importieren</code>.
  ...
  <Tab label="Schritt 4">
    Wählen Sie im angezeigten Fenster <code className="action">Neue Datei importieren</code> und klicken Sie anschließend auf <code className="action">Weiter</code>.
  ...
  <Tab label="Schritt 5">
    ...
    :::info
    Über den Button <code className="action">Vorhandene Datei verwenden</code> können Sie die Daten einer bereits an das Import-Tool versendeten Datei erneut importieren.
    :::
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Klicken Sie auf die drei Punkte rechts neben der betreffenden Datenbank und gehen Sie dann auf <code className="action">Zugang zu phpMyAdmin</code>.
