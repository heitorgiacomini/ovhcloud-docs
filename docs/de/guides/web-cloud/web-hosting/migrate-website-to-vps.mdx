...
description: Erfahren Sie, wie Sie Ihre Website von einem Webhosting auf einen OVHcloud VPS migrieren
...
Wenn Sie WordPress verwenden, folgen Sie unserer Anleitung „[Backup Ihrer WordPress Installation](/guides/web-cloud/web-hosting/how-to-backup-your-wordpress)“, um zu erfahren, wie Sie die Dateien und Datenbanken Ihrer WordPress-Website sichern, und fahren Sie dann mit [Schritt 2](#step2) fort.

#### Schritt 1.1 - Verbindung mit dem FTP-Speicherplatz Ihres Webhostings

Folgen Sie den Schritten unserer Anleitung „[Mit dem FTP-Speicherplatz eines Webhostings verbinden](/guides/web-cloud/web-hosting/ftp-connection)“, um sich mit dem FTP-Speicherplatz Ihres Webhostings zu verbinden.
...
Wenn Sie vorhaben, die Datenbank auf den VPS zu migrieren, folgen Sie den Schritten in unserer Anleitung „[Backup einer Webhosting-Datenbank exportieren](/guides/web-cloud/web-hosting/sql-database-export)“, um Ihre Datenbank zu sichern.

### Schritt 2 - Ihren VPS konfigurieren <a name="step2"></a>

:::info
Wenn Sie noch keinen VPS haben, besuchen Sie die [VPS-Produktseite von OVHcloud](https://www.ovhcloud.com/de/vps/). Achten Sie darauf, einen VPS zu wählen, der den Anforderungen Ihrer Website in Bezug auf Ressourcen (RAM, CPU, Storage) und die technischen Spezifikationen Ihres CMS entspricht. Wenn Sie noch nicht mit VPS vertraut sind, lesen Sie unsere Anleitung „[Erste Schritte mit einem VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)“.
:::


#### Schritt 2.1 - Verbindung mit Ihrem VPS

In der Anleitung „[Erste Schritte mit einem VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)“ erfahren Sie, wie Sie sich mit Ihrem VPS verbinden.
...
Um diese Web-Umgebung zu installieren, lesen Sie unsere Anleitung „[Web-Entwicklungsumgebung auf einem VPS oder Dedicated Server installieren](/guides/bare-metal-cloud/virtual-private-servers/install-env-web-dev-on-vps)“.
...
Folgen Sie unserer [Anleitung zur Verwendung von FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide) und verwenden Sie die folgende Konfiguration:
...
- Erstellen Sie einen Ordner `site` in `/home/debian/` (rechtsklicken → <code className="action">Verzeichnis erstellen</code>), und öffnen Sie ihn.
...
Loggen Sie sich via SSH in Ihrem VPS ein, indem Sie den Abschnitt „Mit Ihrem VPS verbinden“ unserer Anleitung „[Erste Schritte mit einem VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)“ verwenden.
...
1. Loggen Sie sich via SSH in Ihrem VPS ein, indem Sie den Abschnitt „Mit Ihrem VPS verbinden“ unserer Anleitung „[Erste Schritte mit einem VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)“ verwenden.
...
Eine vollständige Liste der bewährten Sicherheitspraktiken finden Sie in unserer Anleitung „[Einen VPS absichern](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps)“.
