...
description: Erfahren Sie hier verschiedene Informationen und technische Details zu Webhostings
...
- Sie verfügen über ein [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) in Ihrem Kunden-Account.
...
Weitere Informationen zu diesem Thema finden Sie in unserer Anleitung „[Mit dem FTP-Speicherplatz Ihres Webhostings verbinden](/guides/web-cloud/web-hosting/ftp-connection)“.
...
|Angebote|Kostenloses Hosting|Starter|Basic|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|---|
|Maximaler E-Mail-Versand pro Stunde und Dienst|10|20|100|100|200|2000|2000|2000|2000|

</Region>

<Region zones={['ca', 'apac']}>

|Angebote|Starter|Basic|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|
|Maximaler E-Mail-Versand pro Stunde und Dienst|20|100|100|200|2000|2000|2000|2000|
...
- [Verfolgen und verwalten Sie die automatisierten E-Mails Ihres Webhostings](/guides/web-cloud/web-hosting/mail-function-script-records)
- [Use Case - Tipps nach dem Hacken Ihrer Website](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked)
...
Weitere Informationen hierzu finden Sie auf der [Webhosting Produktseite](https://www.ovhcloud.com/de/web-hosting/) und unserer Anleitung „[Erste Schritte mit Ihrem Angebot Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)“.
...
Weitere Informationen zur Verwaltung von Datenbanken und zur Verbindung mit dem *phpMyAdmin* Interface finden Sie in der Anleitung „[Eine Datenbank auf Ihrem Webhosting erstellen](/guides/web-cloud/web-hosting/sql-create-database)“.
...
Weitere Informationen zu diesem Thema finden Sie in unserer Anleitung „[Webhosting: Umgebung, PHP-Version, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting)“
...
Auf dieser Seite finden Sie die für Ihr Webhosting verfügbaren Bibliotheken, Sprachen und Versionen: [https://webhosting-infos.hosting.ovh.net](https://webhosting-infos.hosting.ovh.net).

<Region zones={['eu']}>
Die technischen Details des Angebots CloudWeb können Sie über folgenden Link einsehen: [https://cloudweb-infos.hosting.ovh.net/](https://cloudweb-infos.hosting.ovh.net/).
</Region>
...
In unserer Dokumentation erfahren Sie, wie Sie sich mit dem [FTP-Speicherplatz Ihres Webhostings verbinden](/guides/web-cloud/web-hosting/ftp-connection) oder [den FTP-Speicherplatz Ihres Webhostings wiederherstellen](/guides/web-cloud/web-hosting/ftp-save-and-backup).
...
Für in Webhostings enthalten Datenbanken oder Datenbankserver (Web Cloud Databases) in Gravelines (GRA), Frankreich und Beauharnois (BHS), Kanada wird täglich ein Backup der Datenbanken durchgeführt. Diese Backups sind verfügbar (über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder über die [OVHcloud API](https://eu.api.ovh.com/)). Die Backups werden zusätzlich auf einer anderen Infrastruktur gespeichert. Diese Daten werden in einem Rechenzentrum in Straßburg (SBG) repliziert. Die Aufbewahrungsfrist für Backups beträgt 30 Tage.

In unserer Dokumentation erfahren Sie, wie Sie [Backups einer Webhosting-Datenbank abrufen](/guides/web-cloud/web-hosting/sql-database-export).
...
[FTP-Speicherplatz Ihres Webhostings wiederherstellen](/guides/web-cloud/web-hosting/ftp-save-and-backup)
