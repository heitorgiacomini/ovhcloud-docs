...
Wenn Sie eine neue Datenbank bei OVHcloud erstellen möchten, loggen Sie sich im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein und klicken Sie auf <code className="action">Hosting-Pakete</code>. Wählen Sie das gewünschte Hosting aus und gehen Sie dann auf den Tab <code className="action">Datenbanken</code>.
