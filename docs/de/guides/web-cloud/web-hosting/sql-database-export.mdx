...
- Sie haben ein [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/), das eine Datenbank enthält.
- Je nach der verwendeten Backup-Methode benötigen Sie Zugriff auf die Verwaltung Ihres Webhostings über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder die Login-Daten der Datenbank.
...
- **Backup über SSH-Zugang erstellen**: Loggen Sie sich hierfür via SSH in Ihren FTP-Speicherbereich ein und verwenden Sie die Kommandozeile, um mit diesem zu interagieren. Für diesen Zugriffstyp sind fortgeschrittene Kenntnisse sowie ein kompatibles [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) erforderlich.
...
Bleiben Sie im Tab <code className="action">Datenbanken</code> und klicken Sie auf den Button <code className="action">...</code> rechts neben der zu sichernden Datenbank und dann auf <code className="action">Backup erstellen</code>.
...
Bleiben Sie im Tab <code className="action">Datenbanken</code> und klicken Sie auf den Button <code className="action">...</code> rechts neben der zu sichernden Datenbank und dann auf <code className="action">Backup wiederherstellen</code>.
...
Um ein Backup herunterzuladen klicken Sie auf den Button <code className="action">...</code> rechts von dem Backup, das Sie wiederherstellen möchten, und dann auf <code className="action">Backup herunterladen</code>. Es erscheint ein Fenster, in dem Sie dazu aufgefordert werden, das Backup auf Ihrem Rechner zu speichern. Akzeptieren und warten, bis die Sicherung heruntergeladen wurde.
...
Loggen Sie sich hierzu auf *phpMyAdmin* ein. Um den Link für den Zugriff darauf zu erfahren, loggen Sie sich in Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein und gehen Sie dann in den Bereich <code className="action">Web Cloud</code>. Klicken Sie in der linken Spalte auf <code className="action">Hosting-Pakete</code> und wählen Sie das betreffende Hosting aus. Gehen Sie dann auf den Tab <code className="action">Datenbanken</code>.

Die angezeigte Tabelle enthält alle Datenbanken, die im Rahmen Ihres Webhosting Angebots erstellt wurden. Klicken Sie auf den Button <code className="action">...</code> rechts neben der betreffenden Datenbank und dann auf <code className="action">Zugang zu phpMyAdmin</code>.
...
Nachdem Sie das Backup-Skript erstellt haben, plazieren Sie es auf dem Speicherplatz Ihres Webhostings. Weitere Informationen hierzu finden Sie in Schritt 2 der [Anleitung zur Nutzung von FTP](/guides/web-cloud/web-hosting/hosting-how-to-get-my-website-online).
