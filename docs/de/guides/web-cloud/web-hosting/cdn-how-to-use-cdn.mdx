...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Suchen Sie auf der angezeigten Seite den Eintrag **CDN-Option**. Klicken Sie auf <code className="action">...</code> rechts daneben, dann auf <code className="action">CDN bestellen</code> oder <code className="action">Option aktivieren</code>, wenn die CDN-Option bereits in Ihrem Hosting enthalten ist.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    ...
    Klicken Sie anschließend auf den Button <code className="action">⁝</code> rechts neben dem gewünschten Domainnamen oder Subdomain und dann auf <code className="action">CDN Aktivieren</code>.
  ...
  <Tab label="Schritt 4">
    Klicken Sie in dem geöffneten Fenster auf <code className="action">Bestätigen</code>, um den CDN zu aktivieren.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    ...
    Klicken Sie anschließend auf den Button <code className="action">⁝</code> rechts neben dem gewünschten Domainnamen oder Subdomain und dann auf <code className="action">CDN leeren</code>.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    ...
    Klicken Sie anschließend auf den Button <code className="action">⁝</code> rechts neben dem gewünschten Domainnamen oder Subdomain und dann auf <code className="action">CDN bearbeiten</code>.
...
<Tabs>
  ...
  <Tab label="Schritt 4">
    ...
    - **Advanced Purge**: Individualiseren Sie die Leerung, indem Sie die zu löschenden Elemente des Caches auswählen: die gesamte Webseite, ein Ordner, eine URI, eine Dateierweiterung oder einen regulären Ausdruck. 
       ...
       Gehen Sie zum Tab <code className="action">Meine Seiten</code>, klicken Sie auf die Schaltfläche <code className="action">⁝</code> rechts neben dem betreffenden Domain- oder Subdomain-Namen und dann auf <code className="action">CDN leeren</code>. 
...
Diese Änderung erfolgt automatisch, wenn die aktive DNS-Zone Ihres Domainnamens auch über den <ManagerLink to="/">OVHcloud Account</ManagerLink> verwaltet wird, der Ihr Webhosting enthält.
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Suchen Sie den Eintrag **CDN-Option**. Klicken Sie auf <code className="action">...</code> rechts daneben und danach auf <code className="action">CDN kündigen</code>.
