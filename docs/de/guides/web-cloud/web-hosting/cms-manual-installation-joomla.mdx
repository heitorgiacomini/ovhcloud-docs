...
:::tip
Um Joomla! **automatisch** in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> zu installieren, lesen Sie unsere Anleitung zur [Installation Ihrer Website mit 1-Klick-Modulen](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
...
- *Enter the database name*: Dieser Name wurde bei der Erstellung der Datenbank im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> definiert. Er ist identisch mit dem Benutzernamen der Datenbank, wenn Sie eine Datenbank verwenden, die in Ihrem Webhosting enthalten ist.
