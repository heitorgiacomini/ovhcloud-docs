...
description: Diese Anleitung erklärt, wie Sie Ihre Website über eine IPv6-Adresse verfügbar machen
...
Um zu überprüfen, ob Ihre Website bereits eine IPv6-Adresse verwendet, können Sie Ihre URL auf der Website [test-ipv6.run](https://test-ipv6.run/domain-checker) eingeben. Es wird geprüft, ob Ihre Website auf dieses IP-Protokoll reagiert. Ist das nicht der Fall, führen Sie die nachfolgenden Schritte aus.
...
Wenn die aktive DNS-Zone Ihrer Domain bei OVHcloud vorhanden ist, verwenden Sie unsere Anleitungen „[Bearbeiten der OVHcloud DNS-Zone](/guides/web-cloud/domains/dns-zone-edit)“ und „[Alle Informationen zu DNS-Einträgen](/guides/web-cloud/domains/dns-zone-records)“, um einen DNS-Eintrag vom Typ **AAAA** zu erstellen.
