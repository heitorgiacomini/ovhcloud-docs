...
description: Erfahren Sie hier, wie Sie Latenzen auf Webseiten analysieren und verbessern können
...
Informationen zum Aktualisieren von PHP finden Sie in [dieser Anleitung](/guides/web-cloud/web-hosting/configure-your-web-hosting).

Informationen zur Verwendung von PHP-FPM in der _stabilen_ Version oder Details zu erweiterten Optionen Ihres Webhostings finden Sie in [dieser Anleitung](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Sie können direkt über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> auf Ihre Logs, Statistiken und Verlaufsdiagramme zugreifen.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Klicken Sie anschließend auf den Button <code className="action">Die Statistiken anzeigen</code> angezeigt, um auf die Besucherstatistiken der Website zuzugreifen, oder auf <code className="action">Die Logs einsehen</code>, um die für Ihr Webhosting verfügbaren Logs anzuzeigen.
...
1. Klicken Sie in der linken Spalte auf <code className="action">Hosting-Pakete</code> und wählen Sie das betreffende Webhosting aus.
2. Klicken Sie auf den Tab <code className="action">Statistiken und Logs</code>. Scrollen Sie bis zum Ende der Seite, um die Graphen zur Webhosting-Nutzung einzusehen.
...
Entdecken Sie hier unsere [CDN Lösung](https://www.ovhcloud.com/de/web-hosting/options/cdn/).
...
**So greifen Sie über phpMyAdmin auf die Datenbank zu:** Um über phpMyAdmin auf Ihre Datenbank zuzugreifen, gehen Sie wie folgt über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> vor:

- Klicken Sie im Bereich <code className="action">Hosting-Pakete</code> auf Ihre Domain.
- Wechseln Sie zur Registerkarte <code className="action">Datenbanken</code>.
- Klicken Sie auf <code className="action">...</code> rechts neben Ihrer Datenbank, um auf phpMyAdmin zuzugreifen.
...
[Das Web Cloud Databases Angebot auf unserer Website](https://www.ovhcloud.com/de/web-cloud/databases/).

## Weiterführende Informationen

[Konfiguration Ihres Webhostings bearbeiten](/guides/web-cloud/web-hosting/configure-your-web-hosting)
