...
Wenn Sie bereits Kunde sind, kann die Bestellung auch über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ausgeführt werden. Wenn Sie eingeloggt sind, folgen Sie diesen Schritten:

- Gehen Sie auf den Tab <code className="action">Web Cloud</code>.
...
- [Email-Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/first-config)
...
- Alle Konfigurationseinstellungen finden Sie in unserer Anleitung "[Erste Schritte mit MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-generalities#2-e-mail-client-verwenden)". Sie finden dort auch Links zu den Konfigurationsanleitungen für die wichtigsten E-Mail-Clients.
