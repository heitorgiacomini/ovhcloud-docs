...
Es ist möglich, den Inhalt Ihrer OVHcloud Datenbank direkt in eine andere Ihrer OVHcloud Datenbanken zu kopieren, indem Sie eine Funktion in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> nutzen. Weitere Informationen finden Sie in unserer Anleitung „[Inhalt einer Datenbank in eine andere duplizieren](/guides/web-cloud/web-hosting/copy-database)“.
...
- [Erste Schritte mit Web Cloud Databasess](/guides/web-cloud/databases/db-getting-started)
- [Importieren Sie Ihre alte Datenbank nach Web Cloud Databasess](/guides/web-cloud/databases/db-restore-import-database)
