...
:::warning
Bevor Sie Datenbankpasswörter Ihrer Website über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ändern, aktualisieren Sie die Konfigurationsdatei Ihrer Website, damit sie weiterhin auf die Datenbank zugreifen kann.
