...
:::tip
Um PrestaShop **automatisch** in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> zu installieren, lesen Sie unsere Anleitung zur [Installation Ihrer Website mit 1-Klick-Modulen](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
...
- *Database name*: Dieser Name wurde bei der Erstellung der Datenbank im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> definiert.
