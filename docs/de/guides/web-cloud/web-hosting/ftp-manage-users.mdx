...
:::info
Diese Anleitung gilt nur für Webhostings der Reihen **Pro**, **Performance**, **Agency**, **Agency Plus** und **Agency Max**. Nur bei diesen Angeboten können mehrere FTP-Benutzer aktiviert werden.
