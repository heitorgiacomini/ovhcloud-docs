...
description: Erfahren Sie hier, wie Sie ein SSL-Zertifikat auf Ihrem OVHcloud Webhosting installieren und verwalten
...
OVHcloud bietet verschiedene Arten von SSL-Zertifikaten für die [Webhostings](https://www.ovhcloud.com/de/web-hosting/) an. Sie werden nachfolgend in dieser Anleitung beschrieben. SSL-Zertifikate sind für die Sicherheit Ihrer Website unerlässlich.
...
- Sie haben mindestens einen [Domainnamen](https://www.ovhcloud.com/de/domains/) registriert.
...
- [Webhosting - Kostenloses SSL-Zertifikat von Let's Encrypt aktivieren](/guides/web-cloud/web-hosting/ssl-letsencrypt): Kostenloses Zertifikat für unsere Webhostings verfügbar.
- [Webhosting - Sectigo DV SSL-Zertifikat aktivieren](/guides/web-cloud/web-hosting/ssl-dv): Zertifikat gültig für einen Domainnamen + dessen www Subdomain (zum Beispiel: `domain.tld` und `www.domain.tld`) oder **nur** eine Subdomain (zum Beispiel: `sub.domain.tld`).
- [Webhosting - Sectigo EV SSL-Zertifikat aktivieren](/guides/web-cloud/web-hosting/ssl-ev): Zertifikat gültig für einen Domainnamen + dessen www Subdomain (zum Beispiel: `domain.tld` und `www.domain.tld`) oder **nur** eine Subdomain (zum Beispiel: `sub.domain.tld`).
- [Webhosting - Eigenes SSL-Zertifikat installieren](/guides/web-cloud/web-hosting/ssl-custom): Wenn Sie über Ihr eigenes SSL-Zertifikat verfügen oder keine der 3 vorherigen Lösungen Ihren Bedürfnissen entspricht.
...
Da diese Überprüfung von den Einstellungen Ihrer Website abhängt, empfehlen wir Ihnen, sich an einen [spezialisierten Dienstanbieter](https://partner.ovhcloud.com/de/directory/) zu wenden. Wir können Ihnen in dieser Hinsicht keine Unterstützung bieten.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Klicken Sie in der Tabelle am unteren Rand der neu angezeigten Seite auf den Button <code className="action">⁝</code> rechts neben der Zeile für die betreffende Domain und dann auf <code className="action">SSL deaktivieren</code>.
    
    <img className="thumbnail" alt="SSL deaktivieren" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/ssl-certificates/disable-ssl.png" loading="lazy" />
  </Tab>
  <Tab label="Schritt 4">
    Bestätigen Sie im angezeigten Fenster die Deaktivierung, indem Sie auf <code className="action">Bestätigen</code> klicken.
    
    <img className="thumbnail" alt="SSL löschen" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/ssl-certificates/ssl-deletion.png" loading="lazy" />
  </Tab>
</Tabs>
...
Die IP-Adresse Ihres Webhostings finden Sie in unserer Anleitung „[Verzeichnis von IP-Adressen für die Webhosting Cluster](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip)“.  
Um die aktive DNS-Zone Ihrer Domain zu bearbeiten, lesen Sie unsere Anleitung „[Bearbeiten der OVHcloud DNS-Zone](/guides/web-cloud/domains/dns-zone-edit)“.
...
Die IP-Adressen Ihres Webhostings finden Sie in unserer Anleitung „[Verzeichnis von IP-Adressen für die Webhosting Cluster](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip)“.  
Um die aktive DNS-Zone Ihrer Domain zu bearbeiten, lesen Sie unsere Anleitung „[Bearbeiten der OVHcloud DNS-Zone](/guides/web-cloud/domains/dns-zone-edit)“.
...
Wenn nötig, lesen Sie unsere Anleitung „[Webhosting - Sectigo EV SSL-Zertifikat aktivieren](/guides/web-cloud/web-hosting/ssl-ev)“, um diese Situation zu beheben.
...
Um dies zu korrigieren, lesen Sie unsere Anleitung „[Die URL einer Website mit mod_rewrite über die .htaccess Datei umschreiben](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)“ oder wenden Sie sich an einen [spezialisierten Dienstleister](https://partner.ovhcloud.com/de/directory/), wenn Sie dabei Schwierigkeiten haben.
...
Falls nötig, lesen Sie unsere Anleitung „[Webhosting - Website auf HTTPS umstellen](/guides/web-cloud/web-hosting/ssl-activate-https-website)“ oder wenden Sie sich an einen [spezialisierten Dienstleister](https://partner.ovhcloud.com/de/directory/), wenn Sie Hilfe benötigen.
