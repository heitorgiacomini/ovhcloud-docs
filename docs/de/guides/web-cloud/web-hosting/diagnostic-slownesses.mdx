...
description: Ermitteln Sie den Ursprung der Ladezeiten Ihrer Website und erfahren Sie, wie Sie diese Situation verbessern
...
Um den Cluster und den Filer zu ermitteln, auf dem sich Ihr Webhosting befindet, konsultieren Sie: „[Webhosting - Cluster und Filer eines Webhostings finden](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer)“.
...
Legen Sie im Wurzelverzeichnis Ihrer Website auf dem [FTP-Speicherplatz Ihres Webhostings](/guides/web-cloud/web-hosting/ftp-connection) eine Datei mit dem Namen **phpinfo.php** an.
...
Loggen Sie sich in Ihrer Datenbank ein, indem Sie **Schritt 3** unserer [Anleitung zu Webhosting-Datenbanken](/guides/web-cloud/web-hosting/sql-create-database) befolgen.

Wenn Sie eine Datenbank mit **Web Cloud Databases** nutzen, lesen Sie unsere Anleitung zur [Datenbankverbindung mit Web Cloud Databases](/guides/web-cloud/databases/db-connecting-database-server).
...
:::warning
Falls Sie einen Fehler feststellen, lesen Sie unsere [Anleitung zur Behebung von Datenbankfehlern](/guides/web-cloud/web-hosting/diagnosis-database-errors). Loggen Sie sich nach der Fehlerbehebung erneut ein.
...
Überprüfen Sie die auf Ihrem Webhosting verwendete PHP-Engine, PHP-Version und Ausführungsumgebung. Lesen Sie hierzu unsere Anleitung zur [Konfiguration Ihres Webhostings](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Um die verfügbaren PHP-Versionen je nach Ausführungsumgebung zu vergleichen, lesen Sie **Schritt 2** der Anleitung zur [Konfiguration der PHP-Version auf Ihrem Hosting](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Um die ausgehenden Verbindungen Ihres Hostings zu analysieren, analysieren Sie dessen Logs vom Typ **OUT**. Weitere Informationen finden Sie in unserer Dokumentation zur [Verwendung von Hosting-Logs](/guides/web-cloud/web-hosting/logs-and-statistics).
...
Lesen Sie hierzu die Logs vom Typ **WEB** Ihres Webhostings unter Verwendung unserer Anleitung: [Die Logs Ihres Webhostings einsehen](/guides/web-cloud/web-hosting/logs-and-statistics).
...
<img className="thumbnail" alt="Firefox Netzwerk-Analyse" src="/images/assets/screens/other/browsers/diagnostic-tools/F12.png" loading="lazy" />
:::
...
Lesen Sie auch unsere Anleitung zur [Optimierung der Performance Ihrer Website](/guides/web-cloud/web-hosting/optimise-your-website-performance).
