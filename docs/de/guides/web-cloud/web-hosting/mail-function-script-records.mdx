...
Die Überwachung und Verwaltung der automatisierten E-Mails Ihres OVHcloud Webhostings erfolgt über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>.
...
Gehen Sie zum Entsperren in den Bereich <code className="action">Web Cloud</code>, klicken Sie auf <code className="action">Hosting-Pakete</code> und wählen Sie das betreffende Hosting aus der Liste aus. Klicken Sie anschließend auf den Tab <code className="action">Mehr</code> und wählen Sie <code className="action">E-Mail-Skripte</code>.

Klicken Sie dann auf <code className="action">E-Mails im Fehlerstatus</code> und warten Sie einige Minuten, bis der Versand-Dienst wieder aktiv ist.
...
Gehen Sie nach der Sicherung Ihres Hostings in den Bereich <code className="action">Web Cloud</code>, klicken Sie auf <code className="action">Hosting-Pakete</code> und wählen Sie das betreffende Hosting aus der Liste aus. Klicken Sie anschließend auf den Tab <code className="action">Mehr</code> und wählen Sie <code className="action">E-Mail-Skripte</code>.
