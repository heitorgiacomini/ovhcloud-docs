...
description: Diese Anleitung erklärt, wie Sie Ihre gehackte Website reparieren
...
- [Passwort für den Zugang zu Ihrer OVHcloud Kundenkennung ändern](/guides/account-and-service-management/account-information/manage-ovh-password)
- [Den Zugang zu Ihrem OVHcloud Kundencenter mit Zwei-Faktor-Authentifizierung absichern](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa)
- [Passwort für den Zugang zum FTP-Speicherplatz Ihres Webhostings ändern](/guides/web-cloud/web-hosting/ftp-change-password)
- [Passwort für den Zugriff auf Ihre Datenbank ändern](/guides/web-cloud/web-hosting/sql-change-password)

Wir empfehlen Ihnen auch die Verwendung eines [Passwort-Managers](/guides/account-and-service-management/account-information/manage-ovh-password#einen-passwort-manager-verwenden).
...
Folgen Sie unserer Anleitung zu [Statistiken und Logs Ihres Webhostings](/guides/web-cloud/web-hosting/logs-and-statistics), um in den "Web"-Logs nach den entsprechenden Einträgen zu suchen, die Schadcode in die Website injizieren.
...
Wenn Sie absolut sicher sind, dass es sich um eine unerwünschte IP-Adresse handelt, können Sie den Zugang zu Ihrem Hosting sperren, indem Sie unsere Dokumentation zu den [Zugriffsbeschränkungen über die Datei ".htaccess"](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website) befolgen.
...
- [SQL-Backup Ihrer Datenbank abrufen](/guides/web-cloud/web-hosting/sql-database-export)
- [SQL-Backup in Ihre Datenbank importieren](/guides/web-cloud/web-hosting/sql-importing-mysql-database)
...
Wenn sich Ihr Hosting im Zustand "Disabled" befindet, wird auch die über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verfügbare Option zur automatischen Wiederherstellung deaktiviert.
...
Um das Webhosting wiederherzustellen, befolgen Sie die Anweisungen in Schritt 4 [dieser Anleitung](/guides/web-cloud/web-hosting/diagnostic-403-forbidden).
...
Um sich mit dem Speicherplatz Ihres Hostings zu verbinden, lesen Sie [unsere Anleitung](/guides/web-cloud/web-hosting/ftp-connection).
...
Weitere Informationen zu den "CHMOD"-Rechten finden Sie im Abschnitt "Nützliche Informationen" unseres [Tutorials zur Nutzung des FTP-Clients Filezilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide#useful-information).
...
Sichern Sie Ihre Kontaktformulare mindestens mit einem "Captcha"-System ab, um zu vermeiden, dass Bots SPAM über diese Methode versenden. Wenn die "mail()"-Funktion von PHP ebenfalls auf Ihrem Hosting gesperrt wurde, lesen Sie hierzu [unsere Anleitung](/guides/web-cloud/web-hosting/mail-function-script-records), um die Sperrung zu beheben.

Lesen Sie auch unsere Anleitung zur [Sicherung Ihrer Website](/guides/web-cloud/web-hosting/secure-your-website), um das Risiko eines erneuten Hacks möglichst gering zu halten.

## Weiterführende Informationen <a name="go-further"></a>

[Mit dem Speicherplatz Ihres Webhostings verbinden](/guides/web-cloud/web-hosting/ftp-connection)

[Konfiguration Ihres Webhostings ändern](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Application Firewall aktivieren](/guides/web-cloud/web-hosting/multisites-activating-application-firewall)

[Die Performance Ihrer Website optimieren](/guides/web-cloud/web-hosting/optimise-your-website-performance)
