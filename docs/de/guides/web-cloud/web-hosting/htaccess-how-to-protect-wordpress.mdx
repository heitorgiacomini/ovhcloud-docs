...
description: Erfahren Sie hier, wie Sie Ihre WordPress Website mit einer oder mehreren htaccess-Dateien absichern
...
- Sie haben einen FTP-Client, z.B. [FileZilla](https://filezilla-project.org/) installiert, wie in unserem [Tutorial zu FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide) erläutert.

**.htaccess**-Dateien können mit Texteditoren erstellt und bearbeitet werden, zum Beispiel:

- [Notepad](https://support.microsoft.com/de-de/windows/hilfe-in-windows-editor-4d68c388-2ff2-0e7f-b706-35fb2ab88a8c) in Windows
- [TextEdit](https://support.apple.com/de-de/guide/textedit/welcome/mac) in macOS
...
Wenn Sie kein CMS verwenden, stellt Ihnen OVHcloud auch ein [Tutorial zum Schützen von Verzeichnissen oder des Verwaltungsinterface Ihrer Website über .htaccess Dateien](/guides/web-cloud/web-hosting/htaccess-protect-directory-by-password) zur Verfügung.

Kontaktieren Sie bei Fragen unsere [User Community](https://community.ovhcloud.com/community/en) oder [OVHcloud Partner](https://partner.ovhcloud.com/de/directory/). Die Support-Teams von OVHcloud werden Ihnen zu diesen Themen keine Hilfe bieten können.
:::
...
:::warning
Bevor Sie den folgenden Schritten folgen, leiten Sie HTTP-Anfragen nach HTTPS um. Folgen Sie hierzu den Anweisungen in unserer Anleitung: [Website mit SSL-Zertifikat auf HTTPS umstellen](/guides/web-cloud/web-hosting/ssl-activate-https-website#schritt-1-ssl-zertifikat-fur-das-hosting-aktivieren)
:::
...
Weitere Informationen zu diesem Thema finden Sie in unserer Anleitung zur [IP-basierten Zugriffsbeschränkung über die .htaccess-Datei](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website).
