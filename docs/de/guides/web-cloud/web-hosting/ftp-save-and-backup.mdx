...
<Region zones={['eu']}>
- Sie verfügen über ein [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) Angebot (mit Ausnahme von Cloud Web).
</Region>
...
- Der Status "Wartung" wird in Ihrem <ManagerLink to="/#/web/hosting">OVHcloud Kundencenter</ManagerLink> angezeigt.
...
Diese Login-Informationen finden Sie in unserer Anleitung ["Mit dem FTP-Speicherplatz eines Webhostings verbinden"](/guides/web-cloud/web-hosting/ftp-connection).
