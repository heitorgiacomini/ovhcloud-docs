...
description: Erfahren Sie hier, wie Sie einen Gandi-Domainnamen zu OVHcloud transferieren
...
Sobald Sie den Autorisierungscode erhalten haben, können Sie den Transfer Ihres Domainnamens durchführen, indem Sie die Schritte in unserer Anleitung "[Domainnamen zu OVHcloud transferieren](/guides/web-cloud/domains/transfer-incoming-generic-domain)" befolgen.
