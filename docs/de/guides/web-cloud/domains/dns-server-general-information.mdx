...
description: Erfahren Sie hier, welche Rolle DNS-Server spielen, was sie enthalten und wie sie mit einem Domainnamen funktionieren
...
Sie ermöglichen insbesondere die Verwendung von [Domainnamen](https://www.ovhcloud.com/de/domains/), um auf Websites zuzugreifen, ohne dass Sie sich die IP-Adresse des Servers merken müssen, auf dem diese Website gehostet ist.

<img className="thumbnail" alt="DNS-Auflösung" src="/images/assets/schemas/dns/dns-resolution.png" loading="lazy" />
...
Lesen Sie unsere Anleitung „[DNS-Server einer OVHcloud Domain bearbeiten](/guides/web-cloud/domains/dns-server-edit)“, wenn Sie diese Aktion für einen bei OVHcloud registrierten Domainnamen durchführen möchten.
...
:::tip[Success]
- Weitere Informationen zu DNS-Zonen finden Sie in unserer Anleitung „[Alle Informationen zu DNS-Zonen](/guides/web-cloud/domains/dns-zone-general-information)“.
- Lesen Sie anschließend unsere Anleitung zu [DNS-Einträgen](/guides/web-cloud/domains/dns-zone-records), um einen besseren Überblick zu erhalten.
:::
