...
description: Erfahren Sie hier, wie Sie einen Hostinger-Domainnamen zu OVHcloud transferieren
...
Für Domainnamen, die bei Hostinger registriert sind, können Sie den Sperrstatus verwalten, indem Sie den Bereich <code className="action">Domains</code> öffnen und den Domainnamen auswählen, der transferiert werden soll.
...
Um sich mit der Änderung des Inhabers eines Domainnamens vertraut zu machen, lesen Sie diese [Anleitung](/guides/web-cloud/domains/trade-domain).
