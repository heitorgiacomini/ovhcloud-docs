...
:::info
Die Erstellung / Änderung / Löschung einer DNS-Zone in Ihrem <ManagerLink to="/#/web/zone">OVHcloud Kundencenter</ManagerLink> ist kostenlos.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/billing/autorenew/services">Meine Angebote und Dienste</ManagerLink> und dann auf den Button <code className="action">...</code> rechts neben der DNS-Zone, die Sie kündigen möchten, und dann auf <code className="action">Meinen Dienst kündigen</code>.
