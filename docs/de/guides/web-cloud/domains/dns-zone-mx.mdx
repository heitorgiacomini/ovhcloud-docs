...
- Sie verfügen über einen MX Plan (enthalten in einem [Webhosting](https://www.ovhcloud.com/de/web-hosting/) oder separat bestellt), einen unserer [OVHcloud E-Mail-Dienste](https://www.ovhcloud.com/de/emails/) oder einen externen E-Mail-Dienst.
...
Nachfolgend finden Sie die Konfiguration für OVHcloud MX Plan (Standalone oder in einem [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) enthalten) und [Exchange](https://www.ovhcloud.com/de/emails-exchange/). Unsere E-Mail-Server verfügen über integrierte Antispam- und Antivirensoftware.

</Region>

<Region zones={['apac']}>

Nachfolgend finden Sie die Konfiguration für OVHcloud MX Plan (Standalone oder in einem [OVHcloud Webhosting](https://www.ovhcloud.com/de/web-hosting/) enthalten). Unsere E-Mail-Server verfügen über integrierte Antispam- und Antivirensoftware.
