...
Um den Domainnamen zu entsperren und den Transfer-Code abzurufen, folgen Sie den Schritten in der [Dokumentation von O2Switch](https://faq.o2switch.fr/espace-client/recuperer-code-de-transfert).
