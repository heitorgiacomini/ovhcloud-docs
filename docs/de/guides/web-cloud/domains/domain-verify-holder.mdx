...
Für bestimmte Erweiterungen (z. B.: .fr, .it, .es) kann der Domainadministrator direkt im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> die E-Mail-Adresse des Inhaberkontakts gemäß den in Schritt 2 dieser Seite beschriebenen Schritten ändern.
...
<Tabs>
  <Tab label="Schritt 1">
    Rufen Sie die Seite <ManagerLink to="/#/web/ongoing-operations">Laufende Vorgänge</ManagerLink> auf und wählen Sie den betreffenden Domainnamen in der angezeigten Liste aus.
