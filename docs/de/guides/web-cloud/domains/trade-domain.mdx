...
description: Erfahren Sie hier, wie Sie den Inhaber eines Domainnamens ändern oder die zugehörigen Informationen aktualisieren
...
- Ihr Kunden-Account ist der [Kontakt für Administrator und Abrechnung](/guides/account-and-service-management/account-information/managing-contacts) des entsprechenden Domainnamens.
...
- Statusaktualisierungen des Domainnamens. Öffnen Sie dazu die Seite <ManagerLink to="/#/web/ongoing-operations">Laufende Vorgänge</ManagerLink>.
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Im Bereich **Abo** finden Sie den Abschnitt **Kontakte**. Klicken Sie rechts auf den Button <code className="action">...</code> und anschließend auf <code className="action">Die Kontakte verwalten</code>.
  ...
  <Tab label="Schritt 4">
    ...
    Wenn Sie **nur** Angaben zum Inhaber bearbeiten, die keine dieser Daten betreffen, bearbeiten Sie die relevanten Felder und klicken Sie dann auf <code className="action">Bestätigen</code>. In diesem Fall ist es nicht notwendig, einen Inhaberwechsel zu beantragen. Für diesen Vorgang müssen Sie die Änderungen nicht per E-Mail bestätigen.
    
    Ist ein Inhaberwechsel erforderlich, klicken Sie unten auf den Link <code className="action">Klicken Sie hier, um fortzufahren</code>.
...
- Sobald der Inhaber geändert wurde, kann der Domainname für 60 Tage nicht [an einen anderen Registrar übertragen werden](/guides/web-cloud/domains/transfer-outgoing-domain).
...
[Verwaltung der Kontakte Ihrer Dienstleistungen](/guides/account-and-service-management/account-information/managing-contacts)
