...
<summary>Wie kann ich einen Domainnamen bei OVHcloud bestellen?</summary>


Folgen Sie diesen Schritten:

1. Öffnen Sie die [OVHcloud Website](https://www.ovhcloud.com/de/).
2. Geben Sie auf der angezeigten Seite im dafür vorgesehenen Feld den Domainnamen ein, den Sie reservieren möchten (z.B. `domain.tld`), und klicken Sie auf die Schaltfläche <code className="action">Suchen</code>.
...
4. Wenn Sie einen verfügbaren Domainnamen gefunden haben, klicken Sie auf <code className="action">Kaufen</code> und dann in der rechten Spalte auf <code className="action">Bestellung fortsetzen</code>.
5. Wählen Sie etwaige zusätzliche Optionen oder Dienste aus, die Sie zusammen mit Ihrem Domainnamen abonnieren möchten, und klicken Sie auf <code className="action">Weiter</code>, bis der Bestellvorgang Sie auffordert, sich zu authentifizieren oder ein OVHcloud Kundenkonto zu erstellen.
6. Nach der Authentifizierung mit Ihrem OVHcloud Kundenkonto können Sie die Kontaktdaten (Inhaber, Administrator, Technik) Ihres Domainnamens anpassen. Klicken Sie auf <code className="action">Weiter</code>, um zur Bestellübersicht zu gelangen.
7. Auf der Seite `Bestellübersicht` können Sie bei Bedarf die DNS-Konfiguration, die auf Ihren Domainnamen angewendet wird, ändern, indem Sie auf den Link <code className="action">Konfiguration ändern</code> klicken. Sobald Ihre Änderungen abgeschlossen sind, klicken Sie auf <code className="action">Bezahlen</code>, um zum letzten Schritt Ihrer Bestellung zu gelangen.
...
Sie können Ihren Domainnamen dann über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verwalten.
...
<summary>Wie kann ich einen Domainnamen auf dem Sekundärmarkt kaufen?</summary>
...
<summary>Wie kann ich feststellen, ob mein Domainname bei OVHcloud registriert ist?</summary>


Dazu können Sie eine [WHOIS](https://www.ovhcloud.com/de/domains/whois/)-Abfrage durchführen, um herauszufinden, wo Ihr Domainname registriert ist, und um zu überprüfen, ob Sie als Inhaber des Domainnamens eingetragen sind.
...
<summary>Wie kann ich das Ablaufdatum eines Domainnamens herausfinden?</summary>


Die schnellste Lösung ist eine [WHOIS](https://www.ovhcloud.com/de/domains/whois/)-Abfrage für den Domainnamen. Suchen Sie nach Durchführung der Abfrage im Ergebnis nach der Zeile, die dem Ablaufdatum entspricht (z.B. `Expiry Date: 2025-09-22T08:00:00Z`, `Registry Expiry Date: 2025-09-22T08:00:00Z`, usw.).
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/billing/autorenew/services">Meine Angebote und Dienste</ManagerLink>.
  </Tab>
  <Tab label="Schritt 2">
...
<summary>Wie kann ich das jährliche Ablaufdatum eines Domainnamens ändern?</summary>
...
<summary>Wie kann ich einen Tippfehler in meinem Domainnamen korrigieren?</summary>
...
<summary>Wie kann ich einen bereits bestellten Domainnamen ändern?</summary>
...
<summary>Wie kann ich einen Domainnamen löschen?</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Suchen Sie in der angezeigten Tabelle die Zeile, die Ihrem Domainnamen entspricht, klicken Sie rechts auf <code className="action">...</code> und dann auf <code className="action">Mein Abonnement kündigen</code>.
  </Tab>
  <Tab label="Schritt 3">
    Wählen Sie auf der angezeigten Seite den Kündigungsmodus (sofort oder zum Ablaufdatum des Dienstes) und klicken Sie unten auf die Schaltfläche <code className="action">Ja, kündigen</code>.
...
:::tip
Alle Details finden Sie in unserer Anleitung "[Wie kündige ich meine OVHcloud Dienste](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-cancel-services)".
...
<summary>Ich habe eine E-Mail zur Bestätigung der Inhaberinformationen meines Domainnamens erhalten. Was soll ich tun?</summary>


Wenn Sie Zweifel an der Echtheit der erhaltenen E-Mail haben, lesen Sie zunächst unsere Anleitung "[Vorsicht vor Betrug – Betrügerische E-Mails und Phishing erkennen](/guides/account-and-service-management/account-information/phishing-care)".
...
<summary>Ich habe die E-Mail zur Bestätigung der Inhaberinformationen nicht erhalten und mein Domainname ist gesperrt. Was soll ich tun?</summary>
...
<summary>Was ist ein IDN (Internationalized Domain Name)?</summary>
...
Nach der Bestellung erscheinen IDNs in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> im Format **xn--**.

Auch wenn Ihr Domainname in [internationalisierter Notation (IDN)](https://en.wikipedia.org/wiki/Internationalized_domain_name) in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> angezeigt wird, funktioniert er anderswo normal und wird normal angezeigt. Ihre Website-Adresse wird wie gewünscht angezeigt. Ihre E-Mail-Adressen werden Ihren Kontakten ebenfalls wie gewünscht angezeigt.
...
<summary>Wie kann ich einen IDN (Internationalized Domain Name) korrigieren?</summary>
...
<summary>Wie kann ich einen einzelnen Domainnamen in einem Alldom-Paket verlängern?</summary>


Dazu müssen Sie mindestens als ["Rechnungskontakt"](/guides/account-and-service-management/account-information/managing-contacts) für den betreffenden Domainnamen eingetragen sein. Anschließend müssen Sie den Verlängerungsmodus des Domainnamens auf **automatische Verlängerung** umstellen.
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Klicken Sie in der angezeigten Tabelle rechts neben dem betreffenden Domainnamen auf <code className="action">...</code> in der Spalte `Aktionen` und dann auf <code className="action">Verlängerung konfigurieren</code>. Sie können dann die Verlängerung dieses Domainnamens auf den Modus **automatische Verlängerung** einstellen.
  </Tab>
</Tabs>
...
:::tip
Alle Details finden Sie in unserer Anleitung "[Verlängerung von OVHcloud Diensten](/guides/account-and-service-management/managing-billing-payments-and-services/automatic-renewal)".
...
<summary>Ist mein Domainname nach einem Inhaberwechsel übertragbar?</summary>
...
<summary>Mein Domainname ist für 60 Tage gegen Transfer gesperrt. Was soll ich tun?</summary>
...
<summary>Ich kann meinen Domainnamen nicht in meinem Kundencenter finden. Was soll ich tun?</summary>


Führen Sie zunächst eine [WHOIS](https://www.ovhcloud.com/de/domains/whois/)-Abfrage durch, um herauszufinden, wo Ihr Domainname registriert ist, und um zu überprüfen, ob Sie als Inhaber des Domainnamens eingetragen sind.

Fall 1.A – Ihr Domainname ist bei OVHcloud registriert und Sie sind als Inhaber eingetragen:

Führen Sie ein [Verfahren zur Kontaktwiederherstellung](https://www.ovh.de/cgi-bin/de/procedure/procedureChangeContacts.cgi) durch, damit Ihr Domainname vollständig in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verwaltet wird. So müssen Sie die Person, die Ihren Domainnamen zuvor verwaltet hat, nicht mehr kontaktieren.
...
Sie können jedoch versuchen, die Person oder Organisation über die Anweisungen in [diesem Formular](https://www.ovhcloud.com/de/lp/request-ovhcloud-registered-domain/) zu kontaktieren.
...
<summary>Ich kann die Person, die meinen Domainnamen verwaltet, nicht kontaktieren. Was soll ich tun?</summary>


Führen Sie zunächst eine [WHOIS](https://www.ovhcloud.com/de/domains/whois/)-Abfrage durch, um zu überprüfen, ob Sie als Inhaber des Domainnamens eingetragen sind.
...
<summary>Kann ich meinen Domainnamen verkaufen?</summary>
...
:::info
Die Änderung einer DNS-Zone ist ein sensibler Vorgang und kann zu Unterbrechungen der mit Ihrem Domainnamen verbundenen Dienste führen (Webhosting, E-Mail usw.). Kontaktieren Sie im Zweifelsfall einen [spezialisierten Dienstleister](https://partner.ovhcloud.com/de/directory/).
...
<summary>Was ist eine DNS-Zone?</summary>
...
:::tip
Alle Details finden Sie in unserer Anleitung "[Alles über DNS-Zonen](/guides/web-cloud/domains/dns-zone-general-information)".
...
<summary>Was ist ein DNS-Eintrag?</summary>
...
- Allgemeine Informationen:
    - [Alles über DNS-Einträge](/guides/web-cloud/domains/dns-zone-records)
- DNS-Pointer-Einträge:
    - [Einen DNS-A-Eintrag für einen Domainnamen hinzufügen](/guides/web-cloud/domains/dns-zone-a-record-creation)
    - [Einen DNS-AAAA-Eintrag für einen Domainnamen hinzufügen](/guides/web-cloud/domains/dns-zone-aaaa-record-creation)
    - [Einen DNS-CNAME-Eintrag für einen Domainnamen hinzufügen](/guides/web-cloud/domains/dns-zone-cname-record-creation)
- Erweiterte DNS-Einträge:
    - [Einen DNS-TXT-Eintrag für einen Domainnamen hinzufügen](/guides/web-cloud/domains/dns-zone-txt-record-creation)
- DNS-E-Mail-Einträge:
    - [MX-Eintrag für die E-Mail-Verwaltung konfigurieren](/guides/web-cloud/domains/dns-zone-mx)
    - [E-Mail-Sicherheit mit einem SPF-Eintrag verbessern](/guides/web-cloud/domains/dns-zone-spf)
    - [E-Mail-Sicherheit mit einem DKIM-Eintrag verbessern](/guides/web-cloud/domains/dns-zone-dkim)
    - [E-Mail-Sicherheit mit einem DMARC-Eintrag verbessern](/guides/web-cloud/domains/dns-zone-dmarc)
...
<summary>Welche DNS-Einträge sind in einer OVHcloud DNS-Zone verfügbar?</summary>
...
<summary>Kann ich die in meiner OVHcloud DNS-Zone deklarierten DNS-Server ändern?</summary>
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/web-domains/domain">Domainnamen</ManagerLink>, und wählen Sie den betreffenden Domainnamen aus.
  ...
  <Tab label="Schritt 2">
    Wählen Sie den Tab <code className="action">DNS-Server</code> aus, sobald Sie sich auf dem betreffenden Domainnamen befinden.
  </Tab>
  <Tab label="Schritt 3">
    Klicken Sie auf die Schaltfläche <code className="action">DNS-Server ändern</code> rechts neben der Tabelle "DNS-Server". Je nach Bildschirmauflösung kann sich die Schaltfläche unterhalb der Tabelle befinden.
...
:::tip
Alle Details finden Sie in unserer Anleitung "[DNS-Server eines OVHcloud Domainnamens ändern](/guides/web-cloud/domains/dns-server-edit)".
...
<summary>Was ist der Unterschied zwischen einem A-Eintrag (IPv4) und einem AAAA-Eintrag (IPv6)?</summary>
...
- [Einen DNS-A-Eintrag für einen Domainnamen hinzufügen](/guides/web-cloud/domains/dns-zone-a-record-creation)
- [Einen DNS-AAAA-Eintrag für einen Domainnamen hinzufügen](/guides/web-cloud/domains/dns-zone-aaaa-record-creation)
- [IPv6 für Ihre Website konfigurieren](/guides/web-cloud/web-hosting/configure-ipv6)
...
<summary>Wie kann ich einen PTR-Eintrag für meine externe IP bei OVHcloud konfigurieren?</summary>
...
:::tip
Alle Details finden Sie in unserer Anleitung "[Alles über DNS-Einträge](/guides/web-cloud/domains/dns-zone-records)".
...
<summary>Wie kann ich die Standard-TTL in meiner OVHcloud DNS-Zone ändern?</summary>
...
<summary>Was ist ein SOA-DNS-Eintrag?</summary>
...
<summary>Wie kann ich die Konfiguration meiner DNS-Zone überprüfen?</summary>
...
<summary>Wie kann ich die Propagation von Änderungen in meiner DNS-Zone überprüfen?</summary>
...
<summary>Wie kann ich eine DNS-Zone wiederherstellen?</summary>
...
:::tip
Alle Details finden Sie in unserer Anleitung "[Verlauf einer DNS-Zone verwalten](/guides/web-cloud/domains/dns-zone-history)".
...
<summary>Wie kann ich eine Kopie meiner DNS-Zone abrufen?</summary>
...
<summary>Kann ich eine DNS-Zone für eine Subdomain erstellen?</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Wählen Sie nach erfolgreicher Überprüfung, ob Sie die minimalen Einträge für die zu erstellende DNS-Zone aktivieren möchten. Diese Auswahl ist nicht endgültig, da Sie die [DNS-Zonen-Einträge jederzeit bearbeiten](/guides/web-cloud/domains/dns-zone-edit) können.
  </Tab>
  <Tab label="Schritt 4">
...
<summary>Wie kann ich alle Subdomains desselben Domainnamens auf dieselbe IP-Adresse umleiten?</summary>
...
<summary>Kann ich einen Wildcard in meiner DNS-Zone einrichten?</summary>
...
<summary>Ich habe versehentlich meine DNS-Zone gelöscht und möchte sie wiederherstellen. Was soll ich tun?</summary>
...
:::tip
Wenn Sie diese E-Mail nicht erhalten haben, überprüfen Sie Ihren Spam-Ordner oder gehen Sie auf die Seite <ManagerLink to="/#/account/useraccount/dashboard">Mein Account</ManagerLink>, und klicken Sie auf den Tab <code className="action">Empfangene E-Mails</code>.
...
- [OVHcloud DNS-Zone für einen Domainnamen erstellen](/guides/web-cloud/domains/dns-zone-create)
- [OVHcloud DNS-Zone bearbeiten](/guides/web-cloud/domains/dns-zone-edit)
- [Verlauf einer DNS-Zone verwalten](/guides/web-cloud/domains/dns-zone-history)
...
<summary>Wie kann ich eine Anfrage zur Löschung einer DNS-Zone stornieren?</summary>
...
<summary>Ich kann keine DNS-Zone für meinen Domainnamen aktivieren. Was soll ich tun?</summary>
...
<summary>Warum finde ich den Tab "GLUE" nicht in meinem OVHcloud Kundencenter?</summary>


Diese Funktion ist nicht für alle Domainendungen verfügbar.
Wenn der Tab in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> nicht angezeigt wird, bedeutet dies, dass die Option "GLUE" für Ihren Domainnamen nicht verfügbar ist.

:::tip
Alle Details finden Sie in unserer Anleitung "[DNS-Server eines Domainnamens anpassen (Glue Records)](/guides/web-cloud/domains/glue-registry)".
...
:::info
Die Änderung von DNS-Servern ist ein sensibler Vorgang und kann zu Unterbrechungen der mit Ihrem Domainnamen verbundenen Dienste führen (Webhosting, E-Mail usw.). Kontaktieren Sie im Zweifelsfall einen [spezialisierten Dienstleister](https://partner.ovhcloud.com/de/directory/).
...
<summary>Wie kann ich meine DNS-Server ändern?</summary>
...
<summary>Wie kann ich meine DNS-Server anpassen?</summary>
...
<summary>Wie kann ich meine DNS-Server durch die von OVHcloud bereitgestellten ersetzen?</summary>
...
<summary>In meinem Kundencenter erscheint eine Fehlermeldung, dass ich nicht die OVHcloud DNS-Server für meinen Domainnamen verwende. Was soll ich tun?</summary>


In Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> zeigt diese Meldung lediglich an, dass die für Ihren Domainnamen erstellte DNS-Zone nicht dessen aktive DNS-Zone ist.
...
<summary>Ich kann die DNS-Server eines Domainnamens nicht über mein OVHcloud Kundencenter ändern. Was soll ich tun?</summary>
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/web-domains/domain">Domainnamen</ManagerLink>, und überprüfen Sie, ob der betreffende Domainname angezeigt wird.
  ...
  <Tab label="Schritt 2">
    **Fall 1** – Der Domainname erscheint nicht in der Liste:
    ...
    Das bedeutet, dass der Domainname nicht über Ihr OVHcloud Kundencenter verwaltet wird. Führen Sie eine [WHOIS](https://www.ovhcloud.com/de/domains/whois/)-Abfrage durch, um herauszufinden, wo er registriert ist.
    
    Sie können dann eine der folgenden Aktionen durchführen (wenn Sie der im WHOIS des Domainnamens deklarierte Inhaber sind):
    
    - Der Domainname ist bei OVHcloud registriert: Sie können ein [Verfahren zur Kontaktwiederherstellung](https://www.ovh.de/cgi-bin/de/procedure/procedureChangeContacts.cgi) durchführen, damit Ihr Domainname in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verwaltet wird.
    - Der Domainname ist nicht bei OVHcloud registriert: Sie können einen [eingehenden Transfer](/guides/web-cloud/domains/transfer-incoming-generic-domain) zu OVHcloud durchführen, damit Ihr Domainname in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verwaltet wird.
    
    **Fall 2** – Der Domainname erscheint in der Liste:
    
    Das bedeutet, dass Sie nicht über ausreichende Rechte verfügen, um den Domainnamen über Ihr OVHcloud Kundencenter zu verwalten. Führen Sie eine [WHOIS](https://www.ovhcloud.com/de/domains/whois/)-Abfrage durch, um zu überprüfen, ob Sie als Inhaber des Domainnamens eingetragen sind.
    
    Sie können dann ein [Verfahren zur Kontaktwiederherstellung](https://www.ovh.de/cgi-bin/de/procedure/procedureChangeContacts.cgi) durchführen, damit Ihr Domainname vollständig in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verwaltet wird.
  </Tab>
</Tabs>
...
[FAQ zu OVHcloud E-Mails](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/faq-emails)

[FAQ zum Webhosting](/guides/web-cloud/web-hosting/faq)
