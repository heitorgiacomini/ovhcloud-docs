...
Identifizieren Sie alle vorhandenen "A"-Einträge für Ihren Domainnamen allein (z.B. `mydomain.ovh.`) und für die Subdomain "www" (z.B. `www.mydomain.ovh.`).
    ...
    **2 - Löschung:** Löschen Sie alle vorhandenen "A"-Einträge für die Subdomain "www". Wenn mehr als 4 "A"-Einträge für den Domainnamen allein vorhanden sind, löschen Sie die überzähligen Einträge, sodass nur 4 übrig bleiben. Klicken Sie für jeden zu löschenden Eintrag auf den Button <code className="action">...</code> rechts in der entsprechenden Zeile und dann auf <code className="action">Eintrag löschen</code>.
    
    **3 - Änderung:** Ändern Sie jeden verbleibenden "A"-Eintrag für den Domainnamen allein, indem Sie auf den Button <code className="action">...</code> und dann auf <code className="action">Eintrag bearbeiten</code> klicken. Ersetzen Sie das Ziel durch eine der 4 IPv4-Adressen von Google Sites (eine andere Adresse pro Eintrag):
    ...
    **4 - Hinzufügen:** Wenn weniger als 4 "A"-Einträge vorhanden waren, erstellen Sie die fehlenden Einträge. Klicken Sie oben rechts auf <code className="action">Eintrag hinzufügen</code>, wählen Sie den Eintragstyp <code className="action">A</code>, lassen Sie das Feld **Subdomain** leer und geben Sie im Feld **Ziel** jede noch nicht zugewiesene IPv4-Adresse ein. Klicken Sie auf <code className="action">Weiter</code> und bestätigen Sie.
...
Identifizieren Sie alle vorhandenen "TXT"-Einträge für Ihren Domainnamen allein (z.B. `mydomain.ovh.`) und für die Subdomain "www" (z.B. `www.mydomain.ovh.`).
    ...
    **3 - Hinzufügen:** Erstellen Sie einen TXT-Verifizierungseintrag. Klicken Sie oben rechts auf <code className="action">Eintrag hinzufügen</code>, wählen Sie den Eintragstyp <code className="action">TXT</code>. Füllen Sie die Felder **Subdomain** und **Ziel** mit den Informationen von der Seite "[TXT record values](https://support.google.com/a/answer/2716802?hl=de&ref_topic=2716886&sjid=3052810298579211755-EU)" der offiziellen Dokumentation aus. In der Regel ist das Feld **Subdomain** leer und der Wert im Feld **Ziel** hat das Format `google-site-verification=XXXXXXXXXXXX`. Klicken Sie auf <code className="action">Weiter</code> und bestätigen Sie.
...
Identifizieren Sie alle vorhandenen "CNAME"-Einträge für die Subdomain "www" (z.B. `www.mydomain.ovh.`).
    ...
    **3 - Änderung:** Wenn ein "CNAME"-Eintrag für die Subdomain "www" vorhanden ist, klicken Sie auf den Button <code className="action">...</code> und dann auf <code className="action">Eintrag bearbeiten</code>. Ersetzen Sie nur das **Ziel** durch `ghs.googlehosted.com.`. Klicken Sie auf <code className="action">Weiter</code> und bestätigen Sie.
    
    Wenn kein "CNAME"-Eintrag für die Subdomain "www" vorhanden ist, klicken Sie oben rechts auf <code className="action">Eintrag hinzufügen</code>, wählen Sie den Eintragstyp <code className="action">CNAME</code>, geben Sie `www` im Feld **Subdomain** und `ghs.googlehosted.com.` im Feld **Ziel** ein. Klicken Sie auf <code className="action">Weiter</code> und bestätigen Sie.
