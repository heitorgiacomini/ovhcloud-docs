...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/web/zone">DNS-Zone</ManagerLink>, dann auf den Button <code className="action">Bestellen</code>.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/web/zone">DNS-Zone</ManagerLink>, dann wählen Sie die Subdomain aus.
