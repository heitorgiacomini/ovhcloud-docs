...
<img className="thumbnail" alt="E-Mail" src="/images/assets/schemas/emails/dns-dkim-send.gif" loading="lazy" />
...
<img className="thumbnail" alt="E-Mail" src="/images/assets/schemas/emails/dns-dkim-receive.gif" loading="lazy" />
