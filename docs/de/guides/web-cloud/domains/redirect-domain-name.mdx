...
- **Über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>**, in dem ein Konfigurationsassistent Ihre Weiterleitung einrichten kann.
...
Achtung: Eine über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> erstellte Weiterleitung erlaubt nicht die Weiterleitung einer `https://`-URL auf einen anderen Domainnamen oder eine andere URL.
...
Neben Weiterleitungen, die auf DNS-Einträge vom Typ A, AAAA und CNAME verweisen, sind über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> 3 Weiterleitungsoptionen verfügbar.
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Gif1" src="/images/assets/schemas/domains/visible-redirection.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Gif2" src="/images/assets/schemas/domains/invisible-redirection.mp4" />
