---
title: Alle Informationen zur DNS-Zone
description: Erfahren Sie hier, welche Rolle eine DNS-Zone spielt und welche Einträge sie für einen Domainnamen enthält
...
Für ein besseres Verständnis empfehlen wir Ihnen vorab unsere Anleitung „[Alle Informationen zu DNS-Servern](/guides/web-cloud/domains/dns-server-general-information)“.
...
Weitere Informationen finden Sie in unserer Dokumentation: [Funktionsweise eines DNS-Servers](https://www.ovhcloud.com/de/domains/dns-server/).
...
Weitere Informationen zu den verschiedenen Eintragstypen finden Sie in unserer Anleitung zu [DNS-Einträgen](/guides/web-cloud/domains/dns-zone-records). Dort finden Sie Elemente, die Ihnen zum Beispiel ein besseres Verständnis der [Bearbeitung einer OVHcloud DNS-Zone](/guides/web-cloud/domains/dns-zone-edit) ermöglichen.
...
<img className="thumbnail" alt="DNS zone dashboard" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/dns-zone/dns-zone-dashboard.png" loading="lazy" />
...
Für E-Mails gibt die DNS Zone an, dass DNS-Anfragen für E-Mail-Adressen mit der Endung *@domain.tld* prioritär an den Server *mx1.mail.ovh.ca* gesendet werden sollen. Wenn die Antwort zu lange dauert oder nicht verfügbar ist, wird die Anfrage an den Server *mx2.mail.ovh.ca* weitergeleitet, bis der letzte gemeldete Server *mx3.mail.ovh.ca* erreicht ist.
