...
- Sie haben Zugriff auf Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> mit den erforderlichen [Berechtigungen zur Verwaltung](/guides/account-and-service-management/account-information/managing-contacts) des Domainnamens (Rechnungskontakt).
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/billing/autorenew/services">Meine Angebote und Dienste</ManagerLink>. Identifizieren Sie in der Tabelle den oder die Domainnamen, deren Verlängerungsmodus Sie ändern möchten.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/billing/autorenew/services">Meine Angebote und Dienste</ManagerLink>. Identifizieren Sie in der Tabelle den Domainnamen, den Sie verlängern möchten.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/billing/autorenew/services">Meine Angebote und Dienste</ManagerLink>. Identifizieren Sie in der Tabelle den Domainnamen, den Sie kündigen möchten.
...
<Tabs>
  <Tab label="Schritt 1">
    Gehen Sie auf die Seite <ManagerLink to="/#/billing/autorenew/services">Meine Angebote und Dienste</ManagerLink>. Identifizieren Sie in der Tabelle den Domainnamen, für den Sie eine Verlängerungsrechnung bezahlen müssen.
...
[OVHcloud Dienste verlängern](/guides/account-and-service-management/managing-billing-payments-and-services/automatic-renewal)
