...
<Region zones={['ca']}>
OVHcloud bietet verschiedene E-Mail-Lösungen an: MX Plan (autonom oder in einem Webhosting-Angebot inbegriffen) und Exchange. Diese verfügen über individuelle Funktionen und können sich an verschiedene Einsatzzwecke anpassen. Ihre Bedürfnisse ändern sich? OVHcloud stellt Ihnen ein Migrationswerkzeug zur Verfügung, mit dem Sie von einer Lösung zur anderen wechseln können.
</Region>
...
<Region zones={['ca']}>
**Diese Anleitung erklärt, wie Sie einen E-Mail-Account von MX Plan zu Exchange migrieren.**
</Region>

:::warning
[OVHcloud Mail Migrator](/guides/web-cloud/email-and-collaborative-solutions/migrating/omm-migrate-email-account-to-ovhcloud) ermöglicht es Ihnen, Ihre Nachrichten von einem E-Mail-Server zu einem anderen zu migrieren.<br/>
Wenn Ihre E-Mails nur lokal gespeichert sind (POP-Konfiguration oder lokales Archiv), können Sie eine [Exportdatei aus Ihrem E-Mail-Client erstellen](/guides/web-cloud/email-and-collaborative-solutions/migrating/manual-email-migration), und anschließend [die PST-Datei über OMM importieren](/guides/web-cloud/email-and-collaborative-solutions/migrating/omm-migrate-email-account-to-ovhcloud) oder [direkt aus Ihrem E-Mail-Client importieren](/guides/web-cloud/email-and-collaborative-solutions/migrating/manual-email-migration).
...
<Region zones={['ca']}>
Weitere Informationen zum Hinzufügen eines Domainnamens finden Sie in der Hilfe zu [Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain).
</Region>
