...
<Region zones={['ca']}>
Sie möchten Ihre E-Mail-Adressen von einer Exchange-Plattform auf eine andere Exchange- oder MX Plan-Plattform migrieren. In dieser Anleitung wird ein  zweistufiger Migrationsprozess beschrieben:
</Region>
...
<Region zones={['ca']}>
Um eine MX Plan Lösung nach Exchange zu migrieren, folgen Sie unserer Anleitung [Migration einer MX Plan E-Mail-Adresse auf einen Exchange Account](/guides/web-cloud/email-and-collaborative-solutions/migrating/migration-control-panel).
</Region>
...
- [Übertragung von Rechten](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation)
