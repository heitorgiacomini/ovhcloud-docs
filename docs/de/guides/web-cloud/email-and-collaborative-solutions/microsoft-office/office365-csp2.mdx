...
description: Erfahren Sie hier, wie Sie einen Office 365 Reseller Dienst (CSP2) bei OVHcloud abonnieren und verwalten
...
- **Direkter Link:** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Klicken Sie auf <code className="action">Bestellen</code>, um den Vorgang abzuschließen.
...
Mit <i className="icons-pen"></i> können Sie die Gesamtzahl der Lizenzen des Abonnements ändern. Mit <i className="icons-bin"></i> können Sie das Abonnement und alle Lizenzen kündigen.
