...
description: Erfahren Sie hier, wie Sie einen SMTP Send Connector auf Ihrer OVHcloud Exchange Plattform hinzufügen
...
Loggen Sie sich anschließend mit Ihren Zugangsdaten in die OVHcloud API-Konsole ein. Weitere Informationen finden Sie in unserer Anleitung [Erste Schritte mit der OVHcloud API](/guides/manage-and-operate/api/first-steps).
...
Klicken Sie auf <code className="action">Execute</code> um den API-Aufruf zu starten.
...
[DNS-Zone bearbeiten](/guides/web-cloud/domains/dns-zone-edit)

[Domain zu Ihrem Exchange Dienst hinzufügen](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain)
