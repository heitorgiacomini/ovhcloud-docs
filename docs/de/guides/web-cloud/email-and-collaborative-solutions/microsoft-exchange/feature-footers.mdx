...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Exchange Signaturen" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-footers/exchange-footer-step3aag.mp4" />
