...
:::info
Für weitere Informationen zu Logs Data Platform konsultieren Sie unsere Anleitung zu [Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/introduction).
...
<Tabs>
  ...
  <Tab label="Fall 2">
    **Abonnieren eines neuen Datenstroms auf Ihrer Logs Data Platform Lösung**
    ...
    Konsultieren Sie unsere Anleitungen [Introduction to Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/introduction) und [Quick start for Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start), um diese Aktion durchzuführen.
