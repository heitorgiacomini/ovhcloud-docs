...
<Region zones={['ca']}>
Outlook Web App ist ein Interface, das für unser Angebot **Exchange** und einen Teil der Accounts **MX Plan** verwendet wird.
</Region>

<Region zones={['apac']}>
Outlook Web App ist ein Interface, das für einen Teil der Accounts **MX Plan** verwendet wird.
</Region>
