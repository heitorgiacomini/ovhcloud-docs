...
Um eine Migration per Datei oder mehrere Migrationen durchzuführen, lesen Sie die Abschnitte "Migration per Datei" und "Eine Migration per Mehrfachmigration durchführen und verfolgen (Projektmodus)" unserer Anleitung "[E-Mail-Accounts über OVHcloud Mail Migrator migrieren](/guides/web-cloud/email-and-collaborative-solutions/migrating/omm-migrate-email-account-to-ovhcloud)".
...
Um MX Plan E-Mail-Accounts  zu löschen (Beispiel: `kontakt@mydomain.ovh`), folgen Sie unserer Anleitung "[E-Mail-Account löschen](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/delete-email-account)".
