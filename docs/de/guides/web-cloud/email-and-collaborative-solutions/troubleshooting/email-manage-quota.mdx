...
- **Direktlink:** <ManagerLink to="/#/web/web/email_domain">MX Plan</ManagerLink>
...
- **Direktlink:** <ManagerLink to="/#/web/email_pro">E-Mail Pro</ManagerLink>
- **Navigationspfad:** <code className="action">Web Cloud</code> > <code className="action">E-Mail Pro</code> > Wählen Sie Ihre Plattform aus

**Exchange:**

- **Direktlink:** <ManagerLink to="/#/web/exchange">Exchange</ManagerLink>
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="E-Mail" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/email-manage-quota/email-quota-intro.mp4" />
...
Gehen Sie in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> in den Bereich <code className="action">Web Cloud</code> und folgen Sie den passenden Anweisungen für Ihren E-Mail-Dienst:
...
<ZoneTabs>
  <Tab label="MX Plan">
    Die Größe eines MX Plan Accounts kann zwischen 2,5 MB und 5 GB betragen. Sie können die Kapazität bei Bedarf über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink><br/> ändern.
...
<ZoneTabs>
  ...
  <Tab label="E-Mail Pro" availableIn={['eu']}>
    ...
    - [Windows 10 Mail](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration) (bei Windows inklusive)<br/>
    ...
    - [Mail](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration) (inklusive mit macOS)<br/>
    - [Outlook](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-macos-configuration)<br/>
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/email-pro/thunderbird-macos-configuration) (kostenlos)<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/thunderbird-windows-configuration) (kostenlos)<br/><br/>>
