...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="EML-Datei aus OWA exportieren" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa02.mp4" />
