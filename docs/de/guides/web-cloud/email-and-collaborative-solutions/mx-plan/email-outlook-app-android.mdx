---
title: MX Plan / Zimbra STARTER - Konfiguration von Outlook für Android
description: Erfahren Sie hier, wie Sie Ihre MX Plan oder Zimbra STARTER E-Mail-Adresse in der mobilen Outlook-App für Android einrichten
...
- Sie verfügen über einen MX Plan, als E-Mail-Dienst enthalten in einem [OVHcloud Webhosting-Angebot](https://www.ovhcloud.com/de/web-hosting/) oder als eigenständige Lösung.
...
- Tippen Sie auf <code className="action">Löschen</code> bei "Möchten Sie den Account löschen?".
