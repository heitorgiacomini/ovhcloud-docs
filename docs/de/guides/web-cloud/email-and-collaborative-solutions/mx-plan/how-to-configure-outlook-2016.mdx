...
<Tabs>
  ...
  <Tab label="Schritt 5">
    ...
    <Region zones={['eu']}>
    - **Server**: imap.mail.ovh.net **oder** ssl0.ovh.net
    - Port: **993**
    ...
    <Region zones={['eu']}>
    - **Server**: smtp.mail.ovh.net **oder** ssl0.ovh.net
    - Port: **465**
    - Verschlüsselungsmethode: **SSL/TLS**
    </Region>
...
<Region zones={['eu']}>
- **Accounttyp**: Wählen Sie IMAP aus
- **Eingehender E-Mail-Server**: imap.mail.ovh.net **oder** ssl0.ovh.net
- **Ausgehender E-Mail-Server (SMTP)**: smtp.mail.ovh.net **oder** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Accounttyp**: Wählen Sie IMAP aus
- **Eingehender E-Mail-Server**: imap.mail.ovh.ca
- **Ausgehender E-Mail-Server (SMTP)**: smtp.mail.ovh.ca
</Region>
...
Das Fenster ist in zwei Abschnitte unterteilt, **Eingehender Posteingang** und **Ausgehender Postausgang**. Klicken Sie auf den Abschnitt, den Sie ändern möchten.
    ...
    Diese Zahl finden Sie in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>, im Bereich <code className="action">Web Cloud</code> und anschließend <code className="action">E-Mail Pro</code>. Der Servername ist im Feld **Verbindung** des Tabs <code className="action">Allgemeine Informationen</code> sichtbar.
...
<Tabs>
  <Tab label="IMAP-Konfiguration">
    <Region zones={['eu']}>
    - **Server (empfangen)**: imap.mail.ovh.net **oder** ssl0.ovh.net.
    ...
    <Region zones={['ca', 'apac']}>
    - **Server (empfangen)**: imap.mail.ovh.ca.
    - **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
    - **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
    - **Port**: 993.
    - **Sicherheitstyp**: SSL/TLS.
  ...
  <Tab label="POP-Konfiguration">
    <Region zones={['eu']}>
    - **Server (empfangen)**: pop.mail.ovh.net **oder** ssl0.ovh.net.
    - **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
    - **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
    - **Port**: 995.
    - **Sicherheitstyp**: SSL/TLS.
    ...
    <Region zones={['ca', 'apac']}>
    - **Server (empfangen)**: pop.mail.ovh.ca.
    - **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
    - **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
    - **Port**: 995.
    - **Sicherheitstyp**: SSL/TLS.
...
<Region zones={['eu']}>
- **Server (senden)**: smtp.mail.ovh.net **oder** ssl0.ovh.net.
- **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
- **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
- **Port**: 465.
- **Sicherheitstyp**: SSL/TLS.
...
<Region zones={['ca', 'apac']}>
- **Server (senden)**: smtp.mail.ovh.ca.
- **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
- **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
- **Port**: 465.
- **Sicherheitstyp**: SSL/TLS.
