...
<Tabs>
  <Tab label="IMAP-Konfiguration">
    ...
    - **Eingangsserver**: imap.mail.ovh.net **oder** ssl0.ovh.net.
    - **Port**: 993.
    - **Sicherheitstyp**: SSL/TLS.
    </Region>
    <Region zones={['ca', 'apac']}>
    - **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
    - **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
    - **Eingangsserver**: imap.mail.ovh.ca.
    - **Port**: 993.
    - **Sicherheitstyp**: SSL/TLS.
    </Region>
  </Tab>
  <Tab label="POP-Konfiguration">
    ...
    - **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
    - **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
    - **Eingangsserver**: pop.mail.ovh.net **oder** ssl0.ovh.net.
    - **Port**: 995.
    - **Sicherheitstyp**: SSL/TLS.
    </Region>
    <Region zones={['ca', 'apac']}>
    - **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
    - **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
    - **Eingangsserver**: pop.mail.ovh.ca.
    - **Port**: 995.
    - **Sicherheitstyp**: SSL/TLS.
    </Region>
  </Tab>
...
- **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
- **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
- **Ausgangsserver**: smtp.mail.ovh.net **oder** ssl0.ovh.net.
- **Port**: 465.
- **Sicherheitstyp**: SSL/TLS.
</Region>
...
- **Benutzername**: Geben Sie die **vollständige** E-Mail-Adresse ein.
- **Passwort**: Geben Sie das Passwort des E-Mail-Accounts ein.
- **Ausgangsserver**: smtp.mail.ovh.ca.
- **Port**: 465.
- **Sicherheitstyp**: SSL/TLS.
</Region>
