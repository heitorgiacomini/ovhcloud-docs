...
description: Erfahren Sie hier, wie Sie Mailinglisten verwenden
...
Wechseln Sie zur Registerkarte <code className="action">Mailinglisten</code> Ihres E-Mail-Dienstes.
...
Um eine neue Mailingliste zu erstellen, klicken Sie auf <code className="action">Mailingliste hinzufügen</code>.
...
Um die Optionen der Mailingliste zu ändern, klicken Sie rechts davon auf <code className="action">...</code>. Sie können dann die Optionen aktualisieren, die Mailingliste löschen sowie die Abonnentenliste per E-Mail freigeben.
...
|---|---|
|Klicken Sie rechts auf <code className="action">Abonnenten hinzufügen</code>.|Klicken Sie rechts auf <code className="action">Über eine Datei entfernen</code>.|
...
- Manuelle Eingabe von Adressen durch Klicken auf <code className="action">E-Mail-Adresse hinzufügen</code>.
...
Klicken Sie auf <code className="action">Abonnenten in CSV exportieren</code>, um eine CSV-Datei mit allen Ihren Abonnenten zu erstellen. Diese Option ist in unserem Fall nicht verfügbar, da kein Abonnent hinzugefügt wurde.
...
|---|---|
|Klicken Sie rechts auf <code className="action">Moderatoren hinzufügen</code>.|Klicken Sie rechts auf <code className="action">Über eine Datei entfernen</code>.|
...
- manuelle Eingabe von Adressen durch Klicken auf <code className="action">Eine E-Mail-Adresse hinzufügen</code>.
