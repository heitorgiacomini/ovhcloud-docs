...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Ordner freigeben" src="/images/web-cloud/email-and-collaborative-solutions/using-the-outlook-web-app-webmail/owa-directory-sharing/exchange-folder-step2aag.mp4" />
...
[Berechtigungen für einen Exchange Account übertragen](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation)
