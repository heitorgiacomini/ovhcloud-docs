...
Klicken Sie auf <ManagerLink to="/#/web/email_pro">diesen Link</ManagerLink>, um zum Bereich <code className="action">E-Mail Pro</code> zu gelangen. Der Servername wird im Bereich **Verbindung** auf der Seite <code className="action">Allgemeine Informationen</code> angezeigt.
