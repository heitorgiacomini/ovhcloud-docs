...
Um Ihre E-Mail Pro-Adresse in Outlook classic zu konfigurieren, konsultieren Sie unsere Anleitung "[E-Mail Pro - Einrichten eines E-Mail-Accounts auf klassischem Outlook für Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration)".
...
Klicken Sie auf <ManagerLink to="/#/web/email_pro">diesen Link</ManagerLink>, um zum Bereich <code className="action">E-Mail Pro</code> zu gelangen.
