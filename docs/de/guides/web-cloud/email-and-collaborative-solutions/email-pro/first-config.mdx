...
description: Erfahren Sie hier, wie Sie Ihre E-Mail Pro Lösung einrichten
...
Wenn Sie Ihren E-Mail Pro Dienst gerade bestellt haben, erscheint automatisch ein Fenster mit der Aufforderung <code className="action">Eine Domain hinzufügen</code>. Sollte das Fenster nicht angezeigt werden, gehen Sie in den Tab <code className="action">Assoziierte Domains</code> und klicken Sie auf den Button <code className="action">Eine Domain hinzufügen</code>.
...
Nachdem Sie Ihre Auswahl vorgenommen haben, klicken Sie auf <code className="action">Weiter</code>.
...
Klicken Sie auf <code className="action">Weiter</code>, um die Domain hinzuzufügen.

**Wenn Sie einen von OVHcloud verwalteten Domainnamen ausgewählt haben**, kann dessen Konfiguration automatisch vorgenommen werden. Setzen Sie hierzu einen Haken im entsprechenden Feld und klicken Sie dann auf <code className="action">Weiter</code>, um mit dem Hinzufügen der Domain fortzufahren.
...
- **DKIM**: Einrichtung einer verschlüsselten digitalen Signatur zur Sicherung des E-Mail-Verkehrs. Weitere Informationen finden Sie in unserer Anleitung „[E-Mail-Sicherheit durch DKIM-Eintrag verbessern](/guides/web-cloud/domains/dns-zone-dkim)“.

**Für einen nicht von OVHcloud verwalteten Domainnamen** fahren Sie mit Schritt 3 fort.

Am Ende der Konfiguration überprüfen Sie die angezeigten Informationen. Klicken Sie danach auf <code className="action">Bestätigen</code>, um die Domain hinzufügen.
...
In der Spalte <code className="action">Diagnose</code> können Sie sehen, ob die Konfiguration der MX-Felder der Domain korrekt ist. Ein rotes Feld zeigt an, dass die Konfiguration geändert werden muss.

- **Automatische Konfiguration beim Hinzufügen eines Domainnamens von OVHcloud**: Wenn Sie gerade erst eine Änderung vorgenommen haben, kann es einige Stunden dauern, bis diese im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> angezeigt wird.
...
- **Manuelle Konfiguration einer nicht von OVHcloud verwalteten Domain**: Klicken Sie auf das rote Feld, um zu sehen, welche Änderungen notwendig sind.
    - *CNAME-Eintrag*: Folgen Sie unserer Anleitung „[CNAME-Eintrag erstellen, um eine assoziierte Domain hinzuzufügen](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-dns-cname)“.
    - *MX-Eintrag*: Folgen Sie unserer Anleitung „[MX-Eintrag zur Domainkonfiguration hinzufügen](/guides/web-cloud/domains/dns-zone-mx)“.
    - *SRV-Eintrag*: Geben Sie in Ihrer DNS-Zone die Informationen, die Sie beim Klicken auf das rote Feld erhalten haben, ein. Folgen Sie unserer Anleitung „[OVHcloud DNS-Zone bearbeiten](/guides/web-cloud/domains/dns-zone-edit)“.
    - *SPF-Eintrag*: Geben Sie in Ihrer DNS-Zone die Informationen, die Sie beim Klicken auf das rote Feld erhalten haben, ein. Folgen Sie unserer Anleitung „[E-Mail-Sicherheit durch SPF-Eintrag verbessern](/guides/web-cloud/domains/dns-zone-spf)“.
    - *DKIM-Eintrag*: Geben Sie in Ihrer DNS-Zone die Informationen, die Sie beim Klicken auf das rote Feld erhalten haben, ein. Folgen Sie unserer Anleitung „[E-Mail-Sicherheit durch DKIM-Eintrag verbessern](/guides/web-cloud/domains/dns-zone-dkim)“.
...
Zur Konfiguration Ihrer E-Mail-Accounts gehen Sie in den Tab <code className="action">E-Mail-Accounts</code>. Die Tabelle zeigt die bestellten Accounts als “*@configureme.me*” an.

Um sie zu konfigurieren klicken Sie auf <code className="action">...</code> und dann auf <code className="action">Ändern</code>.
...
Wenn alle Angaben vollständig sind, klicken Sie auf <code className="action">Weiter</code>. Überprüfen Sie die angezeigten Informationen und klicken Sie dann auf <code className="action">Bestätigen</code>, um die Konfiguration Ihres Accounts abzuschließen.

:::info
Führen Sie diesen Schritt für alle zur Verfügung stehenden Accounts durch. Sie können weitere Accounts über den Button <code className="action">Accounts bestellen</code> hinzufügen.
...
Nach Abschluss der Konfiguration können Sie Ihre E-Mail-Adressen verwenden. Dazu stellt Ihnen OVHcloud eine Online-Anwendung (*Web App*) zur Verfügung. Diese App ist über die Adresse [Webmail](https://www.ovhcloud.com/de/mail/) erreichbar. Geben Sie hier Ihre E-Mail-Adresse und das Passwort ein, um sich einzuloggen.
...
Wenn Sie Ihre E-Mail-Adresse auf einem E-Mail-Client oder einem Gerät (beispielsweise einem Smartphone oder einem Tablet) einrichten möchten, nutzen Sie hierzu die passende [E-Mail Pro Anleitung](/guides/web-cloud/email-and-collaborative-solutions/email-pro/overview). Wenn Sie nur die erforderlichen Daten zur Konfiguration Ihres E-Mail Pro Accounts benötigen, verwenden Sie die folgenden Einstellungen:
...
Der Servername wird im Kasten **Verbindung** auf der Seite <code className="action">Allgemeine Informationen</code> Ihres E-Mail Pro Dienstes angezeigt.
...
[Posteingangsregeln in OWA erstellen](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/feature-redirections)

[Einen Alias zu einem E-Mail-Account hinzufügen](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/feature-redirections)
...
[Die Abrechnung Ihrer E-Mail Pro Accounts verwalten](/guides/web-cloud/email-and-collaborative-solutions/email-pro/manage-billing-emailpro)

[Sicherheitseinstellungen eines E-Mail-Dienstes verwalten](/guides/web-cloud/email-and-collaborative-solutions/common-email-features/security-policy)
