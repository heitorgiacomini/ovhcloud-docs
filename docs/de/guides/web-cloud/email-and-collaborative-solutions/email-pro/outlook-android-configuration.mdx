...
Klicken Sie auf <ManagerLink to="/#/web/email_pro">diesen Link</ManagerLink>, um zum Bereich <code className="action">E-Mail Pro</code> zu gelangen. Der Servername wird im Feld **Verbindung** im Tab <code className="action">Allgemeine Informationen</code> angezeigt.
