...
Wenn Sie die Rechte eines bestehenden Benutzers ändern möchten, lesen Sie unsere Anleitung "[Web Cloud Databases - Benutzerrechte ändern](/guides/web-cloud/databases/db-modify-users-rights)".
...
Um eine Datenbank zu importieren, lesen Sie unsere Anleitung "[Datenbank auf Ihrem Datenbankserver wiederherstellen und importieren](/guides/web-cloud/databases/db-restore-import-database)".
...
Lesen Sie dazu die Sonderfälle in unserer Anleitung "[Web Cloud Databases - Wie kann eine IP-Adresse autorisiert werden?](/guides/web-cloud/databases/db-authorise-ip-mask)", um den Zugriff von OVHcloud Webhostings auf Ihre Web Cloud Databases zu aktivieren oder zu deaktivieren.
...
Um auf die Logs Ihrer Web Cloud Databases Lösung zuzugreifen, lesen Sie unsere Anleitung "[Web Cloud Databases - Wie können die Logs abgerufen werden?](/guides/web-cloud/databases/db-retrieve-logs)".

## Weiterführende Informationen

[Datenbanken und Benutzer auf Ihrem Datenbankserver erstellen](/guides/web-cloud/databases/db-create-databases-users)

[Verbindung mit einer Datenbank auf Ihrem Datenbankserver herstellen](/guides/web-cloud/databases/db-connecting-database-server)
...
[Ihren Datenbankserver konfigurieren](/guides/web-cloud/databases/db-configure-optimise-database-server)
