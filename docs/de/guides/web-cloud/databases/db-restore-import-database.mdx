...
Um Ihre Datenbank direkt über phpMyAdmin zu importieren, müssen Sie sich zuerst einloggen. Folgen Sie hierzu dem Abschnitt "[Mit einer MySQL oder MariaDB Datenbank verbinden](/guides/web-cloud/databases/db-connecting-database-server#mit-einer-mysql-oder-mariadb-datenbank-verbinden)".
