...
Um Ihre Datenbank direkt über phpMyAdmin zu exportieren, müssen Sie sich zuerst einloggen. Folgen Sie dazu der Anleitung "[Mit einer Datenbank verbinden](/guides/web-cloud/databases/db-connecting-database-server)".
