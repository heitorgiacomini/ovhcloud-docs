...
:::warning
Wenn Sie eine "Web Cloud Databases"/"Private SQL"-Lösung verwenden, denken Sie daran, Ihre IP-Adresse mithilfe der Anleitung zur [Konfiguration Ihres Datenbankservers](/guides/web-cloud/databases/db-configure-optimise-database-server#gerer-vos-acces) zu autorisieren.
