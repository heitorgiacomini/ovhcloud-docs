...
<Tabs>
  ...
  <Tab label="Schritt 2">
    ...
    <img className="thumbnail" alt="Allgemeine Informationen" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-cloud-databases/general-information/general-information.png" loading="lazy" />
  </Tab>
</Tabs>
...
<summary>Eine IP-Adresse autorisieren</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Klicken Sie auf den Tab <code className="action">Autorisierte IPs</code> und dann auf den Button <code className="action">IP-Adresse / Maske hinzufügen</code>.
...
<summary>Verbindungen von OVHcloud Webhostings autorisieren</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Setzen Sie einen Haken bei <code className="action">Den OVHcloud Webhostings den Zugriff auf die Datenbank erlauben</code>.
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Wählen Sie die gewünschte RAM-Größe aus und klicken Sie auf <code className="action">Weiter</code>. Danach können Sie die gewünschte Laufzeit wählen.
...
<summary>MySQL und MariaDB Instanz</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Klicken Sie auf den Tab <code className="action">Konfiguration</code>.
  </Tab>
  <Tab label="Schritt 3">
    Im Bereich **Allgemeine Konfiguration von MySQL** finden Sie die derzeit für Ihre Datenbank festgelegte Konfiguration. Sie können diese direkt bearbeiten und dann auf <code className="action">Anwenden</code> klicken.
    ...
    Nehmen Sie die erforderlichen Änderungen vor und klicken Sie auf <code className="action">Bestätigen</code>.
  </Tab>
</Tabs>
...
<summary>PostgreSQL Instanz</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 3">
    Im Bereich **Allgemeine Konfiguration von PostgreSQL** finden Sie die derzeit für Ihre Datenbank festgelegte Konfiguration. Sie können diese direkt bearbeiten und dann auf <code className="action">Anwenden</code> klicken.
    ...
    Außerdem können Sie Erweiterungen für Ihre Datenbanken aktivieren. Klicken Sie hierzu auf den Tab <code className="action">Datenbanken</code> und dann auf das Tabellensymbol der betreffenden Datenbank in der Spalte **"Erweiterungen"**.
...
<summary>Wie erfahre ich die genaue PostgreSQL-Version, die ich verwende?</summary>


Geben Sie diesen Befehl in phpPgAdmin ein, nachdem Sie auf **Ihre Datenbank** im Bereich **"SQL"** geklickt haben, und klicken Sie dann auf <code className="action">Starten</code>:
...
<summary>Wie erfahre ich die genaue MySQL- oder MariaDB-Version, die ich verwende?</summary>


Geben Sie diesen Befehl in phpMyAdmin im Bereich **"SQL"** ein und klicken Sie dann auf <code className="action">Ausführen</code>:
...
<summary>Zugang zu den Logs</summary>


Um die Logs Ihrer Web Cloud Databases Lösung einzusehen, lesen Sie unsere Anleitung "[Web Cloud Databases - Logs abrufen](/guides/web-cloud/databases/db-retrieve-logs)".
...
<summary>RAM-Nutzung überwachen</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Klicken Sie auf den Tab <code className="action">Metriken</code>. Sie finden dort die Grafik **"Statistiken zum verwendeten RAM"**.
...
<summary>Anzahl der Verbindungen pro Minute überwachen</summary>
...
<Tabs>
  ...
  <Tab label="Schritt 2">
    Klicken Sie auf den Tab <code className="action">Metriken</code>. Sie finden dort die Grafik **"Statistiken der Gesamtzahl der Verbindungen pro Minute"**.
...
<summary>Datenbank indexieren</summary>
...
<summary>Datenbank bereinigen</summary>
...
<summary>Anzeigebegrenzung</summary>
...
<summary>Anfragen gruppieren</summary>
...
<summary>Nur nützliche Daten abrufen</summary>
...
<summary>Optionen mit zu hohem Ressourcenverbrauch vermeiden</summary>
