...
![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory1.png)

You can click on the 'Date' column on the left to sort your log by send date.

![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory2.png)

The Actions `...` heading at the end of each SMS allows you to view or delete the message.

![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory3.png)
...
![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory4.png)
 
The `Filter` button allows you to filter your search by sender (if you have several senders) or by recipient.

![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory5.png)
...
![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory6.png)
...
![sms-history](/images/guides/web-cloud/messaging/sms/sms-history/smshistory7.png)
...
Further information about the ptt codes and various DLR IDs can be found in the final section of the guide [Everything you need to know about SMS users](/guides/web-cloud/messaging/sms/sms-users#step-5-specify-a-callback-url).
