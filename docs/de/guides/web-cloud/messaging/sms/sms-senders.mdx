...
- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, in the `Telecom` section, then `SMS`.

![OVHcloud Control Panel Telecom SMS](/images/assets/screens/control-panel/product-selection/telecom/tpl-telecom-03-fr-sms.png)

## Instructions

Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and select `Telecom`.

Then click on `SMS` and select your SMS account.
...
You can customise your sender. However, you will no longer be able to receive a reply from the recipient of your SMS. To access the management of SMS senders, select the `Senders` tab (1) when you are on the relevant SMS account.

![sms send control panel](/images/guides/web-cloud/messaging/sms/sms-senders/sms-send-control-panel04E.png)

If you want to add an additional SMS sender, click on the `Actions` button in the centre, then on `Add` (2).

![sms send control panel](/images/guides/web-cloud/messaging/sms/sms-senders/sms-send-control-panel05E.png)
