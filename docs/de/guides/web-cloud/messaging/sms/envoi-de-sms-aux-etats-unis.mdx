...
Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then select `Telecom`. Next, click `SMS` and select your SMS account. Click on the `Message and campaign` tab then click `SMS management`.
...
You can view the other possible return codes in [this guide](/guides/web-cloud/messaging/sms/sms-users).
