...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then select `Telecom`. Next, select `SMS`.
...
Now that your list has been imported, you can follow the instructions in our guide on [Sending SMS messages via the OVHcloud Control Panel](/guides/web-cloud/messaging/sms/send-sms-control-panel) in order to send an SMS to the recipients of this list.

## Go further

[Sending SMS messages via the OVHcloud Control Panel](/guides/web-cloud/messaging/sms/send-sms-control-panel)

[Managing SMS address books](/guides/web-cloud/messaging/sms/sms-address-books)
