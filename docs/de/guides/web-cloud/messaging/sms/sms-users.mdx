...
![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers.png)
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then select `Telecom`. Next, click `SMS` and select your SMS account.

Then click on the `API users` tab. To add a user, click `Actions`, then `Add`.

![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers01e-2021.png)
...
![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers03e-2021.png)
...
![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers04-2021.png)
...
![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers05-2021.png)
...
![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers06-2021.png)
...
![sms-users](/images/guides/web-cloud/messaging/sms/sms-users/smsusers07-2021.png)
