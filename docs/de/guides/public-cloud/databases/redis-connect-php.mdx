...
description: Connect to your Public Cloud Databases for Valkey using the PHP programming language
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide: [Connect with CLI](/guides/public-cloud/databases/redis-connect-cli).
...
- [Valkey - Capabilities and Limitations](/guides/public-cloud/databases/redis-capabilities)
- [Configuring vRack for Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack)
