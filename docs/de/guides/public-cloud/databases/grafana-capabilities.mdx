...
description: Discover the capabilities and limitations of Public Cloud Databases for Dashboards
...
Please refer to the [DBMS lifecycle policy guide](/guides/public-cloud/databases/lifecycle-policy) for recommendations on version upgrades and end of life announcements of major versions. Additionally, you can follow the Grafana® Release Cycle on their official page: [https://grafana.com/](https://grafana.com/).
...
More information on [https://raw.githubusercontent.com/grafana/grafana/main/LICENSE](https://raw.githubusercontent.com/grafana/grafana/main/LICENSE).
...
You can further customise your Dashboards by using advanced parameters. See the [Advanced parameters references documentation](/guides/public-cloud/databases/grafana-advanced-parameters-references) for more information on the supported parameters.
