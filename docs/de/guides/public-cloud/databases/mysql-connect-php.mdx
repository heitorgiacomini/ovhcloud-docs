...
description: Connect to your Public Cloud Databases for MySQL using the PHP programming language
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MySQL with CLI](/guides/public-cloud/databases/mysql-connect-cli).
...
Select the <code className="action">General Information</code> tab. In the **Login Informations** section, download the CA certificate.
