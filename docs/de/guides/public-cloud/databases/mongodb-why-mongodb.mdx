---
title: Why choose MongoDB?
description: Discover the main reasons to choose mongoDB as your database engine
...
<img className="thumbnail" alt="alt text" src="/images/public-cloud/databases/mongodb-17-why-mongodb/replicaset.png" loading="lazy" />
...
<img className="thumbnail" alt="alt text" src="/images/public-cloud/databases/mongodb-17-why-mongodb/terminology.png" loading="lazy" />
