...
<img className="thumbnail" alt="User Creation" src="/images/public-cloud/databases/mongodb-02-manage-control-panel/mongodb_02_manage_control_panel-add_user.png" loading="lazy" />

After a few seconds the user is ready with the "Enabled" status, you can then reset and note its password.

<img className="thumbnail" alt="User ready" src="/images/public-cloud/databases/mongodb-02-manage-control-panel/mongodb_02_manage_control_panel-reset_password.png" loading="lazy" />
...
<img className="thumbnail" alt="Add an IP" src="/images/public-cloud/databases/mongodb-02-manage-control-panel/mongodb_02_manage_control_panel-add_ip.png" loading="lazy" />
...
<img className="thumbnail" alt="MongoDB General Information" src="/images/public-cloud/databases/mongodb-02-manage-control-panel/mongodb_02_manage_control_panel-copy_uri.png" loading="lazy" />
