...
This guide aims at providing you with a clear and practical understanding of [Savings Plans](https://www.ovhcloud.com/de/public-cloud/savings-plan/) to help you optimise your infrastructure costs. We'll explain what Savings Plans are, how they work, and how to choose the model best suited to your specific needs. Through concrete examples, you will discover how these plans can reduce your expenditure while offering flexibility in the management of your resources.
...
[Savings Plans](https://www.ovhcloud.com/de/public-cloud/savings-plan/) are a flexible pricing model that offers lower rates than pay-as-you-go pricing, in exchange for a commitment to use the service for a given period (1, 6, 12, 24 or 36 months).
