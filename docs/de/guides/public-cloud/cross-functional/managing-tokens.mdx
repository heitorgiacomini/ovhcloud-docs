...
description: Erfahren Sie hier, wie Sie Token über die Keystone API verwenden
...
Um sich mit Horizon zu verbinden und die Datei herunterzuladen, lesen Sie [diese Anleitung](/guides/public-cloud/cross-functional/introducing-horizon).
