...
- OpenStack ist bereits [auf Ihrem System installiert](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
...
Wie in [dieser Anleitung](/guides/public-cloud/cross-functional/create-and-delete-a-user) erklärt, ist das Passwort ist nur eimalig während der Erstellung sichtbar.
