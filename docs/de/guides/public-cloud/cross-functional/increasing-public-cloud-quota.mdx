...
- Sie haben eine [gültige Zahlungsart](/guides/account-and-service-management/managing-billing-payments-and-services/manage-payment-methods) in Ihrem OVHcloud Kundencenter hinterlegt.
...
Klicken Sie im linken Menü auf <code className="action">Quota und Regionen</code> unter **Einstellungen**.

Im oberen rechten Bereich der angezeigten Seite finden Sie die Option **Quota autoscaling**:

- Um weitere Informationen zu dieser Funktion zu erhalten, klicken Sie auf das Symbol <code className="action">?</code> neben dieser Option.
...
<img className="thumbnail" alt="auto scaling" src="/images/public-cloud/cross-functional/increasing-public-cloud-quota/autoscaling.png" loading="lazy" />
...
:::info
Wenn Sie Ihre Quota erhöhen möchten und die Schaltfläche <code className="action">Quota erhöhen</code> in Ihrem Kundencenter nicht verfügbar ist, klicken Sie auf die Schaltfläche <code className="action">Kundendienst kontaktieren</code>.

:::


<img className="thumbnail" alt="Contact Support" src="/images/public-cloud/cross-functional/increasing-public-cloud-quota/contact_support_quota.png" loading="lazy" />
...
<img className="thumbnail" alt="access quota" src="/images/public-cloud/cross-functional/increasing-public-cloud-quota/raisepciquota1.png" loading="lazy" />
...
Um eine Quota-Erhöhung zu beantragen, klicken Sie auf <code className="action">Quota erhöhen</code>.

<img className="thumbnail" alt="raise-pci-quota" src="/images/public-cloud/cross-functional/increasing-public-cloud-quota/raisepciquota2.png" loading="lazy" />
...
<img className="thumbnail" alt="select quota" src="/images/public-cloud/cross-functional/increasing-public-cloud-quota/selectquotas.png" loading="lazy" />
...
Klicken Sie nach Auswahl der gewünschten Kapazität auf <code className="action">Bestätigen</code>. Ihre Zahlung wird so schnell wie möglich bearbeitet.

:::warning
**Jede manuelle Erhöhung der Quote wird unmittelbar in Rechnung gestellt.**

Nachdem Sie auf die Schaltfläche <code className="action">Bestätigen</code> geklickt haben, wird die Bestellung automatisch erstellt und der Betrag wird von Ihrer Standardzahlungsmethode abgebucht.

:::


Eine detailliertere Übersicht über Ihre Ressourcen erhalten Sie in der [Horizon-Oberfläche](https://horizon.cloud.ovh.net/auth/login/). Klicken Sie nach der Anmeldung auf <code className="action">Project</code> und dann auf <code className="action">Overview</code>.
...
**S3 Quoten**<sup>1</sup>: siehe die offizielle Dokumentation „[Object Storage - Technische Grenzen (EN)](/guides/storage-and-backup/object-storage/s3-limitations)“.

**Quoten für den Managed Kubernetes Service (MKS)**: siehe die offizielle Dokumentation „[ETCD Quotas, usage, troubleshooting and error](/guides/public-cloud/containers-orchestration/managed-kubernetes/etcd-quota-error)“.
