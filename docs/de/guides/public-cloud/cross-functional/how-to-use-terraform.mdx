---
title: Terraform verwenden (EN)
description: Step-by-step documentation on how to use Terraform configurations for your infrastructure
...
- [Configuring user access to Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
...
- [Your OVHcloud API identifiers and authorisation key](/guides/manage-and-operate/api/first-steps)
- [An SSH key](/guides/public-cloud/compute/first-steps-with-public-cloud-instance)
...
You now need to [create a new OpenStack user](/guides/public-cloud/cross-functional/create-and-delete-a-user), then [generate the OpenRC file](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#step-1-retrieve-the-variables) containing all of the credentials you want to export as environment variables.
...
Click on <code className="action">Instances</code>.
...
1. [Create a Public Cloud project manually from the OVHcloud Control Panel](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
