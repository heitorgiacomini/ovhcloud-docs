...
description: How to build and use a custom Docker image containing a Flask application
...
- To go further with **Flask**, imagine creating an app to deploy an Object Detection model. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-web-service-yolov5).
- **Flask** allows you to do sentiment classification on texts using Hugging Face models. [Here it is](/guides/public-cloud/ai-machine-learning/ai-deploy-flask-hugging-face-sentiment-analysis).
