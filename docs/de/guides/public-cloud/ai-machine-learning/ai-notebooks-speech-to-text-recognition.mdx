...
description: How to convert Speech to Text using AI Notebooks
...
You can launch your notebook from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).
...
- With NLP, you can do **sentiment analysis**. For more information, click [here](/guides/public-cloud/ai-machine-learning/ai-notebooks-hugging-face-sentiment-analysis).
