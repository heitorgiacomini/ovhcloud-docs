...
This documentation provides an overview of the billing and lifecycle management of various AI model categories offered on [AI Endpoints](https://www.ovhcloud.com/de/public-cloud/ai-endpoints/). We will cover the cost structure for Large Language Models (LLM), Audio models, Image models, Embedding models, and more. Additionally, we will explain the lifecycle of our models, including model decommissioning and redirecting, ensuring that you have all the necessary information to effectively manage your AI Endpoints.
...
For detailed information on models, quantization, pricing units, and prices, please visit the <code className="action">AI Endpoints</code> section of the `AI and Machine Learning` drop-down menu, on the [OVHcloud website](https://www.ovhcloud.com/de/public-cloud/prices/#ai-&-machine-learning):
