...
<img className="thumbnail" alt="FLUX model running on AI Deploy" src="/images/public-cloud/ai-machine-learning/deploy-tuto-19-flux/flux-ai-deploy-demo.gif" loading="lazy" />
