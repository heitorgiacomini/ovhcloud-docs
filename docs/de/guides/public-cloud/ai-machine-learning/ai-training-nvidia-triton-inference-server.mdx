...
description: How to use optimally AI models with NVIDIA Triton Inference Server and AI Training
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/training-tuto-10-triton-inference-server/ovh-ai-training-triton-inference-server.png" loading="lazy" />

## Requirements

- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>
- [ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installed
...
To upload the models to an OVHcloud Object Storage container, you can use the `ovhai` [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-access-data).
...
:::info
For more information on how to build Docker images compatible with OVHcloud AI solutions, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-training-build-use-custom-image).
...
:::warning
The shared registry of AI Training should only be used for testing purposes. Please consider attaching your own registry. More information about this can be found [here](/guides/public-cloud/ai-machine-learning/ai-manage-registries). The images pushed to this registry are for AI Tools workloads only, and will not be accessible for external uses.
...
<img className="thumbnail" alt="DogImage" src="/images/public-cloud/ai-machine-learning/training-tuto-10-triton-inference-server/dog.jpg" loading="lazy" />
