...
This documentation provides an overview on how to use structured outputs with the various AI models offered on [AI Endpoints](https://www.ovhcloud.com/de/public-cloud/ai-endpoints/).
...
Visit our [Catalog](https://www.ovhcloud.com/de/public-cloud/ai-endpoints/catalog/) to find out which models are compatible with Structured Output.
...
In this guide, we have explained how to use Structured Output with the [AI Endpoints](https://www.ovhcloud.com/de/public-cloud/ai-endpoints/) models. We have provided a comprehensive overview of the feature which can help you perfect your integration of LLM for your own application.
