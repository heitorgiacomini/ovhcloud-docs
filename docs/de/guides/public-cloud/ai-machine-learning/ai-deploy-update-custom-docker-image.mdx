...
description: How to update and use the Docker image of your AI Deploy app
...
- The [OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client)
...
Learn how to use public and private registries when working with OVHcloud AI Tools [here](/guides/public-cloud/ai-machine-learning/ai-manage-registries).
