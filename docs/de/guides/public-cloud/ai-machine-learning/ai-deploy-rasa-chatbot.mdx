...
description: Understand how simple it is to deploy a chatbot with AI Deploy
...
In a previous tutorial, we created and trained a Rasa Chatbot with AI Notebooks: [How to create and train a chatbot on OVHcloud](/guides/public-cloud/ai-machine-learning/ai-notebooks-create-rasa-chatbot).
