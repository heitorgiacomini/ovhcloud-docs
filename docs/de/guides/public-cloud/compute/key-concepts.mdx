...
description: "Erfahren Sie die Grundlagen von Public Cloud Compute: wie Instanzen funktionieren, verfügbare Arten und Größen, Multi-AZ-Bereitstellungen, Image-Management, SSH-Sicherheit, Backup-Mechanismen, öffentliche/private Netzwerke und Vorteile von Savings Plans."
...
OVHcloud Compute Instanzen werden in [mehreren Rechenzentren weltweit](https://www.ovhcloud.com/de/about-us/global-infrastructure/regions/) bereitgestellt, um eine hohe Verfügbarkeit und Nähe zu Ihren Nutzern zu gewährleisten. Beispiele für Regionen sind:
...
:::info
**Best Practice:** Für kritische Workloads ist eine [Multi-AZ-Bereitstellung](/guides/public-cloud/cross-functional/deployments-modes-reference-architecture) zu bevorzugen, um Dienstresilienz und -kontinuität zu gewährleisten.
:::
...
- **[Benutzerdefinierte Images](/guides/public-cloud/compute/upload-own-image):** Sie können eigene Images im QCOW2- oder RAW-Format importieren, wodurch Sie Ihre Umgebung vollständig steuern und Migrationen, standardisierte Vorlagen oder spezialisierte Konfigurationen ermöglichen.

**Lebenszyklus und Support:** OVHcloud aktualisiert regelmäßig den Image-Katalog. Prüfen Sie die Lebenszyklus- und End-of-Support-Bekanntmachungen, um sicherzustellen, dass Ihre Images weiterhin unterstützt werden. Siehe [hier](/guides/public-cloud/compute/image-life-cycle).
...
Für detaillierte Anweisungen zur Erstellung und Nutzung von SSH-Schlüsseln konsultieren Sie [unsere Anleitung](/guides/public-cloud/compute/creating-ssh-keys).
...
:::info
**Best Practice:** Backups ersetzen keine [resiliente Architektur](/guides/public-cloud/cross-functional/deployments-modes-reference-architecture). Für kritische Umgebungen kombinieren Sie Backups mit Multi-AZ-Replikation, um maximale Datensicherheit und Dienstverfügbarkeit zu gewährleisten.
:::
...
Für detailliertere Anweisungen zur Konfiguration von Public Cloud Netzwerken konsultieren Sie [unsere Anleitung](/guides/public-cloud/network-services/concepts).
...
Savings Plans helfen Ihnen, Ihr Budget zu optimieren, ohne die Leistung und Zuverlässigkeit Ihrer Cloud-Umgebung zu beeinträchtigen. Weitere Informationen finden Sie in [unserer Anleitung](/guides/public-cloud/cross-functional/savings-plans).
...
- [So erstellen Sie eine Public Cloud Instanz und verbinden sich damit](/guides/public-cloud/compute/getting-started)
- [Verwalten Sie Ihre Public Cloud Instanzen](/guides/public-cloud/compute/first-steps-with-public-cloud-instance)
- [Starten Sie eine Instanz von einem bootfähigen Volume](/guides/public-cloud/compute/start-instance-on-attached-volume)
- [Instanz einstellen oder pausieren](/guides/public-cloud/compute/suspend-or-pause-an-instance)
