...
- Sie haben eine Public Cloud Instanz über Ihr [OVHcloud Kundencenter](/guides/public-cloud/compute/getting-started) oder über das [Horizon-Interface](/guides/public-cloud/compute/create-instance-in-horizon) erstellt.
- Sie haben einen [SSH-Schlüssel erstellt](/guides/public-cloud/compute/creating-ssh-keys).
...
- Attach Interface: Mit dieser Option können Sie über das VLAN eine oder mehrere private Interfaces zu Ihrer Instanz hinzufügen. Weitere Informationen finden Sie in [diesem Abschnitt](/guides/public-cloud/network-services/vrack#ein-privates-interface-hinzufugen) der vRack-Anleitung.
- Detach Interface: Diese Option ermöglicht das Abtrennen einer Schnittstelle, die mit einer Instanz verbunden ist. Weitere Informationen finden Sie in [diesem Abschnitt](/guides/public-cloud/network-services/vrack#loschung-eines-interfaces) der vRack-Anleitung.
...
Weitere Informationen finden Sie in [dieser Anleitung](/guides/public-cloud/compute/getting-started#user-mgmt).  
