...
- Attach Interface: Mit dieser Option können Sie über das VLAN eine oder mehrere private Interfaces zu Ihrer Instanz hinzufügen. Weitere Informationen finden Sie in [diesem Abschnitt](/guides/public-cloud/network-services/vrack#adding-a-private-interface) der vRack-Anleitung.
- Detach Interface: Diese Option ermöglicht das Abtrennen einer Schnittstelle, die mit einer Instanz verbunden ist. Weitere Informationen finden Sie in [diesem Abschnitt](/guides/public-cloud/network-services/vrack#removing-a-private-interface) der vRack-Anleitung.
