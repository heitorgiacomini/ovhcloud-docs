...
- Sie haben ein [Block Storage](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance)-Volume in Ihrem [Public Cloud Projekt](/guides/public-cloud/cross-functional/create-a-public-cloud-project) erstellt.
