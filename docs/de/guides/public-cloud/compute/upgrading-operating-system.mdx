...
description: Erfahren Sie hier, wie Sie ein End-of-Life-Betriebssystem aktualisieren
...
OVHcloud empfiehlt Ihnen daher dringend, bevor Sie diesem Tutorial folgen, [Ihre Instanz zu sichern](/guides/public-cloud/compute/save-an-instance) und entsprechende Tests an Ihren Anwendungen durchzuführen, um sicherzustellen, dass diese auf der neuen Version des Betriebssystems funktionieren.
:::
...
- Sie haben [administrativen Zugriff auf den Server](/guides/public-cloud/compute/getting-started#connect-instance)
- Sie haben [ein Backup Ihrer Instanz durchgeführt](/guides/public-cloud/compute/save-an-instance)
...
Überprüfen Sie, ob Ihre Anwendungen wie gewohnt funktionieren. Im Falle eines Problems empfehlen wir Ihnen, das vor dem Update [durchgeführte Backup](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) wiederherzustellen.
...
Überprüfen Sie, dass Ihre Anwendungen wie gewohnt funktionieren. Im Falle eines Problems empfehlen wir Ihnen, das vor dem Update [durchgeführte Backup](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) wiederherzustellen.

:::info
Bei Schwierigkeiten finden Sie möglicherweise Antworten auf Ihre Fragen in der [Fedora Dokumentation](https://docs.fedoraproject.org/en-US/quick-docs/dnf-system-upgrade/).
:::
