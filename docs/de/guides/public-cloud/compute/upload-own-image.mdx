...
- Sie haben einen OpenStack [Benutzer](/guides/public-cloud/cross-functional/create-and-delete-a-user).
- Ihre Umgebung ist bereit zur [CLI-Verwendung](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) (wenn Sie CLI nutzen).
