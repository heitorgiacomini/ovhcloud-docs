...
description: Erfahren Sie hier, wie Sie die Performance Ihrer Disks überprüfen können
...
Wenn Sie die Geschwindigkeit einer zusätzlichen Disks testen möchten, müssen Sie diese einbinden. Weitere Informationen finden Sie in [dieser Anleitung](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance#unter-windows).
