...
* [Guide for creating a Public Cloud Instance](/guides/public-cloud/compute/getting-started)
...
- A [Public Cloud Instance](/links/public-cloud/prices) in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> with Ubuntu 18.04 installed
...
![Setup screen](/images/guides/public-cloud/compute/install-owncloud-on-a-public-cloud-instance/owncloud-setup-screen.png)
