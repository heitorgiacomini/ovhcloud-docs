...
- [Vorbereitung der Umgebung für die Verwendung der OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) durch Installation des *python-cinderclient* und des *python-novaclient*
...
:::info
Sie können auch die Dokumentation zum OpenStack-Client auf der [OpenStack-Webseite](https://docs.openstack.org/python-openstackclient/latest/) einsehen.
:::
