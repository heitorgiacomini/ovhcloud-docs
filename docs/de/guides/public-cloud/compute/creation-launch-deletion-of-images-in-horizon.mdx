...
description: Erstellung, Start und Löschung von Abbildern (Images) in Horizon
...
- [Erstellung eines Zugangs zu Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
