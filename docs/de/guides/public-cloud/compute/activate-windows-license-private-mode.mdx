...
description: Erfahren Sie hier, wie Sie eine Windows-Lizenz für eine Instanz im privaten Modus aktivieren
...
- Sie haben einen [OpenStack User erstellt](/guides/public-cloud/cross-functional/create-and-delete-a-user).

Wir empfehlen, die [Einführung in das Horizon Interface](/guides/public-cloud/cross-functional/introducing-horizon) zu lesen, um sich mit Horizon vertraut zu machen.
...
Loggen Sie sich in [Horizon-interface](https://horizon.cloud.ovh.net/auth/login/) mit der im [ersten Teil dieser Anleitung](/guides/public-cloud/network-services/vrack#horizon) beschriebenen Methode ein. 

Wählen Sie die korrekte Zone im Menü aus.

![Region](/images/public-cloud/compute/activate-windows-license-private-mode/horizon1.png)

Öffnen Sie <code className="action">Compute</code> und dann <code className="action">Instances</code> links im Menü.

<img className="thumbnail" alt="Instanz" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon2.png" loading="lazy" />

Um ein Interface hinzuzufügen, klicken Sie in der Spalte “Actions” auf den Pfeil, um auf die Aktionen zuzugreifen, die auf der Instanz möglich sind. Klicken Sie dann auf <code className="action">Attach Interface</code>:
...
<img className="thumbnail" alt="select interface" src="/images/public-cloud/compute/activate-windows-license-private-mode/attachinterfacehorizon.png" loading="lazy" />
...
Wenn Sie sich in Ihrer Windows-Instanz eingeloggt haben, klicken Sie auf das <code className="action">Startmenü</code> und dann auf das Icon von <code className="action">Windows PowerShell</code>.
...
<img className="thumbnail" alt="Windows Key aktivieren" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="Windows Key aktivieren" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />

## Weiterführende Informationen

[Den Aktivierungsschlüssel Ihres Windows Servers korrigieren](/guides/bare-metal-cloud/dedicated-servers/windows-key).
