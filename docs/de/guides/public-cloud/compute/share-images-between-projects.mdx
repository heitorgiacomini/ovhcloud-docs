...
description: Erfahren Sie hier, wie Sie ein Image mit OpenStack zwischen Public Cloud Projekten teilen können
lastUpdated: 2025-04-01
---

## Ziel

Es kann vorkommen, dass Sie ein Image eines [Instanz Backups](/guides/public-cloud/compute/save-an-instance) oder ein Image eines [Volume Backups](/guides/public-cloud/compute/volume-backup) für mehrere Public Cloud Projekte freigeben müssen.
...
- Sie haben [Ihre Umgebung für die Verwendung der OpenStack API vorbereitet](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
