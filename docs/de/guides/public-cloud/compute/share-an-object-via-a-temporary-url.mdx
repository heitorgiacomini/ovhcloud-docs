...
description: So teilen Sie ein Objekt, ohne persönliche Informationen weiterzugeben
...
- [Sie haben die Umgebung für die Verwendung der OpenStack-API vorbereitet](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
- [Sie haben die OpenStack-Umgebungsvariablen eingerichtet](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables).
