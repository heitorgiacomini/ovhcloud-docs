...
description: Erfahren Sie hier, wie Sie vorinstallierte Anwendungen auf Instanzen einrichten
...
Installieren Sie über das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>, die OVHcloud API oder OpenStack Horizon API die Anwendung Ihrer Wahl auf Ihrer Public Cloud Instanz.
...
1. Verbinden Sie sich mit der [API Konsole](https://eu.api.ovh.com/).
...
<img className="thumbnail" alt="cPanel" src="/images/public-cloud/compute/apps-first-steps/change_root.png" loading="lazy" />
...
Ja, das können Sie. Stellen Sie sicher, dass Sie bei Ihrem Registrar für Ihre Domain “GLUE” Einträge erstellen. Wenn Sie zum Beispiel “ns1.mydomain.com” und “ns2.mydomain.com” wünschen, müssen Sie “GLUE” Einträge konfigurieren, damit beide auf die IP-Adresse Ihres Servers zeigen. Wenn Ihre Domain bei OVHcloud registriert ist, folgen Sie [dieser Anleitung](/guides/web-cloud/domains/glue-registry#schritt-1-glue-eintrage-hinzufugen). Bitte beachten Sie, dass die Erstellung 24 Stunden dauern kann.
