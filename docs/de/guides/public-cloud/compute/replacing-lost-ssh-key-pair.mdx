...
description: Erfahren Sie hier, wie Sie den Server-Zugriff mit einem neuen SSH-Schlüsselpaar wiederherstellen, falls der private Schlüssel verloren ist
...
- Sie haben eine [Public Cloud Instanz](https://www.ovhcloud.com/de/public-cloud/compute/) in Ihrem OVHcloud Kunden-Account.
...
Erstellen Sie ein neues SSH-Schlüsselpaar auf Ihrem lokalen Gerät, wie im [ersten Abschnitt der Dokumentation zu SSH-Schlüsseln](/guides/public-cloud/compute/creating-ssh-keys) beschrieben.

### Schritt 2: Auf Ihre Instanz im Rescue-Modus zugreifen

Folgen Sie den Anweisungen in der [Anleitung zum Rescue-Modus](/guides/public-cloud/compute/put-an-instance-in-rescue-mode), um die Instanz im Rescue-Modus neu zu starten, sich mit ihr zu verbinden und Ihre Partitionen zu mounten.
...
Starten Sie die Instanz im "normalen" Modus über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> neu. Folgen Sie bei Bedarf der [Anleitung zum Rescue-Modus](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
