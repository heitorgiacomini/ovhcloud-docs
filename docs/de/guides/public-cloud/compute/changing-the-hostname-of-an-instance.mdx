...
description: Erfahren Sie hier, wie Sie den Hostnamen einer Public Cloud Instanz bearbeiten
...
- Sie verfügen über eine [Public Cloud Instanz](/guides/public-cloud/compute/getting-started).
- Sie haben [administrativen Zugriff](/guides/public-cloud/compute/getting-started#connect-instance) (sudo) auf Ihre Instanz über SSH.
