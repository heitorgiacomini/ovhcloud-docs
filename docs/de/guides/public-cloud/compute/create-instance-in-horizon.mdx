...
- Sie haben ein [Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project), Projekt in Ihrem OVHcloud Kunden-Account erstellt.
- Sie haben Zugang zum [Horizon-Interface](/guides/public-cloud/cross-functional/introducing-horizon). 
...
Loggen Sie sich zunächst im Horizon-Interface ein. Wenn Sie hierbei Hilfe benötigen, lesen Sie unsere [Anleitung](/guides/public-cloud/cross-functional/introducing-horizon).
...
Weitere Informationen zum Erstellen eines SSH-Schlüssels finden Sie in [dieser Anleitung](/guides/public-cloud/compute/getting-started#create-ssh).


<Tabs>
  <Tab label="+ Create Key Pair">
    Klicken Sie auf die Schaltfläche <code className="action">+ Create Key Pair</code>, um ein Schlüsselpaar zu erstellen. Bitte beachten Sie, dass bei dieser Option zusätzliche Schritte notwendig sind, bevor Sie sich mit der Instanz verbinden können, insbesondere wenn Sie die PuTTY-Software verwenden, um sich mit Ihrer Instanz zu verbinden. Lesen Sie [diesen Abschnitt](/guides/public-cloud/compute/getting-started#connect-instance) der entsprechenden Anleitung.
