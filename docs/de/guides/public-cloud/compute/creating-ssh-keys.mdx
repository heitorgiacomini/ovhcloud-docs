...
description: Erfahren Sie hier, wie Sie Schlüsselpaare für OpenSSH auf Ihrem lokalen Gerät konfigurieren und für sichere Verbindungen zu Ihrer Instanz verwenden
...
Weitere Informationen finden Sie in unserer [Anleitung zur Erstellung einer Public Cloud Instanz](/guides/public-cloud/compute/getting-started).
:::
...
:::info
`Ed25519` gilt als derzeit sicherste Methode, aber `RSA` ist eine valide Alternative. Beide sind mit dem [OVHcloud Kundencenter](/guides/public-cloud/compute/getting-started) kompatibel.
:::
...
Kopieren Sie diese Schlüsselzeichenfolge, um [sie einer neuen Instanz hinzuzufügen oder in Ihr Kundencenter zu importieren](/guides/public-cloud/compute/getting-started).
...
Eine detaillierte Erklärung dieser Schritte finden Sie in [unserer Anleitung](/guides/public-cloud/compute/configuring-additional-ssh-keys).

## Weiterführende Informationen

[Erstellung einer Public Cloud Instanz](/guides/public-cloud/compute/getting-started)

[Erste Schritte mit SSH-Verbindungen](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)

[Zusätzliche SSH-Schlüssel erstellen](/guides/public-cloud/compute/configuring-additional-ssh-keys)
