...
description: Erfahren Sie hier, wie Sie das Dateisystem einer Public Cloud Instanz oder eines VPS unter FreeBSD 12 anpassen
...
- Sie haben die Instanz / den VPS kürzlich installiert oder [angepasst](/guides/public-cloud/compute/resize-of-an-instance)
