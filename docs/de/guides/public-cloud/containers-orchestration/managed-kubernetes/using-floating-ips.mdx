...
description: Find out how to enable and manage Floating IPs on worker nodes for Managed Kubernetes Service clusters
...
For more information about MKS plans and their differences, see the [MKS Plans comparison guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans).
...
For a complete list of available regions by plan, see the following guide: [Regional Availability by MKS Plan](/guides/public-cloud/containers-orchestration/managed-kubernetes/datacenters-nodes-storage-flavors).
...
For detailed pricing information, please refer to [OVHcloud Public Cloud Prices](https://www.ovhcloud.com/en-gb/public-cloud/prices/#compute) (Floating IP section).
...
For more information on managing Floating IPs with OpenStack, see the following guide: [Concepts - Additional IP or Floating IP](/guides/public-cloud/network-services/additional-ip-vs-floating-ip).
...
- [MKS Plans comparison](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans): Learn more about Free vs Standard plan differences.
- [Regional availability](/guides/public-cloud/containers-orchestration/managed-kubernetes/datacenters-nodes-storage-flavors): Check available regions for each plan.
- [OVHcloud API console](/links/console): Explore the full OVHcloud API.
- [Concepts - Additional IP or Floating IP](/guides/public-cloud/network-services/additional-ip-vs-floating-ip): Understand the difference between Additional IP and Floating IP.
- [OVHcloud Public Cloud prices](https://www.ovhcloud.com/en-gb/public-cloud/prices/#compute): Check Floating IP pricing.
