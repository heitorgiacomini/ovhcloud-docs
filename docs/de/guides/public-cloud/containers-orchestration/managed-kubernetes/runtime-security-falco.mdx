...
description: Find out how to secure your OVHcloud Managed Kubernetes with Falco, a runtime security tool
...
<img className="thumbnail" alt="Falco Schema" src="/images/public-cloud/containers-orchestration/managed-kubernetes/runtime-security-falco/falco-schema.png" loading="lazy" />
...
<img className="thumbnail" alt="Falcosidekick UI" src="/images/public-cloud/containers-orchestration/managed-kubernetes/runtime-security-falco/falcosidekick-ui.png" loading="lazy" />

<img className="thumbnail" alt="Falcosidekick UI" src="/images/public-cloud/containers-orchestration/managed-kubernetes/runtime-security-falco/falcosidekick-ui-2.png" loading="lazy" />

Click the "EVENTS" tab:

<img className="thumbnail" alt="Falcosidekick UI" src="/images/public-cloud/containers-orchestration/managed-kubernetes/runtime-security-falco/falcosidekick-ui-search.png" loading="lazy" />
...
To do that, you need to have an Object Storage container. If you don't already had one, you can follow the [Creating an Object Storage container](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) guide.
...
<img className="thumbnail" alt="OVHcloud Object Storage falco bucket" src="/images/public-cloud/containers-orchestration/managed-kubernetes/runtime-security-falco/falco-bucket.png" loading="lazy" />
...
<img className="thumbnail" alt="OVHcloud Object Storage bucket falco" src="/images/public-cloud/containers-orchestration/managed-kubernetes/runtime-security-falco/bucket.png" loading="lazy" />
