...
description: Find out how to do some operations on specific Nodes and Nodes Pools, like taint, drain and cordon, on OVHcloud Managed Kubernetes
...
Follow the [cluster creation](/guides/public-cloud/containers-orchestration/managed-kubernetes/label-nodeaffinity-node-pools#cluster-creation) step by step guide.

### Second node pool creation

Now, your Kubernetes cluster is up and running. You can see it in your OVHcloud Control Panel.

<img className="thumbnail" alt="Select your cluster" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-1.png" loading="lazy" />

Click on your cluster, then on the <code className="action">Node pools</code> tab.

We will create our second Node pool.
Click on the <code className="action">Add a node pool</code> button.

Then enter a name for your second node pool, `second-node-pool` for example.

<img className="thumbnail" alt="Name your second node pool" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-2.png" loading="lazy" />

Select a flavor for your new node pool, we can choose "D2-8", a different flavor than our other node pool.

<img className="thumbnail" alt="Select a flavor for your second node pool" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-3.png" loading="lazy" />
...
<img className="thumbnail" alt="Define a size and autoscaling for your second node pool" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-4.png" loading="lazy" />

Choose `Hourly` billing mode for this second node pool.

<img className="thumbnail" alt="Billing mode" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-5.png" loading="lazy" />
...
<img className="thumbnail" alt="Status Installing" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-6.png" loading="lazy" />

<img className="thumbnail" alt="Status OK" src="/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/create-a-nodepool-7.png" loading="lazy" />

### Check everything is correctly configured

To do some operations on your Nodes, through `kubectl` CLI, we invite you to follow our guide to [configuring default settings](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-kubectl).
...
![Cordon a Node](/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/cordon.png)
...
![Drain a Node](/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/drain.png)
...
![Taint a Node](/images/public-cloud/containers-orchestration/managed-kubernetes/taint-drain-node-pools/taint.png)
