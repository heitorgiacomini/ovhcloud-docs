...
For more information about MKS plans and their features, see the [MKS Plans comparison guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans).
:::
...
- **Floating IPs per node**: Automatically assign public Floating IPs to worker nodes for direct public access and node bandwidth usage. See the "[Using Floating IPs on MKS Standard](/guides/public-cloud/containers-orchestration/managed-kubernetes/using-floating-ips)" guide for more information.
...
For more information, please refer to the following page: [OVHcloud Public Cloud instances](https://www.ovhcloud.com/de/public-cloud/prices/)
...
This is detailed in the [quickstart with OVH API](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploy-hello-world) guide.

GPU (`T1-*`) instances are now supported! If you want to know [how to deploy GPU applications on Kubernetes Managed Service](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploy-gpu-application), please read our tutorial.
...
This is detailed in the [Persistent Volumes](/guides/public-cloud/containers-orchestration/managed-kubernetes/set-up-persistent-volume) guide.
