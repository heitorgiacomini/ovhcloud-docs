...
description: "Find out how to deploy a \"Hello World\" application on an OVHcloud Managed Kubernetes cluster"
...
- at least one node on the cluster (see the [ordering a node](/guides/public-cloud/containers-orchestration/managed-kubernetes/managing-nodes) guide for details) 
- a well configured  `kubectl` (see the [configuring kubectl](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-kubectl) guide for details) 
...
<img className="thumbnail" alt="Testing your service" src="/images/public-cloud/containers-orchestration/managed-kubernetes/deploying-an-application/deploying_an_application-01.png" loading="lazy" />
