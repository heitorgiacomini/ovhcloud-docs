...
![Migration of a Kubernetes to OVHcloud](/images/guides/public-cloud/containers-orchestration/managed-kubernetes/migration-to-ovhcloud/migration-schema.png)
