...
description: Erfahren Sie hier, wie Sie Ihre OVHcloud Infrastruktur mit Ubika WAAP Gateway in der Public Cloud absichern können
...
- Sie haben eine [Additional IP-Adresse](https://www.ovhcloud.com/de/network/additional-ip/), um Failover und die Konfiguration von Hochverfügbarkeit zu ermöglichen.
...
Gehen Sie in den Bereich <code className="action">Download</code> auf der [offiziellen Website von Ubika](https://my.ubikasec.com/). Loggen Sie sich in Ihren Ubika-Account ein und folgen Sie den Anweisungen zum Herunterladen des UWG OpenStack Images.
