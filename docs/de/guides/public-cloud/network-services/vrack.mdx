...
description: Erfahren Sie hier, wie Sie Ihr vRack mit Public Cloud Instanzen einrichten
...
OVHcloud [vRack](https://www.ovhcloud.com/de/network/vrack/) ist eine Lösung für private Netzwerke, die es unseren Kunden ermöglicht, den Datenverkehr zwischen OVHcloud Dedizierten Servern sowie anderen OVHcloud Diensten zu leiten. Ebenso können Sie [Public Cloud Instanzen](https://www.ovhcloud.com/de/public-cloud/compute/) in Ihr privates Netzwerk einfügen, um eine Infrastruktur aus physischen und virtuellen Ressourcen zu erstellen.
...
Das <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ist eine vollständig visuelles Interface, die ideal geeignet ist, um mehrere VLANs zu verwalten. Sie können außerdem den privaten IP-Bereich anpassen, der standardmäßig in 10.1.0.0/16 liegt.
...
Verwenden Sie [diese Anleitung](/guides/public-cloud/cross-functional/introducing-horizon), um sich mit Horizon vertraut zu machen.
...
Jede Aktion, die Sie in Ihrem OVHcloud Kundencenter durchführen, kann mit der [OVHcloud APIv6](https://eu.api.ovh.com/) aufgerufen werden.  
...
Sie können sie einfach über [unsere Webseite](https://eu.api.ovh.com/) erreichen, aber auch verwenden, um Ihre PHP- oder Python-Skripte zu erstellen.
...
Verwenden Sie [diese Anleitung](/guides/manage-and-operate/api/first-steps), um mit der OVHcloud APIv6 zu beginnen.
...
Dazu müssen Sie den richtigen Terraform-Provider und -Ressource auswählen. Weitere Informationen finden Sie in unserer Anleitung zu [der Verwendung von Terraform mit OVHcloud](/guides/manage-and-operate/terraform/at-ovhcloud).
...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    ...
    Klicken Sie im linken Menü auf die Schaltfläche <code className="action">Dienst hinzufügen</code> (Warenkorb-Symbol). Nutzen Sie den Filter oben auf der Seite oder scrollen Sie nach unten, um den Dienst <code className="action">vRack</code> zu finden.
...
Sie werden auf eine andere Seite weitergeleitet, um die Bestellung zu bestätigen. Es wird einige Minuten dauern, bis das vRack in Ihrem Account eingerichtet ist.
    ...
    Sobald der Dienst aktiv ist, finden Sie ihn in Ihrem Kundencenter im Bereich <code className="action">Network</code> > <code className="action">Private vRack Netzwerk</code>, bezeichnet als "pn-xxxxxx".
    ...
    <img className="thumbnail" alt="Projekt zum vRack hinzufügen" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/addprojectvrack.png" loading="lazy" />
...
Um die Konfiguration Ihres vRacks über das OVHcloud Kundencenter fortzusetzen, fahren Sie mit dieser Anleitung unter [Schritt 2: Ein privates Netzwerk im vRack erstellen](#create-pn-in-vrack) fort, im Tab **Über das OVHcloud Kundencenter**.
  ...
  <Tab label="Über die OVHcloud APIv6">
...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    ...
    Klicken Sie im Bereich <code className="action">Public Cloud</code> auf <code className="action">Private Network</code> im linken Menü unter **Netzwerk**.
    
    <img className="thumbnail" alt="VLAN-Erstellung" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack2022-03.png" loading="lazy" />
...
Klicken Sie auf die Schaltfläche <code className="action">Privates Netzwerk hinzufügen</code>. Die folgende Seite ermöglicht es Ihnen, mehrere Einstellungen anzupassen.
    ...
    <img className="thumbnail" alt="Region auswählen" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack5-2024.png" loading="lazy" />

Im nächsten Schritt werden Ihnen mehrere Optionen präsentiert:
    
    <img className="thumbnail" alt="Netzwerk erstellen" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack6-2022.png" loading="lazy" />
...
Im Feld **Name des privaten Netzwerks** legen Sie einen Namen für Ihr privates Netzwerk fest.
    ...
    **Netzwerk-Gateway-Optionen**
    ...
    - **Ein Gateway zuweisen und sich mit dem privaten Netzwerk verbinden**: Wählen Sie diese Option, wenn Sie beabsichtigen, Instanzen mit einem privaten Netzwerk zu erstellen. Weitere Informationen finden Sie in den folgenden Anleitungen: [Ein privates Netzwerk mit Gateway erstellen](/guides/public-cloud/network-services/create-private-network-gateway) und [Erstellen und Verbinden mit Ihrer ersten Public Cloud-Instanz](/guides/public-cloud/compute/getting-started).
    
    :::warning
    Wenn die zweite Option grau ist, bedeutet dies, dass die ausgewählte Region sie nicht unterstützt. Weitere Informationen finden Sie auf unserer [Seite zur Regionenverfügbarkeit](https://www.ovhcloud.com/de/public-cloud/regions-availability/).
  ...
  <Tab label="Über die OVHcloud APIv6">
    Nachdem Sie sich in die [OVHcloud APIv6-Schnittstelle](https://eu.api.ovh.com/) angemeldet haben, folgen Sie diesen Schritten:
...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    Wenn Sie Unterstützung benötigen, folgen Sie zunächst dieser Anleitung: [Erstellen einer Instanz im OVHcloud Kundencenter](/guides/public-cloud/compute/getting-started). Beim Erstellen einer Instanz können Sie in Schritt 5 einen Netzwerkmodus wählen, gefolgt von einem privaten Netzwerk, in das Sie Ihre Instanz integrieren können.
  ...
  <Tab label="Über die OVHcloud APIv6">
    Nachdem Sie sich bei der [OVHcloud APIv6-Schnittstelle](https://eu.api.ovh.com/) angemeldet haben, folgen Sie diesen Schritten:
...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    ...
    Klicken Sie auf <code className="action">Instanzen</code> in der linken Navigationsleiste und dann auf <code className="action">⁝</code> rechts neben der Instanz. Wählen Sie <code className="action">Details der Instanz</code>.
    
    <img className="thumbnail" alt="detail instance" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/instance_details.png" loading="lazy" />
...
Dies öffnet das Instanz-Dashboard. Klicken Sie auf die Schaltfläche <code className="action">⁝</code> im Bereich "Netzwerke", neben "Private Netzwerke", und wählen Sie <code className="action">Netzwerk hinzufügen</code>.
    ...
    <img className="thumbnail" alt="attach network" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack2021-01.png" loading="lazy" />

Wählen Sie die privaten Netzwerke aus, die Sie an Ihre Instanz anhängen möchten, und klicken Sie auf <code className="action">Bestätigen</code>.
    
    <img className="thumbnail" alt="attach network" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/vrack9.png" loading="lazy" />
  </Tab>
  <Tab label="Über die OVHcloud APIv6">
...
Sie müssen mindestens die folgenden Felder ausfüllen:
  ...
  <Tab label="Über Horizon">
    ...
    <img className="thumbnail" alt="connection Horizon" src="/images/public-cloud/network-services/getting-started-07-creating-vrack/horizon1.png" loading="lazy" />
