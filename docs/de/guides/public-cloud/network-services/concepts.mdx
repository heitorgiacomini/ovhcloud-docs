...
Public Cloud private networks are being created on top of a [vRack](https://www.ovhcloud.com/de/network/vrack/) - an OVHcloud service providing a global private network that can be assigned to a Public Cloud project.
