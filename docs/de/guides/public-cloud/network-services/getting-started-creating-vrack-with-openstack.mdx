...
<img className="thumbnail" alt="Projekt hinzufügen" src="/images/public-cloud/network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### Über die OVHcloud APIv6

Um ein vRack mit der OVHcloud APIv6 zu aktivieren und zu verwalten, lesen Sie [diesen Abschnitt](/guides/public-cloud/network-services/vrack-apiv6#step-1-activating-and-managing-a-vrack) (EN) der entsprechenden Anleitung.
...
[Konfiguration von vRack für Public Cloud mit OVHcloud APIv6](/guides/public-cloud/network-services/vrack-apiv6) (EN).
