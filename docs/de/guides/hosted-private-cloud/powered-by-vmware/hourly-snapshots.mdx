...
description: Erfahren Sie hier die Funktionsweise der stündlichen Sicherungen
...
<img className="thumbnail" alt="data store" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot01.png" loading="lazy" />

Erstellen Sie einen Ordner, in den Sie später die wiederherzustellenden Dateien kopieren.

<img className="thumbnail" alt="destination folder" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot02.png" loading="lazy" />
...
<img className="thumbnail" alt="copy files" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot03.png" loading="lazy" />

Sobald die Dateien kopier twurden, fügen Sie diese VM einfach in Ihr **Inventory** ein, indem Sie auf die Datei `.vmx` und dann auf <code className="action">Register VM</code>  klicken.

<img className="thumbnail" alt="register vm" src="/images/hosted-private-cloud/powered-by-vmware/hourly-snapshots/snapshot04.png" loading="lazy" />
...
Wir empfehlen Ihnen die Verwendung einer vollständigen Backup-Lösung wie zum Beispiel unseres [Veeam Backup](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service)-Dienstes oder eines anderen Systems, das ein vollständiges Backup Ihrer virtuellen Maschinen erstellt.
