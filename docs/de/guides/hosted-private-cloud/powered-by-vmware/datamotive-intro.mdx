...
description: Discover an overview of the Datamotive multi-cloud solution, for a Hosted Private Cloud - VMware on OVHcloud hybridization with other platforms
...
<img className="thumbnail" alt="Datamotive" src="/images/hosted-private-cloud/powered-by-vmware/datamotive-intro/datamotive_dashboard.png" loading="lazy" />
...
Join our [community of users OVHcloud](https://community.ovhcloud.com/community/en).