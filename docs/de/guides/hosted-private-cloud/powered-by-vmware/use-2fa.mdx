...
<img className="thumbnail" alt="Private Cloud Gateway" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/gatewayPCC.jpg" loading="lazy" />
...
<img className="thumbnail" alt="QR-Code scannen" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/scanQRcode.png" loading="lazy" />
...
<img className="thumbnail" alt="2FA Login" src="/images/hosted-private-cloud/powered-by-vmware/use-2fa/2FAtoken.png" loading="lazy" />
...
Diese Anwendungen müssen zuerst über die vCenter-Zugangseinstellungen, die Sie über Ihr [Kundencenter](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#sicherheit) festlegen, autorisiert werden.
