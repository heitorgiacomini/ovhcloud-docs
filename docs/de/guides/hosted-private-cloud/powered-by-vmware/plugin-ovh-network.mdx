...
<img className="thumbnail" alt="Informationen über IPs und Blöcke" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_02.png" loading="lazy" />
...
:::info
Diese Konfiguration können Sie auch in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> vornehmen. 
