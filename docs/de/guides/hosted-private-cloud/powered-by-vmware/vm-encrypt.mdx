...
description: So aktivieren Sie die VMware-Funktion zur Verschlüsselung Ihrer virtuellen Maschinen
...
- You need to have signed up to a [Hosted Private Cloud](https://www.ovhcloud.com/de/hosted-private-cloud/vmware/) offer.
