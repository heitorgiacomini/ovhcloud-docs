...
- Sie sind in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> eingeloggt und befinden sich unter <code className="action">Hosted Private Cloud</code> im Bereich <code className="action">Hosted Private Cloud</code>.
...
Im Menüpunkt <code className="action">Hosted Hosted Private Cloud</code> im Bereich <code className="action">Hosted Private Cloud</code> Ihres <ManagerLink to="/">OVHcloud Kundencenters</ManagerLink> finden Sie eine allgemeine Übersicht.

<img className="thumbnail" alt="Allgemeine Informationen" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel1.png" loading="lazy" />
...
<img className="thumbnail" alt="Allgemeine Informationen" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel2.png" loading="lazy" />
...
<img className="thumbnail" alt="Optionen" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel3.png" loading="lazy" />
...
<img className="thumbnail" alt="Optionen" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel4.png" loading="lazy" />

Weitere Informationen zur Kündigung eines Hosted Private Cloud Dienstes finden Sie in unserer Anleitung [Hosted Private Cloud kündigen](/guides/account-and-service-management/managing-billing-payments-and-services/cancel-private-cloud).

#### Datacenter

In diesem Tab finden Sie eine kurze Zusammenfassung der virtuellen Rechenzentren in Ihrer Hosted Private Cloud Lösung:

<img className="thumbnail" alt="Datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel5.png" loading="lazy" />
...
<img className="thumbnail" alt="Benutzer" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel6.png" loading="lazy" />
...
<img className="thumbnail" alt="Benutzerrechte je Datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel7.png" loading="lazy" />
...
<img className="thumbnail" alt="Sicherheitseinstellungen" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel8.png" loading="lazy" />
...
Weitere Informationen zu dieser Option finden Sie in [dieser Anleitung](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt).

#### Operationen

In diesem Tab finden Sie die aktuell auf Ihrer Infrastruktur ausgeführten Operationen:

<img className="thumbnail" alt="Operationen" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel9.png" loading="lazy" />
...
<img className="thumbnail" alt="Windows-SPLA-Lizenz" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel10.png" loading="lazy" />
...
<img className="thumbnail" alt="Datacenter-Ansicht" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel11.png" loading="lazy" />
...
<img className="thumbnail" alt="Hosts" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel12.png" loading="lazy" />
...
<img className="thumbnail" alt="Datastores" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel13.png" loading="lazy" />
...
<img className="thumbnail" alt="Backup" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel14.png" loading="lazy" />

Weitere Informationen zu dieser Option finden Sie in [dieser Anleitung](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service) (Englisch).
