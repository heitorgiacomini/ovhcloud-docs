...
description: Hier erfahren Sie, wie Sie eine Workaround-Lösung mithilfe von VMware-DRS-Regeln einrichten, um VM-Freeze zu vermeiden.
...
Um diese Lösung umzusetzen, klicken Sie auf den entsprechenden Cluster, gehen Sie auf den Tab <code className="action">Configure</code> und dann auf den Abschnitt <code className="action">VM/Host Rules</code>.
