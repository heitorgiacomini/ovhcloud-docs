...
<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT10v2.gif" loading="lazy" />
...
<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT.png" loading="lazy" />
...
<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT1.png" loading="lazy" />

Der Host: 

<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT2.png" loading="lazy" />

Abschließend: Eine Zusammenfassung Ihrer Auswahl. Bestätigen Sie, um FT auf Ihrer virtuellen Maschine zu aktivieren:

<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT3.png" loading="lazy" />
...
<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT4.png" loading="lazy" />

Nun haben Sie je nach Bedarf die Auswahl zwischen verschiedenen Aktionen.

<img className="thumbnail" alt="Fault Tolerance" src="/images/hosted-private-cloud/powered-by-vmware/vmware-fault-tolerance/FT5.png" loading="lazy" />
