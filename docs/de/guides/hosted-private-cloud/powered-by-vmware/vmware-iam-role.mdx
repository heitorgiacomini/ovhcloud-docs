...
Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and click the <code className="action">Hosted Private Cloud</code> tab.
...
You can now follow the steps in the guide [IAM for VMware on OVHcloud - How to associate a role with a global IAM policy](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-role-policy).
