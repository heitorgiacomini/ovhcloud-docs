...
<img className="thumbnail" alt="InterDC rules" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-spn-connector/spn-connector-rules-interDC.svg" loading="lazy" />
