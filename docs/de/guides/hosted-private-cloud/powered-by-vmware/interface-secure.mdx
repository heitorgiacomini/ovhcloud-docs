...
description: Erfahren Sie hier, wie Sie das sichere Interface verwenden, um kritische Operationen zu bestätigen
...
Hinweis: Über Ihr OVHcloud Kundencenter können Sie diese Berechtigung auch anderen Benutzern erteilen. Wenn Sie hierbei Hilfe benötigen, lesen Sie die Anleitung [Einführung in das Kundencenter der OVHcloud Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud).
...
<img className="thumbnail" alt="Erste SMS" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/SMS1.png" loading="lazy" />
...
- einen Link zur Bestätigung der Operation (Achtung: Wenn Ihr Telefon nicht mit einem Netzwerk verbunden ist, dessen [IP zugelassen](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#sicherheit) ist, wird die Seite nicht angezeigt.)

Um die Operation zu bestätigen, loggen Sie sich über den in der Nachricht enthaltenen Link ein. Gehen Sie dann in den Bereich <code className="action">Operation validation</code>.

<img className="thumbnail" alt="Operation bestätigen" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
Laden Sie die Operation, indem Sie die zugehörige ID im Feld „Operation ID“ eingeben, und klicken Sie dann auf den Button <code className="action">Load operation</code>. Geben Sie anschließend den Token ein, den Sie per SMS erhalten haben, und klicken Sie auf <code className="action">Confirm operation</code>.

<img className="thumbnail" alt="Token der Operation" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />
...
<img className="thumbnail" alt="Zweite SMS" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/SMS2.png" loading="lazy" />
...
Um ein Benutzerpasswort zu ändern, loggen Sie sich im sicheren Interface ein (`https://pcc-xxx-xxx-xxx-xxx.ovh.com/secure/`) und klicken Sie auf den Button <code className="action">Change password</code>.

<img className="thumbnail" alt="Passwort ändern" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Passwort festlegen" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
Um ein Benutzerpasswort zurückzusetzen, loggen Sie sich im sicheren Interface ein (`https://pcc-xxx-xxx-xxx-xxx.ovh.com/secure/`) und klicken Sie auf den Button <code className="action">Password lost</code>.

<img className="thumbnail" alt="Passwort verloren" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />

Eine Nachricht zeigt an, dass Sie in der Lage sein müssen, SMS zu empfangen, um fortzufahren. Ist das der Fall, geben Sie die angeforderten Informationen ein (darunter der Benutzer, dessen Passwort zurückgesetzt werden soll) und klicken Sie auf <code className="action">Next step</code>.

<img className="thumbnail" alt="Benutzerinformationen" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Token und Passwort" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
