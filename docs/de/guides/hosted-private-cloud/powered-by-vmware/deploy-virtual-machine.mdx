...
- Sie sind auf Ihrem [vSphere Interface](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion) eingeloggt.
...
<img className="thumbnail" alt="VM deployen" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm01.png" loading="lazy" />

Sie haben mehrere Optionen, um eine virtuelle Maschine zu erstellen:

- per ISO-Datei, verfügbar in Ihrem Datastore. Sie können [ein ISO in einen Datastore hochladen](/guides/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload).
- über ein eigenes oder ein [von OVHcloud bereitgestelltes](/guides/hosted-private-cloud/powered-by-vmware/ovf-template) Template
...
<img className="thumbnail" alt="Erstellungsoptionen" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm02.png" loading="lazy" />
...
<img className="thumbnail" alt="Speicherort der virtuellen Maschine" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm03.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl der Ressourcen" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm04.png" loading="lazy" />
...
<img className="thumbnail" alt="Wahl des Speichers" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm05.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl der Kompatibilität" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm06.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl des Gast-Betriebssystems" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm07.png" loading="lazy" />
...
<img className="thumbnail" alt="Wahl des Netzwerks" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm08.png" loading="lazy" />
...
<img className="thumbnail" alt="Auswahl der ISO-Datei" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm09.png" loading="lazy" />
...
<img className="thumbnail" alt="ISO verbinden" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm10.png" loading="lazy" />
...
<img className="thumbnail" alt="VM Zusammenfassung" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm11.png" loading="lazy" />
...
<img className="thumbnail" alt="VM starten" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm12.png" loading="lazy" />
...
<img className="thumbnail" alt="VM-Konsole" src="/images/hosted-private-cloud/powered-by-vmware/deploy-virtual-machine/vm13.png" loading="lazy" />
