---
title: Erstellung eines VLAN (EN)
...
<img className="thumbnail" alt="nominate portgroup" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/09network2.png" loading="lazy" />
...
<img className="thumbnail" alt="portgroup configuration" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/10network3.png" loading="lazy" />
...
<img className="thumbnail" alt="security settings" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/11network4.png" loading="lazy" />
...
<img className="thumbnail" alt="traffic shaping" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/12network5.png" loading="lazy" />
...
<img className="thumbnail" alt="portgroup finalisation" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/15network9.png" loading="lazy" />

You will then be presented with a summary of the changes. Click <code className="action">Finish</code> to confirm the creation.

<img className="thumbnail" alt="portgroup finalisation" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/16network10.png" loading="lazy" />

Here we can see that **VLAN21** is available and functional.

<img className="thumbnail" alt="vlan created" src="/images/hosted-private-cloud/powered-by-vmware/create-vlan/17network11.png" loading="lazy" />
