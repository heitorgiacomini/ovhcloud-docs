...
description: Erfahren Sie hier, wie Sie geplante Wartungsarbeiten auf Ihrer VMware on OVHcloud 
...
- Sie haben Zugriff auf Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder auf die  [OVHcloud API ](https://eu.api.ovh.com/).

## In der praktischen Anwendung

:::tip
Benachrichtigungen von OVHcloud sind auch in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verfügbar.<br/>
Klicken Sie oben rechts auf Ihren Namen und dann im Menü auf <code className="action">E-Mails von OVHcloud</code>.
...
Loggen Sie sich mit dem Administrator-Account in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein.

Wählen Sie im Bereich <code className="action">Hosted Private Cloud</code> Ihren Dienst aus und klicken Sie auf den Tab <code className="action">Operationen</code>. Wählen Sie im Drop-down-Menü <code className="action">Verfügbar</code>, um die Tasks zu filtern.

Klicken Sie dann auf den Button <code className="action">...</code> und dann auf <code className="action">Bearbeitungsdatum ändern</code>.

<img className="thumbnail" alt="Änderung" src="/images/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling/maintenance-date-edition01.png" loading="lazy" />

:::info
Wenn <code className="action">Bearbeitungsdatum ändern</code> grau ist, kann diese Wartungsarbeit nicht verschoben werden.
...
Klicken Sie anschließend auf den Button <code className="action">Ändern</code>, um Ihre Planung zu bestätigen.

<img className="thumbnail" alt="Änderung" src="/images/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling/maintenance-date-edition02.png" loading="lazy" />

### Mit der OVHcloud API

Loggen Sie sich in der [OVHcloud API-Konsole](https://eu.api.ovh.com/) ein. Folgen Sie falls nötig unserer Anleitung "[Erste Schritte mit der OVHcloud API](/guides/manage-and-operate/api/first-steps)".
