...
description: So installieren Sie VMware Tools auf Linux oder Windows
...
Um die Festplatte der VMware-Tools über den vSphere-Web-Client zu mounten, klicken Sie mit der rechten Maustaste auf die VM, dann auf <code className="action">Guest OS</code> und schließlich auf <code className="action">Install VMware Tools</code>. 

<img className="thumbnail" alt="installer VMware Tools" src="/images/hosted-private-cloud/powered-by-vmware/vmware-tools-install/tools.png" loading="lazy" />
...
<img className="thumbnail" alt="VMware tools windows" src="/images/hosted-private-cloud/powered-by-vmware/vmware-tools-install/windows.jpg" loading="lazy" />
