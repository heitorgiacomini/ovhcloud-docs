...
description: Erfahren Sie hier, wie Sie einen IP-Block für Ihr Hosted Private Cloud Projekt bestellen
...
:::info
Welche IPs Ihres Blocks reserviert sind und wofür sie verwendet werden, können Sie in unserer Anleitung zum [OVHcloud Network Plugin](/guides/hosted-private-cloud/powered-by-vmware/plugin-ovh-network) nachlesen.
...
<img className="thumbnail" alt="Feld nexthop" src="/images/hosted-private-cloud/powered-by-vmware/ajout-de-bloc-ip/move-api.png" loading="lazy" />

Das Ergebnis wird wie folgt angezeigt:

<img className="thumbnail" alt="Feld nexthop" src="/images/hosted-private-cloud/powered-by-vmware/ajout-de-bloc-ip/api-result.png" loading="lazy" />
...
Sie können die Migration Ihres IP-Blocks über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> im Bereich <code className="action">Hosted Private Cloud</code> unter <code className="action">Private Cloud</code> nachverfolgen. Klicken Sie auf Ihren Hosted Private Cloud Dienst und dann auf den Tab <code className="action">Operationen</code>.

Die Referenz der Operation lautet „removeIpRipeBlock“.

<img className="thumbnail" alt="Operationen Kundencenter" src="/images/hosted-private-cloud/powered-by-vmware/ajout-de-bloc-ip/operations.png" loading="lazy" />

Die IP wird dann im <code className="action">Ip-Parkplatz</code> angezeigt.
