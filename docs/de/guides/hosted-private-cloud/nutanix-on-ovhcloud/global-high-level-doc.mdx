---
title: Nutanix on OVHcloud - Allgemeine Dokumentation (EN)
description: Technical details of the Nutanix on OVHcloud solution
...
<img className="thumbnail" alt="diagram image" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/01-global-high-level-doc/infra1.png" loading="lazy" />
...
This machine is only for you to download your first sources (Windows ISO, appliances, etc.). You will need to replace this virtual machine with another operating system. See this guide for more information: [Replace OVHgateway](/guides/hosted-private-cloud/nutanix-on-ovhcloud/software-gateway-replacement).
