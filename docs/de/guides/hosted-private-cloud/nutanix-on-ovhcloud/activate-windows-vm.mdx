...
description: Find out how to activate a Windows Server virtual machine installed on a Nutanix by OVHcloud solution with an OVHcloud SPLA licence
...
- A virtual machine running Windows Server. You can use this guide to install a virtual machine on Windows: [Virtual Machine Management](/guides/hosted-private-cloud/nutanix-on-ovhcloud/virtual-machine-management)
...
<img className="thumbnail" alt="Activate run tools" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/34-activate-windows-vm/01-run01.png" loading="lazy" />

<img className="thumbnail" alt="Run" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/34-activate-windows-vm/01-run02.png" loading="lazy" />
