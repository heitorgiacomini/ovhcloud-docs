...
description: Customised redeployment of a Nutanix Cluster using OVHcloud tools
...
- access to the [OVHcloud API page](https://eu.api.ovh.com/)

:::warning
If you have signed up to the **Nutanix on OVHcloud BYOL offer** and have activated licences on your cluster, you will need to uninstall your licences before you launch the redeployment. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](/guides/hosted-private-cloud/nutanix-on-ovhcloud/activate-licenses-on-byol).
...
In the OVHcloud Control Panel, click on the <code className="action">Hosted Private Cloud</code> tab, select your cluster below the `Nutanix` category on the left-hand side, then click on <code className="action">Redeploy cluster</code>.
...
If you have subscribed to the Nutanix BYOL offer, a reminder will tell you not to forget to uninstall your licences. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](/guides/hosted-private-cloud/nutanix-on-ovhcloud/activate-licenses-on-byol). When your licences are uninstalled, click <code className="action">Continue</code>.
...
Click <code className="action">Customise the Configuration</code> and click <code className="action">Next</code>
...
Then click <code className="action">Redeploy</code>.
...
Enter `REDEPLOY` and click <code className="action">Confirm</code>.
...
Log in to the [OVHcloud API](https://api.ovh.com). For more details on how the OVHcloud API works, please refer to our guide on [Getting started with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps)

:::warning
If you use the OVHcloud API to repackage your cluster with a Nutanix BYOL offer, you will not receive a message to notify you to uninstall your licences. Don't forget to do so. You can use this guide to manage your licences: [Manage licences in your Nutanix on OVHcloud BYOL Offer cluster](/guides/hosted-private-cloud/nutanix-on-ovhcloud/activate-licenses-on-byol). After uninstalling your licences, you can redeploy your cluster with the OVHcloud API.
...
Then click the <code className="action">+</code> button.
...
Click the <code className="action">+</code> button again.
...
In the **Prism Central Configuration** section, check <code className="action">Define property</code> and <code className="action">Empty array</code>.<br/>
...
Click <code className="action">Execute</code> to start the cluster redeployment.
