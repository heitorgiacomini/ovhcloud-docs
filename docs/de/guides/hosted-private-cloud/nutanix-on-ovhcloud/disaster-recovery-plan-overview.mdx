---
title: Disaster Recovery Plan in Nutanix (EN)
description: Overview of various Disaster Recovery Plan solutions in Nutanix
...
- Connecting all sites via the same [vRack](https://www.ovhcloud.com/de/network/vrack/).
...
An example of an IPsec interconnection in this guide: [IPsec interconnection between two sites](/guides/hosted-private-cloud/nutanix-on-ovhcloud/ipsec-interconnection)
...
Details of these solutions can be found in our documentation on [asynchronous or NearSync replication through Prism Element](/guides/hosted-private-cloud/nutanix-on-ovhcloud/prism-element-replication)
...
[IPsec interconnection between two sites](/guides/hosted-private-cloud/nutanix-on-ovhcloud/ipsec-interconnection)
