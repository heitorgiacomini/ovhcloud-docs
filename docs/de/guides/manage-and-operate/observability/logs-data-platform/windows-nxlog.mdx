...
description: Configure NXLog to send the event logs of your Windows servers to Logs Data Platform.
...
<img className="thumbnail" alt="LDP certificate" src="/images/manage-and-operate/observability/logs-data-platform/ingestion-windows-nxlog/ssl.png" loading="lazy" />
...
<img className="thumbnail" alt="Restart Screenshot" src="/images/manage-and-operate/observability/logs-data-platform/ingestion-windows-nxlog/panel_config.png" loading="lazy" />
...
<img className="thumbnail" alt="Graylog Screenshot" src="/images/manage-and-operate/observability/logs-data-platform/ingestion-windows-nxlog/graylog.png" loading="lazy" />

I think that's pretty much it. I know, it didn't even take 10 minutes :-).

If you want to go further, don't hesitate to fly to the [NXlog documentation](https://docs.nxlog.co/userguide/documentation.html)
