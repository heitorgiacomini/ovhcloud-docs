...
description: All the logs of your pods in one place
...
- [Created at least one Stream and get its token.](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start)
...
<img className="thumbnail" alt="kube_graylog" src="/images/manage-and-operate/observability/logs-data-platform/ingestion-kubernetes-fluent-bit/kube_graylog.png" loading="lazy" />
