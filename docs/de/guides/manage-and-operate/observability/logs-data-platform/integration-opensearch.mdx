...
As explained in our [introductory documentation](/guides/manage-and-operate/observability/logs-data-platform/introduction), Logs Data Platform heavily relies on [OpenSearch](https://github.com/opensearch-project/OpenSearch) to work. OpenSearch has a rich ecosystem and allows very complex queries.
...
- A [Logs Data Platform account](/links/manage-operate/logs-data-platform)
...
You can follow [this documentation](/guides/manage-and-operate/observability/logs-data-platform/ldp-index) to use it.
...
If you use the [managed OpenSearch index as a service feature](/guides/manage-and-operate/observability/logs-data-platform/index-as-a-service), you can also attach multiple *indices* to an *alias*. In that case, attach the alias and configure it as described below.
...
- **Personal Access Token (PAT)** for a local user: [generate a token](/guides/manage-and-operate/observability/logs-data-platform/tokens) via the IAM console or API.
...
To create a local user, go to the <ManagerLink to="/#/iam/identities/users">Identities</ManagerLink> page. Complete the required fields and click <code className="action">Confirm</code> to create the user.
...
A [Personal Access Token](/guides/manage-and-operate/observability/logs-data-platform/tokens) is needed to interact with the Logs Data Platform or OVHcloud API when using a local user. As said in the corresponding guide, you can create one by using the API:
...
- Using our managed OpenSearch Dashboards instances to visualize logs: [here](/guides/manage-and-operate/observability/logs-data-platform/opensearch-dashboards).
- Using Grafana to visualize logs: [here](/guides/manage-and-operate/observability/logs-data-platform/using-grafana-with-logs).
- Using ElastAlert to set up alerting on logs: [here](/guides/manage-and-operate/observability/logs-data-platform/elastalert).
