...
description: Erfahren Sie hier, wie Sie ein Dateisystem im Rescue-Modus auf Fehler überprüfen
...
Starten Sie den Server im Rescue-Modus über das Kundencenter neu. Wenn nötig, verwenden Sie unsere Anleitung zum [Rescue-Modus](/guides/bare-metal-cloud/virtual-private-servers/rescue).
