...
description: Erfahren Sie hier, wie Sie grundsätzliche Sicherheitsmaßnahmen anwenden, um Ihren VPS vor Angriffen und unbefugtem Zugriff zu schützen
...
Wenn Sie Ihren ersten OVHcloud VPS konfigurieren, empfehlen wir, zum Einstieg unsere Anleitung zur [Ersteinrichtung eines VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) zu nutzen.
:::


Die folgenden Beispiele setzen voraus, dass Sie als [Benutzer mit erhöhten Berechtigungen](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds) eingeloggt sind.
...
- [Wie man Authentifizierungsschlüssel für SSH-Verbindungen zu OVHcloud-Servern erstellt und verwendet](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)
- [Tutorial – Wie man PuTTY für SSH-Verbindungen und -Authentifizierungen verwendet](/guides/web-cloud/web-hosting/ssh-using-putty-on-windows)
...
Denken Sie daran, dass Sie nun den neuen Port immer angeben müssen, wenn Sie eine [SSH-Verbindung mit Ihrem Server aufbauen](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction):
...
Wenn Sie aus Ihrem System ausgesperrt sind, können Sie unsere [Rescue-Modus](/guides/bare-metal-cloud/virtual-private-servers/rescue) verwenden, um Ihre Änderungen wiederherzustellen.

### Erstellen eines Benutzers mit eingeschränkten Rechten <a name="createuser"></a>

Im Allgemeinen sollten Aufgaben, die keine Root-Rechte erfordern, über einen Standardbenutzer ausgeführt werden. Weitere Informationen finden Sie in [dieser Anleitung](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).

### Konfiguration der internen Firewall (iptables) <a name="iptables"></a>
...
Weitere Informationen zu *iptables* finden Sie in unserer [Anleitung](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable).
...
### Fail2ban installieren <a name="fail2ban"></a>
...
### Konfiguration der OVHcloud Network Firewall <a name="networkfirewall"></a>
...
Wenn Sie die OVHcloud Network Firewall aktivieren möchten, folgen Sie [dieser Anleitung](/guides/bare-metal-cloud/dedicated-servers/firewall-network).

### Ihr System und Ihre Daten sichern <a name="backup"></a>
...
Alle Informationen zu den für Ihren Dienst verfügbaren Backup-Lösungen finden Sie auf der [Produktseite](https://www.ovhcloud.com/de/vps/options/) und in den [zugehörigen Anleitungen](/guides/bare-metal-cloud/virtual-private-servers/overview).

## Weiterführende Informationen

[Erste Schritte mit einem VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) 

[SSH-Schlüssel verwenden](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Firewall auf einem Windows Server konfigurieren](/guides/bare-metal-cloud/virtual-private-servers/activate-port-firewall-soft-win)

[Konfiguration der Linux Firewall mit iptables](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable)
