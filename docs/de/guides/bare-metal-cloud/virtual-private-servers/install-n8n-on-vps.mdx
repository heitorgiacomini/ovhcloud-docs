...
### Log in to your VPS <a id="step1"></a>
...
### You are using a pre-installed OVHcloud image <a id="step2"></a>
...
### You are not using an OVHcloud pre-installed image <a id="step3"></a>
...
### DNS configuration <a id="step4"></a>
...
### Access the n8n interface <a id="step5"></a>
...
![Install n8n VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-n8n-on-vps/setup_n8n.png)
...
![Install n8n VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-n8n-on-vps/login_n8n.png)
