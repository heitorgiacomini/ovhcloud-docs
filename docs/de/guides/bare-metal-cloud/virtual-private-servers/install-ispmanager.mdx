...
- A [VPS](/links/bare-metal/vps) or a [Dedicated Server](/links/bare-metal/bare-metal) in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> with a [recommended configuration for ISPmanager](https://www.ispmanager.com/docs/ispmanager/system-requirements).
