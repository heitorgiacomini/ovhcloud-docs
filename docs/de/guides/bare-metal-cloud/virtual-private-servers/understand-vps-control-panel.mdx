...
Dieser Abschnitt stellt die wichtigsten Informationen zur Abrechnung Ihres Dienstes bereit. Weitere Informationen zu diesem Thema finden Sie in [unseren entsprechenden Anleitungen](/guides/account-and-service-management/managing-billing-payments-and-services/best-practices).
...
- Wenn Sie zuvor [einen öffentlichen Schlüssel gespeichert haben](/guides/bare-metal-cloud/dedicated-servers/import-keys-control-panel) in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>, wählen Sie den gewünschten Schlüssel aus dem Dropdown-Menü `SSH-Schlüssel für die Vorinstallation` aus.
...
- [Erstellen und Verwenden von Authentifizierungsschlüsseln für SSH-Verbindungen zu OVHcloud Servern](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)
