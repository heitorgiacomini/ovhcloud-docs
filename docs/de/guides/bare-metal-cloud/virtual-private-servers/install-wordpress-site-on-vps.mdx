...
![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/result_wp_info.png)
...
![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/result_wp_downloaded.png)
...
![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/result_wp_config.png)
...
![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/result_wp_installed.png)
...
![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/result_nginx_t.png)
...
Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then go to the `Web Cloud` section.

In the left-hand menu, click `Domain names`, then select the domain name you have chosen for your WordPress website. 

Click on the `DNS Zone` tab, then, in the table that appears, identify the row with the value `A` as its type. Click the `...` button and select `Modify record`.

![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/dns_zone_line_cta.png)

In the window that pops up, enter the IP address of your VPS or dedicated server in the `Target` field, then click `Next`. Check that the information you have entered is correct, then click `Confirm`.

![WP VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-site-on-vps/dns_zone_modify_target.png)
