...
- `serviceName`: Geben Sie den internen Namen Ihrer Lizenz ein (siehe Abschnitt `Lizenzen` in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>).
...
- Download über SFTP: Verbinden Sie sich mit Ihrem VPS mit einem Software-Client, der SFTP unterstützt (z. B. [FileZilla](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp)), und übertragen Sie alle Dateien im Root-Verzeichnis des Systems.
