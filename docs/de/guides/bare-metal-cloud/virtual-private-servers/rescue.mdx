...
:::info
Sie erhalten eine automatische E-Mail mit den SSH-Login-Daten, um im Rescue-Modus auf den VPS zuzugreifen. Bitte warten Sie auf den Eingang der E-Mail, bevor Sie weitere Maßnahmen ergreifen. Diese E-Mail ist auch in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> verfügbar. Klicken Sie in der rechten oberen Ecke auf den mit Ihrem OVHcloud Kunden-Account assoziierten Namen und wählen Sie <code className="action">E-Mails von OVHcloud</code> aus.
...
[Austauschen eines SSH-Schlüsselpaars](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)
