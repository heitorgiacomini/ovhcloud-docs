...
description: Erfahren Sie hier, wie Sie ein SSL-Zertifikat auf einem OVHcloud VPS installieren
...
1. Laden Sie einen SSH-Client wie [PuTTY](/guides/web-cloud/web-hosting/ssh-using-putty-on-windows) herunter, oder verwenden Sie das integrierte Terminal Ihres Betriebssystems.
