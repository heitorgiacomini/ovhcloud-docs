...
- Administrative access to the source [VPS](https://www.ovhcloud.com/de/vps/) (via SSH).
- A [dedicated server](https://www.ovhcloud.com/de/bare-metal/) or [Public Cloud](https://www.ovhcloud.com/de/public-cloud/) instance in your OVHcloud account.
...
We have provided you with this guide in order to help you with common tasks. However, we recommend contacting a [specialist provider](https://partner.ovhcloud.com/de/directory/) if you encounter any difficulties. We will not be able to assist you. You can find more information in the ["Go further"](#go-further) section of this guide.
:::
