...
Click the `DNS zone` tab. In the table, identify the row with the value `A`, click on the button `...` and select `Modify record`.

![WP Docker VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-docker-on-vps/dns_zone_line_cta.png)
...
![WP Docker VPS](/images/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-docker-on-vps/dns_zone_modify_target.png)
