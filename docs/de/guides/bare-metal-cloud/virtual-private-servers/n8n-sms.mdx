...
- An [OVHcloud SMS account](/links/telecom/sms) and a valid [SMS sender](/guides/web-cloud/messaging/sms/sms-senders).
...
![N8N SMS](/images/guides/bare-metal-cloud/virtual-private-servers/n8n-sms/nodes.png)
...
### Industrialization and security <a id="industrialisation"></a>
