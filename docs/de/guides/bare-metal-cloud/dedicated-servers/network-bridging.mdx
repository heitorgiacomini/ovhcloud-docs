...
<Tabs>
  <Tab label="Über Ihr Kundencenter">
    Loggen Sie sich in Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein, gehen Sie in den Bereich <code className="action">Bare Metal Cloud</code> und wählen Sie Ihren Server in <code className="action">Dedicated Server</code> aus.
...
:::info
Für alle Betriebssysteme und Distributionen **muss**** Ihre virtuelle Maschine mit der virtuellen MAC-Adresse konfiguriert werden, die in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> hinterlegt wurde.
