...
:::info
Weitere Informationen zu unserer Anti-DDoS-Lösung finden Sie auf [unserer Website](https://www.ovhcloud.com/de/security/anti-ddos/).
...
- Sie verfügen über einen OVHcloud Dienst mit einer dedizierten öffentlichen IP-Adresse ([Dedicated Server](https://www.ovhcloud.com/de/bare-metal/), [VPS](https://www.ovhcloud.com/de/vps/), [Public Cloud Instanz](https://www.ovhcloud.com/de/public-cloud/), [Hosted Private Cloud](https://www.ovhcloud.com/de/hosted-private-cloud/vmware/), [Additional IP](https://www.ovhcloud.com/de/network/additional-ip/) etc.).
...
<img className="thumbnail" alt="Filter-Dienst" src="/images/bare-metal-cloud/dedicated-servers/firewall-network/selectservice_cut_new.png" loading="lazy" />

Klicken Sie anschließend auf die Schaltfläche <code className="action">⁝</code> rechts neben der entsprechenden IPv4-Adresse und wählen Sie <code className="action">Edge Network Firewall konfigurieren</code> (oder klicken Sie auf das Status-Symbol in der Spalte **Edge Firewall**).

<img className="thumbnail" alt="Aktivierung der Network Firewall" src="/images/bare-metal-cloud/dedicated-servers/firewall-network/firewall_config_new.png" loading="lazy" />
...
Weitere Informationen finden Sie in den folgenden Anleitungen: [Firewall auf einem Windows Server konfigurieren](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win) und [Konfiguration der Linux Firewall mit iptables](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).

:::


**Um eine Regel hinzuzufügen**, klicken Sie oben links auf die Schaltfläche <code className="action">+ Regel hinzufügen</code>:

| ![add-rule-btn](/images/bare-metal-cloud/dedicated-servers/firewall-network/enf_add_rule_new.png) |
|:--:|
| Klicken Sie auf <code className="action">+ Regel hinzufügen</code>. |
...
|:--|
| - Eine Priorität (von 0 bis 19, wobei 0 die erste anzuwendende Regel ist, gefolgt von den anderen) <br/> - Eine Aktion (<code className="action">Accept</code> oder <code className="action">Deny</code>) <br/> - Das Protokoll <br/> - Quell-IP (optional) |
...
|:--:|
| <code className="action">Einschalten</code> zum Aktivieren |
...
<img className="thumbnail" alt="Konfigurationsbeispiel" src="/images/bare-metal-cloud/dedicated-servers/firewall-network/exemple.png" loading="lazy" />
...
Detaillierte Einblicke in erkannte Angriffe und die Ergebnisse der Aktivitäten des Scrubbing Centers erhalten Sie in unserem [Network Security Dashboard](/guides/bare-metal-cloud/dedicated-servers/network-security-dashboard).
...
- [Einen Game Server mit der Application Firewall schützen](/guides/bare-metal-cloud/dedicated-servers/firewall-game-ddos)
