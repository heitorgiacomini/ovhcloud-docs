...
description: Erfahren Sie hier, wie Sie Zugriff auf Ihren Server mit einem neuen SSH-Schlüsselpaar wiederherstellen, falls der private Schlüssel verloren ist
...
Wenn Sie [SSH-Schlüssel](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys) zum Zugriff auf Ihren Server verwenden, kann der Verlust Ihres privaten SSH-Schlüssels zur Folge haben, dass Sie sich nicht mehr auf Ihrem Server einloggen können.

Sie können sich jedoch weiterhin über den [OVHcloud Rescue-Modus](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) mit Ihrem Server verbinden. Dieser Modus ermöglicht den Login mit einem provisorischen Passwort, um Zugriff auf Ihr System zu erhalten.
...
Erstellen Sie auf Ihrem Gerät ein neues SSH-Schlüsselpaar, wie im ersten Teil der Dokumentation zu [SSH-Schlüsseln](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys) beschrieben.
...
- [Rescue-Modus Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
- [Rescue-Modus VPS](/guides/bare-metal-cloud/virtual-private-servers/rescue)
...
Stellen Sie den Boot-Modus wieder auf "normal" um und starten Sie den Server in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> neu. Folgen Sie bei Bedarf der [Anleitung zum Rescue-Modus](#step2).

Sie haben jetzt mit Ihrem neuen SSH-Schlüsselpaar wieder Zugriff auf den Server.

## Weiterführende Informationen

[Einführung SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)
