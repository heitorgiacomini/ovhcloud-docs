...
Sie benötigen die IP-Adresse Ihres Servers, die Sie in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> finden, sowie den Namen des für die SSH-Verbindung zu verwendenden Benutzer-Accounts. Weitere Informationen zu diesem Thema finden Sie in unseren Anleitungen:
...
<img className="thumbnail" alt="SFTP Rescue-Modus Remote-Site" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_03.png" loading="lazy" />
...
<img className="thumbnail" alt="Remote-SFTP-Site" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_01.png" loading="lazy" />
...
<img className="thumbnail" alt="Fortschritt der SFTP-Übertragung" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_02.png" loading="lazy" />
