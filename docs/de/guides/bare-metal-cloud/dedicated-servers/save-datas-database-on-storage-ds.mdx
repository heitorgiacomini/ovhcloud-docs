...
description: Daten-Backup in 5 Schritten
...
- eine Produktionsinfrastruktur ([VPS](https://www.ovhcloud.com/de/vps/), [Dedicated Server](https://www.ovhcloud.com/de/bare-metal/), [Public Cloud](https://www.ovhcloud.com/de/public-cloud/), etc.)
- eine SSH-Verbindung zwischen dem Storage Server und der Produktionsinfrastruktur
- empfohlen: ein privates Netzwerk zwischen Ihren Servern ([OVHcloud vRack](https://www.ovhcloud.com/de/network/vrack/))
...
Gehen Sie in Ihr <ManagerLink to="/">OVHcloud Kundencenter </ManagerLink> und installieren Sie Ihren Server. Wie bereits erwähnt, verwenden wir Debian 9.4. Weitere Informationen finden Sie in unserer Anleitung [Erste Schritte mit einem Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server#ihren-dedizierten-server-installieren-oder-reinstallieren).

Wenn Sie das Betriebssystem für die Installation ausgewählt haben, setzen Sie einen Haken in dem Feld <code className="action">Konfiguration der Partitionen anpassen</code>.

<img className="thumbnail" alt="Konfiguration der Partitionen anpassen" src="/images/bare-metal-cloud/dedicated-servers/save-datas-database-on-storage-ds/custompartition.png" loading="lazy" />

An dieser Stelle wählen Sie den RAID-Typ von `/home` (1) und Sie können, wenn Sie möchten, die Partition erweitern (2).

<img className="thumbnail" alt="/home bearbeiten" src="/images/bare-metal-cloud/dedicated-servers/save-datas-database-on-storage-ds/partition_customization_menu.png" loading="lazy" />
