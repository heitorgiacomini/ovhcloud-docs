...
Erfahren Sie, wie Sie Additional IPs in einem vRack mithilfe unserer Anleitungen für [IPv4](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack) und [IPv6](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack) konfigurieren.
...
Melden Sie sich bei Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> an, klicken Sie im Menü links auf <code className="action">Network</code> und dann auf <code className="action">Öffentliche IP-Adressen</code>.
