...
description: Erfahren Sie hier, wie Sie das Netzwerk auf Proxmox VE konfigurieren
...
- An [OVHcloud dedicated server](https://www.ovhcloud.com/de/bare-metal/)
- One or more [Additional IP addresses](https://www.ovhcloud.com/de/network/additional-ip/)
...
* A [server compatible with vRack](https://www.ovhcloud.com/de/bare-metal/)
* A [vRack service](https://www.ovhcloud.com/de/network/vrack/)
