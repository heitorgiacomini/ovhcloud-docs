...
<img className="thumbnail" alt="Server Manager – Lokaler Server mit deaktiviertem NIC Teaming" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Kontextmenü zum Hinzufügen eines Interfaces zu einem neuen Team" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-02.0.png" loading="lazy" />
...
<img className="thumbnail" alt="Dialog &quot;Neues Team&quot; mit Teamname und OK-Schaltfläche" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-02.png" loading="lazy" />
...
<img className="thumbnail" alt="NIC Teaming Interface-Eigenschaften mit spezifischem VLAN-Tag" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-03.png" loading="lazy" />
...
<img className="thumbnail" alt="Windows-Startmenü mit Systemsteuerung-Option" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-04.png" loading="lazy" />

Klicken Sie auf <code className="action">Netzwerk und Internet</code>:

<img className="thumbnail" alt="Systemsteuerung mit Kategorie &quot;Netzwerk und Internet&quot;" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-05.png" loading="lazy" />

Klicken Sie dann auf <code className="action">Netzwerk- und Freigabecenter</code>:

<img className="thumbnail" alt="Link zum Netzwerk- und Freigabecenter in Windows" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-06.png" loading="lazy" />

Klicken Sie anschließend auf <code className="action">Adaptereinstellugen ändern</code>:

<img className="thumbnail" alt="Adaptereinstellungen ändern im Netzwerk- und Freigabecenter" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-07.png" loading="lazy" />
...
<img className="thumbnail" alt="Rechtsklick auf VLAN-Interface zum Öffnen der Eigenschaften" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-08.png" loading="lazy" />
...
<img className="thumbnail" alt="Adaptereigenschaften mit hervorgehobenem IPv4-Protokoll" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-09.png" loading="lazy" />
...
<img className="thumbnail" alt="IPv4-Einstellungen mit VLAN-IP-Adresse und Subnetzmaske" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-10.png" loading="lazy" />
...
- [vRack zwischen Public Cloud und Dedicated Server konfigurieren](/guides/bare-metal-cloud/dedicated-servers/configuring-the-vrack-between-the-public-cloud-and-a-dedicated-server)
