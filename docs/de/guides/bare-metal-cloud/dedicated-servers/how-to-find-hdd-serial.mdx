...
description: Ermitteln Sie die Seriennummer einer Festplatte auf Ihrem Dedicated Server, um diese für einen Austauschantrag zu identifizieren.
...
Für eine detaillierte Übersicht der Befehle sowie die Vorgehensweise beim Testen Ihrer Festplatten lesen Sie folgende [Anleitung (LSI Raid Controller)](/guides/bare-metal-cloud/dedicated-servers/raid-hard#using-the-lsi-raid-controller) (Englisch).
...
Um zu ermitteln, welche Festplatte zu einem bestimmten “sg”-Gerät gehört, folgen Sie dieser [Anleitung](/guides/bare-metal-cloud/dedicated-servers/raid-hard) (Englisch).
...
- [Defekte Festplatte auf einem Dedicated Server austauschen](/guides/bare-metal-cloud/dedicated-servers/disk-replacement)
