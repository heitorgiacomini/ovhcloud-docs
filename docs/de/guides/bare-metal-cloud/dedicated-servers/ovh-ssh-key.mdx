...
description: Installieren Sie einen OVHcloud SSH-Schlüssel auf Ihrem Dedicated Server, um den OVHcloud Support-Teams sicheren administrativen Zugriff zu gewähren.
...
- Sie sind [via SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) eingeloggt (Root-Zugriff). 
...
- [SSH-Schlüssel für Dedicated Server im Kundencenter speichern](/guides/bare-metal-cloud/dedicated-servers/import-keys-control-panel)
