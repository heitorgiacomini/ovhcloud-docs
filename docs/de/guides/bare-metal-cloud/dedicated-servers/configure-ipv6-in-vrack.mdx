...
:::info
Das vRack unterstützt sowohl IPv4- als auch IPv6-öffentliches Routing mit Additional-IP-Adressblöcken. Die Anleitung zur Konfiguration von IPv4-Blöcken finden Sie hier: [Einen IP-Block im vRack konfigurieren](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
...
- IPv4:
    - [IP-Aliasing auf Dedicated Servern konfigurieren](/guides/bare-metal-cloud/dedicated-servers/network-ipaliasing).
    - [IP-Aliasing auf einem VPS konfigurieren](/guides/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing).
- IPv6:
    - [IPv6 auf Dedicated Servern konfigurieren](/guides/bare-metal-cloud/dedicated-servers/network-ipv6).
    - [IPv6 auf einem VPS konfigurieren](/guides/bare-metal-cloud/virtual-private-servers/configure-ipv6).
    - [IPv6 auf einer Public-Cloud-Instanz konfigurieren](/guides/public-cloud/network-services/ipv6-configuration).
...
- Sie verfügen über einen aktiven [vRack](https://www.ovhcloud.com/de/network/vrack/)-Dienst in Ihrem Account.
- Sie verfügen über einen [vRack-kompatiblen Server](https://www.ovhcloud.com/de/network/vrack/), der mit Ihrem vRack-Netzwerk verbunden ist.
...
:::warning
Diese Funktion kann auf Servern der [**Eco**-Produktlinie](https://eco.ovhcloud.com/de/about/) eingeschränkt oder nicht verfügbar sein.
...
<summary>Einen neuen Additional-IPv6-Block anfordern</summary>
...
<img className="thumbnail" alt="Konfigurationsseite" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="IPv6 in einem vRack konfigurieren" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
...
<summary>Über das OVHcloud Kundencenter</summary>


<img className="thumbnail" alt="vRack-Verwaltung" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="vRack-Auswahl" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="SLAAC aktivieren" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/702.png" loading="lazy" />
...
<summary>Über die APIv6 (alternativer Weg)</summary>
...
<img className="thumbnail" alt="api post add block" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/post-ipv6.png" loading="lazy" />
...
<img className="thumbnail" alt="GET ipv6 call" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-04.png" loading="lazy" />
...
<img className="thumbnail" alt="GET subrange bridged into your vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-05.png" loading="lazy" />
...
<img className="thumbnail" alt="GET subrange bridged into your vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-06.png" loading="lazy" />
...
<img className="thumbnail" alt="API call POST enable SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-07.png" loading="lazy" />
...
<summary>Beim Bestellen einer Additional IP</summary>
...
- Melden Sie sich im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> an.
...
- Klicken Sie auf die Schaltfläche <code className="action">IPs bestellen</code> oben auf der Seite.
...
- Wählen Sie <code className="action">Privates vRack-Netzwerk</code>.
- Klicken Sie in der Spalte "Öffentliche IP und Bandbreite" auf die Schaltfläche <code className="action">Verwalten</code> für das entsprechende vRack.
...
- Wechseln Sie zur Registerkarte <code className="action">Öffentliches IP-Routing</code>.
...
- Klicken Sie im Fenster der betreffenden Region auf <code className="action">Bandbreite ändern</code>.
- Wählen Sie die gewünschte Bandbreitenoption im rechten Bereich aus und klicken Sie auf <code className="action">Zur Bestellung</code>, um die Bestellung zu bestätigen.
...
<summary>Statische IP-Konfiguration</summary>
...
<summary>Automatische IP-Konfiguration (SLAAC)</summary>
...
<img className="thumbnail" alt="Einen IPv6 in einem vRack für den gerouteten Modus konfigurieren" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/routed-mode-20240513.png" loading="lazy" />
...
Nach dem Hinzufügen einer Additional IP zu Ihrem vRack können Sie das geroutete Subnetz verwalten, indem Sie auf die Schaltfläche <code className="action">Subnetz hinzufügen</code> klicken.

<img className="thumbnail" alt="vRack-Auswahl" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="weiter" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/800.png" loading="lazy" />

Das erstellte geroutete Subnetz `2001:41d0:abcd::ef10::/60` ist über den Next Hop `2001:41d0:abcd::ef00::2` erreichbar.

<img className="thumbnail" alt="weiter" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/801.png" loading="lazy" />
...
<img className="thumbnail" alt="weiter" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-02.png" loading="lazy" />
...
<summary>Statische IP-Konfiguration für einen Host (empfohlen)</summary>
...
<summary>Automatische IP-Konfiguration (SLAAC) für einen Host</summary>
...
<summary>Konfiguration des gerouteten Subnetzes auf einem Host und innerhalb einer VM</summary>
...
<summary>Konfiguration des gerouteten Subnetzes innerhalb einer VM</summary>
...
<summary>Lokal, auf einem Host</summary>
...
<summary>Lokal, auf einer VM</summary>
...
<summary>Von einem Remote-Host</summary>
...
<img className="thumbnail" alt="image" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-08.png" loading="lazy" />
