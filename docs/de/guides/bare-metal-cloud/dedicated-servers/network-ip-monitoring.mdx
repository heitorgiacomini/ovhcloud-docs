...
description: Erfahren Sie hier die IP-Adressen zur Einrichtung Ihrer Firewall, um OVHcloud Monitoring auf Ihrem Server zu erlauben
...
Loggen Sie sich zunächst in Ihr <ManagerLink to="/">OVHcloud Kundencenter ein</ManagerLink> und gehen Sie zum Bereich <code className="action">Bare Metal Cloud</code>. Wählen Sie den betreffenden Server unter <code className="action">Dedicated Server</code> aus.

Sie können den Monitoring-Status eines Servers vom Tab <code className="action">Allgemeine Informationen</code> aus einrichten (Abschnitt **Dienststatus**).
...
[Konfiguration der Network Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network).
