...
Die Login-Daten (Benutzername und Passwort) werden Ihnen per E-Mail bei der ersten Installation oder einer Reinstallation eines Servers über Ihr <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> gesendet.
