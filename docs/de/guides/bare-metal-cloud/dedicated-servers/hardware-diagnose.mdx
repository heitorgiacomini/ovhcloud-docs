...
description: Führen Sie eine Hardware-Diagnose auf Ihrem OVHcloud Dedicated Server im Rescue-Modus durch, um Festplatten-, RAM- oder CPU-Fehler zu identifizieren.
...
- Sie haben den Server im [Rescue-Modus](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) gestartet.
...
- [Dedicated Server - Datenbanken im Rescue-Modus abrufen](/guides/bare-metal-cloud/dedicated-servers/restore-bdd-rescue)

- [BMC-Firmware-Version auf einem Dedicated Server prüfen](/guides/bare-metal-cloud/dedicated-servers/bmc-fw-update)
