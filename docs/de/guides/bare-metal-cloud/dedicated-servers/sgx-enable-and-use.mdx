...
<Tabs>
  <Tab label="Über das OVHcloud Kundencenter">
    ...
    **2 - SGX aktivieren**
    ...
    <img className="thumbnail" alt="SGX aktivieren" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/enable_sgx.png" loading="lazy" />

Klicken Sie auf der nächsten Seite auf die Schaltfläche <code className="action">Aktivieren</code>.
    
    <img className="thumbnail" alt="SGX aktivieren" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/enable_sgx2.png" loading="lazy" />

Sie können entweder SGX mit einer bestimmten Menge reservierten Speichers aktivieren oder SGX aktivieren, indem Sie Ihrem Software-System erlauben, den benötigten Speicher automatisch zu reservieren. Nachdem Sie Ihre Wahl getroffen haben, klicken Sie auf <code className="action">Bestätigen</code>.
    
    <img className="thumbnail" alt="SGX aktivieren" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/manage_sgx.png" loading="lazy" />

Es erscheint ein Fenster, um zu bestätigen, dass die Aktivierung von Intel SGX einen Neustart Ihres Servers erfordert.
    
    <img className="thumbnail" alt="SGX aktivieren" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/confirmation-popup_sgx.png" loading="lazy" />
...
Um zu überprüfen, ob Ihr Dienst über die SGX-Option verfügt, nutzen Sie folgenden Aufruf: 
    ...
    <Api version="v1" section="/dedicated/server" method="GET" route={"/dedicated/server/\\{serviceName\\}/biosSettings/sgx"} />    <img className="thumbnail" alt="SGX deaktiviert" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/get-disabled.png" loading="lazy" />
...
Aktivieren Sie SGX unter Verwendung des Servernamens:
    ...
    <Api version="v1" section="/dedicated/server" method="POST" route={"/dedicated/server/\\{serviceName\\}/biosSettings/sgx/configure"} />    <img className="thumbnail" alt="SGX konfigurieren" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/post-configure.png" loading="lazy" />
    ...
    <Api version="v1" section="/dedicated/server" method="GET" route={"/dedicated/server/\\{serviceName\\}/task/\\{taskId\\}"} />    <img className="thumbnail" alt="SGX-Konfigurationsaufgabe abrufen" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/get-task.png" loading="lazy" />

Sie können bestätigen, dass der Status auf aktiviert gesetzt ist, indem Sie folgenden Aufruf ausführen:
    
    <Api version="v1" section="/dedicated/server" method="GET" route={"/dedicated/server/\\{serviceName\\}/biosSettings/sgx"} />    <img className="thumbnail" alt="SGX aktiviert" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/get-enabled.png" loading="lazy" />
  </Tab>
  <Tab label="Manuelle Konfiguration im BIOS">
    **1 - Starten Sie eine Remote KVM-Sitzung**
    ...
    <img className="thumbnail" alt="Starten Sie eine Remote KVM-Sitzung" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/manager.png" loading="lazy" />
...
**2 - SGX aktivieren**
    ...
    <img className="thumbnail" alt="SGX aktivieren" src="/images/bare-metal-cloud/dedicated-servers/sgx-enable-and-use/sgx_bios.png" loading="lazy" />

Speichern Sie die Änderungen, indem Sie die Taste <code className="action">F10</code> drücken. Eine Bestätigung wird angezeigt; wählen Sie `Yes`.
