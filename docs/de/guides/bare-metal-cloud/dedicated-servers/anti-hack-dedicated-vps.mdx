...
description: Erfahren Sie, welche Informationen angezeigt und bereitgestellt werden, wenn der interne Anti-Hack-Schutz von OVHcloud ausgelöst wird.
...
Wenn der Anti-Hack-Schutz auf Ihrem Dedicated Server ausgelöst wird, sehen Sie eine Meldung im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink>: "*Ihr Server wurde gehackt. Bitte kontaktieren Sie unser Support-Team für Anweisungen zum weiteren Vorgehen.*"
...
<img className="thumbnail" alt="Anti-Hack-Informationen Dedicated Server" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-service.png" loading="lazy" />
...
<img className="thumbnail" alt="Anti-Hack-Informationen VPS" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-vps.png" loading="lazy" />
