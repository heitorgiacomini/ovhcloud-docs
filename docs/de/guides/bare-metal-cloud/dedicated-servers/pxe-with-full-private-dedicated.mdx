...
description: Find out how to reboot your OVHcloud servers, working through your active private aggregation
...
Get a private infrastructure without having to change the default configuration for your [OVHcloud dedicated servers](https://www.ovhcloud.com/de/bare-metal/).
...
With [OVHcloud dedicated servers](https://www.ovhcloud.com/de/bare-metal/), you can configure/declare your own networks.<br/>
...
You can therefore use/declare your *public* and *private* networks via our solution [vRack](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server).

We will present the case of [dedicated server(s)](https://www.ovhcloud.com/de/bare-metal/) configured in **OLA** mode, i.e. with **only** private networks.
This choice offers your infrastructure the best possible isolation/protection for your hosted service.<br/>
The only significant difference is that [private networks](/guides/network/ovhcloud-connect/overview#private-connection) do not have access to everything that does not belong to your infrastructure.<br/>
...
![Netboot in action](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/netboot_steps.png)
...
- At least one [dedicated server](https://www.ovhcloud.com/de/bare-metal/) with an operating system **already installed**.
...
- You must have all of the network interfaces for this server in **private** mode, which implies that you have already configured [our OLA feature](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager).<br/>
...
> Select your server and check that it is eligible for `OLA: OVHcloud Link Aggregation` in the <code className="action">Network interfaces</code> tab.
>
> <img className="thumbnail" alt="OLA1" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/Scr_OLA1.png" loading="lazy" />
>
> <img className="thumbnail" alt="OLA2" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/Scr_OLA2.png" loading="lazy" />
...
![Schema](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/schema_basic_en.png)
...
<img className="thumbnail" alt="iPXE in action" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/animation.gif" loading="lazy" />

*Corresponds to the result of steps 8 and 9.*<br/>

<img className="thumbnail" alt="rEFInd en action" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/rEFInd.png" loading="lazy" /><br/>
