...
* A [dedicated server](https://www.ovhcloud.com/de/bare-metal/) **ready to be installed/reinstalled** in your OVHcloud account.
...
Some [dedicated servers](https://www.ovhcloud.com/de/bare-metal/) have multiple groups of disks. For example, one group with SATA disks and another group with SSD disks. Those servers are sometimes also called **hybrid servers**.
