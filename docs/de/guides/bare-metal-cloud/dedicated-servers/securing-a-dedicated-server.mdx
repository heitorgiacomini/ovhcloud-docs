...
description: "Wenden Sie grundlegende Sicherheitsmaßnahmen auf Ihrem Dedicated Server an: SSH-Härtung, Firewall-Konfiguration und Dienstüberwachung."
...
Wenn Sie Ihren ersten OVHcloud Server konfigurieren, empfehlen wir, zum Einstieg unsere Anleitung zur [Ersteinrichtung eines Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server) zu verwenden.
:::
...
Weitere Informationen zu Iptables finden Sie in unserer [Anleitung](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).
...
Für weitere Informationen zu unseren Storage-Angeboten lesen Sie [unsere Anleitung](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage) zum Thema.

## Weiterführende Informationen

[Firewall auf einem Windows Server konfigurieren](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)
...
- [Webserver (LAMP) auf Debian oder Ubuntu installieren](/guides/bare-metal-cloud/dedicated-servers/installing-lamp-debian9-ubuntu18)

- [Dedicated Server mit Memcached-Dienst absichern](/guides/bare-metal-cloud/dedicated-servers/memcache-secure)
