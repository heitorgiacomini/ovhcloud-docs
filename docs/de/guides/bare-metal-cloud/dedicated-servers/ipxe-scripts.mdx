...
Im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> kann der Boot-Modus nur aus einer vorgegebenen Liste ausgewählt werden: Primäre Disk oder Rescue.
...
Sie können nun im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> oder über die [OVHcloud API](https://eu.api.ovh.com/) auf Disk- oder [Rescue-Modus](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) umstellen.
