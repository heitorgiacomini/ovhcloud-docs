...
description: Kopieren Sie mit rsync ganz einfach die Daten von Ihrem dedizierten Server auf einen anderen
...
Um noch mehr zu erfahren, können Sie sich mit unserer User Community auf [https://community.ovh.com/en/](https://community.ovh.com/en/) austauschen.
