...
description: Tauschen Sie eine defekte Festplatte auf einem Dedicated Server mit Software-RAID ohne Ausfallzeit durch Hot-Swap aus.
...
Die defekte Festplatte kann jetzt von einem Techniker im Rechenzentrum ausgetauscht werden. Nachdem der Vorgang abgeschlossen ist, muss das RAID nur erneut synchronisiert werden. Verwenden Sie hierzu folgende Dokumentation: [Software-RAID](/guides/bare-metal-cloud/dedicated-servers/raid-soft).
...
<img className="thumbnail" alt="smart_sdb_windows" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-soft/smart_sdb_windows.png" loading="lazy" />
...
<img className="thumbnail" alt="id_lsi_windows" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-soft/id_lsi_windows.png" loading="lazy" />

In unserem Beispiel hat die LSI-Karte den Index/die ID 0.

Mit dieser Information können Sie jetzt für die betreffende Festplatte (mithilfe ihrer “**Serial Number**”) die “**Slot ID**” und die “**Enclosure ID**” ermitteln.

<img className="thumbnail" alt="select-string" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-soft/select-string.png" loading="lazy" />
...
<img className="thumbnail" alt="locate" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-soft/locate.png" loading="lazy" />
...
[Erfahren Sie hier, wie Sie das RAID Array Ihres Servers rekonfigurieren](/guides/bare-metal-cloud/dedicated-servers/raid-soft)

[OVHcloud API and Storage](/guides/bare-metal-cloud/dedicated-servers/partitioning-ovh) (Englisch)

[Managing hardware RAID](/guides/bare-metal-cloud/dedicated-servers/raid-hard) (Englisch)

[Hot Swap - Hardware RAID](/guides/bare-metal-cloud/dedicated-servers/hotswap-raid-hard) (Englisch)

- [Dedicated Server - Software-RAID verwalten (UEFI)](/guides/bare-metal-cloud/dedicated-servers/raid-soft-uefi)
