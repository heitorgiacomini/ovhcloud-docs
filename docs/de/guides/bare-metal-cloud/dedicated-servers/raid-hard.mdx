---
title: Hardware-RAID auf einem Dedicated Server verwalten
description: Überprüfen Sie den Zustand Ihres Hardware-RAID-Controllers und überwachen Sie die Festplattengesundheit auf Ihrem OVHcloud Dedicated Server.
...
- a [dedicated server](https://www.ovhcloud.com/de/bare-metal/) with a hardware RAID configuration
