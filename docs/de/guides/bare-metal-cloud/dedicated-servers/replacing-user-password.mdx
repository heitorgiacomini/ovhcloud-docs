...
:::info
Um den Zugang zu einem Server wiederherzustellen, auf dem Sie sich mit einem SSH-Schlüssel einloggen, folgen Sie stattdessen unserer Anleitung "[Austauschen eines SSH-Schlüsselpaars](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)".
...
Denken Sie daran, den regulären Startmodus zu aktivieren, bevor Sie Ihren Server im <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> neu starten.
...
[SSH-Schlüssel erstellen und verwenden](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)
