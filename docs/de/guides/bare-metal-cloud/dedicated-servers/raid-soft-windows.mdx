...
description: Erstellen Sie die Software-RAID-Mirror-Konfiguration auf einem Windows Dedicated Server nach einem Festplattenaustausch neu.
...
Wenn Sie eingeloggt sind, klicken Sie mit der rechten Maustaste auf das <code className="action">Startmenü</code> und öffnen Sie <code className="action">Ausführen</code>.

<img className="thumbnail" alt="Windows-Startmenü mit Option &quot;Ausführen&quot;" src="/images/bare-metal-cloud/dedicated-servers/raid-soft-windows/raid-soft-windows-01.png" loading="lazy" />

Geben Sie "cmd" ein und klicken Sie auf <code className="action">OK</code>.

<img className="thumbnail" alt="Ausführen-Dialog mit eingegebenem cmd-Befehl" src="/images/bare-metal-cloud/dedicated-servers/raid-soft-windows/raid-soft-windows-02.png" loading="lazy" />
...
In diesem Beispiel ist `Disk 1` ein Ersatzlaufwerk, das installiert wurde, um die fehlerhafte `Disk M0` zu ersetzen, die zuvor [physisch entfernt](/guides/bare-metal-cloud/dedicated-servers/disk-replacement) wurde.
...
- [Dedicated Server - Software-RAID verwalten (BIOS)](/guides/bare-metal-cloud/dedicated-servers/raid-soft)

- [Creating a Windows Partition on a Dedicated RAID Server](/guides/bare-metal-cloud/dedicated-servers/windows-raid-hard)
