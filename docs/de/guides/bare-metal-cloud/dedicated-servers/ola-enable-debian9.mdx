...
description: Aktivieren Sie OVHcloud Link Aggregation auf Ihrem Debian (Versionen 9 bis 11)
...
Wenn die Netzwerkkonfiguration Ihres Systems stattdessen `Netplan` verwendet, lesen Sie [diese Anleitung](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-netplan).
...
<br/>Loggen Sie sich hierzu in Ihrem <ManagerLink to="/">OVHcloud Kundencenter</ManagerLink> ein. Klicken Sie im Bereich <code className="action">Bare Metal Cloud</code> Ihren Server aus <code className="action">Dedicated Server</code>, aus und klicken Sie dann auf den Tab <code className="action">IPMI</code> (1).
