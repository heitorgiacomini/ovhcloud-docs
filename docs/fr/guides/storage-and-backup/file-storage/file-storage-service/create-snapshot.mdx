...
description: "Découvrez comment répertorier, créer et supprimer des snapshots de partage NFS dans le service File Storage d'OVHcloud à l'aide de l'API. Garantissez la cohérence des données et gérez efficacement les snapshots."
...
:::info
**Astuce :** Reportez-vous à la [console d'API OVHcloud](https://eu.api.ovh.com/console/) pour obtenir des informations précises sur les opérations, les méthodes HTTP et les schémas de requête.
:::


## Prérequis

- Un [projet Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) avec le service File Storage activé.
...
- [File Storage Service – Concepts clés](/guides/storage-and-backup/file-storage/file-storage-service/key-concepts)
