...
description: "Apprenez à gérer les snapshots du NAS-HA via l'API OVHcloud"
...
:::info
N’hésitez pas à vous rendre sur [la page FAQ NAS-HA](/guides/storage-and-backup/file-storage/ha-nas/nas-faq) pour retrouver toutes les informations détaillées concernant la fonction snapshot.
:::
