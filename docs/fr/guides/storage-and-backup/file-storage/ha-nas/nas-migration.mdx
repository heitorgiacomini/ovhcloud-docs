...
description: "Decouvrez ici comment migrer vos données d'un NAS-HA à un autre via un partage NFS."
...
- Avoir monté votre NAS-HA au préalable en suivant le guide pour [monter votre NAS-HA via un partage NFS](/guides/storage-and-backup/file-storage/ha-nas/nas-nfs).
