...
description: "Découvrez comment gérer les ACL d'un volume Enterprise File Storage en utilisant les API OVHcloud"
...
Toutes les routes API utilisées pour ce guide sont disponibles dans la section */storage* : [https://api.ovh.com/console/#/storage](https://api.ovh.com/console/#/storage).
...
<Api version="v1" section="/storage" method="GET" route={"/storage/netapp/\{serviceName\}/share/\{shareId\}/acl"} />
...
<Api version="v1" section="/storage" method="DELETE" route={"/storage/netapp/\{serviceName\}/share/\{shareId\}/acl/\{aclRuleId\}"} />
