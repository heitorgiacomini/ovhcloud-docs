...
- Un [réseau privé vRack Private Network](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) actif dans la même région.
- Avoir accès à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou à la [CLI OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables).
...
- **Lien direct :** <ManagerLink to="/#/dedicated/netapp">Enterprise File Storage</ManagerLink>
...
Suivez la procédure décrite dans l'**étape 1 : activer et gérer un vRack** de notre guide « [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) ».
...
Suivez la procédure décrite dans l'**étape 2 : créer un réseau privé dans le vRack** de notre guide « [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) ».
...
Suivez la procédure décrite dans l'**étape 3 : intégrer une instance au vRack** de notre guide « [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) ».
...
1. Dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>, accédez à la section <code className="action">Network</code>, puis cliquez sur <code className="action">vRack Services</code>. 
