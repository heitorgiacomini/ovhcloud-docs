...
description: "Découvrez les concepts liés au provisionnement, au suivi ainsi qu'au test des performances de la solution Enterprise File Storage"
...
<img className="thumbnail" alt="Enterprise File Storage Perf 1" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-concepts-performances/Netapp_Hierarchie_2.png" loading="lazy" />
