...
description: Découvrez comment créer et gérer vos volumes OVHcloud Enterprise File Storage en utilisant les API OVHcloud
...
:::info
Pour NFS, vous trouverez les instructions de montage dans le guide [Monter votre NAS via un partage NFS](/guides/storage-and-backup/file-storage/ha-nas/nas-nfs).
