...
description: FAQ sur la solution Entreprise File Storage
...
Oui, ce service est directement accessible depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, dans la rubrique <code className="action">Bare Metal Cloud</code> puis <code className="action">Storage et Backup</code>.
