...
description: "Découvrez les principes de fonctionnement de l'offre Enterprise File Storage"
...
Le compte OVHcloud est par défaut le contact administrateur, technique et facturation du service. Retrouvez plus d’informations sur notre guide « [Gérer les contacts de ses services»](/guides/account-and-service-management/account-information/managing-contacts) ».

![Enterprise File Storage 1](/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-concepts/Netapp_Concept_1.png)
...
![Enterprise File Storage 2](/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-concepts/Netapp_Concept_2.png)
...
Retrouvez plus d'informations sur le guide [« Gérer vos volumes »](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volumes).
...
![Enterprise File Storage 3](/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-concepts/Netapp_Concept_3.png)
...
Retrouvez plus d'informations sur le guide [« Gérer les ACL d'un volume »](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-acl).
...
![Enterprise File Storage 4](/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-concepts/Netapp_Concept_4.png)

Retrouvez plus d'informations sur le guide [« Gérer les snapshots d'un volume »](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-snapshots).
...
Échangez avec notre communauté d’utilisateurs sur Discord : [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud)
