...
:::info
Vous pouvez créer un volume et un snapshot de type `manual` grâce à l'[API OVHcloud](https://eu.api.ovh.com/) ou depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>.
