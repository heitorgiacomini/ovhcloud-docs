...
description: Déployez NetApp Trident CSI sur OVHcloud Enterprise File Storage pour gérer les volumes et les snapshots dans Kubernetes
...
- Un [vRack](https://www.ovhcloud.com/fr/network/vrack/) avec [vRack Services](/guides/network/vrack-services/global) configuré
- Connaître les [API OVHcloud](/guides/manage-and-operate/api/first-steps) et/ou la [CLI OVHcloud](/guides/manage-and-operate/cli/getting-started)
...
<img className="thumbnail" alt="Schéma des prérequis Trident" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/trident_efs_requirements.excalidraw.png" loading="lazy" />
...
[Gestion des comptes de service OVHcloud via l'API](/guides/manage-and-operate/api/manage-service-account)
