...
description: Retrouvez ici les concepts permettant de mettre en oeuvre les ACL dans Public Cloud Archive
...
- [Avoir créé des utilisateurs OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user).
...
![Création des utilisateurs](/images/storage-and-backup/object-storage/pca-acl/create-users.png)
...
![Autre utilisateur](/images/storage-and-backup/object-storage/pca-acl/other-user.png)
