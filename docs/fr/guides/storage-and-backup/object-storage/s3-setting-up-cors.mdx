...
description: Découvrez comment activer et configurer CORS sur vos buckets
...
<img className="thumbnail" alt="CORS" src="/images/storage-and-backup/object-storage/s3-setting-up-cors/cors.png" loading="lazy" />
