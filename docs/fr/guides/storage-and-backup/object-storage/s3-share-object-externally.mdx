...
description: Découvrez comment partager en toute sécurité des fichiers Object Storage en externe dans OVHcloud, en utilisant des URLs signées, des objets public-read ou des politiques de bucket pour un accès contrôlé
...
<Tabs>
  <Tab label="Via des URLs signées">
  ...
  <Tab label="Via des objets publics">
