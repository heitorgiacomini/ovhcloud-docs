...
- Ouvrez la vue **Infrastructure de sauvegarde**. Dans le volet d'inventaire, sélectionnez le nœud **Dépôts de sauvegarde** et cliquez sur <code className="action">Ajouter un dépôt</code> sur le ruban. Dans la boîte de dialogue **Add Backup Repository**, sélectionnez <code className="action">Object Storage</code> > <code className="action">S3 Compatible</code>.

- Ouvrez la vue **Infrastructure de sauvegarde**. Dans le panneau d'inventaire, faites un clic-droit sur le nœud **Dépôts de sauvegarde** et sélectionnez <code className="action">Ajouter un dépôt de sauvegarde</code>. Dans la boîte de dialogue **Add Backup Repository**, sélectionnez <code className="action">Object Storage</code> > <code className="action">S3 Compatible</code>.

<img className="thumbnail" alt="Launch New Object Repository Wizard" src="/images/storage-and-backup/object-storage/s3-veeam/highperf-veeam-20220103142309570.png" loading="lazy" />
...
<img className="thumbnail" alt="Specify Object Storage Name" src="/images/storage-and-backup/object-storage/s3-veeam/highperf-veeam-2022010416461795.png" loading="lazy" />
...
Si vous avez déjà un enregistrement d'informations d'identification qui a été configuré à l'avance, sélectionnez-le dans la liste déroulante. Sinon, cliquez sur <code className="action">Ajouter</code> et fournissez vos clés d'accès et secrètes. Vous pouvez également cliquer sur le lien <code className="action">Gérer les comptes cloud</code> pour ajouter, modifier ou supprimer un enregistrement d'informations d'identification.
...
<img className="thumbnail" alt="Step 3. Specify Object Storage Account" src="/images/storage-and-backup/object-storage/s3-veeam/highperf-veeam-20220104174350437.png" loading="lazy" />
...
Pour sélectionner un dossier, cliquez sur <code className="action">Parcourir</code> et sélectionnez un dossier existant ou créez-en un nouveau en cliquant sur <code className="action">Nouveau dossier</code>.
...
<img className="thumbnail" alt="Step 4. Specify Object Storage Settings" src="/images/storage-and-backup/object-storage/s3-veeam/highperf-veeam-20220104180054702.png" loading="lazy" />
...
- Cliquez sur <code className="action">Finish</code> pour quitter l'assistant.

<img className="thumbnail" alt="Step 5. Finish Working with Wizard" src="/images/storage-and-backup/object-storage/s3-veeam/highperf-veeam-20220104180210797.png" loading="lazy" />
