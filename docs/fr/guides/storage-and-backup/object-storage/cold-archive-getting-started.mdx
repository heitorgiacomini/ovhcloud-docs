...
description: Ce guide vous montre comment gérer vos données avec Cold Archive
...
Pour en savoir plus sur cette classe de stockage, consultez notre guide « [Choisir la bonne classe de stockage pour vos besoins](/guides/storage-and-backup/object-storage/s3-choosing-the-right-storage-class-for-your-needs) ».
...
Comme expliqué en détail dans la [FAQ Cold Archive](/guides/storage-and-backup/object-storage/cold-archive-faq), il existe deux manières de consommer Cold Archive :
...
- [Premiers pas avec Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage#utilisation-de-aws-cli)
- `awscli` version >= 1.16.62

## En pratique

:::info
Vous pouvez retrouver la présentation de Cold Archive v1 ainsi que son workflow [ici](/guides/storage-and-backup/object-storage/cold-archive-overview).
:::
...
<Tabs>
  <Tab label="Via l'API S3 AWS">
    ```bash
    aws --endpoint-url https://s3.rbx-archive.io.cloud.ovh.net put-ovh-archive `<bucket_name>`
    ```
  </Tab>
  <Tab label="Via l'espace client OVHcloud">
    Cliquez sur le bouton <code className="action">⋮</code> puis sur <code className="action">Archiver</code>.
    
    <img className="thumbnail" alt="Archive a cold archive bucket" src="/images/storage-and-backup/object-storage/cold-archive-getting-started/cold_archive_01.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Via l'espace client OVHcloud">
    Cliquez sur le bouton <code className="action">⋮</code> puis sur <code className="action">Restaurer</code>.
    
    <img className="thumbnail" alt="Restore a cold archive bucket" src="/images/storage-and-backup/object-storage/cold-archive-getting-started/cold_archive_02.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Via l'espace client OVHcloud">
    Cliquez sur le bouton <code className="action">⋮</code> puis sur <code className="action">Supprimer</code>.
    
    <img className="thumbnail" alt="Delete a cold archive bucket" src="/images/storage-and-backup/object-storage/cold-archive-getting-started/cold_archive_03.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Via l'espace client OVHcloud">
    ...
    <img className="thumbnail" alt="Cold archive bucket information" src="/images/storage-and-backup/object-storage/cold-archive-getting-started/cold_archive_04.png" loading="lazy" />
  </Tab>
</Tabs>
