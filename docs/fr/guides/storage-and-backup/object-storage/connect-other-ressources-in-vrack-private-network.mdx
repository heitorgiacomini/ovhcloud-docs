...
description: "Découvrez comment utiliser l'Object Storage avec des ressources dans un réseau privé"
...
- Un [réseau privé vRack](/guides/public-cloud/network-services/vrack).
- Une [Gateway Public Cloud](/guides/public-cloud/network-services/create-private-network-gateway).
...
<img className="thumbnail" alt="vrack private network with buckets - diagram" src="/images/storage-and-backup/object-storage/connect-other-ressources-in-vrack-private-network/object_storage_buckets_vrack_private.png" loading="lazy" />

### Création d'un réseau privé vRack et d'une Gateway Public Cloud

Afin de créer et de configurer à la fois une Gateway Public Cloud et un réseau privé vRack, veuillez suivre le guide « [Créer un réseau privé avec une Gateway](/guides/public-cloud/network-services/create-private-network-gateway) ». Ce guide explique comment :
...
Pour appliquer cette nouvelle politique à votre utilisateur S3, veuillez suivre lles étapes définies dans le guide « [Object Storage - Gestion des identités et des accès](/guides/storage-and-backup/object-storage/s3-identity-and-access-management) », et ainsi finaliser l'interconnexion entre vos ressources Object Storage et celles présentes au sein de votre réseau privé.
