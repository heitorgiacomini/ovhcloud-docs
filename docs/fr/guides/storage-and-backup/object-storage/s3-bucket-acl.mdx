...
![policies](/images/storage-and-backup/object-storage/s3-bucket-acl/s3_bucket_acl-20230228171656561.png)
...
- **log delivery group** : ce groupe contient les utilisateurs applicatifs utilisés par les services d'OVHcloud pour écrire les journaux d'accès aux serveurs dans les buckets (voir [Server Access Logging](/guides/storage-and-backup/object-storage/s3-server-access-logging)).
