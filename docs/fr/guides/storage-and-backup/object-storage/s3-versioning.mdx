...
<img className="thumbnail" alt="États du versioning" src="/images/storage-and-backup/object-storage/s3-versioning/versionning.png" loading="lazy" />
...
<img className="thumbnail" alt="Versioning désactivé" src="/images/storage-and-backup/object-storage/s3-versioning/Withversioningdisabled.png" loading="lazy" />
...
<img className="thumbnail" alt="Suppression permanente sans versioning" src="/images/storage-and-backup/object-storage/s3-versioning/Withversioningdisabled2.png" loading="lazy" />
...
<img className="thumbnail" alt="Versioning activé" src="/images/storage-and-backup/object-storage/s3-versioning/Withversioningenabled.png" loading="lazy" />
...
<img className="thumbnail" alt="Marqueur de suppression avec versioning" src="/images/storage-and-backup/object-storage/s3-versioning/Withversioningenabled2.png" loading="lazy" />
...
<img className="thumbnail" alt="Téléchargement ou suppression de versions spécifiques" src="/images/storage-and-backup/object-storage/s3-versioning/Withversioningenabled3.png" loading="lazy" />
...
<Tabs>
  <Tab label="Via l'espace client OVHcloud">
    ...
    Pour supprimer définitivement une version spécifique, cliquez sur l'objet concerné, accédez à l'onglet <code className="action">Versions</code>, cliquez sur le bouton <code className="action">...</code>, sélectionnez <code className="action">Supprimer</code>, puis confirmez la suppression définitive.
  </Tab>
  <Tab label="Via l'AWS CLI">
