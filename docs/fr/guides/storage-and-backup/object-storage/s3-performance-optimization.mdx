...
- Avoir créé un [bucket OVHcloud](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage)
...
:::warning
Les numéros de référence peuvent être compris entre 1 et 10 000 inclus. Vous pouvez vérifier les limitations techniques [ici](/guides/storage-and-backup/object-storage/s3-limitations).
:::
...
Pour personnaliser la valeur par défaut sur AWS CLI, consultez [ce guide](/guides/storage-and-backup/object-storage/s3-optimise-the-sending-of-your-files).
