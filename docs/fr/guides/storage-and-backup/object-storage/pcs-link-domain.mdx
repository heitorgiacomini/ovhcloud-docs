...
description: Retrouvez ici comment lier un nom de domaine a un conteneur.
...
- Consultez le guide [Création de conteneur de stockage](/guides/storage-and-backup/object-storage/pcs-create-container)
- Un nom de domaine
