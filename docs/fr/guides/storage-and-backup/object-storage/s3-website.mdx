...
description: Apprenez à configurer un bucket Object Storage pour héberger un site web statique
...
:::warning
- Assurez-vous que la région dans laquelle vous hébergez votre bucket supporte la classe de stockage que vous choisissez. Vous pouvez consulter la liste des classes de stockage prises en charge par région [ici](/guides/storage-and-backup/object-storage/s3-location).
...
[Activer HTTPS sur un site statique avec un fqdn personnalisé](/guides/storage-and-backup/object-storage/s3-website-https)
