...
description: "Découvrez comment utiliser l'API Swift"
...
Cette URL est composée d'un point de terminaison, disponible à partir de l'[interface Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security), du nom de votre conteneur et du nom de votre objet (y compris le préfixe).
