...
description: "Découvrez comment optimiser l'envoi de vos fichiers vers votre bucket"
...
- [AWS CLI](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) installé
