...
- [Créer un utlisateur OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user#creation-dun-utilisateur-openstack)
...
- [Charger les variables d'environnement OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#recuperation-des-variables)
