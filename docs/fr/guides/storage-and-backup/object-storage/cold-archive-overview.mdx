...
description: Découvrez le service, ses fonctionnalités et sa facturation
...
[OVHcloud Cold Archive](https://www.ovhcloud.com/fr/public-cloud/cold-archive/) est une classe de stockage conçue pour un stockage à long terme des données rarement accédées.
...
Veuillez vous référer à la [FAQ Cold Archive](/guides/storage-and-backup/object-storage/cold-archive-faq) pour en savoir plus sur les principales différences entre les deux options Cold Archive.
...
![Concept Cold Archive](/images/storage-and-backup/object-storage/cold-archive-overview/5_Steps.png)
...
Exploitez votre cycle de vie et apprenez à créer des buckets, archiver, récupérer des données, répertorier les métadonnées, en lisant [ce guide](/guides/storage-and-backup/object-storage/cold-archive-getting-started).

[Toute la documentation Object Storage](/guides/storage-and-backup/object-storage/overview).
