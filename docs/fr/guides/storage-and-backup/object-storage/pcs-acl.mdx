...
description: Retrouvez ici les concepts permettant de mettre en oeuvre les ACL dans Object Storage
...
![Création des utilisateurs](/images/storage-and-backup/object-storage/pcs-acl/create-users.png)
...
![Autre utilisateur](/images/storage-and-backup/object-storage/pcs-acl/other-user.png)
