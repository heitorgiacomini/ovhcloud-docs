...
- Le fichier OpenRC, obtenu depuis l'[espace client OVHcloud](/guides/public-cloud/cross-functional/create-and-delete-a-user) ou [Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
