...
description: "Retrouvez ici les limites techniques de l'offre Object Storage"
...
Découvrez comment maximiser vos performances avec [ce guide](/guides/storage-and-backup/object-storage/s3-performance-optimization).
...
| **Nombre maximum de règles de *lifecycle*** | 1 000 | Comprendre les [règles de *lifecycle*](/guides/storage-and-backup/object-storage/s3-bucket-lifecycle) |
| **Nombre maximum de règles de réplication** | 1 000 | Comprendre la [réplication de buckets](/guides/storage-and-backup/object-storage/s3-asynchronous-replication) |
| **Nombre maximum de tags de bucket** | 50 | - |
| **Nombre maximum de tags d'objet** | 10 | - |
| **Nombre maximum de versions par objet** | 100 000 | Au-delà de cette valeur, une erreur 403 est renvoyée avec le code MaxVersionsReached. Comprendre la [*versioning* des objets](/guides/storage-and-backup/object-storage/s3-versioning) |
...
Consultez notre guide [Object Storage - Compatibilité](/guides/storage-and-backup/object-storage/s3-s3-compliancy).
