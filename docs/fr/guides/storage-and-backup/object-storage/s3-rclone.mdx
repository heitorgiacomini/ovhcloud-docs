...
description: Découvrez comment configurer Rclone afin de synchroniser vos fichiers vers et depuis Object Storage
...
:::info
Pour identifier le point de terminaison correspondant à votre classe de stockage, consultez ce guide : [Object Storage - Endpoints et géo-disponibilité de l’Object Storage](/guides/storage-and-backup/object-storage/s3-location)
:::
