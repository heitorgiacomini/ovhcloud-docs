...
- Disposer de vos identifiants utilisateur (*OS_USERNAME*) et de projet (*OS_PROJECT_NAME* ou *OS_TENANT_NAME*), que vous pouvez obtenir en téléchargeant le fichier « OpenRC » dans le menu [Users and Roles](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#etape-1-recuperer-les-variables) de votre <ManagerLink to="/">espace client Public Cloud OVHcloud</ManagerLink>.
- Disposer de votre mot de passe d'utilisateur OpenStack.

Si vous ne connaissez plus votre mot de passe d'utilisateur OpenStack, vous pouvez le modifier en suivant [ce guide](/guides/public-cloud/cross-functional/create-and-delete-a-user).
