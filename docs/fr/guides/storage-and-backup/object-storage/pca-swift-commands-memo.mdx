...
description: "Retrouvez ici les principales commandes swift pour gérer vos conteneurs d'objets Public Cloud Archive"
...
Consultez la documentation [Mémo de commandes curl](/guides/storage-and-backup/object-storage/pca-curl-commands-memo) pour l'upload du manifest.
:::
