...
La durée minimale des règles de transition entre 2 storage classes est de **1 jour**, ce qui signifie que votre configuration de lifecycle ne sera pas valide et que vous obtiendrez une erreur si le nombre de jours pour votre règle de transition est inférieur à 1 jour. En pratique, si vous avez plus d'une transition, la durée pour la nième transition doit être supérieure ou égale à n.

Exemples:
- vous avez une transition de High Performance à Standard, la durée minimale est de 1 jour
- vous avez 3 transitions: la 1ere de High Performance à Standard, la 2e Standard à Infrequent Access et la 3e de Infrequent Access à Active Archive. La durée minimale pour la 1ere transition est de 1 jour, 2 jours pour la 2e et 3 jours pour la 3e.
