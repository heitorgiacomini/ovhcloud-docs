...
description: "Retrouvez ici les principales commandes swift pour gérer vos conteneurs d'objets"
...
Consultez la documentation [Mémo de commandes curl](/guides/storage-and-backup/object-storage/pcs-curl-commands-memo) pour l'upload du manifest.
:::
