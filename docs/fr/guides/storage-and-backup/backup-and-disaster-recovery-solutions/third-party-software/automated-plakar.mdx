...
description: Découvrez comment automatiser, chiffrer et superviser les sauvegardes de vos serveurs avec Plakar et OVHcloud Object Storage.
...
- Un serveur [VPS](https://www.ovhcloud.com/fr/vps/) ou un [serveur dédié](https://www.ovhcloud.com/fr/bare-metal/).
...
<img className="thumbnail" alt="Aperçu de l'architecture" src="/images/storage-and-backup/backup-and-disaster-recovery-solutions/third-party-software/plakar-automated-backup/architecture_overview.png" loading="lazy" />
...
Dans le menu de gauche, allez dans <code className="action">Object Storage</code>.

**Créer un utilisateur Object Storage**

1. Ouvrez l'onglet <code className="action">Utilisateurs</code>.
2. Cliquez sur <code className="action">Créer un utilisateur</code>.

    <img className="thumbnail" alt="Créer un utilisateur Object Storage" src="/images/storage-and-backup/backup-and-disaster-recovery-solutions/third-party-software/plakar-automated-backup/create_os_user.png" loading="lazy" />
...
1. Cliquez sur <code className="action">Créer un conteneur d'objets</code>.
...
:::info
Pour plus de détails sur la création et la gestion d’un bucket Object Storage, vous pouvez suivre notre guide [Object Storage – Premiers pas avec Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage).
...
1. Rendez-vous dans <code className="action">Bare Metal Cloud</code> > <code className="action">VPS</code>.
2. Cliquez sur <code className="action">Commander</code> puis <code className="action">Configurer votre VPS</code>.

    <img className="thumbnail" alt="Créer un VPS" src="/images/storage-and-backup/backup-and-disaster-recovery-solutions/third-party-software/plakar-automated-backup/create_vps.png" loading="lazy" />
...
Pour plus d'informations sur la configuration initiale et la sécurité des VPS, consultez notre guide [Premiers pas avec un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
...
<summary>Définir un token personnalisé (recommandé)</summary>
...
<summary>Utiliser un token généré automatiquement</summary>
