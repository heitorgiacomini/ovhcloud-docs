...
description: Présentation des fonctionnalités et avantages du produit Backup Agent
...
Découvez comment naviguer dans la VSPC via [ce guide](/guides/storage-and-backup/backup-agent/vspc-presentation).
...
- Le stockage repose sur la technologie [OVHcloud Object Storage](https://www.ovhcloud.com/fr/public-cloud/object-storage/) qui est hébergée dans les datacenters OVHcloud.
