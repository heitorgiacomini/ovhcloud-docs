...
Vous devez télécharger l'agent depuis la section <ManagerLink to="/#/bmc-backup-agent-baremetal/service">Backup Agent</ManagerLink> de votre espace client OVHcloud et l'installer sur votre nouveau système d'exploitation.
