...
description: Découvrez comment fonctionne le système de Vault et la localisation de vos données de sauvegarde
...
Cela se base sur nos buckets Object Storage, que vous pouvez retrouver sur [ce lien](https://www.ovhcloud.com/fr/public-cloud/object-storage/).

Pour retrouver vos Vaults, cliquez sur <ManagerLink to="/#/bmc-backup-agent-baremetal/service">ce lien</ManagerLink> pour accéder à la section <code className="action">Backup Agent</code>, puis cliquez sur l'onglet <code className="action">Vaults</code>.
