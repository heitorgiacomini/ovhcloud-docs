...
description: Ce guide vous présente comment avoir accès à votre cluster en utilisant le client rbd.
...
- L'adresse IP publique ou privée de votre machine cliente est autorisée dans la liste de contrôle d'accès (ACL) &#123;&#125; de votre cluster Ceph. Consultez notre guide « [Cloud Disk Array - Comment créer une ACL IP](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-an-ip-acl) ».
...
Connectez-vous à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur <code className="action">Bare Metal Cloud</code>, puis sur <code className="action">Cloud Disk Array</code> et sélectionnez votre service.
...
- « [Cloud Disk Array - Comment créer des utilisateurs](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-a-user) »
- « [Modifier les droits des utilisateurs](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-change-user-rights) »
:::
