...
description: Activez SME sur votre serveur dédié Ubuntu et créez une machine virtuelle SEV sécurisée
...
[Comment gérer Intel SGX sur un serveur dédié](/guides/bare-metal-cloud/dedicated-servers/sgx-enable-and-use)
