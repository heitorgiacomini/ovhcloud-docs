...
Via l’[API OVHcloud](https://eu.api.ovh.com/), vous pouvez aussi définir des scripts personnalisés.
...
Vous pouvez à tout moment basculer à nouveau sur le disque ou sur le mode rescue à partir de l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> (consultez notre guide « [Activer et utiliser le mode rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) »), ou via l’[API OVHcloud](https://eu.api.ovh.com/).
