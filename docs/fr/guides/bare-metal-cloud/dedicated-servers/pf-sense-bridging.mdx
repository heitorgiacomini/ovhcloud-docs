...
Dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur `Network` dans le menu situé à gauche de l'écran, puis sur `Adresses IP Publiques`.
