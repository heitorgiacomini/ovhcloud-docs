...
description: Exécutez des diagnostics matériels sur votre serveur dédié OVHcloud en mode rescue pour identifier les pannes disque, RAM ou CPU
...
- Avoir redémarré le serveur en [mode rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode).
...
[Récupération des bases de données en mode rescue](/guides/bare-metal-cloud/dedicated-servers/restore-bdd-rescue)

[Comment vérifier la version du firmware BMC sur un serveur dédié](/guides/bare-metal-cloud/dedicated-servers/bmc-fw-update)
