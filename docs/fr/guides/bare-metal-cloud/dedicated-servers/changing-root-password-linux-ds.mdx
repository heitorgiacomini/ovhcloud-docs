---
title: "Configurer les comptes utilisateurs et l'accès root (Dédié)"
description: "Gérez les comptes utilisateurs, l'accès sudo et la connexion root sur un serveur dédié GNU/Linux pour une administration sécurisée"
...
Pour des instructions plus détaillées sur ce sujet, veuillez consulter notre guide « [Premiers pas avec SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) ».
