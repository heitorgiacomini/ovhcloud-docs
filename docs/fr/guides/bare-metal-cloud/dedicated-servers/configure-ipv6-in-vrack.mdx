...
:::info
Le vRack prend en charge le routage public IPv4 et IPv6 avec des blocs d’adresses Additional IP. Retrouvez les instructions sur la configuration de blocs IPv4 dans ce guide : [Configurer un bloc IP dans le vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
...
- Un service [vRack](https://www.ovhcloud.com/fr/network/vrack/) actif sur votre compte
- Un [serveur compatible vRack](https://www.ovhcloud.com/fr/network/vrack/) connecté à votre réseau vRack
...
Consultez notre [comparatif des serveurs Eco](https://eco.ovhcloud.com/fr/compare/) pour obtenir plus d'informations.
...
<summary>Demander un nouveau bloc Additional IPv6</summary>
...
<img className="thumbnail" alt="page de configuration" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurer une IPv6 dans un vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
...
<img className="thumbnail" alt="vrack management" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="vrack selection" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="enabling SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/702.png" loading="lazy" />
...
<summary>Via l'APIv6 (méthode alternative)</summary>
...
- Connectez-vous à <ManagerLink to="/">l'espace client OVHcloud</ManagerLink>.
...
- Dans la barre latérale gauche du Tableau de bord, ouvrez <code className="action">Network</code>.
...
<summary>Configuration IP statique</summary>
...
<summary>Configuration IP automatique (SLAAC)</summary>
...
<img className="thumbnail" alt="Configuring an IPv6 in a vRack for routed-mode" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/routed-mode-20240513.png" loading="lazy" />
...
Après avoir ajouté Additional IP à votre vRack, vous pouvez gérer le sous-réseau routé en cliquant sur le bouton <code className="action">Ajouter un sous-réseau</code> .

<img className="thumbnail" alt="vrack select" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="continue" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/800.png" loading="lazy" />

Le sous-réseau routé `2001:41d0:abcd:ef10::/60` est accessible via le saut suivant `2001:41d0:abcd:ef00::2`.

<img className="thumbnail" alt="continue" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/801.png" loading="lazy" />
...
<summary>Commandes APIv6</summary>
...
<img className="thumbnail" alt="continue" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-02.png" loading="lazy" />
...
<summary>Configuration IP statique d'un hôte (recommandé)</summary>
...
<summary>Configuration IP automatique (SLAAC) pour un hôte</summary>
...
<summary>Configuration du sous-réseau routé sur un hôte et à l'intérieur d'une machine virtuelle</summary>
...
<summary>Configuration d'un sous-réseau routé dans une VM</summary>
...
<summary>Locale, sur un hôte</summary>
...
<summary>Locale, sur une VM</summary>
...
<summary>Depuis un hôte distant</summary>
