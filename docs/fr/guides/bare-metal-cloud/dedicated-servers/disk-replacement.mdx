...
description: "Identifiez un disque défectueux sur votre serveur dédié OVHcloud et demandez son remplacement via l'espace client"
...
Si vous possédez un serveur disposant d'un RAID logiciel, référez-vous au guide [« RAID Logiciel »](/guides/bare-metal-cloud/dedicated-servers/raid-soft) afin de trouver les disques installés sur votre serveur.
...
Si vous possédez un serveur disposant d'un RAID matériel, référez-vous au guide [« RAID Matériel »](/guides/bare-metal-cloud/dedicated-servers/raid-hard) et utilisez la procédure concernant votre type de contrôleur RAID pour trouver les chemins d'accès à vos disques.
...
Dans le cas d'un disque NVMe, il sera nécessaire de placer le serveur en [mode rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) et installer l'outil `nvme-cli`.
...
- **le numéro de série du disque à remplacer ainsi que de tous les autres disques sains**. Pour récupérer le numéro de série du disque à remplacer, consultez [ce guide](/guides/bare-metal-cloud/dedicated-servers/how-to-find-hdd-serial). Si, pour une raison ou une autre, il n'est pas possible d'extraire le numéro de série du disque, veuillez le notifier dans le ticket, et nous communiquer le numéro de série du ou des disques à ne pas remplacer. 
...
:::info
Ce type de remplacement n'est possible que pour les [serveurs dédiés](https://www.ovhcloud.com/fr/bare-metal/) avec une carte RAID.
:::
...
Si vous possédez un serveur en RAID logiciel, il convient de lancer manuellement la resynchronisation de vos disques. Pour cela, n'hésitez pas à vous reporter à la documentation liée au [« RAID logiciel »](/guides/bare-metal-cloud/dedicated-servers/raid-soft).

## Aller plus loin

[RAID logiciel](/guides/bare-metal-cloud/dedicated-servers/raid-soft)

[RAID matériel](/guides/bare-metal-cloud/dedicated-servers/raid-hard)

[Mode Rescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
