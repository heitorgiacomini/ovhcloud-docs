...
description: Configurez le pare-feu intégré de Windows sur votre serveur dédié pour contrôler le trafic réseau entrant et sortant
...
<img className="thumbnail" alt="Ecran des paramètres avances du pare-feu Windows" src="/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/step1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Liste des règles entrantes avec option d'activation" src="/images/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win/step2.PNG" loading="lazy" />
