...
:::info
Pour récupérer l'accès à un serveur auquel vous vous connectez avec une clé SSH, référez-vous alors à notre guide « [Comment remplacer une paire de clés SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair) ».
...
Pensez à utiliser le mode de démarrage **normal** de votre serveur lorsque vous le redémarrez depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>.
