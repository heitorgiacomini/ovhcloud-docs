...
description: Résolvez les lenteurs de téléchargement dans les conteneurs et VM Proxmox VE sur les serveurs avec cartes réseau Broadcom BCM57502
...
[Configurer le réseau sur Proxmox VE sur les gammes High Grade, Scale & Advance](/guides/bare-metal-cloud/dedicated-servers/proxmox-network-hg-scale)
