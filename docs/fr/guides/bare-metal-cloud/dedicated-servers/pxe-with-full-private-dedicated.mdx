...
description: Découvrez comment réaliser les redémarrages de vos serveurs OVHcloud fonctionnant à travers votre agrégation privée active
...
Vous avez donc la possiblité d'utiliser/déclarer vos réseaux *publics* et *privés* en passant par notre solution [vRack](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server).
...
La seule différence majeure notable est que les [réseaux privés](/guides/network/ovhcloud-connect/overview#prive) n'ont donc pas accès à tout ce qui n'appartient pas à votre infrastructure.<br/>
...
![Netboot en action](/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/netboot_steps.png)
...
- Avoir toutes les interfaces réseau de ce serveur en mode **privé**, ce qui sous-entend que vous avez préalablement configuré [notre fonctionnalité OLA](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager).<br/>
...
>
> Sélectionnez votre serveur et vérifiez son éligibilité à `OLA: OVHcloud Link Aggregation` dans l'onglet <code className="action">Interfaces réseau</code>.
>
...
<img className="thumbnail" alt="iPXE en action" src="/images/bare-metal-cloud/dedicated-servers/pxe-with-full-private-dedicated/animation.gif" loading="lazy" />
