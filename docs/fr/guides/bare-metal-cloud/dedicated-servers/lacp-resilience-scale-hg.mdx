...
description: "Renforcez la résilience réseau de votre serveur Bare Metal OVHcloud en configurant l'agrégation des interfaces publiques et privées"
...
- Disposer d'un [serveur dédié](https://www.ovhcloud.com/fr/bare-metal/) possédant 4 interfaces réseau (gammes High Grade et SCALE).
...
<img className="thumbnail" alt="Comparaison de la résilience avant/après" src="/images/bare-metal-cloud/dedicated-servers/lacp-resilience-scale-hg/resilience_comparison.svg" loading="lazy" />
...
Pour activer la nouvelle règle, vous devez [passer en mode **OLA**](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager), puis revenir au mode par défaut.
...
[Comment configurer l'agrégation de liens avec LACP dans Debian 12 ou Ubuntu 24.04](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-netplan)
