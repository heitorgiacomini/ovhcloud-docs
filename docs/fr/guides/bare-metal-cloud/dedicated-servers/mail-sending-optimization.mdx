...
Vous pouvez bien entendu aller plus loin, en configurant l'enregistrement SPF pour un nom de domaine spécifique ou en utilisant l'adresse IPv6. Pour bien comprendre l'enregistrement SPF, consultez notre guide sur la [configuration d'un enregistrement SPF](/guides/web-cloud/domains/dns-zone-spf).
...
Pour plus d'informations, consultez notre guide sur la [configuration d'un enregistrement DKIM](/guides/web-cloud/domains/dns-zone-dkim).
...
Pour plus d'informations, consultez notre guide sur la [configuration d'un enregistrement DMARC](/guides/web-cloud/domains/dns-zone-dmarc).
...
Si vos serveurs DNS sont gérés par OVHcloud, consultez notre guide sur [l'édition d'une zone DNS OVHcloud via votre espace client](/guides/web-cloud/domains/dns-zone-edit).
...
Pour configurer le chemin du *reverse* DNS dans <ManagerLink to="/">l'espace client OVHcloud</ManagerLink> veuillez vous référer à [notre guide dédié](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns).
