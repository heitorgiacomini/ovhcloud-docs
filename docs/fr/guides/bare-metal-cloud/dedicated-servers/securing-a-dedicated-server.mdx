...
description: "Appliquez les mesures de sécurité essentielles sur votre serveur dédié : durcissement SSH, configuration du firewall et surveillance"
...
S'il s'agit de votre première configuration d'un serveur dédié OVHcloud, nous vous invitons à consulter en premier lieu notre guide [Premiers pas avec un serveur dédié](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).
:::
...
Pour plus d'informations sur iptables, consultez notre [guide dédié](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).
...
Pour plus d'informations sur nos solutions de stockage de sauvegarde, consultez notre [guide](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage) de stockage de sauvegarde.

## Aller plus loin

[Configurer le pare-feu sous Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)

[Network Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network)

[Tutoriel - Installer un serveur web (LAMP) sur Debian ou Ubuntu](/guides/bare-metal-cloud/dedicated-servers/installing-lamp-debian9-ubuntu18)

[Sécuriser un serveur avec service Memcached](/guides/bare-metal-cloud/dedicated-servers/memcache-secure)
