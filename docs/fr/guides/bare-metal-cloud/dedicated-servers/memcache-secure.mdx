...
description: "Sécurisez le service Memcached sur votre serveur dédié pour empêcher les accès distants non autorisés et l'exposition des données"
...
[Configurer le pare-feu sous Linux avec Iptables](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable)
