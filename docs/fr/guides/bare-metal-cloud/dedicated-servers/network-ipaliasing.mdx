...
<Tabs>
  ...
  <Tab label="Windows Servers">
    ...
    **En lignes de commande (recommandé)**
    ...
    :::warning
    Attention, le serveur ne sera plus accessible si vous entrez des informations incorrectes. Vous devrez alors effectuer les corrections en mode [WinRescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode#windows) ou via l'[IPMI](/guides/bare-metal-cloud/dedicated-servers/ipmi).
    :::
    ...
    :::warning
    Attention, le serveur ne sera plus accessible si vous entrez des informations incorrectes. Vous serez alors obligé d’effectuer les corrections en mode [WinRescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode#windows) ou via l'[IPMI](/guides/bare-metal-cloud/dedicated-servers/ipmi).
    :::
