...
description: Déployez un OpenNebula Hosted Cloud certifié en utilisant des serveurs Bare Metal OVHcloud et des playbooks Ansible
...
- **Deux** [serveurs dédiés](https://www.ovhcloud.com/fr/bare-metal/) des gammes Scale ou High Grade
- Un service [vRack](https://www.ovhcloud.com/fr/network/vrack/) actif
- Un bloc public d'adresses [Additional IP](https://www.ovhcloud.com/fr/network/additional-ip/), dimensionné selon vos besoins
...
Les serveurs de la [gamme Scale](https://www.ovhcloud.com/fr/bare-metal/scale/) sont adaptés aux environnements de cloud de petite à moyenne taille.

Les serveurs de la [gamme High Grade](https://www.ovhcloud.com/fr/bare-metal/high-grade/) sont plus appropriés pour les charges de travail de production lourdes.
...
Tout d'abord, vous devez installer Ubuntu 24.04 LTS sur vos deux serveurs dédiés, en suivant les instructions de [ce guide](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).

Ensuite, ajoutez les deux serveurs à votre service vRack en suivant l'étape 2 de [ce guide de configuration vRack](/guides/bare-metal-cloud/dedicated-servers/vrack-configuring-on-dedicated-server).

Enfin, depuis l'espace client OVHcloud, ouvrez la section <code className="action">Réseau</code>, puis sélectionnez <code className="action">Adresses IP publiques</code> sous **Réseau public**. Une fois que vous avez atteint l'interface de gestion des IP, cliquez sur le bouton <code className="action">Commander des IPs</code> en haut de la page. Choisissez la version d'IP, puis **sélectionnez le vRack auquel vos serveurs sont connectés**, et la région dans laquelle ces serveurs sont hébergés.
...
Si vous avez des doutes ou besoin d'informations supplémentaires, veuillez consulter le guide suivant : [Configuration d'un bloc d'IP supplémentaire dans un vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
...
<img className="thumbnail" alt="Network" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/opennebula_network.png" loading="lazy" />
...
Pour plus d'informations sur les paramètres d'agrégation de liens, veuillez consulter le guide suivant : [Améliorer la résilience réseau sur les serveurs Bare Metal](/guides/bare-metal-cloud/dedicated-servers/lacp-resilience-scale-hg).
...
Ouvrez les pages de gestion des deux serveurs dédiés et recueillez les paramètres mis en évidence :

<img className="thumbnail" alt="page d'administration des serveurs dédiés" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/bare_metal_network.png" loading="lazy" />
...
<img className="thumbnail" alt="ip address des serveurs dédiés" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/bare_metal_ip_address.png" loading="lazy" />
...
<img className="thumbnail" alt="user guide template 1" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_template_1.png" loading="lazy" />

<img className="thumbnail" alt="user guide template 2" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_template_2.png" loading="lazy" />

### Démarrer un nouveau serveur virtuel

Sur la base du modèle importé, créez une nouvelle instance de serveur virtuel.

<img className="thumbnail" alt="user guide create vm 1" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_1.png" loading="lazy" />

<img className="thumbnail" alt="user guide create vm 2" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_2.png" loading="lazy" />

<img className="thumbnail" alt="user guide create vm 3" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_3.png" loading="lazy" />

Vous pouvez ajuster la capacité de stockage, l'allocation CPU et RAM lors de cette phase de configuration.

<img className="thumbnail" alt="user guide create vm 4" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_4.png" loading="lazy" />

<img className="thumbnail" alt="user guide create vm 5" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_5.png" loading="lazy" />

<img className="thumbnail" alt="user guide create vm 6" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_6.png" loading="lazy" />
...
<img className="thumbnail" alt="user guide create vm 7" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_7.png" loading="lazy" />

<img className="thumbnail" alt="user guide create vm 8" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_create_vm_8.png" loading="lazy" />
...
<img className="thumbnail" alt="user guide check vm 1" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_1.png" loading="lazy" />

<img className="thumbnail" alt="user guide check vm 2" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_2.png" loading="lazy" />

Lancez la console de votre serveur virtuel pour valider le déploiement.

<img className="thumbnail" alt="user guide check vm 3" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_3.png" loading="lazy" />

<img className="thumbnail" alt="user guide check vm 4" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_connectivity_4.png" loading="lazy" />
...
<img className="thumbnail" alt="user guide hotplug 1" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_1.png" loading="lazy" />

<img className="thumbnail" alt="user guide hotplug 2" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_2.png" loading="lazy" />

<img className="thumbnail" alt="user guide hotplug 3" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_3.png" loading="lazy" />

<img className="thumbnail" alt="user guide hotplug 4" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_hotplug_4.png" loading="lazy" />
...
<img className="thumbnail" alt="user guide terminate 1" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_terminate_1.png" loading="lazy" />

<img className="thumbnail" alt="user guide terminate 2" src="/images/bare-metal-cloud/dedicated-servers/opennebula-deployment/user_guide_terminate_2.png" loading="lazy" />
...
Si vous avez besoin de formation ou d'une assistance technique pour mettre en œuvre nos solutions, contactez votre représentant commercial ou cliquez sur [ce lien](https://www.ovhcloud.com/fr/professional-services/) pour obtenir un devis et demander l'assistance des experts de notre équipe Professional Services pour votre cas d'utilisation et projet spécifiques.
