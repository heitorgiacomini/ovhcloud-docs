...
description: "Récupérez le numéro de série d'un disque dur sur votre serveur dédié pour l'identifier lors d'une demande de remplacement"
...
Pour un aperçu détaillé de ces commandes et de la façon de tester vos disques durs, reportez-vous à [ce guide (contrôleur RAID LSI)](/guides/bare-metal-cloud/dedicated-servers/raid-hard).
...
Vous pouvez vous référer à [ce guide (contrôleur RAID LSI)](/guides/bare-metal-cloud/dedicated-servers/raid-hard) pour déterminer quel disque dur correspond à un périphérique « sg » désigné.
...
[Remplacer un disque défectueux](/guides/bare-metal-cloud/dedicated-servers/disk-replacement)
