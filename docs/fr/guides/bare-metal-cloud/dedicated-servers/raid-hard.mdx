...
description: "Vérifiez l'état de votre contrôleur RAID matériel et surveillez la santé des disques durs sur votre serveur dédié OVHcloud"
...
- Posséder un [serveur dédié](https://www.ovhcloud.com/fr/bare-metal/) avec une configuration RAID matériel.
