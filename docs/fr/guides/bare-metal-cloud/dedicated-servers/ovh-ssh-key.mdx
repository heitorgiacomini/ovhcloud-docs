...
description: Installez une clé SSH OVHcloud sur votre serveur dédié pour accorder un accès administratif sécurisé aux équipes support OVHcloud
...
- Être [connecté en SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) (accès root).
...
[Comment stocker les clés SSH dans votre espace client](/guides/bare-metal-cloud/dedicated-servers/import-keys-control-panel)
