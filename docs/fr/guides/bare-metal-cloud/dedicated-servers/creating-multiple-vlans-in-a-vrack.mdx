...
<img className="thumbnail" alt="Server Manager Local Server avec NIC Teaming desactive" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Menu contextuel pour ajouter l'interface a une nouvelle equipe" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-02.0.png" loading="lazy" />
...
<img className="thumbnail" alt="Dialogue New Team avec nom de l'equipe et bouton OK" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-02.png" loading="lazy" />
...
<img className="thumbnail" alt="Proprietes de l'interface NIC Teaming avec tag VLAN spécifique" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-03.png" loading="lazy" />
...
<img className="thumbnail" alt="Menu Demarrer de Windows affichant l'option Panneau de configuration" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-04.png" loading="lazy" />

Cliquez sur <code className="action">Réseau et Internet</code> :

<img className="thumbnail" alt="Panneau de configuration avec categorie Réseau et Internet" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-05.png" loading="lazy" />

Cliquez ensuite sur <code className="action">Centre Réseau et partage</code> :

<img className="thumbnail" alt="Lien Centre Réseau et partage sous Windows" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-06.png" loading="lazy" />

Cliquez alors sur <code className="action">Modifier les paramètres de la carte</code> :

<img className="thumbnail" alt="Modifier les paramètres de la carte dans le Centre Réseau et partage" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-07.png" loading="lazy" />

Ensuite, faites un clic droit sur l’interface VLAN, puis cliquez sur <code className="action">Propriétés</code> :

<img className="thumbnail" alt="Clic droit sur l'interface VLAN pour ouvrir les Proprietes" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-08.png" loading="lazy" />
...
<img className="thumbnail" alt="Proprietes de la carte avec protocole IPv4 mis en évidence" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-09.png" loading="lazy" />
...
<img className="thumbnail" alt="Paramètres IPv4 avec adresse IP et masque de sous-réseau du VLAN" src="/images/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack/vrack2-windows-10.png" loading="lazy" />
