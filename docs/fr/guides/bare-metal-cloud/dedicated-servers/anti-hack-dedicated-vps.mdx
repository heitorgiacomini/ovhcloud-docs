...
description: "Découvrez les informations visibles et fournies lorsque la protection Anti-Hack interne d'OVHcloud est déclenchée"
...
Lorsque la protection Anti-Hack est déclenchée sur votre Serveur dédié, un message s'affiche dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> : « *Votre serveur a été compromis. Veuillez contacter notre équipe d'assistance pour obtenir des instructions sur la marche à suivre.* »
...
<img className="thumbnail" alt="informations antihack SD" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-service.png" loading="lazy" />
...
<img className="thumbnail" alt="informations antihack VPS" src="/images/bare-metal-cloud/dedicated-servers/anti-hack-dedicated-vps/hacked-vps.png" loading="lazy" />
