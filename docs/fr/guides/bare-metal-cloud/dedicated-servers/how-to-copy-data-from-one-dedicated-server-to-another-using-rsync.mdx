...
description: Copiez facilement les données de votre serveur dédié vers un autre grâce à rsync
...
[Comment utiliser le SFTP pour transférer des fichiers](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp)

[Migrer les données d'un serveur dédié vers un autre](/guides/bare-metal-cloud/dedicated-servers/migrate-a-server-to-another)
