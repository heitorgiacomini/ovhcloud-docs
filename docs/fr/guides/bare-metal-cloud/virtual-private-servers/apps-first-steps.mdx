...
description: Découvrez comment déployer des applications préinstallées sur votre VPS
...
Depuis <ManagerLink to="/">l'espace client OVHcloud</ManagerLink> ou les API OVHcloud, installez l'application de votre choix. Vous pouvez également consulter notre guide [Débuter avec un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
