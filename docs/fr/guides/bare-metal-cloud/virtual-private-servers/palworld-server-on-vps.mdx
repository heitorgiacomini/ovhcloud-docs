...
description: Découvrez comment installer votre propre serveur compatible avec Palworld sur un VPS ou un Serveur Dédié OVHcloud
...
:::warning
Si vous n'êtes pas familier avec l'utilisation d'un VPS, consultez notre guide « [Débuter avec un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) ».

Pour une installation sur un serveur dédié, assurez-vous d'avoir suivi les [premiers pas avec un serveur dédié](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).
:::


## En pratique

Une fois le système d'exploitation installé, connectez-vous à votre VPS en SSH, tel que décrit dans le guide « [Débuter avec un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) ».<br/>
Si vous utilisez un serveur dédié, suivez les instructions du guide « [Premiers pas avec un serveur dédié](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server) ».
...
Plusieurs informations vous sont demandées. Appuyez sur la touche <code className="action">Entrée</code> pour valider.
...
Suivez les instructions à l'écran et appuyez sur la touche <code className="action">Entrée</code> pour valider.
