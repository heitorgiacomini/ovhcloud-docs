...
description: Découvrez comment déployer et automatiser le code de votre site web via GitHub Actions sur un VPS OVHcloud
...
:::warning
Si besoin, consultez notre guide « [Débuter avec un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) » avant de poursuivre la lecture de ce guide.
:::
...
:::info
Afin d'être sûr de remplir les prérequis, consultez les guides « [Installer un environnement de développement web sur un VPS ou un serveur dédié](/guides/bare-metal-cloud/virtual-private-servers/install-env-web-dev-on-vps) » et « [Sécuriser un VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps) ».
:::
