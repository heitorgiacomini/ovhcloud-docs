...
description: Découvrez comment exporter et importer une configuration n8n complète (workflows et identifiants) d’un VPS externe vers un VPS OVHcloud, et inversement.
...
- Disposer de deux [VPS](https://www.ovhcloud.com/fr/vps/) fonctionnels (OVHcloud ou autres)
- Disposer d'un accès administrateur (sudo) via SSH à votre serveur

## En pratique

:::tip[Success]
Si vous devez commencer une nouvelle installation, optez pour un [VPS n8n OVHcloud préinstallé](https://www.ovhcloud.com/fr/vps/vps-n8n/) pour démarrer rapidement.
:::
...
<Tabs>
  <Tab label="Cas A - Installation en CLI natif">
  ...
  <Tab label="Cas B - Installation via Docker">
    ...
    <img className="thumbnail" alt="Import export n8n" src="/images/bare-metal-cloud/virtual-private-servers/import-export-n8n/workflow_successfully_exported.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="Import export n8n" src="/images/bare-metal-cloud/virtual-private-servers/import-export-n8n/workflow_successfully_copied.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Cas B - Installation via Docker">
    ...
    <img className="thumbnail" alt="Import export n8n" src="/images/bare-metal-cloud/virtual-private-servers/import-export-n8n/credentials_successfully_exported.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="Import export n8n" src="/images/bare-metal-cloud/virtual-private-servers/import-export-n8n/credentials_successfully_copied.png" loading="lazy" />
  </Tab>
</Tabs>
...
Pour en savoir plus, consultez notre guide [Modifier une zone DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit)
