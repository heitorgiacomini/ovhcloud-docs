...
description: Découvrez comment sécuriser un serveur avec Iptables
...
Consultez notre guide sur la [sécurisation d'un VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps) pour plus d'informations.
...
<img className="thumbnail" alt="version-iptables" src="/images/bare-metal-cloud/virtual-private-servers/firewall-Linux-iptable/step2-version-iptables.PNG" loading="lazy" />
...
Pour plus d'informations sur l'accès à cet outil, veuillez consulter [ce guide](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps).  
:::
