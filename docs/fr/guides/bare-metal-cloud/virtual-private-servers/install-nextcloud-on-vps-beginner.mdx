...
description: Découvrez comment installer simplement Nextcloud sur un VPS OVHcloud à l’aide de Docker et de Docker Compose, afin de disposer d’un cloud personnel fonctionnel
...
- Disposer d'une offre [VPS OVHcloud](https://www.ovhcloud.com/fr/vps/) sous **Ubuntu 22.04 LTS** (ou équivalent)
...
Dans votre navigateur, ouvrez [http://IPv4_DE_VOTRE_VPS:8080](http://IPv4_DE_VOTRE_VPS:8080).
