...
description: "Découvrez comment envoyer des SMS depuis n8n en utilisant l'API OVHcloud"
...
- Disposer d'un [compte SMS OVHcloud](https://www.ovhcloud.com/fr/sms/) et d'un [expéditeur SMS](/guides/web-cloud/messaging/sms/sms-senders) valide.
- Disposer d'un [VPS OVHcloud](https://www.ovhcloud.com/fr/vps/), d'un serveur ou d'un poste local avec [n8n](https://n8n.io/) installé et accessible.

## En pratique

Si vous n'avez pas encore installé [n8n](https://n8n.io/) sur votre VPS, suivez les instructions de notre guide « [Installer n8n sur un VPS OVHcloud](/guides/bare-metal-cloud/virtual-private-servers/install-n8n-on-vps) ».
...
Pour cela, consultez la section **Utilisation avancée : coupler les API OVHcloud avec une application** de notre guide « [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps) », puis copiez et conservez les trois identifiants `Application key`, `Application secret` et `Consumer key`.
...
<img className="thumbnail" alt="N8N SMS" src="/images/bare-metal-cloud/virtual-private-servers/n8n-sms/nodes.png" loading="lazy" />
...
- [L'expéditeur doit être défini dans votre compte OVHcloud](/guides/web-cloud/messaging/sms/sms-senders). Pour réaliser un test sans déclarer d'expéditeur et utiliser un numéro court, remplacez `"sender": "Your_sender"` par `"senderForResponse": true`.
:::
