...
description: "Découvrez comment réinitialiser le mot de passe de votre compte Administrateur Windows sur un VPS ou une instance Public Cloud grâce au mode Rescue d'OVHcloud"
...
Connectez-vous à votre serveur via SSH. (Consultez notre [guide d'introduction SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) si nécessaire.)

Vous pouvez également ouvrir une connexion au serveur en utilisant [KVM (VPS)](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps) ou la [console VNC (instance Public Cloud)](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#accessvnc).
