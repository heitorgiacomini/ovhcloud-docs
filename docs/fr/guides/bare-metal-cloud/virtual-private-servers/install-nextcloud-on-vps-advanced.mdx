...
- Disposer d'une offre [VPS OVHcloud](https://www.ovhcloud.com/fr/vps/) sous **Ubuntu 22.04 LTS**
...
- Accédez à [https://cloud.exemple.com](https://cloud.exemple.com)
...
Pour un premier déploiement ou un usage personnel, le **[guide pour utilisateurs débutants](/guides/bare-metal-cloud/virtual-private-servers/install-nextcloud-on-vps-beginner)** est suffisant.
