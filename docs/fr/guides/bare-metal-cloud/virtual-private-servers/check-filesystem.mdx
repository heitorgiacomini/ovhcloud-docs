...
Lancez un redémarrage du serveur en mode rescue depuis l'espace client. Si nécessaire, consultez notre [guide du mode rescue](/guides/bare-metal-cloud/virtual-private-servers/rescue).
