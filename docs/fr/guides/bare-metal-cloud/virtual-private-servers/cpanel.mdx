...
Si vous disposez déjà d'un VPS et que vous souhaitez y installer cPanel, vous pouvez réinstaller le VPS à partir de votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> via un [OS compatible avec cPanel](https://www.ovhcloud.com/fr/vps/os/).
