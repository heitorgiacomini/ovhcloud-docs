...
description: Comment se connecter aux API ou lignes de commande OpenStack avec ses comptes de service OVHcloud
...
- Vous savez [utiliser l'API OpenStack](/guides/public-cloud/compute/starting-with-nova).
