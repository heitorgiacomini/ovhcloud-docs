...
Il est possible d'accéder au Swagger correspondant à votre domaine OKMS en cliquant sur le lien présent dans le <ManagerLink to="/#/dedicated/security/kms">dashboard de votre domaine OKMS</ManagerLink>.

<img className="thumbnail" alt="swagger" src="/images/manage-and-operate/secret-manager/secret-manager-rest-api/swagger.png" loading="lazy" />
...
<img className="thumbnail" alt="public-swagger-ui" src="/images/manage-and-operate/secret-manager/secret-manager-rest-api/public-swagger-ui.png" loading="lazy" />
...
<img className="thumbnail" alt="firefox-cert-manager" src="/images/manage-and-operate/secret-manager/secret-manager-rest-api/firefox-cert-manager.png" loading="lazy" />
...
<img className="thumbnail" alt="chromium-cert-manager" src="/images/manage-and-operate/secret-manager/secret-manager-rest-api/chromium-cert-manager.png" loading="lazy" />
...
<img className="thumbnail" alt="identification-certificat" src="/images/manage-and-operate/secret-manager/secret-manager-rest-api/firefox-identify-with-certificate.png" loading="lazy" />
