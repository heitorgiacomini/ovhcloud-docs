...
Il est possible d'accéder au swagger correspondant à votre KMS en cliquant sur le lien présent dans le dashboard de votre domaine <ManagerLink to="/#/dedicated/security/kms">Key Management Service</ManagerLink>.
