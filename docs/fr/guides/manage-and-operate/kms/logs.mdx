...
description: Analyser les logs KMS via LDP
...
Les logs du KMS sont accessibles depuis l'onglet <code className="action">Logs</code> d'un KMS.
...
Depuis l'onglet <code className="action">Logs</code> il est possible de s'abonner à un flux LDP.
Une fois l'abonnement actif, l'ensemble des logs seront transmis à [Logs Data Platform](https://www.ovhcloud.com/fr/identity-security-operations/logs-data-platform/) pour retrouver l'historique des logs générés et la possiblité de faire des recherches plus avancées, créer des alertes et des visualisations.

<img className="thumbnail" alt="LDP Subscription" src="/images/manage-and-operate/kms/kms-troubleshooting/kms-ldp-subscription.png" loading="lazy" />

Pour plus d'informations, veuillez consulter notre guide « [Quick start for Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start) ».
