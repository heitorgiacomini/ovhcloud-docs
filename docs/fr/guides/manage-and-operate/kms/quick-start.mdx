...
description: Mettez en oeuvre votre OVHcloud KMS
...
Les étapes nécessaires pour créer votre certificat d'accès sont disponibles dans la [documentation associée](/guides/manage-and-operate/kms/okms-certificate-management).
...
- En utilisant les [API Rest](/guides/manage-and-operate/kms/kms-usage), si vous souhaitez utiliser manuellement les API pour chiffrer ou signer vos données.
- En utilisant le [protocole KMIP](/guides/manage-and-operate/kms/kms-kmip), si vous souhaitez connecter n'importe quel produit compatible KMIP avec le KMS OVHcloud.
