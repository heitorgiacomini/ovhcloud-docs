...
description: "Découvrez les nouveaux principes d'exposition et de consommation liés à l'API v2 OVHcloud"
...
:::info
Les exemples d'évènement et de tâche présentés ci-dessus peuvent varier selon la section d'API. Veuillez vous référer à la [console](/guides/manage-and-operate/api/console-preview) pour visualiser la définition exacte relative à chaque section.
:::
...
[Exploration des API OVHcloud](/guides/manage-and-operate/api/console-preview)
