...
Pour lister et révoquer les clés, il est possible d'utiliser le [portail API](https://eu.api.ovh.com/) ou l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> :
...
<Tabs>
  ...
  <Tab label="Via l'espace client OVHcloud">
    Rendez-vous sur la page <ManagerLink to="/#/dedicated/account/iam/api-keys">Clés API</ManagerLink>.
