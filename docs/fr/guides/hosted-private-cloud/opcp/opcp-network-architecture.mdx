...
- les flux sortants d'OPCP vers vos services d'infrastructure (NTP, DNS, S3<sup>1</sup> de sauvegarde, LDAP, syslog).
...
<img className="thumbnail" alt="Topologie OPCP NANOPOD - 1 contrôleur" src="/images/hosted-private-cloud/opcp/opcp-network-architecture/opcp-1controller-setup.png" loading="lazy" />
...
<img className="thumbnail" alt="Topologie OPCP STANDARD POD/FABRIC - 3 contrôleurs" src="/images/hosted-private-cloud/opcp/opcp-network-architecture/opcp-3controllers-setup.png" loading="lazy" />
