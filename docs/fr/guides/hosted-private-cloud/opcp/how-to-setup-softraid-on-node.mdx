...
description: Apprenez à configurer et gérer un RAID logiciel sur un nœud OpenStack Ironic dans OPCP
...
- [Guide OPCP - Cycle de vie d'un nœud](/guides/hosted-private-cloud/opcp/node-lifecycle)
