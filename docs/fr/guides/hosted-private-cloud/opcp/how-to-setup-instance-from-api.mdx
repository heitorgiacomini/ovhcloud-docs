...
description: Découvrez comment déployer une instance OPCP via les API OpenStack en configurant les réseaux, sous-réseaux, instances et clés SSH
...
- [Charger les variables d'environnement pour le projet](/guides/hosted-private-cloud/opcp/how-to-use-api-and-get-credentials).
