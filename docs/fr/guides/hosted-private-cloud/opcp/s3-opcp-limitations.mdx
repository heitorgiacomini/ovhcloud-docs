...
description: "Découvrez les spécifications d'Object Storage pour OVHcloud OPCP, avec informations sur l'accès aux buckets, les classes de performance, le chiffrement et le versioning."
...
Les fonctionnalités d'Object Storage dans OPCP sont principalement les mêmes que dans les régions OVHcloud. Certaines différences importantes sont détaillées dans [le tableau comparatif de ce guide](/guides/storage-and-backup/object-storage/s3-s3-compliancy).
