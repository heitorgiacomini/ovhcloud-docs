...
- Allez dans la section `Clients` et cliquez sur <code className="action">Créer un client</code>.  
...
- Cliquez sur <code className="action">Suivant</code>, puis sur <code className="action">Enregistrer</code>.
...
- Cliquez sur <code className="action">Configurer un nouveau mapper</code>.
