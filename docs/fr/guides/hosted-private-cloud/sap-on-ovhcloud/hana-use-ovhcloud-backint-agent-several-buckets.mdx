...
description: Ce guide fournit des instructions générales pour utiliser OVHcloud Backint Agent pour SAP HANA avec plusieurs buckets Object Storage
...
- [Un projet Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) dans votre compte OVHcloud avec :
    - [Deux buckets Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) et [un utilisateur Object Storage](/guides/storage-and-backup/object-storage/s3-identity-and-access-management#creation-dun-utilsateur) avec le droit de lecture et d'écriture.
- Une base de données SAP HANA installée.
- [OVHcloud Backint Agent pour SAP HANA installé](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-install-ovhcloud-backint-agent).
...
Pour la planification de vos sauvegardes SAP HANA, veuillez vous référer à notre guide [Installer et utiliser OVHcloud Backint Agent pour SAP HANA](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-install-ovhcloud-backint-agent#planification).

### Restauration

Pour la restauration de votre base de données SAP HANA, veuillez vous référer à notre guide [Installer et utiliser OVHcloud Backint Agent pour SAP HANA](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-install-ovhcloud-backint-agent#restauration).
