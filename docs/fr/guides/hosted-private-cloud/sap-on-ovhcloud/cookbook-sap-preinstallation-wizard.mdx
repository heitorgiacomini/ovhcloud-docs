...
Pour accéder à notre assistant de pré-installation SAP, rendez-vous dans la section <code className="action">SAP Features Hub</code> du menu <code className="action">Hosted Private Cloud</code>, disponible depuis <ManagerLink to="/">l'espace client</ManagerLink> de votre compte OVHcloud.
