...
description: Découvrez comment prendre en main et configurer votre environnement Bare Metal Pod SecNumCloud
...
<img className="thumbnail" alt="Page de connexion Keycloak" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/keycloak_login.png" loading="lazy" />

Une fois vos identifiants saisis pour vous enregistrer, vous aurez accès au tableau de bord du produit.

<img className="thumbnail" alt="Dashboard visible une fois identifié" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/dashboard.png" loading="lazy" />
...
<img className="thumbnail" alt="Emplacement du raccourci vers Horizon" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/dashboard_login_horizon.png" loading="lazy" />

Après s’être connecté, l'interface Horizon OpenStack se présente ainsi :

<img className="thumbnail" alt="Interface Horizon OpenStack" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_dashboard.png" loading="lazy" />
...
<img className="thumbnail" alt="Menu de l’interface OpenStack Horizon" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_menu.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section Overview (vue d'ensemble)" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_project_overview.png" loading="lazy" />
...
- **Limit Summary** : Les limites de quotas attribuées au projet pour chaque type de ressource. Ceci permet également de visualiser le niveau de consommation des ressources par rapport aux capacités disponibles.
    ...
    <img className="thumbnail" alt="Capture d'écran de la section Limit Summary" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_quota_categories.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section Usage Summary" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_quota_historical.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section API-Access" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_project_apiaccess.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section Instances" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_instance_list.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section Images" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_image_list.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section Key Pairs" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_sshkey_list.png" loading="lazy" />
...
<img className="thumbnail" alt="Capture d'écran de la section Network Topology" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_network_topology.png" loading="lazy" />

##### Section Networks

Cette section contient la liste des réseaux disponibles pour les serveurs dédiés sur votre **Bare Metal Pod**.

<img className="thumbnail" alt="Capture d'écran de la section Networks" src="/images/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_network_list.png" loading="lazy" />
