---
title: Comment sauvegarder une instance Bare Metal Pod SecNumCloud
description: Découvrez comment sauvegarder une instance Bare Metal Pod SecNumCloud sur Object Storage
