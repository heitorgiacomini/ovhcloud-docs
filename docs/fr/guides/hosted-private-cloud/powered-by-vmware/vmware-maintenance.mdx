...
description: Apprenez-en plus sur les opérations effectuées pour assurer la fiabilité et la performance de vos équipements Hosted Private Cloud VMware on OVHcloud
...
- Être connecté à <ManagerLink to="/">l'espace client OVHcloud</ManagerLink> ou à la [console API console pour vos services](https://eu.api.ovh.com/).
- Être contact administrateur ou technique de l'infrastructure [VMware on OVHcloud](https://www.ovhcloud.com/fr/hosted-private-cloud/vmware/).
...
Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> avec un compte administrateur et cliquez sur l'onglet <code className="action">Hosted Private Cloud</code>.

Sélectionnez votre infrastructure sous <code className="action">VMware</code> puis cliquez sur l'onglet <code className="action">Operations</code>. 
...
Pour connaitre les opérations en cours ou rafraichir les anciennes opérations, utilisez le bouton <code className="action">Rafraîchir</code> situé en haut à droite du tableau des opérations.

Vous pouvez modifier la date de traitement d'une opération en cours en cliquant sur le bouton <code className="action">...</code> à droite d'une opération, puis sur <code className="action">Modifier la date de traitement</code>.

Pour plus d'informations sur la replanification d'une opération de maintenance, consultez le guide « [Comment replanifier une opération d'une maintenance sur votre Hosted Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling) ».

Vous pouvez aussi filtrer les opérations par statut via le menu déroulant situé à gauche au dessus du tableau.

<img className="thumbnail" alt="Maintenance Operation Filtre" src="/images/assets/screens/control-panel/product-selection/hosted-private-cloud/vmware/operations/maintenance-filter.png" loading="lazy" />

### Accéder aux details des opérations de maintenance

#### Depuis l'espace client OVHcloud

Voici un exemple d'une opération visible dans la section <code className="action">Operations</code> de l'espace client OVHcloud :
...
<Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/robot"} />
...
<Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/robot/\{name\}"} />
...
Pour plus d'informations sur la replanification d'une opération de maintenance, consultez le guide « [Replanification d'une opération de maintenance sur votre Hosted Private Cloud VMware on OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling) ».

Échangez sur le channel dédié Discord : [https://discord.gg/ovhcloud](https://discord.gg/ovhcloud) ou rejoignez notre [communauté d'utilisateurs](https://community.ovhcloud.com/community/fr).
