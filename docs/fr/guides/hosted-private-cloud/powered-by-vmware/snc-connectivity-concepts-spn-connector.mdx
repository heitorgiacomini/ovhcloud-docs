...
<img className="thumbnail" alt="SPN connector rules" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-spn-connector/spn-connector-rules1.svg" loading="lazy" />
...
<img className="thumbnail" alt="Règles InterDC" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-spn-connector/spn-connector-rules-interDC.svg" loading="lazy" />
...
<img className="thumbnail" alt="SPN InterDC HLD" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-spn-connector/SNC-SPN-InterDC-HLD.svg" loading="lazy" />
