...
- Avoir un identifiant utilisateur vSphere et/ou vROPS actif (créé dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>)
...
<img className="thumbnail" alt="Accès vROPS" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en01logpage.png" loading="lazy" />

Utilisez votre identifiant vSphere ou l'utilisateur vROPS local que vous possédez.

<img className="thumbnail" alt="Accès vROPS" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en02log.png" loading="lazy" />

Vous accédez alors à la page d'accueil vROPS avec l'accès à toutes les fonctionnalités.

<img className="thumbnail" alt="Accueil vROPS" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en03home.png" loading="lazy" />
...
<img className="thumbnail" alt="section Data sources" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en04datasources.png" loading="lazy" />
...
<img className="thumbnail" alt="section Environment" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en05environment.png" loading="lazy" />
...
<img className="thumbnail" alt="section Visualize" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en06dashboards.png" loading="lazy" />
...
<img className="thumbnail" alt="créer un dashboard" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en06dashboardsb.png" loading="lazy" />
...
<img className="thumbnail" alt="section troubleshoot" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en07troubleshoot.png" loading="lazy" />
...
<img className="thumbnail" alt="section optimize" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en08optimize.png" loading="lazy" />
...
<img className="thumbnail" alt="section plan" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en09plan.png" loading="lazy" />
...
<img className="thumbnail" alt="section configure" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en10configure.png" loading="lazy" />
...
<img className="thumbnail" alt="section automation" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en11automation.png" loading="lazy" />
...
<img className="thumbnail" alt="section administration" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en12administration.png" loading="lazy" />
