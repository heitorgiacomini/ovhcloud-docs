---
title: Cycle de vie des solutions VMware on OVHcloud
...
### Gammes commerciales concernées

** Solutions VMware on OVHcloud** :
...
<img className="thumbnail" alt="Cycle de vie typique d'un service VMware on OVHcloud" src="/images/hosted-private-cloud/powered-by-vmware/lifecycle-policy/01_lifecycle_pcc.png" loading="lazy" />

## Statut des gammes commerciales VMware on OVHcloud

### Produits (Plateformes)

|                   Commercial Range                    | General Availability | Mode Maintenance | Mode Sunset | End of Support |
|:-----------------------------------------------------:|:--------------------:|:------------:|:-------------:|:-----------:|
...
Pour le service Managed VMware vSphere, un cycle de vie matériel spécifique s’applique :

- **End of Sales** désigne la date à partir de laquelle la création de nouveaux clusters n’est plus possible. Au-delà de cette date, les clients ne peuvent plus démarrer de service sur ce matériel.
- **End of Growth** désigne la date à partir de laquelle l’ajout de nouveaux hôtes pour un cluster existant n’est plus possible. Au-delà de cette date, les clients ne peuvent plus commander cette génération matérielle. Cela n’affecte toutefois pas les engagements contractuels pour les clusters existants (mises à jour, pièces de rechange, SLA).
- **End of Support** désigne la date à partir de laquelle les mises à jour, les correctifs de chaîne d’exécution, l'accès au service, l’assistance d’OVHcloud et les SLA cessent.

|                   Génération matérielle               | General Availability |    End of Sales    |     End of Growth     | End of Support |
|:-----------------------------------------------------:|:--------------------:|:------------:|:-------------:|:-----------:|
...
|             Essentials (Intel Broadwell)              |          2020        |  2026-05-26  |  2026-06-30   | 2027-06-30  |
|               Premier (Intel Xeon Gold)               |          2020        |  2026-05-26  |  2027-03-31   | 2027-10-31  |
|           Premier 2027 (Intel Emerald Rapids)         |          2026        |             |               |             |
|           Private VCF aaS Gen3 (Intel Granite Rapids)  |          2027        |             |               |             |

## Logiciels intégrés

### Cycle de vie VMware by Broadcom

Pour connaître la politique de cycle de vie des produits VMware by Broadcom, consultez la page de l'éditeur :
