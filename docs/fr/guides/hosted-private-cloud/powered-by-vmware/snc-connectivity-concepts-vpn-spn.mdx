...
<img className="thumbnail" alt="Règles VPN-SPN" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-Elligibility-Rules-2.svg" loading="lazy" />

* VPN-SPN peut être attaché à 1 ou plusieurs vRack.
* Nx VPN-SPN peuvent être attachés à Nx vRack.

<img className="thumbnail" alt="VPN-SPN sur le même vRack" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-Elligibility-Rules-1.svg" loading="lazy" />
...
<img className="thumbnail" alt="VPN-SPN and SPN Connector" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/spn-connector-rules-vpn.svg" loading="lazy" />
...
<img className="thumbnail" alt="VPN overview" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-SPN-VPN-vrack-v0.svg" loading="lazy" />
...
<img className="thumbnail" alt="Exemple de configuration OCC IP" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-SPN-VPN-Routing-v0.svg" loading="lazy" />
...
<img className="thumbnail" alt="VPN-SPN BGP view" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn/SNC-SPN-VPN-BGP-v0.svg" loading="lazy" />
