...
- Avoir pris connaissances des guides Public VCF as-a-Service :
    - [Les concepts fondamentaux](/guides/hosted-private-cloud/powered-by-vmware/vcd-get-concepts)
    - [Comment se connecter à son organisation](/guides/hosted-private-cloud/powered-by-vmware/vcd-logging)
    - [Comment utiliser l'interface utilisateur](/guides/hosted-private-cloud/powered-by-vmware/vcd-getting-started-dashboard-overview)
...
Le service Veeam Data Platform est disponible et prêt à l'emploi pour les 3 offres OVHcloud (voir le [catalogue des fonctionnalités](/guides/hosted-private-cloud/powered-by-vmware/vcd-get-concepts#key-features)).
...
<img className="thumbnail" alt="Backup VM" src="/images/hosted-private-cloud/powered-by-vmware/vcd-backup/vcd_veeam_backup_vm.png" loading="lazy" />
