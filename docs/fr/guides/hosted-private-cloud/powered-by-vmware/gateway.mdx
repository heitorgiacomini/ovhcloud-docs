...
description: Découvrez comment activer la Private Gateway sur une infrastructure Hosted Private Cloud
...
* Avoir ajouté le réseau de la private gateway dans [les autorisations par IP source](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud).
