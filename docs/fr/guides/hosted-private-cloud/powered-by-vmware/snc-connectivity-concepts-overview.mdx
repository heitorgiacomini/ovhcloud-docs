...
description: Présentation des concepts de SecNumCloud Connectivity
...
<img className="thumbnail" alt="SNC Network Global Overview" src="/images/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-overview/SNC-Global-Network.svg" loading="lazy" />
