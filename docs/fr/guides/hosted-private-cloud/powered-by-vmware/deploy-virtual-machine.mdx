...
- Être connecté à votre [interface vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion).
...
- La création depuis un ISO, qui sera dans votre datastore et que vous aurez pu importer en suivant [ce guide](/guides/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload)
- Vous pouvez également déployer une machine virtuelle depuis un template que vous pouvez avoir ou un [template OVH](/guides/hosted-private-cloud/powered-by-vmware/ovf-template)
