...
description: Apprenez à maintenir vos hôtes ESXi à jour via vSphere Lifecycle Management, en toute sécurité et en quelques clics.
...
Accédez au menu <code className="action">Updates</code> > <code className="action">Hosts</code> > <code className="action">Image</code> pour consulter l’image actuelle.

<img className="thumbnail" alt="Affichage de l'image actuelle dans vLCM" src="/images/hosted-private-cloud/powered-by-vmware/vmware-update-esxi-vlcm/vlcm_00.png" loading="lazy" />

Cliquez sur <code className="action">Edit</code> pour modifier l’image.

<img className="thumbnail" alt="Bouton Edit pour modifier l'image" src="/images/hosted-private-cloud/powered-by-vmware/vmware-update-esxi-vlcm/vlcm_01.png" loading="lazy" />
...
Cliquez sur <code className="action">Save</code> pour valider et enregistrer l’image sélectionnée.

<img className="thumbnail" alt="Sélection d'une nouvelle version ESXi" src="/images/hosted-private-cloud/powered-by-vmware/vmware-update-esxi-vlcm/vlcm_02.png" loading="lazy" />
...
Cliquez sur <code className="action">Remediate All</code> pour appliquer l’image à l’ensemble des hôtes du cluster.

<img className="thumbnail" alt="Lancement avec Remediate All" src="/images/hosted-private-cloud/powered-by-vmware/vmware-update-esxi-vlcm/vlcm_03.png" loading="lazy" />
...
Cliquez sur <code className="action">Start Remediation</code> pour démarrer le processus.
...
<img className="thumbnail" alt="Validation finale" src="/images/hosted-private-cloud/powered-by-vmware/vmware-update-esxi-vlcm/vlcm_05.png" loading="lazy" />
