...
description: Découvrez comment utiliser le client html de téléversement du datastore et Govc afin de manipuler des données dans votre environnement VMware vSphere on OVHcloud managé
...
- Être administrateur technique de l'infrastructure [VMware on OVHcloud](https://www.ovhcloud.com/fr/hosted-private-cloud/vmware/).
...
Connectez-vous à l'interface web vSphere, en vous aidant si besoin du guide « [Se connecter à la console Web vSphere on OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion) ».
...
<img className="thumbnail" alt="vSphere Home" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/vsphere_home.png" loading="lazy" />

#### Téléverser des fichiers

Vous disposez de 2 façons d'y accéder, libre à vous de choisir celle qui vous convient le mieux :

**1\. Depuis le menu <code className="action">Inventaire</code> :**

|                                        **Images**                                         | **Étapes**                                                                       |
|:-----------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------|
| <img className="thumbnail" alt="vSphere Datastore Upload 01" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_inventory_2.png" loading="lazy" />      | - Cliquez sur <code className="action">Inventaire</code>.                                         |
| <img className="thumbnail" alt="vSphere Datastore Upload 01" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore.png" loading="lazy" /><br/> <img className="thumbnail" alt="vSphere Datastore Upload 01" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_1.png" loading="lazy" />| - Depuis `pcc-XXX-XXX-XXX-XXX.ovh.XX`, cliquez sur <code className="action">Banques de données</code>. |

Vous retrouvez alors l'ensemble de vos banques de données (datastores) listées.

Cliquez sur votre banque de données pour voir apparaitre une section <code className="action">Fichiers</code> dans laquelle s'ouvre votre fenêtre automatiquement.

<img className="thumbnail" alt="vSphere Datastore Inventory" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/inventory_datastore.png" loading="lazy" />

Depuis la section <code className="action">Fichiers</code> de votre banque de données ouverte, cliquez sur <code className="action">TÉLÉCHARGER DES FICHIERS</code>

Localisez l'élément à téléverser depuis votre ordinateur local (un fichier `XXX.iso` par exemple) et cliquez sur <code className="action">Ouvrir</code> pour téléverser le fichier (ISO ou autre) depuis votre machine connectée au client HTML vSphere.
...
<img className="thumbnail" alt="Datastore Upload - Files" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_4.png" loading="lazy" />
...
Ce menu vous renvoie également à l'interface <code className="action">Fichers</code> de téléversement :

|                                        **Images**                                         | **Étapes**                                                |
|:-----------------------------------------------------------------------------------------:|:----------------------------------------------------------|
| <img className="thumbnail" alt="vSphere Global Inventory" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/global_inventory.png" loading="lazy" />      | - Cliquez sur <code className="action">Listes d'inventaires globaux</code>. |
| <img className="thumbnail" alt="vSphere Global Inventory Datastore" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/global_inventory_datastores.png" loading="lazy" /> | - Puis sur <code className="action">Banques de données</code>.                  |

<img className="thumbnail" alt="vSphere Global Inventory Datastore" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/global_inventory_datastores_2.png" loading="lazy" />

Cliquez sur le `Datastore` souhaité.

Vous allez vous retrouver dans la section <code className="action">Fichiers</code> ou vous pourrez téléverser des données dans votre banque de données.

Cliquez ensuite sur <code className="action">TÉLÉCHARGER DES FICHIERS</code> pour sélectionner le fichier (ISO ou autre) à téléverser depuis votre machine locale.

Localisez l'élément à téléverser depuis votre ordinateur local (un fichier `XXX.iso` par exemple) et cliquez sur <code className="action">Ouvrir</code>

#### Téléverser des dossiers

Depuis votre banque de données, dans la section <code className="action">Fichiers</code>, cliquez sur <code className="action">TÉLÉCHARGER UN DOSSIER</code>.

Localisez l'élément à téléverser depuis votre machine connectée au client HTML vSphere et cliquez sur <code className="action">Ouvrir</code>

Le téléversement ne commencera qu'après la confirmation validée : 

|                                       **Images**                                       | **Étapes**                                       |
|:--------------------------------------------------------------------------------------:|:-------------------------------------------------|
|        <img className="thumbnail" alt="vSphere Upload Folder" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_folder_upload.png" loading="lazy" />        | - Pour confirmer, cliquez sur <code className="action">Envoyer</code>. |

#### Déplacer/Copier des fichiers

Depuis votre banque de données, cliquez sur <code className="action">DÉPLACER VERS</code> ou <code className="action">COPIER DANS</code>.

<img className="thumbnail" alt="Datastore Upload- Move/copy" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_4.png" loading="lazy" />

Localisez l'élément de destination à déplacer depuis la banque de données et cliquez sur <code className="action">OK</code>.

<img className="thumbnail" alt="Datastore Upload - Move/copy" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_move.png" loading="lazy" />

Vous devez disposer des droits suffisants pour effectuer ce type d'actions.

#### Renommer des fichiers

Depuis votre banque de données, cliquez sur <code className="action">Remplacer le nom par</code>.

<img className="thumbnail" alt="Datastore Upload - Rename" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_upload_rename.png" loading="lazy" />

Renommez votre fichier puis cliquez sur <code className="action">OK</code>.

#### Créer un dossier (facultatif)

Depuis la section <code className="action">Fichiers</code> de votre banque de données, cliquez sur <code className="action">NOUVEAU DOSSIER</code> pour créer un dossier où stocker vos fichiers.

Nommez votre dossier et cliquez sur <code className="action">OK</code>.

<img className="thumbnail" alt="Datastore Upload - Create a folder" src="/images/hosted-private-cloud/powered-by-vmware/vmware-datastore-upload/datastore_4.png" loading="lazy" />
...
<Tabs>
  <Tab label="Linux">
    **Installation**
    ...
    Vous pouvez télécharger le binaire depuis les assets du dépôt officiel GitHub VMware : [https://github.com/vmware/govmomi/releases](https://github.com/vmware/govmomi/releases)
  ...
  <Tab label="Windows">
    **Installation**
    ...
    Si vous préférez, vous pouvez simplement lancer la decompression du `Zip` de l'asset `Govc` Windows suivant (x86_64.zip) après l'avoir téléchargé à l'url suivante : [https://github.com/vmware/govmomi/releases/download/v0.43.0/govc_Windows_x86_64.zip](https://github.com/vmware/govmomi/releases/download/v0.43.0/govc_Windows_x86_64.zip)
...
- [IAM pour VMware on OVHcloud - Présentation et FAQ](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-getting-started)
...
Échangez avec notre [communauté d'utilisateurs OVHcloud](https://community.ovhcloud.com/community/fr).