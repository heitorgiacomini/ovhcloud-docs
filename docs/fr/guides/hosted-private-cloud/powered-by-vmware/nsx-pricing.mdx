...
- Être connecté à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> pour gérer vos NSX Edges.
...
Connectez-vous à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>.<br/>
...
3. **Supprimer des NSX Edges inutilisés** :
    ...
    Identifiez l’Edge à supprimer dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>.
