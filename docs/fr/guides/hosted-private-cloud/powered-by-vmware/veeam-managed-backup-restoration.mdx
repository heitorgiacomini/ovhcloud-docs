...
description: Découvrez comment restaurer des sauvegardes Veeam Managed Backup via les API OVHcloud
...
- [Veeam Managed Backup activé](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service) sur votre offre Hosted Private Cloud

## En pratique

Si vous n'êtes pas habitué au fonctionnement des API OVHcloud, consultez notre guide [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps).

### Étape 1 : générer un rapport de sauvegardes

Il vous faut dans un premier temps cibler les sauvegardes à restaurer.

Connectez-vous sur [https://api.ovh.com/](https://eu.api.ovh.com/) et utilisez l'appel suivant :
