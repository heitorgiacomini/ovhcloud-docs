...
Notez qu'il est également possible d'accorder cette autorisation à d'autres utilisateurs via l'espace client OVHcloud. Reportez-vous si nécessaire à notre [Présentation de l’espace client Private Cloud OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud).
...
<img className="thumbnail" alt="Premier SMS" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/SMS1.png" loading="lazy" />
...
- un lien permettant de valider l'opération (notez que si votre téléphone n'est pas connecté à un réseau dont [l'adresse IP est autorisée](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#securite), la page n'apparaîtra pas).
...
<img className="thumbnail" alt="Validation de l'opération" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
<img className="thumbnail" alt="Jeton d'opération" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />
...
<img className="thumbnail" alt="Modifier le mot de passe" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Définir le mot de passe" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Mot de passe perdu" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />
...
<img className="thumbnail" alt="Informations utilisateur" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Jeton et mot de passe" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
