...
description: Découvrez comment installer les VMware tools sur Linux ou Windows
...
Afin de monter le disque des VMware tools depuis le web client Vsphere, faites un clic droit sur la VM, puis cliquez sur <code className="action">Guest OS</code> et enfin sur <code className="action">Install VMware Tools</code>. 
