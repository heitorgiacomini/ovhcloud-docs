...
Vous pouvez créer votre certificat d’accès dans OKMS en utilisant soit l’[API OVHcloud](https://eu.api.ovh.com/), soit <ManagerLink to="/">l'espace client OVHcloud</ManagerLink>.
...
#### Option 2 : Utiliser <ManagerLink to="/">l'espace client OVHcloud</ManagerLink>.
