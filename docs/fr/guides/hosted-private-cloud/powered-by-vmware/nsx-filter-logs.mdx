...
description: Découvrez comment accéder aux logs du pare-feu NSX-T et les filtrer afin de résoudre les problèmes de trafic bloqué sur votre Hosted Private Cloud
...
- Être connecté à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> avec NSX-T activé, ou à votre système Syslog ou plateforme d’agrégation de logs
...
- Avec <code className="action">Log Insight</code>, créez des filtres et des tableaux de bord.
...
Si vous rencontrez des difficultés avec le réseau au sein de VCD on OVHcloud, consultez le guide « [VMware Cloud Director on OVHcloud - Network Concepts](/guides/hosted-private-cloud/powered-by-vmware/vcd-network-concepts) ».
