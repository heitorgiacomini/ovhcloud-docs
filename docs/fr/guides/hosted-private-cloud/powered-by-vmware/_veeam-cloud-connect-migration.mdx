...
Suivez les étapes de ce guide : [Object Storage - Création d'un bucket](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage).

2\. **Configurer un nouveau repository de sauvegarde.**

Consultez notre guide : [Object Storage - Utiliser Object Storage avec Veeam](/guides/storage-and-backup/object-storage/s3-veeam).
