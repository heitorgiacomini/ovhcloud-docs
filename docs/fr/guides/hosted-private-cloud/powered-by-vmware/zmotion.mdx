---
title: ZMotion
description: Comprendre le mécanisme de Zmotion
...
<img className="thumbnail" alt="VMotion" src="/images/hosted-private-cloud/powered-by-vmware/zmotion/zmotionPrez.png" loading="lazy" />
