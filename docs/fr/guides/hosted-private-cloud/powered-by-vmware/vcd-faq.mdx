...
description: Retrouvez les questions les plus fréquentes concernant Public VCF as-a-Service
...
<details>
<summary>Qu’est-ce que Public VCF as-a-Service par OVHcloud ?</summary>
...
Pour plus d'informations, voir la page [les principes clés de Public VCF as-a-Service sur OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/vcd-get-concepts#key-features).
...
<details>
<summary>Comment la migration sera-t-elle effectuée par OVHcloud ?</summary>


Si vous choisissez de migrer vers Public VCF as-a-Service, OVHcloud se chargera de la migration pour vous, vous pouvez suivre le guide suivant [Public VCF as-a-Service - Migration depuis VMware vSphere on OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/vcd-migration-use-cases) pour toutes informations complémentaires sur le processus complet.
...
<details>
<summary>Comment migrer mes données vers Public VCF as-a-Service ?</summary>
...
<details>
<summary>Puis-je toujours avoir accès à vSphere ESXi et à l’API vCenter avec Public VCF as-a-Service ?</summary>
...
<details>
<summary>Puis-je quand même utiliser des produits comme Veeam, Naviko, Rubik pour sauvegarder mes VM ?</summary>
...
<details>
<summary>Comment sont configurées les sauvegardes avec Public VCF as-a-Service ?</summary>


Pour les Backup, nous vous proposerons **Veeam Managed Backup** avec un plugin intégré pour les backup de VM, vous pouvez suivre le guide suivant pour plus d'information : [Public VCF as-a-Service - Sauvegarde avec Veeam Data Platform](/guides/hosted-private-cloud/powered-by-vmware/vcd-backup).
...
<details>
<summary>Puis-je utiliser des règles comme l’affinité et l’anti-affinité comme précédemment avec vSphere ?</summary>
...
<details>
<summary>Quelles certifications s'appliquent au nouveau service Public VCF as-a-Service ?</summary>
...
<details>
<summary>Puis-je choisir avec Public VCF as-a-Service le type de disque Thin ou Thick lorsque je crée une nouvelle machine virtuelle ou un nouveau disque ?</summary>
...
<details>
<summary>Puis-je utiliser mes licences Windows Server existantes dans Public VCF as-a-Service ?</summary>
