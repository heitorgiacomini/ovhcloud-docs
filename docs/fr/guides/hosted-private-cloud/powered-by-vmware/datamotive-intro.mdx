...
description: "Découvrez une présentation de la solution de multi-cloud Datamotive, pour une hybridation de Hosted Private Cloud - VMware on OVHcloud avec d'autres plateformes"
...
<img className="thumbnail" alt="Datamotive" src="/images/hosted-private-cloud/powered-by-vmware/datamotive-intro/datamotive_schema.png" loading="lazy" />
...
<img className="thumbnail" alt="Datamotive Console" src="/images/hosted-private-cloud/powered-by-vmware/datamotive-intro/datamotive_dashboard.png" loading="lazy" />
...
<img className="thumbnail" alt="Datamotive Login" src="/images/hosted-private-cloud/powered-by-vmware/datamotive-intro/datamotive_login.png" loading="lazy" />
