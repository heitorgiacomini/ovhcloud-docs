...
Dans le menu de gestion des utilisateur de votre environnment Hosted Private cloud, cliquer sur `Activer l'IAM OVHcloud`.

![IAM Enable](/images/guides/hosted-private-cloud/powered-by-vmware/use-iam-with-v-sphere/enable_iam.png)
...
La gestion des permissions de vSphere de chaque rôle IAM s'effectue comme pour n'importe quel autre utilisateur de votre Hosted Private Cloud, via l'API ou dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>

#### Via l'espace client

Sur le menu de gestion des utilisateurs, cliquer sur "Créer un role IAM"

![IAM users](/images/guides/hosted-private-cloud/powered-by-vmware/use-iam-with-v-sphere/create_iam_user.png)
...
![IAM Policies](/images/guides/hosted-private-cloud/powered-by-vmware/use-iam-with-v-sphere/action_on_policy.png)
...
Dans le menu de gestion des utilisateur de votre environnment Hosted Private cloud, cliquer sur `Désactiver l'IAM OVHcloud`.

![IAM Disable](/images/guides/hosted-private-cloud/powered-by-vmware/use-iam-with-v-sphere/disable_iam.png)
