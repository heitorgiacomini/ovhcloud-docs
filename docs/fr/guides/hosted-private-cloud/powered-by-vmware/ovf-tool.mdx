...
<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool.png" loading="lazy" />
...
<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool2.png" loading="lazy" />
...
<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool5.png" loading="lazy" />
...
<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool6.png" loading="lazy" />

On peut constater que l'export s'est déroulé correctement.

<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool7.png" loading="lazy" />

Si vous souhaitez convertir votre fichier .OVF au format .VMX, utilisez la commande `ovftool -tt=vmx fichier.ovf /destination/`.

<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool8.png" loading="lazy" />

<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool9.png" loading="lazy" />

Pour importer, il est nécessaire de connaitre le data-store de destination : `ovftool -ds=datastore fichier.ovf`

<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool11.png" loading="lazy" />
...
<img className="thumbnail" alt="OVF TOOL" src="/images/hosted-private-cloud/powered-by-vmware/ovf-tool/ovftool14.png" loading="lazy" />
