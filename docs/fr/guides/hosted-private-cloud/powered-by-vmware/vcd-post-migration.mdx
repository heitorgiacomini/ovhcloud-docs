...
description: Apprenez à configurer votre réseau après la migration de VMware vSphere vers Public VCF as-a-Service
...
- Une offre [Public VCF as-a-Service](https://www.ovhcloud.com/fr/lp/vmware-vcd-evolution/).
...
2\. Modifiez le mode d’attribution des IP et sélectionnez <code className="action">DHCP</code>.

<img className="thumbnail" alt="Paramètre DHCP" src="/images/hosted-private-cloud/powered-by-vmware/vcd-post-migration/01-VCD-post-migration.png" loading="lazy" />

3\. Assurez-vous que <code className="action">Guest customization settings</code> est défini sur `Disabled` avant de modifier les paramètres de l’interface réseau (NIC).

<img className="thumbnail" alt="Paramètre Désactivé" src="/images/hosted-private-cloud/powered-by-vmware/vcd-post-migration/02-VCD-post-migration.png" loading="lazy" />
