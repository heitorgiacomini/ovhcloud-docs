...
description: "Découvrez comment obtenir les logs des nœuds NSX grâce à l'API dédiée et/ou Bundle"
...
<img className="thumbnail" alt="Panneau des règles de la Gateway Firewall" src="/images/hosted-private-cloud/powered-by-vmware/nsx-t-get-logs-by-api/01nsx-t_get_logs_by_api.png" loading="lazy" />

Les paramètres de la règle sont alors disponibles. Activez l'option <code className="action">logging</code> qui doit alors passer au vert.

<img className="thumbnail" alt="Activation des logs pour la règle" src="/images/hosted-private-cloud/powered-by-vmware/nsx-t-get-logs-by-api/02nsx-t_get_logs_by_api.png" loading="lazy" />
