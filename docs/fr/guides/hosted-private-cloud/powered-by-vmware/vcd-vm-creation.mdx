...
description: Comment créer une nouvelle machine virtuelle dans Public VCF as-a-Service
...
Pour créer votre machine virtuelle, accédez d'abord au datacenter où vous prévoyez de la déployer. Ensuite, naviguez vers la section <code className="action">Calculer</code> > <code className="action">Machines Virtuelles</code> > <code className="action">Nouvelle VM</code>.

<img className="thumbnail" alt="dashboard Public VCF as-a-Service" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-dashboard-vcd.png" loading="lazy" />

<img className="thumbnail" alt="dashboard vm" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-vm-dashboad.png" loading="lazy" />

**Cliquez sur les onglets ci-dessous.**

<Tabs>
  <Tab label="À partir d'un Modèle">
    ...
    <img className="thumbnail" alt="Menu Vm Creation" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-creation-template-vm.png" loading="lazy" /><br/>
  ...
  <Tab label="À partir d'un Nouveau">
    ...
    <img className="thumbnail" alt="Menu Vm Creation" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vdc-creation-vm-scratch.png" loading="lazy" /><br/>
    La section `Calculer` vous permet de configurer la quantité de vCPU et de mémoire souhaitée pour cette machine virtuelle.
  </Tab>
  <Tab label="À partir d'un Clone">
    ...
    <img className="thumbnail" alt="Menu Vm Creation" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-vm-clone.png" loading="lazy" /><br/>
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="Creation VM Storage" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-creation-vm-network.png" loading="lazy" />
...
En ce qui concerne la section <code className="action">Stratégies de stockage</code>, vous ne trouverez qu'une seule possibilité : la politique de stockage par défaut de vSAN.

Vous pouvez également ajouter des disques virtuels dans cette section si vous en avez besoin de plusieurs.

<img className="thumbnail" alt="Storage Policies" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-create-vm-storage-policies.png" loading="lazy" />

Pour conclure, veuillez examiner toutes les informations fournies pour vous assurer de leur exactitude. Cliquez ensuite sur <code className="action">OK</code> pour lancer le déploiement de la machine virtuelle. Une fois le déploiement terminé, vous verrez la nouvelle VM répertoriée dans le centre de données virtuel sélectionné.

<img className="thumbnail" alt="VM Template Created" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-vm-template-created.png" loading="lazy" />
...
>
> <img className="thumbnail" alt="VM Creation Gif" src="/images/hosted-private-cloud/powered-by-vmware/vcd-first-vm-creation/vcd-create-VM.gif" loading="lazy" />
