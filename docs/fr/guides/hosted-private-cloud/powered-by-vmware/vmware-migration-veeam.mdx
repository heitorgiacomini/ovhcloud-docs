...
Pour les environnements SecNumCloud, veuillez consulter le guide dédié : [Move2Cloud - Migrating VMware Workloads to SecNumCloud Hosted Private Cloud with Veeam Replication](/guides/hosted-private-cloud/powered-by-vmware/vmware-migration-veeam-secnumcloud)
...
1. Connectez-vous à <ManagerLink to="/">l'espace client OVHcloud</ManagerLink>
2. Accédez à <code className="action">Hosted Private Cloud</code> > Secure SSL Gateway
3. Ajoutez les adresses IP autorisées

Consultez aussi notre [guide de IP whitelisting](/guides/hosted-private-cloud/powered-by-vmware/authorise-ip-vcenter-access).
...
Voir [le guide IAM](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-getting-started).
...
Voir le [guide de démarrage NSX](/guides/hosted-private-cloud/powered-by-vmware/nsx-first-steps).
...
- [VPN avec NSX](/guides/hosted-private-cloud/powered-by-vmware/nsx-configure-ipsec)
...
Utilisez [Storage vMotion](/guides/hosted-private-cloud/powered-by-vmware/storage-vmotion) pour déplacer les VM, puis configurez les backups dans [OVHcloud Object Storage](https://www.ovhcloud.com/fr/public-cloud/object-storage/).
...
Pour plus d’informations, consultez le [guide Storage vMotion](/guides/hosted-private-cloud/powered-by-vmware/storage-vmotion).
