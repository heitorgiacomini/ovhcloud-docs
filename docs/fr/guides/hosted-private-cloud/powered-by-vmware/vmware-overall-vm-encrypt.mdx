...
- Disposer des droits IAM suffisants avec votre compte de service OVHcloud et vos ressources KMS Hosted Private Cloud VMware on OVHcloud. Consultez les guides suivants :
    ...
    - [IAM pour VMware on OVHcloud - Comment activer IAM](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-activation).
    - [IAM pour VMware on OVHcloud - Comment créer un rôle vSphere IAM](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-role).
    - [IAM pour VMware on OVHcloud - Comment associer un rôle vSphere et un utilisateur à une politique IAM](/guides/hosted-private-cloud/powered-by-vmware/vmware-iam-role-policy).
...
:::warning
Réfléchissez bien aux dépendances de votre infrastructure par rapport au serveur clé. Pour plus d'informations, consultez le « [Guide 2 - HPC - Activer le chiffrement de VM avec OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt).
...
- « [Guide 5 - HPC - Activation du chiffrement de VM avec un KMS externe](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt) »
...
- « [Guide 2 - HPC - Activer le chiffrement de VM avec OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt) »
...
- « [Guide 2 - HPC - Activer le chiffrement de VM avec OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#activation-okms) »
...
- « [Guide 2 - HPC - Activer le chiffrement de VM avec OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#add-okms) »
...
- « [Guide 2 - HPC - Activer le chiffrement de VM avec OKMS](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#activation-chiffrement) »

Si vous avez quelques zones d'ombres sur l'ensemble des étapes à suivre, de la commande jusqu'à l'activation du chiffrement des VM, consultez le [sommaire du guide 2](/guides/hosted-private-cloud/powered-by-vmware/okms-vm-encrypt#summary) ».
...
- « [Guide 4 - HPC - Activation du chiffrement de VM avec un vNKP](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt-vnkp) ».
