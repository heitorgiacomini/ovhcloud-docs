...
- Être connecté à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou à l'[interface d'administration de vos services par API](https://eu.api.ovh.com/).

## En pratique

:::tip
Les e-mails envoyés par OVHcloud sont également accessibles depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>.<br/>
...
Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> avec un compte administrateur.
...
<img className="thumbnail" alt="modification horaire" src="/images/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling/maintenance-date-edition01.png" loading="lazy" />
...
<img className="thumbnail" alt="modification horaire" src="/images/hosted-private-cloud/powered-by-vmware/maintenance-rescheduling/maintenance-date-edition02.png" loading="lazy" />
