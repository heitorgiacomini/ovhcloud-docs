...
description: Découvrez comment créer une alerte sortante SMTP dans vROps
...
Vous pouvez contrôler que le flux a bien été ouvert grâce à ce [endpoint](https://eu.api.ovh.com/console/#/dedicatedCloud/%7BserviceName%7D/vrops/outgoingFlow/%7BoutgoingFlowId%7D~GET).
...
<img className="thumbnail" alt="FlowApi" src="/images/hosted-private-cloud/powered-by-vmware/vrops-monitoring-by-smtp/vrops_flow_api.png" loading="lazy" />
...
Pour ce faire, rendez-vous dans la section `Configure` puis l'onglet <code className="action">Alerts</code>.

![PannelAlert](/images/hosted-private-cloud/powered-by-vmware/vrops-monitoring-by-smtp/vrops_alerts_pannel.png)

Plusieurs types d'alertes s'offrent à vous, il vous faut sélectionner <code className="action">Outbound Settings</code>.

![PannelAlert2](/images/hosted-private-cloud/powered-by-vmware/vrops-monitoring-by-smtp/vrops_alert_menu2.png)

Vous arrivez sur un récapitulatif de tous vos paramètres Outbound Settings. Cliquez sur le bouton <code className="action">ADD</code>.

![AddButton](/images/hosted-private-cloud/powered-by-vmware/vrops-monitoring-by-smtp/vrops_add_button.png)

Au niveau de l'option `Plugin Type`, sélectionnez <code className="action">Standard Email Plugin</code>.
...
![AlertConfigure](/images/hosted-private-cloud/powered-by-vmware/vrops-monitoring-by-smtp/vrops_configure_alert.png)
...
Vous pouvez tester votre configuration avec le bouton <code className="action">Test</code> situé en bas de la page.
...
<img className="thumbnail" alt="EditAlert" src="/images/hosted-private-cloud/powered-by-vmware/vrops-monitoring-by-smtp/vrops_edit_alert.png" loading="lazy" />
