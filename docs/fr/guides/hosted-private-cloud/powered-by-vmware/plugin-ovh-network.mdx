...
description: Découvrez comment utiliser le plugin OVH Network sur votre offre Private Cloud
...
<img className="thumbnail" alt="Information about IPs and blocks" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Edit Reverse button" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_03.png" loading="lazy" />
...
:::info
Ce processus de configuration est également accessible sur votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. 
