...
L’<ManagerLink to="/">espace client OVHcloud</ManagerLink> intègre désormais une nouvelle fonctionnalité, avec laquelle vous pouvez :
...
- Avoir activé les **licences Windows** dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Consultez la partie « licence windows » de notre guide « [Présentation de l'espace client Hosted Private Cloud OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud) » pour plus d'informations.
...
Si vous utilisez votre propre licence (BYOL), aucune activation n’est nécessaire dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>.
...
1. Rendez-vous dans la section <code className="action">Hosted Private Cloud</code> de votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> et cliquez sur <code className="action">Managed VMware vSphere</code>.
...
<img className="thumbnail" alt="Licence overview" src="/images/hosted-private-cloud/powered-by-vmware/spla-license-management/licence-visibility-FR.png" loading="lazy" />

:::info
L’activation de la licence dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> n’est requise que si vous souhaitez qu’OVHcloud fournisse une licence SPLA pour cette machine virtuelle.
...
- **Cas n° 2 : vous souhaitez qu’OVHcloud fournisse une licence pour la VM :**
    - La licence de la VM doit être activée depuis l’<ManagerLink to="/">espace client OVHcloud</ManagerLink> pour être correctement facturée.
...
3. Cliquez sur <code className="action">...</code> à droite, puis sur <code className="action">Activer la licence</code>.
    ...
    <img className="thumbnail" alt="Activer la licence" src="/images/hosted-private-cloud/powered-by-vmware/spla-license-management/activate-licence-FR.png" loading="lazy" />
...
<img className="thumbnail" alt="Activer la licence" src="/images/hosted-private-cloud/powered-by-vmware/spla-license-management/select-licence-FR.png" loading="lazy" />
...
:::info
Les machines virtuelles déployées depuis les [bibliothèques de contenu OVHcloud (VMware content libraries)](/guides/hosted-private-cloud/powered-by-vmware/how-to-use-content-library) sont automatiquement attachées à une licence Windows correspondante.
