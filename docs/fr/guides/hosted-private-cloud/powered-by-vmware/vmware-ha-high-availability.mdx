...
description: Maitriser la politique de redémarrage avec la fonction HA
...
<img className="thumbnail" alt="schéma HA" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HA3.png" loading="lazy" />
...
Cliquez sur <code className="action">Modifier</code> et cochez la case pour arctiver la fonctionnalité HA.
...
La désactivation est nécessaire pour réaliser des opérations de mise à jour avec [l'update manager](/guides/hosted-private-cloud/powered-by-vmware/use-vmware-update-manager) par exemple. Dans ce cas précis, l'hôte est isolé.

<img className="thumbnail" alt="activation HA" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="panne de l'hôte" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="isolation d'hôte" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="banque de données avec PDL" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="banque de données avec APD" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Surveillance de VM

La surveillance des machines virtuelles est disponible suite à l'installation des [VMware tools](/guides/hosted-private-cloud/powered-by-vmware/vmware-tools-install). 
...
<img className="thumbnail" alt="Surveillande de VM" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
