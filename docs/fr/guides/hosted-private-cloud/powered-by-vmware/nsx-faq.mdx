...
Vous trouverez, dans le [guide de migration](/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc), comment déplacer votre IP existante depuis votre plateforme NSX-v et la router vers l'IP attachée à la partie Tier-0 (T0).
...
Le cluster de NSX Edges est bien compatible avec un vRack OVHcloud. Vous pouvez ajouter votre Datacenter virtuel qui porte NSX-T dans le vRack de votre choix. Retrouvez plus d'informations sur [cette page](/guides/hosted-private-cloud/powered-by-vmware/vrack-and-hosted-private-cloud).
