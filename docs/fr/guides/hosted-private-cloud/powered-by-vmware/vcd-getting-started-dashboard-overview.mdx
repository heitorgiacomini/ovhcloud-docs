...
:::info
Si vous ne savez comment vous connecter au portail web de votre organisation, consultez d'abord [ce guide](/guides/hosted-private-cloud/powered-by-vmware/vcd-logging).
:::
...
<img className="thumbnail" alt="Dashboard Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd-dashboard-overview.png" loading="lazy" />
...
<img className="thumbnail" alt="Datacenters Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_datacenter.gif" loading="lazy" />
...
<img className="thumbnail" alt="vApp Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd-Vapp-view.png" loading="lazy" />
...
<img className="thumbnail" alt="Applications Overview animé" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_application.gif" loading="lazy" />
...
<img className="thumbnail" alt="Réseau Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_networking.gif" loading="lazy" />
...
<img className="thumbnail" alt="Content Hub Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_content-hub.gif" loading="lazy" />
...
<img className="thumbnail" alt="Libraries Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd-libraries-overview.png" loading="lazy" />
...
<img className="thumbnail" alt="Administration Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_administration.gif" loading="lazy" />

### Surveiller

<img className="thumbnail" alt="Monitoring Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_monitor.gif" loading="lazy" />
...
<img className="thumbnail" alt="More options Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_more.gif" loading="lazy" />
...
<img className="thumbnail" alt="Loupe Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd_overview_loupe.gif" loading="lazy" />
...
<img className="thumbnail" alt="Tasks Overview" src="/images/hosted-private-cloud/powered-by-vmware/vcd-getting-started/vcd-recent-tasks-overview.png" loading="lazy" />
