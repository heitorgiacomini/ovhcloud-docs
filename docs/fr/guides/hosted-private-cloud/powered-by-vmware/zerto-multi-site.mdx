...
- Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, puis accédez à la section <code className="action">Hosted Private Cloud</code>.
...
<img className="thumbnail" alt="zerto manager tab" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/zerto_manager_tab.png" loading="lazy" />
...
<img className="thumbnail" alt="zerto manager add onprem zerto" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/zerto_manager_add_onprem_zerto.png" loading="lazy" />
...
<img className="thumbnail" alt="zerto manager vpn configuration" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/zerto_manager_vpn_configuration.png" loading="lazy" />
...
<img className="thumbnail" alt="zerto manager status finished" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/zerto_status_finished.png" loading="lazy" />
...
- Sur Zerto Managed vSphere, accédez à l'onglet <code className="action">Sites</code> et récupérez le jeton (token) :
    ...
    <img className="thumbnail" alt="zerto get token" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/zerto_get_token.png" loading="lazy" />
...
- Sur votre Zerto on-premises, sélectionnez <code className="action">Associer à un site</code>, puis saisissez l’adresse IP Zerto du Managed vSphere ainsi que le jeton :
    ...
    <img className="thumbnail" alt="zerto pair site" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/zerto_pair_site.png" loading="lazy" />
...
<img className="thumbnail" alt="network diagram" src="/images/hosted-private-cloud/powered-by-vmware/zerto-multi-site/network_diagram.png" loading="lazy" />
