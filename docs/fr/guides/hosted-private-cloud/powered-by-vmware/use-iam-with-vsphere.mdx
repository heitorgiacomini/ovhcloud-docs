...
<img className="thumbnail" alt="IAM Enable" src="/images/hosted-private-cloud/powered-by-vmware/use-iam-with-vSphere/enable_iam.png" loading="lazy" />
...
<img className="thumbnail" alt="IAM users" src="/images/hosted-private-cloud/powered-by-vmware/use-iam-with-vSphere/create_iam_user.png" loading="lazy" />
...
<img className="thumbnail" alt="IAM Policies" src="/images/hosted-private-cloud/powered-by-vmware/use-iam-with-vSphere/action_on_policy.png" loading="lazy" />
...
<img className="thumbnail" alt="IAM Disable" src="/images/hosted-private-cloud/powered-by-vmware/use-iam-with-vSphere/disable_iam.png" loading="lazy" />
