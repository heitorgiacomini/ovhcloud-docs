...
- [Autoriser des IP à se connecter au vCenter](/guides/hosted-private-cloud/powered-by-vmware/authorise-ip-vcenter-access)
...
N'hésitez pas à consulter notre guide [Présentation de l’espace client Hosted Private Cloud OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud).
...
<img className="thumbnail" alt="Mot de passe perdu" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_0.png" loading="lazy" />
...
<img className="thumbnail" alt="Lancement du processus" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Informations utilisateur" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Informations utilisateur" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_3.png" loading="lazy" />
...
- [Valider une opération avec un token](/guides/hosted-private-cloud/powered-by-vmware/interface-secure#valider-une-operation-avec-un-jeton)
...
- [Mise en place d'un tunnel IPsec avec NSX](/guides/hosted-private-cloud/powered-by-vmware/nsx-configure-ipsec)
...
- [Activer la Private Gateway](/guides/hosted-private-cloud/powered-by-vmware/gateway)
...
- [Activation du chiffrement des machines virtuelles (VM Encryption)](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt)
