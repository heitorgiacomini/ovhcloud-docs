...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_1.jpg" loading="lazy" />

Cliquez sur “Explore the OVH API”.

Une fois sur l’interface, cliquez sur le lien login.

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_login.jpg" loading="lazy" />

Entrez votre nic-handle et votre mot de passe. Les logins sont les mêmes que pour l’espace client OVH.

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_log.jpg" loading="lazy" />

## Utilisation de l’API

Rendez vous dans la partie dedicatedCloud.

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_example.jpg" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/api.jpg" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/retrieve_infos.PNG" loading="lazy" />

Je modifie la description avec l'appel PUT : /dedicatedCloud/&#123;serviceName&#125;/datacenter/&#123;datacenterId&#125;

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/command_put.PNG" loading="lazy" />

Et voici les informations mise à jour :

<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/dc_after_put.PNG" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/access_ip.PNG" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/access_ip_show.PNG" loading="lazy" />
...
<img className="thumbnail" alt="" src="/images/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/delete_datacenter.PNG" loading="lazy" />
