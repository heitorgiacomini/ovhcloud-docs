...
Commencez par ajouter de nouveaux datastores en suivant le guide « [Ajouter des espaces de stockage](/guides/hosted-private-cloud/powered-by-vmware/how-to-add-storage) ».
...
Enfin, supprimez vos anciens datastores en suivant le guide « [Supprimer un datastore](/guides/hosted-private-cloud/powered-by-vmware/delete-datastore) ».
...
Pour réaliser votre migration, vous pouvez suivre ce guide : [Migrer vers une nouvelle infrastructure](/guides/hosted-private-cloud/powered-by-vmware/service-migration-vdc).
...
<img className="thumbnail" alt="espace client - récupération de la version de vsphere" src="/images/hosted-private-cloud/powered-by-vmware/lifecycle-actions/manager-version-vsphere.png" loading="lazy" />
...
<img className="thumbnail" alt="vSphere - récupération des données" src="/images/hosted-private-cloud/powered-by-vmware/lifecycle-actions/vsphere-version-nsx-v.png" loading="lazy" />
