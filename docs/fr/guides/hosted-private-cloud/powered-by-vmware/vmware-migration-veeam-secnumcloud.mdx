...
description: Découvrez comment migrer vos charges de travail VMware on-premises vers un environnement Hosted Private Cloud SecNumCloud d’OVHcloud à l’aide de Veeam Replication.
...
<img className="thumbnail" alt="migration" src="/images/hosted-private-cloud/powered-by-vmware/vmware-migration-veeam-secnumcloud/secnumcloud.png" loading="lazy" />
...
- Pour les services exposés à Internet, demandez des IP publiques supplémentaires ou utilisez la [fonction BYOIP](https://www.ovhcloud.com/fr/network/byoip/).
...
- Suivez le guide « [Autoriser des IP à se connecter au vCenter](/guides/hosted-private-cloud/powered-by-vmware/authorise-ip-vcenter-access) » pour autoriser les IP de votre infrastructure source et des composants Veeam.
- Pour éviter la double authentification (2FA) sur les composants Veeam, consultez la section *Application access permission* du guide « [Utilisation de la double authentification (2FA) sur votre infrastructure Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/use-2fa) ».
...
Pour savoir comment créer des comptes locaux et activer l’authentification à deux facteurs, suivez le guide « [Interface securisée](/guides/hosted-private-cloud/powered-by-vmware/interface-secure) ».
...
Pour débuter avec NSX-T, référez-vous au guide « [Premiers pas avec NSX](/guides/hosted-private-cloud/powered-by-vmware/nsx-first-steps) ».
...
Pour l’installation pas à pas, suivez notre guide « [Installer Veeam Backup & Replication](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/veeam-veeam-backup-replication) ».
...
- [NSX avec IPsec](/guides/hosted-private-cloud/powered-by-vmware/nsx-configure-ipsec)
...
:::warning
Les environnements SNC requièrent des SPN. Pour en savoir plus, consultez le guide  « [VPN-SPN - Présentation du concept](/guides/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn) ».
:::
...
Consultez le guide « [VMware Storage vMotion](/guides/hosted-private-cloud/powered-by-vmware/storage-vmotion) ».
...
Suivez les étapes décrites dans notre guide « [Object Storage - Utiliser Object Storage avec Veeam](/guides/storage-and-backup/object-storage/s3-veeam) ».
