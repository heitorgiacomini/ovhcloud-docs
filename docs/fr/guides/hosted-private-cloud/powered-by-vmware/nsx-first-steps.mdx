...
Pensez à [commander un nouveau bloc IP](/guides/hosted-private-cloud/powered-by-vmware/add-ip-block) si vous souhaitez pouvoir ultérieurement migrer d’un environnement VMware on OVHcloud à un autre environnement, ou si votre plan de reprise d’activité nécessite le déplacement du bloc IP.
