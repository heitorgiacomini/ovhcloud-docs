...
<img className="thumbnail" alt="empreinte du certificat" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/certificate_thumbprints_01.png" loading="lazy" />

<img className="thumbnail" alt="empreinte du certificat" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/certificate_thumbprints_02.png" loading="lazy" />
...
Connectez-vous à votre <ManagerLink to="/">espace client</ManagerLink> et assurez-vous de vous situer dans la section <code className="action">Hosted Private Cloud</code>. 
...
<img className="thumbnail" alt="import certificat KMS" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/vm-encrypt_02.png" loading="lazy" />

#### Vérifier que le KMS est configuré

Vérifiez que le « **Connection Status** » correspondant au KMS est en mode « Normal ».

<img className="thumbnail" alt="vérifier connection status" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/vm-encrypt_03.png" loading="lazy" />
...
<img className="thumbnail" alt="vMotion chiffré" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/vm-encrypt_06.png" loading="lazy" />
...
<img className="thumbnail" alt="vérification de la configuration" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/vm-encrypt_07.png" loading="lazy" />

<img className="thumbnail" alt="vérification de la configuration" src="/images/hosted-private-cloud/powered-by-vmware/vm-encrypt/vm-encrypt_09.png" loading="lazy" />
...
Vous pouvez ainsi lire le guide suivant, qui détaille la procédure à suivre : [KMS for VMware on OVHcloud - Solution et cas d'usages pour chiffrer des VM](/guides/hosted-private-cloud/powered-by-vmware/vmware-overall-vm-encrypt).
