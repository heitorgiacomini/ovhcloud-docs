...
description: Vérifiez les versions de Nutanix AOS supportées par OVHcloud
...
Cliquez sur <code className="action">Execute</code> pour récupérer les informations de versions.

![01 Get version 01](/images/hosted-private-cloud/nutanix-on-ovhcloud/11-nutanix-aos-supported-versions/01-get-supported-version01.png)
...
![01 Get version 02](/images/hosted-private-cloud/nutanix-on-ovhcloud/11-nutanix-aos-supported-versions/01-get-supported-version02.png)
