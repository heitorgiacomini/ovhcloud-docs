...
Pour créer le container vous devez dans un premier temps créer un projet : [Créer votre premier projet Public Cloud - OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
