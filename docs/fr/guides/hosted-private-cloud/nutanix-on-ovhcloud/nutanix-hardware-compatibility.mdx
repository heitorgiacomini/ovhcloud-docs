...
description: Aperçu détaillé des composants matériels qualifiés pour les plateformes Nutanix d’OVHcloud
...
Si vous avez besoin de formation ou d’assistance technique pour mettre en œuvre nos solutions, veuillez contacter votre Technical Account Manager ou cliquer sur [ce lien](https://www.ovhcloud.com/fr/professional-services/) pour obtenir un devis ou solliciter nos experts Professional Services pour une analyse personnalisée de votre projet.
