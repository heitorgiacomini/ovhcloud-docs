...
description: Les détails techniques de la solution Nutanix on OVHcloud
...
<img className="thumbnail" alt="image du diagramme" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/01-global-high-level-doc/infra1.png" loading="lazy" />
...
Cette machine n'a pour but que de vous permettre de télécharger vos premières sources (ISO windows, appliances, etc). Vous devrez remplacer cette machine virtuelle par un autre système d'exploitation. Consultez ce guide pour plus d'informations : [Remplacement de l'OVHgateway](/guides/hosted-private-cloud/nutanix-on-ovhcloud/software-gateway-replacement).
