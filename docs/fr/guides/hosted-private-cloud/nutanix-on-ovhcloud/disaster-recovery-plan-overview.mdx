...
description: "Aperçu des diverses solutions de Plan de Reprise d'Activité sous Nutanix"
...
- Une connexion des sites entre eux au travers du même [vRack](https://www.ovhcloud.com/fr/network/vrack/) sur tous les sites.

<img className="thumbnail" alt="Interconnection with vRack diagram" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/43-disaster-recovery-plan-overview/vrackinterconnection.png" loading="lazy" />

- La mise en place d'un VPN IPsec entre les deux clusters Nutanix. 

<img className="thumbnail" alt="Interconnection with IPsec diagram" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/43-disaster-recovery-plan-overview/ipsecinterconnection.png" loading="lazy" />

Un exemple d'interconnexion IPsec est disponible à cette adresse : [Interconnexion IPsec entre deux sites](/guides/hosted-private-cloud/nutanix-on-ovhcloud/ipsec-interconnection)
...
Retrouvez le détail de ces solutions dans notre documentation sur la [réplication asynchrone ou *NearSync* au travers de Prism Element](/guides/hosted-private-cloud/nutanix-on-ovhcloud/prism-element-replication)
...
[Interconnexion IPsec entre deux sites](/guides/hosted-private-cloud/nutanix-on-ovhcloud/ipsec-interconnection)
