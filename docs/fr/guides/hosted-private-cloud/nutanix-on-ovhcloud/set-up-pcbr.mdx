...
description: Découvrez comment créer un bucket S3 OVHcloud sécurisé et configurer le Point-in-Time Backup de Prism Central
...
Pour créer le conteneur, vous devez dans un premier temps créer un projet Public Cloud. Pour cela, suivez notre guide : [Créer votre premier projet Public Cloud - OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
...
<img className="thumbnail" alt="05 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br5.png" loading="lazy" />

Choisissez API compatible S3 et 3-AZ (pour plus de résilience) ou 1-AZ :

<img className="thumbnail" alt="01 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br1.png" loading="lazy" />

Sélectionnez ensuite la région :

<img className="thumbnail" alt="02 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br3.png" loading="lazy" />
...
<img className="thumbnail" alt="03 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br2.png" loading="lazy" />

Désactivez le chiffrement :

<img className="thumbnail" alt="08 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br8.png" loading="lazy" />

Ajoutez un utilisateur existant ou créez un utilisateur, par exemple *admin-mst-gra* :

<img className="thumbnail" alt="02 Object Storage" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/mst2.png" loading="lazy" />

Notez bien les informations suivantes : 

<img className="thumbnail" alt="03 Object Storage Credentials" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/mst3.png" loading="lazy" />

Une fois que le conteneur est créé, rendez-vous sur le tableau de bord et configurez la rétention :

<img className="thumbnail" alt="06 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br6.png" loading="lazy" />

<img className="thumbnail" alt="07 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br7.png" loading="lazy" />
...
Installez et configurez le client AWS CLI, référez-vous si besoin à notre guide : [Premiers pas avec Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage).
...
<img className="thumbnail" alt="09 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br9.png" loading="lazy" />
...
<img className="thumbnail" alt="10 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br10.png" loading="lazy" />

<img className="thumbnail" alt="11 Prism Central Backup" src="/images/hosted-private-cloud/nutanix-on-ovhcloud/83-backup-pc-s3/pc-br11.png" loading="lazy" />
