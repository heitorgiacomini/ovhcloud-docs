...
- Une machine virtuelle sous Windows Server. Vous pouvez vous aider de ce guide pour installer une machine virtuelle sous Windows : [Gestion des machines virtuelles](/guides/hosted-private-cloud/nutanix-on-ovhcloud/virtual-machine-management).
