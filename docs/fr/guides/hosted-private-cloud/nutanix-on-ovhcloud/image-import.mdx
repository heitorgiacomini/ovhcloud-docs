...
description: Gestion des images ISO à partir de Prism Central
...
![Affichage du menu de gauche](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/PrismCentralDashboardWithLeftMenu.PNG)

Dépliez <code className="action">Compute & Storage</code> et cliquez sur <code className="action">Images</code>.

![Menu de gauche déplié avec Image surlignée](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/PrismCentralLefMenuToImage.PNG).

Cliquez sur <code className="action">Add Image</code>.

![Prism Central - Gestion des Images](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/PrismCentralAddImage.PNG)

Cliquez sur le bouton <code className="action">Add File</code>.

![Fenêtre d'ajout d'une image](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/AddImage01.PNG)

Sélectionnez le fichier d'image et cliquez sur <code className="action">Open</code>.

![Fenêtre des options d'ajout d'une image partie 1](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/AddImage02.PNG)

Saisissez le nom du fichier, rajoutez une description puis cliquez sur <code className="action">Next</code>.

![Fenêtre des options d'ajout d'une image partie 2](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/AddImage03.PNG)

Laissez les options par défaut et cliquez sur <code className="action">Save</code>.

![Fenêtre des options d'ajout d'une image partie 3](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/AddImage04.PNG)

L'image importée apparaît dans le tableau de bord des images dans Prism Central.

![Tableau de bord des images avec nouvelle image - Prism Central](/images/hosted-private-cloud/nutanix-on-ovhcloud/05-image-import/PrismCentralDashboardImagesWithNewImages.PNG)
