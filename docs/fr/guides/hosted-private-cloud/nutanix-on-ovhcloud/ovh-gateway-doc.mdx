...
description: Découvrez comment fonctionne la passerelle OVHgateway
...
Vous pouvez-vous aider de ce guide : [Remplacement de l'OVHgateway](/guides/hosted-private-cloud/nutanix-on-ovhcloud/software-gateway-replacement).
...
Connectez-vous à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> et accédez à la gestion de votre [vRack](https://www.ovhcloud.com/fr/network/vrack/). Vérifiez l'adresse Additional IP utilisée par le cluster Nutanix.
...
Cliquez sur <code className="action">Next</code>, puis sur <code className="action">Create VM</code>.
