...
<img className="thumbnail" alt="Vue d'ensemble diagram" src="/images/network/load-balancer-revamp/high-availability/fig-1.fr.svg" loading="lazy" />
...
<img className="thumbnail" alt="Routage Anycast diagram" src="/images/network/load-balancer-revamp/high-availability/fig-2.fr.svg" loading="lazy" />
...
<img className="thumbnail" alt="Sondes et failover diagram" src="/images/network/load-balancer-revamp/high-availability/fig-3.fr.svg" loading="lazy" />
...
<img className="thumbnail" alt="Anti-affinité entre zones diagram" src="/images/network/load-balancer-revamp/high-availability/fig-4.fr.svg" loading="lazy" />
