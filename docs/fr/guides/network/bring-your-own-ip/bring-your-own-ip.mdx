...
Pour choisir une région, veuillez vous référer à la liste des régions disponibles accessible sur [cette page](https://www.ovhcloud.com/fr/network/byoip/).
...
Connectez-vous à l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>, ouvrez le menu <code className="action">Network</code> dans la barre latérale de gauche, puis sélectionnez <code className="action">Adresses IP publiques</code>.

<img className="thumbnail" alt="Adresses IP publiques - Bouton BYOIP" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_public_ip.png" loading="lazy" />

Cliquez sur le bouton <code className="action">+ Bring your own IP</code> en haut de la page. Vous serez redirigé vers la page de configuration BYOIP.

<img className="thumbnail" alt="Commander BYOIP" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_order.png" loading="lazy" />
...
<img className="thumbnail" alt="AS BYOIP - OVHcloud" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_as_ovhcloud.png" loading="lazy" />

<img className="thumbnail" alt="AS BYOIP - Personnalisé" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_as_custom.png" loading="lazy" />

Enfin, cliquez sur le bouton <code className="action">Suivant</code> en bas de la page. Une fenêtre de confirmation s'ouvre. Veuillez vous assurer que tous les prérequis sont respectés, puis cliquez sur le bouton <code className="action">Confirmer</code> pour soumettre votre commande. 

<img className="thumbnail" alt="Soumettre la commande BYOIP" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_confirm.png" loading="lazy" />

Tous vos blocs IP importés porteront le tag `BYOIP`.

<img className="thumbnail" alt="Tag BYOIP" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_tag.png" loading="lazy" />

Le filtrage des adresses IP publiques par tag n’est pas disponible actuellement. Nous vous recommandons de les filtrer en cliquant sur la barre <code className="action">Tous les types de service</code> au-dessus du tableau, puis en sélectionnant <code className="action">Toutes les Additional IP</code>. Vous pourrez ainsi différencier vos Additional IP classiques des adresses importées grâce au tag `BYOIP` mentionné ci-dessus.
...
Depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur votre <code className="action">nom de compte</code> en haut à droite de la fenêtre, puis sélectionnez <code className="action">Mes offres et services</code> dans le menu déroulant.

Dans la barre de recherche en haut à droite du tableau qui s'est ouvert, à côté du bouton de filtre, tapez "byoip", puis appuyez sur la touche <code className="action">Entrée</code> pour filtrer vos services BYOIP.

<img className="thumbnail" alt="Annulation BYOIP" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_cancel.png" loading="lazy" />

Trouvez le service que vous souhaitez annuler, puis cliquez sur le bouton <code className="action">...</code> correspondant sur la droite du tableau et sélectionnez <code className="action">Résilier mon service</code>.

Une fenêtre de confirmation s'affichera :

<img className="thumbnail" alt="Confirmation d'annulation BYOIP" src="/images/network/bring-your-own-ip/bring-your-own-IP/byoip_cancel_confirmation.png" loading="lazy" />

Choisissez si vous souhaitez résilier le service immédiatement ou à la date d'expiration, puis cliquez sur <code className="action">Oui, résilier</code>.
