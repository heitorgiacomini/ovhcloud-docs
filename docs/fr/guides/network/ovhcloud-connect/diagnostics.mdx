...
<img className="thumbnail" alt="Métriques clés à surveiller" src="/images/network/ovhcloud-connect/diagnostics/fig-1.fr.svg" loading="lazy" />
...
- [Transférer les logs de votre OVHcloud Connect](/guides/network/ovhcloud-connect/logs-to-customers) vers Logs Data Platform pour un stockage et une analyse à long terme
