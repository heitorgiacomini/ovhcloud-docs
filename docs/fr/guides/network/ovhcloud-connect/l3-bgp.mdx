...
- **Surveillez la session.** Configurez des alertes pour les flaps BGP et les coupures de session — voir [Surveiller votre connexion](/guides/network/ovhcloud-connect/diagnostics).
...
- [Surveiller votre connexion](/guides/network/ovhcloud-connect/diagnostics)
