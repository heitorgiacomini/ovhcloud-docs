...
2. Cliquez sur **Commander une nouvelle connexion**.
3. Sélectionnez **Connexion via un opérateur**.
...
7. Vérifiez le tarif et **confirmez** la commande.
...
<img className="thumbnail" alt="Et ensuite ?" src="/images/network/ovhcloud-connect/order-provider/fig-1.fr.svg" loading="lazy" />
