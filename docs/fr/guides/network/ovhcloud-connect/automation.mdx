...
description: "Découvrez comment administrer OVHcloud Connect de manière programmatique via l’API, la CLI et Terraform"
...
:::tip
**Conseil de sécurité :** ne codez jamais en dur vos identifiants API. Utilisez des variables d’environnement, un fichier de configuration (`ovh.conf`) ou un gestionnaire de secrets.
:::

## Interface en ligne de commande (CLI)

Vous pouvez utiliser les wrappers d’API dans un contexte de scripting ou créer des scripts CLI légers à l’aide des SDKs ci-dessus.
