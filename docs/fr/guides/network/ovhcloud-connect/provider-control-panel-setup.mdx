...
<img className="thumbnail" alt="Vue d'ensemble des étapes" src="/images/network/ovhcloud-connect/provider-control-panel-setup/fig-1.fr.svg" loading="lazy" />
...
- Mettez en place la [supervision](/guides/network/ovhcloud-connect/diagnostics)
