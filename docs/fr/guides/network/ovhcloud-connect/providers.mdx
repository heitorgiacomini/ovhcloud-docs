...
description: "Découvrez les opérateurs réseau tiers partenaires d'OVHcloud qui proposent une connectivité managée"
...
:::info
**Remarque :** la liste des providers pris en charge peut évoluer. Consultez la [page web OVHcloud Connect](/links/network/ovhcloud-connect) pour la liste la plus à jour.
:::
...
- **Site web :** [bso.co/bso-network/cloud-connect-solutions](https://www.bso.co/bso-network/cloud-connect-solutions)
- **Documentation :** [bso.co/resource-centre](https://www.bso.co/resource-centre)
...
- **Site web :** [equinix.com/interconnection-services/fabric](https://www.equinix.com/product-solutions/connectivity/fabric)
...
- Consultez [Emplacements des PoPs et régions](/guides/network/ovhcloud-connect/pop-locations-regions) pour identifier où vous pouvez vous connecter
- Suivez le [Quick Start avec un Provider](/guides/network/ovhcloud-connect/occ-provider-control-panel-setup) pour démarrer
