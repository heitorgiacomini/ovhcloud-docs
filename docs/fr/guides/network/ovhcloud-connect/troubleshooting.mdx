...
| **Guide de monitoring** | [Superviser votre OVHcloud Connect](/guides/network/ovhcloud-connect/diagnostics) |
...
1. Depuis l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>, allez dans **Support** → **Créer un ticket**.
...
- Mettez en place un [monitoring](/guides/network/ovhcloud-connect/diagnostics) proactif pour détecter les problèmes avant qu'ils n'impactent vos utilisateurs
