...
| **Votre ASN** (mode L3) | Votre numéro de système autonome (public ou privé) pour le peering BGP |
| **Plan d’adressage IP** (mode L3) | Les préfixes que vous comptez annoncer ainsi que le sous-réseau de peering |
| **VLAN** (mode L2) | Les VLAN que vous souhaitez étendre vers OVHcloud (aucun ASN ni plan d’adressage IP n’est requis en mode L2) |
...
- [Configurer OCC L2](/guides/network/ovhcloud-connect/l2)
