...
description: "Transmettez vos logs d'événements OVHcloud Connect vers Logs Data Platform pour les stocker, les interroger et les visualiser"
...
Si vous souhaitez en savoir plus sur Logs Data Platform avant de lire ce guide, consultez le [guide d'introduction à Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction).

## Glossaire

- **Logs Data Platform :** une plateforme de gestion de logs entièrement managée et sécurisée par OVHcloud. Pour plus d'informations, consultez la page produit [Logs Data Platform](https://www.ovhcloud.com/fr/logs-data-platform/).
...
- Un compte Logs Data Platform (LDP) avec au moins un *Stream* actif configuré. Ce guide vous accompagne dans toutes les étapes nécessaires : [Démarrage rapide pour Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).
...
- Un [service OVHcloud Connect](/guides/network/ovhcloud-connect/ovhcloud-connect-overview) opérationnel.
...
Notez que l'activation de la transmission est gratuite, mais l'utilisation du service Logs Data Platform vous sera facturée selon la grille tarifaire standard. Pour la tarification de LDP, consultez cette [page](https://www.ovhcloud.com/fr/logs-data-platform/).
...
Vous pouvez retrouver les spécifications de l'API dans le [portail API OVHcloud](https://api.ovh.com/) :
...
<Api version="v1" section="/ovhCloudConnect" method="POST" route={"/ovhCloudConnect/\{serviceName\}/log/subscription"} />
...
<Api version="v1" section="/ovhCloudConnect" method="GET" route={"/ovhCloudConnect"} />
:::
...
<Api version="v1" section="/ovhCloudConnect" method="GET" route={"/ovhCloudConnect/\{serviceName\}/log/kind"} />
:::
...
<Api version="v1" section="/ovhCloudConnect" method="GET" route={"/ovhCloudConnect/\{serviceName\}/log/subscription"} />

Une fois que vous disposez du `subscriptionId`, vous pouvez en obtenir les détails à l'aide de l'appel API suivant :

<Api version="v1" section="/ovhCloudConnect" method="GET" route={"/ovhCloudConnect/\{serviceName\}/log/subscription/\{subscriptionId\}"} />
...
Référez-vous à la documentation suivante : [Logs Data Platform - Visualiser, interroger et exploiter vos logs](https://www.ovhcloud.com/fr/logs-data-platform/) pour plus de détails sur l'utilisation de vos logs avec Logs Data Platform, notamment comment :
...
<Api version="v1" section="/ovhCloudConnect" method="DELETE" route={"/ovhCloudConnect/\{serviceName\}/log/subscription/\{subscriptionId\}"} />

## Et ensuite ?

- [Superviser votre OVHcloud Connect](/guides/network/ovhcloud-connect/diagnostics)
- [Résolution des problèmes OVHcloud Connect](/guides/network/ovhcloud-connect/troubleshooting)
- [Déclarer et suivre un incident](/guides/network/ovhcloud-connect/incident-followup)
