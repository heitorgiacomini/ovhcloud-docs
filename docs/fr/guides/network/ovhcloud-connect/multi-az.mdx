...
<img className="thumbnail" alt="Architecture Multi-AZ avec des liens OVHcloud Connect redondants via des PoPs et Availability Zones distincts" src="/images/network/ovhcloud-connect/multi-az/image.png" loading="lazy" />
