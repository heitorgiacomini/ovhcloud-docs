...
description: "Comprenez comment les architectures Multi-AZ renforcent la résilience d'OVHcloud Connect"
...
<img className="thumbnail" alt="Architecture Multi-AZ" src="/images/network/ovhcloud-connect/multi-az/image.png" loading="lazy" />
...
Consultez [Configurer OCC L3 avec BGP](/guides/network/ovhcloud-connect/l3-bgp) pour des instructions de configuration détaillées.
...
- Découvrez les [SLAs](/guides/network/ovhcloud-connect/slas) et l'impact du Multi-AZ sur vos garanties de disponibilité
- Consultez le [guide de configuration des AZ](/guides/network/ovhcloud-connect/vrack-network-setup) pour mettre en place des sous-réseaux entre zones
- Explorez les [tutoriels d'architectures résilientes](/guides/network/ovhcloud-connect/resilient-architecture) pour des exemples pas à pas
