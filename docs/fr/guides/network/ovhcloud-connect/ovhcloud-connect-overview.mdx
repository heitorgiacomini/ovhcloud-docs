...
<img className="thumbnail" alt="Conception globale" src="/images/network/ovhcloud-connect/ovhcloud-connect-overview/image.png" loading="lazy" />
...
- Accédez aux [guides Quick Start : Provider](/guides/network/ovhcloud-connect/provider-control-panel-setup) pour vous connecter.
