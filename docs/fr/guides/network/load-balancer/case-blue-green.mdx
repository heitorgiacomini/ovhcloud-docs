...
description: Ce guide vous montre comment déployer une infrastructure blue-green avec le Load Balancer OVHcloud
...
- Deux [serveurs dédiés](https://www.ovhcloud.com/fr/bare-metal/), l'un hébergeant votre environnement de production, l'autre, un serveur de configuration similaire hébergeant votre environnement de développement.
...
<img className="thumbnail" alt="Add a new HTTP farm dedicated to infrastructure A" src="/images/network/load-balancer/case-blue-green/ferme1.png" loading="lazy" />
...
<Api version="v1" section="/ipLoadbalancing" method="PUT" route={"/ipLoadbalancing/\{serviceName\}/http/farm"} />


<Api version="v1" section="/ipLoadbalancing" method="DELETE" route={"/ipLoadbalancing/\{serviceName\}/http/farm"} />
...
<img className="thumbnail" alt="Add a new server to the farm HTTP A" src="/images/network/load-balancer/case-blue-green/serveur1.png" loading="lazy" />

<img className="thumbnail" alt="Enter the HTTP A server’s configuration" src="/images/network/load-balancer/case-blue-green/server1.png" loading="lazy" />
...
<img className="thumbnail" alt="Add a new HTTP farm dedicated to infrastructure B" src="/images/network/load-balancer/case-blue-green/ferme2.png" loading="lazy" />

<img className="thumbnail" alt="Create a second farm dedicated to infrastructure B" src="/images/network/load-balancer/case-blue-green/backend2.png" loading="lazy" />
...
<img className="thumbnail" alt="Add a new server to the farm HTTP B" src="/images/network/load-balancer/case-blue-green/serveur2.png" loading="lazy" />

<img className="thumbnail" alt="Enter the HTTP B server’s configuration" src="/images/network/load-balancer/case-blue-green/server2.png" loading="lazy" />
...
<img className="thumbnail" alt="Farm configuration" src="/images/network/load-balancer/case-blue-green/farms.png" loading="lazy" />
...
<img className="thumbnail" alt="Adding a front-end dedicated to production, a blue front-end" src="/images/network/load-balancer/case-blue-green/frontend1.png" loading="lazy" />

<img className="thumbnail" alt="Enter the blue front-end’s configuration" src="/images/network/load-balancer/case-blue-green/fblue.png" loading="lazy" />
...
<img className="thumbnail" alt="Add the green front-end, dedicated to development" src="/images/network/load-balancer/case-blue-green/frontend2.png" loading="lazy" />

<img className="thumbnail" alt="Enter the green front-end’s configuration" src="/images/network/load-balancer/case-blue-green/fgreen.png" loading="lazy" />
...
<img className="thumbnail" alt="Apply your changes to the zone" src="/images/network/load-balancer/case-blue-green/deploy.png" loading="lazy" />
...
<img className="thumbnail" alt="Result after updating front-ends" src="/images/network/load-balancer/case-blue-green/switch.png" loading="lazy" />
