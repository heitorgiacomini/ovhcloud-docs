...
Vous pouvez commander une zone supplémentaire depuis l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>. Dans la section <code className="action">Network</code>, sous <code className="action">Services réseau</code> cliquez sur <code className="action">Load Balancer</code>.
