...
description: Découvrez les différents modes de répartition de charge du Load Balancer OVHcloud
...
Pour une vue d'ensemble des composants du service OVHcloud Load Balancer, consultez ce guide : [Présentation du service OVHcloud Load Balancer](/guides/network/load-balancer/use-presentation).
...
Dans la section <code className="action">Fermes de serveur</code>, vous verrez les fermes actuellement créées. Il vous suffit d'éditer l'une d'entre elles en cliquant sur les trois points à droite puis sur <code className="action">Modifier</code> :

<img className="thumbnail" alt="Modification d'une ferme" src="/images/network/load-balancer/create-balancing/server_cluster_change.png" loading="lazy" />

Dans les <code className="action">Paramètres avancés</code> vous pourrez modifier votre <code className="action">Mode de répartition</code> :

<img className="thumbnail" alt="Modification d'une ferme" src="/images/network/load-balancer/create-balancing/distrib_mode_edit.png" loading="lazy" />

Une fois l'algorithme souhaité sélectionné, cliquez sur <code className="action">Mettre à jour</code>, puis sur <code className="action">Appliquer la configuration</code> dans le bandeau jaune qui apparaît :

<img className="thumbnail" alt="Appliquer la configuration" src="/images/network/load-balancer/create-balancing/apply_config.png" loading="lazy" />
