...
description: "En utilisant le service BGP, vous bénéficiez d'un contrôle total sur vos politiques de routage et la résilience du réseau. Suivez ce guide pour configurer et optimiser vos sessions BGP"
...
- Au moins un [serveur dédié Bare Metal](https://www.ovhcloud.com/fr/bare-metal/) parmi les gammes suivantes : High Grade, Scale, Advance Gen3. Tous les serveurs qui participeront au peering BGP doivent être dans la même région 1-AZ.
- Être connecté à l’<ManagerLink to="/">espace client OVHcloud</ManagerLink>.
- Si vous utilisez [Bring Your Own IP (BYOIP)](https://www.ovhcloud.com/fr/network/byoip/) : les préfixes IP que vous possédez et pouvez annoncer.
- Un [réseau privé vRack](https://www.ovhcloud.com/fr/network/vrack/).
...
Vous devez soit acheter des [Additional IP](https://www.ovhcloud.com/fr/network/additional-ip/) chez OVHcloud, soit utiliser vos propres adresses IP avec BYOIP.
...
Si vous souhaitez importer vos adresses IP, vous devez utiliser notre service BYOIP. Veuillez suivre [cette documentation](/guides/network/bring-your-own-ip/bring-your-own-ip) pour importer vos IP chez OVHcloud.
...
:::warning
**Important** :
- Seules les régions 1-AZ (possédant une seule AZ) sont disponibles pendant l'alpha.
...
<img className="thumbnail" alt="BGPaaS Basic Architecture" src="/images/network/bgp-service/bgp-service-config/bgpaas_basic-peering.png" loading="lazy" />
...
<img className="thumbnail" alt="BGPaaS RS Peering" src="/images/network/bgp-service/bgp-service-config/bgpaas_rs-peering.png" loading="lazy" />

Et voici une vue détaillée des sessions BGP entre les Edges, les RS et les Hôtes :

<img className="thumbnail" alt="BGPaaS sessions detail" src="/images/network/bgp-service/bgp-service-config/shadow_bgpaas_rs-peering.png" loading="lazy" />
