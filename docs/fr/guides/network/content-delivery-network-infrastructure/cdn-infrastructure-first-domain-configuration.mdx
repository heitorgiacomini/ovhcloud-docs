...
description: "Découvrez les bonnes pratiques de paramétrage d'un domaine sur votre CDN OVH"
...
- Bénéficier du [Content Delivery Network (CDN) d'OVH](https://www.ovhcloud.com/fr/network/cdn/).
- Avoir accès à la gestion de la zone DNS de votre nom de domaine.
- Avoir accès à votre <ManagerLink to="/">espace client OVH</ManagerLink>.
...
Pour cela, rendez-vous dans votre <ManagerLink to="/">espace client OVH</ManagerLink> dans l'onglet <code className="action">Dédié</code>, puis <code className="action">NAS et CDN</code>.

Cliquez ensuite sur <code className="action">Ajouter un domaine au CDN</code> :

<img className="thumbnail" alt="Espace client CDN" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png" loading="lazy" />

Dans l'étape 1, il vous sera possible de choisir le sous-domaine à ajouter au CDN :

<img className="thumbnail" alt="Ajouter un sous-domaine sur le CDN" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Ajouter un backend" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Nom de photo" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png" loading="lazy" />
