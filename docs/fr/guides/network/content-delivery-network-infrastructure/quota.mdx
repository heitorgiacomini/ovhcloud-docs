...
description: Découvrez comment fonctionne le quota sur votre CDN
...
Si vous avez besoin de quota supplémentaire, vous pouvez le commander directement depuis votre <ManagerLink to="/">espace client OVH</ManagerLink> :

<img className="thumbnail" alt="Ajout de quota" src="/images/network/content-delivery-network-infrastructure/quota/add_quota.png" loading="lazy" />

Retrouvez les tarifications de ce quota sur [notre site](https://www.ovhcloud.com/fr/network/cdn/).
...
<img className="thumbnail" alt="Utilisation du quota" src="/images/network/content-delivery-network-infrastructure/quota/quota_used.png" loading="lazy" />
