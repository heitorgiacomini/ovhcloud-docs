...
description: "Découvrez comment optimiser la sécurité de votre compte OVHcloud, gérer vos informations personnelles et déléguer l'accès à votre compte."
...
:::info
En cas de difficultés de connexion à votre compte, consultez la partie « [Je ne parviens pas à me connecter](/guides/account-and-service-management/account-information/ovhcloud-account-login#login-failure) » de notre guide « [Se connecter à l'espace client OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-login)».
...
Retrouvez toutes nos recommandations sur les mots de passe sur notre guide « [Modifier le mot de passe de votre compte](/guides/account-and-service-management/account-information/manage-ovh-password) ».

#### Sauvegarder votre mot de passe

Si vous ne l'avez pas encore fait, sauvegardez votre mot de passe dans un [gestionnaire de mots de passe](/guides/account-and-service-management/account-information/manage-ovh-password#utiliser-un-gestionnaire-de-mots-de-passe).
...
Pour renseigner cette adresse e-mail de secours, rendez-vous sur votre <ManagerLink to="/#/account/useraccount/infos">profil utilisateur</ManagerLink>.
...
Évitez d'utiliser des adresses e-mail liées à un nom de domaine que vous gérez depuis votre espace client. En cas de coupure sur ce domaine, vous ne recevriez plus nos notifications. Si vous êtes dans cette situation, suivez [les procédures indiquées dans ce guide](/guides/account-and-service-management/account-information/ovhcloud-account-login#invalid-email).
...
Vous trouverez tous les détails pour l'activer sur notre guide « [Sécuriser son compte OVHcloud avec la double authentification](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) ».
...
Vous pouvez modifier les informations de votre compte. Rendez-vous sur votre <ManagerLink to="/#/account/useraccount/infos">profil utilisateur</ManagerLink>.

Modifiez vos informations, puis cliquez sur le bouton <code className="action">Enregistrer les modifications</code>.
...
Si vous désirez renseigner une nouvelle adresse e-mail principale de contact, vous devrez valider celle-ci à l'aide d'un code envoyé à votre adresse de contact principale actuelle. Une fois ce code reçu, cliquez sur le bouton <code className="action">J'ai reçu mon code de validation</code>.

<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/all-about-username/nichandle07.png" loading="lazy" />

Renseignez alors le code dans le champ intitulé `Code de validation`, puis validez.

<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/all-about-username/nichandle08.png" loading="lazy" />
...
Une fois vos informations complétées, cliquez sur le bouton <code className="action">Valider</code>.
...
Pour en savoir davantage, consultez le [guide sur la gestion des utilisateurs](/guides/account-and-service-management/account-information/ovhcloud-users-management).

#### Gérer les contacts

Vous pouvez déléguer la gestion administrative **ou** technique **ou** de facturation d'un ou plusieurs services de votre compte à un autre compte OVHcloud. Consultez le guide sur [la gestion des contacts](/guides/account-and-service-management/account-information/managing-contacts) pour en savoir plus.

### Que faire en cas de suspicion d'usurpation d'identité ?

Si vous recevez un e-mail vous indiquant une connexion inconnue à votre espace client, nous vous conseillons de [modifier immédiatement le mot de passe de votre compte](/guides/account-and-service-management/account-information/manage-ovh-password#modifier-votre-mot-de-passe) et de [sécuriser votre compte avec une double authentification](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
[En cas d'échec de connexion à l'espace client](/guides/account-and-service-management/account-information/ovhcloud-account-login#login-failure)
