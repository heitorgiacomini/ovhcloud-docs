...
description: Détail des groupes de permissions mis à disposition par OVHcloud
...
- Savoir [mettre en place des politiques IAM via l'espace client](/guides/account-and-service-management/account-information/iam-policy-ui)
- Savoir [mettre en place des politiques IAM via l'API](/guides/account-and-service-management/account-information/iam-policies-api)
...
<img className="thumbnail" alt="Permissions groups UI" src="/images/account-and-service-management/account-information/iam-permission-groups/permissions_groups_ui.png" loading="lazy" />
