...
description: "Découvrez comment donner des droits d'accès spécifiques aux utilisateurs d'un compte OVHcloud"
...
<img className="thumbnail" alt="IAM Policies" src="/images/account-and-service-management/account-information/iam-policies-api/iam_policies.png" loading="lazy" />
...
- Savoir [gérer des comptes utilisateurs](/guides/account-and-service-management/account-information/ovhcloud-users-management)
...
[https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/policy](https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/policy)
...
- **permissionsGroups**: Liste des [groupes de permissions](/guides/account-and-service-management/account-information/iam-permission-groups) appliqués à cette politique.
...
[https://api.ovh.com/console-preview/?section=%2Fme&branch=v1#overview](https://api.ovh.com/console-preview/?section=%2Fme&branch=v1#overview)
...
Pour plus d'informations, consultez notre [documentation sur la gestion des utilisateurs](/guides/account-and-service-management/account-information/ovhcloud-users-management).
...
[https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/resource](https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/resource)
...
[https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/resourceGroup](https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/resourceGroup)
...
[https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/reference/action](https://api.ovh.com/console-preview/?section=%2Fiam&branch=v2#get-/iam/reference/action)
...
La description complète des groupes de permissions est disponible dans la [documentation dédiée](/guides/account-and-service-management/account-information/iam-permission-groups)
