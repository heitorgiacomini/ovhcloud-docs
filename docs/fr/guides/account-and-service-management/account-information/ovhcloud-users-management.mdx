...
Depuis la page <ManagerLink to="/#/iam/identities/users">Identités IAM</ManagerLink>, cliquez sur <code className="action">Ajouter un utilisateur</code>.
...
L'utilisateur créé pourra dès lors se connecter à <ManagerLink to="/">l'espace client OVHcloud</ManagerLink> en utilisant cet identifiant.
