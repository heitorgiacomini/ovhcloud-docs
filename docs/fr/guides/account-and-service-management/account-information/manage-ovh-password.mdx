...
- Sur la page <ManagerLink to="/#/account/useraccount/security">Sécurité du compte</ManagerLink>, cliquez sur le bouton <code className="action">Modifier</code> situé à droite de la mention **Mot de passe**.
