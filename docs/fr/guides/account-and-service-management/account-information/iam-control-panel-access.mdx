...
Ensuite il est possible soit d'utiliser un groupe de permissions managé `controlPanelAccess`
...
Ou d'ajouter les 4 droits listés ci-dessus en tant qu'actions.
