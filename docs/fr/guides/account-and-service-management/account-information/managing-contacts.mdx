...
- **Lien direct :** <ManagerLink to="/#/account/contacts/services">Gestion des contacts</ManagerLink>
...
Ouvrez la page <ManagerLink to="/#/account/contacts/services">Gestion des contacts</ManagerLink>.
...
Vous pouvez uniquement désigner un autre contact technique pour vous remplacer. Une validation par e-mail de votre part ainsi que de celle du nouveau contact technique seront nécessaires.

#### Je suis contact facturation

Vous pouvez uniquement désigner un autre contact facturation pour vous remplacer. Une validation par e-mail de votre part ainsi que de celle du nouveau contact facturation seront nécessaires.
...
:::warning
Nous vous déconseillons de donner à un tiers, quel qu'il soit, les identifiants d'accès à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>.
