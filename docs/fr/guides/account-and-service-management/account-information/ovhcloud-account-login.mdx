...
description: Découvrez comment vous authentifier sur votre compte OVHcloud
...
- Avoir consulté les [bonnes pratiques de sécurisation de votre compte OVHcloud](/guides/account-and-service-management/account-information/all-about-username)
...
Rendez-vous sur <ManagerLink to="/">la page d'authentification OVHcloud</ManagerLink>, renseignez votre identifiant client (ou votre adresse e-mail principale) et votre mot de passe.

<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/ovhcloud-account-login/account-log-in-FR.png" loading="lazy" />

Si vous avez activé la [double authentification](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa), vous devrez alors renseigner le code unique de connexion généré par votre périphérique (téléphone, tablette ou clé U2F).
...
<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/ovhcloud-account-login/customer-id-bill-fr.png" loading="lazy" />
...
<img className="thumbnail" alt="identifiant client" src="/images/assets/screens/control-panel/product-selection/right-menu/id.png" loading="lazy" />

### J'ai perdu mon mot de passe

En cas de perte ou d'oubli de votre mot de passe, consultez [ce guide détaillant la marche à suivre pour le modifier](/guides/account-and-service-management/account-information/manage-ovh-password#si-vous-ne-connaissez-plus-votre-mot-de-passe-actuel).
...
Une fois cette action effectuée, il est essentiel de [renseigner une **nouvelle** adresse e-mail de secours](/guides/account-and-service-management/account-information/all-about-username#backup-email) dans votre compte.
...
Vous devez compléter ce [formulaire en ligne](http://www.ovh.com/fr/cgi-bin/fr/procedure/procedureChangeEmail.cgi) afin que votre identité soit vérifiée.
...
- utiliser les codes de secours actifs que vous avez sauvegardés ;
- utiliser un autre périphérique de double authentification à votre disposition, si vous en avez activé plusieurs ;
- désactiver la double authentification.

Consultez les démarches appropriées sur notre guide « [Sécuriser son compte OVHcloud avec la double authentification](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa#que-faire-si-lun-de-mes-peripheriques-est-perdu-ou-cesse-de-fonctionner) ».
...
[Créer votre compte OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation)
