...
description: "Consultez vos crédits du Startup Program d'OVHcloud pour gérer vos ressources et suivre votre solde et historique de consommation"
...
Dans <ManagerLink to="/#/billing/payment/method">Mes moyens de paiement</ManagerLink>, sélectionnez l’onglet <code className="action">Mes bons d’achat</code>. Ici, vous verrez le montant total de vos crédits attribués, la date d'expiration, les crédits restants, et l’historique de leur consommation.

    <img className="thumbnail" alt="bons d'achat" src="/images/account-and-service-management/startup-program/04-view-credits/02-vouchers.png" loading="lazy" />
