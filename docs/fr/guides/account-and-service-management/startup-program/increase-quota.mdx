...
description: "Découvrez comment augmenter les quotas Public Cloud pour un membre du Startup Program d'OVHcloud et optimiser vos ressources Cloud"
...
- Vous êtes membre du [Startup Program](https://startup.ovhcloud.com/fr/).
- Votre compte OVHcloud dispose d'un moyen de paiement valide. Consultez [ce guide](/guides/account-and-service-management/managing-billing-payments-and-services/manage-payment-methods) pour vous aider à ajouter un moyen de paiement valide.
- Votre compte est enregistré sous le statut `Entreprise`. Consultez [ce guide](/guides/account-and-service-management/account-information/all-about-username) pour vous aider à modifier vos informations.
...
Dans votre <ManagerLink to="/#/pci/projects">projet Public Cloud</ManagerLink>, accédez à la rubrique `Project Management` et cliquez sur <code className="action">Quota and Regions</code>. Cliquez sur <code className="action">Contacter le support</code>.
...
Motivez votre demande d'augmentation de quota en précisant votre participation au Startup Program d'OVHcloud et en indiquant votre besoin technique et le nom du Startup Program Manager en charge du suivi de votre participation (consultez la liste des Startup Program Managers [ici](https://startup.ovhcloud.com/fr/faq-support/#SPManager)).
...
Retrouvez la liste des Startup Program Managers [ici](https://startup.ovhcloud.com/fr/faq-support/#SPManager).
