...
description: "Découvrez comment commander votre projet Public Cloud avec l'API OVHcloud"
...
- Disposer d'un [mode de paiement](/guides/account-and-service-management/managing-billing-payments-and-services/manage-payment-methods) valide et enregistré dans votre compte OVHcloud
- Être familiarisé avec le [fonctionnement de l'APIv6 OVHcloud](/guides/manage-and-operate/api/first-steps).
