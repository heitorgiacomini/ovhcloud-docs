...
Dans ce résultat, copiez l'intégralité de l'URL en « HTTPS » (**sans les guillemets**) présente à droite de la mention `"link":`, puis collez-la dans la barre de recherche de votre navigateur internet pour initier le téléchargement du bilan carbone au format PDF.
