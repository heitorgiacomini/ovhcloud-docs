...
description: Découvrez comment renouveler vos services via l’API OVHcloud
...
Pour utiliser l'[API de renouvellement](https://api.ovh.com/console/#/service/&#123;serviceId&#125;/renew#GET), vous aurez besoin du `serviceId`. Cette information est disponible avec l'API `serviceInfos`, par exemple :
