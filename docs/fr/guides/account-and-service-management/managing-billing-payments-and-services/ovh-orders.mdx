...
|4|Méthodes de paiement disponibles. Seules les méthodes de paiement autorisées dans le pays d'origine du compte ou celles liées au type de compte enregistré vous seront proposées.|

Vous pouvez à tout moment retrouver votre bon de commande sur la page <ManagerLink to="/#/billing/orders">Mes commandes</ManagerLink>, comme expliqué ci-dessous.
...
Après génération de votre bon de commande, vous pouvez le suivre depuis la page <ManagerLink to="/#/billing/orders">Mes commandes</ManagerLink> :

* Cliquez sur le bouton <code className="action">...</code> à droite de votre commande.
...
Si les critères d'éligibilité au droit de rétractation sont remplis, il peut être mis en application directement depuis la page <ManagerLink to="/#/billing/orders">Mes commandes</ManagerLink> :
