...
description: "Explication des différents types de facturation (horaire et mensuelle) sur l'offre Hosted Private Cloud"
...
Dans votre client vSphere, vous avez la possibilité de commander des ressources (hôtes et datastores) à l'heure, à travers les onglets <code className="action">Add OVH Host</code> et <code className="action">Add OVH Storage</code>.
...
Sur votre client vSphere, en vous rendant dans l'onglet <code className="action">Add OVH Host</code>, vous verrez les différents types d'hôtes compatibles avec votre infrastructure.
...
<img className="thumbnail" alt="historique hôtes" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_start.png" loading="lazy" />

En cliquant sur <code className="action">Next</code>, vous arriverez sur le récapitulatif et la demande de confirmation de votre commande.

<img className="thumbnail" alt="recapitulatif commande" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_recap.png" loading="lazy" />

Après avoir cliqué une nouvelle fois sur <code className="action">Next</code>, la commande s'effectuera, vous pourrez ensuite cliquer sur le bouton <code className="action">Finish</code> pour revenir à la première page de cet onglet.

<img className="thumbnail" alt="commande validée" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_finish.png" loading="lazy" />

#### Commande de datastore

La commande de datastore est similaire à celle des hôtes. Rendez-vous dans votre client vSphere, puis sur l'onglet <code className="action">Add OVH Storage</code>. Vous retrouverez une liste présentant les datastores compatibles avec votre infrastructure, leur taille, leur disponibilité en temps réel et leur prix à l'heure.

<img className="thumbnail" alt="commande datastore" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_datastore_start.png" loading="lazy" />
...
La commande de ressources mensuelles se fait depuis l'espace client OVHcloud dans l'onglet <code className="action">Datacenter</code> de votre Hosted Private Cloud.
...
Dans votre espace client OVHcloud, vous pouvez commander un hôte, en cliquant sur le bouton <code className="action">Commander un host</code>. Une fenêtre s'ouvrira, vous laissant le choix des hôtes possibles dans votre infrastructure, avec les ressources CPU/RAM et le prix mensuel HT.

Vous pouvez en commander plusieurs à la fois.

<img className="thumbnail" alt="commande hote" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_manager.png" loading="lazy" />

En cliquant sur <code className="action">Suivant</code>, vous aurez un résumé de la commande, et vous serez invité à accepter les conditions d'utilisation du service.

<img className="thumbnail" alt="confirmation commande hote" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_host_manager_confirm.png" loading="lazy" />
...
Dans votre espace client OVHcloud, les différents types de datastores seront présents sur la fenêtre ouverte en cliquant sur <code className="action">Commander un datastore</code>.

<img className="thumbnail" alt="commande datastore" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_datastore_manager.png" loading="lazy" />

Puis la confirmation.

<img className="thumbnail" alt="confirmation commande datastore" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-order_datastore_manager_confirm.png" loading="lazy" />
...
Depuis votre espace client OVHcloud, vous pouvez activer les licences SPLA, afin de [déployer des machines virtuelles Windows avec une licence OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).

Après avoir cliqué sur le bouton <code className="action">Activer le SPLA</code>, la fenêtre suivante s'ouvrira :

<img className="thumbnail" alt="activer SPLA" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-activate_spla.png" loading="lazy" />
...
L'activation se fait sur le bouton disponible dans l'onglet <code className="action">Backup</code>. Vous devrez confirmer l'activation sur le fenêtre qui s'ouvrira.

<img className="thumbnail" alt="activer Veeam" src="/images/account-and-service-management/managing-billing-payments-and-services/facturation-private-cloud/images-activate_veeam.png" loading="lazy" />
