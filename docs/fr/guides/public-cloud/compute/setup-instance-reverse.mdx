...
Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, accédez à la section <code className="action">Network</code> et cliquez sur <code className="action">Adresses IP Publiques</code>.
