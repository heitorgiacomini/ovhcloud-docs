...
description: "Vérifiez le nombre d'opérations d'entrée-sortie par seconde (IOPS) que vos disques sont en mesure d'effectuer"
...
- Posséder une [instance Public Cloud](https://www.ovhcloud.com/fr/public-cloud/compute/).
...
Pour tester la vitesse d'un disque supplémentaire, vous devez le monter. Pour plus d'informations, consultez ce [guide](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance#sous-windows).
