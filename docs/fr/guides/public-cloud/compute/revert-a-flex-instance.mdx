...
- Posséder une [instance Public Cloud OVHcloud](/guides/public-cloud/compute/getting-started#configuration) de type *flex*.
- [Créer un accès à l'interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
