...
description: Découvrez comment déployer des applications préinstallées sur vos instances Public Cloud
...
- Une [instance Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) dans votre compte OVHcloud.
...
Depuis <ManagerLink to="/">l'espace client OVHcloud</ManagerLink>, les API OVHcloud ou de l'API OpenStack Horizon, installez l'application de votre choix sur votre instance Public Cloud.
...
1. Connectez-vous à la [console API](https://eu.api.ovh.com/)
...
Si votre domaine est enregistré chez OVHcloud, vous pouvez suivre [ce guide](/guides/web-cloud/domains/dns-zone-edit).
...
<summary>Pourquoi définir le mot de passe root?</summary>
...
<summary>Où est ma licence pour cPanel?</summary>
...
<summary>Où est ma licence Plesk?</summary>
