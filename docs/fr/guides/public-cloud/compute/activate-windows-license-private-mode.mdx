...
description: Découvrez comment activer une license Windows sur une instance en mode privé
...
- [Avoir créé un utilisateur OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)

Nous vous recommandons de consulter le guide « [Accéder à l’interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon) » pour vous familiariser à Horizon.
...
Connectez-vous à l’interface [Horizon](https://horizon.cloud.ovh.net/auth/login/) en suivant la méthode indiquée dans la [première partie de ce guide](/guides/public-cloud/network-services/vrack#interface-horizon).
...
Dirigez-vous ensuite dans <code className="action">Compute</code>, puis <code className="action">Instances</code> :
...
<img className="thumbnail" alt="activation clé windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="activation clé windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />

## Aller plus loin

[Découvrez comment corriger la clé d’activation de votre Windows Server](/guides/bare-metal-cloud/dedicated-servers/windows-key).
