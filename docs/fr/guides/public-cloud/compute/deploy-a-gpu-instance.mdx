...
- [Une clé SSH](/guides/public-cloud/compute/creating-ssh-keys) créée pour déployer une instance GPU Linux.
...
Suivez ensuite les étapes restantes, comme détaillé dans [ce guide](/guides/public-cloud/compute/getting-started#create-instance). Ce processus peut prendre quelques minutes.
