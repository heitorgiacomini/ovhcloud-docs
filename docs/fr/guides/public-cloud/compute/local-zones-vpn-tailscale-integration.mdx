...
- [Deux instances Public Cloud](/guides/public-cloud/compute/getting-started) déployées dans différentes [Local Zones OVHcloud](https://www.ovhcloud.com/fr/public-cloud/local-zone-compute/) (nous utiliserons Prague et Madrid pour cet exemple).
- Un [accès SSH à vos instances Public Cloud OVHcloud Local Zones](/guides/public-cloud/compute/creating-ssh-keys).
...
- Des connaissance du protocole SSH et des commandes de base du terminal. Pour plus d'informations sur le SSH, consultez notre guide sur [comment créer et utiliser des clés SSH pour les instances Public Cloud](/guides/public-cloud/compute/creating-ssh-keys).

## En pratique

### Étape 1 - Créer deux instances dans les Local Zones OVHcloud

[Créez deux instances](/guides/public-cloud/compute/getting-started) dans différentes Local Zones OVHcloud, comme Prague et Madrid.
