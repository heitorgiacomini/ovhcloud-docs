...
description: "Découvrez comment partager des images entre des projets Public Cloud à l'aide d'OpenStack"
lastUpdated: 2025-04-01
---

## Objectif

Il peut arriver que vous deviez partager une image [Instance backup](/guides/public-cloud/compute/save-an-instance) ou une image [Volume backup](/guides/public-cloud/compute/volume-backup) entre  plusieurs projets Public Cloud.
...
Pour plus d'informations, veuillez consulter la [documentation officielle OpenStack](https://docs.openstack.org/image-guide/share-images.html).
...
- [Préparer l’environnement à l’utilisation de l’API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)

Vous aurez également besoin de :

- posséder une [Instance Public Cloud](https://www.ovhcloud.com/fr/public-cloud/) dans votre compte OVHcloud ;
- Un utilisateur [OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) créé dans votre projet ;

:::info
Ce guide fait référence à l'utilisation du [client de ligne de commande OpenStack](https://docs.openstack.org/python-openstackclient/latest/).
:::
