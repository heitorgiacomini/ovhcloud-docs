...
description: Découvrez comment activer le mode rescue sur une instance Metal
...
:::info
Ce guide s'applique uniquement aux instances Metal. Pour accéder au mode rescue pour tous les autres types d'instances, suivez [ce guide principal](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
:::
...
- Une [instance Metal Public Cloud](/guides/public-cloud/compute/getting-started) dans votre projet.
