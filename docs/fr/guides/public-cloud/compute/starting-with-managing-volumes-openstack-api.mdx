...
- [Préparer l'environnement pour utiliser l'API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) en installant python-cinderclient et python-novaclient
...
:::info
Il est aussi possible de consulter la documentation du client Openstack directement sur [le site OpenStack](https://docs.openstack.org/python-openstackclient/latest/).
:::
