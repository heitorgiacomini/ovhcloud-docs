...
description: "Découvrez comment créer un groupe de serveurs et l'utiliser avec une instance Public Cloud"
...
- Posséder un [projet Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) créé depuis votre compte OVHcloud.
- Avoir accès à [l'interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon).
...
<Tabs>
  <Tab label="Tableau de bord OpenStack">
    ...
    1. Cliquez sur <code className="action">Compute</code> dans l'onglet de gauche, puis sur <code className="action">Server Groups</code>.
    1. Cliquez ensuite sur <code className="action">+ Create Server Group</code>.
    1. Dans la fenêtre qui s'affiche, sélectionnez un nom (*Name*) et une politique (*Policy*) pour votre groupe de serveurs.
    1. Cliquez sur <code className="action">Submit</code>.
  </Tab>
  <Tab label="CLI">
...
<Tabs>
  <Tab label="Tableau de bord OpenStack">
    ...
    1. Connectez-vous à l'interface [Horizon](https://horizon.cloud.ovh.net/auth/login/).
    1. Sélectionnez la région appropriée dans le menu déroulant en haut à gauche.
    1. Cliquez sur <code className="action">Compute</code> dans l'onglet de gauche, puis sur <code className="action">Instances</code>.
    1. Cliquez sur <code className="action">Launch Instance</code>.
    1. Dans la fenêtre qui apparaît, complétez les champs requis pour créer votre instance. Dans le champ <code className="action">Server Group</code>, cliquez sur la flèche déroulante à côté de `Available` pour afficher la liste des groupes de serveurs disponibles. Sélectionnez un groupe de serveurs et il sera déplacé vers `Allocated`.
    ...
    1. Une fois terminé, cliquez sur <code className="action">Launch Instance</code>.
  </Tab>
  <Tab label="CLI">
