...
- Attach Interface : cette option permet d'ajouter une ou plusieurs interfaces privées à votre instance via le VLAN. Pour plus d'informations, consultez [cette partie](/guides/public-cloud/network-services/vrack#adding-a-private-interface) du guide correspondant.
- Detach Interface : cette option permet de détacher une interface liée à une instance. Pour plus d'informations, consultez [cette partie](/guides/public-cloud/network-services/vrack#removing-a-private-interface) du guide correspondant.
