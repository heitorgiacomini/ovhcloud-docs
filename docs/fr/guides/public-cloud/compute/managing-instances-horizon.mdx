...
- Avoir créé une instance Public Cloud depuis votre [espace client OVHcloud](/guides/public-cloud/compute/getting-started) ou à travers l'[interface Horizon](/guides/public-cloud/compute/create-instance-in-horizon).
- [Avoir créé une clé SSH](/guides/public-cloud/compute/creating-ssh-keys).
...
- Attach Interface : cette option permet d'ajouter une ou plusieurs interfaces privées à votre instance via le VLAN. Pour plus d'informations, consultez [cette partie](/guides/public-cloud/network-services/vrack#ajout-dune-interface-privee) du guide correspondant.
- Detach Interface : cette option permet de détacher une interface liée à une instance. Pour plus d'informations, consultez [cette partie](/guides/public-cloud/network-services/vrack#suppression-dune-interface-privee) du guide correspondant.
...
Consultez [ce guide](/guides/public-cloud/compute/getting-started#user-mgmt) pour plus d'informations.
