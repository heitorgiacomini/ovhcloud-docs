...
Accédez à l'interface [Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user). Choisissez alors la région dans laquelle vous voulez créer un groupe de sécurité, via le bouton en haut à gauche.
