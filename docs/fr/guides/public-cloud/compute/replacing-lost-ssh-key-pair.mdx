...
description: "Découvrez comment restaurer l'accès au serveur en remplaçant une paire de clés SSH par une nouvelle en cas de perte de votre clé privée"
...
Créez une nouvelle paire de clés SSH sur votre appareil local, en suivant les instructions de la première partie du [guide de création d'une clé SSH](/guides/public-cloud/compute/creating-ssh-keys).

### Étape 2 : accéder à votre instance en mode rescue

Suivez les étapes du [guide du mode rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) pour redémarrer l'instance en mode rescue, vous y connecter et monter vos partitions.
...
Redémarrez l'instance en mode « normal » depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Consultez les instructions du [guide sur le mode rescue](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) si nécessaire.
