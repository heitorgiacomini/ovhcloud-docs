...
description: Découvrez comment partager un objet sans fournir vos informations personnelles
...
- [Avoir préparé l'environnement pour utiliser l'API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
