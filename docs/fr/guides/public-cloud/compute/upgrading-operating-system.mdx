...
description: "Découvrez comment mettre à jour un système d'exploitation en fin de vie"
...
Par conséquent, avant de suivre ce tutoriel, OVHcloud vous recommande vivement de [sauvegarder votre instance](/guides/public-cloud/compute/save-an-instance) et d'effectuer des tests approfondis sur vos applications, pour s'assurer qu'elles fonctionnent sur la nouvelle version du système d'exploitation.
:::
...
- Disposer d'un [accès administrateur au serveur](/guides/public-cloud/compute/getting-started#connect-instance)
- Avoir effectué [une sauvegarde de votre instance](/guides/public-cloud/compute/save-an-instance)
...
Vérifiez alors que vos applications fonctionnent comme prévu. En cas de problème, nous vous recommandons de [restaurer la sauvegarde](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) effectuée avant la mise à jour.
...
Vérifiez que vos applications fonctionnent comme prévu. En cas de problème, nous vous recommandons de [restaurer la sauvegarde](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) effectuée avant la mise à jour.
