...
- [Avoir créé une instance depuis l'espace client OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
- [Disposer d'un accès administrateur](/guides/public-cloud/compute/getting-started#connect-instance).
