...
- Avoir créé une [instance Public Cloud](/guides/public-cloud/compute/getting-started).
- Être [connecté en SSH](/guides/public-cloud/compute/getting-started#connect-instance) (sudo) à l'instance.
