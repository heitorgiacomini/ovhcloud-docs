...
description: Découvrez les fonctionnalités, les capacités et les limites actuelles des instances Local Zones
lastUpdated: 2026-01-16
---

## Objectif

Les instances Local Zones sont une extension des [régions](https://www.ovhcloud.com/fr/public-cloud/regions-availability/) qui rapprochent les services OVHcloud de lieux spécifiques, offrant une latence réduite et des performances améliorées pour les applications.
...
- [Object Storage - Spécifications pour Local Zones](/guides/storage-and-backup/object-storage/s3-local-zones-limitations)
