...
- Être connecté à [l'interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
...
<img className="thumbnail" alt="ajouter le projet à vRack" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png" loading="lazy" />
...
<img className="thumbnail" alt="Sélection de la région" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/region2021.png" loading="lazy" />
...
<img className="thumbnail" alt="Créer un sous-réseau" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/create_subnet.png" loading="lazy" />

Dans la fenêtre, complétez les champs :

<img className="thumbnail" alt="Créer un sous-réseau" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/create_subnet_1.png" loading="lazy" />
...
<img className="thumbnail" alt="décochez DHCP" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/uncheck_dhcp.png" loading="lazy" />

Une fois le sous-réseau créé, votre réseau privé apparaîtra comme suit :

<img className="thumbnail" alt="Nouvel affichage du réseau privé" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/display_subnet.png" loading="lazy" />
