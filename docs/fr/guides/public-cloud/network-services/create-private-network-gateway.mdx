...
Ces opérations peuvent être réalisées depuis l’<ManagerLink to="/">espace client OVHcloud</ManagerLink>, l’[API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) ou l’[API OVHcloud](https://eu.api.ovh.com/).
...
- Avoir accès à l’[API OVHcloud](https://eu.api.ovh.com/) ou à l’environnement OpenStack ([Tutoriel](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment))
...
<Tabs>
  <Tab label="Etape 1">
    ...
    Veuillez noter qu'il est nécessaire d'avoir activé le vRack avant de poursuivre. Si vous n'en possédez pas, nous vous invitons à consulter cette [section](/guides/public-cloud/network-services/vrack#activation) du guide correspondant.
...
- [Comment utiliser Terraform sur le Public Cloud OVHcloud](/guides/public-cloud/cross-functional/how-to-use-terraform)
