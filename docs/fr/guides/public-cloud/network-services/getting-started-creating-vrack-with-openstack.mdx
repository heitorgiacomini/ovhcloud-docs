...
description: "Découvrez comment activer et gérer un vRack Public Cloud à l'aide de l'OpenStack CLI"
...
- Consulter le guide [Configurer le vRack sur le Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) (pour comprendre les différentes méthodes de gestion du vRack avec le Public Cloud)
...
- [Détacher une interface](#detach-interface)
...
Une fois le service actif, vous le retrouverez sous <code className="action">Public Cloud</code> > votre projet > <code className="action">Network</code> > <code className="action">Réseau Privé vRack</code>. Sous l’appellation « pn-xxxxxx ».
...
<img className="thumbnail" alt="ajouter le projet" src="/images/public-cloud/network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### Depuis les APIv6 OVHcloud

Pour activer et gérer un vRack depuis les APIv6 OVHcloud, cliquez [ici](/guides/public-cloud/network-services/vrack-apiv6#etape-1-activer-et-gerer-un-vrack) pour consulter le guide spécifique à cette méthode.
...
Pensez également à noter les informations suivantes, comme indiqueé dans le [guide d'utilisation de l'API Nova](/guides/public-cloud/compute/starting-with-nova) :
...
[Configuration du vRack Public Cloud depuis les APIv6 OVHcloud](/guides/public-cloud/network-services/vrack-apiv6).
