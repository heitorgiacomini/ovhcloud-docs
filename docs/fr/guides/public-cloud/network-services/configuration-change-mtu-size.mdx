...
- [Préparer un environnement pour utiliser l’API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
...
- [Gestion des tokens](/guides/public-cloud/cross-functional/managing-tokens)
...
- Le(s) Node(s) Managed Kubernetes si vous utilisez une [passerelle personnalisée déployée dans le vRack avec un cluster Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/vrack-custom-gateway).
