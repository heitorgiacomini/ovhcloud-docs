...
description: Comprendre les concepts de configuration du Load Balancer Public Cloud
...
<img className="thumbnail" alt="Architecture du Load Balancer privée à privée" src="/images/public-cloud/network-services/concepts-03-loadbalancer/priv-to-priv.png" loading="lazy" />
...
<img className="thumbnail" alt="Architecture du Load Balancer public-privé" src="/images/public-cloud/network-services/concepts-03-loadbalancer/pub-to-priv.png" loading="lazy" />
...
|---|---|---|---|---|
|Private to Private | Obligatoire | Non requis | 3 ([src](/guides/public-cloud/network-services/known-limits)) | Non requis |
|Public to Private | Obligatoire | Obligatoire | 5 ([src](/guides/public-cloud/network-services/known-limits)) | Obligatoire |
|Public to Public | Obligatoire | Obligatoire | 5 ([src](/guides/public-cloud/network-services/known-limits)) | Obligatoire |
...
- Configurez votre premier load balancer avec ce [guide](/guides/public-cloud/network-services/getting-started-load-balancer).
