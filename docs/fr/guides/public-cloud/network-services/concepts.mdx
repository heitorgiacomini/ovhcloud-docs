...
description: Découvrez quels sont les concepts de base du Public Cloud Networking
...
Les réseaux privés du Public Cloud sont construits au-dessus d’un [vRack](https://www.ovhcloud.com/fr/network/vrack/), un service OVHcloud fournissant un réseau privé global pouvant être affecté à un projet Public Cloud.
...
Pour en savoir plus, consultez notre guide [Load Balancer](/guides/public-cloud/network-services/getting-started-load-balancer) .
...
Apprenez-en plus sur les Additional IP et Floating IP sur la [page concept dédiée](/guides/public-cloud/network-services/additional-ip-vs-floating-ip).
