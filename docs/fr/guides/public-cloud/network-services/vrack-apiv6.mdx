...
description: Découvrez comment activer et gérer un vRack Public Cloud depuis les APIv6 OVHcloud
...
- [Avoir créer un utilisateur OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user).
- Connaissances réseaux élémentaires.
- Consulter le guide [Configuration du vRack Public Cloud](/guides/public-cloud/network-services/vrack) pour connaître les différentes méthodes proposées pour gérer le vRack Public Cloud OVHcloud.
...
Pour plus d'informations sur la gestion des vLan du vRack des serveurs dédiés, vous pouvez consulter ce guide : [Créer plusieurs VLAN dans le vRack](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack)
:::
...
[Configuration du vRack Public Cloud](/guides/public-cloud/network-services/vrack)
