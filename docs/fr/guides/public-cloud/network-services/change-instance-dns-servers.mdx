...
Connectez-vous sur votre instance en SSH. Reportez-vous au guide « [Se connecter à une instance Public Cloud](/guides/public-cloud/compute/getting-started#connect-instance) » pour plus d'informations à ce sujet.
...
Connectez-vous à l'instance via une session bureau à distance ou avec la console VNC. Consultez le guide  « [Se connecter à une instance Public Cloud](/guides/public-cloud/compute/getting-started#connect-instance) » pour plus d'informations à ce sujet.
