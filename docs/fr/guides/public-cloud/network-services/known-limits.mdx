...
- dans [Horizon](/guides/public-cloud/cross-functional/introducing-horizon) ;
- via le [CLI OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) en effectuant `openstack floating ip list` et `openstack loadbalancer list` ;
