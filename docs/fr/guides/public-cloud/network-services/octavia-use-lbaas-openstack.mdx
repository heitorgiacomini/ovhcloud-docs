...
- Avoir un [réseau privé](/guides/public-cloud/network-services/vrack) configuré dans votre projet
...
>
> Vous pouvez en savoir plus sur notre page [Concepts](/guides/public-cloud/network-services/additional-ip-vs-floating-ip).
>
...
<img className="thumbnail" alt="diagram" src="/images/public-cloud/network-services/technical-resources-01-using-lbaas-in-openstack-environment/topology.png" loading="lazy" />
