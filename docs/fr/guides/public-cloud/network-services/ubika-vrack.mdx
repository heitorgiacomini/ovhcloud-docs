...
description: Découvrez comment sécuriser votre infrastructure OVHcloud avec Ubika WAAP Gateway déployé sur Public Cloud
...
- Un compte Ubika créé via le [site web d'Ubika](https://my.ubikasec.com/).
...
- Une adresse [Additional IP](https://www.ovhcloud.com/fr/network/additional-ip/) pour permettre le failover et la configuration de la haute disponibilité.
- Une licence Ubika WAAP Gateway BYOL (**B**ring **Y**our **O**wn **L**icence), obtenue directement auprès d'Ubika via le [site officiel Ubika](https://my.ubikasec.com/). Vous devrez la fournir lors de l'installation et de la configuration.
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/ubika-vrack.png" loading="lazy" />
...
Rendez-vous dans la section <code className="action">download</code> du [site officiel d'Ubika](https://my.ubikasec.com/). Connectez-vous à votre compte Ubika et suivez les instructions pour télécharger l'image UWG OpenStack.
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/login.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/managed-1.png" loading="lazy" />

Ajoutez la seconde instance :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/managed-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/virtual-interface-1.png" loading="lazy" />

UWG managed-2 :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/virtual-interface-2.png" loading="lazy" />

Supprimez la passerelle par défaut et ajoutez la passerelle vRack pour chaque Ubika managé (`Setup` > `Networking` > `Routes`).

UWG managed-1 :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/default-gateway-1.png" loading="lazy" />

UWG managed-2 :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/default-gateway-2.png" loading="lazy" />

Créez une configuration active/passive haute disponibilité (`Setup` > `High Availability` > `Add`) :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/ha-1.png" loading="lazy" />

Ajoutez une addresse IP du bloc d'IP en tant qu'IP Virtuelle :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/ha-2-vrack.png" loading="lazy" />

Ajoutez les deux instances UWG managées en tant que membres VRRP à l'aide des interfaces de charge de travail (eth1) :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/ha-3.png" loading="lazy" />

Appliquez la configuration (bouton en haut à droite de l'interface) :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/ha-4.png" loading="lazy" />

### Configurer les licences <a name="step3"></a>

Les licences Ubika WAAP Gateway sont disponibles directement auprès d'Ubika via le [site officiel d'Ubika](https://my.ubikasec.com/). En fonction de vos besoins de déploiement, vous pouvez choisir entre une licence de machine virtuelle unique ou une licence en mode Haute disponibilité, qui prend en charge une configuration Active-Backup avec deux instances de data-plane et une ou plusieurs instances de control-plane. Les licences varient également en fonction du SSL TPS (Transactions Par Seconde), prenant en charge plusieurs certificats SSL ou des capacités de failover.
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/reverse-proxy.png" loading="lazy" />

Créez un enregistrement DNS A pour le serveur web pointant vers l'IP virtuelle du déploiement Ubika :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/dns-vrack.png" loading="lazy" />
...
<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/tunnel-1.png" loading="lazy" />

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/tunnel-2.png" loading="lazy" />

Appliquez la configuration :

<img className="thumbnail" alt="Ubika vrack" src="/images/public-cloud/network-services/tutorial-ubika-vrack/tunnel-3.png" loading="lazy" />
