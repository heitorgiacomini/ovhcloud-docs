...
description: "Découvrez comment configurer un Load Balancer Public Cloud sécurisé avec Let's Encrypt"
...
Vous pouvez créer une instance dans votre projet dans la région où votre Load Balancer se situe. Pour plus de détails à ce sujet, consultez notre [guide](/guides/public-cloud/compute/getting-started). Nous vous recommandons d'utiliser Ubuntu comme système d'exploitation. Le format d2-2 sera suffisant pour cette opération.
...
Si vos serveurs DNS sont gérés par OVHcloud, consultez [ce guide](/guides/web-cloud/domains/dns-zone-edit).
