...
description: "Maîtriser la mise en place et la gestion d'un Health Monitor avec les Load Balancers Public Cloud OVHCloud via l'espace client OVHcloud, la CLI, Horizon et Terraform"
...
<strong>1.</strong> Cliquez sur <code className="action">Load Balancer</code> dans le menu de gauche. Sélectionnez le Load Balancer que vous souhaitez configurer.<br/>
<strong>2.</strong> Cliquez sur l'onglet <code className="action">Pools</code> puis cliquez sur le Pool pour lequel vous souhaitez créer un Health Monitor.

<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/network-services/technical-resources-03-lbaas-create-health-monitor/healthM1.png" loading="lazy" />

<strong>3.</strong> Cliquez sur l'onglet <code className="action">Health Monitors</code> dans les détails du Pool, puis sur <code className="action">Ajouter un Health Monitor</code>.

<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/network-services/technical-resources-03-lbaas-create-health-monitor/healthM2.png" loading="lazy" />
...
<strong>4.</strong> Une fois toutes les informations renseignées, cliquez sur <code className="action">Ajouter</code> pour activer votre Health Monitor.

<img className="thumbnail" alt="Schema 1" src="/images/public-cloud/network-services/technical-resources-03-lbaas-create-health-monitor/healthM3.png" loading="lazy" />
...
Dans le menu de gauche, cliquez sur l'onglet <code className="action">Network</code> et sélectionnez <code className="action">Load Balancers</code>.

Choisissez le Load Balancer que vous souhaitez configurer et cliquez sur l'onglet <code className="action">Health Monitors</code>.

Cliquez sur <code className="action">Create Health Monitor</code> et remplissez les champs requis tels que le type, l'intervalle de vérification, le nombre maximal de tentatives et le délai d'expiration.

Confirmez la création en cliquant sur <code className="action">Create</code>.
