...
- Un Load Balancer nécessite un sous-réseau, lisez [ce guide](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) pour plus d'informations
...
<Tabs>
  <Tab label="Via l'espace client OVHcloud">
    ...
    **Étape 1 : Choix de la région**
    ...
    <img className="thumbnail" alt="Choix de la région" src="/images/public-cloud/network-services/getting-started-01-create-lb-service/region.png" loading="lazy" />
    ...
    **Étape 2 : Choix de la taille**
    ...
    <img className="thumbnail" alt="Choix de la taille" src="/images/public-cloud/network-services/getting-started-01-create-lb-service/size.png" loading="lazy" />
...
L'interface contient un lien vers notre site sur lequel les caractéristiques et un benchmark de toutes les tailles sont fournis. Une fois que vous avez choisi votre taille, cliquez sur <code className="action">Suivant</code>.
    ...
    **Étape 4 : Sélectionner le réseau privé et le sous-réseau sur lesquels le Load Balancer sera créé**
    ...
    <img className="thumbnail" alt="Choix du réseau" src="/images/public-cloud/network-services/getting-started-01-create-lb-service/private_network.png" loading="lazy" />
