...
Ce scénario est couvert par le guide « [Attacher une adresse Floating IP à une instance Public Cloud](/guides/public-cloud/network-services/attach-floating-ip-to-instance) ».

#### Architecture de configuration

<img className="thumbnail" alt="schema" src="/images/public-cloud/network-services/configuration-01-snat-configuration/architecture.png" loading="lazy" />
...
Créez une VM avec une Floating IP comme expliqué dans ce [guide](/guides/public-cloud/network-services/attach-floating-ip-to-instance).
