...
description: Découvrez comment partager un réseau privé entre deux projets Public Cloud OVHcloud.
...
Référez-vous aux guides suivants :
  ...
  - [Attacher une adresse Floating IP à une instance Public Cloud](/guides/public-cloud/network-services/attach-floating-ip-to-instance).
  - [Gestion des règles de firewall et port security sur les réseaux utilisant OpenStack CLI](/guides/public-cloud/cross-functional/security-group-private-network)
