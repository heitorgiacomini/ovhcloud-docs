...
<img className="thumbnail" alt="Ajout IP" src="/images/public-cloud/network-services/additional-ip-buy/buyaddIP_01.png" loading="lazy" />

À l'étape 1 de la commande, cliquez sur <code className="action">Suivant</code>.

<img className="thumbnail" alt="Ajout IP" src="/images/public-cloud/network-services/additional-ip-buy/buyaddIP_02.png" loading="lazy" />

L'étape 2 permet de sélectionner un pays pour la nouvelle adresse IP.

<img className="thumbnail" alt="Ajout IP" src="/images/public-cloud/network-services/additional-ip-buy/buyaddIP_03.png" loading="lazy" />
...
[Configurer une Additional IP](/guides/public-cloud/network-services/configure-additional-ip)
