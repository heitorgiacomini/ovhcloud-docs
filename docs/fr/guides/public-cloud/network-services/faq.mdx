...
description: Foire aux questions sur les services réseau Public Cloud
...
<details>
<summary>Le tarif de la solution Load Balancer  varie en fonction de la capacité en bande passante. Comment cela peut-il être paramétré / modifié ?</summary>
...
<details>
<summary>Puis-je utiliser mon Load Balancer avec des serveurs Bare Metal comme backends ? Puis-je utiliser mon Load Balancer avec des backends dans différentes régions Public Cloud ?</summary>
...
<details>
<summary>Puis-je connecter mon Load Balancer à mon Managed Kubernetes Service (MKS) ?</summary>
...
<details>
<summary>Je souhaite monitorer mon Load Balancer Public Cloud. Est-il possible d’activer metrics automatiquement sur le Load Balancer ?</summary>


Oui cette [fonctionnalité](https://docs.openstack.org/octavia/latest/user/guides/monitoring.html) est disponible depuis le déploiement de la version Zed en juin 2023. Retrouvez plus d'informations sur [cette page](/guides/public-cloud/network-services/loadbalancer-monitoring-prometheus).

</details>


<details>
<summary>Comment est mise en oeuvre la redondance pour chaque type d'offre ? Les Amphoras sont-ils configurés en mode ACT/STBY ?</summary>
...
<details>
<summary>Le Load Balancer peut-il être utilisée avec des adresses Additional IP (Failover IP) ?</summary>
...
<details>
<summary>Puis-je utiliser plusieurs protocoles (UDP, TCP, HTTP) sur un même Load Balancer ?</summary>
...
<details>
<summary>Que se passe-t-il si le Load Balancer Public Cloud reçoit plus de requêtes que prévu ? Le prix va-t-il augmenter ? En serai-je informé ?</summary>
...
<details>
<summary>Dans une architecture Public-to-Public, quel composant doit être dimensionné pour le trafic sortant ?</summary>
...
<details>
<summary>Qu’est-ce que la Gateway ? Quelle est sa place dans l’écosystème OpenStack ?</summary>
...
<details>
<summary>Les tarifs de la solution Gateway varient selon la capacité en bande passante. Comment cela peut-il être paramétré / modifié ?</summary>
...
<details>
<summary>Est-ce que une Gateway peut être utilisée avec des instances Load Balancer dans d'autres régions ?</summary>
...
<details>
<summary>Le routeur virtuel L3 (Gateway) peut-il m'aider si je souhaite avoir une Gateway d'accès à Internet pour toutes les VMs de mon vRack ?</summary>


Oui, c'est le cas pour une Gateway (routeur L3 avec option SNAT). Actuellement, seules les instances en **mode privé** de réseau et connectées à un réseau privé à région unique sont prises en charge. Pour plus d'informations, consultez notre [guide concept sur le réseau Public Cloud](/guides/public-cloud/network-services/concepts).

</details>


<details>
<summary>Puis-je utiliser un routeur L3 pour router le trafic entre différents sous-réseaux dans une région Public Cloud ?</summary>
...
<details>
<summary>Puis-je utiliser un routeur L3 pour router le trafic entre différents sous-réseaux dans plusieurs régions Public Cloud ?</summary>
...
<details>
<summary>Le service Gateway sera-t-il fourni avec une IP et un port publics ?</summary>
...
<details>
<summary>Comment générer une instance privée à utiliser avec l'option Gateway et SNAT ?</summary>
...
<details>
<summary>L’IP publique de la Gateway est-elle protégée contre les attaques DDoS ?</summary>
...
<details>
<summary>J'ai créé une instance en mode privé (elle n'a que des ports privés). Comment s’y connecter ?</summary>
...
<details>
<summary>Lorsque j'essaie d'associer une Floating IP au port du réseau Ext-Net, j'obtiens l'erreur suivante : "External network ... is not reachable from subnet .... Therefore, cannot associate Port ... with a Floating IP."</summary>
...
<details>
<summary>J'ai des VMs qui communiquent sur un réseau privé et je veux associer une Floating IP à une de ces VMs. Quel est le pool à choisir pour l'adresse Floating IP ?</summary>
...
<details>
<summary>Les adresses Floating IP sont-elles protégées contre les attaques DDoS ?</summary>
