...
description: "Guide pratique pour concevoir une Landing Zone sécurisée et évolutive sur le Public Cloud OVHcloud, couvrant la mise en réseau, l'IAM, les sauvegardes, etc."
...
- [Avoir configuré les variables d'environnement OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables).
- Être familier de [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform), si vous avez l'intention de l'utiliser.
- Compréhension de base des [concepts de réseau cloud](https://www.ovhcloud.com/fr/public-cloud/network/) (par exemple, sous-réseaux, gateways, adresses Floating IP).
...
<img className="thumbnail" alt="Landing zone architecture diagram" src="/images/public-cloud/cross-functional/landing-zone-migration/landing_zone_architecture.png" loading="lazy" />
...
Suivez [ce guide](/guides/public-cloud/network-services/create-private-network-gateway) pour configurer une gateway.
...
Utilisez les adresses Floating IP pour exposer en toute sécurité certaines ressources privées (par exemple, des instances, des services) à l'Internet public. Suivez [ce guide](/guides/public-cloud/network-services/attach-floating-ip-to-instance) pour associer une adresse Floating IP.
...
Suivez [ce guide](/guides/public-cloud/network-services/getting-started-load-balancer) pour configurer et utiliser un Load Balancer.
...
Suivez [ce guide](/guides/public-cloud/network-services/stormshield-vrack) pour configurer et utiliser un pare-feu Stormshield.
...
Suivez [ce guide](/guides/public-cloud/network-services/ubika-vrack) pour déployer une protection WAAP avec Ubika.
...
Consultez [cette documentation](/guides/network/ovhcloud-connect/occ-direct-control-panel).
...
Consultez la [documentation associée](/guides/public-cloud/cross-functional/security-structure-best-practices).
...
Ceci est essentiel pour l'observabilité, les audits de sécurité et le dépannage. Suivez [cette documentation](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).
...
Utilisez les tags, les rôles IAM et les alertes pour associer les coûts aux équipes, aux environnements ou aux services. Pour plus d'informations, consultez [cette documentation](/guides/public-cloud/cross-functional/analyze-billing).
