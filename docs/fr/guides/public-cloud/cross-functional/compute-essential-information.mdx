...
description: "Découvrez des notions de base utiles pour commencer dans l'environnement Public Cloud"
...
- [Ouvrir un compte OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation)
- [Créer votre premier projet Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Se familiariser avec l'interface Public Cloud](/guides/public-cloud/cross-functional/public-cloud-interface-walk-me)
- [Créer sa première instance](/guides/public-cloud/compute/getting-started)
- [Gérer ses quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota)
...
Pour démarrer, vous aurez d'abord besoin d'un [compte client OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation).

Vous devrez ensuite [créer un projet Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project). Un projet est un environnement que vous allez dédier à un contexte.
...
Votre moyen de payement étant enregistré, il servira à débiter le montant calculé pour votre [facturation en fin de mois](/guides/public-cloud/cross-functional/analyze-billing). Ce calcul est fait sur la base du temps d'utilisation de chaque ressource, en fonction du prix des ressources. Pour les instances, les prix sont généralement affichés sous forme de tarif horaire pour plus de lisibilité, mais la facturation se fait à la seconde, avec une durée minimale de facturation d'une minute.
...
<br/>Ces quotas sont attribués par localisation (région au sens OpenStack). Il se peut donc que vous atteigniez le maximum de ressources possibles sur votre projet et qu'il faille [augmenter ces quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota).
...
- Si vous souhaitez utiliser les APIs OpenStack ou Amazon S3, ou l'interface Horizon, vous aurez à [créer des utilisateurs](/guides/public-cloud/cross-functional/create-and-delete-a-user) pour cela. Les utilisateurs peuvent éventuellement avoir des droits limités afin de sécuriser les périmètres d'action.
- Si vous n'avez pas besoin d'accéder aux APIs ou à Horizon, vous pouvez [associer un autre compte client OVHcloud](/guides/public-cloud/cross-functional/delegate-projects) en complément sur votre projet.
...
|---|---|
|[FAQ](/guides/public-cloud/cross-functional/faq-pci)|Les questions les plus fréquentes au sujet de Public Cloud.|
|[Lexique](/guides/public-cloud/cross-functional/introduction-about-instances)|Les concepts et définitions dont vous aurez besoin pour avancer.|
...
|Documentation|Détails|
|---|---|
|[Créer sa première instance](/guides/public-cloud/compute/getting-started)|Premier guide pratique pour démarrer un serveur cloud depuis l'espace client OVHcloud.|
|[Utilisation d'une clé SSH](/guides/public-cloud/compute/creating-ssh-keys)| Pour vous connecter à une instance Linux, vous aurez besoin de passer par une connexion SSH, ce guide vous en détaille l'utilisation.|
|[Configuration du réseau privé](/guides/public-cloud/network-services/vrack)|Chez OVHcloud, les réseaux privés sont portés par la technologie vRack. Ce guide vous accompagne dans cette mise en place.|
|[Attacher un disque supplémentaire à une instance](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance)|Ce guide vous accompagne pour ajouter du stockage additionnel à votre première instance.|
|[Accéder à l'interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon)|L'interface Horizon d'OpenStack permet certaines actions avancées, voici comment vous y connecter.|
|[Créer un cluster Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/create-cluster) (EN)|Ce guide vous accompagne pas à pas dans la création de votre premier cluster Kubernetes.|
|[Configurer une Additional IP](/guides/public-cloud/network-services/configure-additional-ip)|Les Additional IP peuvent vous permettre de basculer le trafic d'une instance à une autre, ce guide vous expliquera comment configurer cela.|
|[Utilisation de l'interface Horizon](/guides/public-cloud/cross-functional/introducing-horizon)|Horizon est l'interface classique d'OpenStack, ce guide vous expliquera comment y accéder.|
|[Installation de la CLI OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)|OpenStack peut également être utilisé en ligne de commande, voici comment installer les outils.|
