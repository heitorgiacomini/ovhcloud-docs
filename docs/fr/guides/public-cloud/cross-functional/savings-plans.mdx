...
description: Savings Plans - Tout ce que vous devez savoir pour optimiser vos coûts
...
Ce guide a pour objectif de vous fournir une compréhension claire et pratique des [Savings Plans](https://www.ovhcloud.com/fr/public-cloud/savings-plan/), afin de vous aider à optimiser vos coûts d'infrastructure. Nous expliquerons ce que sont les Savings Plans, leur fonctionnement, et comment choisir le modèle le plus adapté à vos besoins spécifiques. À travers des exemples concrets, vous découvrirez comment ces Savings Plans peuvent réduire vos dépenses tout en offrant une flexibilité dans la gestion de vos ressources.
...
Les [Savings Plans](https://www.ovhcloud.com/fr/public-cloud/savings-plan/) sont un modèle de tarification flexible qui offre des tarifs inférieurs à la tarification à la demande, en échange d'un engagement d'utilisation sur une durée donnée (1, 6, 12, 24 ou 36 mois).
...
:::warning
En ce qui concerne les instances actives simultanément, pour savoir si une ressource suspendue ou mise en pause est considérée comme active, veuillez vous référer au guide suivant : [Suspendre ou mettre en pause une instance](/guides/public-cloud/compute/suspend-or-pause-an-instance)
...
- Si le client dispose de 15 instances de type B3-8 et souscrit à un Savings Plan pour 10 instances B3-8, les 10 premières seront automatiquement couvertes par la facturation du Savings Plan et les 5 autres seront facturées au tarif standard sans remise.
...
- Après analyse de ses besoins, le client opte pour la combinaison suivante :
    - Un Savings Plan de 3 ans couvrant 20 VMs B3-16. Cela représente une **réduction de 54 %** par rapport à une facturation standard (à l'usage).
    - Un Savings Plan de 1 an couvrant 10 VMs B3-8. Cela représente une **réduction de 35 %** par rapport à une facturation standard (à l'usage).

Grâce à cette combinaison, le client réalise des économies substantielles en optimisant ses ressources de production à long terme, tout en maintenant la flexibilité nécessaire pour son environnement de développement, avec des réductions respectives de 54 % et 35 % par rapport à une facturation standard.
...
<details>
<summary>**a. Filtres de sélection**</summary>


<img className="thumbnail" alt="Dashboard focus on filters" src="/images/public-cloud/cross-functional/savings-plans/dashboard_filters.png" loading="lazy" />
...
<details>
<summary>**b. Indicateurs des Savings Plan**</summary>
...
<img className="thumbnail" alt="Dashboard focus on kpi" src="/images/public-cloud/cross-functional/savings-plans/dashboard_kpi.png" loading="lazy" />
...
<img className="thumbnail" alt="Dashboard focus on graph" src="/images/public-cloud/cross-functional/savings-plans/dashboard_graph.png" loading="lazy" />
...
- **Légendes des couleurs du graphique :**
    ...
    - **Rouge :** Représente le nombre de ressources non couvertes par un Savings Plan et facturées au tarif standard.

</details>


<details>
<summary>**d. Tableau de suivi de consommation**</summary>


<img className="thumbnail" alt="Dashboard focus on conso" src="/images/public-cloud/cross-functional/savings-plans/dashboard_conso.png" loading="lazy" />
...
<details>
<summary>Facturation de Savings Plan pour les instances</summary>
...
<img className="thumbnail" alt="Facturation d'un Savings Plan pour des instances" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_instances_svp.png" loading="lazy" />
...
Les instances supplémentaires, c'est-à-dire celles qui ne sont pas couvertes par votre Savings Plan, sont facturées à la seconde au tarif standard, comme pour une facturation classique.
Par exemple, si vous utilisez 10 instances de troisième génération pendant 10 heures au cours du mois, cela représente 100 heures-instance d'utilisation (10 instances x 10 heures), facturées au tarif standard, en plus de la ligne du Savings Plan.

<img className="thumbnail" alt="Facturation pour des instances à l'heure" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_instances_hours.png" loading="lazy" />

</details>


<details>
<summary>Facturation de Savings Plan pour Rancher</summary>
...
<img className="thumbnail" alt="Facturation d'un Savings Plan pour des VCPu" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_rancher_svp.png" loading="lazy" />
...
Les vCPUs supplémentaires, c'est-à-dire ceux qui ne sont pas couverts par votre Savings Plan, sont facturés à la seconde au tarif standard, comme pour la facturation standard.
Par exemple, si vous utilisez 10 vCPUs pendant 10 heures au cours du mois, cela représente 100 heures-vCPU d'utilisation (10 vCPUs x 10 heures), facturées au tarif standard, en plus de la ligne du Savings Plan.

<img className="thumbnail" alt="Facturation pour des VCPu à l'heure." src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_rancher_hours.png" loading="lazy" />
