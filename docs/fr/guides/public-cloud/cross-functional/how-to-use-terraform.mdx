...
description: "Décrouvez comment utiliser l'outil Terraform pour abstraire le déploiement de votre infrastructure"
...
<iframe className="video" width="560" height="315" src="https://www.youtube-nocookie.com/embed/TFfKd24rzvE" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true}></iframe>

**Découvrez comment utiliser Terraform sur le Public Cloud OVHcloud.**

## Prérequis

* [Configurer un accès utilisateur à Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
...
* [Disposer de vos identifiants API et de votre clé d'autorisation OVHcloud](/guides/manage-and-operate/api/first-steps)
* [Une clé SSH](/guides/public-cloud/compute/first-steps-with-public-cloud-instance)
...
<img className="thumbnail" alt="token" src="/images/public-cloud/cross-functional/how-to-use-terraform/first_step.png" loading="lazy" />

<img className="thumbnail" alt="token created" src="/images/public-cloud/cross-functional/how-to-use-terraform/create_token.png" loading="lazy" />
...
Il faut maintenant [créer un nouvel utilisateur OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user), puis [générer le fichier OpenRC ](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#etape-1-recuperer-les-variables) contenant tous les identifiants que vous souhaitez exporter en tant qu'environnement variables.
...
Cliquez sur <code className="action">Instances</code>.
...
<img className="thumbnail" alt="public-cloud" src="/images/public-cloud/cross-functional/how-to-use-terraform/basic_infrastructure_for_a_web_site.png" loading="lazy" />
...
1. [Créer manuellement un projet Public Cloud depuis l'espace client OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
