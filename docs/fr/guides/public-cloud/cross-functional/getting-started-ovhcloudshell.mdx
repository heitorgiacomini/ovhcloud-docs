...
description: "Découvrez comment utiliser rapidement et gérer le OVHcloud Shell directement depuis l'espace client OVHcloud pour simplifier vos opérations et workflows cloud."
...
Cliquez sur le bouton <code className="action">OVHcloud Shell</code> pour lancer le terminal.

<img className="thumbnail" alt="Bouton Cloudshell" src="/images/public-cloud/cross-functional/getting-started-ovhcloudshell/OVHcloud_Shell.png" loading="lazy" />
