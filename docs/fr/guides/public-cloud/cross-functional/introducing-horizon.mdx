...
- Un [project Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) dans votre compte OVHcloud.
- **[Facultatif depuis septembre 2023]** Un utilisateur [OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) créé dans votre projet. Cette étape est facultative car nous avons déployé une authentification unique (SSO : *Single Sign-On*) entre l'espace client OVHcloud et Horizon.
...
<img className="thumbnail" alt="orchestration" src="/images/public-cloud/cross-functional/introducing-horizon/orchestration2021.png" loading="lazy" />
