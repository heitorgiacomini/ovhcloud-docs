...
- Avoir créé un utilisateur OpenStack. Consultez [le guide qui y est dédié](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- Avoir préparé l’environnement pour utiliser OpenStack. Consultez pour cela le guide suivant : [Préparer l’environnement pour utiliser l’API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
...
Comme indiqué dans [ce guide](/guides/public-cloud/cross-functional/create-and-delete-a-user), le mot de passe n'est visible qu'une seule fois, à sa création.
