...
description: Comprenez les mécanismes de résilience 3-AZ et explorez les architectures de référence OVHcloud
...
<details>
<summary>**Résilience multi-AZ dans le Public Cloud**</summary>
...
<details>
<summary>**Déploiement en 2-AZ avec Block Storage régional** <a name="2az-with-regional-block-storage"></a></summary>
...
<details>
<summary>**Déploiement en 2-AZ avec Block Storage local**</summary>


Ce schéma illustre une architecture de déploiement en 2-AZ avec du service Block Storage local.

<img className="thumbnail" alt="2-az with local storage" src="/images/public-cloud/cross-functional/3az-ref-architecture/2az-with-local-storage.png" loading="lazy" />
