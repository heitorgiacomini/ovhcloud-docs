...
- Avoir créé un [premier projet Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
...
<img className="thumbnail" alt="Public Cloud interface - menu compte" src="/images/public-cloud/cross-functional/03-public-cloud-interface-walk-me/account-2025.png" loading="lazy" />
...
<img className="thumbnail" alt="Menu projet" src="/images/public-cloud/cross-functional/03-public-cloud-interface-walk-me/project-menu-2025.png" loading="lazy" />
...
<img className="thumbnail" alt="Renommer un projet Public Cloud" src="/images/public-cloud/cross-functional/03-public-cloud-interface-walk-me/rename-project.png" loading="lazy" />
...
<img className="thumbnail" alt="Public Cloud interface - menu raccourcis" src="/images/public-cloud/cross-functional/03-public-cloud-interface-walk-me/shortcuts-2025.png" loading="lazy" />
...
<img className="thumbnail" alt="Public Cloud interface - assistant de configuration" src="/images/public-cloud/cross-functional/03-public-cloud-interface-walk-me/wizard-2025.png" loading="lazy" />
...
|---|---|
|**Horizon**|C'est l'[interface graphique](/guides/public-cloud/cross-functional/introducing-horizon) habituellement disponible sur OpenStack. Elle n'est pas modifiée, ce qui permet aux utilisateurs qui ont l'habitude de cette interface de retrouver leurs réflexes.|
|**Utilisateurs & Rôles**|Permet de [créer des utilisateurs](/guides/public-cloud/cross-functional/create-and-delete-a-user) et de leur attribuer un rôle. Ces utilisateurs permettent notamment d'accèder directement aux APIs ou à l'interface Horizon. Vous pouvez par exemple créer un utilisateur pour vos opérations de maintenance classiques et un utilisateur pour vos outils d'automatisation, comme par exemple Terraform.|
|**Quota & Régions**|Cet outil vous permet de piloter les localisations et les limites de ressources disponibles sur votre projet.<br/><br/>**Les quotas** : Suivant certains critères (nombre de factures déjà payées, utilisation d'autres produits OVHcloud), notre système met en place des quotas (des limites) au nombre de ressources que vous pouvez créer, ceci dans le but d'éviter tout problème d'impayés. Par défaut, le système augmente vos quotas automatiquement quand certains critères sont atteints. Vous pouvez cependant [effectuer une augmentation manuelle d'un quota](/guides/public-cloud/cross-functional/increasing-public-cloud-quota) depuis cet outil.<br/><br/>**Les régions** : Public Cloud est disponible dans plusieurs localisations dans le monde. De plus, chaque localisation peut comporter plusieurs « régions » (notion propre à OpenStack). Par exemple, pour un client européen, la zone APAC (Asie Pacifique) est désactivée par défaut. Si cela correspond à vos besoins, vous pouvez activer de nouvelles régions depuis ce menu.|
|**Clés SSH**|Un outil qui vous permet de [gérer vos clés SSH](/guides/public-cloud/compute/creating-ssh-keys) de manière centralisée.|
|**Facturation**|Public Cloud fonctionnant en « *pay as you go* », les factures sont éditées en fin de mois. Dans [ce menu](/guides/public-cloud/cross-functional/analyze-billing), vous pourrez suivre votre consommation actuelle, voir une prévision de la prochaine facture et bien sûr retrouver vos précédentes factures.|
...
|**Paramètres du projet**|Ce dernier outil vous permet de configurer les paramètres généraux du projet comme son nom, sa configuration en tant que « projet par défaut du compte », la compatibilité HDS, ou encore de [supprimer votre projet Public Cloud](/guides/public-cloud/cross-functional/delete-a-project)|
