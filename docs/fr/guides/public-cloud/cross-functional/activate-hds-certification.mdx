...
<img className="thumbnail" alt="activer HDS nouveau projet" src="/images/public-cloud/cross-functional/activate-hds-certification/hds-new-project.png" loading="lazy" />
...
<img className="thumbnail" alt="activer HDS projet existant" src="/images/public-cloud/cross-functional/activate-hds-certification/hds-current-project1.png" loading="lazy" />
