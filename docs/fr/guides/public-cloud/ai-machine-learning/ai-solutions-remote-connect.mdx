---
title: AI Tools - Connexion SSH à distance (EN)
...
- An AI Notebook or AI Training Project created inside a [Public Cloud project](https://www.ovhcloud.com/fr/public-cloud/) in your OVHcloud account
...
Here is how to add your SSH key to your AI Solution if you are using the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or the `ovhai` CLI:

<Tabs>
  <Tab label="Using the Control Panel (UI)">
    Click <ManagerLink to="/#/pci/projects">this link</ManagerLink> to access your Public Cloud project, then go to the <code className="action">AI & Machine Learning</code> category in the left menu and choose <code className="action">AI Notebooks</code> or <code className="action">AI Training</code> section.
