...
description: "Comment utiliser a modèle existant pour faire de l'apprentissage par transfert?"
...
- A [user](/guides/public-cloud/ai-machine-learning/ai-users) for AI Notebooks
...
:::info
To know more about how to **push your data to Object Storage**, please refer to the dedicated [documentation](/guides/public-cloud/ai-machine-learning/ai-cli-data).

:::


Then, you can launch your notebook from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).

### Launching a Jupyter notebook with "Miniconda" via UI

To launch your notebook from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, refer to the following steps.
...
:::info
To learn more about how to use and **manage your data in a notebook with UI**, check this [documentation](/guides/public-cloud/ai-machine-learning/ai-notebooks-manage-data-ui).
...
:::info
To know more about how to use and **manage your data in a notebook with the CLI**, refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-cli-access-data).
...
- If you want to deploy a Gradio app for **Image classification** or **Sketch recognition**, check out this [documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-gradio-sketch-recognition).
- If you are interested in **Computer Vision**, familiarise yourself with Object Detection by following this [tutorial](/guides/public-cloud/ai-machine-learning/ai-notebooks-yolov5-example).
