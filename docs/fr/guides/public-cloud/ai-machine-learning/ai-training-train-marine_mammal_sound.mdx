...
description: "Découvrez à quel point il est simple d'entraîner un modèle à l'aide d'AI Training"
...
You can see the Notebook step in the tutorial: [Audio analysis and classification with AI](/guides/public-cloud/ai-machine-learning/ai-notebooks-marine-mammal-sounds-classification).
...
You can reuse the previous object storage used in the Notebook tutorial [Audio analysis and classification with AI](/guides/public-cloud/ai-machine-learning/ai-notebooks-marine-mammal-sounds-classification) or follow the step [Uploading your dataset on Public Cloud Storage](/guides/public-cloud/ai-machine-learning/ai-notebooks-marine-mammal-sounds-classification#uploading-your-dataset-on-public-cloud-storage) of this same tutorial.
...
For more explanations about the CLI command for AI Training, please read this guide: [CLI Reference](/guides/public-cloud/ai-machine-learning/ai-cli-overview).
...
To create the application using the trained model, you can follow this tutorial: [Deploy an app for audio classification task using Streamlit](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-sounds-classification).
