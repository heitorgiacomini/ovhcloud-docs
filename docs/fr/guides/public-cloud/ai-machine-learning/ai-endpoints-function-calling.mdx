...
This documentation provides an overview on how to use function calling with the AI models offered on [AI Endpoints](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/).
...
Visit our [Catalog](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/catalog/) to find out which models are compatible with Function Calling.
...
In this guide, we have explained how to use Function Calling with the [AI Endpoints](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/) models.
