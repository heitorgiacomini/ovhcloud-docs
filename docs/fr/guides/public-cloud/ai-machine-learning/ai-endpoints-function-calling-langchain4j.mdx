...
Combined with OVHcloud **[AI Endpoints](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/)** which offers both LLM and embedding models, it becomes easy to create advanced, production-ready assistants.
...
void main() throws Exception &#123;
    ...
    // Main chatbot configuration, choose on of the available models on the AI Endpoints catalog (https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/catalog/)
