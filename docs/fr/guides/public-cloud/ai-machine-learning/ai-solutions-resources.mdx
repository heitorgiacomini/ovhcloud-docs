...
description: Découvrez comment monitorer les ressources cloud utiliséees par vos AI Tools
...
- An AI Project created inside a [Public Cloud project](https://www.ovhcloud.com/fr/public-cloud/) in your OVHcloud account
- An [AI user](/guides/public-cloud/ai-machine-learning/ai-users)
- Access to the <ManagerLink to="/#/pci/projects">OVHcloud Control Panel</ManagerLink> or [the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installed on your computer
...
The monitoring dashboard for **AI Tools** can be accessed via a dedicated URL, which is provided in the AI Tool details, accessible from the Control Panel (UI) or with the [ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client). The monitoring URL is structured as follows: *`https://monitoring.<REGION>.ai.cloud.ovh.net/d/gpu?var-job=<JOB-ID>`*.
