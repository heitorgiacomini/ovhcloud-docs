...
[AI Endpoints](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/) is a serverless platform provided by OVHcloud that offers easy access to a selection of world-renowned, pre-trained AI models.
...
For up-to-date limitations, refer to [Endpoint Limitations](#endpoint-limitations) and check model capabilities in the [Catalog](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/catalog/).
:::


## Objective

This documentation provides an overview of the `v1/responses` route on [AI Endpoints](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/), including:
...
<Tabs>
  ...
  <Tab label="cURL (Tool definition only)">
...
Refer to the [Catalog](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/catalog/) and model pages for supported content types.
:::
...
To maximise compatibility, always verify supported features for your chosen model in the [AI Endpoints catalog](https://www.ovhcloud.com/fr/public-cloud/ai-endpoints/catalog/), and consider falling back to `v1/chat/completions` when a feature is not available on `v1/responses`.

## Go further

Browse the full [AI Endpoints documentation](/guides/public-cloud/ai-machine-learning/overview) to explore other guides and tutorials.
