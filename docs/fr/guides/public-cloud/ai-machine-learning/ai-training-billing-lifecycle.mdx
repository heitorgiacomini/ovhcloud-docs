...
Their official pricing is available in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/fr/public-cloud/prices/).
