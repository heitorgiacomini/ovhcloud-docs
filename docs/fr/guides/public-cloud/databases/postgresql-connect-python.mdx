---
title: Se connecter avec Python au service Public Cloud Databases pour PostgreSQL (EN)
description: Connect to your Public Cloud Databases for PostgreSQL using the Python programming language
