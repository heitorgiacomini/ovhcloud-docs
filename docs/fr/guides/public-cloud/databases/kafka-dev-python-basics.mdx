...
description: Develop your first Python applications using Kafka
...
- A Public Cloud Databases for Kafka service running and configured. [This guide](/guides/public-cloud/databases/kafka-getting-started) can help you to meet this requirement.
- Following the [Getting Started guide](/guides/public-cloud/databases/kafka-getting-started), save all certificates in a dedicated folder: 
