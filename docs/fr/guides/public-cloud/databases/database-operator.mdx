---
title: "Installer l'opérateur Kubernetes pour les bases de données Public Cloud (EN)"
...
- Access to the [OVHcloud API](https://eu.api.ovh.com/). Create your credentials using our [First Steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps) guide.
