...
More information on [https://github.com/apache/kafka/blob/trunk/LICENSE](https://github.com/apache/kafka/blob/trunk/LICENSE).

### Hardware resources

#### Flexible storage

You can increase the storage of your cluster up to the maximum allowed for a given reference. Please refer to the [Resize your cluster storage guide](/guides/public-cloud/data-analytics/analytics/resize-cluster-storage) for more information.
...
You can further customize your Kafka by using advanced parameters. See the [Advanced parameters references documentation](/guides/public-cloud/databases/kafka-advanced-parameters-references) for more information on the supported parameters.
...
Logs and metrics are available through the Control Panel and the API. Additionally, cross service integration can be configured to leverage your logs and metrics in other Public Cloud Database services. You could then view your Kafka logs in Opensearch and metrics in Dashboards service (metrics have to be exported first in a time series compatible engine such as PostgreSQL). See the [Cross Service Integration documentation](/guides/public-cloud/databases/databases-cross-service-integration) for more information.
