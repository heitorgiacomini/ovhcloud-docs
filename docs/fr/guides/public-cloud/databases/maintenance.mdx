---
title: Opérations de maintenance des bases de données Public Cloud (EN)
...
<Api version="v1" section="/cloud" method="GET" route={"/1.0/cloud/project/\{serviceName\}/database/postgresql/\{productId\}/maintenance"} />


<img className="thumbnail" alt="Choose Maintenance" src="/images/public-cloud/databases/databases-15-maintenances/maintenancesql.png" loading="lazy" />
...
<img className="thumbnail" alt="Choose Maintenance" src="/images/public-cloud/databases/databases-15-maintenances/maintenancesql2.png" loading="lazy" />

You can also decide to preemptively apply some operations, using this API endpoint:

<Api version="v1" section="/cloud" method="POST" route={"/1.0/cloud/project/\{serviceName\}/database/postgresql/\{productId\}/maintenance/\{maintenanceId\}/apply"} />
