---
title: Se connecter avec Python au service Public Cloud Databases pour MongoDB (EN)
description: Connect to your Public Cloud Databases for MongoDB using the Python programming language
...
One of the easiest, yet powerful, is to use a Command Line Interface (CLI), as shown in our guide : [Connect to MongoDB with CLI](/guides/public-cloud/databases/mongodb-connect-cli).
...
Conda will allow you to build a specific environment when working with MongoDB, without impacting your existing configurations. For more information please visit [https://www.conda.io](https://www.conda.io).
:::
...
Once you know the IP address, follow the steps from this guide : [Configure your MongoDB instance to accept incoming connections](/guides/public-cloud/databases/mongodb-manage-control-panel).
...
As shown in the code, we use the **PyMongo** official driver. Use the official PyMongo documentation for exhaustive command list : [https://docs.mongodb.com/drivers/pymongo/](https://docs.mongodb.com/drivers/pymongo/).
