...
description: Public Cloud Databases Frequently Asked Questions
...
We are adding more and more Databases Management Systems over time, please find the exact list and proposed versions in our [Capabilities and Limitations page](/guides/public-cloud/databases/capabilities).
...
Please read our [Getting started with Public Cloud Databases documentation](/guides/public-cloud/databases/getting-started).
...
Since we bill per second, this operation can be repeated as much as you need (and without a significant increase in your bill).
...
Please find the exact list and proposed versions in our [Capabilities and Limitations page](/guides/public-cloud/databases/capabilities).
...
You don't pay before using the service. At the end of the month, we summarize your spending in one bill per project. Public Cloud Databases are billed per second, for the service range and flavor selected during DB instance creation, with a minimum billing period of 1 minute.
...
During the DB instance creation, you can select the region and datacenter to deploy your service. Please find the exact list in our [Capabilities and Limitations page](/guides/public-cloud/databases/capabilities).

### Do we provide Multi-AZ deployments?

Public Cloud Databases support both Single Availability Zone and Multi-Availability Zone deployment modes.
...
Backups are performed differently according to the DBMS. See [Automated backups](/guides/public-cloud/databases/backups) for more details.
...
The period during which the backup is stored depends on the plan you subscribed. You can find it in our [Automated backups documentation](/guides/public-cloud/databases/backups).
...
Yes, you can. Please refer to [Automated backups](/guides/public-cloud/databases/backups) for more details.
...
Please read our [Getting started guide](/guides/public-cloud/databases/getting-started) to get a step-by-step documentation.

### How can I add new users for my database instance?

Once your database instance is created, you can manage database users either in the OVHcloud Control Panel or via Terraform or the API. You need at least 1 created and configured user. Please read our [Getting started guide](/guides/public-cloud/databases/getting-started) to get a step-by-step documentation.
...
For healthcare compliance such as HIPAA/HDS, please refer to our [official page](https://www.ovhcloud.com/fr/enterprise/certification-conformity/hds/). For certification overview, please refer to our [official page](https://www.ovhcloud.com/fr/enterprise/certification-conformity/).
...
In order to manage storage issues, please refer to the [Handling "Disk Full" situations](/guides/public-cloud/databases/handling-disk-full) guide.
