...
La création d'utilisateurs du service s'effectue via l'espace client et l'API.

Par défaut, il est possible de créer jusqu'à 50 utilisateurs par service. Si vous avez besoin de plus de 50 utilisateurs, contactez le support OVHcloud pour demander une augmentation de cette limite.
