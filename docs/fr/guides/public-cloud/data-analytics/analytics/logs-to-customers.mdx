...
description: Find out how to forward logs of your Analytics service to your Logs Data Platform data stream
...
- In the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> go to the LDP page.
