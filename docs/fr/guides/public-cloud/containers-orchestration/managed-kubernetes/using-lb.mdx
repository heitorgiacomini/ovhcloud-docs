...
description: Find out how to use and expose your app deployed on an OVHcloud Managed Kubernetes LoadBalancer
...
A dedicated documentation for [Public Load Balancer](https://www.ovhcloud.com/fr/public-cloud/load-balancer/) is available, please look at the [Expose your applications using a load balancer](/guides/public-cloud/containers-orchestration/managed-kubernetes/expose-applications-using-load-balancer).
:::
