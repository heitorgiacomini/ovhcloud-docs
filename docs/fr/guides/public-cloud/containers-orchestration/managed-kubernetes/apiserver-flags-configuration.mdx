...
description: "Find out how to configure the managed components of your Kubernetes: CoreDNS, IPVS, and even API server admission plugins on an OVHcloud Managed Kubernetes cluster"
...
<img className="thumbnail" alt="Log in to the API Explorer" src="/images/public-cloud/containers-orchestration/managed-kubernetes/apiserver-flags-configuration/kubernetes-quickstart-api-ovh-com-001.png" loading="lazy" />
...
<img className="thumbnail" alt="Kubernetes section of the API Explorer" src="/images/public-cloud/containers-orchestration/managed-kubernetes/apiserver-flags-configuration/kubernetes-quickstart-api-ovh-com-002.png" loading="lazy" />
...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-kubernetes/apiserver-flags-configuration/api-rights.png" loading="lazy" />
...
<img className="thumbnail" alt="Copy paste service name" src="/images/public-cloud/containers-orchestration/managed-kubernetes/apiserver-flags-configuration/get-service-name.png" loading="lazy" />
