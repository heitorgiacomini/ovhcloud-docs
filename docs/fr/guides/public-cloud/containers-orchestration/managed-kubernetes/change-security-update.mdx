...
description: Find out how to change the security update policy on an OVHcloud Managed Kubernetes cluster
...
<img className="thumbnail" alt="Access to the administration UI" src="/images/public-cloud/containers-orchestration/managed-kubernetes/change-security-update/upgrading-kubernetes-version-000.png" loading="lazy" />

Click on the <code className="action">...</code> button to the right of your Kubernetes cluster and choose <code className="action">Manage cluster</code>.

<img className="thumbnail" alt="Click on the right end button and choose Manage cluster" src="/images/public-cloud/containers-orchestration/managed-kubernetes/change-security-update/upgrading-kubernetes-version-001.png" loading="lazy" />

On the *Management* section, click on <code className="action">Change security policy</code>.

<img className="thumbnail" alt="Click on Change the security policy" src="/images/public-cloud/containers-orchestration/managed-kubernetes/change-security-update/change-security-update-002.png" loading="lazy" />
...
Choose one option and click <code className="action">Confirm</code>.

<img className="thumbnail" alt="Click on Confirm" src="/images/public-cloud/containers-orchestration/managed-kubernetes/change-security-update/change-security-update-004.png" loading="lazy" />
...
Specifically, you have to generate these credentials via the [OVHcloud token generation page](https://api.ovh.com/createToken/?GET=/*&POST=/*&PUT=/*&DELETE=/*) with the following rights: **GET**, **POST**, **PUT** and **DELETE** on `/*`.
...
<img className="thumbnail" alt="Copy paste service name" src="/images/public-cloud/containers-orchestration/managed-kubernetes/change-security-update/get-service-name.png" loading="lazy" />
...
In this resources configuration, we ask Terraform to create a Kubernetes cluster, in the GRA5 region, using the Kubernetes version 1.31 (the last and recommended version at the time we wrote this tutorial), with a security update policy that equals to "Do not update".
...
To have an overview of the OVHcloud Managed Kubernetes service, you can go to the [OVHcloud Managed Kubernetes page](https://www.ovhcloud.com/fr/public-cloud/kubernetes/).
