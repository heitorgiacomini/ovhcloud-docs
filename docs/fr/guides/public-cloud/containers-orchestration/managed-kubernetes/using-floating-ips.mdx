...
description: Découvrez comment activer et gérer les Floating IP sur les nœuds workers pour les clusters Managed Kubernetes Service
...
Pour plus d'informations sur les plans MKS et leurs différences, consultez le [guide de comparaison des plans MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans).
:::
...
Pour une liste complète des régions disponibles par plan, consultez le guide « [Disponibilité régionale par plan MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/datacenters-nodes-storage-flavors) ».
:::
...
Pour des informations détaillées sur la tarification, veuillez consulter les [tarifs OVHcloud Public Cloud](https://www.ovhcloud.com/fr/public-cloud/prices/#compute) (section Floating IP).
...
<Api version="v1" section="/cloud/project/" method="POST" route={"/cloud/project/\{serviceName\}/kube"} />
...
<Api version="v1" section="/cloud/project/" method="POST" route={"/cloud/project/\{serviceName\}/kube/\{kubeId\}/nodepool"} />
...
<Api version="v1" section="/cloud/project/" method="PUT" route={"/cloud/project/\{serviceName\}/kube/\{kubeId\}/nodepool/\{nodePoolId\}"} />
...
<Api version="v1" section="/cloud/project/" method="GET" route={"/cloud/project/\{serviceName\}/kube/\{kubeId\}/nodepool/\{nodePoolId\}"} />
...
Pour plus d'informations sur la gestion des Floating IP avec OpenStack, consultez notre guide « [Concepts - Additional IP ou Floating IP](/guides/public-cloud/network-services/additional-ip-vs-floating-ip) ».
...
- [Comparaison des plans MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans) : En savoir plus sur les différences entre les plans Free et Standard.
- [Disponibilité régionale](/guides/public-cloud/containers-orchestration/managed-kubernetes/datacenters-nodes-storage-flavors) : Consulter les régions disponibles pour chaque plan.
- [Console API OVHcloud](/links/console) : Explorer l'API OVHcloud complète.
- [Concepts - Additional IP ou Floating IP](/guides/public-cloud/network-services/additional-ip-vs-floating-ip) : Comprendre la différence entre Additional IP et Floating IP.
- [Tarifs OVHcloud Public Cloud](https://www.ovhcloud.com/fr/public-cloud/prices/#compute) : Consulter les tarifs des Floating IP.
