...
Les Floating IP sont facturées à la seconde selon la tarification d'OVHcloud Public Cloud.
...
:::info
Les Floating IP sont facturées par adresse IP pour la durée exacte pendant laquelle elles sont assignées à un nœud, avec une durée minimale de facturation d'une minute. Elles sont automatiquement supprimées (et la facturation s'arrête) lors de la suppression des nœuds.
:::
...
- <ApiLink>Console API OVHcloud</ApiLink> : Explorer l'API OVHcloud complète.
