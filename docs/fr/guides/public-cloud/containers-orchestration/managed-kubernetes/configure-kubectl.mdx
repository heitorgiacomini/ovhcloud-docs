...
<img className="thumbnail" alt="Configuring default settings for kubectl" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/kubernetes-quickstart-01.png" loading="lazy" />

Then, click on <code className="action">kubeconfig</code> to download the `kubectl` configuration file:

<img className="thumbnail" alt="Configuring default settings for kubectl" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/kubernetes-quickstart-02.png" loading="lazy" />

How kubeconfig files are loaded?

- 1. from the <code className="action">--kubeconfig</code> flag, is specified
...
<img className="thumbnail" alt="Add environment variables" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-kubectl-on-an-ovh-managed-kubernetes-cluster/configuring_default_settings_for_kubectl-02.png" loading="lazy" />
...
You can switch between different clusters by using the <code className="action">kubectl config</code> command.
