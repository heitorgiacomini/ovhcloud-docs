...
| **Enterprise File Storage** | NFS | [EFS avec MKS](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi) |
| **NAS-HA** | NFS | [NAS-HA avec MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-multi-attach-persistent-volumes-nas-ha) |
| **Cloud Disk Array** | CephFS | [CDA avec MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-multi-attach-persistent-volumes-cloud-disk-array) |
...
Pour la matrice complète des versions, consultez [Plugins Kubernetes et versions logicielles](/guides/public-cloud/containers-orchestration/managed-kubernetes/plugins-software-versions-reserved-resources).
...
- [Limites connues](/guides/public-cloud/containers-orchestration/managed-kubernetes/known-limits)
- [Choisir le bon plan : Free vs Standard](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans)
- [Modèle de responsabilité](/guides/public-cloud/containers-orchestration/managed-kubernetes/responsibility-model)
- [Versions logicielles et ressources réservées](/guides/public-cloud/containers-orchestration/managed-kubernetes/plugins-software-versions-reserved-resources)
- [Utiliser le réseau privé vRack](/guides/public-cloud/containers-orchestration/managed-kubernetes/using-vrack)
