...
- Un cluster [OVHcloud Managed Kubernetes](https://www.ovhcloud.com/fr/public-cloud/kubernetes/)
...
:::info
Plus d'informations sur l'utilisation de l'API OVHcloud : [Premiers pas avec l'API OVHcloud](/guides/manage-and-operate/api/first-steps).
:::
...
<Api version="v1" section="/cloud/project/{serviceName}/kube" method="POST" route={"/cloud/project/\{serviceName\}/kube"} />
...
<Api version="v1" section="/cloud/project/{serviceName}/kube" method="GET" route={"/cloud/project/\{serviceName\}/kube"} />
...
<Api version="v1" section="/cloud/project/{serviceName}/kube/{kubeId}/reset" method="POST" route={"/cloud/project/\{serviceName\}/kube/\{kubeId\}/reset"} />
...
[Limites connues d'OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/known-limits)

[Premiers pas avec l'API OVHcloud](/guides/manage-and-operate/api/first-steps)

Si vous avez besoin d'une formation ou d'une assistance technique pour la mise en œuvre de nos solutions, contactez votre commercial ou cliquez sur [ce lien](https://www.ovhcloud.com/fr/professional-services/) pour obtenir un devis et demander une analyse personnalisée de votre projet à nos experts Professional Services.
