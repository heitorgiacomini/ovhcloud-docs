...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Extraire un fichier eml depuis OWA" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa02.mp4" />
