...
Depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, dirigez-vous dans la partie <code className="action">Web Cloud</code> puis suivez les instructions selon votre offre:
...
<ZoneTabs>
  <Tab label="MX Plan">
    La capacité d'un compte MX Plan peut aller de 2,5 Mo à 5 Go. S'il est saturé et que sa capacité est inférieure à 5 Go, vous pouvez modifier sa capacité via l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>.<br/>
...
<Region zones={['ca']}>
- le protocole IMAP sur l'offre **MXplan** ;
- le protocole MAPI sur l'offre **Exchange** pour Outlook Windows ;
- le protocole EWS sur l'offre **Exchange** pour Outlook macOS.
</Region>
...
Configuration d'un compte MX Plan sur **macOS** :<br/><br/>
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    ...
    - [Courrier sur Windows 10](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration) (inclus avec Windows)<br/>
...
Configuration d'un compte Email Pro sur **macOS** :<br/><br/>
    - [Mail](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration) (inclus avec macOS)<br/>
    - [Outlook](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-macos-configuration)<br/>
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/email-pro/thunderbird-macos-configuration) (gratuit)<br/>
  </Tab>
  <Tab label="Exchange" availableIn={['eu', 'ca']}>
    ...
    - [Thunderbird](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/thunderbird-windows-configuration) (gratuit)<br/><br/>
