...
:::info
Pour les offres de type **Private Exchange**, le lien de connexion au webmail se situe dans le cadre **Connexion** de l'onglet <code className="action">Information générales</code> sur votre plateforme.
:::


Une fois connecté, cliquez sur <code className="action">Éléments supprimés</code> dans la colonne de gauche, puis sur <code className="action">Récupérer les éléments supprimés</code> dans la partie supérieure de la colonne centrale.
...
Validez ensuite votre restauration en cliquant sur <code className="action">Récupérer</code>.
