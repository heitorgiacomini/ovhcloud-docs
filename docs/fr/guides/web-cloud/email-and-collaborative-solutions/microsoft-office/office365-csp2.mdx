...
description: Découvrez comment  souscrire et administrer un service Office 365 Revendeurs (CSP2) chez OVHcloud
...
- **Lien direct :** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Cliquez sur <code className="action">Commander</code> pour finaliser.
...
<img className="thumbnail" alt="office365" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/csp2-01.png" loading="lazy" />
...
<img className="thumbnail" alt="office365" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_services_details.png" loading="lazy" />
...
L’icône <i className="icons-pen"></i> permet de modifier le nombre total de licences de l'abonnement. L'icône <i className="icons-bin"></i> permet de résilier l'abonnement ainsi que toutes ses licences.
...
<img className="thumbnail" alt="office365" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_Subscribers.png" loading="lazy" />
