...
description: Découvrez comment gérer la politique de sécurité de votre service e-mail
...
- renforcer la vérification des messages entrants sur nos serveurs et à destination de vos adresses e-mail (uniquement pour les comptes [Exchange](https://www.ovhcloud.com/fr/emails/hosted-exchange/));
- définir comment les messages dits « indésirables » s'afficheront dans vos boites aux lettres (uniquement pour les comptes [Exchange](https://www.ovhcloud.com/fr/emails/hosted-exchange/)).
...
|---|---|
|Cliquez sur l'onglet `Plus` puis sur <code className="action">Gérer la politique de sécurité</code>.|Cliquez sur l'onglet <code className="action">Sécurité</code>.|
...
:::info
Si vous ne voyez pas apparaitre l'onglet <code className="action">Plus</code> dans le panneau de gestion de votre offre <code className="action">MX Plan</code>, cela signifie que vous êtes sur une offre MX Plan historique. Il n'y a pas de gestion de la politique de sécurité sur l'offre MX Plan historique.
...
Une fois ces informations complétées, validez ces changements en cliquant sur <code className="action">Suivant</code>, puis sur <code className="action">Valider</code> pour les offres « MX Plan » et « Email Pro ». Cliquez sur <code className="action">Enregistrer les modifications</code> pour l'offre Exchange.
...
Une fois votre choix effectué, validez ces changements en cliquant sur <code className="action">Enregistrer les modifications</code>.
