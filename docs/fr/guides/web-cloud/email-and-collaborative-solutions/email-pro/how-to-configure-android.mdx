...
description: "Apprenez à configurer un compte Email Pro sur Android, via l'application Gmail"
...
Cliquez sur <ManagerLink to="/#/web/email_pro">ce lien</ManagerLink> pour accéder à la section <code className="action">Email Pro</code>. Le nom du serveur s'affiche dans la zone **Connexion** de l'onglet <code className="action">Informations générales</code>.
...
<Tabs>
  <Tab label="Première configuration">
    Sélectionnez <code className="action">Ajouter une adresse e-mail</code><br/><br/><img className="thumbnail" alt="emailpro" src="/images/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-android/android-first.png" loading="lazy" />
  </Tab>
  <Tab label="Configuration existante">
    ...
    3. Sélectionnez <code className="action">Ajouter un compte</code><br/><br/>![emailpro](/images/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-android/android-existing.png)&#123;thumbnail .h-600&#125;
  </Tab>
</Tabs>
...
<Tabs>
  <Tab label="Etape 1">
    Dans le menu des types de comptes e-mail, sélectionnez <code className="action">Autre</code>.<br/><br/>
  ...
  <Tab label="Etape 3">
    Sélectionnez le protocole de réception des e-mails. Il est conseillé de sélectionner <code className="action">Personnel (IMAP)</code><br/><br/>Retrouvez [plus de détails sur les protocoles POP et IMAP](#popimap) à la fin de ce guide pour comprendre leurs différences.<br/><br/>
  ...
  <Tab label="Etape 8">
    Déterminez le nom d'affichage de votre adresse e-mail dans l'application Gmail puis appuyez sur <code className="action">Suivante</code>.<br/><br/>
...
[Exchange - Configurer une adresse e-mail dans Gmail pour Android](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-android).
