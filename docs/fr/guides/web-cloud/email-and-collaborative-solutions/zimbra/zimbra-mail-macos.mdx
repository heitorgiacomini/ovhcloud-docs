...
description: "Découvrez comment configurer votre adresse e-mail Zimbra Pro sur l'application Mail sur Mac via le protocole EWS"
...
- **Si un compte est déjà paramétré sur l'application Mail** : 
    - Cliquez sur <code className="action">Mail</code> dans la barre de menu en haut de votre écran.
    - Cliquez sur <code className="action">Comptes</code>.
    - Dans la fenêtre « Comptes Internet » qui s'affiche, cliquez sur <code className="action">Ajouter un compte</code>
...
<Tabs>
  <Tab label="Étape 1">
    - Sélectionnez <code className="action">Microsoft Exchange</code>.
    - Définissez un **nom** et saisissez votre **adresse e-mail**.
    - Cliquez ensuite sur <code className="action">Se connecter</code>.
  ...
  <Tab label="Étape 2">
    - Choisissez <code className="action">Configurer manuellement</code> depuis la fenêtre qui apparaît.
  ...
  <Tab label="Étape 3">
    ...
    Pour finaliser la configuration, appuyez sur <code className="action">Se connecter</code> et sélectionnez les fonctionnalités que vous souhaitez explorer sur votre Mac.
...
1. Cliquez sur <code className="action">Mail</code> dans la barre de menu en haut de votre écran.
1. Cliquez sur <code className="action">Comptes</code> et sélectionnez le compte e-mail concerné.
