...
description: Découvrez comment débuter avec votre offre Zimbra depuis votre espace client OVHcloud
...
<iframe className="video" width="560" height="315" src="https://www.youtube-nocookie.com/embed/G5cumO64sjw?si=kZr5AHHaoYBONkGl" title="Zimbra OVHcloud" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowFullScreen={true}></iframe>

## Prérequis

- Avoir souscrit à un compte e-mail sur notre solution e-mail Zimbra OVHcloud.
- Disposer d'un [nom de domaine OVHcloud](https://www.ovhcloud.com/fr/domains/).
...
Si vous ajoutez un grand nombre de noms de domaine sur votre service Zimbra, il peut être utile de les regrouper en les associant à une « organisation ». Depuis votre service Zimbra, cliquez sur <code className="action">Organisation</code>.
...
Depuis les onglets <code className="action">Organisation</code>, <code className="action">Domaine</code> et <code className="action">Comptes e-mail</code>, en cliquant sur le label d'une organisation, vous créez un filtre qui affichera uniquement les éléments liés à cette organisation.
...
:::warning
Pour un fonctionnement optimal lorsque vous utilisez le même nom de domaine entre les offres OVHcloud [Exchange](https://www.ovhcloud.com/fr/emails/hosted-exchange/), [Email Pro](https://www.ovhcloud.com/fr/emails/email-pro/) et Zimbra, il est nécessaire de configurer le nom de domaine en `non-authoritatif`. Pour savoir comment configurer un nom de domaine en non-authoritatif sur une plateforme Exchange ou Email Pro, consultez notre guide [Ajouter un nom de domaine sur une plateforme e-mail](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain).
...
Pour ajouter un nom de domaine à votre service Zimbra, cliquez sur l'onglet <code className="action">Domaine</code> puis cliquez sur <code className="action">Ajouter un domaine</code>.
...
Cliquez sur <code className="action">Confirmer</code> pour finaliser l'ajout de votre domaine et lancer le processus de configuration.
  </Tab>
  <Tab label="Domaine externe">
...
Depuis l'onglet <code className="action">Domaine</code> de votre service Zimbra, cliquez sur l'icône « &#8285; » à droite du nom de domaine concerné pour afficher les options.
...
- Cliquez sur <code className="action">Configurer</code> pour modifier l'organisation associée à votre nom de domaine.
- Cliquez sur <code className="action">Diagnostics</code> pour afficher l'interface de diagnostic des enregistrements DNS du nom de domaine. Il est nécessaire de s'assurer qu'aucune alerte n'est affichée pour chacun des enregistrements DNS mentionnés dans les onglets. Suivez les instructions détaillées dans chaque onglet mentionnant une alerte pour configurer les enregistrements DNS :
...
La gestion des adresses e-mail de votre service Zimbra se fait depuis l'onglet <code className="action">Comptes e-mail</code>. Le tableau affiche la liste des comptes e-mail présents sur votre service ainsi que 3 informations pour chacun d'eux :
...
Vous retrouvez également en haut de cette page un lien vers le [Webmail](https://www.ovhcloud.com/fr/mail/) pour pouvoir vous connecter directement au contenu de votre compte e-mail depuis votre navigateur internet.
...
Pour créer un compte e-mail sur votre service Zimbra, cliquez sur l'onglet <code className="action">Comptes e-mail</code> puis sur <code className="action">Créer un compte</code>.
...
Cliquez sur <code className="action">Confirmer</code> pour lancer la création du compte.
...
1. Cliquez sur l'onglet <code className="action">Comptes e-mail</code>.
...
- Connectez-vous au [webmail](https://www.ovhcloud.com/fr/mail/) depuis un navigateur internet et saisissez votre adresse e-mail et votre mot de passe. Pour plus de détails consultez, notre page « [Utiliser le webmail Zimbra](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra) ».
- Configurez un logiciel de messagerie sur votre ordinateur, votre smartphone ou votre tablette. Consultez notre page « [Configurer son adresse e-mail Zimbra sur un logiciel de messagerie](/guides/web-cloud/email-and-collaborative-solutions/zimbra/mail-apps) ».

### Redirections <a name="redirections"></a>

Pour créer une redirection sur une adresse e-mail Zimbra, connectez-vous au [webmail](https://www.ovhcloud.com/fr/mail/).
...
<Tabs>
  <Tab label="Etape 1">
    - Cliquez sur l'onglet <code className="action">Comptes e-mail</code> de votre service Zimbra.
...
- Cliquez sur <code className="action">Enregistrer</code> pour finaliser la mise en place de votre message d'absence.
