...
description: Découvrez comment configurer votre adresse e-mail Zimbra Pro sur Outlook pour Windows via le protocole ActiveSync
...
<Tabs>
  <Tab label="Étape 1">
    ...
    2. Cliquez sur <code className="action">Comptes d'utilisateurs</code>.
    3. Cliquez sur <code className="action">Courrier</code>.
    4. Cliquez sur <code className="action">Comptes de messagerie...</code>.
  ...
  <Tab label="Étape 2">
    - Depuis la fenêtre **Paramètres du compte**, dans l'onglet `Messagerie`, cliquez sur <code className="action">Nouveau...</code>.
  ...
  <Tab label="Étape 4">
    - Sélectionnez <code className="action">Exchange ActiveSync</code>.
    - Cliquez sur <code className="action">Suivant</code> pour continuer.
  ...
  <Tab label="Étape 5">
    ...
    Cliquez sur <code className="action">Suivant</code> pour finaliser l'ajout du compte.
  ...
  <Tab label="Étape 7">
    ...
    Il n'est pas nécessaire de modifier les autres paramètres. Cliquez sur <code className="action">Appliquer</code> pour valider les paramètres et assurez-vous qu'ils soient conformes. Cliquez enfin sur <code className="action">OK</code> pour accéder à Outlook et commencer à utiliser votre adresse e-mail.
...
1. Rendez-vous dans le **panneau de configuration** de Windows.
1. Cliquez sur <code className="action">Comptes d'utilisateurs</code>.
1. Cliquez sur <code className="action">Courrier</code>.
1. Cliquez sur <code className="action">Comptes de messagerie...</code>.
1. Sélectionnez le compte e-mail concerné dans la liste et cliquez sur <code className="action">Modifier...</code>.
...
1. Cliquez sur <code className="action">Courrier</code>.
1. Cliquez sur <code className="action">Comptes de messagerie...</code>.
1. Sélectionnez le compte e-mail concerné dans la liste et cliquez sur <code className="action">Supprimer</code>.
