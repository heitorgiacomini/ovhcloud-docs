...
Nous vous recommandons de vérifier la configuration du nom de domaine paramétré sur votre service Exchange dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, onglet <code className="action">Domaines associés</code>, puis colonne <code className="action">Diagnostic</code> du tableau.
