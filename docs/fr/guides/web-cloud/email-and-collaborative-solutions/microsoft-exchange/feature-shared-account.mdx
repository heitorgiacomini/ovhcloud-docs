...
description: Ajouter et utiliser un compte partagé sur votre offre E-mail Exchange
...
Sélectionnez l’onglet <code className="action">Comptes partagés</code> dans le menu horizontal et cliquez sur <code className="action">Ajouter un compte partagé</code>.
...
Cliquez ensuite sur <code className="action">Suivant</code> pour accéder au récapitulatif. Finalisez l'opération en cliquant sur <code className="action">Valider</code>.
...
Depuis l’onglet <code className="action">Comptes partagés</code> de votre plateforme Exchange, cliquez sur le bouton <code className="action">...</code> devant le compte partagé, puis cliquez sur <code className="action">Configurer les délégations</code>. Vous pourrez alors choisir, dans votre liste de comptes, ceux qui auront la possibilité d'accéder au compte partagé.
...
Cliquez ensuite sur <code className="action">Suivant</code> et <code className="action">Valider</code> pour enregistrer les modifications.
...
Connectez-vous au webmail Exchange (OWA) à l'adresse [Webmail](https://www.ovhcloud.com/fr/mail/) avec un compte e-mail ayant le droit d'accès au compte partagé.
<br/>Dans notre exemple, nous nous connectons avec le compte **guide-exchange@**.

Une fois connecté, dans la colonne de gauche, faites un clic droit sur l'arborescence principale de votre adresse e-mail puis sur <code className="action">Ajouter un dossier partagé</code>.
...
Saisissez ensuite le nom de votre compte partagé, puis cliquez sur <code className="action">Ajouter</code> lorsque celui-ci a été trouvé dans l'annuaire Exchange.
...
[Déléguer des permissions sur un compte Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation)
...
[Ajouter un pied de page pour vos comptes Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/feature-footers)
