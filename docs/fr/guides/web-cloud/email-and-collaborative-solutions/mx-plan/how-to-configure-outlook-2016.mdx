...
:::info
Vous utilisez Outlook pour Mac ? Consultez notre documentation : [Configurer son adresse e-mail sur Outlook pour Mac](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/how-to-configure-outlook-2016-mac).
...
<Tabs>
  ...
  <Tab label="Étape 5">
    ...
    <Region zones={['eu']}>
    - **Serveur** : imap.mail.ovh.net **ou** ssl0.ovh.net
    - Port : **993**
    ...
    <Region zones={['eu']}>
    - **Serveur** : smtp.mail.ovh.net **ou** ssl0.ovh.net
    - Port : **465**
    - Méthode de chiffrement : **SSL/TLS**
    </Region>
...
- **Serveur de courrier entrant** : imap.mail.ovh.net **ou** ssl0.ovh.net
- **Serveur de courrier sortant (SMTP)** : smtp.mail.ovh.net **ou** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Type de compte** : sélectionnez IMAP
- **Serveur de courrier entrant** : imap.mail.ovh.ca
- **Serveur de courrier sortant (SMTP)** : smtp.mail.ovh.ca
</Region>
...
La fenêtre est divisée en deux parties, **Courrier entrant** et **Courrier sortant**. Cliquez sur la partie que vous souhaitez modifier.
    ...
    Retrouvez ce chiffre dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, dans la rubrique <code className="action">Web Cloud</code> puis <code className="action">Email Pro</code>. Le nom du serveur est visible dans le cadre **Connexion** de l'onglet <code className="action">Informations Générales</code>.
