...
<ZoneTabs>
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    ...
    2. Vous pouvez commander un compte Email Pro via l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou directement sur [ovhcloud.com](https://www.ovhcloud.com/fr/mail/).
...
:::info
**Trucs et Astuces** : Si la connexion à votre webmail est impossible, votre mot de passe est peut-être erroné. Vérifiez-le et, si nécessaire, nous vous invitons à le modifier depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> et à renouveler votre connexion.
...
Pour ce faire nous vous mettons à disposition des guides afin d'effectuer la mise en place de votre adresse. Vous pouvez les retrouver sur [la page de nos guides MX Plan](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/landing-page-mx-plan).

<ZoneTabs>
  <Tab label="E-mails et Zimbra Mail" availableIn={['eu']}>
    **Ordinateur Windows**
  ...
  <Tab label="Email Pro" availableIn={['eu']}>
    **Ordinateur Windows**
    ...
    - [Courrier pour Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/windows-10-mailapp-configuration).
    
    **Ordinateur Apple Mac**
    - [Outlook pour macOS](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-macos-configuration).
    - [Mail pour macOS](/guides/web-cloud/email-and-collaborative-solutions/email-pro/macos-mailapp-configuration).
    - [Thunderbird pour macOS](/guides/web-cloud/email-and-collaborative-solutions/email-pro/thunderbird-macos-configuration).
  ...
  <Tab label="Microsoft Exchange" availableIn={['eu', 'ca']}>
    **Ordinateur Windows**
    ...
    - [Thunderbird pour Windows](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/how-to-configure-thunderbird-windows).
