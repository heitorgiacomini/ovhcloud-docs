...
<Tabs>
  <Tab label="Menu supérieur">
    ...
    <img className="thumbnail" alt="Zimbra - menu supérieur" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-02.png" loading="lazy" />
  </Tab>
  <Tab label="Colonne de gauche">
...
Pour créer un dossier, cliquez sur le bouton <code className="action">+ Ajouter un dossier</code> en bas de la colonne.

Vous pouvez également créer un sous-dossier en effectuant un clic droit sur le dossier de votre choix, puis en cliquant sur <code className="action">Créer un sous-dossier</code>.
...
<img className="thumbnail" alt="Zimbra - dossiers" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-06.png" loading="lazy" />

:::info
**Type d'affichage**

L'affichage de vos e-mails se présente sous une forme qui peut être modifiée. Pour cela, cliquez le bouton <code className="action">Afficher</code> situé en haut à droite de cette fenêtre.
:::


Il est possible de trier et d'afficher les e-mails en fonction de certains critères en cliquant sur le filtre en place (par défaut, <code className="action">Date</code>) en haut de la liste des e-mails.

<img className="thumbnail" alt="Zimbra - dossiers" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-06-date.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Recherche avancée">
    ...
    <img className="thumbnail" alt="Zimbra - recherche avancée" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-09.png" loading="lazy" />
  </Tab>
</Tabs>
...
1. **Suppression d'un e-mail** : Lorsque vous affichez un e-mail dans la boite de réception ou l'un des dossiers et que vous cliquez sur <code className="action">supprimer</code>, celui-ci ira par défaut dans la corbeille.
2. **Vider la Corbeille** : Lorsque vous <code className="action">Videz la corbeille</code> ou supprimez un e-mail depuis celle-ci, l'e-mail n'apparaît plus dans la corbeille et rentre dans sa période de rétention de 30 jours.
3. **Accéder à la restauration** : Pour récupérer un e-mail supprimé de la corbeille depuis moins de 30 jours, faites un clic droit sur <code className="action">Corbeille</code>, puis cliquez sur <code className="action">Récupérer le courrier jeté</code>.
4. **Choisir les e-mails à restaurer** : Depuis cette fenêtre vous pouvez observer les e-mails qui ont été vidés de la corbeille. Sélectionnez le ou les e-mails que vous souhaitez restaurer. Cliquez sur <code className="action">Suivant</code>, choisissez le dossier dans lequel vous souhaitez restaurer les e-mails, puis cliquez sur <code className="action">Enregistrer</code>.

<img className="thumbnail" alt="Zimbra - recherche simple" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-restore.png" loading="lazy" />

### Rediger un e-mail <a name="email-writing"></a>

Pour rédiger un nouvel e-mail, cliquez sur le bouton <code className="action">Nouveau Message</code> (1) dans la partie supérieure gauche de votre fenêtre Zimbra.

<img className="thumbnail" alt="Zimbra - rédiger un e-mail" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-10.png" loading="lazy" />
...
<Tabs>
  <Tab label="En-tête">
    ...
    - **À** : le(s) destinataire(s) de votre e-mail. Cliquez sur <code className="action">À</code> pour accéder à votre [carnet de contacts](#contacts) et sélectionner vos destinataires.<br/>
    - **Cc** : cliquez sur <code className="action">Cc/Cci</code> à droite du champ <code className="action">À</code> pour afficher ce champ. La copie carbone est un champ destinataire qui permet d'envoyer votre e-mail en copie à des personnes que vous souhaitez intégrer dans une boucle sans pour autant qu'ils soient considérés comme destinataires directs de l'e-mail (contrairement aux destinataires du champ « **À** »).<br/>
    - **CCi** : cliquez sur <code className="action">Cc/Cci</code> à droite du champ <code className="action">À</code> pour afficher ce champ. La copie carbone invisible est un champ destinataire qui permet de transmettre un e-mail sans que les autres destinataires voient la ou les personnes en « **Cci** ».<br/>
    - **Objet** : titre de l'e-mail, premier élément visible à la réception avant d'ouvrir l'e-mail.<br/>
    - <code className="action">...</code> : situé à droite du champ <code className="action">De</code>, il vous donne accès à 3 options :<br/>
  ...
  <Tab label="Corps de l'e-mail">
    Pour rédiger le corps de votre e-mail, vous disposez d'une barre d'outils HTML dans la partie inférieure de votre fenêtre. Cela vous permettra une rédaction de vos e-mails avec mise en page, directement via votre navigateur. De plus, le bouton <code className="action">&lt; ></code> (tout à droite dans votre barre d'outils) vous ouvre une fenêtre dans laquelle vous pouvez coller un e-mail pré-rédigé depuis un outil externe.
...
Après avoir rédigé votre e-mail, avant de cliquer sur <code className="action">Envoyer</code>, vous pouvez y attacher une pièce jointe en cliquant sur l'icône de trombone situé à côté du bouton <code className="action">Envoyer</code>.

<img className="thumbnail" alt="Zimbra - pièce jointe" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-13.png" loading="lazy" />

:::tip[Success]
**Annuler un envoi**

Si vous avez activé l'option `Annuler l'envoi` dans la rubrique « **Écrire un mail** » des préférences Zimbra, vous pouvez cliquer sur <code className="action">DEFAIRE</code> pour annuler l'envoi.
Ce bouton reste disponible pendant environ 5 secondes.

<img className="thumbnail" alt="Zimbra - annuler un envoi" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-cancel-email.png" loading="lazy" />
:::
...
<img className="thumbnail" alt="Zimbra - préférences" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-14.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Afficher le mail">
    ...
    - **Panneau d'aperçu** : sélectionnez l'une des 3 dispostions pour visualiser vos dossiers et e-mails. Cette option reprend les choix que l'on retrouve sur bouton <code className="action">Afficher</code> lorsqu'on visualise ses e-mails.
...
Pour créer un contact, cliquez sur le bouton <code className="action">Nouveau contact</code> en haut de la colonne de gauche.
...
Cliquez ensuite sur <code className="action">Enregistrer</code>.

<img className="thumbnail" alt="Zimbra - nouveau contact" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-16.png" loading="lazy" />
...
Pour créer un dossier, cliquez sur le bouton <code className="action">+ Ajouter un dossier</code> en bas de la colonne de gauche.

Vous pouvez également créer un sous-dossier en effectuant un clic droit sur le dossier de votre choix, puis en cliquant sur <code className="action">Créer un sous-dossier</code>. Les dossiers « Contacts par e-mail » et « Corbeille » ne permettent pas la création de sous-dossiers.

Pour déplacer un contact dans un des dossiers, sélectionnez le contact dans la colonne du milieu puis, dans la fenêtre du contact qui apparaît à droite, cliquez sur le bouton <code className="action">Déplacer</code>. Sélectionnez alors le dossier que vous souhaitez attribuer au contact.

<img className="thumbnail" alt="Zimbra - dossiers de contacts" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-17.png" loading="lazy" />
...
Pour affecter un contact à l'une de vos listes, sélectionnez le contact dans la colonne du milieu puis, dans la fenêtre qui apparaît à droite, cliquez sur <code className="action">Affecter à des listes</code>. Cochez la ou les listes que vous souhaitez attribuer au contact. Vous pouvez également saisir le nom d'une nouvelle liste et cliquer sur <code className="action">Ajouter</code>.
...
<Tabs>
  <Tab label="Importer les Contacts">
    ...
    Cliquez ensuite sur <code className="action">Importer</code> pour ouvrir la fenêtre d'importation. Le bouton `Browse...` vous permet d'aller récupérer le fichier contenant vos contacts au format « .csv » ou « .vcf ». <br/><br/>
  ...
  <Tab label="Exporter les Contacts">
    ...
    Cliquez ensuite sur <code className="action">Exporter</code> pour ouvrir la fenêtre d'exportation. Choisissez le type de fichier que vous souhaitez exporter puis cliquez sur <code className="action">Exporter maintenant</code>.<br/><br/>
...
- **(1)** : Pour créer un calendrier, passez votre curseur sur `Mes agendas` dans la colonne de gauche et cliquez sur le bouton `+`. Saisissez un nom et définissez une couleur, puis cliquez sur <code className="action">Enregistrer</code>

Il est également possible de créer des sous-calendriers.

- **(2)** : Pour créer un sous-calendrier, passez votre curseur sur le calendrier pour lequel vous souhaitez en créer un, puis faites un clic droit pour afficher le menu déroulant. Cliquez sur `Ajouter un sous-calendrier`. Saisissez un nom et définissez une couleur, puis cliquez sur <code className="action">Enregistrer</code>
...
- **(1)** : Cliquez sur <code className="action">Nouvel évènement</code> dans le coin supérieur gauche.
- **(2)** : Cliquez sur la plage horaire de votre calendrier dans laquelle vous souhaitez ajouter un événement. Pour un ajout simplifié, il vous suffit de définir un titre pour l'évènement et un lieu puis de cliquer sur <code className="action">Enregistrer</code>. Pour ajouter plus de détails sur votre évènement, cliquez sur <code className="action">Ajouter d'autres détails</code>
...
- **Équipement** : en cliquant sur <code className="action">Afficher l'équipement</code>, vous faites apparaître cette ligne pour définir un équipement partagé que vous allez utiliser pour votre évènement.
...
Une fois votre évènement défini, cliquez sur <code className="action">Enregistrer</code>.
...
- **(1)** : Pour créer une tâche, cliquez sur le bouton <code className="action">...</code> puis sur <code className="action">Nouvelle tâche</code> ou simplement sur le bouton <code className="action">+</code> à côté de votre liste de tâches.

- **(2)** : Pour créer une nouvelle liste de tâches, cliquez sur le bouton <code className="action">...</code> puis sur <code className="action">Créer une liste</code>.
...
Cliquez ensuite sur <code className="action">Enregistrer</code> pour finaliser la création de votre tâche.
...
Cliquez sur l'icône <code className="action">Mallette</code> située dans la barre supérieure pour accéder à votre espace de stockage. Vous pourrez y déposer vos fichiers et les partager.

1. Dans la colonne de gauche, vous retrouvez les dossiers de votre espace de stockage.

    - Pour créer un nouveau dossier, cliquez sur <code className="action">+ Ajouter un dossier</code> en bas de la colonne. Renseignez le nom souhaité puis validez en appuyant sur la touche <code className="action">Entrée</code>.
    - Pour créer un sous-dossier, faites un clic droit sur l'un des dossiers, puis cliquez sur <code className="action">Créer un sous-dossier</code>. Renseignez le nom souhaité puis validez en appuyant sur la touche <code className="action">Entrée</code>.
...
1. Cliquez sur <code className="action">Télécharger</code> (Upload) dans la colonne de gauche.
2. Depuis la fenêtre d'exploration de fichiers, sélectionnez le ou les fichiers à téléverser sur votre espace de stockage.
3. Cliquez sur <code className="action">Ouvrir</code> pour téléverser le ou les éléments sur votre espace de stockage.
...
<Tabs>
  <Tab label="Partager un fichier">
    1. Sélectionnez le fichier à partager et cliquez sur <code className="action">Suite...</code>.
    2. Cliquez sur <code className="action">Partager...</code>.
    3. Saisissez l'adresse e-mail de l'invité, puis cliquez sur <code className="action">Ajouter</code>. Vous pouvez ajouter plusieurs adresses e-mail.
    4. Choisissez les droits que vous souhaitez attribuer à l'invité.
    5. Cliquez sur <code className="action">Enregistrer</code> pour finaliser le partage.
  ...
  <Tab label="Partager un dossier">
    1. Faites un clic droit sur le dossier à partager, puis cliquez sur <code className="action">Partager...</code>.
    2. Saisissez l'adresse e-mail de l'invité, puis cliquez sur <code className="action">Ajouter</code>. Vous pouvez ajouter plusieurs adresses e-mail.
    3. Choisissez les droits que vous souhaitez attribuer à l'invité.
    4. Cliquez sur <code className="action">Enregistrer</code> pour finaliser le partage.
...
- Cliquez sur l'icône <code className="action">Mallette</code> située dans la barre supérieure pour accéder à votre espace de stockage.
- Sélectionnez le fichier que vous souhaitez éditer.
- Dans la barre supérieure, cliquez sur <code className="action">Éditer</code>.
...
Pour accèder à la création de filtres, cliquez sur la roue crantée en haut à droite de votre interface Zimbra puis sur <code className="action">Paramètres</code> et enfin sur <code className="action">Filtres</code> dans la colonne de gauche.

<img className="thumbnail" alt="Zimbra - créer un filtre" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-21.png" loading="lazy" />

Si des filtres existent, vous retrouverez la liste selon leur ordre d'application :

- **(1)** Vous pouvez afficher un aperçu de chaque filtre en cliquant sur le bouton <code className="action">...</code> à droite du filtre puis sur <code className="action">Détails</code>. Le bouton <code className="action">Appliquer</code> permet de lancer l'action paramétrée pour ce filtre.
...
Cliquez sur le bouton <code className="action">+ Ajouter un filtre</code> pour lancer sa création. La fenêtre du mode simple s'affiche par défaut. Vous pouvez passer en mode avancé en cliquant sur <code className="action">Passer à avancé</code> pour disposer de tous les opérateurs de comparaison. N'hésitez pas à vous aider de la section « [Comprendre comment paramétrer ses filtres](#filters-howto) ».

<Tabs>
  <Tab label="Mode simple">
    <img className="thumbnail" alt="Zimbra - filtres - mode simple" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-22.png" loading="lazy" />
  </Tab>
  <Tab label="Mode avancé">
    <img className="thumbnail" alt="Zimbra - filtres - mode avancé" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/email-zimbra/zimbra-23.png" loading="lazy" />
  </Tab>
</Tabs>
...
- Cliquez sur le bouton <code className="action">⚙</code> en haut à droite de votre fenêtre de webmail.
- Cliquez sur <code className="action">Paramètres</code>.
- Cliquez sur la section <code className="action">Filtres</code> depuis la fenêtre des paramètres.
- Cliquez sur le bouton <code className="action">Ajouter un filtre</code>.
    ...
    - Sur la ligne suivante, choisissez <code className="action">À</code> (To), laissez <code className="action">contient</code> (contains), puis saisissez l'adresse e-mail sur laquelle vous êtes connecté dans le champ juste à droite.
    ...
    - Cliquez sur <code className="action">+ Ajouter une action</code> (Add an action) plus bas, puis sélectionnez `Garder dans le dossier de réception` (Keep in Inbox).
...
Pour accéder au paramètre de délégation, cliquez sur la roue crantée en haut à droite de votre interface Zimbra puis sur <code className="action">Paramètres</code> et enfin sur <code className="action">Ecrire un mail</code> dans la colonne de gauche.
...
**(1) Délégués**. Pour déléguer votre compte e-mail à un autre compte, cliquez sur <code className="action">Ajouter des délégués</code>.
...
Cliquez sur la roue crantée en haut à droite de votre interface Zimbra puis sur <code className="action">Paramètres</code> et enfin sur <code className="action">Signatures</code> dans la colonne de gauche.
...
Pour accéder à la gestion de votre répondeur, cliquez sur la roue crantée en haut à droite de votre interface, puis sur <code className="action">Paramètres</code> et enfin sur <code className="action">Absent du bureau</code>.
...
- Le bouton <code className="action">M'envoyer une copie du message en absence</code> vous envoie un aperçu de cette réponse automatique dans votre boite de réception.
