...
description: Découvrez dans ce guide comment utiliser les listes de diffusion.
...
- Disposer d'une offre e-mail MX Plan 100 minimum ou d'un [Hébergement Web](https://www.ovhcloud.com/fr/web-hosting/) éligible aux listes de diffusion.
...
Afin de créer votre mailing list, dirigez-vous sur l'onglet <code className="action">mailing lists</code> de votre service e-mail.
...
Pour créer une nouvelle mailing list, cliquez sur <code className="action">Ajouter une mailing list</code>.
...
Pour modifier les options de la mailing list, cliquez sur <code className="action">...</code> à droite de celle-ci. Vous pourrez alors mettre à jour les options, supprimer la mailing list ou encore partager la liste de ses abonnés par e-mail.
...
|---|---|
|Cliquez sur <code className="action">Ajouter des abonnés</code> à droite.|Cliquez sur <code className="action">Supprimer via un fichier</code> à droite.|
...
- la saisie manuelle d'adresses en cliquant sur <code className="action">Ajouter une adresse email</code>.
...
Cliquez sur <code className="action">exporter les abonnés en CSV</code> afin de générer un fichier CSV contenant l'ensemble de vos abonnés. Cette option n'est pas disponible dans notre cas car aucun abonné n'a été ajouté.
...
|---|---|
|Cliquez sur <code className="action">Ajouter des modérateurs</code> à droite.|Cliquez sur <code className="action">Supprimer via un fichier</code> à droite.|
