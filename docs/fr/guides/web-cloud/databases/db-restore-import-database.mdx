...
Pour importer votre base de données directement depuis phpMyAdmin, connectez-vous au préalable en vous aidant du paragraphe « [Se connecter à une base de données MySQL ou MariaDB](/guides/web-cloud/databases/db-connecting-database-server#se-connecter-a-une-base-de-donnees-mysql-ou-mariadb) ».
