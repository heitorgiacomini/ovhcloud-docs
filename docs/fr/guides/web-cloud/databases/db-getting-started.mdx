...
Si vous avez besoin de modifier les droits d'un utilisateur existant, consultez notre guide « [Web Cloud Databases - Modifier les droits d'un utilisateur](/guides/web-cloud/databases/db-modify-users-rights) ».
...
Pour importer une base de données, consultez notre guide « [Restaurer et importer une base de données sur votre serveur de bases de données](/guides/web-cloud/databases/db-restore-import-database) ».
...
Pour cela, consultez les cas particuliers de notre guide « [Web Cloud Databases - Comment autoriser une adresse IP ?](/guides/web-cloud/databases/db-authorise-ip-mask) » pour activer / désactiver l'accès des hébergements web OVHcloud à votre base de données Web Cloud Databases.
...
Pour accéder aux logs de votre solution Web Cloud Databases, consultez notre guide « [Web Cloud Databases - Comment récupérer les logs ?](/guides/web-cloud/databases/db-retrieve-logs) ».

## Aller plus loin

[Créer vos bases de données et vos utilisateurs sur votre serveur de bases de données](/guides/web-cloud/databases/db-create-databases-users)

[Se connecter à la base de données de votre serveur de bases de données](/guides/web-cloud/databases/db-connecting-database-server)
