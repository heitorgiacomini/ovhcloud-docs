...
Pour vérifier cela, récupérez l'adresse IP publique de votre point d'accès à Internet puis consultez la section **Autoriser une adresse IP** de [ce guide](/guides/web-cloud/databases/db-getting-started).
...
Si besoin, consultez nos guides « [Introduction à Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction) » (EN) et « [Démarrer rapidement avec Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start) » (EN).
  </Tab>
  <Tab label="Étape 5">
...
[Premiers pas avec votre Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)
