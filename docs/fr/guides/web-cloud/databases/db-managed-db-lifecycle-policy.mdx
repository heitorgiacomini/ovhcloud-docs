...
- Les services Web Cloud Databases, instances SGBD dédiées joignables via le réseau public ou via le réseau Web Hosting ([voir les annonces](/guides/web-cloud/databases/db-eos-eol)).

- Les services SharedSQL Web Hosting, bases de données MySQL joignables via le réseau Web Hosting ([voir les annonces](/guides/web-cloud/web-hosting/sql-eos-eol)).
