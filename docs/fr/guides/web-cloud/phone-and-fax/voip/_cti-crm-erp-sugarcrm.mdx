...
Pour créer un token nous allons utiliser la console API (il est possible de créer un token directement en API sans passer par la console). Rendez-vous sur la page des [API](/links/api), connectez-vous et utilisez le call API suivant :

<Api version="v1" section="/telephony" method="POST" route={"/telephony/\\{billingAccount\\}/service/\\{serviceName\\}/eventToken"} />

![Connectez vous avec votre compte client.](/images/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm/img_2582.jpg)
...
![appel API POST](/images/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm/img_2581.jpg)
...
![Ouvrez la page index.html et indiquez votre token.](/images/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm/img_2583.jpg)

Sur la page `Vue d'ensemble` vous retrouvez tous les événements qui se sont produits depuis l'ouverture de la page.

![CTI OVHcloud](/images/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm/img_2584.png)

Rendez-vous dans la partie `Configuration` puis `Appel du CGI`.
...
![URL](/images/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm/img_2585.jpg)
...
![test couplage](/images/guides/web-cloud/phone-and-fax/voip/cti-crm-erp-sugarcrm/img_2586.png)
