...
L'ensemble des e-mails envoyés par OVHcloud sont accessibles depuis votre espace client. Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur votre nom en haut à droite, puis sur <code className="action">Mes communications</code>.
...
Le répondeur de votre ligne téléphonique est également consultable depuis votre espace client OVHcloud. <ManagerLink to="/#/telecom/telephony">Accédez à la section VoIP & Fax</ManagerLink> et choisissez le groupe de facturation contenant votre ligne. Dans l'onglet <code className="action">Services</code>, sélectionnez la ligne souhaitée puis cliquez sur <code className="action">Répondeur</code>.
...
Pour plus de détails, consultez le guide « [Déployer automatiquement l'IPBX 3CX sur l'offre Public Cloud OVHcloud](/guides/web-cloud/phone-and-fax/voip/3cx-public-cloud-automatic-deployment) ».
