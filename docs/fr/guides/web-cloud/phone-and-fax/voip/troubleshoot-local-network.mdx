...
description: Découvrez comment effectuer des vérifications basiques sur votre réseau local pour favoriser le fonctionnement de la téléphonie VoIP OVHcloud
...
<img className="thumbnail" alt="port sur téléphone" src="/images/web-cloud/phone-and-fax/voip/troubleshoot-01-local-network/phone-port.png" loading="lazy" />
...
<img className="thumbnail" alt="port sur routeur" src="/images/web-cloud/phone-and-fax/voip/troubleshoot-01-local-network/router-port.png" loading="lazy" />
...
- [Rétablir son service suite à une coupure complète ou partielle](/guides/web-cloud/internet/internet-access/interruption-de-service)
- [Rétablir la synchronisation d’une connexion suite à une coupure](/guides/web-cloud/internet/internet-access/reestablish-synchronization)
- [Résoudre une interruption ou des lenteurs de navigation](/guides/web-cloud/internet/internet-access/resoudre-interruption-lenteurs-navigation)
- [Redémarrer ou réinitialiser une box OVHcloud](/guides/web-cloud/internet/internet-access/restart-reboot-modem)
...
Suivez les instructions de [ce guide](/guides/web-cloud/phone-and-fax/voip/troubleshoot-fix-control-panel) pour effectuer ce dépannage.
