...
- cliquez sur le bouton `Messagerie` dans la barre inférieure du logiciel. Cette méthode ne fonctionne que si vous avez correctement renseigné le numéro `123` dans les paramètres du logiciel (plus d'informations sur [ce guide](/guides/web-cloud/phone-and-fax/voip/popc-setting-up#configuration-dans-le-logiciel)).
...
Vous pourrez alors rétablir les paramètres nécessaires à la configuration de votre ligne SIP OVHcloud en vous aidant de notre guide pour [installer le logiciel POPC](/guides/web-cloud/phone-and-fax/voip/popc-setting-up#configuration-dans-le-logiciel).
