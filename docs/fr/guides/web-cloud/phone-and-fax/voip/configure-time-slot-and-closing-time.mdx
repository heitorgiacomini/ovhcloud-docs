...
description: Découvrez comment configurer des plages horaires et des fermetures exceptionnelles sur votre ligne OVHcloud
...
Dans l'onglet <code className="action">Gestion des appels</code>, cliquez sur <code className="action">Gérer les plages horaires</code>.

<img className="thumbnail" alt="gerer-plages-horaires" src="/images/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step1.png" loading="lazy" />
...
<img className="thumbnail" alt="gerer-plages-horaires" src="/images/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step2.png" loading="lazy" />

#### Étape 2 : configurer les redirections

:::tip
Pour configurer et personnaliser le répondeur d'une ligne, consultez le guide « [Configurer et consulter le répondeur de sa ligne](/guides/web-cloud/phone-and-fax/voip/configurer-consulter-repondeur-ligne-ovh) »
...
<img className="thumbnail" alt="gerer-plages-horaires" src="/images/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step4.png" loading="lazy" />

Dès que toutes vos plages horaires sont configurées, cliquez sur le bouton <code className="action">Valider</code> pour sauvegarder ces changements. Vous avez aussi la possibilité de cliquer sur <code className="action">Appliquer à plusieurs numéros</code> pour dupliquer les paramètres sur d’autres files d’appels.

#### Étape 4 : activer l'utilisation des plages horaires

Il ne reste plus qu’à activer les plages horaires. Dans la partie `Configuration générale` de la page, cliquez sur <code className="action">Oui</code> puis sur <code className="action">Valider</code>.
...
<img className="thumbnail" alt="gerer-plages-horaires" src="/images/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-time-slot-step5.png" loading="lazy" />
...
:::info
Les fermetures exceptionnelles complètent [vos plages horaires paramétrées](/guides/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time#gerer-les-plages-horaires). Il est donc indispensable que ces dernières soient activées pour que les fermetures exceptionnelles s'appliquent.

:::


Dans l'onglet <code className="action">Gestion des appels</code>, cliquez sur <code className="action">Gérer les fermetures exceptionnelles</code>.

<img className="thumbnail" alt="gerer-fermetures-exceptionnelles" src="/images/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-closing-time-step1.png" loading="lazy" />
...
Une fois les informations renseignées, cliquez sur <code className="action">Créer l'événement</code>. Répétez cette manipulation afin d'ajouter toutes les fermetures exceptionnelles que vous souhaitez créer. Puis cliquez sur le bouton <code className="action">Valider</code> pour sauvegarder ces changements.
 
Enfin, dans la partie `Paramètres` de la page, assurez-vous que le « **fuseau horaire** » paramétré est correct et que les plages horaires sont activées. Si vous effectuez un changement, cliquez sur le bouton <code className="action">Valider</code> pour le sauvegarder.

<img className="thumbnail" alt="gerer-fermetures-exceptionnelles" src="/images/web-cloud/phone-and-fax/voip/configure-time-slot-and-closing-time/manage-closing-time-step2.png" loading="lazy" />
