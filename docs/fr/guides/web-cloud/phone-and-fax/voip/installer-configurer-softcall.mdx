...
Cliquez sur l'onglet <code className="action">Services</code>, sélectionnez la ligne SIP utilisée par votre application Softcall puis cliquez sur l'onglet <code className="action">Softphone</code>.

#### Appliquer un thème

Vous pouvez définir un thème de couleur à appliquer à votre interface Softcall.

Dirigez-vous sur la section <code className="action">Appliquer un thème</code>.

Sélectionnez la couleur de votre choix puis cliquez sur le bouton <code className="action">Appliquer un thème</code> pour valider. Redémarrez votre application Softcall pour activer le changement de thème.
