...
description: Apprenez à gérer et utiliser les appels simultanés avec une ligne téléphonique OVHcloud
...
Dans l'onglet <code className="action">Gestion des appels</code>, cliquez sur <code className="action">Appels simultanés</code>.

<img className="thumbnail" alt="appels-simultanes" src="/images/web-cloud/phone-and-fax/voip/gerer-utiliser-appels-simultanes/simultaneous-call-step1.png" loading="lazy" />
...
<img className="thumbnail" alt="appels-simultanes" src="/images/web-cloud/phone-and-fax/voip/gerer-utiliser-appels-simultanes/simultaneous-call-step2.png" loading="lazy" />
