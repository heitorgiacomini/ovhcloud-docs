...
description: "Découvrez comment valider votre identité depuis l'espace client OVHcloud afin d'exploiter un numéro spécial SVA"
...
<img className="thumbnail" alt="vérifier l'identité" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-identite.png" loading="lazy" />
...
<img className="thumbnail" alt="renseigner coordonnées" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-coordonnees02.png" loading="lazy" />

<img className="thumbnail" alt="renseigner coordonnées" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-coordonnees03.png" loading="lazy" />

### Ajouter des bénéficiaires

Si vous êtes le seul bénéficiaire, cochez la case « Mon représentant est bénéficiaire ».

<img className="thumbnail" alt="représentant bénéficiaire" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-beneficiaire01.png" loading="lazy" />

Dans le cas contraire, cliquez sur <code className="action">+ Ajouter un bénéficiaire</code> et renseignez les coordonnées du bénéficiaire.

<img className="thumbnail" alt="ajout bénéficiaires" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-beneficiaire02.png" loading="lazy" />
...
Cliquez sur <code className="action">Étape suivante</code>.

Dans la fenêtre qui s'affiche alors, prenez connaissance des informations puis saisissez `CONFIRMER` dans le champ prévu à cet effet et cliquez sur <code className="action">Valider mes informations</code>.

<img className="thumbnail" alt="confirmation" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-confirmer.png" loading="lazy" />
...
<img className="thumbnail" alt="confirmation" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-lemonway01.png" loading="lazy" />

Cliquez sur <code className="action">C'est parti</code> pour fournir vos documents.

<img className="thumbnail" alt="confirmation" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-lemonway02.png" loading="lazy" />

:::info
Si vous ne pouvez pas fournir tous vos documents en une fois, cliquez sur <code className="action">Enregistrer et finir plus tard</code>.

Pour accéder par la suite à la plateforme Lemonway : depuis le <code className="action">Tableau de bord</code> du groupe de facturation VoIP, cliquez sur <code className="action">Voir mon profil SVA</code>.
...
Dans le <code className="action">Tableau de bord</code> de votre groupe de téléphonie, vérifiez le statut de votre **Profil SVA** :

- **Valide** : vos documents sont validés. Vous pouvez accéder à vos informations et les modifier si nécessaire en cliquant sur <code className="action">Voir mon profil SVA</code>.

    <img className="thumbnail" alt="vérification SVA" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-statut-valide.png" loading="lazy" />

- **En attente de validation** : vos documents ne sont pas encore intégralement fournis ou validés. Cliquez sur <code className="action">Voir mon profil SVA</code> pour accéder à la plateforme Lemonway et vérifier le statut de vos documents.

    <img className="thumbnail" alt="vérification SVA" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-statut-en-attente-de-validation.png" loading="lazy" />

- **Incomplet** : un ou plusieurs documents fournis ne sont pas conformes. Cliquez sur <code className="action">Finaliser mon formulaire de validation d'identité</code> ou sur <code className="action">Voir mon profil SVA</code> pour accéder à la plateforme Lemonway et vérifier le statut de vos documents.

    <img className="thumbnail" alt="vérification SVA" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-acces-lemonway.png" loading="lazy" />

    <img className="thumbnail" alt="vérification SVA" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-statut-incomplet.png" loading="lazy" />

Sur les exemples ci-dessous, le document 1 est validé et le document 2 est refusé :

<img className="thumbnail" alt="vérification SVA" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-doc-valide.png" loading="lazy" />

<img className="thumbnail" alt="vérification SVA" src="/images/web-cloud/phone-and-fax/voip/verification-identite-numeros-sva/sva-doc-refus.png" loading="lazy" />
