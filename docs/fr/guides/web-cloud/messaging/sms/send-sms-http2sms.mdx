...
description: "Découvrez comment envoyer des SMS via des requêtes HTTP en utilisant Wget directement depuis la barre d'adresses de votre navigateur"
...
- Avoir créé un utilisateur SMS via l'espace client OVHcloud ou directement via les API. À cet effet, vous pouvez consulter le guide suivant : [Tout savoir sur les utilisateurs SMS](/guides/web-cloud/messaging/sms/sms-users)
- Disposer d'un compte SMS OVHcloud avec des crédits SMS
- Disposer d'un expéditeur SMS actif. Pour en savoir plus à ce sujet, vous pouvez consulter ce [guide](/guides/web-cloud/messaging/sms/send-sms-control-panel#etape-3-choisir-votre-expediteur-sms)

## En pratique

L'envoi d'un SMS se fait via une requête HTTPS avec ses champs obligatoires (et facultatifs, le cas échéant) à l'adresse suivante : [https://www.ovh.com/cgi-bin/sms/http2sms.cgi?](https://www.ovh.com/cgi-bin/sms/http2sms.cgi?).

<img className="thumbnail" alt="http2sms" src="/images/web-cloud/messaging/sms/send-sms-http2sms/img_4011.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Liste des caractères SMS" src="/images/web-cloud/messaging/sms/send-sms-http2sms/smsauthorizedcharacters.png" loading="lazy" />
