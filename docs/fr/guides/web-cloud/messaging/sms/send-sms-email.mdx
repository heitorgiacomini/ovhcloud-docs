...
description: Découvrez comment configurer et envoyer des SMS directement depuis votre adresse e-mail grâce à la passerelle email2sms OVHcloud
...
Vous pouvez consulter le guide suivant pour toute précision sur les utilisateurs SMS : [Tout savoir sur les utilisateurs SMS](/guides/web-cloud/messaging/sms/sms-users)
...
<img className="thumbnail" alt="Liste des caractères SMS" src="/images/web-cloud/messaging/sms/send-sms-email/smsauthorizedcharacters.png" loading="lazy" />
