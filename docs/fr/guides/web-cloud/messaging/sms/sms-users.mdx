...
description: "Découvrez comment créer, configurer et gérer les utilisateurs API pour l'envoi de SMS, y compris les permissions et restrictions"
...
Cliquez sur l'onglet <code className="action">Utilisateurs API</code>. Pour ajouter un utilisateur, cliquez sur le bouton <code className="action">Actions</code> puis sur <code className="action">Ajouter</code>.
...
La gestion du quota s'effectue depuis l'onglet <code className="action">Utilisateurs API</code>. En face de l'utilisateur choisi, cliquez sur les <code className="action">...</code> puis sur <code className="action">Quota</code>.
...
La configuration d'une limite pour un utilisateur s'effectue depuis le même menu, en cliquant sur les <code className="action">...</code> puis sur <code className="action">Limite</code>.
...
Pour l'activer, cliquez sur les <code className="action">...</code> à droite de l'utilisateur puis sur <code className="action">Restrictions</code>.
...
Pour plus d'informations sur la fonction http2sms, consultez le guide [Envoyer des SMS depuis une URL](/guides/web-cloud/messaging/sms/send-sms-http2sms).

### Étape 5 : Spécifier une URL de Callback

Pour un suivi personnalisé des accusés de réception SMS (Delivery reporting ou DLR), vous pouvez spécifier une URL dite de Callback en cliquant sur les <code className="action">...</code> à droite de l'utilisateur puis sur <code className="action">Callback</code>.
...
Pour plus d'informations sur l'utilisation des API OVHcloud, consultez notre guide [Premiers pas avec les API OVHcloud](/guides/manage-and-operate/api/first-steps).
