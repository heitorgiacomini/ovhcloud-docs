...
description: Découvrez comment configurer un environnement de développement PHP et envoyer votre premier SMS avec l’API RESTful OVHcloud pas à pas
...
<img className="thumbnail" alt="votre projet avec Composer" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2450.jpg" loading="lazy" />
...
<img className="thumbnail" alt="création des tokens" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2451.jpg" loading="lazy" />
...
<img className="thumbnail" alt="récupération des tokens" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2452.jpg" loading="lazy" />
