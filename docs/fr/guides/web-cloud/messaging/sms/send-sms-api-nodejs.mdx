...
description: Découvrez comment configurer un environnement Node.js et envoyer votre premier SMS pas à pas avec le wrapper de l’API RESTful OVHcloud
...
<img className="thumbnail" alt="création des tokens" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2462.jpg" loading="lazy" />
...
<img className="thumbnail" alt="récupération des tokens" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2463.jpg" loading="lazy" />
