...
description: Découvrez comment envoyer des SMS avec réponse depuis votre espace client OVHcloud et gérer les options de réception des réponses
...
<img className="thumbnail" alt="fonctionnement sms avec réponse" src="/images/web-cloud/messaging/sms/sms-with-reply/SMSreponse.png" loading="lazy" />
...
Dans la barre d'onglets, cliquez sur <code className="action">Options</code> puis sur <code className="action">Options des réponses</code>.

<img className="thumbnail" alt="options SMS réponse" src="/images/web-cloud/messaging/sms/sms-with-reply/SMSreponse-options.png" loading="lazy" />
...
Une fois votre option configurée, cliquez sur le bouton <code className="action">Valider</code>.
...
Dans l'espace client, sélectionnez l'onglet <code className="action">Accueil</code> de votre compte SMS. Cliquez ensuite sur <code className="action">Envoyer un SMS</code>.

<img className="thumbnail" alt="envoi SMS" src="/images/web-cloud/messaging/sms/sms-with-reply/SMSreponse-envoi.png" loading="lazy" />

Assurez-vous que votre expéditeur est bien le `Numéro permettant la réponse (France uniquement)`.

<img className="thumbnail" alt="envoi SMS" src="/images/web-cloud/messaging/sms/sms-with-reply/SMSreponse-expediteur.png" loading="lazy" />
...
Dans l'espace client, cliquez sur l'onglet <code className="action">Message et campagne</code> de votre compte SMS. Cliquez ensuite sur <code className="action">SMS reçus</code>.

<img className="thumbnail" alt="SMS reçus" src="/images/web-cloud/messaging/sms/sms-with-reply/SMSreponse-recus.png" loading="lazy" />
