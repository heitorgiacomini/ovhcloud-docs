...
Afin que la configuration du bloc IP puisse s'effectuer en local sur votre box OVHcloud, il est impératif de désactiver la prise en main à distance de celle-ci. Pour cela, toujours depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink> sur l'accès à Internet concerné, positionnez-vous sur l'onglet <code className="action">Mon modem</code>.
