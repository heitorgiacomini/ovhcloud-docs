...
Pour connaître le nombre d'emplacements libres restants, depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, sélectionnez le *Pack* contenant l'accès à Internet concerné.
...
Pour cela, depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, sélectionnez le *Pack* contenant l'accès à Internet concerné, puis cliquez sur <code className="action">Activer un service</code> dans le cadre « Téléphonie ».
...
Veuillez consulter [nos guides Fax](/guides/web-cloud/phone-and-fax/voip/faq-voip) afin d'avoir plus de détails sur l'utilisation de ce service.
