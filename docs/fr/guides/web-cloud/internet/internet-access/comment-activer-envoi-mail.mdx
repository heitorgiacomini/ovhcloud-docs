...
description: "Découvrez comment activer ou désactiver l'envoi d'e-mails depuis votre connexion OVHcloud via l'espace client"
...
<img className="thumbnail" alt="Mail Sending status" src="/images/web-cloud/internet/internet-access/comment-activer-envoi-mail/MailSending-Status.png" loading="lazy" />
...
<img className="thumbnail" alt="Mail Sending status" src="/images/web-cloud/internet/internet-access/comment-activer-envoi-mail/MailSending-Disable.png" loading="lazy" />
