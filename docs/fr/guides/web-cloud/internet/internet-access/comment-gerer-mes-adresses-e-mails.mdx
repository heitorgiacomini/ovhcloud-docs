...
Pour démarrer la manipulation, depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, sélectionnez le *Pack* contenant l'accès à Internet concerné, puis cliquez sur <code className="action">Activer un service</code> dans la rubrique « Téléphonie ».
