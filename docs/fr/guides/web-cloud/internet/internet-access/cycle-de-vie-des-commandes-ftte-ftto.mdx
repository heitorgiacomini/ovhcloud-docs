...
description: Découvrez comment se déroule le parcours complet des commandes FTTE et FTTO, de la commande à la livraison
...
- Avoir commandé un accès [FTTE ou FTTO](https://www.ovhcloud.com/fr/internet/) chez OVHcloud.
...
<img className="thumbnail" alt="parcours client" src="/images/web-cloud/internet/internet-access/cycle-de-vie-des-commandes-ftte-ftto/commandes-ftte-et-ftto.png" loading="lazy" />
