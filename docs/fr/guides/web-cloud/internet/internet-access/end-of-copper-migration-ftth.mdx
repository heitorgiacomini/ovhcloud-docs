...
description: Découvrez comment migrer votre connexion xDSL vers la fibre optique en raison de la fermeture progressive du réseau cuivre
...
Depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, accédez à l'onglet <code className="action">Télécom</code>.
...
<img className="thumbnail" alt="informations fermeture cuivre" src="/images/web-cloud/internet/internet-access/end-of-copper-migration-ftth/info-fermeture-cuivre.png" loading="lazy" />
...
Cliquez sur le bouton <code className="action">Migrer vers la fibre</code>.
...
Sélectionnez les options souhaitées (lignes téléphoniques, comptes e-mail, Garantie de Temps de Rétablissement) puis cliquez sur le bouton <code className="action">Choisir cette offre</code> sous la colonne correspondant à l'offre `Fibre Pro`.
...
<img className="thumbnail" alt="changement offre fibre" src="/images/web-cloud/internet/internet-access/end-of-copper-migration-ftth/changement-offre-fibre.png" loading="lazy" />

Renseignez les informations relatives à votre habitation, répondez à la question concernant votre boîtier fibre PTO (Point de Terminaison Optique) et cliquez sur <code className="action">Confirmer la sélection</code>.

<img className="thumbnail" alt="conservation des services" src="/images/web-cloud/internet/internet-access/end-of-copper-migration-ftth/services2023.png" loading="lazy" />

Cochez les cases correspondant aux services à conserver puis cliquez sur <code className="action">Confirmer la sélection des services</code>.

À l'étape suivante, sélectionnez les informations du rendez-vous et cliquez sur <code className="action">Confirmer la sélection</code>.
...
<Tabs>
  <Tab label="Étape 1">
    **Récupérez les informations techniques sur arcep.fr :**
    ...
    Accédez au [site officiel de l'ARCEP](https://cartefibre.arcep.fr/) et cliquez sur l'onglet <code className="action">Déploiements fibre</code> en haut à droite afin d'afficher la carte des déploiements de la fibre en France.
...
Cliquez ensuite sur le point vert correspondant à votre bâtiment afin d'afficher ses informations.
    ...
    <img className="thumbnail" alt="ARCEP - Déploiements fibre" src="/images/web-cloud/internet/internet-access/end-of-copper-migration-ftth/arcep03.png" loading="lazy" style={{ maxWidth: '600px' }} />
  ...
  <Tab label="Étape 2">
    **Vérifiez les informations sur l'outil d'éligibilité OVHcloud :**
    ...
    Cliquez sur l'onglet <code className="action">Par référence d'immeuble</code> et renseignez l'**Identifiant immeuble IPE** préalablement noté sur le site de l'ARCEP. Cliquez alors sur <code className="action">Vérifier mon éligibilité</code>.
    
    <img className="thumbnail" alt="Eligibilité Fibre OVHcloud" src="/images/web-cloud/internet/internet-access/end-of-copper-migration-ftth/eligibilite.png" loading="lazy" style={{ maxWidth: '600px' }} />
...
Vérifiez que l'adresse obtenue correspond bien à celle que vous avez notée sur le site de l'ARCEP.
  ...
  <Tab label="Étape 3">
    **Effectuez un déménagement de votre accès à Internet :**
    ...
    Depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, effectuez une demande de déménagement de votre accès en suivant notre guide « [Comment déménager mon accès xDSL/Fibre](/guides/web-cloud/internet/internet-access/comment-demenager-mon-acces-xdsl) ». Choisissez l'offre Fibre Pro.
    ...
    <img className="thumbnail" alt="espace client OVHcloud - Déménagement" src="/images/web-cloud/internet/internet-access/end-of-copper-migration-ftth/espace-client-demenagement.png" loading="lazy" />
...
:::warning
Cette résiliation est uniquement **technique**. Vous devez **[résilier commercialement votre service](/guides/web-cloud/internet/internet-access/comment-resilier-mon-acces-xdsl)** pour finaliser la suppression de votre service et éviter toute facturation future.
