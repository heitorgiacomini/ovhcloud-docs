...
description: Découvrez comment vérifier la stabilité de votre accès xDSL ou FTTH en utilisant les API OVHcloud
...
<img className="thumbnail" alt="serviceName dans espace client" src="/images/web-cloud/internet/internet-access/verifier-stabilite-acces/servicename-2022.png" loading="lazy" />

### Utiliser les API OVHcloud

Utilisez l'appel API suivant pour récupérer les logs :

<Api version="v1" section="/xdsl" method="GET" route={"/xdsl/\{serviceName\}/radiusConnectionLogs"} />

Saisissez, dans le champ `serviceName`, la référence de votre accès obtenue à l'étape précédente. Cliquez alors sur <code className="action">Execute</code>.

Voici un exemple de retour :

<img className="thumbnail" alt="api_radex" src="/images/web-cloud/internet/internet-access/verifier-stabilite-acces/api_radex3.png" loading="lazy" />
...
Si vous constatez des reconnexions fréquentes sur l'un de vos accès xDSL ou FTTH, nous vous conseillons de faire le point sur votre [desserte interne](/guides/web-cloud/internet/internet-access/la-desserte-interne) et de consulter nos guides de [diagnostic et dépannage](/guides/web-cloud/internet/internet-access/overview).
