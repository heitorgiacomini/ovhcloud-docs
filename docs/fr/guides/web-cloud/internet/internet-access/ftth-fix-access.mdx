...
description: Découvrez comment dépanner et remettre en service votre accès Internet fibre - FTTH, FTTE ou FTTO - OVHcloud
...
- Disposer d'un [accès Internet FTTH, FTTE ou FTTO OVHcloud](https://www.ovhcloud.com/fr/internet/).
...
- **Lien direct :** <ManagerLink to="/#/telecom/pack">Accès Internet</ManagerLink>
...
:::info
Ce guide s'adresse uniquement aux clients disposant d'un [accès Internet FTTH, FTTE ou FTTO OVHcloud](https://www.ovhcloud.com/fr/internet/). Si vous disposez d'un accès Internet xDSL OVHcloud, reportez-vous aux documentations xDSL correspondantes accessibles depuis la [page des guides Accès Internet](/guides/web-cloud/internet/internet-access/overview).
...
Rendez-vous sur la page [https://status.isp.ovhcloud.com/](https://status.isp.ovhcloud.com/) et vérifiez si votre accès Internet fibre est affecté par un incident en cours.
...
<Tabs>
  <Tab label="FTTH - Vérifications jusqu'à l'ONT">
    :::warning
    **Lors de vos manipulations : n'effectuez jamais un *reset* de l'équipement ONT**. 
    ...
    |---|---|
    |![diagnosticfibre](/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-huawei.jpg)|![diagnosticfibre](/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-nokia.jpg)|
    ...
    **ONT Huawei**
    ...
    <img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-huawei.jpg" loading="lazy" />
...
**ONT Nokia**
    ...
    <img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-ont-nokia.jpg" loading="lazy" />
  </Tab>
  <Tab label="FTTE et FTTO - Vérifications jusqu'au RAD">
    Voici un schéma représentant l'équipement RAD :
    
    <img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-rad.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-power.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-wan.png" loading="lazy" />
...
Positionnez-vous ensuite sur le menu <code className="action">Network Setting</code>, puis cliquez sur <code className="action">Broadband</code>.

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-internet-step1.png" loading="lazy" />

Sur la page qui apparaît, modifiez l'interface correspondant à votre « [Profil modem](/guides/web-cloud/internet/internet-access/advanced-config-router-manually) », en cliquant sur le bouton représentant une feuille avec un crayon :
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-internet-step2.png" loading="lazy" />

En dessous de « PPP Information », renseignez vos identifiants PPP à côté de « PPP User Name » et « PPP Password ».

Cliquez sur <code className="action">OK</code>, puis patientez quelques instants le temps que la manipulation soit prise en compte. Si le voyant « **INTERNET** » reste éteint, [prenez contact avec notre équipe support](https://help.ovhcloud.com/csm?id=csm_get_help) afin de poursuivre le diagnostic.

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-box-ovh-test-internet-step3.png" loading="lazy" />
...
- si vous avez activé le protocole **IPv6** sur votre accès Internet OVHcloud, assurez-vous que le ou les sites qui ne fonctionnent pas sont bien accessibles via ce protocole. Si ce n'est pas le cas, désactiver l'IPv6 pourrait rétablir l'accès à ces pages. Cette gestion s'effectue dans l'espace client, en cliquant sur l'onglet <code className="action">Mon accès</code> de l'accès à Internet concerné, puis sur la section « Caractéristiques ».
...
Pour débuter la manipulation, effectuez un clic droit sur l'image en bas à gauche représentant le logo **Windows** et cliquez sur <code className="action">Connexions réseau</code>. Dans la fenêtre qui apparaît, assurez-vous d'être bien positionné sur l'onglet <code className="action">État</code> dans la barre de menu à gauche, puis cliquez sur <code className="action">Modifier les options d'adaptateur</code>.

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step1.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step2.png" loading="lazy" />

Vous pouvez remarquer différents états concernant les cartes réseau.

|États|Illustration|Description|
|---|---|---|
|Active et connectée|<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step3.png" loading="lazy" />|La carte réseau est activée et vous êtes connecté à la box OVHcloud. La connexion depuis cette carte doit donc être fonctionnelle.|
|Active et non connectée|<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step4.png" loading="lazy" />|La carte réseau est activée, mais vous n'êtes pas connecté à la box OVHcloud. La connexion depuis cette carte n'est donc pas fonctionnelle.|
|Désactivée|<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step5.png" loading="lazy" />|La carte réseau est désactivée. La connexion depuis cette carte n'est donc pas fonctionnelle.|
...
Pour l'activer, faites un clic droit sur l'image représentant la carte, puis cliquez sur <code className="action">Activer</code>. Patientez alors le temps de son activation. Si la manipulation échoue, la carte est peut-être mal installée ou hors service. Dans ce cas, vous devrez vous rapprocher d'un professionnel, comme un technicien informatique. 

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step6.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step7.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step8.png" loading="lazy" />
...
<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step9.png" loading="lazy" />
...
Depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, cliquez sur votre accès à Internet FTTH ou xDSL dans le cadre `Accès Internet` à droite, puis positionnez-vous sur l'onglet <code className="action">Mon modem</code> et cliquez sur <code className="action">Configurer les réseaux Wi-Fi</code> dans la section <code className="action">Configuration générale</code>.

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/espaceclient2022.png" loading="lazy" />

Dans la page qui apparaît, cliquez sur le bouton représentant des points de suspension (à droite du réseau Wi-Fi que vous souhaitez configurer), puis sur <code className="action">Éditer</code>. La configuration actuelle s'affiche en dessous du tableau. Vous pouvez y modifier le canal et la clé Wi-Fi. 

Validez vos changements grâce au bouton <code className="action">Valider</code> et **patientez cinq minutes, le temps que la modification soit prise en compte par votre box OVHcloud.** Si nécessaire, effectuez plusieurs tests concernant le canal Wi-Fi afin de trouver le plus stable et le mieux adapté à votre situation.

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/wifi-2022.png" loading="lazy" />
...
Depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, cliquez sur votre accès à Internet FTTH ou xDSL dans le cadre `Accès Internet` à droite, puis positionnez-vous sur l'onglet <code className="action">Mon modem</code> et descendez dans la page jusqu'à voir la section <code className="action">Configuration réseau</code>.

Nous allons nous intéresser spécifiquement aux tableaux « IP LAN » et « DHCP ».

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step12-2022.png" loading="lazy" />
...
Pour réinitialiser la configuration de votre box OVHcloud, depuis l'onglet <code className="action">Mon modem</code>, descendez dans la page jusqu'à voir la section <code className="action">Configurations avancées</code>, puis cliquez sur <code className="action">Réinitialiser la configuration OVHcloud</code>. **Patientez cinq minutes le temps que la modification soit prise en compte par votre modem.**

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step13-2022.png" loading="lazy" />
...
Dans la nouvelle fenêtre qui apparaît, les différentes cartes réseau (Wi-Fi ou Ethernet) installées sur votre ordinateur s'affichent. Effectuez un clic droit sur la carte (Wi-Fi ou câble) concernée, puis sélectionnez <code className="action">Propriétés</code>. Assurez-vous que la case à côté de `Protocole Internet version 4 (TCP/IPv4)` est bien cochée. Ensuite, cliquez sur le nom `Protocole Internet version 4 (TCP/IPv4)` pour qu'il s'affiche en surbrillance, puis cliquez sur le bouton <code className="action">Propriétés</code>.

Au sein de cette nouvelle fenêtre, assurez-vous que « Obtenir une adresse IP automatiquement » et « Obtenir les adresses des serveurs DNS automatiquement » sont bien cochés. Cliquez finalement sur les boutons <code className="action">OK</code> pour valider vos modifications, le cas échéant. 

<img className="thumbnail" alt="diagnosticfibre" src="/images/web-cloud/internet/internet-access/ftth-fix-access/acces-internet-laptop-test-step14.png" loading="lazy" />
