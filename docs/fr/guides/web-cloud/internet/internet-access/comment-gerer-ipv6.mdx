...
description: "Découvrez comment activer l'adresse IPv6 de votre connexion OVHcloud depuis l'espace client"
...
<img className="thumbnail" alt="IPv6 status" src="/images/web-cloud/internet/internet-access/comment-gerer-ipv6/IPv6-status.png" loading="lazy" />
...
Pour en savoir plus sur la configuration à distance du modem OVHcloud, veuillez consulter le guide suivant : [Configurer sa box à partir de l'espace client OVHcloud](/guides/web-cloud/internet/internet-access/configuration-du-modem-a-partir-de-votre-espace-client).
...
<img className="thumbnail" alt="IPv6 status" src="/images/web-cloud/internet/internet-access/comment-gerer-ipv6/IPv6-activate.png" loading="lazy" />
