...
description: Découvrez comment modifier le profil de synchronisation de votre accès xDSL/FTTH
...
Depuis votre <ManagerLink to="/#/telecom/pack">espace client OVHcloud</ManagerLink>, cliquez sur votre accès à Internet FTTH ou xDSL dans le cadre `Accès Internet` à droite.
...
<img className="thumbnail" alt="Mon_acces" src="/images/web-cloud/internet/internet-access/modification-du-profil-de-synchronisation/XdslMonAcces-2022.png" loading="lazy" />

**Pour un accès ADSL :**

<img className="thumbnail" alt="profil adsl" src="/images/web-cloud/internet/internet-access/modification-du-profil-de-synchronisation/ProfilsADSL.gif" loading="lazy" />

**Pour un accès VDSL :**

<img className="thumbnail" alt="profil vdsl" src="/images/web-cloud/internet/internet-access/modification-du-profil-de-synchronisation/ProfilsVDSL.gif" loading="lazy" />
