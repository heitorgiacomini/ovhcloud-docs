...
description: "Utilisez l'API Connectivity OVHcloud pour vérifier l'éligibilité cuivre et fibre et gérer vos accès Internet"
...
Consultez les [offres d'accès Internet OVHcloud](https://www.ovhcloud.com/fr/internet/).
