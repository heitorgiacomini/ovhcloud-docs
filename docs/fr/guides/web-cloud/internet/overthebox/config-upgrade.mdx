...
description: Découvrez comment mettre à jour votre appareil OverTheBox
...
Depuis votre <ManagerLink to="/#/telecom/overTheBox">espace client OVHcloud</ManagerLink>, sélectionnez le service OverTheBox que vous souhaitez mettre à jour.
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/config-upgrade/manager-version-2024.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/config-upgrade/manager-available-2024.png" loading="lazy" />

### Mise à jour via l'espace client

:::warning
Cette action n'est possible que si votre appareil contacte notre serveur de provisioning. Si ce n'est pas le cas, vous devez [installer manuellement l'image](/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel).
...
Cliquez ensuite sur le bouton <code className="action">Mettre à jour</code>, puis cliquez une seconde fois sur l'encart explicatif, la mise à jour commencera alors.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/config-upgrade/manager-upgrade-2024.png" loading="lazy" />
...
Depuis votre <ManagerLink to="/#/telecom/overTheBox">espace client OVHcloud</ManagerLink>, sélectionnez le service OverTheBox que vous souhaitez modifier.

Sélectionnez ensuite le canal souhaité à l'aide du menu déroulant <code className="action">Versions disponibles</code>.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/config-upgrade/manager-releaseChannel-2024.png" loading="lazy" />
...
Activez ou désactivez les mises à jour automatiques à l'aide de l'interrupteur <code className="action">Autoriser les mises à jour automatiques la nuit</code>.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/config-upgrade/manager-autoupgrade-2024.png" loading="lazy" />
...
Il est toutefois possible de revenir sur une version antérieure depuis l'interface web locale, consultez la section `Mise à jour depuis l'interface web locale` du guide « [Installer l’image OverTheBox sur votre matériel](/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel) ».
