...
description: Découvrez comment installer manuellement une image OverTheBox sur votre appareil
...
:::info
Cette méthode peut être utilisée pour revenir sur une version antérieure. Il faudra impérativement décocher la case <code className="action">keep settings</code>.
:::
...
- Cliquez sur le bouton <code className="action">Flash image...</code>.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/step1-luci-flash-1-2024.png" loading="lazy" />

- Cliquez sur <code className="action">Browse...</code>.
- Choisissez le fichier d'image que vous venez de télécharger.
- Puis cliquez sur <code className="action">Upload</code>.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/step1-luci-flash-2-2024.png" loading="lazy" />

- Si vous souhaitez conserver vos configurations cochez la case <code className="action">Keep settings</code>. Il est toutefois recommandé de la laisser décochée pour éviter d'éventuels conflits de configuration entre différentes versions.
- Cliquez sur <code className="action">Continue</code>.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/step1-luci-flash-3-2024.png" loading="lazy" />

- Attendez quelques minutes afin qu'**OverTheBox** soit de nouveau opérationnelle.

:::tip[Success]
Votre OverTheBox est maintenant mise à jour, votre configuration a été réappliquée automatiquement si la case <code className="action">Keep settings</code> n'a pas été décochée.
:::
...
- Cliquez sur <code className="action">Parcourir</code> pour retrouver le fichier **.img**.
- Sélectionnez la clé USB dans le champ **Device**.
- Cliquez sur <code className="action">Write</code>.
- Une fois la procédure terminée, cliquez sur <code className="action">Exit</code>.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-windows-win32di.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-macos-diskutil.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-nuc.png" loading="lazy" />

Dans le cas d'une OverTheBox IT v1, la clé USB doit être branchée sur un des ports USB **noirs** :

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-itv1.png" loading="lazy" />

Dans le cas d'une OverTheBox Plus, la clé USB doit être branchée sur un des ports USB **en façade** :

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-v2b.png" loading="lazy" />

Dans le cas d'une OverTheBox IT v2, la clé USB doit être branchée sur un des ports USB **au dos** :

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel/usbboot-v2c.png" loading="lazy" />
...
[Configurer un ancien appareil OverTheBox v1 (Intel & IT v1)](/guides/web-cloud/internet/overthebox/intel-itv1-installation)
...
- Sur une machine avec 1 seul port ethernet : [Configurer un ancien appareil OverTheBox v1 (Intel & IT v1)](/guides/web-cloud/internet/overthebox/intel-itv1-installation).
- Sur une machine avec plus d'un port ethernet : [Comment installer OverTheBox ?](/guides/web-cloud/internet/overthebox/plus-itv2-installation).
:::
