...
description: Découvrez comment accéder à distance à votre OverTheBox
...
Depuis votre <ManagerLink to="/#/telecom/overTheBox">espace client OVHcloud</ManagerLink>, sélectionnez le service OverTheBox auquel vous souhaitez accéder à distance et cliquez sur <code className="action">Accès à distance</code>.

Informations à inscrire dans la partie <code className="action">Ajouter un accès à distance</code> :
...
- Validez la création à l'aide du bouton <code className="action">Valider</code>.
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/middle-acces-a-distance/step1-create-2024.png" loading="lazy" />
...
<Tabs>
  <Tab label="HTTPS">
    ...
    <img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/middle-acces-a-distance/step2-connecthttps-2024.png" loading="lazy" />
  </Tab>
  <Tab label="SSH">
    ...
    <img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/middle-acces-a-distance/step2-connectssh-2024.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/middle-acces-a-distance/step3-delete-2024.png" loading="lazy" />
