...
description: Découvrez comment installer et configurer un ancien appareil OverTheBox v1 (Intel & IT v1)
lastUpdated: 2024-05-29
---

:::warning
Ce guide est déprécié et concerne la configuration d'équipements OverTheBox qui ne sont plus disponibles à la vente.
Veuillez vous reporter au guide suivant pour les offres OverTheBox actuelles : [Comment installer OverTheBox ?](/guides/web-cloud/internet/overthebox/plus-itv2-installation)
...
- Une **OverTheBox** fournie par OVHcloud ou une installation depuis le projet Open Source ([installer l'image OverTheBox sur votre matériel](/guides/web-cloud/internet/overthebox/advanced-installer-limage-overthebox-sur-votre-materiel)).
{/* CP-NAV-START:telecom-otb */}
---

### Accès à l'espace client OVHcloud

- **Lien direct :** <ManagerLink to="/#/telecom/overTheBox">OverTheBox</ManagerLink>
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-final-plugs.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-network.gif" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step1_OTBv1.jpg" loading="lazy" />

Dans le cas d'une OverTheBox IT v1 :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step1_OTBv2a.jpg" loading="lazy" />
...
Dans le cas d'une OverTheBox Intel :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step2_OTBv1.jpg" loading="lazy" />

Dans le cas d'une OverTheBox IT v1 :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step2_OTBv2a.jpg" loading="lazy" />
...
Dans le cas d'une OverTheBox Intel :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step3-1_OTBv1.jpg" loading="lazy" />

Dans le cas d'une OverTheBox IT v1 :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step3-1_OTBv2a.jpg" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step3-2.png" loading="lazy" />

- Depuis votre <ManagerLink to="/#/telecom/overTheBox">espace client OVHcloud</ManagerLink>, sélectionnez le **service OverTheBox** que vous souhaitez associer à votre boîtier.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step3-3.png" loading="lazy" />

- Faites au préalable un copier-coller du nouveau **Device ID** sur l'interface **OverTheBox**.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step3-4.png" loading="lazy" />

- Modifiez l'**Identifiant du périphérique** et indiquez le **"Device ID"**.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step3-5.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step4-1.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step4-3.png" loading="lazy" />

Cette opération dure 30 secondes. Le DHCP sera ensuite géré par votre **OverTheBox**.

<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step4-4.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step4-5.png" loading="lazy" />
...
Dans le cas d'une OverTheBox Intel :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step5-1_OTBv1.jpg" loading="lazy" />

Dans le cas d'une OverTheBox IT v1 :
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step5-1_OTBv2a.jpg" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step5-3.png" loading="lazy" />
...
<img className="thumbnail" alt="overthebox" src="/images/web-cloud/internet/overthebox/intel-itv1-installation/installationV1-step5-4.png" loading="lazy" />
