...
description: Découvrez comment installer et faire vos premiers pas sur Composer
...
- Posséder une [offre d'hébergement web](https://www.ovhcloud.com/fr/web-hosting/) disposant d'un accès SSH.

## En pratique

Connectez-vous en SSH à votre hébergement mutualisé à l'aide de notre guide sur [l'utilisation du SSH avec votre hébergement web mutualisé OVHcloud](/guides/web-cloud/web-hosting/ssh-on-webhosting).
