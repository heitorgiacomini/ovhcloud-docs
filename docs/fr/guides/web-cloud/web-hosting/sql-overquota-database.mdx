...
Si votre base de données est présente sur une solution [Web Cloud Databases](https://www.ovhcloud.com/fr/web-cloud/databases/), consultez notre guide « [Web Cloud Databases - Se connecter à votre base de données](/guides/web-cloud/databases/db-connecting-database-server) », puis passez directement à l'[étape 1.2](#step1.2) du présent guide.
...
Il est possible de dupliquer le contenu de votre base de données OVHcloud directement vers une autre de vos bases de données OVHcloud grâce à une fonctionnalité présente dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Pour cela, consultez notre guide « [Dupliquer le contenu d'une base de données dans une autre](/guides/web-cloud/web-hosting/copy-database) ».
...
- [Premiers pas avec l'offre Web Cloud Databasess](/guides/web-cloud/databases/db-getting-started)
- [Importer votre ancienne base de données dans votre offre Web Cloud Databasess](/guides/web-cloud/databases/db-restore-import-database)
