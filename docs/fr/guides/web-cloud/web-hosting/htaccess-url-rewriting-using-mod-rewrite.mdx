...
description: "Découvrez comment réécrire l'URL d'accès à votre site grâce au mod_rewrite via le fichier .htaccess"
...
Pour éditer (ou créer) des répertoires, connectez-vous à l'espace FTP de votre hébergement. Au besoin, aidez-vous du guide « [Accéder à mon espace de stockage](/guides/web-cloud/web-hosting/ftp-connection) ».
...
Consultez notre guide sur la [configuration d'un multisite sur un hébergement mutualisé](/guides/web-cloud/web-hosting/multisites-configure-multisite) si vous souhaitez plus d'informations sur le sujet.
...
Si vous ne disposez pas d'un certificat SSL, consultez notre guide sur la [gestion d'un certificat SSL sur un hébergement mutualisé OVHcloud](/guides/web-cloud/web-hosting/ssl-on-webhosting).
...
[Bloquer l'accès à mon site web pour certaines adresses IP via un fichier .htaccess](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website)
