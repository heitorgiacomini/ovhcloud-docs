...
- Le domaine (avec sous-domaine si souhaité) qui sera utilisé pour votre site web doit être déclaré en tant que [Multisite](/guides/web-cloud/web-hosting/multisites-configure-multisite) sur votre hébergement web OVHcloud.
...
Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> puis sélectionnez <code className="action">Web Cloud</code>. Cliquez sur <code className="action">Hébergements</code>, choisissez l'offre d'hébergement sur laquelle vous souhaitez installer un « module en 1 clic » puis cliquez sur l'onglet <code className="action">Modules en 1 clic</code>.
...
Si votre domaine n'est pas dans la liste, rendez-vous dans l'onglet <code className="action">Multisite</code> pour l'ajouter. Consultez notre guide [Comment partager mon hébergement web entre plusieurs sites](/guides/web-cloud/web-hosting/multisites-configure-multisite) si besoin.
...
:::info
L'installation et la réception de l'e-mail peuvent prendre jusqu'à 15 minutes à compter du moment où vous avez cliqué sur le bouton <code className="action">Installer</code> dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>.
...
Pour réaliser cette méthode d'installation, assurez-vous que la case <code className="action">Installation en mode avancé</code> est cochée, puis cliquez sur le bouton <code className="action">Suivant</code> :
...
Pour récupérer les identifiants de connexion à votre base de données incluse avec votre hébergement web, consultez [ce guide](/guides/web-cloud/web-hosting/sql-create-database).

Pour récupérer les identifiants de connexion à votre base de données créée sur une instance Web Cloud Databases, consultez [ce guide](/guides/web-cloud/databases/db-getting-started).
...
- *Port* : indiquez systématiquement le numéro **3306** (port par défaut) pour une base de données incluse avec votre hébergement web. Pour une base présente sur une instance Web Cloud Databases, consultez [ce guide](/guides/web-cloud/databases/db-getting-started).
...
Pour les bases de données créées sur une offre Web Cloud Databases, référez-vous aux informations indiquées dans [ce guide](/guides/web-cloud/databases/db-getting-started).
...
- *domaine :* nom de domaine avec lequel vous souhaitez installer votre CMS. Si besoin, consultez notre guide [Comment partager mon hébergement web entre plusieurs sites](/guides/web-cloud/web-hosting/multisites-configure-multisite).
