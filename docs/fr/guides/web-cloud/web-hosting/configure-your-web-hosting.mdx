...
En résumé, modifier la configuration de votre hébergement web depuis l'<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou modifier les valeurs présentes dans le fichier « .ovhconfig » revient à réaliser la même opération.
...
- Disposer d’une offre d’[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/), à l'exception d'une [offre d'hébergement Cloud Web](https://www.ovhcloud.com/fr/web-hosting/cloud-web-offer/).
...
- **Via l'espace client OVHcloud**. Connectez-vous à <ManagerLink to="/">l'espace client OVHcloud</ManagerLink> puis rendez-vous dans la partie <code className="action">Web Cloud</code>. Dans la colonne de gauche, cliquez sur <code className="action">Hébergements</code> puis choisissez l'hébergement web concerné. Dans l'onglet <code className="action">Informations générales</code>, repérez la version en dessous de *Version PHP globale*. 
...
<Tabs>
  <Tab label="Étape 1">
    Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, puis rendez-vous dans la partie <code className="action">Web Cloud</code>.
...
|http.firewall|Permet d'activer ou de désactiver le [firewall fourni avec les hébergements web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/options/). Renseignez **security** pour l'activer ou **none** pour le désactiver.|
