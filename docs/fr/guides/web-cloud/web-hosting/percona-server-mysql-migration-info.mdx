...
description: Découvrez les avantages de la migration de MySQL vers Percona Server pour MySQL
...
- Disposer d'une offre d'[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/) avec une base de données mutualisée OVHcloud (MySQL) associée.
