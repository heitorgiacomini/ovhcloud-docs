...
:::tip
Pour installer Drupal **automatiquement** depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, consultez notre documentation sur l'[installation d'un module « en un clic »](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
