...
1. Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, rendez-vous dans <code className="action">Web Cloud</code> puis cliquez sur votre hébergement web.
...
4. Cliquez sur <code className="action">Lever les mesures de sécurité</code>.
