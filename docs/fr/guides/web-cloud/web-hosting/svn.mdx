---
title: Utiliser SVN
description: Découvrez comment utiliser SVN en SSH sur votre hebergement web
...
- Se connecter en SSH à votre hébergement Web (vous pouvez consulter notre guide [Utiliser l’accès SSH de son hébergement web](/guides/web-cloud/web-hosting/ssh-on-webhosting))

## En pratique

### Création du dépôt

Une fois connecté en [SSH sur votre hébergement](/guides/web-cloud/web-hosting/ssh-on-webhosting), créez le répertoire racine des dépôts SVN, puis le dépôt.
...
<img className="thumbnail" alt="hosting" src="/images/assets/screens/other/web-tools/terminal/terminal-ls-la-svn.png" loading="lazy" />
...
Nous vous invitons à suivre le guide [Créer des clés SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys#create-ssh-key).
...
Vous retrouverez également ces infrormations on consultant notre guide [Utiliser l’accès SSH de son hébergement web](/guides/web-cloud/web-hosting/ssh-on-webhosting).
:::


<img className="thumbnail" alt="hosting" src="/images/assets/screens/other/web-tools/terminal/terminal-homez-folder.png" loading="lazy" />
...
- Téléchargez et installez [TortoiseSVN](https://tortoisesvn.net/downloads.html)
...
<img className="thumbnail" alt="hosting" src="/images/assets/screens/other/web-tools/tortoisesvn/checkout.png" loading="lazy" />

Il existe une très bonne documentation en anglais pour Subversion : [http://svnbook.red-bean.com/en/1.5/index.html](http://svnbook.red-bean.com/en/1.5/index.html)
