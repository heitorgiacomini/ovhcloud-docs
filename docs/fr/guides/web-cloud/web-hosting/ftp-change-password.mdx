...
:::info
Pour plus d'informations sur les bonnes pratiques en matière de gestion de mots de passe, consultez le guide « [Modifier le mot de passe de votre compte](/guides/account-and-service-management/account-information/manage-ovh-password) ».
:::

Selon votre offre d'[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/), le mot de passe de votre utilisateur FTP se modifie de deux façons différentes.

**Cliquez sur votre offre pour afficher le contenu.**

<details>
<Region zones={['eu']}>
<summary>Offres Hébergement gratuit, Starter, Perso et Startup (un seul utilisateur FTP)</summary>
</Region>
<Region zones={['ca', 'apac']}>
<summary>Offres Starter, Perso et Startup (un seul utilisateur FTP)</summary>
</Region>
...
<Tabs>
  ...
  <Tab label="Étape 2">
    Cliquez sur l'onglet <code className="action">FTP - SSH</code>.
  ...
  <Tab label="Étape 3">
    Un tableau affiche les *utilisateurs FTP* créés sur votre hébergement web. Cliquez sur le *pictogramme en forme de crayon* dans la colonne <code className="action">Mot de passe</code>, renseignez le nouveau mot de passe **en respectant la politique des mots de passe** puis confirmez le changement en cliquant sur le *bouton vert* de validation.
...
<details>
<summary>Offres Pro, Performance, Agency, Agency Plus et Agency Max (plusieurs utilisateurs FTP)</summary>
