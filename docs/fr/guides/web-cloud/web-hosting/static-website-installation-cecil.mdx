...
- Être en capacité de transférer des fichiers en FTP avec un client comme [FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).
- Paramétrer votre zone DNS pour faire pointer votre nom de domaine (ou sous-domaine) vers votre hébergement web mutualisé. Cela s'avère notamment utile si vous souhaitez héberger plusieurs [sites web](/guides/web-cloud/web-hosting/multisites-configure-multisite) sur votre hébergement web mutualisé.
...
Pour vous aider à déclarer un domaine ou un sous-domaine sur l'un des sites web de votre hébergement, consultez notre page « [Partager son hébergement entre plusieurs sites](/guides/web-cloud/web-hosting/multisites-configure-multisite) ».
...
<img className="thumbnail" alt="Installation Cecil" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil01.png" loading="lazy" />
...
<img className="thumbnail" alt="Installation Cecil" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil02.png" loading="lazy" />

Vous pouvez maintenant voir le résultat en vous rendant sur votre nom de domaine:

<img className="thumbnail" alt="Installation Cecil" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil03.png" loading="lazy" />
...
Si votre nom de domaine ou sous-domaine est hébergé chez OVHcloud, consultez nos guides relatifs à la [configuration DNS](/guides/web-cloud/domains/dns-zone-edit) et à la mise en place d'un [site web sur votre hébergement web](/guides/web-cloud/web-hosting/multisites-configure-multisite).
...
<img className="thumbnail" alt="Fichier de configuration YAML" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil04.png" loading="lazy" />
...
<img className="thumbnail" alt="Installation Cecil" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil05.png" loading="lazy" />
...
<img className="thumbnail" alt="Installation Cecil" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil06.png" loading="lazy" />

Vous pouvez le visualiser sur votre serveur en tapant l'URL de votre site, suivi de `/mypage/`:

<img className="thumbnail" alt="Résultat navigateur" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil07.png" loading="lazy" />

### Personnaliser les fichiers de votre site

#### Modification sur le serveur

L'édition des fichiers _Markdown_ peut se faire directement sur le serveur d'hébergement web. Sur votre offre d'[hébergement Performance](https://www.ovhcloud.com/fr/web-hosting/performance-offer/), votre accès SSH pour permet d'utiliser indifféremment [GNU nano](https://nano-editor.org/), [vi](https://ex-vi.sourceforge.net/) ou [vim](https://www.vim.org/).
...
<img className="thumbnail" alt="Édition du fichier dans GNU nano" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil08.png" loading="lazy" />

Ajoutez quelques lignes en respectant la syntaxe _Markdown_:

<img className="thumbnail" alt="Ajout de contenu dans le fichier" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil09.png" loading="lazy" />
...
<img className="thumbnail" alt="Page mise à jour" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil10.png" loading="lazy" />
...
<img className="thumbnail" alt="Téléchargement avec FileZilla" src="/images/assets/screens/other/web-tools/filezilla/cecil-folder.png" loading="lazy" />

Vous pouvez maintenant éditer les fichiers dans votre I.D.E.:

<img className="thumbnail" alt="Affichage dans Visual Studio Code" src="/images/assets/screens/other/web-tools/vscode/static-website-installation-cecil12.png" loading="lazy" />
...
[Ajouter du contenu dynamique dans une page web statique générée avec Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil-api-call)

Le [site officiel de l'application Cecil](https://cecil.app/)

Un [guide sur le format Markdown](https://www.markdownguide.org/)

Notre [guide sur l'utilisation de FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide)
