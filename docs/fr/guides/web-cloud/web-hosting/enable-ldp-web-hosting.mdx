...
Votre offre d'[hébergement web](https://www.ovhcloud.com/fr/web-hosting/) génère donc ses propres logs.
...
Du fait que les offres d'[hébergement web](https://www.ovhcloud.com/fr/web-hosting/) peuvent être utilisées avec de nombreux services (bases de données, etc.), celles-ci peuvent, en complément des logs en temps réel déjà disponibles, être abonnées par flux de données à Logs Data Platform.
...
<Tabs>
  ...
  <Tab label="Étape 5">
    ...
    <img className="thumbnail" alt="Log Data Platform" src="/images/assets/screens/control-panel/product-selection/bare-metal-cloud/logs-data-platform/data-stream/add-data-stream.png" loading="lazy" />
    
    Si besoin, consultez nos guides « [Introduction à Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction) » (EN) et « [Démarrer rapidement avec Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start) » (EN) pour réaliser ces actions.
  </Tab>
  <Tab label="Étape 6">
    ...
    Pour effectuer cela et, comme expliqué [précédemment](#webhosting-ldp), retournez dans l'onglet <code className="action">Logs</code> de votre offre d'hébergement web pour vous abonner à ce nouveau flux de données, puis suivez cette fois-ci le [Cas n°1](#webhosting-ldp-case1) décrit plus haut.
  </Tab>
</Tabs>
