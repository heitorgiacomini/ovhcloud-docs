...
description: "Decouvrez comment protéger un répertoire ou l'accès à l'administration de votre site web via une authentification avec les fichiers « .htaccess » et « .htpasswd »"
...
Ceci en utilisant deux fichiers de configuration (HTTP) Apache à placer dans [l'espace FTP](/guides/web-cloud/web-hosting/ftp-connection) de votre hébergement Web : 
...
- Disposer des identifiants de connexion à [l'espace FTP de votre hébergement](/guides/web-cloud/web-hosting/ftp-connection).
...
Si vous utilisez un CMS Wordpress, OVHcloud met également à disposition un tutoriel sur comment [utiliser le fichier htaccess avec WordPress](/guides/web-cloud/web-hosting/htaccess-how-to-protect-wordpress).
...
Pour cela, contactez notre [communauté d'utilisateurs](https://community.ovhcloud.com/community/fr) ou nos [partenaires OVHcloud](https://partner.ovhcloud.com/fr/directory/).
:::
...
Pour modifier la version de PHP de vos sites web sur votre hébergement web, consultez notre guide « [Hébergement web : environnement, version PHP, « .ovhconfig »](/guides/web-cloud/web-hosting/configure-your-web-hosting) ».
...
Connectez-vous à [l'espace de stockage FTP](/guides/web-cloud/web-hosting/ftp-connection) de votre hébergement web. Ouvrez le [« dossier racine »](/guides/web-cloud/web-hosting/multisites-configure-multisite) vers lequel pointe votre nom de domaine.
...
Remontez dans le « dossier racine » où vous avez créé le fichier « crypt.php ». Cliquez sur <code className="action">Editer</code> puis placez les lignes suivantes :
...
Si vous disposez d'un hébergement **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max**, connectez-vous ensuite en [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting) à votre hébergement web. Descendez dans le « **dossier racine** » où se trouve votre script « crypt.php ».
...
:::warning
Pour des raisons de sécurité, l'utilisation du SSH est recommandée. Toutefois, si vous disposez d'une offre **Starter**, **Perso** ou **Startup** sur lesquelles le SSH est indisponible, vous pouvez aussi exécuter le fichier « crypt.php » via votre navigateur Web.
...
- `your_ftp_login` : le login FTP que vous utilisez pour vous connecter à votre espace de stockage FTP. Pour récupérer votre login FTP, consultez notre guide sur la [connexion à votre espace FTP](/guides/web-cloud/web-hosting/ftp-connection).
...
[Se connecter à l'espace FTP de son hébergement Web](/guides/web-cloud/web-hosting/ftp-connection)

[Tutoriel - Opérations réalisables avec un fichier « .htaccess »](/guides/web-cloud/web-hosting/htaccess-what-else-can-you-do)
...
[Réécrire l'URL d'accès à mon site grâce au mod_rewrite via le fichier .htaccess](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)
