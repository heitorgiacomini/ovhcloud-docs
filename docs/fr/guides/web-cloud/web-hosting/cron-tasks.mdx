...
Rendez-vous dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Cliquez sur l'onglet <code className="action">Web Cloud</code>, puis sur <code className="action">Hébergements</code>.
