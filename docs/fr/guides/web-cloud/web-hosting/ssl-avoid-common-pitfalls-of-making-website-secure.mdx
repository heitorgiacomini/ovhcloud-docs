...
description: Découvrez comment éviter les erreurs courantes de sécurisation de son site web avec le SSL
...
:::info
Certains sites web utilisent des [Content Delivery Netnwork (CDN)](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn) pour héberger, par exemple, des librairies *Javascript* (comme *JQuery*). 
