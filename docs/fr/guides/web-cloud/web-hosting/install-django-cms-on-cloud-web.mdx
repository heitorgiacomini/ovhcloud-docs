...
description: Apprenez à installer Django CMS avec Python sur votre hébergement Cloud Web OVHcloud
...
<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/tab-python3.png" loading="lazy" />
...
<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/runtime-software-application/modify-a-runtime-software-application-python3.png" loading="lazy" />

### Étape 2 : associez Python à un multisite

Maintenant que Python est activé en tant que moteur d’exécution, vous devez l’associer à l’un de vos multisites. Pour cela, positionnez-vous sur l’onglet <code className="action">Multisite</code>. Le tableau qui s’affiche contient tous les noms de domaine qui ont été ajoutés en tant que multisite.

<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/multisite/tab-python3-full-disabled.png" loading="lazy" />
...
<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/multisite/add-a-domain-or-sub-domain-step-2-django.png" loading="lazy" />
...
<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/ftp-ssh/change-password.png" loading="lazy" />
...
Pour redémarrer le _daemon_ Python, retournez dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Positionnez-vous sur l’onglet <code className="action">Multisite</code>, cliquez à droite du nom de domaine concerné sur le bouton <code className="action">...</code> à droite, puis choisissez <code className="action">Redémarrer</code>.

Une fois ceci fait, l’application sera accessible via le nom de domaine choisi dans la configuration de votre multisite.
    
<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/control-panel/product-selection/web-cloud/cloud-web/multisite/restart-python3.png" loading="lazy" />
...
<img className="thumbnail" alt="django-cloud-web" src="/images/assets/screens/other/cms/django/installation-successfull.png" loading="lazy" />
