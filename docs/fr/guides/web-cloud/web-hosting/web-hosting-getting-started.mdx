...
<Tabs>
  ...
  <Tab label="Étape 2">
    Sélectionnez l'onglet <code className="action">Mes sites</code> une fois positionné sur l'hébergement web concerné.
  </Tab>
  <Tab label="Étape 3">
    Dans le tableau qui apparaît, cliquez sur le bouton <code className="action">⁝</code> situé à droite du site web créé automatiquement lors de la création de votre hébergement web, puis sur <code className="action">Ajouter un domaine</code>.
  </Tab>
  <Tab label="Étape 4">
...
<Tabs>
  ...
  <Tab label="Étape 2">
    Sélectionnez l'onglet <code className="action">Modules en 1 clic</code> une fois positionné sur l'hébergement web concerné.
  </Tab>
  <Tab label="Étape 3">
    Sur la page qui s'affiche, cliquez sur le bouton <code className="action">Ajouter un module</code>.
  </Tab>
  <Tab label="Étape 4">
    Dans la fenêtre qui s'ouvre, sélectionnez le CMS que vous souhaitez installer. Choisissez ensuite le domaine sur lequel installer le module en sélectionnant le nom de domaine souhaité **sans les « www »** devant (exemple : `domain.tld` et non pas `www.domain.tld`), puis cliquez directement sur <code className="action">Installer</code>.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Étape 2">
    Sur la page qui s'affiche et dans l'encadré **Configuration**, cliquez sur le bouton <code className="action">...</code> situé à droite de la mention <code className="action">Adresses e-mails</code>, puis sur <code className="action">Activer mon offre e-mail</code>.
  </Tab>
  <Tab label="Étape 3">
...
<Tabs>
  ...
  <Tab label="Étape 3">
    Sur la nouvelle page qui apparaît, cliquez sur le bouton <code className="action">Créer une adresse E-mail</code>.
  </Tab>
  <Tab label="Étape 4">
