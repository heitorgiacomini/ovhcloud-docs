...
description: Découvrez comment rendre votre site web compatible avec une adresse IPv6
...
Nous mettons à votre disposition ce guide afin de vous accompagner au mieux sur des tâches courantes. Si vous éprouvez des difficultés, nous vous recommandons de faire appel à un [prestataire spécialisé](https://partner.ovhcloud.com/fr/directory/) et/ou de contacter l'éditeur du service. En effet, nous ne serons pas en mesure de vous fournir une assistance. Plus d'informations dans la section [« Aller plus loin »](#go-further) de ce tutoriel.
...
Pour vérifier si votre site web utilise déjà une adresse IPv6, utilisez le site [test-ipv6.run](https://test-ipv6.run/domain-checker). Il vous indiquera si votre site web répond sur ce nouveau protocole IP. Si ce n'est pas le cas, poursuivez la lecture de notre guide.
...
Si la zone DNS active de votre nom de domaine est présente che OVHcloud, utilisez nos guides « [Éditer une zone DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit) », puis « [Tout savoir sur les enregistrements DNS](/guides/web-cloud/domains/dns-zone-records) » pour créer une entrée DNS de type **AAAA**.
