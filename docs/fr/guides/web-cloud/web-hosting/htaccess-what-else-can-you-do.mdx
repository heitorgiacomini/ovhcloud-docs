...
description: "Découvrez quelques exemples d'opérations réalisables avec un fichier « .htaccess »"
...
Pour plus d'informations, consultez notre tutoriel : [« Comment bloquer l'accès à mon site pour certaines adresses IP via un fichier .htaccess ? »](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website).
...
Pour plus d'informations, consultez notre tutoriel [« Protéger l'interface d'administration de votre site par un fichier .htaccess »](/guides/web-cloud/web-hosting/htaccess-protect-directory-by-password).
...
Retrouvez plus d'informations dans notre tutoriel : [« Réécrire l'URL d'accès à mon site grâce au mod_rewrite via le fichier .htaccess »](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite).
...
Retrouvez plus d'informations sur cette fonctionnalité dans la [documentation officielle Apache](https://httpd.apache.org/docs/trunk/fr/custom-error.html).
...
[Protéger l'interface d'administration de votre site par un fichier .htaccess](/guides/web-cloud/web-hosting/htaccess-protect-directory-by-password)
