...
description: Découvrez nos conseils pour réparer votre site Web piraté
...
- [Changer le mot de passe d'accès à votre identifiant client OVHcloud](/guides/account-and-service-management/account-information/manage-ovh-password).
- [Sécuriser l'accès à votre espace client OVHcloud avec une double authentification](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
- [Modifier le mot de passe d'accès à l'espace de stockage FTP de votre hébergement Web](/guides/web-cloud/web-hosting/ftp-change-password).
- [Changer le mot de passe d'accès à votre base de données](/guides/web-cloud/web-hosting/sql-change-password).

Nous vous recommandons également d'utiliser un [gestionnaire de mots de passe](/guides/account-and-service-management/account-information/manage-ovh-password#utiliser-un-gestionnaire-de-mots-de-passe).
...
Utilisez notre guide sur [les statistiques et logs de votre hébergement Web](/guides/web-cloud/web-hosting/logs-and-statistics) pour rechercher les éléments malveillants injectés dans votre site web. Vous trouverez les informations dans les logs « web ». 
...
Si vous êtes absolument sûr qu'il s'agit d'une IP malveillante, vous pouvez lui bloquer l'accès à votre hébergement en suivant notre documentation sur les [restrictions d'accès via le fichier « .htaccess »](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website).
...
- [Restaurer l'espace de stockage FTP de votre hébergement Web](/guides/web-cloud/web-hosting/ftp-save-and-backup)
- [Récupérer la sauvegarde SQL de votre base de données](/guides/web-cloud/web-hosting/sql-database-export)
- [Importer la sauvegarde SQL dans votre base de données](/guides/web-cloud/web-hosting/sql-importing-mysql-database)
...
Si votre hébergement est en état « désactivé », les robots de restauration automatique disponibles depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> seront désactivés également.
...
Pour réactiver l'hébergement Web, suivez les instructions de l'étape 4 de ce [guide](/guides/web-cloud/web-hosting/diagnostic-403-forbidden#reactivate-web-hosting).
...
Pour vous connecter à l'espace de stockage de votre hébergement, consultez [notre guide](/guides/web-cloud/web-hosting/ftp-connection) sur le sujet.
...
Retrouvez plus de détails sur les droits « CHMOD » dans la section « Informations utiles » de notre [tutoriel sur l'utilisation du client FTP Filezilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide#useful-information).
...
Sécurisez vos formulaires de contact à minima à l'aide d'un système de type « Captcha », afin d'éviter que des robots malveillants n'émettent du SPAM par ce biais. Si la fonction « mail() » de PHP a également été bloquée sur votre hébergement, consultez [notre guide](/guides/web-cloud/web-hosting/mail-function-script-records) sur ce sujet pour résoudre ce blocage.

Consultez également notre guide sur [comment sécuriser votre site Web](/guides/web-cloud/web-hosting/secure-your-website), afin de diminuer au maximum le risque qu'un nouveau piratage se produise.

## Aller plus loin <a name="go-further"></a>

[Se connecter à l'espace de stockage de son hébergement Web](/guides/web-cloud/web-hosting/ftp-connection)

[Modifier la configuration de son hébergement Web](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Activer le pare-feu applicatif](/guides/web-cloud/web-hosting/multisites-activating-application-firewall)

[Optimiser les performances de son site](/guides/web-cloud/web-hosting/optimise-your-website-performance)
