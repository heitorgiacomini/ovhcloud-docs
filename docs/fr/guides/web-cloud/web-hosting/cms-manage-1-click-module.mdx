...
Pour accéder à la partie publique de votre site suite à l'installation d'un module en 1 clic, rendez-vous dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur <code className="action">Web Cloud</code>, <code className="action">Hébergements</code>, sur l'hébergement concerné puis sur l'onglet <code className="action">Modules en 1 clic</code>.
...
Pour accéder à la partie de votre site réservée aux administrateurs, rendez-vous dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur <code className="action">Web Cloud</code>, <code className="action">Hébergements</code>, sur l'hébergement concerné puis sur l'onglet <code className="action">Modules en 1 clic</code>.
...
Vous pouvez également rechercher l'e-mail reçu lors de la création de votre module depuis votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> : cliquez sur votre nom en haut à droite de l'écran puis, dans le menu qui apparaît, cliquez sur <code className="action">Emails de service</code>.
...
Pour supprimer votre module en 1 clic, rendez-vous dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>, cliquez sur <code className="action">Web Cloud</code>, <code className="action">Hébergements</code>, sur l'hébergement concerné puis sur <code className="action">Modules en 1 clic</code>.
...
Pour finaliser la suppression de votre module, rendez-vous donc dans l'onglet <code className="action">Bases de données</code>, toujours dans la partie <code className="action">Web cloud</code>, <code className="action">Hébergements</code> et dans l'hébergement concerné sur votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> puis cliquer sur <code className="action">...</code> à droite de la ligne désignant la base et sur le bouton <code className="action">Supprimer la base de données</code>.
