...
description: Découvrez comment activer un certificat SSL Sectigo DV sur votre hébergement Web OVHcloud
...
<Tabs>
  ...
  <Tab label="Étape 4">
    Dans la nouvelle fenêtre qui s'ouvre, sélectionnez le nom de domaine ou sous-domaine concerné à l'aide du menu déroulant, puis cliquez sur <code className="action">Valider</code> pour être redirigé vers le bon de commande de votre certificat SSL Sectigo DV.
...
<Tabs>
  ...
  <Tab label="Étape 3">
    ...
    <img className="thumbnail" alt="Tableau de gestion des certificats SSL" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/ssl-certificates/tab.png" loading="lazy" />
  </Tab>
</Tabs>


Votre certificat SSL Sectigo DV est désormais installé et actif. Vous pouvez dès à présent l'utiliser avec votre site web en passant, par exemple, votre [site web en HTTPS](/guides/web-cloud/web-hosting/ssl-activate-https-website).
