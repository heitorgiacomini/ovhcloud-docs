...
**Vérifier l'activation du protocole SFTP**

Pour cela, consultez notre guide « [Hébergement web - Comment activer l'accès SFTP](/guides/web-cloud/web-hosting/enable-sftp) ».
