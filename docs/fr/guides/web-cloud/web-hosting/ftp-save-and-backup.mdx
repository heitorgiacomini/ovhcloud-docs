...
Lorsque vous effectuez une sauvegarde de sécurité pour votre site et que vous utilisez une base de données, faites également une sauvegarde de votre base de données. N'hésitez pas à consultez notre guide pour [récupérer une sauvegarde de votre (vos) base(s) de données](/guides/web-cloud/web-hosting/sql-database-export).
...
- Selon la méthode utilisée, disposer d’un accès à la gestion de l’offre d’hébergement web depuis l’<ManagerLink to="/">espace client OVHcloud</ManagerLink> ou du mot de passe de l'utilisateur FTP vous permettant d'accéder à votre espace de stockage. 
...
Si l'espace de stockage FTP utilisé est supérieur à la moitié de l'espace de stockage FTP total de votre offre d'hébergement web, récupérez en local certains éléments volumineux de votre site web (pour cela, vous pouvez utiliser [Filezilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide)).
...
Pour déterminer si votre site a été placé en mode « maintenance », référez-vous à notre guide [Que faire en cas de page « 403 forbidden » ?](/guides/web-cloud/web-hosting/diagnostic-403-forbidden). 

Dans ce cas de figure :

- Un e-mail est envoyé au [contact administrateur](/guides/account-and-service-management/account-information/managing-contacts#acceder-a-la-gestion-des-contacts) de l'hébergement par nos équipes. 
- Le statut « maintenance » apparaît dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Dans la partie <code className="action">Web Cloud</code>, cliquez sur votre service dans la section <code className="action">Hébergements</code> puis sur l'onglet <code className="action">Informations générales</code>.
...
<Tabs>
  ...
  <Tab label="Étape 5">
    ...
    Une fois la date sélectionnée, cliquez sur le bouton <code className="action">Suivant</code>. 
  </Tab>
  <Tab label="Étape 6">
...
Prenez quelques instants afin de vous assurer qu'aucun fichier ne sera perdu suite à la restauration, comme un fichier que vous auriez placé sur votre espace de stockage après la date de restauration choisie. Comme précisé, la restauration va en effet écraser l'ensemble des données actuelles afin de les remplacer par celles de la sauvegarde.
    ...
    Dès que vous êtes prêt à initier la sauvegarde, cliquez sur le bouton <code className="action">Valider</code>.
  </Tab>
</Tabs>
...
- **utiliser le logiciel FileZilla** : vous devrez télécharger au préalable ce logiciel depuis le site de son éditeur. OVHcloud met à votre disposition la documentation « [Utiliser le logiciel FileZilla avec son hébergement web](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide) », vous permettant de découvrir comment l'utiliser. Attention cependant, celle-ci ne se substitue pas à la documentation officielle de l'éditeur.

- **utiliser le logiciel Cyberduck** : vous devrez télécharger au préalable ce logiciel depuis le site de son éditeur. OVHcloud met à votre disposition la documentation « [Utiliser le logiciel Cyberduck avec son hébergement web](/guides/web-cloud/web-hosting/ftp-cyberduck-user-guide-on-mac) », vous permettant de découvrir comment l'utiliser. Attention cependant, celle-ci ne se substitue pas à la documentation officielle de l'éditeur.
...
Vous pouvez retrouver ces informations dans l'onglet <code className="action">FTP - SSH</code> de votre hébergement.

<img className="thumbnail" alt="FTP- SSH" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/ftp-ssh.png" loading="lazy" />

Si vous n’êtes plus en possession du mot de passe de l'utilisateur FTP, reportez-vous aux instructions décrites dans notre documentation « [Modifier le mot de passe d’un utilisateur FTP](/guides/web-cloud/web-hosting/ftp-change-password) ».
...
[Utiliser le logiciel FileZilla avec son hébergement web](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide)

[Utiliser le logiciel Cyberduck avec son hébergement web](/guides/web-cloud/web-hosting/ftp-cyberduck-user-guide-on-mac)
