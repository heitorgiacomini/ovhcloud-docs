...
<Region zones={['eu']}>
- Disposer d'une offre d'[hébergement web](https://www.ovhcloud.com/fr/web-hosting/) (ne fonctionne pas avec un hébergement Cloud Web).
</Region>
...
- Le statut « maintenance » apparaît dans votre <ManagerLink to="/#/web/hosting">espace client OVHcloud</ManagerLink>.
...
Vous pouvez retrouver ces informations dans notre guide [« Se connecter à l’espace de stockage FTP de son hébergement web »](/guides/web-cloud/web-hosting/ftp-connection).
