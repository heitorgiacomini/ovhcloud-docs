...
description: "Identifiez l'origine des lenteurs de votre site web et découvrez comment résoudre cette situation"
...
Pour connaître le cluster et le filer où se trouve votre hébergement mutualisé, consultez notre guide « [Hébergement web - Comment connaître son cluster et son filer](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer) ».
...
Placez, à la racine de votre site web dans l'[espace de stockage FTP de votre hébergement mutualisé](/guides/web-cloud/web-hosting/ftp-connection), un fichier que vous nommerez `phpinfo.php`.
...
Connectez-vous à votre base de données en suivant **l'étape 3** de notre guide sur la [création d'une base de données mutualisée](/guides/web-cloud/web-hosting/sql-create-database).

Si vous utilisez une base de données sur une offre **Web Cloud Databases**, consultez notre guide sur [la connexion à votre base de données présente sur une offre Web Cloud Databases](/guides/web-cloud/databases/db-connecting-database-server).
...
:::warning
Si vous rencontrez une erreur, consultez notre documentation sur les [erreurs courantes rencontrées avec une base de données](/guides/web-cloud/web-hosting/diagnosis-database-errors). Agissez ensuite à l'aide du guide ci-dessus pour corriger votre situation puis tentez à nouveau de vous connecter à votre base de données.
...
Vérifiez le moteur PHP, la version PHP et l'environnement d'exécution utilisés sur votre hébergement web, en vous aidant de notre guide sur la [configuration de votre hébergement web](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Pour comparer les versions de PHP disponibles en fonction de l'environnement d'exécution utilisé, consultez **l'étape 2** du guide sur la [configuration de la version PHP sur votre hébergement](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Pour analyser les connexions sortantes de votre hébergement, consultez les logs **OUT** de ce dernier. Vous pouvez vous aider de notre documentation sur [la consultation des logs de votre hébergement](/guides/web-cloud/web-hosting/logs-and-statistics).
...
Pour effectuer cette action, consultez les logs **WEB** de votre hébergement web à l'aide de notre documentation sur [comment consulter les logs de votre hébergement](/guides/web-cloud/web-hosting/logs-and-statistics).
...
<img className="thumbnail" alt="Analyse réseau Firefox" src="/images/assets/screens/other/browsers/diagnostic-tools/F12.png" loading="lazy" />
...
:::info
OVHcloud propose plusieurs [offres CDN](https://www.ovhcloud.com/fr/web-hosting/options/). Si vous souhaitez en utiliser ou en activer une pour votre hébergement web, connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> puis consultez notre guide sur [l'utilisation du CDN OVHcloud](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
...
Consultez notre guide sur l'[optimisation des performances pour votre site Internet](/guides/web-cloud/web-hosting/optimise-your-website-performance).

Vous pouvez trouver des pistes d'optimisation pour votre site en l'analysant sur [gtmetrix.com](https://gtmetrix.com) (ce site n'est pas affilié à OVHcloud).
