...
<summary>Activer le SFTP sur une offre d'hébergement web **gratuite**, **Starter**, **Perso** ou **Startup**</summary>
...
<summary>Activer le SFTP sur une offre d'hébergement web **Pro**, **Performance**, **Agency**, **Agency Plus** ou **Agency Max**</summary>
