...
description: "Utilisez l'API publique OVHcloud pour configurer l'affichage de vos données dans le Whois"
...
<Api version="v1" section="/domain" method="GET" route={"/domain/\{serviceName\}/rules/optin"} />
...
<Api version="v1" section="/domain" method="GET" route={"/domain/\{serviceName\}/configurations/optin"} />
...
<Api version="v1" section="/domain" method="PUT" route={"/domain/\{serviceName\}/configurations/optin"} />
...
<Api version="v1" section="/domain" method="GET" route={"/domain/\{serviceName\}/rules/emailsObfuscation"} />
...
<Api version="v1" section="/domain" method="GET" route={"/domain/\{serviceName\}/configurations/obfuscatedEmails"} />
...
<Api version="v1" section="/domain" method="PUT" route={"/domain/\{serviceName\}/configurations/obfuscatedEmails"} />
...
<Api version="v1" section="/domain" method="POST" route={"/domain/\{serviceName\}/configurations/obfuscatedEmails/refresh"} />
