...
#### Étape 1 : Modification du TAG de votre nom de domaine

Pour pouvoir transférer votre nom de domaine chez OVHcloud, vous devez préalablement indiquer le TAG OVHcloud chez votre registrar actuel. Le TAG OVHcloud est « OVH-FR ». La liste des TAGS des différents registrars est disponible sur le site officiel du registre [Nominet](https://registrars.nominet.uk/uk-namespace/registrar-agreement/list-of-registrars/).

:::info
Si vous ne parvenez pas à effectuer la modification du Tag de votre nom de domaine via
...
votre nom de domaine sera ensuite présent dans votre <ManagerLink to="/">espace client OVHcloud</ManagerLink> sous quelques heures.
...
#### Renouvellement du nom de domaine suite a un transfert

Le transfert étant gratuit, la date d'expiration du nom de domaine suite à son transfert sera la même qu'avant son transfert. Pour le renouveler suite au transfert, rendez-vous sur le [site OVHcloud](https://www.ovh.com/cgi-bin/order/renew.cgi).
