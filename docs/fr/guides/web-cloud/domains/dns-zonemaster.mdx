...
> Avant de changer les serveurs DNS, vous pouvez effectuer une recherche avancée à la l'aide de la case <code className="action">Options</code> en saisissant « dns1.test.tld » et « dns2.test.tld » dans les cases `Serveurs DNS`.<br/>
