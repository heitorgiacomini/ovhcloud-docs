...
Connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Dans la section <code className="action">Noms de domaine</code>, sélectionnez le nom de domaine concerné. Cliquez sur l'onglet <code className="action">Zone DNS</code>.
...
Pour ajouter un enregistrement SPF dans la configuration OVHcloud de votre nom de domaine, connectez-vous à votre <ManagerLink to="/">espace client OVHcloud</ManagerLink>. Rendez-vous dans la section <code className="action">Noms de domaine</code>, cliquez sur le nom de domaine concerné, puis rendez-vous ensuite dans l’onglet <code className="action">Zone DNS</code>.
