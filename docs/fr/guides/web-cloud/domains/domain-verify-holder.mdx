---
title: Nom de domaine - Gestion du contact titulaire
description: "Découvrez comment vérifier, corriger ou compléter les informations de contact du titulaire d'un nom de domaine suite à la réception d'un e-mail d'alerte d'OVHcloud"
...
Après la commande, le titulaire du nom de domaine recevra un e-mail d'OVHcloud afin de valider son adresse e-mail et confirmer sa bonne joignabilité.
...
En cliquant sur <code className="action">Confirmer votre adresse e-mail</code>, une nouvelle page s'ouvrira sur un lien validant directement l'adresse e-mail du titulaire.
...
<Tabs>
  ...
  <Tab label="Étape 2">
    ...
    Retrouvez ensuite la mention **Contacts** dans le cadre **Abonnement**. Cliquez sur le bouton <code className="action">...</code> à droite puis sur <code className="action">Gérer les contacts</code>.
  ...
  <Tab label="Étape 3">
    Sur la nouvelle page, rendez-vous dans le cadre **Titulaire**, puis cliquez sur le bouton <code className="action">Modifier</code>.
  ...
  <Tab label="Étape 4">
    ...
    Si vos modifications concernent **uniquement** des informations différentes de celles mentionnées ci-dessus, réalisez-les directement, puis cliquez sur <code className="action">Valider</code>. Dans ce cas précis, il ne sera pas nécessaire de lancer une demande de changement de titulaire. Pour cette opération, vous n'avez pas besoin de confirmer les modifications par e-mail.
    
    Le cas échéant et pour initier la demande de changement de titulaire, cliquez sur le lien <code className="action">Cliquez ici pour continuer</code> situé en bas de page.
...
Retrouvez plus de détails sur le changement de titulaire dans notre guide : « [Nom de domaine - Comment changer le titulaire ?](/guides/web-cloud/domains/trade-domain) ».
  </Tab>
</Tabs>
...
Si l'adresse e-mail associée à votre nom de domaine est incorrecte ou inaccessible (par exemple à cause d'une erreur de saisie), [contactez le support OVHcloud](https://www.ovhcloud.com/fr/support-levels/).

Veuillez noter que le titulaire du domaine devra à nouveau justifier son identité en fournissant les documents requis selon son type (particulier, entreprise, association, etc.).
...
Pour certaines extensions ( par exemple : .fr, .it, .es), l'administrateur du domaine peut se rendre directement sur son <ManagerLink to="/">espace client OVHcloud</ManagerLink> et modifier l'adresse du contact titulaire en suivant les étapes décrites à l'étape 2 de cette page.
...
<Tabs>
  <Tab label="Étape 1">
    Accédez à la page <ManagerLink to="/#/web/ongoing-operations">Opérations en cours</ManagerLink>, puis retrouvez le nom de domaine concerné.
    
    <img className="thumbnail" alt="Opérations en cours" src="/images/assets/screens/control-panel/product-selection/web-cloud/ongoing-operations.png" loading="lazy" />
  </Tab>
  <Tab label="Étape 2">
    Cliquez sur le bouton <code className="action">⁝</code> situé à droite, puis sur <code className="action">Modifier l'opération</code>.
  ...
  <Tab label="Étape 3">
    Dans la fenêtre qui s'ouvre, cochez le choix <code className="action">Relancer l'opération</code>, puis cliquez sur <code className="action">Confirmer</code>.
