...
description: Préparez et configurez la zone DNS de votre nom de domaine OVHcloud pour la connecter à un hébergement Wix
...
Repérez les enregistrements « A » existants pour votre nom de domaine seul (exemple : `mydomain.ovh.`) et pour le sous-domaine « www » (exemple : `www.mydomain.ovh.`).
    ...
    **3 - Modification :** si un enregistrement « A » existe pour le nom de domaine seul, cliquez sur le bouton <code className="action">...</code> puis sur <code className="action">Modifier l'entrée</code>. Laissez le champ **Sous-domaine** vide et remplacez la cible par l'adresse IPv4 relevée depuis votre interface Wix. Cliquez sur <code className="action">Suivant</code> et validez.
    
    Si aucun enregistrement « A » n'existe, cliquez sur <code className="action">Ajouter une entrée</code> en haut à droite, sélectionnez le champ de pointage <code className="action">A</code>, laissez le champ **Sous-domaine** vide et saisissez l'adresse IPv4 relevée depuis votre interface Wix dans le champ **Cible**. Cliquez sur <code className="action">Suivant</code> et validez.
...
Repérez les enregistrements « CNAME » existants pour le sous-domaine « www » (exemple : `www.mydomain.ovh.`).
    ...
    **3 - Modification :** si un enregistrement « CNAME » existe pour le sous-domaine « www », cliquez sur le bouton <code className="action">...</code> puis sur <code className="action">Modifier l'entrée</code>. Remplacez uniquement la **Cible** par la valeur relevée depuis votre interface Wix. Cliquez sur <code className="action">Suivant</code> et validez.
    
    Si aucun enregistrement « CNAME » n'existe pour le sous-domaine « www », cliquez sur <code className="action">Ajouter une entrée</code> en haut à droite, sélectionnez le champ de pointage <code className="action">CNAME</code>, saisissez `www` dans le champ **Sous-domaine** et la valeur relevée depuis votre interface Wix dans le champ **Cible**. Cliquez sur <code className="action">Suivant</code> et validez.
  </Tab>
</Tabs>
