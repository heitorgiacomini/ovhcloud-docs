...
Repérez les enregistrements « A » existants pour votre nom de domaine seul (exemple : `mydomain.ovh.`) et pour le sous-domaine « www » (exemple : `www.mydomain.ovh.`).
    ...
    **2 - Suppression :** supprimez tous les enregistrements « A » existants pour le sous-domaine « www ». Si plus de 2 enregistrements « A » existent pour le nom de domaine seul, supprimez les enregistrements excédentaires pour n'en conserver que 2. Pour chaque enregistrement à supprimer, cliquez sur le bouton <code className="action">...</code> à droite de la ligne correspondante, puis sur <code className="action">Supprimer l'entrée</code>.
    
    **3 - Modification :** modifiez chaque enregistrement « A » conservé pour le nom de domaine seul en cliquant sur le bouton <code className="action">...</code> puis sur <code className="action">Modifier l'entrée</code>. Remplacez la cible par l'une des 2 adresses IPv4 de Webflow (une adresse différente par enregistrement) :
...
Repérez les enregistrements « CNAME » existants pour le sous-domaine « www » (exemple : `www.mydomain.ovh.`).
    ...
    **3 - Modification :** si un enregistrement « CNAME » existe pour le sous-domaine « www », cliquez sur le bouton <code className="action">...</code> puis sur <code className="action">Modifier l'entrée</code>. Remplacez uniquement la **Cible** par `proxy-ssl.webflow.com.`. Cliquez sur <code className="action">Suivant</code> et validez.
    
    Si aucun enregistrement « CNAME » n'existe pour le sous-domaine « www », cliquez sur <code className="action">Ajouter une entrée</code> en haut à droite, sélectionnez le champ de pointage <code className="action">CNAME</code>, saisissez `www` dans le champ **Sous-domaine** et `proxy-ssl.webflow.com.` dans le champ **Cible**. Cliquez sur <code className="action">Suivant</code> et validez.
  </Tab>
</Tabs>
