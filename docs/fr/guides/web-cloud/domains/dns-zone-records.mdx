...
**L'[édition d'une zone DNS](/guides/web-cloud/domains/dns-zone-edit) est une manipulation sensible** : réaliser un changement inopportun pourrait, par exemple, rendre indisponible l'accès à votre site internet ou la réception de nouveaux messages sur vos adresses e-mail.
...
<Tabs>
  ...
  <Tab label="Champ NS">
    **N**ame **S**erver<br/><br/>
    ...
    :::warning
    Si vous [éditez une zone DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit), ne modifiez pas, via le bouton <code className="action">Modifier en mode textuel</code>, les enregistrements NS de votre zone DNS au profit de serveurs DNS externes à OVHcloud. En effet, cette zone DNS fonctionne **uniquement** avec des serveurs DNS OVHcloud.
    :::
...
<Tabs>
  <Tab label="MX">
    **M**ail e**X**changer<br/><br/>
    ...
    Il est probable que votre fournisseur e-mail dispose de plusieurs serveurs e-mail : plusieurs champs MX doivent donc être créés. Consultez notre documentation « [Ajouter un champ MX à la configuration de son nom de domaine](/guides/web-cloud/domains/dns-zone-mx) ».
  ...
  <Tab label="SPF">
    **S**ender **P**olicy **F**ramework <br/><br/>
    ...
    Consultez notre documentation « [Ajouter un champ SPF à la configuration de son nom de domaine](/guides/web-cloud/domains/dns-zone-spf) » pour en savoir plus.
  </Tab>
  <Tab label="DKIM">
    **D**omain**K**eys **I**dentified **M**ail<br/><br/>
    ...
    Consultez notre documentation « [Configurer un enregistrement DKIM](/guides/web-cloud/domains/dns-zone-dkim) » pour en savoir plus.
  </Tab>
  <Tab label="DMARC">
    **D**omain-based **M**essage **A**uthentication, **R**eporting and **C**onformance<br/><br/>
    ...
    Consultez notre documentation « [Configurer un enregistrement DMARC sur votre nom de domaine](/guides/web-cloud/domains/dns-zone-dmarc) » pour en savoir plus.
  </Tab>
</Tabs>
