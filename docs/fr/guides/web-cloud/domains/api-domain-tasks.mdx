...
description: Fonctionnement des tâches asynchrones sur les noms de domaine
...
<Api version="v1" section="/me" method="GET" route={"/me/task/domain"} />
...
<Api version="v1" section="/me" method="GET" route={"/me/task/domain/\{id\}"} />
...
<Api version="v1" section="/me" method="GET" route={"/me/task/domain/\{id\}/argument"} />
...
<Api version="v1" section="/me" method="GET" route={"/me/task/domain/\{id\}/argument/\{key\}"} />
...
<Api version="v1" section="/me" method="PUT" route={"/me/task/domain/\{id\}/argument/\{key\}"} />


{/* prettier-ignore */}
<Tabs>
  <Tab label="Exemple simplifié de requête">
    ```sh
...
<Api version="v1" section="/me" method="POST" route={"/me/task/domain/\{id\}/relaunch"} />
