...
description: "Découvrez le rôle d'une zone DNS et les enregistrements qu'elle contient pour un nom de domaine"
...
Pour une meilleure compréhension de l'ensemble, nous vous recommandons au préalable de consulter notre guide « [Tout savoir sur les serveurs DNS](/guides/web-cloud/domains/dns-server-general-information) ».
...
Pour plus d'informations, consultez notre page web expliquant [comment fonctionne un serveur DNS](https://www.ovhcloud.com/fr/domains/dns-server/).
...
Consultez notre guide sur [les enregistrements DNS](/guides/web-cloud/domains/dns-zone-records) pour plus d'informations sur les différents types d'enregistrements évoqués ci-dessus. Vous y retrouverez des éléments qui vous permettront, par exemple, de mieux appréhender l'[édition d'une zone DNS OVHcloud](/guides/web-cloud/domains/dns-zone-edit).
