...
- Disposer d'une offre MX Plan (incluse dans l'offre d’[hébergement web](https://www.ovhcloud.com/fr/web-hosting/) ou l'offre MX Plan commandée séparément), une de nos [offres e-mail OVHcloud](https://www.ovhcloud.com/fr/emails/), ou un service e-mail externe.
...
Retrouvez ci-dessous la configuration MX OVHcloud à utiliser pour nos solutions MX Plan (seule ou incluse dans une offre d’[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/)), [E-mail Pro](https://www.ovhcloud.com/fr/emails/email-pro/), [Exchange](https://www.ovhcloud.com/fr/emails-exchange/) et [Zimbra](https://www.ovhcloud.com/fr/emails/zimbra-emails/). Nos serveurs e-mail disposent d'un antispam et d'un antivirus intégré.

</Region>

<Region zones={['ca']}>

Retrouvez ci-dessous la configuration MX OVHcloud à utiliser pour nos solutions MX Plan (seule ou incluse dans une offre d’[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/)) et [Exchange](https://www.ovhcloud.com/fr/emails-exchange/). Nos serveurs e-mail disposent d'un antispam et d'un antivirus intégré.

</Region>

<Region zones={['apac']}>

Retrouvez ci-dessous la configuration MX OVHcloud à utiliser pour nos solutions MX Plan (seule ou incluse dans une offre d’[hébergement web OVHcloud](https://www.ovhcloud.com/fr/web-hosting/)). Nos serveurs e-mail disposent d'un antispam et d'un antivirus intégré.
...
<Tabs>
  ...
  <Tab label="Étape 2">
    ...
    <img className="thumbnail" alt="Enregistrement MX DNS" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/dns-zone/mx-entries-research.png" loading="lazy" />
  </Tab>
  <Tab label="Étape 3">
    - Si des enregistrements MX existent déjà et que vous souhaitez les modifier, cliquez sur le bouton <code className="action">...</code> à droite de chaque ligne du tableau concernée puis sur <code className="action">Modifier l'entrée</code>.
    - Si aucun enregistrement MX n'est présent, cliquez sur le bouton <code className="action">Ajouter une entrée</code> à droite du tableau puis choisissez <code className="action">MX</code>.
  </Tab>
  <Tab label="Étape 4">
    ...
    **Si vous disposez d'une solution e-mail OVHcloud**, reportez-vous aux informations données à l'étape « [Connaître la configuration MX d'OVHcloud](#mxovhcloud) ».
    ...
    <img className="thumbnail" alt="Enregistrement MX DNS" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/dns-zone/modify-a-dns-zone-record-mx-step-1.png" loading="lazy" />
  </Tab>
  <Tab label="Étape 5">
    Une fois les informations complétées, finalisez les étapes puis cliquez sur <code className="action">Valider</code>.
  </Tab>
</Tabs>
