...
description: Find out how to access the OPCP node inventory
...
- Being an administrator of the [OPCP](https://www.ovhcloud.com/en-gb/hosted-private-cloud/onprem-cloud-platform/) infrastructure and have access to the administration interface `admin.dashboard`.
