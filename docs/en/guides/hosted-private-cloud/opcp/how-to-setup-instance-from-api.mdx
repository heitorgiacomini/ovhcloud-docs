...
description: Learn how to deploy an OPCP instance via OpenStack APIs by configuring networks, subnets, instances, and SSH keys
...
- [Load the environment variables for the project](/guides/hosted-private-cloud/opcp/how-to-use-api-and-get-credentials).
