...
- the outbound flows from OPCP toward your infrastructure services (NTP, DNS, S3<sup>1</sup> for backups, LDAP, syslog).
...
<img className="thumbnail" alt="OPCP NANOPOD topology - 1 controller" src="/images/hosted-private-cloud/opcp/opcp-network-architecture/opcp-1controller-setup.png" loading="lazy" />
...
<img className="thumbnail" alt="OPCP STANDARD POD/FABRIC topology - 3 controllers" src="/images/hosted-private-cloud/opcp/opcp-network-architecture/opcp-3controllers-setup.png" loading="lazy" />
