...
- **Direct link:** <ManagerLink to="/#/dedicated/nutanix">Nutanix</ManagerLink>
...
In <code className="action">Network</code>, click on <code className="action">Load Balancer</code> and select the Load Balancer associated with your cluster.
