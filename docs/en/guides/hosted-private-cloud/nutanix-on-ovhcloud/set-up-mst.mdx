...
To create the container, you first need to create a project: [Create your first Public Cloud project - OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
