...
description: This guide is designed to help you retrieve the fields from your SAP logs to perform searches in your logs
...
If you haven't configured your OVHcloud Logs Data Platform service, please take note of our documentation [SAP logs on OVHcloud Logs Data Platform - Solution Setup](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-logs-on-ovhcloud-logs-data-platform-solution-setup) to get started.
