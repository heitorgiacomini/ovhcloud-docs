...
description: This guide provides instructions for using the SAP system Terraform module developed by OVHcloud
...
- [VMware on OVHcloud solution](https://www.ovhcloud.com/en-gb/enterprise/products/hosted-private-cloud/) deployed.
...
:::info
Where "SAP HANA VM Storage Policy" has been previously created on vSphere interface with a thick provisioning policy. To know more about our recommendations about this VM Storage Policy, we advise you to read [this guide](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-hana-template-vmware#configure-advanced-parameters).
