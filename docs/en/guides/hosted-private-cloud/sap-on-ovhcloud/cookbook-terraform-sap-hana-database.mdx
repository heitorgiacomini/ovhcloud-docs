...
description: This guide provides instructions for using the SAP HANA databases Terraform module developed by OVHcloud
...
:::info
Where "SAP HANA VM Storage Policy" has been previously created on vSphere interface with a thick provisioning policy. To know more about our recommendations about this VM Storage Policy, we advise you [this guide](/guides/hosted-private-cloud/sap-on-ovhcloud/cookbook-sap-hana-template-vmware#configure-advanced-parameters).
