...
description: This guide provides instructions for deploying a SLES for SAP virtual machine with SAP HANA, OVHcloud Backint Agent and SAP logs on OVHcloud Logs Data Platform pre-installed
