...
description: Find out how to manage load balancing with DRS
...
<img className="thumbnail" alt="Function DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png" loading="lazy" />
...
If DRS is not active in your cluster, go to the <code className="action">Configure</code> tab and then select <code className="action">vSphere DRS</code> available in the <code className="action">Services</code> menu.

Click on <code className="action">EDIT</code> and then on the slide button <code className="action">vSphere DRS</code> to enable it.

<img className="thumbnail" alt="Activation DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
Finally, the "Virtual Machine Automation" option allows you to configure specific DRS settings for certain VMs in the `VM Overrides` submenu of the <code className="action">Configure</code> tab. (Some VMs may have a partially automated migration mode while the cluster will be fully automated.)

<img className="thumbnail" alt="Automation DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Additional Options" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="Advanced Options" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### DRS rules

In the <code className="action">Configure</code> tab you can find the management of `VM/Host Rules`.

<img className="thumbnail" alt="DRS rules" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
The fourth rule, **Virtual Machines to Virtual Machines** is explained in our guide on [VMware HA](/guides/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability).

<img className="thumbnail" alt="DRS rules" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
