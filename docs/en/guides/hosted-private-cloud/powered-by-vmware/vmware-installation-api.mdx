...
description: Find out how to implement and use the vSphere SDK
...
This example uses a VM installed with Debian 9, deployed from [templates available for your Hosted Private Cloud infrastructure](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
This example uses a VM installed with Ubuntu 18.04, deployed from [templates available for your Hosted Private Cloud infrastructure](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
After reading the terms, accept them and continue by pressing <code className="action">Enter</code>.

After the installation, additional modules will be installed. Hit <code className="action">Enter</code> to continue the installation.
