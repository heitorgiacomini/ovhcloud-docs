...
description: This guide will show you how to implement a bypass solution, using the VMware DRS mechanism
...
- [Veeam Managed Backup](https://www.ovhcloud.com/en-gb/enterprise/products/hosted-private-cloud/veeam-backup-managed/) option enabled
...
To implement this solution, click on the relevant cluster, then go to the <code className="action">Configure</code> tab and the <code className="action">VM/Host Rules</code> section
