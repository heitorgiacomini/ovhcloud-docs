...
In <code className="action">General information</code>, verify that the vRack shown is the one linked to your public IP block.
    ...
    <img className="thumbnail" alt="Select VDC and check vRack" src="/images/hosted-private-cloud/powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-03.png" loading="lazy" />
...
Locate the vRack segment named `vRack segment - VLAN0` or `vRack segment - PUBLIC`.
    ...
    <img className="thumbnail" alt="Add a subnet on the vRack segment" src="/images/hosted-private-cloud/powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-05.png" loading="lazy" />
...
<img className="thumbnail" alt="Select Direct network type and gateway" src="/images/hosted-private-cloud/powered-by-vmware/vcd-declare-public-gateway/vcd-declare-public-gateway-08.png" loading="lazy" />
