...
- a deployed [NSX Edge Services Gateway](/guides/hosted-private-cloud/powered-by-vmware/nsx-add-new-tier1-gateway)
...
![Menu](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en01dash.png)

On the left side, navigate to the `NSX Edges` section then click on the appliance you're setting up.

![NSX](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en02nsx.png)
...
![IPSEC](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en03vpn.png)
...
![IPSEC](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en04global.png)

In the `IPsec VPN Sites` section, click `+ Add`.

![IPSEC](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en04bisadd.png)
...
![IPSEC](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en05newipsec.png)

In the `Tunnel Configuration` page, set your encryption parameters (including certificates if needed) then click `Add`.

![IPSEC](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en06ipsectunnel.png)

You can now `Start` the IPsec VPN service and `Publish` all the changes made.

![IPSEC](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en07ipsecstart.png)
...
![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en08l2.png)
...
![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en09l2global.png)
...
![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en10l2peer.png)

You can now `Start` the L2 VPN service and `Publish` all the changes made.

![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en11l2pub.png)
...
![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en12l2client.png)
...
![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en13l2clientset.png)

You can now `Start` the L2 VPN service and `Publish` all the changes made.

![L2](/images/guides/hosted-private-cloud/powered-by-vmware/nsx-configurer-un-vpn-via-une-gateway-edge/en14l2clientpub.png)
