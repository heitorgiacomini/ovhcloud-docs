...
description: Find out how to install VMware tools on Linux or Windows
...
To mount the VMware tools disk from the Vsphere web client, right-click on the VM, then click on <code className="action">Guest OS</code> and finally on <code className="action">Install VMware Tools</code>. 
