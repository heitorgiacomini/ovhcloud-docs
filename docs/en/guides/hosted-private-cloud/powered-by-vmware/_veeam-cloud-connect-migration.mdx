...
Use the `Export Entire Backup Chain` option in the Cloud Connect console.
...
Use the `Add Existing Backup` option in the Veeam Backup & Replication Enterprise Edition console.
