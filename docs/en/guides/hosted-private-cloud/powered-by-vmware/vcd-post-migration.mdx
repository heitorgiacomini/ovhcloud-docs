...
- A [Public VCF as-a-Service](https://www.ovhcloud.com/en-gb/lp/vmware-vcd-evolution/) on OVHcloud solution.
- Being the technical administrator of the managed [VMware vSphere on OVHcloud](https://www.ovhcloud.com/en-gb/hosted-private-cloud/vmware/) infrastructure.
