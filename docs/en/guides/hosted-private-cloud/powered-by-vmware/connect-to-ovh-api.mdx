...
![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_1.jpg)

Cliquez sur "Explore the OVH API".

Une fois sur l'interface, cliquez sur le lien login.

![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_login.jpg)

Entrez votre nic-handle et votre mot de passe. Les logins sont les mêmes que pour l'espace client OVH.

![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_log.jpg)

## Utilisation de l'API

Rendez vous dans la partie dedicatedCloud.

![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/connection_api_example.jpg)
...
![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/api.jpg)
...
![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/retrieve_infos.PNG)

Je modifie la description avec l'appel PUT : /dedicatedCloud/\{serviceName\}/datacenter/\{datacenterId\}

![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/command_put.PNG)

Et voici les informations mise à jour :

![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/dc_after_put.PNG)
...
![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/access_ip.PNG)
...
![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/access_ip_show.PNG)
...
![](/images/guides/hosted-private-cloud/powered-by-vmware/connect-to-ovh-api/delete_datacenter.PNG)
