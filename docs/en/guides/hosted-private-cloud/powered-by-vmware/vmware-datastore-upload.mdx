...
Log in to the vSphere web interface, using the guide “[Log in to the vSphere on OVHcloud web console](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connection)” if necessary.
