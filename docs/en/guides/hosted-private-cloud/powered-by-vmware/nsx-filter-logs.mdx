...
description: Learn how to access and filter NSX-T firewall logs to troubleshoot blocked traffic on your Hosted Private Cloud.
...
- Access to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> with NSX-T enabled, or to your Syslog/log aggregation system
...
- Use <code className="action">Log Insight</code> to create filters and dashboards
