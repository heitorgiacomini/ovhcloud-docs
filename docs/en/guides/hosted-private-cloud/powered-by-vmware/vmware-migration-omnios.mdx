...
You can also use the <code className="action">Advanced</code> option to migrate only one disk if the VM has multiple disks.
    ...
    <img className="thumbnail" alt="Advanced datastore selection" src="/images/hosted-private-cloud/powered-by-vmware/vmware-migration-omnios/omnios-09.png" loading="lazy" />
