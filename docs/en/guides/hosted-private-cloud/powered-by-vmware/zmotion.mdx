---
title: Zmotion
description: Find out how the Zmotion process works
...
<img className="thumbnail" alt="zmotion" src="/images/hosted-private-cloud/powered-by-vmware/zmotion/zmotionPrez.png" loading="lazy" />
