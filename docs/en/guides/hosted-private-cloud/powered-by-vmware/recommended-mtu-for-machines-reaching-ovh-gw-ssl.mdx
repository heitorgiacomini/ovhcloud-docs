...
description: Find out how to check your current MTU size and set it up to the OVHcloud recommended value
...
- a [VMware on OVHcloud infrastructure](https://www.ovhcloud.com/en-gb/hosted-private-cloud/vmware/)
