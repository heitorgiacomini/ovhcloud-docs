...
description: Find out how OVHcloud hourly snapshots work
...
Once the files are copied, simply add this VM to your **Inventory** by clicking on the `.vmx` file, then on the <code className="action">Register VM</code> menu item above.
...
We recommend using a full backup solution, such as our [Veeam Managed Backup](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service) service, or any other system that performs a full backup of your virtual machines.
