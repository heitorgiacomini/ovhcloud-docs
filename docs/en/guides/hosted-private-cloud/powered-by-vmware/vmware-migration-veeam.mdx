...
With [OVHcloud vRack](https://www.ovhcloud.com/en-gb/network/vrack/), you can create up to 4,000 VLANs, which allows you to replicate your current IP address plan without any re-IP.
...
For internet-exposed services, allocate additional public IPs or use the [Bring Your Own IP (BYOIP)](https://www.ovhcloud.com/en-gb/network/byoip/) feature to retain your existing IP addresses.
...
For higher bandwidth and lower latency, you can subscribe to [OVHcloud Connect](https://www.ovhcloud.com/en-gb/network/ovhcloud-connect/), which provides an MPLS-like link between your on-prem infrastructure and your OVHcloud tenant.

With [OVHcloud Connect](https://www.ovhcloud.com/en-gb/network/ovhcloud-connect/), latency is controlled, and you can choose the bandwidth you need, from 200 Mbps up to several Gbps.
...
Move VMs to target storage using [Storage vMotion](/guides/hosted-private-cloud/powered-by-vmware/storage-vmotion) and configure backup jobs in [OVHcloud Object Storage](https://www.ovhcloud.com/en-gb/public-cloud/object-storage/) to protect your workloads.
...
1. **Define Backup Storage:**
    - Use OVHcloud **[S3*-compatible Object Storage](https://www.ovhcloud.com/en-gb/public-cloud/object-storage/)** as a backup repository for scalability and cost efficiency.
