...
description: Find the most frequently asked questions about Public VCF as-a-Service
...
For more information, see the page [Public VCF as-a-Service - The fundamentals of Public VCF as-a-Service](/guides/hosted-private-cloud/powered-by-vmware/vcd-get-concepts#key-features).
...
<details>
<summary>How will the migration be carried out by OVHcloud ?</summary>


If you choose to migrate to Public VCF as-a-Service, OVHcloud will perform the migration for you, you can follow the following guide [Public VCF as-a-Service - Audit tricky use cases of migration](/guides/hosted-private-cloud/powered-by-vmware/vcd-migration-use-cases) for further information on the full process.
...
<details>
<summary>Can I still access vSphere ESXi and the vCenter API with Public VCF as-a-Service ?</summary>
...
<details>
<summary>Can I still use products like Veeam, Naviko, Rubik to back up my VMs ?</summary>
...
For backups, we will offer you **Veeam Managed Backup** with an integrated plugin for VM backups, you can follow the following guide for more information: [Public VCF as-a-Service - Backup with Veeam Data Platform](/guides/hosted-private-cloud/powered-by-vmware/vcd-backup).
...
<details>
<summary>Can I use rules like affinity and anti-affinity as before with vSphere ?</summary>
...
<details>
<summary>Can I choose the Thin or Thick disk type with Public VCF as-a-Service when I create a new virtual machine or disk ?</summary>
...
If you require training or technical support to implement our solutions, contact your sales representative or click [this link](https://www.ovhcloud.com/en-gb/professional-services/) to get a quote and request a custom analysis of your project from our Professional Services team experts.
