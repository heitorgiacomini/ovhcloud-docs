...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Extract an eml file from OWA" src="/images/web-cloud/email-and-collaborative-solutions/troubleshooting/diagnostic-headers/owa02.mp4" />
