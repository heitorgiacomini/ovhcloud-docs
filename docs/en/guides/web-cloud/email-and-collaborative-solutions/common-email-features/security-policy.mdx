...
description: Find out how to manage the security policy of your email service
...
|---|---|
|Click on the `More` tab, then on <code className="action">Manage security policy</code>.|Click on <code className="action">Security</code>.|
...
:::info
If you do not see the <code className="action">More</code> tab appear in the control panel of your <code className="action">MX Plan</code> service, this means that you are on a legacy MX Plan offer. There is no security policy management on the legacy MX Plan solution.
...
Once this information has been entered, you can save these changes for Email and Email Pro solutions by clicking on <code className="action">Next</code>, then <code className="action">Confirm</code>. For the Exchange solution, click <code className="action">Save changes</code>.
...
Once you have made your choice, confirm these changes by clicking <code className="action">Save changes</code>.
