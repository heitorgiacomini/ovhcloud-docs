...
description: Find out how to subscribe to and manage an Office 365 Reseller (CSP2) service from OVHcloud
...
- An <ManagerLink to="/">OVHcloud customer account</ManagerLink>
...
- **Direct link:** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Click <code className="action">Order</code> to complete.
...
Use the <i className="icons-pen"></i> to change the total number of licences in the subscription. The <i className="icons-bin"></i> allows you to cancel the subscription and all of its licences.
