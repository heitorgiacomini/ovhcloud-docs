...
You can purchase Outlook licenses in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and Office 365 licenses on the [Microsoft 365](https://www.ovhcloud.com/en-gb/collaborative-tools/microsoft-365/) page. We recommend using one of these solutions if you would like to use Outlook email software, or more software from the Office suite, depending on your needs.
