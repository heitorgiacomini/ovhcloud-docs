...
description: Find out how to use mailing lists
...
- an MX Plan 100 minimum or [web hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/) eligible for mailing lists
...
To create a mailing list, go to the <code className="action">Mailing lists</code> tab for your email service.
...
To create a new mailing list, click <code className="action">Add a mailing list</code>.
...
To modify the mailing list options, click the <code className="action">...</code> to the right-hand side of it. You can then update the options, delete the mailing list, or share the list of subscribers via email.
...
|---|---|
|Click <code className="action">Add subscribers</code> on the right-hand side.|Click <code className="action">Remove via a file</code> on the right-hand side.|
...
- entering the email address manually by clicking <code className="action">Add an email address</code>
...
Click <code className="action">Export subscribers in CSV format</code> to generate a CSV file containing all of your subscribers. This option is not available in our example, because no subscribers have been added.
...
|---|---|
|Click <code className="action">Add moderators</code> on the right-hand side.|Click <code className="action">Remove via a file</code> on the right-hand side.|
