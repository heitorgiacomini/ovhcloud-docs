...
<Tabs>
  ...
  <Tab label="Step 5">
    ...
    <Region zones={['eu']}>
    - **Server**: imap.mail.ovh.net **or** ssl0.ovh.net
    - Port : **993**
    ...
    <Region zones={['eu']}>
    - **Server**: smtp.mail.ovh.net **or** ssl0.ovh.net
    - Port : **465**
    - Encryption method : **SSL/TLS**
    </Region>
...
- **Incoming mail server**: imap.mail.ovh.net **or** ssl0.ovh.net
- **Outgoing mail server (SMTP)**: smtp.mail.ovh.net **or** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Account type**: select IMAP
- **Incoming mail server**: imap.mail.ovh.ca
- **Outgoing mail server (SMTP)**: smtp.mail.ovh.ca
</Region>
...
**Password**: enter the password associated with your e-mail address.
...
The window is divided into two parts, **Incoming mail** and **Outgoing mail**. Click on the part you wish to modify.
    ...
    Find this number in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, in the <code className="action">Web Cloud</code> section then <code className="action">Email Pro</code>. The server name is visible in the **Connection** box of the <code className="action">General information</code> tab.
...
<Tabs>
  <Tab label="IMAP configuration">
    <Region zones={['eu']}>
    - **Incoming server**: imap.mail.ovh.net **or** ssl0.ovh.net.
    ...
    <Region zones={['ca', 'apac']}>
    - **Incoming server**: imap.mail.ovh.ca.
    - **User name**: enter the **full** e-mail address.
    - **Password**: enter the e-mail address password.
    - **Port**: 993.
    - **Security type**: SSL/TLS.
  ...
  <Tab label="POP configuration">
    <Region zones={['eu']}>
    - **Incoming server**: pop.mail.ovh.net **or** ssl0.ovh.net.
    - **User name**: enter the **full** e-mail address.
    - **Password**: enter the e-mail address password.
    - **Port**: 995.
    - **Security type**: SSL/TLS.
    ...
    <Region zones={['ca', 'apac']}>
    - **Incoming server**: pop.mail.ovh.ca.
    - **User name**: enter the **full** e-mail address.
    - **Password**: enter the e-mail address password.
    - **Port**: 995.
    - **Security type**: SSL/TLS.
...
<Region zones={['eu']}>
- **Outgoing server**: smtp.mail.ovh.net **or** ssl0.ovh.net.
- **User name**: enter the **full** e-mail address.
- **Password**: enter the e-mail address password.
- **Port**: 465.
- **Security type**: SSL/TLS.
...
<Region zones={['ca', 'apac']}>
- **Outgoing server**: smtp.mail.ovh.ca.
- **User name**: enter the **full** e-mail address.
- **Password**: enter the e-mail address password.
- **Port**: 465.
- **Security type**: SSL/TLS.
