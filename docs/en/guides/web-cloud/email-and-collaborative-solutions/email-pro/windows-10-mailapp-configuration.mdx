...
To configure your Email Pro address on Classic Outlook, refer to our guide "[Email Pro - Configure an e-mail account on Classic Outlook for Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration)".
