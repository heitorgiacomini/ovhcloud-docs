...
Click <ManagerLink to="/#/web/email_pro">this link</ManagerLink> to access the <code className="action">Email Pro</code> section. The server name is visible in the **Connection** box in the <code className="action">General information</code> tab.
