...
description: Find out how to configure your Email Pro account on the Outlook mobile application for iOS
...
<Tabs>
  ...
  <Tab label="Step 2">
    ...
    - If the account parameter window displays "**Exchange**" at the top, press the `?` button in the top right corner of the **(1)** screen, then choose <code className="action">Change account provider</code> **(2)**. Then select `IMAP` **(3)** and proceed to step 3.
...
OVHcloud also offers a web application you can use to access your email account from your browser. You can log in with your email credentials here: [Webmail](https://www.ovhcloud.com/en-gb/mail/). If you have any questions on how to use it, please refer to our guide: [How to use your account via the OWA interface](/guides/web-cloud/email-and-collaborative-solutions/using-the-outlook-web-app-webmail/email-owa).
