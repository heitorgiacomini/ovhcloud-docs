...
To export your database directly from phpMyAdmin, first log in using the guide "[Connecting to a database](/guides/web-cloud/databases/db-connecting-database-server)".
