...
If you need to modify an existing user's rights, refer to our guide "[Web Cloud Databases - Modifying a user's rights](/guides/web-cloud/databases/db-modify-users-rights)".
...
To import a database, refer to our guide "[Restoring and importing a database to your database server](/guides/web-cloud/databases/db-restore-import-database)".
...
To do this, refer to the specific cases in our guide "[Web Cloud Databases - How to authorise an IP address?](/guides/web-cloud/databases/db-authorise-ip-mask)" to enable or disable access from OVHcloud web hosting plans to your Web Cloud Databases.
...
To access the logs for your Web Cloud Databases solution, refer to our guide "[Web Cloud Databases - How to manage logs](/guides/web-cloud/databases/db-retrieve-logs)".

## Go further

[Creating databases and users on your database server](/guides/web-cloud/databases/db-create-databases-users)

[Connecting to a database on your database server](/guides/web-cloud/databases/db-connecting-database-server)

[Backing up and exporting a database on your database server](/guides/web-cloud/databases/db-backup-export-database-server)

[Restoring and importing a database to your database server](/guides/web-cloud/databases/db-restore-import-database)
