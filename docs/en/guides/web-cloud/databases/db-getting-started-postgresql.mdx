...
- To have viewed [the Web Cloud Databases guide](/guides/web-cloud/databases/db-getting-started)
...
There is also a guide here: [Getting started with the Web Cloud Databases service](/guides/web-cloud/databases/db-getting-started)
