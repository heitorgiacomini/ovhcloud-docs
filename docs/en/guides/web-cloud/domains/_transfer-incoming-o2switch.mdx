---
title: "Transferring a O2Switch domain name to OVHcloud"
excerpt: "Find out how to transfer a O2Switch domain name to OVHcloud"
updated: 2024-06-28
flag: hidden
---
...
To transfer a O2Switch domain name, you will need to follow a specific procedure.

**This guide explains how to transfer a O2Switch domain name to OVHcloud.**
...
If you also need to change the **domain name holder**, you should do so **before** you change the domain name contacts. To do this, use our [change of ownership for domain names instructions](/guides/web-cloud/domains/trade-domain).
:::
...
To unlock the domain name and retrieve the transfer code, follow the steps described in the [O2Switch dedicated documentation](https://faq.o2switch.fr/espace-client/recuperer-code-de-transfert).
