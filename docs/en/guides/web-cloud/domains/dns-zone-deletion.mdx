...
:::info
The creation/modification/deletion of a DNS zone in your <ManagerLink to="/#/web/zone">OVHcloud Control Panel</ManagerLink> is free of charge.
...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/billing/autorenew/services">My offers and services</ManagerLink> page, then click on the <code className="action">...</code> button to the right of the DNS zone you want to cancel, then click on <code className="action">Cancel my subscription</code>.
