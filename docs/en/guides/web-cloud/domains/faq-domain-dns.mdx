...
<summary>How can I subscribe to a domain name with OVHcloud?</summary>


Follow these steps:

1. Go to the [OVHcloud website](https://www.ovhcloud.com/en-gb/).
2. On the displayed page and in the designated field, enter the domain name you wish to reserve (e.g., `domain.tld`), then click the <code className="action">Search</code> button.
...
4. Once you find an available domain name, click the <code className="action">Buy</code> button, then click the <code className="action">Continue Order</code> button in the right column.
5. Select any additional options or services you wish to subscribe to alongside your domain name, then click <code className="action">Next</code> until the order process prompts you to authenticate or create an OVHcloud customer account.
6. Once authenticated with your OVHcloud customer account, you can customise the contact information (holder/registrant, administrator, technical) for your domain name. Click the <code className="action">Continue</code> button to access the order summary.
7. On the `Order Summary` page and if necessary, you can modify the DNS configuration that will apply to your domain name by clicking the <code className="action">Modify Configuration</code> link. Once your changes are complete, click the <code className="action">Pay</code> button to proceed to the final step of your order.
...
You can then manage your domain name by logging into your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
...
<summary>How can I purchase a domain name on the secondary market?</summary>
...
<summary>How can I know if my domain name is registered with OVHcloud?</summary>


To do this, you can perform a [WHOIS](https://www.ovhcloud.com/en-gb/domains/whois/) query to find out where your domain name is registered and to verify that you are indeed declared as the holder of the domain name.
...
<summary>How can I find out the expiration date of a domain name?</summary>


The fastest solution is to perform a [WHOIS](https://www.ovhcloud.com/en-gb/domains/whois/) query on the domain name. Once the query is performed, look in the result for the line corresponding to the expiration date (e.g., `Expiry Date: 2025-09-22T08:00:00Z`, `Registry Expiry Date: 2025-09-22T08:00:00Z`, etc.).
...
<summary>How can I change the annual expiration date of a domain name?</summary>
...
<summary>How can I correct a typo in my domain name?</summary>
...
<summary>How can I modify an already subscribed domain name?</summary>
...
<summary>How can I delete a domain name?</summary>
...
<Tabs>
  ...
  <Tab label="Step 2">
    In the table that appears, locate the line corresponding to your domain name, click the <code className="action">...</code> button on the right, then click <code className="action">Cancel my subscription</code>.
  </Tab>
  <Tab label="Step 3">
    On the page that appears, select the cancellation mode (immediately or at the service's expiration date) then click the <code className="action">Yes, cancel</code> button at the bottom.
...
:::tip
Find all the details in our guide "[How to cancel my OVHcloud services](/guides/account-and-service-management/managing-billing-payments-and-services/how-to-cancel-services)".
...
<summary>I received an email about validating the information associated with my domain name's registrant. What should I do?</summary>


First, if you have doubts about the legitimacy of the received email, consult our guide "[Beware of scams - recognising fraudulent emails and phishing](/guides/account-and-service-management/account-information/phishing-care)".
...
<summary>I did not receive the email to validate the information associated with my domain name and it is suspended. What should I do?</summary>
...
<summary>What is an IDN (Internationalized Domain Name)?</summary>
...
Once subscribed, IDNs appear in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> in the **xn--** format.

Even though your domain name is displayed in [internationalized notation (IDN)](https://en.wikipedia.org/wiki/Internationalized_domain_name) in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, it will function and display normally elsewhere. Your website address will appear as requested. Your email addresses will also display as intended to your contacts.
...
<summary>How can I correct an IDN (Internationalized Domain Name)?</summary>
...
<summary>How can I renew a single domain name in an Alldom pack?</summary>


To do this, you must be at least declared as the ["Billing" contact](/guides/account-and-service-management/account-information/managing-contacts) for the concerned domain name. You will then need to change the renewal mode of the domain name to **automatic renewal**.
...
<Tabs>
  ...
  <Tab label="Step 2">
    In the table that appears and to the right of the concerned domain name, click the <code className="action">...</code> button in the `Actions` column, then click <code className="action">Configure renewal</code>. You can then configure the renewal of this domain name to **automatic renewal** mode.
  </Tab>
</Tabs>
...
<summary>Is my domain name transferable after a change of holder?</summary>
...
<summary>My domain name is locked against transfer for 60 days. What should I do?</summary>
...
<summary>I cannot find my domain name in my Control Panel. What should I do?</summary>


First, perform a [WHOIS](https://www.ovhcloud.com/en-gb/domains/whois/) query to find out where your domain name is registered and to verify that you are declared as the holder of the domain name.

Case #1.A - Your domain name is registered with OVHcloud and you are declared as the holder of the domain name:

Perform a [contact recovery procedure](https://www.ovh.co.uk/cgi-bin/en/procedure/procedureChangeContacts.cgi) to have your domain name fully managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. This way, you will no longer need to contact the person who previously managed your domain name.
...
However, you can try to contact the person or organisation managing it by following the instructions in [this form](https://www.ovhcloud.com/en-gb/lp/request-ovhcloud-registered-domain/).
...
<summary>I cannot contact the person managing my domain name. What should I do?</summary>


First, perform a [WHOIS](https://www.ovhcloud.com/en-gb/domains/whois/) query to verify that you are declared as the holder of the domain name.
...
<summary>Can I sell my domain name?</summary>
...
:::info
Modifying a DNS zone is a sensitive operation and can cause interruptions to services associated with your domain name (web hosting, email, etc.). If in doubt, do not hesitate to contact a [specialised provider](https://partner.ovhcloud.com/en-gb/directory/).
...
<summary>What is a DNS zone?</summary>
...
:::tip
Find all the details in our guide "[Everything you need to know about DNS zones](/guides/web-cloud/domains/dns-zone-general-information)".
...
<summary>What is a DNS record?</summary>
...
- DNS pointer records:
    - [How to add a DNS A record for a domain name](/guides/web-cloud/domains/dns-zone-a-record-creation)
    - [How to add a DNS AAAA record for a domain name](/guides/web-cloud/domains/dns-zone-aaaa-record-creation)
    - [How to add a DNS CNAME record for a domain name](/guides/web-cloud/domains/dns-zone-cname-record-creation)
- Extended DNS records:
    - [How to add a DNS TXT record for a domain name](/guides/web-cloud/domains/dns-zone-txt-record-creation)
- Email DNS records:
    - [Configure an MX record for email management](/guides/web-cloud/domains/dns-zone-mx)
...
<summary>What DNS records are available in an OVHcloud DNS zone?</summary>
...
<summary>Can I change the DNS servers declared in my OVHcloud DNS zone?</summary>
...
<summary>What is the difference between an A (IPv4) and AAAA (IPv6) DNS record?</summary>
...
- [How to add a DNS A record for a domain name](/guides/web-cloud/domains/dns-zone-a-record-creation)
- [How to add a DNS AAAA record for a domain name](/guides/web-cloud/domains/dns-zone-aaaa-record-creation)
- [Configuring IPv6 for your website](/guides/web-cloud/web-hosting/configure-ipv6)
...
<summary>How can I configure a PTR record for my external IP at OVHcloud?</summary>
...
:::tip
Find all the details in our guide "[Everything you need to know about DNS records](/guides/web-cloud/domains/dns-zone-records)".
...
<summary>How can I change the default TTL in my OVHcloud DNS zone?</summary>
...
<summary>What is an SOA DNS record?</summary>
...
<summary>How can I verify my DNS zone configuration?</summary>
...
<summary>How can I check the propagation of changes made in my DNS zone?</summary>
...
<summary>How can I restore a DNS zone?</summary>
...
:::tip
Find all the details in our guide "[Managing the history of a DNS zone](/guides/web-cloud/domains/dns-zone-history)".
...
<summary>How can I retrieve a copy of my DNS zone?</summary>
...
<summary>Can I create a DNS zone for a subdomain?</summary>
...
<Tabs>
  ...
  <Tab label="Step 3">
    Once the verification succeeds, choose whether to activate the minimal entries for the DNS zone you are about to create. This choice is not final, as you can always [edit the DNS zone records](/guides/web-cloud/domains/dns-zone-edit) later.
  </Tab>
  <Tab label="Step 4">
...
<summary>How can I redirect all subdomains of the same domain name to the same IP address?</summary>
...
<summary>Can I set up a wildcard in my DNS zone?</summary>
...
<summary>I accidentally deleted my DNS zone and want to restore it. What should I do?</summary>
...
:::tip
If you did not receive this email, check your spam folder or go to the <ManagerLink to="/#/account/useraccount/dashboard">My account</ManagerLink> page, then click the <code className="action">Emails received</code> tab.
...
<summary>How can I cancel a DNS zone deletion request?</summary>
...
<summary>I cannot activate a DNS zone for my domain name. What should I do?</summary>
...
<summary>Why can't I find the "GLUE" tab in my OVHcloud Control Panel?</summary>


This feature is not available for all domain name extensions.
If the tab does not appear in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, it means the "GLUE" option is unavailable for your domain name.

:::tip
Find all the details in our guide "[Customising a domain name's DNS servers (Glue Records)](/guides/web-cloud/domains/glue-registry)".
...
:::info
Modifying DNS servers is a sensitive operation and can cause interruptions to services associated with your domain name (web hosting, email, etc.). If in doubt, do not hesitate to contact a [specialised provider](https://partner.ovhcloud.com/en-gb/directory/).
...
<summary>How can I modify my DNS servers?</summary>
...
<summary>How can I customise my DNS servers?</summary>
...
<summary>How can I replace my DNS servers with those provided by OVHcloud?</summary>
...
<summary>In my Control Panel, I have an error message indicating that I am not using OVHcloud's DNS servers for my domain name. What should I do?</summary>


In your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, this message simply indicates that the DNS zone created for your domain name is not its active DNS zone.
...
<summary>I cannot modify the DNS servers of a domain name from my OVHcloud Control Panel. What should I do?</summary>
...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/web-domains/domain">Domain names</ManagerLink> page, then check if the concerned domain name appears.
  ...
  <Tab label="Step 2">
    **Case #1** - The domain name does not appear in the list:
    ...
    This means that the domain name is not managed from your OVHcloud Control Panel. Perform a [WHOIS](https://www.ovhcloud.com/en-gb/domains/whois/) query to find out where it is registered.
    
    You can then perform one of the following actions (if you are the registrant declared in the WHOIS of the domain name):
    
    - The domain name is registered with OVHcloud: You can perform a [contact recovery procedure](https://www.ovh.co.uk/cgi-bin/en/procedure/procedureChangeContacts.cgi) so that your domain name is managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
    - The domain name is not registered with OVHcloud: You can perform an [incoming transfer](/guides/web-cloud/domains/transfer-incoming-generic-domain) to OVHcloud so that your domain name is managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
    
    **Case #2** - The domain name appears in the list:
    
    This means that you do not have sufficient rights to manage the domain name from your OVHcloud Control Panel. Perform a [WHOIS](https://www.ovhcloud.com/en-gb/domains/whois/) query to verify that you are indeed declared as the holder of the domain name.
    
    You can then perform a [contact recovery procedure](https://www.ovh.co.uk/cgi-bin/en/procedure/procedureChangeContacts.cgi) so that your domain name is fully managed in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
  </Tab>
</Tabs>
...
[OVHcloud emails FAQ](/guides/web-cloud/email-and-collaborative-solutions/mx-plan/faq-emails)

[Web Hosting FAQ](/guides/web-cloud/web-hosting/faq)
