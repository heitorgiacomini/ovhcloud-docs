...
description: Find out how to transfer a GoDaddy domain name to OVHcloud
...
Follow the steps described in [GoDaddy dedicated documentation](https://www.godaddy.com/help/unlock-or-lock-my-domain-410).

### Step 2 - Get the authorization code 

OVHcloud will ask you to provide the authorization code, or Auth code, before you begin the domain name transfer procedure. You can get it by opening your <code className="action">Domain names</code> portfolio page at GoDaddy.

Follow the steps described in [GoDaddy dedicated documentation](https://www.godaddy.com/help/transfer-my-domain-away-from-godaddy-3560).
