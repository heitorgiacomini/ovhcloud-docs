...
description: Find out what DNS servers do, what they contain, and how they work with a domain name
...
They allow you to use [domain names](https://www.ovhcloud.com/en-gb/domains/) to access your favorite website, without having to remember the IP address of the server that hosts it.
...
Please refer to our guide on [Modifying the DNS servers for an OVHcloud domain name](/guides/web-cloud/domains/dns-server-edit) if you need to perform this action for a domain name registered with OVHcloud.
...
:::tip[Success]
- For more information on DNS zones, please refer to our guide “[Everything you need to know about DNS zone](/guides/web-cloud/domains/dns-zone-general-information)”.
- Then refer to our guide on [DNS records](/guides/web-cloud/domains/dns-zone-records) for a better understanding of everything.
...
[Modify an OVHcloud DNS zone](/guides/web-cloud/domains/dns-zone-edit)
