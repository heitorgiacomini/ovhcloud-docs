...
If you also need to change the **domain name holder**, you should do so **before** you change the domain name contacts. To do this, refer to the following guide: [Domain name - How do I change the holder?](/guides/web-cloud/domains/trade-domain).
...
Your domain name will then be available in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> within a few hours.
