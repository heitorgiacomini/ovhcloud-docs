...
Identify any existing "A" records for your domain name alone (e.g. `mydomain.ovh.`) and for the "www" subdomain (e.g. `www.mydomain.ovh.`).
    ...
    **3 - Modification:** If an "A" record exists for the domain name alone, click the <code className="action">...</code> button, then click <code className="action">Modify record</code>. Leave the **Subdomain** field blank and replace the target with the Shopify IPv4 address: `23.227.38.65`. Click <code className="action">Next</code> and confirm.
    
    If no "A" record exists, click <code className="action">Add an entry</code> at the top right, select the <code className="action">A</code> pointer record, leave the **Subdomain** field blank and enter `23.227.38.65` in the **Target** field. Click <code className="action">Next</code> and confirm.
...
Identify any existing "AAAA" records for your domain name alone (e.g. `mydomain.ovh.`) and for the "www" subdomain (e.g. `www.mydomain.ovh.`).
    ...
    **3 - Modification:** If an "AAAA" record exists for the domain name alone, click the <code className="action">...</code> button, then click <code className="action">Modify record</code>. Leave the **Subdomain** field blank and replace the target with the Shopify IPv6 address: `2620:0127:f00f:5::`. Click <code className="action">Next</code> and confirm.
    
    If no "AAAA" record exists, click <code className="action">Add an entry</code> at the top right, select the <code className="action">AAAA</code> pointer record, leave the **Subdomain** field blank and enter `2620:0127:f00f:5::` in the **Target** field. Click <code className="action">Next</code> and confirm.
...
Identify any existing "CNAME" records for the "www" subdomain (e.g. `www.mydomain.ovh.`).
    ...
    **3 - Modification:** If a "CNAME" record exists for the "www" subdomain, click the <code className="action">...</code> button, then click <code className="action">Modify record</code>. Replace only the **Target** with `shops.myshopify.com.`. Click <code className="action">Next</code> and confirm.
    
    If no "CNAME" record exists for the "www" subdomain, click <code className="action">Add an entry</code> at the top right, select the <code className="action">CNAME</code> pointer record, enter `www` in the **Subdomain** field and `shops.myshopify.com.` in the **Target** field. Click <code className="action">Next</code> and confirm.
  </Tab>
</Tabs>
