...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/billing/autorenew/services">My offers and services</ManagerLink> page. In the table, identify the domain name(s) for which you would like to change the renewal mode.
...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/billing/autorenew/services">My offers and services</ManagerLink> page. In the table, identify the domain name you want to renew.
...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/billing/autorenew/services">My offers and services</ManagerLink> page. In the table, identify the domain name you want to cancel.
...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/billing/autorenew/services">My offers and services</ManagerLink> page. In the table, identify the domain name for which you need to pay a renewal bill.
