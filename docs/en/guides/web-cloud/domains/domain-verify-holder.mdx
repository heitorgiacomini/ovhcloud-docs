...
For certain extensions ( e.g.: .fr, .it, .es), the domain administrator can go directly to their <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and modify the holder contact's email address by following the steps described in Step 2 of this page.
...
<Tabs>
  <Tab label="Step 1">
    Go to the <ManagerLink to="/#/web/ongoing-operations">Ongoing operations</ManagerLink> page, then find your domain name in the list.
