...
description: Find out how to change a domain name holder, or update the information associated with it
...
- Your customer account is the [admin and billing contact](/guides/account-and-service-management/account-information/managing-contacts) for the domain name concerned.
...
- The domain name status updates. To check this, go to the <ManagerLink to="/#/web/ongoing-operations">Ongoing operations</ManagerLink> page.
...
<Tabs>
  ...
  <Tab label="Step 2">
    In the **Plan** box, you will see **Contacts**. Click <code className="action">...</code> on the right-hand side, then <code className="action">Manage contacts</code>.
    
    <img className="thumbnail" alt="Change holder" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/manage-contacts.png" loading="lazy" />
  </Tab>
  <Tab label="Step 3">
    On the new page, go to the **Holder** box, then click the <code className="action">Edit</code> button.
    
    <img className="thumbnail" alt="Manage contacts and holders" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/manage-contacts-and-owners.png" loading="lazy" />
  </Tab>
  <Tab label="Step 4">
    :::warning
    ...
    <img className="thumbnail" alt="Holder informations" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/owner.png" loading="lazy" />
  </Tab>
  <Tab label="Step 5">
    ...
    <img className="thumbnail" alt="Change holder domains list" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/general-information/available-domains.png" loading="lazy" />

Once you have made your choices, click <code className="action">Continue</code>.
  </Tab>
  <Tab label="Step 6">
...
- If the domain name holder has been successfully modified, the domain name will be blocked from being [transferred to another registrar](/guides/web-cloud/domains/transfer-outgoing-domain) for a period of 60 days.
