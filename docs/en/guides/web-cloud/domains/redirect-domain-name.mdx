...
- **From the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>**, where a configuration wizard can be used to set up your redirection.
...
Please note: a redirection created from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> does not allow you to redirect a `https://` URL to another domain name or URL.
...
Apart from "pointing" redirections to DNS A, AAAA and CNAME records, 3 redirection options are available from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
