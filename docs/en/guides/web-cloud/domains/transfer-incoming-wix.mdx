...
description: Find out how to transfer a Wix domain name to OVHcloud
...
To unlock the domain name and retrieve the transfer code, follow the steps described in the [Wix dedicated documentation](https://support.wix.com/en/article/transferring-your-wix-domain-away-from-wix-2477749).
