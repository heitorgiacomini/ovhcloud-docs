...
Do you no longer have access to the CMS administration interface, or can't use the "Forgotten your password" feature because the associated email address can't be accessed? Use phpMyAdmin from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> to reset the password directly from the database.

Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> then select <code className="action">Web Cloud</code>. Click <code className="action">Hosting</code> and select the solution concerned. In the <code className="action">Databases</code> tab, identify the database used by your CMS, click the <code className="action">...</code> button, then <code className="action">Go to phpMyAdmin</code>.
