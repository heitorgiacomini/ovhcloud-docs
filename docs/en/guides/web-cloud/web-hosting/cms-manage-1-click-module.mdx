...
:::info
If your website does not display properly after this, please refer to the OVHcloud Web Hosting guides in the [Troubleshooting](/guides/web-cloud/web-hosting/landing-page-web-hosting) section.
...
<Tabs>
  ...
  <Tab label="Step 3">
    Otherwise, click on the <code className="action">My sites</code> tab. Note the name of the `Root folder` displayed on the line for the relevant website: this is the directory containing the files that make up your 1-click module on the FTP server.
  </Tab>
</Tabs>

{/* CP-STEPS-END:find-db-password */}

Then log on to the [FTP space](/guides/web-cloud/web-hosting/ftp-connection) of your hosting plan. Open the `Root folder` found earlier in the <code className="action">My sites</code> tab and browse to the configuration file for your module:
