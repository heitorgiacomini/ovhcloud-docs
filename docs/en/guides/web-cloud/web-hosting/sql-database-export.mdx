...
To do this, log in to *phpMyAdmin*. To find the access link for this interface, log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> , then go to the <code className="action">Web Cloud</code> section. In the left-hand column, click <code className="action">Hosting plans</code>, then choose the name of the web hosting plan concerned. Go to the <code className="action">Databases</code> tab.
