...
- Depending on which backup method you use, you must be able to administer the Web Hosting plan from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, or have the information you need in order to connect to the database.
...
- **Use the OVHcloud backup tool**: this solution allows you to retrieve backups of your databases from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. This method does not require any particular technical skills.
...
<Tabs>
  ...
  <Tab label="Step 3">
    Click the <code className="action">...</code> button to the right of the database you want to back up, then <code className="action">Create a backup</code>.
...
<Tabs>
  ...
  <Tab label="Step 3">
    Click the <code className="action">...</code> button to the right of the database concerned, then <code className="action">Restore a backup</code>.
  ...
  <Tab label="Step 4">
    To download a backup, click on the <code className="action">...</code> button to the right of the backup you want to retrieve, then on <code className="action">Download the backup</code>. Accept the download to your machine, then wait for the backup to be downloaded.
...
<Tabs>
  ...
  <Tab label="Step 3">
    Click the <code className="action">...</code> button to the right of the database concerned, then <code className="action">Go to phpMyAdmin</code>.
