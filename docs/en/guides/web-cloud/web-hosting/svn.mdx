---
title: Using SVN
description: Find out how to use SVN via SSH on your Web Hosting plan
...
In order to create a key pair, please follow our guide on [Creating SSH keys](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys#create-ssh-key).
