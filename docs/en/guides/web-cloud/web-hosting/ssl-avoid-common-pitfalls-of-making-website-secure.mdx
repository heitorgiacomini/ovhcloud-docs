...
description: Find out how to avoid common errors in securing your website with SSL
...
:::info
Some websites use a [Content Delivery Network (CDN)](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn) to host, for example, *Javascript* libraries (such as *JQuery*). 
