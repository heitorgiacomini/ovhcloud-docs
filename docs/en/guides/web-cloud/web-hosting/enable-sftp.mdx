...
<summary>Enable SFTP on a **Free hosting**, **Starter**, **Personal**, or **Startup** web hosting offer</summary>
...
<summary>Enable SFTP on a **Professional**, **Performance**, **Agency**, **Agency Plus**, or **Agency Max** web hosting offer</summary>
