...
description: Find out how to protect a directory or administration interface by authenticating with .htaccess and .htpasswd files
...
You can do this by using two Apache configuration files (HTTP) to place in [the FTP space](/guides/web-cloud/web-hosting/ftp-connection) of your web hosting plan: 
...
If you are using a WordPress CMS, OVHcloud also provides a tutorial on how to [use the .htaccess file with WordPress](/guides/web-cloud/web-hosting/htaccess-how-to-protect-wordpress).
...
To do this, contact our [user community](https://community.ovhcloud.com/community/en) or [OVHcloud partners](https://partner.ovhcloud.com/en-gb/directory/).
:::
...
To modify the PHP version of your websites on your web hosting plan, please refer to our guide: [Web Hosting: Environment, PHP version, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Log in to [the FTP storage space](/guides/web-cloud/web-hosting/ftp-connection) of your web hosting plan. Open the [root folder](/guides/web-cloud/web-hosting/multisites-configure-multisite) that your domain name points to.
...
Go back to the root folder where you created the file `crypt.php`. Click <code className="action">Edit</code> and place the following lines:
...
If you have a [Pro](https://www.ovhcloud.com/en-gb/web-hosting/professional-offer/) or [Performance](https://www.ovhcloud.com/en-gb/web-hosting/performance-offer/) hosting plan, then log in with [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting) to your web hosting. Go to the **root folder** where your script “crypt.php” is located.
...
:::warning
For security reasons, SSH is recommended. However, if you have a **Starter** solution or a [Personal](https://www.ovhcloud.com/en-gb/web-hosting/personal-offer/) hosting plan where SSH is unavailable, you can also run the "crypt.php" file via your web browser.
...
- `your_ftp_login`: The FTP username used to log in to your FTP storage space. To retrieve your FTP login, please refer to our guide on [logging in to your FTP space](/guides/web-cloud/web-hosting/ftp-connection).
...
[Logging in to your Web Hosting plan’s FTP space](/guides/web-cloud/web-hosting/ftp-connection)

[Tutorial - Operations achievable with a .htaccess file](/guides/web-cloud/web-hosting/htaccess-what-else-can-you-do)
...
[Tutorial - Rewrite the URL for accessing your website](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)
