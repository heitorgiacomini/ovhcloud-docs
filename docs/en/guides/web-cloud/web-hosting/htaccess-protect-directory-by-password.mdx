...
If you have a **Professional**, **Performance**, **Agency**, **Agency Plus** or **Agency Max** hosting plan, then log in with [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting) to your web hosting. Go to the **root folder** where your script “crypt.php” is located.
