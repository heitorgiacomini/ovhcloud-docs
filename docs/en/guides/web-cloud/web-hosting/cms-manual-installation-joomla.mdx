...
:::tip
To install Joomla! **automatically** from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, please refer to our documentation on [installing a 1-click module](/guides/web-cloud/web-hosting/cms-install-1-click-modules).

To manually **install another CMS** (WordPress, Drupal, PrestaShop), please refer to our documentation on [installing a CMS manually](/guides/web-cloud/web-hosting/cms-manual-installation).
...
Select the language, enter the name of your website, and click <code className="action">Setup Login Data</code>.
...
Check the information entered, then click on <code className="action">Setup Database Connection</code>.
...
- *Enter the database name*: This name was defined when the database was created in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. It is identical to the database username if you are using a database included with your web hosting plan.
...
Click <code className="action">Install Joomla</code>.
...
This file to be deleted is located in your [FTP storage space](/guides/web-cloud/web-hosting/ftp-connection).
...
Then go back to your web browser and click again on <code className="action">Install Joomla</code>.
