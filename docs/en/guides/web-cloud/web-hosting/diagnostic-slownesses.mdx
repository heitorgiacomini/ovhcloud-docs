...
description: "Identify the cause of your website's slowdowns and find out how to improve this situation"
...
To find out the cluster and filer where your web hosting is located, refer to our guide "[Web hosting - How to know your cluster and filer](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer)".
...
Place a file called **phpinfo.php** at the root of your website in the [FTP storage space on your web hosting](/guides/web-cloud/web-hosting/ftp-connection).
...
Log in to your database by following **step 3** in our guide on [web hosting databases](/guides/web-cloud/web-hosting/sql-create-database).

If you are using a database of a **Web Cloud Databases** solution, please refer to our guide on [Web Cloud Databases databases](/guides/web-cloud/databases/db-connecting-database-server).
...
:::warning
If you encounter an error, please refer to our documentation on [common errors encountered with a database](/guides/web-cloud/web-hosting/diagnosis-database-errors). Then use the guide above to resolve the issue, and try connecting to your database again.
...
Check the PHP engine, PHP version and runtime environment used on your Web Hosting plan, using our guide to [configuring your Web Hosting plan](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
To compare the available PHP versions depending on the runtime environment you are using, see **Step 2** in the guide on [configuring the PHP version on your web hosting](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
To analyse outgoing connections to your hosting plan, please read its **OUT** logs. You can use our documentation on [web hosting logs](/guides/web-cloud/web-hosting/logs-and-statistics).
...
To do this, please refer to your web hosting plan’s **WEB** logs using our guide on [how to view your hosting plan’s logs](/guides/web-cloud/web-hosting/logs-and-statistics).
...
<img className="thumbnail" alt="Firefox Network Scan" src="/images/assets/screens/other/browsers/diagnostic-tools/F12.png" loading="lazy" />
:::
...
:::info
OVHcloud offers several [CDN options](https://www.ovhcloud.com/en-gb/web-hosting/options/). If you would like to use or activate one for your web hosting plan, log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> then read our guide on [Using the OVHcloud CDN](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
...
See our guide on [optimising performance for your website](/guides/web-cloud/web-hosting/optimise-your-website-performance).
