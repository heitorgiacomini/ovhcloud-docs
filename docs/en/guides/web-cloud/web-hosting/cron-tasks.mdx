...
Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and select <code className="action">Web Cloud</code> in the top navigation bar. Click <code className="action">Hosting plans</code>, then choose the Web Hosting plan concerned. Next, navigate to the <code className="action">cron</code> tab by selecting it in the <code className="action">More</code> submenu.
