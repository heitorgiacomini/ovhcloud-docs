...
Log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, then go to the <code className="action">Web Cloud</code> section. In the left-hand menu, click <code className="action">Websites</code>. A table will appear, listing all of your websites and their main information.
