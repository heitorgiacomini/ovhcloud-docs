...
:::tip
To install WordPress **automatically** from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, please refer to our documentation on [installing a 1-click module](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
