...
- If your database is located in the section of the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> dedicated to your [Web Cloud Databases solutions](/guides/web-cloud/databases/overview), follow [these instructions](#case2).
