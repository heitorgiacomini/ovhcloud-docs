...
<Tabs>
  <Tab label="Using a CMS">
    ...
    Once you have logged in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, this option allows you to quickly install the *WordPress*, *Joomla!*, *PrestaShop* and *Drupal* CMS on your hosting.
  ...
  <Tab label="Putting a locally developed website online">
...
- If you did not attach a domain name when you ordered your web hosting plan, and you would like to use the "email address(es) included with your web hosting plan" option, you will need to do this manually from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
...
To check and/or modify the link between your domain name and your website on your web hosting, **consult the following guides in order:**

- [IP address list for web hosting clusters](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip): You will find all the IP addresses for our web hosting infrastructure there. This guide will particularly help you with domain names whose active DNS zone is not managed at OVHcloud (or managed on a different OVHcloud customer account than your own).
- [How to associate a domain name with an existing website?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website): This guide explains how to add a domain name to a website on your web hosting. It can also help you verify that the declaration of your domain name on the website on your web hosting is correct. If necessary, you can then modify it and proceed accordingly at the active DNS zone level of your domain name.
...
- **For the link between your domain name and your web hosting**: Consult the guides "[List of IP addresses for clusters and web hosting](/guides/web-cloud/web-hosting/clusters-and-shared-hosting-ip)" and "[How to associate a domain name with an existing website?](/guides/web-cloud/web-hosting/my-websites-add-domain-existing-website)" mentioned above to retrieve the IP address of your web hosting, then declare your domain name on your website on your web hosting. Then contact the provider that manages the active DNS zone of your domain name to point it towards your web hosting.

- **For the link between your domain name and your OVHcloud email solution**: Only refer to our guide "[Configure an MX record for email management](/guides/web-cloud/domains/dns-zone-mx)" to retrieve the names of the OVHcloud email servers that need to be entered in your domain name’s active DNS zone. Then contact the provider that manages your domain name’s active DNS zone, and point it to the OVHcloud email servers.
