...
<Tabs>
  ...
  <Tab label="Step 2">
    On the page that pops up, click on the <code className="action">Statistics and logs</code> tab. Scroll down to the bottom of the page, where you will find the graph of your hosting usage.
  </Tab>
  <Tab label="Step 3">
    Select the **type** of information as well as the **period** of the data displayed.
    
    <img className="thumbnail" alt="Infrastructure usage statistics graph" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png" loading="lazy" />
...
**How to access the database via phpMyAdmin:** see the dedicated section in our guide "[Creating and managing a database in your Web Hosting plan](/guides/web-cloud/web-hosting/sql-create-database)".
