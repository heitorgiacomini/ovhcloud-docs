...
<Tabs>
  ...
  <Tab label="Step 2">
    Click on the <code className="action">FTP - SSH</code> tab.
  </Tab>
  <Tab label="Step 3">
...
To do this, refer to our guide "[Web Hosting - How to enable SFTP access](/guides/web-cloud/web-hosting/enable-sftp)".
