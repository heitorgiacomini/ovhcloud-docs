...
description: Discover the benefits of migrating Oracle MySQL to Percona Server for MySQL
...
- An OVHcloud [Web Hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/) with an associated OVHcloud shared database (MySQL)
