...
description: Find out details about the technical capabilities of your Web Hosting plan
...
- If you encounter the access error "530 login authentication failed" when connecting to your FTP storage space: Make sure that the access information to your FTP space is correct. To do this, log in to your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and go to the <code className="action">Web Cloud</code> section. In the left-hand column, click <code className="action">Hosting plans</code>, then select the Web Hosting plan concerned. On the page that opens, click on the <code className="action">FTP - SSH</code> tab.
...
You can find more information on this in our guide on "[Logging in to your Web Hosting plan’s FTP storage space](/guides/web-cloud/web-hosting/ftp-connection)".
...
|Offers|Free hosting|Starter|Personal|Startup|Professional|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|---|
|Maximum number of emails sent per hour and per service|10|20|100|100|200|2000|2000|2000|2000|

</Region>

<Region zones={['ca', 'apac']}>

|Offers|Starter|Personal|Startup|Professional|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|
|Maximum number of emails sent per hour and per service|20|100|100|200|2000|2000|2000|2000|
...
- [Monitoring and managing automated emails from your Web Hosting plan](/guides/web-cloud/web-hosting/mail-function-script-records)
- [Use cases - Tips following your website hacking](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked)

### Database/SQL

#### Simultaneous database connections

On Web Hosting plans (shared databases), there is a limit of 30 concurrent connections per database (this limit increases to 200 if you use a [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/) offer). See the [details of our Web Hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/) to find out the options available in each Web Hosting plan.

You can also order additional [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/) solutions, which have customization options:
...
To find out more, read the details of our [Web Hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/) and our guide “[Getting started with your Web Cloud Databases solution](/guides/web-cloud/databases/db-getting-started)”.
...
Only [Web Cloud Databases](https://www.ovhcloud.com/en-gb/web-cloud/databases/) database servers allow external servers to connect to them. This is because you have previously authorized your external server’s IP address on your database server. If necessary, please refer to our guide on "[Getting started with your Web Cloud Databases solution](/guides/web-cloud/databases/db-getting-started)".
...
For more information on database management and connections to the *phpMyAdmin* interface, please refer to our guide on "[Creating a database on your Web Hosting plan](/guides/web-cloud/web-hosting/sql-create-database)".

### PHP

We recommend referring to our [Web Hosting plans](https://www.ovhcloud.com/en-gb/web-hosting/uc-programming-language/) to ensure that the Web Hosting plan you want to order is right for you.
...
Find more details on this topic in our guide on [Web hosting: environment, PHP version, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting)
...
Once you are connected to your hosting server via SSH, outgoing traffic will be blocked for security reasons. We therefore recommend to use PHP scripts. Please refer to our [SSH guide](/guides/web-cloud/web-hosting/ssh-on-webhosting) for more information. You can consult the official [PHP manual](https://www.php.net/manual/en/function.system.php) on how to execute commands and perform other tasks.
...
Find the libraries, languages and versions available for your Web Hosting plan on this page: [https://webhosting-infos.hosting.ovh.net](https://webhosting-infos.hosting.ovh.net).

<Region zones={['eu']}>
For the technical specifications of the Cloud Web solution, please visit this page: [https://cloudweb-infos.hosting.ovh.net/](https://cloudweb-infos.hosting.ovh.net/).
</Region>
...
Find out how to [log in to your Web Hosting plan’s FTP storage space](/guides/web-cloud/web-hosting/ftp-connection) or [restore your Web Hosting plan’s FTP storage space](/guides/web-cloud/web-hosting/ftp-save-and-backup) in our documentation.
...
For shared databases (included in your Web Hosting plan) or database servers (Web Cloud Databases) offered in Gravelines (GRA), France and Beauharnois (BHS), Canada, the databases are backed up every day. These backups are accessible via the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or via the [OVHcloud API](https://eu.api.ovh.com/). Backups are also stored on another infrastructure. This data is replicated in a data centre in Strasbourg (SBG). The backup retention policy is 30 days.

Find out how to [Retrieve a backup of a Web Hosting plan’s database](/guides/web-cloud/web-hosting/sql-database-export) in our documentation.
...
[Optimizing your website’s performance](/guides/web-cloud/web-hosting/optimise-your-website-performance)

[Restoring your Web Hosting plan’s FTP storage space](/guides/web-cloud/web-hosting/ftp-save-and-backup)
