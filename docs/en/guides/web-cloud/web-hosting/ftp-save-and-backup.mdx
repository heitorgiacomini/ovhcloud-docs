...
<Region zones={['eu']}>
- A [Web Hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/) (please note that this does not work with Cloud Web).
</Region>
...
- The “maintenance” status will appear in your <ManagerLink to="/#/web/hosting">OVHcloud Control Panel</ManagerLink>.
...
You can find this information in our guide ["Logging in to your web hosting plan's FTP storage space"](/guides/web-cloud/web-hosting/ftp-connection).

If you no longer have the FTP user password, please refer to our guide ["Changing an FTP user password"](/guides/web-cloud/web-hosting/ftp-change-password).
