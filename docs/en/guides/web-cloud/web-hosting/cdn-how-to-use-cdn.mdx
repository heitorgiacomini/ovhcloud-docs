...
<Tabs>
  ...
  <Tab label="Step 2">
    On the page that pops up, locate the **CDN option**. Click on <code className="action">...</code> to the right, then on <code className="action">Order a CDN</code> or <code className="action">Activate option</code> if the CDN option is already included in your hosting.
...
<Tabs>
  ...
  <Tab label="Step 3">
    ...
    Then click on the <code className="action">⁝</code> button to the right of the relevant domain name or subdomain, then on <code className="action">Activate the CDN</code>.
  ...
  <Tab label="Step 4">
    In the window that opens, click on <code className="action">Confirm</code> to activate the CDN.
...
<Tabs>
  ...
  <Tab label="Step 3">
    ...
    Then click on the <code className="action">⁝</code> button to the right of the relevant domain name or subdomain, then on <code className="action">Clear CDN</code>.
...
<Tabs>
  ...
  <Tab label="Step 3">
    ...
    Then click on the <code className="action">⁝</code> button to the right of the relevant domain name or subdomain, then on <code className="action">Modify CDN</code>.
...
<Tabs>
  ...
  <Tab label="Step 4">
    ...
    - **Advanced Purge**: Customise your purge by choosing which elements of the cache to clear: the entire site, a folder, a URI, a file extension, or using a custom regular expression. 
       ...
       In the <code className="action">My sites</code> tab, click on the <code className="action">⁝</code> button to the right of the domain name or subdomain concerned, then click on <code className="action">Clear CDN</code>.
...
This change is done automatically if your domain name’s active DNS zone is also managed from the <ManagerLink to="/">OVHcloud account</ManagerLink> containing your Web Hosting plan.
...
<Tabs>
  ...
  <Tab label="Step 2">
    Locate the **CDN option**. Click on <code className="action">...</code> to the right, then on <code className="action">Cancel the CDN</code>.
