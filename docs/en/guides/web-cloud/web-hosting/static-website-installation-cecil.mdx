...
description: This tutorial explains how Cecil allows you to create your static website using a modern template engine (Jamstack)
...
- Be able to transfer files via FTP with a client like [FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide).
- Configure your DNS zone to point your domain name (or subdomain) to your web hosting. This is particularly useful if you want to host multiple [websites](/guides/web-cloud/web-hosting/multisites-configure-multisite) on your web hosting plan.
...
A [shared web hosting](https://www.ovhcloud.com/en-gb/web-hosting/) allows you to declare domains or subdomains on the websites it contains. A domain or subdomain is required to deploy your website created with **Cecil**.

To help you declare a domain or subdomain on one of the websites on your hosting, see our page " [Sharing your hosting between multiple websites](/guides/web-cloud/web-hosting/multisites-configure-multisite) ".
...
If your domain name or subdomain is hosted with OVHcloud, see our guides on [DNS configuration](/guides/web-cloud/domains/dns-zone-edit) and setting up a [website on your web hosting](/guides/web-cloud/web-hosting/multisites-configure-multisite).
...
<img className="thumbnail" alt="YAML configuration file" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil04.png" loading="lazy" />
...
<img className="thumbnail" alt="Browser Result" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil07.png" loading="lazy" />

### Customise your website files

#### Change on server

You can edit Markdown files directly on the Web Hosting server. With an OVHcloud [web hosting plan](https://www.ovhcloud.com/en-gb/web-hosting/) that includes SSH access (**from the Professional plan onwards**), you can use [GNU nano](https://nano-editor.org/), [vi](https://ex-vi.sourceforge.net/) or [vim](https://www.vim.org/).
...
<img className="thumbnail" alt="Editing file in GNU nano" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil08.png" loading="lazy" />

Add a few lines using the Markdown syntax:

<img className="thumbnail" alt="Adding content to file" src="/images/assets/screens/other/web-tools/terminal/static-website-installation-cecil09.png" loading="lazy" />
...
<img className="thumbnail" alt="Page updated" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil10.png" loading="lazy" />
...
<img className="thumbnail" alt="View in Visual Studio Code" src="/images/assets/screens/other/web-tools/vscode/static-website-installation-cecil12.png" loading="lazy" />
...
[Add dynamic content to a static web page generated with Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil-api-call)

[Cecil application official website](https://cecil.app/)

[A Markdown format guide](https://www.markdownguide.org/)

[Our FileZilla user guide](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide)
