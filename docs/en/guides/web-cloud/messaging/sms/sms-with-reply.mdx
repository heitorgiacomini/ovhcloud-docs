...
- Être connecté à l'[espace client OVHcloud](/links/manager-telecom), partie `Télécom` puis `SMS`.

![espace client Telecom SMS](/images/assets/screens/control-panel/product-selection/telecom/tpl-telecom-03-fr-sms.png)
...
![fonctionnement sms avec réponse](/images/guides/web-cloud/messaging/sms/sms-with-reply/SMSreponse.png)
...
Connectez-vous à votre <ManagerLink to="/">espace client</ManagerLink> puis sélectionnez `Télécom`. Cliquez ensuite sur `SMS` et choisissez votre compte SMS.

Dans la barre d'onglets, cliquez sur `Options` puis sur `Options des réponses`.

![options SMS réponse](/images/guides/web-cloud/messaging/sms/sms-with-reply/SMSreponse-options.png)
...
Une fois votre option configurée, cliquez sur le bouton `Valider`.
...
Cliquez sur `Ajouter une notification` pour accéder au menu suivant.
...
Une fois votre notification configurée, cliquez sur le bouton `Valider`. Vous pouvez ajouter plusieurs notifications, les éditer ou les supprimer.

### Envoyer un SMS réponse

Dans l'espace client, sélectionnez l'onglet `Accueil` de votre compte SMS. Cliquez ensuite sur `Envoyer un SMS`.

![envoi SMS](/images/guides/web-cloud/messaging/sms/sms-with-reply/SMSreponse-envoi.png)

Assurez-vous que votre expéditeur est bien le `Numéro permettant la réponse (France uniquement`.

![envoi SMS](/images/guides/web-cloud/messaging/sms/sms-with-reply/SMSreponse-expediteur.png)

Complétez ensuite les champs dédiés au(x) destinataire(s) et à votre message. Pour plus de détails, consultez [notre guide sur l'envoi de SMS depuis l'espace client](/guides/web-cloud/messaging/sms/send-sms-control-panel).

### Consulter les réponses

Dans l'espace client, cliquez sur l'onglet `Message et campagne` de votre compte SMS. Cliquez ensuite sur `SMS reçus`.

![SMS reçus](/images/guides/web-cloud/messaging/sms/sms-with-reply/SMSreponse-recus.png)
