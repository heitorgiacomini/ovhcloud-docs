...
<img className="thumbnail" alt="your project with Composer" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2450.jpg" loading="lazy" />
...
<img className="thumbnail" alt="create tokens" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2451.jpg" loading="lazy" />
...
<img className="thumbnail" alt="retrieving tokens" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2452.jpg" loading="lazy" />
