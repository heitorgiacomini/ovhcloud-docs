...
description: Find out how to configure and send SMS messages directly from any email address using the OVHcloud email2sms gateway feature
...
You can refer to the following guide for any specifics about SMS users: [Everything you need to know about SMS users](/guides/web-cloud/messaging/sms/sms-users)
...
<img className="thumbnail" alt="List of authorised SMS characters" src="/images/web-cloud/messaging/sms/send-sms-email/smsauthorizedcharacters.png" loading="lazy" />
