...
description: Find out how to set up a Node.js environment and send your first SMS message step by step using the OVHcloud RESTful API wrapper
...
[https://auth.eu.ovhcloud.com/api/createToken](https://auth.eu.ovhcloud.com/api/createToken?GET=/sms&GET=/sms/*&GET=/sms/*/jobs&POST=/sms/*/jobs) (this URL will automatically give you the correct rights for the steps described in this guide).

<img className="thumbnail" alt="create tokens" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2462.jpg" loading="lazy" />
...
<img className="thumbnail" alt="retrieving tokens" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2463.jpg" loading="lazy" />
