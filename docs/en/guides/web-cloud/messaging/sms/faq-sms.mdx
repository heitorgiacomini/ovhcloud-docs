...
description: Find the answers to the most frequently asked questions about the OVHcloud SMS service
...
<details>
<summary>How do I create an OVHcloud SMS account?</summary>


To create an OVHcloud SMS account, go to the [dedicated OVHcloud SMS offers page](https://www.ovhcloud.com/en-gb/sms/) and choose the credit pack that suits your needs. The order will automatically create an SMS account accessible from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, in the <ManagerLink to="/#/telecom/sms">SMS section</ManagerLink>. Each SMS account is identified by a unique name (e.g. `sms-xx12345-1`). You can have multiple SMS accounts on the same OVHcloud customer ID, allowing you to separate uses (transactional, marketing, internal notifications) and budgets.

</details>


<details>
<summary>How does the SMS credit system work?</summary>
...
- **Destination:** an SMS to metropolitan France uses 1 credit. International destinations use more credits (see the [OVHcloud pricing grid](https://www.ovhcloud.com/en-gb/sms/prices/)).
...
For more details, see the guide "[Managing SMS credits and enabling automatic top-up](/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms)".

</details>


<details>
<summary>How do I enable automatic SMS credit top-up?</summary>


Automatic top-up allows your SMS account to be topped up automatically when the balance falls below a defined threshold. <ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then go to <code className="action">Options</code> > <code className="action">Automatic top-up</code>. Set the trigger threshold and the top-up amount. A valid payment method must be registered on your account. This option is essential for transactional SMS sending, where a credit shortage would block your critical notifications.
...
<details>
<summary>How do I view the history of my sent and received SMS?</summary>


<ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then the <code className="action">Message and campaign</code> > <code className="action">SMS management</code> > <code className="action">Sending log</code> or <code className="action">SMS received</code> tab. You can filter the history by date, sender, recipient or message. The history is kept for 6 months. It can also be exported in CSV format for analysis.

For more details, see the guide "[Managing SMS history](/guides/web-cloud/messaging/sms/sms-history)".

</details>


<details>
<summary>How do I set up credit threshold alerts?</summary>


For **API users**, <ManagerLink to="/#/telecom/sms">go to the SMS section</ManagerLink>, select your account, then <code className="action">API users</code>. Click <code className="action">...</code> > <code className="action">Limit</code> for the relevant user and configure:
...
For more details, see the guide "[Everything you need to know about SMS users](/guides/web-cloud/messaging/sms/sms-users)".
...
<details>
<summary>How do I send an SMS from the OVHcloud Control Panel?</summary>


<ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then click <code className="action">Send an SMS</code>. Fill in:
...
For more details, see the guide "[Sending SMS from the OVHcloud Control Panel](/guides/web-cloud/messaging/sms/send-sms-control-panel)".

</details>


<details>
<summary>How do I send SMS via a URL (http2sms)?</summary>
...
For more details, see the guide "[Sending SMS from a URL - http2sms](/guides/web-cloud/messaging/sms/send-sms-http2sms)".

</details>


<details>
<summary>How do I send SMS from an email address?</summary>
...
For more details, see the guide "[Sending SMS from an email address](/guides/web-cloud/messaging/sms/send-sms-email)".

</details>


<details>
<summary>How do I send bulk SMS efficiently via the API?</summary>
...
<details>
<summary>How do I create my first SMS campaign?</summary>


<ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then click <code className="action">Send an SMS</code>. The steps are:
...
Campaign tracking is available in <code className="action">Message and campaign</code> > <code className="action">Campaign management</code> > <code className="action">Statistics and history</code>.

For more details, see the guide "[My first SMS campaign](/guides/web-cloud/messaging/sms/ma-premiere-campagne-sms)".

</details>


<details>
<summary>How do I manage my SMS recipient lists?</summary>


<ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then go to <code className="action">Contacts</code> > <code className="action">Create a contact list</code>. You can:
...
For more details, see the guide "[SMS recipient lists](/guides/web-cloud/messaging/sms/liste-de-destinataire-sms)".

</details>


<details>
<summary>How do I manage my SMS address books?</summary>


SMS address books offer richer contact management (first name, surname, number). <ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink>, select your SMS account, then go to <code className="action">Contacts</code> > <code className="action">Address book</code>. You can:
...
For more details, see the guide "[Managing my SMS address books](/guides/web-cloud/messaging/sms/sms-address-books)".

</details>


<details>
<summary>What is the difference between a standard SMS (160 characters) and a long SMS?</summary>
...
<details>
<summary>Which special characters cause an SMS to switch to Unicode encoding?</summary>
...
<details>
<summary>What is the delivery time for an SMS sent via OVHcloud?</summary>
...
<details>
<summary>My SMS messages are not being delivered, how do I diagnose the issue?</summary>


Check the following:

1. **Check your credit balance:** a zero balance immediately blocks all sends.
2. **Check the sending history:** in <code className="action">Message and campaign</code> > <code className="action">SMS management</code> > <code className="action">Sending log</code>, check the status of each SMS. A PTT code indicates the reason for the failure.
...
<details>
<summary>What types of SMS senders can I use?</summary>
...
For more details, see the guide "[Everything you need to know about SMS senders](/guides/web-cloud/messaging/sms/sms-senders)".

</details>


<details>
<summary>How do I add a custom alphanumeric sender?</summary>


<ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then click on the <code className="action">Senders</code> tab. Click <code className="action">Actions</code> > <code className="action">Add</code> and choose "Add senders manually". Fill in:
...
<details>
<summary>Why can I not send an SMS containing a URL with a short number?</summary>
...
<details>
<summary>What is a virtual mobile number (VLN) and how do I obtain one?</summary>
...
The VLN requires a specific SMS plan that includes a virtual mobile number. It cannot be added to an existing SMS account: a new SMS account must be ordered via the [dedicated virtual mobile number page](https://www.ovhcloud.com/en-gb/sms/virtual-numbers). The VLN is assigned for a duration linked to the subscription and is not portable to another operator.

</details>


<details>
<summary>How does the SMS reply service work?</summary>
...
4. The reply can be viewed in your OVHcloud Control Panel (<code className="action">Message and campaign</code> > <code className="action">SMS management</code> > <code className="action">SMS received</code>).
...
<details>
<summary>How do I configure an automatic reply to received SMS?</summary>


<ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then go to <code className="action">Options</code> > <code className="action">Reply options</code>. In the "Action on receipt" section, choose "Reply with a predefined text" or "Call a CGI" (URL of a web script that will be called for each reply received, enabling dynamic processing). You can also configure receipt notifications (by email or SMS).

</details>


<details>
<summary>How do I manage unsubscription requests (STOP)?</summary>


When a recipient replies "STOP" to one of your SMS messages, their number is automatically added to a blacklist by OVHcloud. Future SMS messages sent to this number from your account will be blocked. You can view and manage this blacklist from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, <code className="action">Options</code> > <code className="action">Manage blacklisted recipients</code> tab. You can:
...
<details>
<summary>How do I create and manage API users for SMS?</summary>


SMS API users allow you to delegate SMS sending via the API or the http2sms function without exposing your OVHcloud customer credentials. <ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your SMS account, then click <code className="action">API users</code>. Add a new user by defining a username and password. Each user can be assigned:
...
<details>
<summary>How do I send an SMS via the OVHcloud API in PHP?</summary>
...
For more details, see the guide "[Sending SMS with the OVHcloud API in PHP](/guides/web-cloud/messaging/sms/send-sms-api-php)".

</details>


<details>
<summary>What API endpoints are available for the OVHcloud SMS service?</summary>
...
<details>
<summary>How do I receive delivery reports (DLR) for my SMS via a callback?</summary>


Delivery reports (DLR) confirm the successful delivery of an SMS. To receive them automatically, configure a callback URL on your API user. <ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink>, then <code className="action">API users</code>, click <code className="action">...</code> > <code className="action">Callback</code> for the relevant user. Enter the URL of your web endpoint. With each status update, OVHcloud will call this URL with the following parameters:
...
<details>
<summary>How do I use the SMPP protocol with OVHcloud?</summary>


SMPP (Short Message Peer-to-Peer) is an industry protocol for sending and receiving SMS in volume. <ManagerLink to="/#/telecom/sms">Go to the SMS section</ManagerLink> of your OVHcloud Control Panel, select your account, then go to <code className="action">Options</code> > <code className="action">SMPP Settings</code>. You will obtain the connection parameters: SMPP server address, port, system_id and password. The SMPP protocol offers a persistent connection, higher sending throughput, and native support for DLR in push mode.

For more details, see the guide "[Managing an SMPP SMS account](/guides/web-cloud/messaging/sms/smpp-control-panel)".

</details>


<details>
<summary>What are the technical specifications of the OVHcloud SMPP service?</summary>
...
For more details, see the guide "[SMPP technical specifications](/guides/web-cloud/messaging/sms/smpp-specification)".

</details>


<details>
<summary>How do I integrate OVHcloud SMS sending into my business application or CRM?</summary>
...
<details>
<summary>What are the SMS sending rate limits?</summary>
...
<details>
<summary>Can I send SMS messages containing custom variables?</summary>
...
<details>
<summary>What are the legal obligations for sending marketing SMS in France?</summary>
...
<details>
<summary>What is the difference between a transactional SMS and a marketing SMS?</summary>
...
<details>
<summary>How do I optimise the deliverability rate of my SMS?</summary>
...
<details>
<summary>How do I send SMS to the United States?</summary>
...
- A credit cost higher than a national SMS (see the [pricing grid](https://www.ovhcloud.com/en-gb/sms/prices/) for the exact rate).

The deliverability rate may vary depending on American operators and their anti-spam filters.

For more details, see the guide "[Sending SMS to the United States](/guides/web-cloud/messaging/sms/envoi-de-sms-aux-etats-unis)".

</details>


<details>
<summary>What are the geographical restrictions for sending OVHcloud SMS?</summary>
...
- **Variable pricing:** the credit cost varies depending on the destination. Rates can be viewed in your OVHcloud Control Panel or on the [OVHcloud pricing page](https://www.ovhcloud.com/en-gb/sms/prices/).
