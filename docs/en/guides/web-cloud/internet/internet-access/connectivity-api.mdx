...
description: Use the OVHcloud Connectivity API to check copper and fibre eligibility and manage Internet access
...
- Access to the [OVHcloud API webpage](https://eu.api.ovh.com/).
- Read our [Getting started with OVHcloud APIs guide](/guides/manage-and-operate/api/first-steps) to get started using OVHcloud APIv6.
...
View the [OVHcloud Internet access offers](https://www.ovhcloud.com/fr/internet/).
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/search/cities"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/search/streets"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/search/streetNumbers"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/search/buildings"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/search/buildingsByLine"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/test/line"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/search/lines"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/test/address"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/test/building"} />
...
<Api version="v1" section="/connectivity" method="POST" route={"/connectivity/eligibility/test/otp"} />
