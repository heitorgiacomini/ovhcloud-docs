...
2. Select the Public Cloud project you want to use and click the `Quantum Emulators` category.
3. Click the `Create a Notebook` button. The authorization process will take place silently in the background.

![Create a Notebook Control Panel manager 01](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-01.png)
...
Navigate to the `Public Cloud` section of the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, click the `Quantum Emulators` category.
...
![Create a Notebook Control Panel manager 02](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-02.png)
...
![Create a Notebook Control Panel manager 03](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-03.png)
...
![Create a Notebook Control Panel manager 04](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-04.png)

**5\. Live-code editor**

Choose the code editor you want.

![Create a Notebook Control Panel manager 05](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-05.png)
...
![Create a Notebook Control Panel manager 06](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-06.png)
...
![Create a Notebook Control Panel manager 07](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-07.png)
...
![Create a Notebook Control Panel manager 10](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-08b.png)
...
![Create a Notebook Control Panel manager 11](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-UI-09.png)
...
![Create a Notebook ovhai CLI](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-ovhai-CLI.png)
...
![Create a Notebook API token authentication](/images/guides/public-cloud/quantum-computing/emulators/getting-started/creating-a-notebook-using-API-01.png)
...
![Accessing a Notebook Control Panel manager 1](/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-UI-1.png)

You can also access the Notebook from its dedicated page:

![Accessing a Notebook Control Panel manager 2](/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-UI-2.png)
...
![Access a Notebook ovhai CLI](/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-ovhai-CLI.png)
...
![Access a Notebook API](/images/guides/public-cloud/quantum-computing/emulators/getting-started/accessing-a-notebook-using-API.png)
...
![Notebook Authentication Credentials](/images/guides/public-cloud/quantum-computing/emulators/getting-started/notebook-authentication-creds.png)

**Using an Access Token**

Click the `Login with token` button and enter your access token to log in to your Quantum Notebook.

![Notebook Authentication Token](/images/guides/public-cloud/quantum-computing/emulators/getting-started/notebook-authentication-token.png)
...
![Stop a Notebook Control Panel manager](/images/guides/public-cloud/quantum-computing/emulators/getting-started/stopping-a-notebook-using-UI.png)
...
![Stop a Notebook API](/images/guides/public-cloud/quantum-computing/emulators/getting-started/stopping-a-notebook-using-API.png)
...
![Restart a Notebook Control Panel manager](/images/guides/public-cloud/quantum-computing/emulators/getting-started/restarting-a-notebook-using-UI.png)
...
![Restart a Notebook API](/images/guides/public-cloud/quantum-computing/emulators/getting-started/restarting-a-notebook-using-API.png)
...
![Delete a Notebook Control Panel manager](/images/guides/public-cloud/quantum-computing/emulators/getting-started/deleting-a-notebook-using-UI.png)
...
![Delete a Notebook API](/images/guides/public-cloud/quantum-computing/emulators/getting-started/deleting-a-notebook-using-API.png)
