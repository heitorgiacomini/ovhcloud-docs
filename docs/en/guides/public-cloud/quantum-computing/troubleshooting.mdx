...
To verify your usage metrics, go to the <code className="action">Public Cloud</code> section of the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and select <code className="action">Quantum Notebooks</code>. All your notebooks will be listed. Click on your notebook to check its information. In <code className="action">Resources</code>, you can then access the monitoring of your resources via the `Graph Dashboard`.
