...
description: Learn how we bill Quantum Notebooks
...
- `STARTING`: the notebook is being started and, if any, the remote data is synchronized from the Object Storage. To learn more about data synchronization, please check out the [Data - Concept and best practices](/guides/public-cloud/ai-machine-learning/ai-data) documentation. Then the system allocates the necessary compute resources (CPUs/GPUs) for your notebook. Finally, the base framework you have chosen is pulled for use in the notebook.
...
" section of our [Troubleshooting documentation](/guides/public-cloud/quantum-computing/troubleshooting).
...
<img className="thumbnail" alt="lifecycle" src="/images/public-cloud/quantum-computing/billing/lifecycle.png" loading="lazy" />
...
<img className="thumbnail" alt="billing" src="/images/public-cloud/quantum-computing/billing/billing.png" loading="lazy" />
...
<Tabs>
  <Tab label="For Quantum Emulators">
