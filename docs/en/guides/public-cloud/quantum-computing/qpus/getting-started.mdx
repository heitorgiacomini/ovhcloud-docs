...
1. Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and navigate to the `Public Cloud` section.
2. Select the Public Cloud project you want to use and click the `Quantum QPUs` category.
3. Click the `Create a Notebook` button. The authorization process will take place silently in the background.

![Create a Notebook Control Panel manager 01](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-01.png)
...
Navigate to the `Public Cloud` section of the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and click the `Quantum QPUs` category.
...
![Create a Notebook Control Panel manager 02](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-02.png)
...
![Create a Notebook Control Panel manager 03](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-03.png)

**4\. Pre-configured frameworks**

Choose the Quantum Python framework you want to use, which will be pre-installed and ready to use when your notebook is launched. Select the version that suits your needs. Then, click `Next` to continue.

![Create a Notebook Control Panel manager 04](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-04.png)

**5\. Live-code editor**

Choose the code editor you want.

![Create a Notebook Control Panel manager 05](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-05.png)
...
![Create a Notebook Control Panel manager 06](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-06.png)
...
If you want to learn more about configuring containers and Git repositories in the Notebook, you can refer to this [AI & Machine learning documentation](/guides/public-cloud/ai-machine-learning/ai-notebooks-manage-data-ui). For now, we will launch a classic Notebook without any external volumes added to it.

Click `Next`.

![Create a Notebook Control Panel manager 07](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-07.png)
...
![Create a Notebook Control Panel manager 10](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-08b.png)
...
![Create a Notebook Control Panel manager 11](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-UI-09.png)
...
1. Follow this [AI & Machine learning](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) documentation to install the `ovhai` CLI and log in. 
2. Visit this second documentation to learn [how to create your Quantum Notebook using commands](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).

![Create a Notebook ovhai CLI](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-ovhai-CLI.png)

</Tab>
<Tab label="Using the AI Solution API">

1. Create a bearer token from the *ovhai* CLI. For more detailed instructions on creating a token, check the [manage access tokens](/guides/public-cloud/ai-machine-learning/ai-cli-app-token) documentation.
...
3. `Submit a new notebook` POST method

:::warning
Make sure to select `Bearer Auth` instead of `OAuth 2.0`, which is selected by default.
:::

![Create a Notebook API token authentication](/images/guides/public-cloud/quantum-computing/qpus/getting-started/creating-a-notebook-using-API-01.png)
...
Click the `JupyterLab` link in the `Access` column:

![Accessing a Notebook Control Panel manager 1](/images/guides/public-cloud/quantum-computing/qpus/getting-started/accessing-a-notebook-using-UI-1.png)

You can also access the Notebook from its dedicated page:

![Accessing a Notebook Control Panel manager 2](/images/guides/public-cloud/quantum-computing/qpus/getting-started/accessing-a-notebook-using-UI-2.png)
...
![Access a Notebook ovhai CLI](/images/guides/public-cloud/quantum-computing/qpus/getting-started/accessing-a-notebook-using-ovhai-CLI.png)

You can also get Notebook information using `ovhai notebook get <NOTEBOOK_UUID>`.

</Tab>
<Tab label="Using the Quantum API">

The `URL` of your Notebook should appear in the `Response` panel:

![Access a Notebook API](/images/guides/public-cloud/quantum-computing/qpus/getting-started/accessing-a-notebook-using-API.png)

If not, use the `Paginated list of notebooks` GET endpoint method:

You can also get Notebook information using the `Get notebook information` GET endpoint method.
...
![Stop a Notebook Control Panel manager](/images/guides/public-cloud/quantum-computing/qpus/getting-started/stopping-a-notebook-using-UI.png)
...
![Stop a Notebook API](/images/guides/public-cloud/quantum-computing/qpus/getting-started/stopping-a-notebook-using-API.png)
...
![Restart a Notebook Control Panel manager](/images/guides/public-cloud/quantum-computing/qpus/getting-started/restarting-a-notebook-using-UI.png)
...
![Restart a Notebook API](/images/guides/public-cloud/quantum-computing/qpus/getting-started/restarting-a-notebook-using-API.png)
...
![Delete a Notebook Control Panel manager](/images/guides/public-cloud/quantum-computing/qpus/getting-started/deleting-a-notebook-using-UI.png)
...
![Delete a Notebook API](/images/guides/public-cloud/quantum-computing/qpus/getting-started/deleting-a-notebook-using-API.png)
...
- Learn about the technical features, capabilities, and limitations of the Public Cloud Quantum Notebooks offering [here](/guides/public-cloud/quantum-computing/capabilities).
- Get some hints on how to debug your Notebooks if things go wrong [here](/guides/public-cloud/quantum-computing/troubleshooting).
