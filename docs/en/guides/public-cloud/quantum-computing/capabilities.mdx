...
Quantum Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
You are also able to check it from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> in your notebook's general information by clicking the <code className="action">Go to Graph Dashboard</code> button.
