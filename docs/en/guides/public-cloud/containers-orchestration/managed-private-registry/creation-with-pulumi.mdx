...
description: Create an OVHcloud Managed Private Registry (MPR) with Pulumi
...
![Pulumi](/images/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/pulumi.jpg)
...
In concrete terms, you have to generate these credentials via the [OVH token generation page](https://api.ovh.com/createToken/?GET=/*&POST=/*&PUT=/*&DELETE=/*) with the following rights: **GET**, **POST**, **PUT** and **DELETE** on `/*`.
...
Go to the <code className="action">Managed Private Registry</code> section. Your registry has been successfully created:
...
<img className="thumbnail" alt="Harbor" src="/images/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/harbor.png" loading="lazy" />

<img className="thumbnail" alt="Harbor home page" src="/images/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/harbor-homepage.png" loading="lazy" />

Then click on the created project:

<img className="thumbnail" alt="Harbor created project" src="/images/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/harbor-project.png" loading="lazy" />
