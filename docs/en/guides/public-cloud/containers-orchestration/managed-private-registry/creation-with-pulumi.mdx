...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-private-registry/creating-a-private-registry-with-pulumi/api-rights.png" loading="lazy" />
