...
- A running **[Managed Private Registry](/guides/public-cloud/containers-orchestration/managed-private-registry/creation)**.
...
1. Log in to [Harbor Web UI](/guides/public-cloud/containers-orchestration/managed-private-registry/connect-to-ui) as an **Administrator**.
