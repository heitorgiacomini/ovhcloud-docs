...
description: Find out how to manage Helm charts in the OVHcloud Managed Private Registry
...
<img className="thumbnail" alt="Project list" src="/images/public-cloud/containers-orchestration/managed-private-registry/using-helm-charts/harbor-ui-001.png" loading="lazy" />

Click on the `private` project name to list its repositories:

<img className="thumbnail" alt="Project repository list" src="/images/public-cloud/containers-orchestration/managed-private-registry/using-helm-charts/harbor-ui-002.png" loading="lazy" />
...
<img className="thumbnail" alt="Project repository artifact list" src="/images/public-cloud/containers-orchestration/managed-private-registry/using-helm-charts/harbor-ui-003.png" loading="lazy" />

Finally click on the hash of the second artifact to see the Helm chart details:

<img className="thumbnail" alt="Chart version details - Values" src="/images/public-cloud/containers-orchestration/managed-private-registry/using-helm-charts/harbor-ui-004.png" loading="lazy" />
