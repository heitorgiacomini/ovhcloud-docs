...
<img className="thumbnail" alt="Unauthenticated access to the Harbor interface" src="/images/public-cloud/containers-orchestration/managed-private-registry/add-ip-restrictions/unauthenticated-hmi.png" loading="lazy" />
