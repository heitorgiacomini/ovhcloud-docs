...
description: Find out how to partition and format NVMe disks on OVHcloud Managed Kubernetes IOPS nodes
lastUpdated: 2023-06-30
---

When you order [IOPS nodes](https://www.ovhcloud.com/en-gb/public-cloud/iops/) for your OVHcloud Managed Kubernetes cluster, the NVMe disks are neither partitioned nor formatted, therefore they cannot be used to create Kubernetes persistent volumes.
