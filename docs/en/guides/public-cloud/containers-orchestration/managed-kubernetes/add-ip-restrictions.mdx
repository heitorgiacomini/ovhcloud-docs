...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-kubernetes/add-ip-restrictions/api-rights.png" loading="lazy" />
