...
| **Enterprise File Storage** | NFS | [EFS with MKS](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi) |
| **NAS-HA** | NFS | [NAS-HA with MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-multi-attach-persistent-volumes-nas-ha) |
| **Cloud Disk Array** | CephFS | [CDA with MKS](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-multi-attach-persistent-volumes-cloud-disk-array) |
...
For the complete version matrix, see [Kubernetes Plugins & Software versions](/guides/public-cloud/containers-orchestration/managed-kubernetes/plugins-software-versions-reserved-resources).
...
- [Known limits](/guides/public-cloud/containers-orchestration/managed-kubernetes/known-limits)
- [Choosing the right plan: Free vs Standard](/guides/public-cloud/containers-orchestration/managed-kubernetes/mks-plans)
- [Responsibility model](/guides/public-cloud/containers-orchestration/managed-kubernetes/responsibility-model)
- [Software versions and reserved resources](/guides/public-cloud/containers-orchestration/managed-kubernetes/plugins-software-versions-reserved-resources)
- [Using vRack Private Network](/guides/public-cloud/containers-orchestration/managed-kubernetes/using-vrack)
