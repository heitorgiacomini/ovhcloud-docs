...
![Schema vrack gateway](/images/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/schema_mksvrack.png)
...
> Important: Assuming that your PCI project is added to your [vRack](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack).
...
<Tabs>
  ...
  <Tab label="API">
    <Api version="v1" section="/cloud" method="POST" route={"/cloud/project/\\{serviceName\\}/network/private"} />    > @api &#123;v1&#125; /cloud GET /cloud/project/&#123;serviceName&#125;/network/private
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="API">
    <Api version="v1" section="/cloud" method="GET" route={"/cloud/project/\\{serviceName\\}/network/private/\\{networkId\\}"} />    > @api &#123;v1&#125; /cloud POST /cloud/project/&#123;serviceName&#125;/kube
  ...
  <Tab label="OVHcloud Control Panel">
    ...
    ![Attach a vRack gateway to an OVHcloud Managed Kubernetes cluster](/images/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/attach-vrack-gateway-to-kubernetes-cluster.png)
  </Tab>
  <Tab label="Terraform">
    :::info
...
<img className="thumbnail" alt="Create a cluster" src="/images/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/clusters.png" loading="lazy" />
...
<img className="thumbnail" alt="Create a cluster" src="/images/public-cloud/containers-orchestration/managed-kubernetes/vrack-k8s-custom-gateway/created-cluster.png" loading="lazy" />
