...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-kubernetes/automatically-label-taint-node-pool/api-rights.png" loading="lazy" />
...
You can also create a Node Pool template through the API. You can use the [API Explorer](https://eu.api.ovh.com/) for example to interact with our API.
