...
description: Backing-up Persistent Volumes using Stash
...
- [Prepare your environement to use the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)

- [Get Openstack RC File v3 from Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security)
...
The snapshots are visible on the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. To see thmn, go to Object Storage section, where you will find the Object Storage bucket you have created. By clicking on the bucket you will see the list of objects, including all the snapshot beginning with the `/backup/demo/deployment/stash-demo` we had defined in the `Repository`:

<img className="thumbnail" alt="Snapshots onb OVHcloud Manager" src="/images/public-cloud/containers-orchestration/managed-kubernetes/backing-up-volumes-using-stash/snapshots-on-manager.png" loading="lazy" />
