...
description: Learn how to effectively migrate your Kubernetes cluster from an external provider to OVHcloud, leveraging its features and flexibility.
...
<img className="thumbnail" alt="Migration of a Kubernetes to OVHcloud" src="/images/public-cloud/containers-orchestration/managed-kubernetes/migration-to-ovhcloud/migration-schema.png" loading="lazy" />
...
5. **Deploy Velero Helm chart on the new cluster**
    ...
    - On your newly created OVHcloud Kubernetes cluster, deploy the Velero Helm chart. To do this, you can follow this [guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/backing-up-cluster-velero).
...
9. **Set up Saving Plans (if needed)**
    ...
    Explore the option of [OVHcloud Saving Plans](/guides/public-cloud/cross-functional/savings-plans) to optimize your cloud costs. Learn more about the available Saving Plans to determine if they align with your financial strategy.
