...
description: Find out how to install Knative on OVHcloud Managed Kubernetes and deploy your first serverless containers
...
![Knative components](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-knative/knative-inside.png)
...
![OVHcloud New entry in DNS zone for Knative](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-knative/ovhcloud-entry-dns.png)
...
For more information about DNS on OVHcloud, please read our guide on [how to configure a DNS zone](/guides/web-cloud/domains/dns-zone-edit).
...
![Knative Serving components](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-knative/knative-serving.png)
