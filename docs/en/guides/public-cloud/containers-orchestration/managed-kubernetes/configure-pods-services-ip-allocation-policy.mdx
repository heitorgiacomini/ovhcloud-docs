...
:::info
You can find more information on how to use the OVHcloud API here: [First steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps).
:::
...
[Known limits of OVHcloud Managed Kubernetes](/guides/public-cloud/containers-orchestration/managed-kubernetes/known-limits)
