...
description: Find out how to configure the OIDC provider of an OVHcloud Managed Kubernetes cluster
...
<img className="thumbnail" alt="Your Kubernetes cluster" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/cluster.png" loading="lazy" />

Click on the `...` button in the `OIDC provider` section.

<img className="thumbnail" alt="Configure OIDC provider menu" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/configure-oidc-menu.png" loading="lazy" />
...
<img className="thumbnail" alt="Log in to the API Explorer" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/kubernetes-quickstart-api-ovh-com-001.png" loading="lazy" />
...
<img className="thumbnail" alt="Kubernetes section of the API Explorer" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/kubernetes-quickstart-api-ovh-com-002.png" loading="lazy" />
...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/api-rights.png" loading="lazy" />
...
<img className="thumbnail" alt="Copy paste service name" src="/images/public-cloud/containers-orchestration/managed-kubernetes/configuring-oidc-provider-config/get-service-name.png" loading="lazy" />
