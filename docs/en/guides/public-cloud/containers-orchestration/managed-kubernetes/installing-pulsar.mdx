...
description: Explore how to install Apache Pulsar on an OVHcloud Managed Kubernetes cluster
...
- `kubectl` installed and configured (v1.16 or later). For more information, see [Configuring kubectl on an OVHcloud Managed Kubernetes cluster](/guides/public-cloud/containers-orchestration/managed-kubernetes/configure-kubectl).
