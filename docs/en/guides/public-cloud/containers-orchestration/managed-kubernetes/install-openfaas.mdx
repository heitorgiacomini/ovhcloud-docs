...
description: Find out how to install OpenFaaS CE on OVHcloud Managed Kubernetes using OpenFaaS
...
<img className="thumbnail" alt="OpenFaas logo" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-openfaas/openfaas-logo.png" loading="lazy" />
...
:::info
If you want to better understand the difference between these three modes, you can read our [dedicated guide](/guides/public-cloud/containers-orchestration/managed-kubernetes/using-lb#some-concepts-clusterip-nodeport-ingress-and-loadbalancer).
:::
...
<img className="thumbnail" alt="UI Portal" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-openfaas/ui-portal-01.jpg" loading="lazy" />
