...
Please refer to the guide [Configuring an IP block in a vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack) for more information.
...
In the <code className="action">Public Cloud</code> section, select your project. In the left menu, click on <code className="action">Instances</code> under the **Compute** tab, then find your two SNS EVA instances.
