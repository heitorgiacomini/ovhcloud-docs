...
- [OpenStack CLI installed and configured](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
...
In the tab, click on <code className="action">Members</code> and then on <code className="action">Edit Member</code>.
    ...
    <img className="thumbnail" alt="Update Member Openstack dashboard" src="/images/public-cloud/network-services/weight-load-balancer/update-member_openstack_dashboard-1.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Horizon">
    ...
    <img className="thumbnail" alt="Update weight" src="/images/public-cloud/network-services/weight-load-balancer/member-status-draining.png" loading="lazy" />
  </Tab>
  <Tab label="CLI">
...
Fill in the fields with the previously obtained information:
    ...
    <img className="thumbnail" alt="public-cloud" src="/images/public-cloud/network-services/weight-load-balancer/member-api-update-1.png" loading="lazy" style={{ maxWidth: '800px' }} />
  </Tab>
  <Tab label="Horizon">
    ...
    <img className="thumbnail" alt="Update Member Openstack dashboard" src="/images/public-cloud/network-services/weight-load-balancer/pool-tab.png" loading="lazy" />
