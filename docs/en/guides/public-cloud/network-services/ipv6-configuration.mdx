...
:::info
Floating IP and Gateway currently do not support IPv6. You can only use IPv6 with instances in [Public Mode](/guides/public-cloud/network-services/concepts#publicmode).
