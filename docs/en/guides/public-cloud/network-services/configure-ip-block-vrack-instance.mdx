...
As well as private IP addressing, the [vRack](https://www.ovhcloud.com/en-gb/network/vrack/) also lets you route public IP traffic through your server's [vRack](https://www.ovhcloud.com/en-gb/network/vrack/) port using a public IP address block.
...
<img className="thumbnail" alt="add project to vrack" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/addprojectvrack.png" loading="lazy" />
...
<img className="thumbnail" alt="vrack" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/addIPblock.png" loading="lazy" />
...
Click on <code className="action">Private Network</code> in the left-hand menu under **Network**.

Click on <code className="action">Add Private Network</code>.

<img className="thumbnail" alt="create private network" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2022-03.png" loading="lazy" />
...
<img className="thumbnail" alt="select region" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/vrack2024-01.png" loading="lazy" />
...
<img className="thumbnail" alt="configure network" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/network_configuration.png" loading="lazy" />
...
<img className="thumbnail" alt="Region selection" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/region2021.png" loading="lazy" />

Click on <code className="action">Network</code> in the left-hand tab, then on <code className="action">Networks</code>.

<img className="thumbnail" alt="network" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/create-network.png" loading="lazy" />

Click on the drop-down arrow next to the private network and select <code className="action">Create Subnet</code>.

<img className="thumbnail" alt="Create Subnet" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/create_subnet.png" loading="lazy" />

In the pop-up window, fill in the fields:

<img className="thumbnail" alt="Create Subnet" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/create_subnet_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Uncheck DHCP" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/uncheck_dhcp.png" loading="lazy" />

Once the subnet has been created, your private network will appear as follows:

<img className="thumbnail" alt="New private network display" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/display_subnet.png" loading="lazy" />
...
<img className="thumbnail" alt="region" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/region2021.png" loading="lazy" />

Next, select <code className="action">Compute</code> and then <code className="action">Instances</code> from the menu.

<img className="thumbnail" alt="compute and instance" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/compute_instances.png" loading="lazy" />

Select <code className="action">Attach Interface</code> in the drop-down list for the corresponding instance.

<img className="thumbnail" alt="attach network" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/attach_interface.png" loading="lazy" />

In the pop-up menu, select the appropriate options:

<img className="thumbnail" alt="attach network" src="/images/public-cloud/network-services/configuration-06-configure-ip-block-vrack-to-instance/attach_public_IP.png" loading="lazy" />
