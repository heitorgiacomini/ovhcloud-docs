...
description: Understand the configuration concepts that are powering the Public Cloud Load Balancer
...
<img className="thumbnail" alt="simple LB concepts" src="/images/public-cloud/network-services/concepts-03-loadbalancer/LB_concepts_simple.svg" loading="lazy" />

<img className="thumbnail" alt="full LB concepts" src="/images/public-cloud/network-services/concepts-03-loadbalancer/LB_concepts_full.svg" loading="lazy" />
...
A specific protocol is `PROMETHEUS`, it enables configuring a prometheus endpoint and does not handle traffic itself. This is used to export metrics to Prometheus for monitoring, but it is not used to route application traffic. Find more information about this configuration on [this page](/guides/public-cloud/network-services/loadbalancer-monitoring-prometheus).
...
<img className="thumbnail" alt="Private to Private Load balancer architecture" src="/images/public-cloud/network-services/concepts-03-loadbalancer/priv-to-priv.png" loading="lazy" />
...
<img className="thumbnail" alt="Public to Private Load balancer architecture" src="/images/public-cloud/network-services/concepts-03-loadbalancer/pub-to-priv.png" loading="lazy" />
...
<img className="thumbnail" alt="Public to Public Load balancer architecture" src="/images/public-cloud/network-services/concepts-03-loadbalancer/pub-to-pub.png" loading="lazy" />
...
|---|---|---|---|---|
|Private to Private | Required | Not required | 3 ([src](/guides/public-cloud/network-services/known-limits)) | Not required |
|Public to Private  | Required | Required | 5 ([src](/guides/public-cloud/network-services/known-limits)) | Required |
|Public to Public  | Required | Required | 5 ([src](/guides/public-cloud/network-services/known-limits)) | Required |
...
- Configure your first load balancer with this [guide](/guides/public-cloud/network-services/getting-started-load-balancer).
