...
description: Find out how to set up vRack for your Public Cloud instances with the OpenStack CLI
...
- An [OpenStack user account](/guides/public-cloud/cross-functional/create-and-delete-a-user) (Optional)
- Basic networking knowledge
- Consulting the guide [Configuring the vRack on Public Cloud](/guides/public-cloud/network-services/getting-started-creating-vrack-with-openstack) (to understand the different methods to manage the vRack with the Public Cloud)
...
:::info
This does not apply to newly created projects which are now automatically delivered with a vRack. To view the vRack once the project has been created, go to <code className="action">Public Cloud</code> > your project > <code className="action">Network</code> > <code className="action">vRack private network</code>.
...
Once the service is active, you will find it under <code className="action">Public Cloud</code> > your project > <code className="action">Network</code> > <code className="action">vRack private network</code>. Labelled "pn-xxxxxx".
...
<img className="thumbnail" alt="add project to vrack" src="/images/public-cloud/network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### With the OVHcloud APIv6

To activate and manage a vRack using the OVHcloud APIv6, please refer to [this section](/guides/public-cloud/network-services/vrack-apiv6#step-1-activating-and-managing-a-vrack) of the corresponding guide.
...
Also note the information detailed in [this guide](/guides/public-cloud/compute/starting-with-nova):
