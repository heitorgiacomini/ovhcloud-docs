...
description: Find out how to set up vRack for your Public Cloud instances with the OVHcloud APIv6
...
- Consulting the guide [Configuring the vRack on Public Cloud](/guides/public-cloud/network-services/vrack) (to understand the different methods to manage the vRack with the Public Cloud)
