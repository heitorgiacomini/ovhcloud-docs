...
- OpenStack [installed on your system](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
...
As outlined in [this guide](/guides/public-cloud/cross-functional/create-and-delete-a-user), the password is only visible once — when it is created.
