...
description: Learn how to quickly use, and manage OVHcloud Shell directly from the OVHcloud Control Panel to streamline your cloud operations and workflows.
...
Click on the OVHcloud <code className="action">Shell button</code> to launch the terminal.

<img className="thumbnail" alt="Cloudshell button" src="/images/public-cloud/cross-functional/getting-started-ovhcloudshell/OVHcloud_Shell.png" loading="lazy" />
