...
description: Landing Zones – Everything you need to know to build a secure and scalable cloud foundation
...
See Public Cloud Landing Zone Reference of architecture in [this guide](/guides/public-cloud/cross-functional/landing-zone-migration).
...
- **Compliance:** our cloud services, with their numerous certifications, offer a secure environment that meets the requirements of many repositories. Through our frequent discussions with the French Cybersecurity Agency (ANSSI), we’re able to provide our customers with tools and features that meet the highest standards. View the list of certifications [here](https://www.ovhcloud.com/en-gb/compliance/).
...
OVHcloud protects against **DDoS attacks** with its proprietary, actively maintained anti-DDoS tools. All customers can use this software without charge. The Network Security dashboard provides an overview of the detected malicious activities, which shows how efficient it is. For more details, see [here](/guides/bare-metal-cloud/dedicated-servers/network-security-dashboard).

[**OVHcloud Workflow Management**](https://www.ovhcloud.com/en-gb/public-cloud/workflow-management/): By automating and orchestrating your cloud operations, OVHcloud Workflow Management ensures efficient resource provisioning, policy enforcement, and compliance. It makes intricate procedures simpler, improving agility and control across your OVHcloud infrastructures.

[**Veeam Enterprise Plus**](https://www.ovhcloud.com/en-gb/storage-solutions/veeam-enterprise/): For enterprise environments, Veeam Enterprise Plus delivers advanced backup, disaster recovery, and data management solutions. Whether physical, virtual, or cloud, it safeguards your critical workloads with reliable protection and fast recovery.
...
- **Ingestion:** Ingestion agents, or inputs, receive logs within the Logs Data Platform. They verify the source’s validity and the formatting of logs based on [these rules](/guides/manage-and-operate/observability/logs-data-platform/field-naming-conventions), and may add, update or remove fields before forwarding your logs to storage.
...
For guidance on building your Landing Zone to OVHcloud, check our [building documentation](/guides/public-cloud/cross-functional/landing-zone-migration).
