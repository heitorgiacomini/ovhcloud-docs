...
When you no longer need your [Public Cloud](https://www.ovhcloud.com/en-gb/public-cloud/) project, you can delete it directly from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
...
<img className="thumbnail" alt="delete project" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject1.png" loading="lazy" />
...
<img className="thumbnail" alt="delete project" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject2.png" loading="lazy" />
