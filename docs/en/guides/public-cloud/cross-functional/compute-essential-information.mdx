...
description: Find out some basic tips to get started in the Public Cloud environment
...
- [Open an OVHcloud account](/guides/account-and-service-management/account-information/ovhcloud-account-creation)
- [Create your first Public Cloud project](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [How to use the Public Cloud interface](/guides/public-cloud/cross-functional/public-cloud-interface-walk-me)
- [Create your first instance](/guides/public-cloud/compute/getting-started)
- [Manage quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota)
...
<img className="thumbnail" alt="Public Cloud Ecosystem" src="/images/public-cloud/cross-functional/00-essential-info-to-get-started-on-public-cloud/ecosystem.png" loading="lazy" />
...
To get started, you will first need an OVHcloud [customer account](/guides/account-and-service-management/account-information/ovhcloud-account-creation).

You will then need to [create a Public Cloud project](/guides/public-cloud/cross-functional/create-a-public-cloud-project). A project is an environment that you will dedicate to a context.
...
Since your payment method has been saved, it will be used to debit the amount calculated for your [billing at the end of the month](/guides/public-cloud/cross-functional/analyze-billing). This calculation is based on the usage time of each resource, depending on the price of the resources. For instances, prices are usually displayed as an hourly rate for readability, but billing is calculated per second, with a minimum billing period of 1 minute.
...
<br/>These quotas are allocated by region (in the OpenStack sense). As a result, you may reach the maximum possible resources for your project, and you may need to [increase these quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota).

<img className="thumbnail" alt="Public Cloud quota" src="/images/public-cloud/cross-functional/00-essential-info-to-get-started-on-public-cloud/quota.png" loading="lazy" />
...
- If you would like to use the OpenStack or Amazon S3 APIs, or the Horizon interface, you will need to [create users](/guides/public-cloud/cross-functional/create-and-delete-a-user) to do this. Users may have limited permissions to secure the action perimeters.
- If you do not need access to the APIs or Horizon, you can [link another OVHcloud](/guides/public-cloud/cross-functional/delegate-projects) customer account as an add-on to your project.
...
|---|---|
|[FAQ](/guides/public-cloud/cross-functional/faq-pci)|Frequently asked questions about Public Cloud.|
|[Glossary](/guides/public-cloud/cross-functional/introduction-about-instances)|The concepts and definitions you will need to move forward.|
|[Availability of services by location](https://www.ovhcloud.com/en-gb/public-cloud/regions-availability/)|Service availability tables across different locations.|

Here are some guides to help you with the first steps:

|Documentation|Details|
|---|---|
|[Create your first instance](/guides/public-cloud/compute/getting-started)|First practical guide to starting a cloud server from the OVHcloud Control Panel.|
|[Using an SSH key](/guides/public-cloud/compute/creating-ssh-keys)| To log in to a Linux instance, you will need to log in via an SSH connection. This guide details the procedure.|
|[Private Network Configuration](/guides/public-cloud/network-services/vrack)|At OVHcloud, private networks are powered by vRack technology. This guide will help you get started.|
|[Attach an additional disk to an instance](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance)|This guide will help you add additional storage to your first instance.|
|[Accessing the Horizon interface](/guides/public-cloud/cross-functional/introducing-horizon)|The Horizon interface of OpenStack allows some advanced actions, here is how to connect to it.|
|[Creating a Kubernetes cluster](/guides/public-cloud/containers-orchestration/managed-kubernetes/create-cluster)|This guide will help you step by step in creating your first Kubernetes cluster.|
|[Configuring an Additional IP](/guides/public-cloud/network-services/configure-additional-ip)|Additional IPs can allow you to switch traffic from one instance to another. This guide will explain how to configure this.|
|[Installing the OpenStack CLI](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)|OpenStack can also be used in the command line. Here is how to install the tools.|
...
|Documentation|Details|
|---|---|
|[OpenStack CLI](https://docs.openstack.org/python-openstackclient/stein/#using-openstackclient)|Extensive documentation for the essential openstack command-line client. Documentation for the Stein version, please refer to the [availability table](https://www.ovhcloud.com/en-gb/public-cloud/regions-availability/) to find out what services are available.|
|[APIs OpenStack](https://docs.openstack.org/stein/api/)|Extensive documentation of OpenStack APIs Documentation for the Stein version, please refer to the [availability table](https://www.ovhcloud.com/en-gb/public-cloud/regions-availability/) to find out what services are available.|
