...
description: A practical guide to design a secure and scalable Landing Zone on OVHcloud Public Cloud, covering networking, IAM, backups, and more.
...
- Being familiar with [Terraform](/guides/public-cloud/cross-functional/how-to-use-terraform), if you intend using it.
- Basic understanding of [cloud networking concepts](https://www.ovhcloud.com/en-gb/public-cloud/network/) (e.g., subnets, gateways, Floating IPs).
...
Follow [this guide](/guides/public-cloud/network-services/create-private-network-gateway) to set up a gateway.
...
Use Floating IPs to expose selected private resources (e.g., instances, services) to the public internet securely. Follow [this guide](/guides/public-cloud/network-services/attach-floating-ip-to-instance) to link a Floating IP.
...
Follow [this guide](/guides/public-cloud/network-services/getting-started-load-balancer) to set up and use a Load Balancer.
...
Follow [this guide](/guides/public-cloud/network-services/stormshield-vrack) to set up and use a Stormshield firewall.
...
Follow [this guide](/guides/public-cloud/network-services/ubika-vrack) to deploy a WAAP protection with Ubika.
...
See [this documentation](/guides/network/ovhcloud-connect/occ-direct-control-panel).
...
See the [related documentation](/guides/public-cloud/cross-functional/security-structure-best-practices).
...
This is key for observability, security audits, and troubleshooting. Follow [this documentation](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).
...
Use tagging, IAM roles, and alerts to link costs to teams, environments, or services. For more information, read [this documentation](/guides/public-cloud/cross-functional/analyze-billing).
