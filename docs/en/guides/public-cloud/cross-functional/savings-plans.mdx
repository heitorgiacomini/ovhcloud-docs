...
description: Savings Plans - Everything you need to know to optimise your costs
...
This guide aims at providing you with a clear and practical understanding of [Savings Plans](https://www.ovhcloud.com/en-gb/public-cloud/savings-plan/) to help you optimise your infrastructure costs. We'll explain what Savings Plans are, how they work, and how to choose the model best suited to your specific needs. Through concrete examples, you will discover how these plans can reduce your expenditure while offering flexibility in the management of your resources.
...
[Savings Plans](https://www.ovhcloud.com/en-gb/public-cloud/savings-plan/) are a flexible pricing model that offers lower rates than pay-as-you-go pricing, in exchange for a commitment to use the service for a given period (1, 6, 12, 24 or 36 months).
...
- **Case "1,5:1":** Now let's suppose that another customer uses 15 B3-8 instances, but subscribes to a Savings Plan covering only 10 B3-8 instances. In this case, the customer benefits from the advantageous Savings Plan discount for the first 10 instances. However, the other 5 instances, which are not covered by the Savings Plan, will be billed at the standard rate.
...
:::warning
With regards to simultaneously active instances, find out whether a suspended or paused resource is considered active with the following guide: [Shelve or pause an instance](/guides/public-cloud/compute/suspend-or-pause-an-instance).
...
- If the customer has 15 B3-8 instances and subscribes to a Savings Plan for 10 B3-8 instances, the first 10 will automatically be covered by the Savings Plan billing and the other 5 will be billed at the standard rate without discount.
...
- After analysing its needs, the customer opted for the following combination:
    - A 3-year Savings Plan covering 20 B3-16 VMs. This represents a **reduction of 54%** compared with standard (pay-as-you-go) billing.
    - A 1-year Savings Plan covering 10 B3-8 VMs. This represents a **reduction of 35%** compared to standard (pay-as-you-go) billing.

Thanks to this combination, the customer achieves substantial savings by optimising its production resources over the long term, while maintaining the flexibility required for its development environment, with reductions of 54% and 35% respectively compared with standard invoicing.
...
<details>
<summary>**a. Selection filters**</summary>
...
<details>
<summary>**b. Savings Plan indicators**</summary>
...
- **Graph colour legends:**
    ...
    - **Red:** Represents the number of resources not covered by a Savings Plan and billed at the standard rate.

</details>


<details>
<summary>**d. Savings Plan Usage Detail**</summary>
...
<img className="thumbnail" alt="Billing instances Savings Plan" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_instances_svp.png" loading="lazy" />
...
Additional instances, i.e. those not covered by your Savings Plan, are billed per second at the standard rate, as with standard billing.
For example, if you use 10 3rd-generation instances for 10 hours during the month, this represents 100 instance-hours of usage (10 instances x 10 hours), billed at the standard rate in addition to the Savings Plan line.

<img className="thumbnail" alt="Billing instances per hour" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_instances_hours.png" loading="lazy" />

</details>


<details>
<summary>Billing for Rancher Savings Plan</summary>
...
<img className="thumbnail" alt="Billing Rancher Savings Plan" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_rancher_svp.png" loading="lazy" />
...
Additional vCPUs, i.e. those not covered by your Savings Plan, are billed per second at the standard rate, as with standard billing.
For example, if you use 10 vCPUs for 10 hours during the month, this represents 100 vCPU-hours of usage (10 vCPUs x 10 hours), billed at the standard rate in addition to the Savings Plan line.

<img className="thumbnail" alt="Billing rancher per hour" src="/images/public-cloud/cross-functional/savings-plans/billings_savings_plan_rancher_hours.png" loading="lazy" />
