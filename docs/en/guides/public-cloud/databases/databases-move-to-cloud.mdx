...
description: Learn how to move your databases to OVHcloud with dump & restore or live PostgreSQL migration.
...
<img className="thumbnail" alt="schema migration" src="/images/public-cloud/databases/databases-20-move-to-cloud/schema.png" loading="lazy" />
...
3. Create a new database instance based on your network requirements. Follow [this guide](/guides/public-cloud/databases/getting-started).
