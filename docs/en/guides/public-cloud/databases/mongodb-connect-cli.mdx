---
title: Connect using the CLI for Public Cloud Databases for MongoDB
description: Connect to your Public Cloud Databases for MongoDB using the Command Line Interface (CLI)
...
Follow the steps here after selecting Windows, MacOS or Linux operation system : [https://docs.mongodb.com/mongodb-shell/install/#std-label-mdb-shell-install](https://docs.mongodb.com/mongodb-shell/install/#std-label-mdb-shell-install)
