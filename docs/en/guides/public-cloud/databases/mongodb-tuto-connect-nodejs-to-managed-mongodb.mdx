...
description: Find out how to build a NodeJS application connected to an OVHcloud Managed MongoDB service
...
- A [NodeJS working environment](https://nodejs.org/en/download) and public network connectivity (Internet). This tutorial was made using NodeJS LTS 16.14.0.
...
![NodeJS Chat App form](/images/public-cloud/databases/mongodb-tuto-01-connect-nodejs-to-managed-mongodb/mongodb_tuto_01_connect_nodejs_to_managed_mongodb-20220215103152793.png)
...
![NodeJS Chat App first user](/images/public-cloud/databases/mongodb-tuto-01-connect-nodejs-to-managed-mongodb/mongodb_tuto_01_connect_nodejs_to_managed_mongodb-20220215103402859.png)
...
![NodeJS Chat App second user](/images/public-cloud/databases/mongodb-tuto-01-connect-nodejs-to-managed-mongodb/mongodb_tuto_01_connect_nodejs_to_managed_mongodb-20220215104535750.png)
