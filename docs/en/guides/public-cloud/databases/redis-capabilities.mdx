...
Please refer to the [DBMS lifecycle policy guide](/guides/public-cloud/databases/lifecycle-policy) for recommendations on version upgrades and end of life announcements of major versions. Additionally, you can follow Redis® release cycle on their official page: [https://redis.io/topics/releases](https://redis.io/topics/releases)
...
More information on [https://valkey.io/topics/license/](https://valkey.io/topics/license/).

### Hardware resources

For information on node types and pricing, please refer to the [price page](https://www.ovhcloud.com/en-gb/public-cloud/prices/#7262).
...
You can further customise your service by using advanced parameters. See the [Advanced parameters references documentation](/guides/public-cloud/databases/redis-advanced-parameters-references) for more information on the supported parameters.
...
You can follow the official Redis® documentation about Commands: [https://redis.io/commands/](https://redis.io/commands/).
...
:::info
Update of user ACLs is allowed only via API. Follow this [guide](/guides/public-cloud/databases/redis-update-acls) to learn more.
:::
