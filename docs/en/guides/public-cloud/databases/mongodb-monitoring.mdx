...
description: Learn how to monitor your databases via the OVHcloud Control Panel, using a CLI or a GUI
...
- An OVHcloud managed MongoDB service. If you do not have one, please refer to the following guide: [Getting started with Public Cloud Databases](/guides/public-cloud/databases/getting-started).
- An account you can use to log in to MongoDB. If you do not have one, please refer to the following guide: [Configure your MongoDB instance to accept incoming connections](/guides/public-cloud/databases/mongodb-manage-control-panel).
...
You can use the main metrics and statistics in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> to track and manage your database instance.

For each Public Cloud Database service, in the <code className="action">Metrics</code> tab, you can find the following charts:
...
<img className="thumbnail" alt="Monitoring - Conrol Panel" src="/images/public-cloud/databases/mongodb-15-monitoring/monitoring01.png" loading="lazy" />

### Using the CLI (Command Line Interface) to retrieve information

Depending on the solution you’ve signed up for (Discovery, Production or Advanced), you can use the same "mongo" tool. This binary is available in a .zip file, which you can find on the official MongoDB website via the following link: [https://www.mongodb.com/try/download/community](https://www.mongodb.com/try/download/community). You can then download the version that best suits your platform.
...
Depending on the solution you’ve signed up for (Discovery, Production or Advanced), you can use the same "MongoDB Compass" tool. This is a cross-platform tool — designed to run on any device: Mac, Windows, Linux. It is available on the official MongoDB website via the following link: [https://www.mongodb.com/try/download/compass](https://www.mongodb.com/try/download/compass).

MongoDB Compass has a <code className="action">Performance</code> tab.

<img className="thumbnail" alt="Monitoring - Compass" src="/images/public-cloud/databases/mongodb-15-monitoring/monitoring02.png" loading="lazy" />
...
Clicking on the targeted operation will open the "Operation Details" panel on the right. Clicking on the <code className="action">KILL OP</code> button will terminate this request.

## We want your feedback!

For more information about Managed Databases for MongoDB, please visit our [product page](https://www.ovhcloud.com/en-gb/public-cloud/mongodb/).
