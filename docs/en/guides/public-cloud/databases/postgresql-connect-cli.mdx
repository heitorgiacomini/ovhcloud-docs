...
description: Connect to your Public Cloud Databases for PostgreSQL using the Command Line Interface (CLI)
...
Follow the steps here after selecting Windows, MacOS or Linux as operating system: [https://www.postgresql.org/download/](https://www.postgresql.org/download/)
...
We will follow official PostgreSQL documentation: [https://www.postgresql.org/docs/devel/app-psql.html](https://www.postgresql.org/docs/devel/app-psql.html).
...
[PostgreSQL capabilities](/guides/public-cloud/databases/postgresql-capabilities)
