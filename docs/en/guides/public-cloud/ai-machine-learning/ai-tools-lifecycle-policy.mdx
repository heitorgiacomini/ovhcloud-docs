...
description: Discover the lifecycle of OVHcloud AI Tools (AI Notebooks, AI Training, AI Deploy)
lastUpdated: 2023-09-19
---

## Objective

This document is intended for our OVHcloud end customers and aims at providing information about the lifecycle of the [AI Notebooks, AI Training, AI Deploy](/guides/public-cloud/ai-machine-learning/overview) IT products in the OVHcloud Public Cloud.
