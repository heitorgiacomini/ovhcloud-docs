...
description: How to deploy a Streamlit app for interactive data visualization and prediction
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-07-streamlit-eda-iris/overview-streamlit-eda.png" loading="lazy" />
