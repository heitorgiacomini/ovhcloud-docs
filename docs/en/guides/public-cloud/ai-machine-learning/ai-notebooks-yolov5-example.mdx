...
description: How to train the YOLOv5 model on a custom dataset with AI Notebooks
...
- Do you want to use your YOLOv5 model in an app? [Here it is](/guides/public-cloud/ai-machine-learning/ai-deploy-web-service-yolov5).
