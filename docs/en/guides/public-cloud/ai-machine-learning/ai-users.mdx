...
The **users** of the **OVHcloud AI Solutions** are simply the users of your [Public Cloud project](https://www.ovhcloud.com/en-gb/public-cloud/), which can be created and managed in the <ManagerLink to="/">OVHcloud Control Panel (UI)</ManagerLink>.
...
In addition to the AI Training role, we strongly recommend adding the **ObjectStore Operator** role to your AI users. This role provides read/write access to the **OVHcloud Object Storage**, which is a persistent storage solution to store your [data](/guides/public-cloud/ai-machine-learning/ai-data) that is incorporated into our AI Solutions. This way, you can access your data within the **AI Solutions**.
