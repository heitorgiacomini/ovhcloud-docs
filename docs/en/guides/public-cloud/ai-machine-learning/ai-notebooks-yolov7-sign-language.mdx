...
description: How to train the YOLOv7 model on a custom dataset with AI Notebooks
...
- Do you want to use your YOLOv7 model in an app? [Here it is](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-yolov7-sign-language).
