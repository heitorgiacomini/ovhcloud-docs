---
title: AI Notebooks - Tutorial - Train YOLOv8 to play rock paper scissors
...
You need to attach a volume if your data is in your OVHcloud Object Storage and you want to use it during your experiment, or if you need to save the results of your work in the Object Storage. For more information on data, volumes and permissions, see [our guide on data](/guides/public-cloud/ai-machine-learning/ai-cli-access-data).

If you want to launch it from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, just follow this [guide](/guides/public-cloud/ai-machine-learning/ai-notebooks-definition).
...
If you want to launch it with the CLI, choose the [volumes](/guides/public-cloud/ai-machine-learning/ai-cli-access-data) you want to attach and the number of GPUs (`<nb-gpus>`) to use on your notebook and use the following command:
...
- Do you want to observe the evolution of your metrics during the training of your model? Click [here](/guides/public-cloud/ai-machine-learning/ai-notebooks-weights-biases).
- Do you want to train your YOLOv8 model? [Here it is](/guides/public-cloud/ai-machine-learning/ai-training-train-rock-paper-scissors).
- Do you want to use your YOLOv8 model in an app? [Here it is](/guides/public-cloud/ai-machine-learning/ai-deploy-rock-paper-scissors).
