...
description: Create a voice-enabled chatbot using ASR, LLM, and TTS endpoints in under 100 lines of code
...
Imagine having a virtual assistant that listens to your voice, understands your questions, and responds with spoken answers, in under 100 lines of code. Thanks to [AI Endpoints](https://www.ovhcloud.com/en-gb/public-cloud/ai-endpoints/), this is now easily achievable.
