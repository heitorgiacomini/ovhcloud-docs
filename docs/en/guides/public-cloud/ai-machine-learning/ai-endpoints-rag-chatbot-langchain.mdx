...
description: Learn how to build a RAG (Retrieval Augmented Generation) chatbot using Python, LangChain and AI Endpoints
...
To do this, we will use **[LangChain](https://github.com/langchain-ai/langchain)**, a powerful open-source framework that simplifies working with LLMs in both Python and JavaScript. Combined with OVHcloud **[AI Endpoints](https://www.ovhcloud.com/en-gb/public-cloud/ai-endpoints/)** which offers both LLM and embedding models, it becomes easy to create advanced, production-ready assistants.
...
<img className="thumbnail" alt="chatbot-without-rag" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-11-rag-chatbot-langchain/without-rag.png" loading="lazy" />

and using RAG:

<img className="thumbnail" alt="chatbot-with-rag" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-11-rag-chatbot-langchain/with-rag.png" loading="lazy" />
