...
:::warning
By default, your AI Training job will automatically shut down after **7 consecutive days of being in RUNNING status**. You can also enable **Automatic Restart** to have it restart every 7 days, or contact [our support](https://help.ovhcloud.com/csm?id=csm_get_help) to extend this period to **28 days**.
...
Their official pricing is available in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or on the [OVHcloud Public Cloud website](https://www.ovhcloud.com/en-gb/public-cloud/prices/).
