...
description: Learn how to deploy the DenseNet model in ONNX format for optimized inference
...
For more information on how to train DenseNet on a CIFAR-10 dataset, refer to the following [documentation](/guides/public-cloud/ai-machine-learning/ai-notebooks-finetune-model-export-onnx).
...
:::warning
**Warning**
You must have previously created a `densenet-cifar10-onnx-model` Object Storage bucket when training your model via [AI Notebooks](/guides/public-cloud/ai-machine-learning/ai-notebooks-finetune-model-export-onnx).
...
To get the result of the prediction, click on the <code className="action">Execute</code> button.
...
- You can imagine deploying an image segmentation app through this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-image-segmentation-unet-brain-tumors).
- Feel free to use **Streamlit** to [deploy a Speech-to-Text app](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-speech-to-text-app).
