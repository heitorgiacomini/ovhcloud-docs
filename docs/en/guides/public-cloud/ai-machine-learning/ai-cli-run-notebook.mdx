...
description: Learn how to run an AI Notebook using the CLI
lastUpdated: 2025-11-17
---

## Objective

This guide covers the submission of new [**AI Notebooks**](/guides/public-cloud/ai-machine-learning/ai-notebooks-definition) through the **ovhai** CLI.
...
For more information on **installing and configuring the ovhai CLI, see the guide on [Installing the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client)**.
...
However, to restore your code when you restart a `STOPPED` notebook, it needs to be stored in your Object Storage, which you are billed for. You can find more information about the AI Notebooks billing in the [Billing and Lifecycle guide](/guides/public-cloud/ai-machine-learning/ai-notebooks-billing).
...
## Go further
Learn how to access your Object Storage data and Git repositories from your notebooks [here](/guides/public-cloud/ai-machine-learning/ai-cli-access-data).

Learn how to share your notebooks with other people [here](/guides/public-cloud/ai-machine-learning/ai-cli-sharing-notebooks).
