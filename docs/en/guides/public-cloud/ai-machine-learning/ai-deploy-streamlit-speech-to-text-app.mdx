...
description: How to create and deploy a Streamlit Application for Speech To Text
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-09-streamlit-speech-to-text-app/speech-to-text.png" loading="lazy" />
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-09-streamlit-speech-to-text-app/speech-to-text-app-overview.png" loading="lazy" />
...
- [The OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) **and** [Docker](https://www.docker.com/get-started) installed on your local computer, **or** only an access to a Debian Docker Instance on the <ManagerLink to="/">Public Cloud</ManagerLink>.
