...
description: Learn the concept behind AI Tools data
...
- You can upload and download data from your local environment using the CLI, see [how to install `ovhai` CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client). Next, find out how to [manage your data with the CLI](/guides/public-cloud/ai-machine-learning/ai-cli-data).
- You can use the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, see [create data container](/guides/storage-and-backup/object-storage/pcs-create-container).
...
- You can check how to [use your data in an AI Notebook](/guides/public-cloud/ai-machine-learning/ai-cli-access-data).

- You can check how to [launch an AI Training job with attached volumes](/guides/public-cloud/ai-machine-learning/ai-cli-run-job).
