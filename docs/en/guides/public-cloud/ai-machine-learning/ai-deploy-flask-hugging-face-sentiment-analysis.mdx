...
description: How to deploy an app to analyse text sentiment with Hugging Face and Flask
...
<img className="thumbnail" alt="Hugging Face Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-06-flask-hugging-face/flask-hugging-face-overview.png" loading="lazy" />

For more information about Hugging Face, please visit [https://huggingface.co/](https://huggingface.co/).
...
<img className="thumbnail" alt="Flask tree structure" src="/images/public-cloud/ai-machine-learning/deploy-tuto-06-flask-hugging-face/tree-flask-app.png" loading="lazy" />
...
- You can also imagine deploying an Object Detection model with **Flask** in this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-web-service-yolov5).
- Discover an other tool to deploy easily AI models: **Gradio**. Refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-gradio-sketch-recognition).
