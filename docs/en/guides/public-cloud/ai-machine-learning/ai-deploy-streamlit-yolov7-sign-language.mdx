...
description: How to build a sign language recognition app with Streamlit
...
For more information on how to train YOLOv7 on a custom dataset, refer to the following [documentation](/guides/public-cloud/ai-machine-learning/ai-notebooks-yolov7-sign-language).

Here is an overview of the Sign Language recognition app:

<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-13-streamlit-yolov7/overview-streamlit-yolov7-asl.png" loading="lazy" />
...
:::warning
**Warning**
You must have previously created an `asl-volov7-model` Object Storage container when training your model via [AI Notebooks](/guides/public-cloud/ai-machine-learning/ai-notebooks-yolov7-sign-language).
...
- You can imagine deploying an app using YOLO models with another Python framework: **Flask**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-web-service-yolov5).
- Feel free to use **Streamlit** for other AI tasks! Deploy a Speech-to-Text app [here](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-speech-to-text-app).
