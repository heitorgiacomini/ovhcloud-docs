...
description: Find out how to resolve issues when using AI Endpoints
...
This tutorial provides guidance on how to resolve common issues that may arise when using [AI Endpoints](https://www.ovhcloud.com/en-gb/public-cloud/ai-endpoints/).
...
If you are now unable to use a model you were previously using, it might have been decommissioned. OVHcloud AI Endpoints follows a [model lifecycle process](/guides/public-cloud/ai-machine-learning/ai-endpoints-billing) to ensure a seamless experience for our customers. As stated in the documentation linked above, we notify you of our decision to retire a model three months in advance, giving you time to prepare for migration.
