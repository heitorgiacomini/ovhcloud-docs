...
description: Build your own code assistant directly in VSCode or JetBrains IDEs using the Continue plugin
...
Try out different LLMs from [our catalog](https://www.ovhcloud.com/en-gb/public-cloud/ai-endpoints/catalog/) and choose the one that best fits your use case. You can switch between them easily in the IDE UI.
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Chatbot tool animation" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-03-code-assistant-continue/chatbot.mp4" />
...
<video className="thumbnail" autoPlay loop muted playsInline aria-label="Tab completion animation" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-03-code-assistant-continue/tab-completion.mp4" />
