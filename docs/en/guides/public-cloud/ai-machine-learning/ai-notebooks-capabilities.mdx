...
description: Find out about current features, capabilities and limitations of AI Notebooks
...
AI Notebooks is compliant with the OVHcloud AI CLI. Discover how to [install the OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
You are also able to check it from the OVHcloud Control Panel in your notebook's general information by clicking the <code className="action">Go to Graph Dashboard</code> button.
...
Pricing is available [here](https://www.ovhcloud.com/en-gb/public-cloud/prices/#ai-&-machine-learning).
...
Browse the full [AI Notebooks documentation](/guides/public-cloud/ai-machine-learning/overview) to further understand the main concepts and get started.
