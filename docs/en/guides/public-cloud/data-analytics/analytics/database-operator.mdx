...
description: Find out how to install and use the Kubernetes database operator
...
- Access to the <ApiLink>OVHcloud API</ApiLink>. Create your credentials using our [First Steps with the OVHcloud API](/guides/manage-and-operate/api/first-steps) guide.
...
In order to generate your OVHcloud API, please follow our [First steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) tutorial.

Specifically, you have to generate these credentials via the <CreateToken rights="GET=/cloud/project/*/database/*&POST=/cloud/project/*/database/*&PUT=/cloud/project/*/database/*&DELETE=/cloud/project/*/database/*">OVHcloud token generation page</CreateToken> with the following rights:
