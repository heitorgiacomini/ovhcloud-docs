...
Therefore, OVHcloud strongly recommends to [backup your instance](/guides/public-cloud/compute/save-an-instance) and conduct extensive testing on your applications to make sure they work on the new operating system version prior to following this tutorial.
:::
...
- [Administrative access](/guides/public-cloud/compute/getting-started#connect-instance) to the server
- [Backup](/guides/public-cloud/compute/save-an-instance) must be taken before starting
...
Now verify if your applications are working as expected. In case there are issues, we recommend [restoring your backup](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) that was taken prior to the upgrade.
...
Verify if your applications are working as expected. In case there are issues, we recommend [restoring your backup](/guides/public-cloud/compute/create-restore-a-virtual-server-with-a-backup) that was taken prior to the upgrade.
