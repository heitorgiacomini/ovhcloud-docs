...
description: "Learn the fundamentals of Public Cloud Compute: how instances work, available families and flavors, multi-AZ deployments, image management, SSH security, backup mechanisms, public/private networking, and Savings Plans benefits."
...
OVHcloud Compute instances are deployed across [multiple datacenters worldwide](https://www.ovhcloud.com/en-gb/about-us/global-infrastructure/regions/), ensuring high availability and proximity to your users. Examples of regions include:
...
:::info
**Best Practice:** For critical workloads, prefer a [multi-AZ deployment](/guides/public-cloud/cross-functional/deployments-modes-reference-architecture) to ensure service resilience and continuity.
:::
...
For detailed instructions on creating and using SSH keys, refer to the [OVHcloud SSH guide](/guides/public-cloud/compute/creating-ssh-keys).
...
:::info
**Best Practice:** Backups are not a substitute for a [resilient architecture](/guides/public-cloud/cross-functional/deployments-modes-reference-architecture). For critical environments, combine backups with multi-AZ replication to ensure maximum data protection and service availability.
:::
...
For more detailed guidance on configuring Public Cloud networks, refer to the official [OVHcloud networking guide](/guides/public-cloud/network-services/concepts).
...
Saving Plans help you optimize your budget while maintaining the performance and reliability of your cloud environment. For more details, refer to the official [OVHcloud Savings Plans guide](/guides/public-cloud/cross-functional/savings-plans).
