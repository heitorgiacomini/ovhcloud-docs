...
- You need to have created a Public Cloud instance in your [OVHcloud Control Panel](/guides/public-cloud/compute/getting-started) or through the [Horizon interface](/guides/public-cloud/compute/create-instance-in-horizon)
- [An SSH key](/guides/public-cloud/compute/creating-ssh-keys)
...
- Attach Interface: This option allows you to add one or more private interfaces to your instance via the VLAN. For more information, refer to [this section](/guides/public-cloud/network-services/vrack#adding-a-private-interface) of the corresponding guide.
- Detach Interface: This option allows you to detach an interface linked to an instance. For more information, refer to [this section](/guides/public-cloud/network-services/vrack#removing-a-private-interface) of the corresponding guide.
...
Consult [this guide](/guides/public-cloud/compute/getting-started#user-mgmt) for more information.
