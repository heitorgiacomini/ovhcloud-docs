...
To begin, log in to the Horizon interface. If you are unsure about how to do this, please refer to [our guide](/guides/public-cloud/cross-functional/introducing-horizon).
...
For more information on how to create an SSH key, consult [this guide](/guides/public-cloud/compute/creating-ssh-keys).

<Tabs>
  <Tab label="+ Create Key Pair">
    To create a Keypair, click on the <code className="action">+ Create Key Pair</code> button. Please note that with this option, additional steps have to be made before you are able to connect to the instance, especially if you are using the software PuTTY to connect to your instance. See [this section](/guides/public-cloud/compute/getting-started#connect-instance) of the corresponding guide.
