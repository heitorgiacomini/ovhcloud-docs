...
description: Find out how to scale up your instance resources to address an increased activity
...
[Resize a Public Cloud instance via the OVHcloud Control Panel](/guides/public-cloud/compute/resize-instance-manager)
