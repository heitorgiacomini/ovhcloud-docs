...
description: Find out the current features, capabilities and limitations of Local Zones for Public Cloud
lastUpdated: 2026-01-16
---

## Objective

Local Zones are an extension of [regions](https://www.ovhcloud.com/en-gb/public-cloud/regions-availability/) that bring OVHcloud services closer to specific locations, offering reduced latency and improved performances for applications.
