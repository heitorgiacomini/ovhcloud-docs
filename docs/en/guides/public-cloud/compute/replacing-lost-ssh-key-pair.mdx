...
Create a new SSH key pair on your local device, as described in the first part of the [SSH key guide](/guides/public-cloud/compute/creating-ssh-keys).

### Step 2: Access your instance in rescue mode

Follow the steps in the [rescue mode guide](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) to reboot the instance into rescue mode, connect to it and mount your partitions.
...
Restart the instance in "normal" mode from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. Refer to the [rescue mode guide](/guides/public-cloud/compute/put-an-instance-in-rescue-mode) if needed.
