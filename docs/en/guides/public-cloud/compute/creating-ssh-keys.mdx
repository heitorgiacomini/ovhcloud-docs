...
description: Find out how to create key pairs for OpenSSH on your local device and use them to establish secure connections to your instance
...
You can find more information in our [guide on how to create a Public Cloud instance](/guides/public-cloud/compute/getting-started).
:::
...
For example, [PuTTY](https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html) is an open-source SSH client software with many useful features. Find out how to use it for connections to OVHcloud servers and instances in our detailed tutorial:
...
:::info
`Ed25519` is considered the most secure but `RSA` is a valid alternative. Both methods are compatible with the [OVHcloud Control Panel](/guides/public-cloud/compute/getting-started).
:::
...
Copy this key string to [add it to a new instance or to import it into the OVHcloud Control Panel](/guides/public-cloud/compute/getting-started).
...
[How to create a Public Cloud instance](/guides/public-cloud/compute/getting-started)

[How to get started with SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)

[How to add authentication keys to your instance](/guides/public-cloud/compute/configuring-additional-ssh-keys)
