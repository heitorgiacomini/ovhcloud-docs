...
description: Find out how to change the hostname of a Public Cloud instance
lastUpdated: 2025-03-20
---

## Objective

With the cloud-init module, you can configure your [Public Cloud instance](https://www.ovhcloud.com/en-gb/public-cloud/compute/) when you create it, and each time you reboot it. Consequently, if you wish to reconfigure your hostname, because of an error when creating your instance or to reconfigure your email server, you will need to disable the Cloud-init module. This will configure the hostname so that it is not re-established.
...
- [SSH access](/guides/public-cloud/compute/getting-started#connect-instance) (sudo) to the instance
