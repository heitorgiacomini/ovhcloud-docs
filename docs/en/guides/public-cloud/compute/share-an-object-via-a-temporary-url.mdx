...
description: Find out how to share an object via a temporary URL
...
- An [environment that is ready to use the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
- [The OpenStack environment variables set up](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables).
