...
To find out more, consult the documentation: [Comparison and resilience of Deployment Modes - Understanding 3-AZ / 1-AZ / Local Zones](/guides/public-cloud/cross-functional/deployment-modes-comparison-resilience-details).
