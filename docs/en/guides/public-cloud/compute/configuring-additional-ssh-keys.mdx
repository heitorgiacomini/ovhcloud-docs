...
description: Find out how to configure additional SSH keys for user accounts and add them to your Public Cloud instance
...
- [Administrative access to your instance via SSH](/guides/public-cloud/compute/creating-ssh-keys#login-linux)
...
If necessary, use our [SSH key guide](/guides/public-cloud/compute/creating-ssh-keys) to create a new SSH key pair.  
You can also find information on [managing multiple keys](/guides/public-cloud/compute/creating-ssh-keys#multiplekeys) on your local device if your setup requires it.

### Step 2: Configure a new user account

[Connect to your instance](/guides/public-cloud/compute/getting-started#connect-instance) and use the commands below to create a new user account and `.ssh` folder:
...
You can learn more about user permissions and related topics in our [user account guide](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
Consult the [SSH key guide](/guides/public-cloud/compute/creating-ssh-keys) to learn more about using SSH keys with Public Cloud instances.


## Go further

[How to create Public Cloud instances](/guides/public-cloud/compute/getting-started)
