...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, go to the <code className="action">Network</code> section and click on <code className="action">Public IP Addresses</code>.
