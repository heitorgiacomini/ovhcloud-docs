...
description: Find out how to activate a Windows licence on an instance in private mode
...
- An [OpenStack user account](/guides/public-cloud/cross-functional/create-and-delete-a-user)

We recommend that you read our guide on [Accessing the Horizon](/guides/public-cloud/cross-functional/introducing-horizon) interface to familiarise yourself with Horizon.
...
Log in to the [Horizon](https://horizon.cloud.ovh.net/auth/login/) interface using the method listed in the [first part of this guide](/guides/public-cloud/network-services/vrack#horizon).
...
Select <code className="action">Compute</code> and then <code className="action">Instances</code> from the menu.

<img className="thumbnail" alt="compute and instance" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon2.png" loading="lazy" />
...
<img className="thumbnail" alt="windows key" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="windows key" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />
