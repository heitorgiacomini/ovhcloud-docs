...
description: Find out how to deploy pre-installed applications on your Public Cloud instances
...
Using the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> / API or the OpenStack Horizon / API, install your chosen application on your Public Cloud instance.
...
1. Log in to the [API console here](https://eu.api.ovh.com/).
