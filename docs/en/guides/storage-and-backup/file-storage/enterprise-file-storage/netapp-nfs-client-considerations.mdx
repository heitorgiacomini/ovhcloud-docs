...
description: Specific settings to check and/or implement for the Enterprise File Storage solution
...
- [An Enterprise File Storage solution](https://www.ovhcloud.com/en-gb/storage-solutions/enterprise-file-storage/)
