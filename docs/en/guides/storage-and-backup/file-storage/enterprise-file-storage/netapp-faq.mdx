...
description: Enterprise File Storage FAQ
...
Yes, you can access this service directly from your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> by going to the <code className="action">Bare Metal Cloud</code> section, then <code className="action">Storage and Backup</code>.
