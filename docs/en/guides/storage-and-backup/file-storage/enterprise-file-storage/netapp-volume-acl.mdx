...
description: Manage Enterprise File Storage volume ACLs using the OVHcloud API
...
All API routes used for this tutorial are available under the */storage* section here: [https://api.ovh.com/console/#/storage](https://api.ovh.com/console/#/storage).
