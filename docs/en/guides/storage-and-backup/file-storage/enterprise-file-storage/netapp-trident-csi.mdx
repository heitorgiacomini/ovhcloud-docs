...
- A [vRack](https://www.ovhcloud.com/en-gb/network/vrack/) with [vRack Services](/guides/network/vrack-services/global) configured
- Familiarity with the [OVHcloud APIs](/guides/manage-and-operate/api/first-steps) and/or the [OVHcloud CLI](/guides/manage-and-operate/cli/getting-started)
...
<img className="thumbnail" alt="Trident Requirements Schema" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/trident_efs_requirements.excalidraw.png" loading="lazy" />
...
[Enterprise File Storage - Private network configuration](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-network-config)

[Enterprise File Storage - Connect a Public Cloud instance to an EFS Volume via vRack Private Network](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-pci-connection-via-vrack)

[Managing OVHcloud service accounts via the API](/guides/manage-and-operate/api/manage-service-account)
