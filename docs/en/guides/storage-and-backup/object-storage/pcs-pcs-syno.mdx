...
description: Find here how to synchronise a Synology NAS with Object Storage
...
- [Create an Object Storage container](/guides/storage-and-backup/object-storage/pcs-create-container)
- [Configure an Openstack user](/guides/public-cloud/cross-functional/create-and-delete-a-user#creating-an-openstack-user)
...
[Setting OpenStack environment variables](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#step-1-retrieve-the-variables)
