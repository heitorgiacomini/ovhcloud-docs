...
description: Find out how to access your Public Cloud Archives using Rsync
...
You can generate your OpenStack login and password using this [guide](/guides/public-cloud/cross-functional/create-and-delete-a-user).
