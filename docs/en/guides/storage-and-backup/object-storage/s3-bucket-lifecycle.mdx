...
The minimum duration for transition rules between storage classes is **1 day** i.e your lifecycle configuration will not be valid and you will get an error if the number of days for your transition rule is less than 1 day. In pratice, if you have more than one transition, the minimum duration for the nth transtiion must equal or greater than n.

Examples:
- you have one transition from High Performance to Standard, the minimum duration is 1 day
- you have 3 transitions: 1st from High Performance to Standand, 2nd from Standard to Infrequent Access and 3rd from Infrequent Access to Active Archive. The minimum duration for the 1st transition is 1 day, 2 days for the 2nd one and 3 days for the 3rd one.
