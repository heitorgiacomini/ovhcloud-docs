...
description: Learn how to optimise the sending of your files to your bucket
...
- [AWS CLI](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage) installed
