...
Similar to your source bucket, you will need your `access key`, `secret key` but also the `region ID` for your destination bucket. Navigate to the <code className="action">Object Storage</code> section to collect those details.
