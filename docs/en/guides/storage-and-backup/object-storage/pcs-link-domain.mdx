...
description: Find here how to configure a domain name on your Object Storage container
...
- [Have a storage space](/guides/storage-and-backup/object-storage/pcs-create-container)
- A domain name
