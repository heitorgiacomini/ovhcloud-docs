...
description: This guide shows you how to configure Cyberduck to manage your Public Cloud Archives.
...
- your username (*OS_USERNAME*) and project credentials (*OS_PROJECT_NAME* or *OS_TENANT_NAME*). Retrieve them by downloading the OpenRC file from the [Users and Roles](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#step-1-retrieve-the-variables) menu in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
- your OpenStack user password.

In case you have forgotten your OpenStack user password, you can change it by following [this guide](/guides/public-cloud/cross-functional/create-and-delete-a-user).
...
Then click <code className="action">Connect</code>. Once you're logged in, you will have access to the tree-view of your folders and files.
...
[Getting started with the Swift API](/guides/storage-and-backup/object-storage/pcs-getting-started-with-the-swift-api)
