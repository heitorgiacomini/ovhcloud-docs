...
description: Find out how to use the Swift API
...
- Setting the [OpenStack environment variables](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
...
This URL is made up of an endpoint, available from the [Horizon interface](/guides/public-cloud/cross-functional/compute-horizon-access-security), the name of your container and the name of your object (including the prefix).
