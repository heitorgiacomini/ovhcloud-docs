...
You can use the <code className="action">Billing</code> dashboard in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> to view your current usage, and thus predict the final bill at the end of the month.
