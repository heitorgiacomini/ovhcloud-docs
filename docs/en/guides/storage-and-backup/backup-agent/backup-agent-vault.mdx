...
To find your Vaults, click <ManagerLink to="/#/bmc-backup-agent-baremetal/service">this link</ManagerLink> to access the <code className="action">Backup Agent</code> section, then click on the <code className="action">Vaults</code> tab.
