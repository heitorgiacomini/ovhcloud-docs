...
- At least one Bare Metal server with the Backup Agent installed on it. Read our guide "[How to configure your first backup](/guides/storage-and-backup/backup-agent/first-configuration)" for more information.
...
You must download the agent from the <ManagerLink to="/#/bmc-backup-agent-baremetal/service">Backup Agent</ManagerLink> section of your OVHcloud Control Panel and install it on your new Operating System.
