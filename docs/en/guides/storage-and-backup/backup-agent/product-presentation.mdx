...
description: Overview of the Backup Agent product features and benefits
...
Find out how to browse the VSPC interface via [this guide](/guides/storage-and-backup/backup-agent/vspc-presentation).
...
- Storage is based on [OVHcloud Object Storage](https://www.ovhcloud.com/en-gb/public-cloud/object-storage/) technology, which is hosted in OVHcloud datacenters.
