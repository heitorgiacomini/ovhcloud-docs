...
You must add your client machine's public IP address to the cluster's Access Control List (ACL) to allow it to connect. Follow [this guide](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-an-ip-acl) to add the IP in your Cloud Disk Array ACL.
