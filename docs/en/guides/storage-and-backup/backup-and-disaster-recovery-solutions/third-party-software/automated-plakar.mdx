...
description: Find out how to set up a dedicated server with Plakar to automate, encrypt, and monitor your server backups securely using OVHcloud Object Storage.
...
- A [VPS server](https://www.ovhcloud.com/en-gb/vps/) or a [dedicated server](https://www.ovhcloud.com/en-gb/bare-metal/).
...
<img className="thumbnail" alt="Architecture overview" src="/images/storage-and-backup/backup-and-disaster-recovery-solutions/third-party-software/plakar-automated-backup/architecture_overview.png" loading="lazy" />
...
In the left-hand menu, go to <code className="action">Object Storage</code>.

**Create an Object Storage User**

1. Open the <code className="action">Users</code> tab.
2. Click <code className="action">Create user</code>.

    <img className="thumbnail" alt="Create Object Storage user" src="/images/storage-and-backup/backup-and-disaster-recovery-solutions/third-party-software/plakar-automated-backup/create_os_user.png" loading="lazy" />
...
1. Click <code className="action">Create an Object Storage container</code>.
...
3. Click <code className="action">Create</code> to confirm.

:::info
For more details on creating and managing an Object Storage bucket, you can follow our guide [Object Storage – Getting started with Object Storage](/guides/storage-and-backup/object-storage/s3-getting-started-with-object-storage).
...
1. Go to <code className="action">Bare Metal Cloud</code> > <code className="action">VPS</code>.
2. Click <code className="action">Order</code>, then <code className="action">Configure your VPS</code>.

    <img className="thumbnail" alt="Create VPS" src="/images/storage-and-backup/backup-and-disaster-recovery-solutions/third-party-software/plakar-automated-backup/create_vps.png" loading="lazy" />
...
For more information on initial VPS setup and security, see our guide [Getting started with a VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
...
<summary>Set a custom token (recommended)</summary>
...
<summary>Use an automatically generated token</summary>
