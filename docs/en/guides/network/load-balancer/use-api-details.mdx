...
description: Details of API functionalities
...
All API calls that are made in the section */ipLoadbalancing* are available on [this page](https://eu.api.ovh.com/console/).
