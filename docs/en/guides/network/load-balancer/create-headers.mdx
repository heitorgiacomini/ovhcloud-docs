...
description: Integrate your web services behind a Load Balancer with HTTP headers
...
<img className="thumbnail" alt="IPv4 output address of your OVHcloud Load Balancer service" src="/images/network/load-balancer/create-headers/iplb_service.png" loading="lazy" />
...
Go to the <code className="action">Frontends</code> tab in the dashboard of your OVHcloud Load Balancer service and select the *frontend* to edit or click on the <code className="action">Add a frontend</code> button to create a new one. An editing window will appear, displaying an <code className="action">HTTP Header</code> field in the <code className="action">Advanced Settings</code> section.
...
<img className="thumbnail" alt="Configuration of HTTP headers of a Frontend via ovh manager API" src="/images/network/load-balancer/create-headers/add_headers.png" loading="lazy" />

Click on the <code className="action">Update</code> button after configuring the headers, then on <code className="action">Deploy zone: YOUR ZONE</code> to apply the changes in the concerned zone.
...
In the OVHcloud API console, a <code className="action">+</code> button is available as soon as you start to specify a value, allowing you to add a new field to the list. 

<img className="thumbnail" alt="Configuration of HTTP headers of a Frontend" src="/images/network/load-balancer/create-headers/add_headers_with_api.png" loading="lazy" />
...
- Modification of an existing <code className="action">Frontend</code> :
