...
You can configure your SSL termination from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> in the <code className="action">Bare Metal Cloud</code> section, then <code className="action">Load Balancer</code>.
