...
description: How to configure vRack on a Load Balancer
...
Before starting, if you haven't read it yet, we advise you to read the general presentation of the [Load Balancer](/guides/network/load-balancer/use-presentation) service.
...
As a reminder, a configuration guide for the Load Balancer is available: [Here](/guides/network/load-balancer/create-http-https).
