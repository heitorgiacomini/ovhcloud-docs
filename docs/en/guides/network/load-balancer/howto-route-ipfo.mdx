...
You can define dedicated Additional IPs via the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> by navigating to the <code className="action">Network</code> section, then <code className="action">Load Balancer</code>.
