...
description: Understand the differences between Primary IP and Additional IP addresses, and learn about their use cases
...
You can find more information about the differences between Floating IP and Additional IP in [this guide](/guides/public-cloud/network-services/additional-ip-vs-floating-ip).
...
- **Configuration**: IPv4 and IPv6 addresses configuration details, such as address, prefix size, or default gateway, can be found within the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, usually in the <code className="action">Network</code> tab of the given product.
...
For more information about moving Additional IP, please check [this guide](/guides/bare-metal-cloud/dedicated-servers/move-failover-ip).
...
:::tip
**Related Guides** :
- [Configuring an Additional IPv6 block in a vRack](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack)
- [Configuring an Additional IP block in a vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack)
- [Moving an Additional IP](/guides/bare-metal-cloud/dedicated-servers/move-failover-ip)
- [Configuring Additional IPs in bridge mode on your virtual machines](/guides/bare-metal-cloud/dedicated-servers/network-bridging)
