...
description: Find out how to request the removal of an IP address from a blocklist if your services are impaired by anti-spam providers
...
:::info
Please see our guide on [how to prevent your emails from being marked as spam](/guides/bare-metal-cloud/dedicated-servers/mail-sending-optimization) to see the best practices for running an email server.
...
- The details of your organization (*RWhois*) in the section <code className="action">Network</code>: Open <code className="action">IP</code> and then click the <code className="action">Cogwheel button</code> on the right. Select <code className="action">Manage my organisation</code> from the drop-down menu.
