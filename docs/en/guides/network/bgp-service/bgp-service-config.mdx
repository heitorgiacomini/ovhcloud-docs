...
description: By using BGP Service, you gain full control over your routing policies and network resilience. Follow this guide to set up and optimize your BGP sessions
...
You need to either buy [Additional IP](https://www.ovhcloud.com/en-gb/network/additional-ip/) from OVHcloud or use your own IPs with BYOIP.
...
If you need to import your IPs, you need to use our BYOIP service. Please follow [this documentation](/guides/network/bring-your-own-ip/bring-your-own-ip) to import your IPs to OVHcloud.
