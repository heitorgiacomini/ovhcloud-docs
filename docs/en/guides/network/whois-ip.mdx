...
description: Find out how to determine if an IP address is managed, provided and/or associated with an OVHcloud service, via the ICANN website
...
Once you have entered the IP address, click on the blue <code className="action">Lookup</code> button.
