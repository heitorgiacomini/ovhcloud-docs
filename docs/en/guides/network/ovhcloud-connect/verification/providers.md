...
| Supported provider set: BSO (formerly Intercloud), **Colt Technology Services**, Console Connect, Digital Realty, Equinix (Fabric), Megaport, Orange Business Services, Risq | 39-143 | spec provider list (website): Digital Realty, Colt, Console Connect, Megaport, Equinix, InterCloud/BSO, Orange Business Services, RISQ. **Colt added this cycle** — the guide now lists all 8. |
...
|---|---|---|
| Colt Technology Services description (Colt IQ Network, Dedicated Cloud Access, On Demand NaaS) | 54-58 | **Resolved: Colt was added to the guide** (§ Colt Technology Services). Like the other entries, the marketing description is third-party — no OVHcloud source. |
...
| All external provider URLs (bso.co, **colt.net**, consoleconnect.com, digitalrealty.com, equinix.com, megaport.com, orange-business.com, risq.quebec, plus doc/API links) | 49-143 | live-URL validity and correct deep-links not confirmable from SOT; run /verify-links. (Colt URLs — colt.net/products/cloud/connect/dca, colt.net/products/networking/network-as-a-service — were web-searched when added.) |
