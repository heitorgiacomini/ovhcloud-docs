...
See [Monitor](/guides/network/ovhcloud-connect/diagnostics).
...
Set up independent monitoring for each link, each BGP session, and each WAN circuit. See [Monitor](/guides/network/ovhcloud-connect/diagnostics).
...
- [Monitor your connections](/guides/network/ovhcloud-connect/diagnostics)
