...
<img className="thumbnail" alt="Steps overview" src="/images/network/ovhcloud-connect/occ-direct-control-panel-setup/fig-1.svg" loading="lazy" />
...
- For a managed connection, see [Quick Start: Provider Connection](/guides/network/ovhcloud-connect/provider-control-panel-setup)
- For resilient setups, see [Resilient On-Prem tutorial](/guides/network/ovhcloud-connect/resilient-architecture)
- Set up [monitoring](/guides/network/ovhcloud-connect/diagnostics) for your connection
