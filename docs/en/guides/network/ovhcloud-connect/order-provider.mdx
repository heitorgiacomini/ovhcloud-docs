...
description: 'Learn how to order an OVHcloud Connect service through a third-party network provider'
...
2. Click **Order a new connection**.
...
7. Review pricing and **confirm** the order.
...
<img className="thumbnail" alt="What happens after ordering" src="/images/network/ovhcloud-connect/order-provider/fig-1.svg" loading="lazy" />
