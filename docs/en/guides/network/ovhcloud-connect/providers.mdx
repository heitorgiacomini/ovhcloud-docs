...
description: 'Discover the third-party network providers that partner with OVHcloud to offer managed connectivity'
...
- **Connection speed** — Confirm the bandwidth options available. With OVHcloud Connect Provider, bandwidth ranges from 50 Mbps up to 50 Gbps.
...
:::info
**Note:** The list of supported providers may evolve over time. Check the [OVHcloud Connect Webpage](/links/network/ovhcloud-connect) for the most current list.
:::
...
- **Website:** [bso.co/bso-network/cloud-connect-solutions](https://www.bso.co/bso-network/cloud-connect-solutions)
- **Resources:** [bso.co/resource-centre](https://www.bso.co/resource-centre)

### Colt Technology Services

#### Description

Colt Technology Services is a global network operator running the Colt IQ Network. For private cloud connectivity, its Dedicated Cloud Access (DCA) service establishes direct connections to cloud providers including OVHcloud, while its On Demand (Network-as-a-Service) platform adds real-time, self-service provisioning.

Colt operates across Europe, Asia, and North America, with a focus on low-latency connectivity for enterprises and data-intensive industries.

#### Useful links

- **Website:** [colt.net/products/cloud/connect/dca](https://www.colt.net/products/cloud/connect/dca)
- **On Demand (NaaS):** [colt.net/products/networking/network-as-a-service](https://www.colt.net/products/networking/network-as-a-service)
...
Console Connect provides global reach with a presence across Asia-Pacific, Europe, and the Americas.

#### Useful links

- **Website:** [consoleconnect.com](https://www.consoleconnect.com/clouds/connect-to-ovhcloud/)
- **Documentation:** [consoleconnect.com/help](https://www.consoleconnect.com/help/)
...
Digital Realty provides colocation combined with scalable interconnection options for hybrid and multi-cloud deployments.
...
Equinix Fabric is a solution for enterprises requiring low-latency, high-performance interconnection at scale.

#### Useful links

- **Website:** [equinix.com/interconnection-services/fabric](https://www.equinix.com/product-solutions/connectivity/fabric)
...
Megaport's network spans North America, Europe, and Asia-Pacific, providing reach for hybrid and multi-cloud architectures.
...
Orange Business Services is the enterprise division of Orange, one of Europe's leading telecommunications operators. They provide managed network solutions including MPLS, Internet, and cloud connectivity services tailored for large enterprises and multinational corporations.

Orange Business Services operates a global network with a presence in Europe, Africa, and the Middle East. Their solutions integrate traditional WAN services with modern cloud connectivity, enabling seamless hybrid architectures.
...
1. **You order** a connection to OVHcloud through the provider's portal or with OVHcloud (who gives you a **service key**).
...
- Check [PoP Locations & Regions](/guides/network/ovhcloud-connect/pop-locations-regions) to find where you can connect
- Follow the [Quick Start with a Provider](/guides/network/ovhcloud-connect/occ-provider-control-panel-setup) to get started
