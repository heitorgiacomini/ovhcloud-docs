...
<img className="thumbnail" alt="Key metrics to watch" src="/images/network/ovhcloud-connect/diagnostics/fig-1.svg" loading="lazy" />
...
- [Forward your OVHcloud Connect logs](/guides/network/ovhcloud-connect/logs-to-customers) to Logs Data Platform for long-term storage and analysis
