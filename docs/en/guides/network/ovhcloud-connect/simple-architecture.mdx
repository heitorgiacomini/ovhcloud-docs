...
:::info
Azure uses ASN **12076** for ExpressRoute Private Peering. The OVHcloud BGP AS depends on the PoP region: **65501** (Europe), **65502** (Canada), **65519** (Asia). Do not use **AS65501** as your customer-side ASN (a known issue prevents routes from being propagated); choose a customer ASN in the **64512–65534** range instead.
:::
