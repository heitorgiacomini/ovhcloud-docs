...
Configure monitoring alerts for link status, BGP session, and bandwidth. See [Monitor](/guides/network/ovhcloud-connect/diagnostics).
...
Monitor the WAN edge BGP session and OVHcloud Connect link. See [Monitor](/guides/network/ovhcloud-connect/diagnostics).
...
:::info
Azure uses ASN **12076** for ExpressRoute Private Peering.
:::
