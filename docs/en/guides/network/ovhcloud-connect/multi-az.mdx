...
- **MED (Multi-Exit Discriminator)** — Use MED values to influence inbound routing from OVHcloud. MED is the recommended way to influence OVHcloud/inbound path selection.
