...
This guide explains how to enable forwarding logs from your OVHcloud Connect to Logs Data Platform (LDP), a platform that helps you store, archive, query and visualise your logs.
...
- An up-and-running [OVHcloud Connect service](/guides/network/ovhcloud-connect/introduction).
...
Refer to the following documentation: [Logs Data Platform - Visualising, querying and exploiting your logs](/links/manage-operate/ldp) for more details about how to use your logs with Logs Data Platform, including how to:
