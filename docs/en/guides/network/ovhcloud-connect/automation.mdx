...
description: 'Discover how to manage OVHcloud Connect programmatically using the API, CLI, and Terraform'
lastUpdated: 2026-06-15
---

## Objective

Managing OVHcloud Connect through the OVHcloud API, command-line tools, and Terraform lets you operate it repeatably and at scale instead of clicking through the Control Panel. This approach reduces manual errors, speeds up provisioning, and makes your setup reproducible and version-controlled — useful whenever you want to script deployments or keep configuration under source control.
...
:::tip
**Security tip:** Never hard-code your API credentials. Use environment variables, a configuration file (`ovh.conf`), or a secrets manager.
:::

## Command-Line Interface (CLI)

You can use the API wrappers in a scripting context or build lightweight CLI scripts using the SDKs above.
...
terraform {
  required_providers {
    ovh = {
      source = "ovh/ovh"
      # Use a recent version of the OVHcloud Terraform provider
    }
  }
}
