...
:::info
Alternatively, you can associate from the vRack page: go to <code className="action">Network</code> > <code className="action">vRack</code>, select your vRack, click <code className="action">Add a service</code>, find your **OVHcloud Connect** service in the list of eligible services, then click <code className="action">Add</code> to confirm.
:::
