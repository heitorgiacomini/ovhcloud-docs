...
- **Monitor the session.** Set up alerts for BGP flaps and session drops — see [Monitor your connection](/guides/network/ovhcloud-connect/diagnostics).
...
- [Monitor your connection](/guides/network/ovhcloud-connect/diagnostics)
