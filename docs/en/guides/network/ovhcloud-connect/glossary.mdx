...
A physical location (third-party data center) where the OVHcloud network is available for connection. It is also the entry point of your data into OVHcloud's private network. The accessible PoPs are listed on [this link on our website](https://www.ovhcloud.com/en/network/ovhcloud-connect/).
