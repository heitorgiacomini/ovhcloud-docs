...
|---|---|---|---|
| **OVHcloud Connect Direct** | You manage a physical cable (cross-connect) between your equipment and OVHcloud's equipment in a common Point of Presence. | Layer 2 (L2) and Layer 3 (L3) | Organisations already present in an OVHcloud PoP. |
| **OVHcloud Connect Provider** | A third-party network provider among our [partners](/guides/network/ovhcloud-connect/providers) handles the physical connection on your behalf. | Layer 3 (L3) only | Organisations that are not co-located with OVHcloud or prefer a managed connectivity service. |
