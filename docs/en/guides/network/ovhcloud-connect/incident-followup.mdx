...
description: 'Learn how to report an OVHcloud Connect incident, provide diagnostic information, and track resolution'
...
- Set up proactive [monitoring](/guides/network/ovhcloud-connect/diagnostics) to detect issues before they impact your users
