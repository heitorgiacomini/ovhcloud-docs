...
description: Find out how to forward your logs from an OCC service to Logs Data Platform
...
If you would like to find out more about Logs Data Platform before reading this guide, please refer to the [Logs Data Platform introduction guide](/guides/manage-and-operate/observability/logs-data-platform/introduction).

## Glossary

- **Logs Data Platform:** a fully managed and secured log management platform by OVHcloud. For more information, consult the [Logs Data Platform](https://www.ovhcloud.com/en-gb/identity-security-operations/logs-data-platform/) service page.
...
- An up-and-running [OVHcloud Connect service](/guides/network/ovhcloud-connect/overview).
...
Note that the forwarding activation is free of charge, but you will be charged for the usage of the Logs Data Platform service as per the standard price plan. For LDP pricing, refer to this [page](https://www.ovhcloud.com/en-gb/identity-security-operations/logs-data-platform/).
...
You can retrieve the API specifications in the [OVHcloud API Portal](https://eu.api.ovh.com/):
