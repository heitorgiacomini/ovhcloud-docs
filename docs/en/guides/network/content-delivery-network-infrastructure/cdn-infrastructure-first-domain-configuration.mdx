...
description: Find out how to properly configure a domain on the OVH CDN
...
- an [OVH Content Delivery Network (CDN)](https://www.ovhcloud.com/en-gb/network/cdn/) solution
- access to the <ManagerLink to="/">OVH Control Panel</ManagerLink>
...
To do this, go to the <ManagerLink to="/">OVH Control Panel</ManagerLink>, click on the <code className="action">Dedicated</code> tab, then go to <code className="action">NAS and CDN</code>.

Next, click <code className="action">Add a domain to the CDN</code>.

<img className="thumbnail" alt="CDN Control Panel" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png" loading="lazy" />

In the first step, you can choose the subdomain you want to add to the CDN.

<img className="thumbnail" alt="Add a subdomain name on the CDN" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Add a backend" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Name of photo" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png" loading="lazy" />
