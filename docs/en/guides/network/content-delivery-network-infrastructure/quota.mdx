...
description: Find out how quota works on the CDN
...
If you need additional quota, you can order it directly via the <ManagerLink to="/">OVH Control Panel</ManagerLink>:

<img className="thumbnail" alt="Add quota" src="/images/network/content-delivery-network-infrastructure/quota/add_quota.png" loading="lazy" />

You can view the prices for quota allowance on our [website](https://www.ovhcloud.com/en-gb/network/cdn/).
...
<img className="thumbnail" alt="Quota usage" src="/images/network/content-delivery-network-infrastructure/quota/quota_used.png" loading="lazy" />
