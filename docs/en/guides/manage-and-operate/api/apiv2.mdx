...
description: Discover the new principles of exposure and consumption linked to the OVHcloud API v2
lastUpdated: 2023-04-17
---

## Objective

The APIs available at [https://eu.api.ovh.com/](https://eu.api.ovh.com/) allow you to buy, manage, update and configure OVHcloud products without using a graphical interface like the OVHcloud Control Panel.
...
<img className="thumbnail" alt="API" src="/images/manage-and-operate/api/apiv2/console-schemas-version.png" loading="lazy" />
...
:::info
The event and task examples shown above may vary by API section. Please refer to the [console](/guides/manage-and-operate/api/console-preview) to view the exact definition for each section.
:::
...
[Exploring OVHcloud APIs](/guides/manage-and-operate/api/console-preview)
