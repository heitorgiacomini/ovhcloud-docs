...
description: Find out about useful resources in order to use the official OVHcloud Command Line Interface (CLI)
...
You can check [this guide](/guides/manage-and-operate/api/first-steps) to learn how to create API credentials.
