...
description: Connect Grafana to the Logs Data Platform OpenSearch API to build your dashboards.
...
:::warning
For this to work, ensure that you:

- Set `https://<your_cluster>.logs.ovh.com:9200` as **URL** value
- Set your [Logs Data Platform credentials](/guides/manage-and-operate/observability/logs-data-platform/tokens) for **Basic auth values**
