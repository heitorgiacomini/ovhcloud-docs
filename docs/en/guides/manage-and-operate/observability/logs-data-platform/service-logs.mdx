...
description: Discover how to retrieve your OVHcloud managed products logs in Logs Data Platform
...
OVHcloud Service Logs is a solution that allows you to retrieve your OVHcloud products logs inside Logs Data Platform. It lets you transform these logs into actionable data through the Logs Data Platform feature set:
...
- A [Logs Data Platform](https://www.ovhcloud.com/en-gb/identity-security-operations/logs-data-platform/) account
...
| :----------- | :----------- | :--------- |
| Security & Identity - OVHcloud Account - Activity | OVHcloud Control Panel & API | [Generating OVHcloud account logs with Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding) |
| Security & Identity - OVHcloud Account - Audit | OVHcloud Control Panel & API | [Generating OVHcloud account logs with Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding) |
| Security & Identity - OVHcloud Account - IAM | OVHcloud Control Panel & API | [Generating OVHcloud account logs with Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding) |
| Security & Identity - Key Management Service | OVHcloud Control Panel & API | [Pushing logs from OVHcloud KMS to Logs Data Platform](/guides/manage-and-operate/kms/logs) |
...
| Hosted Private Cloud - Managed VMware vSphere | OVHcloud Control Panel & API | [Hosted Private Cloud - Collect VMware on OVHcloud logs](/guides/hosted-private-cloud/powered-by-vmware/vmware-ldp) |
| Hosting & Collaboration - Web Cloud Databases | OVHcloud Control Panel & API | [Web Cloud Databases - How to manage logs](/guides/web-cloud/databases/db-retrieve-logs) |
| Hosting & Collaboration - Microsoft Private Exchange | OVHcloud Control Panel & API | [Exchange - How to manage logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
| Hosting & Collaboration - Microsoft Trusted Exchange | OVHcloud Control Panel & API | [Exchange - How to manage logs](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-manage-logs) |
| Infrastructure solutions - OVHcloud Connect | OVHcloud Control Panel & API | [OVHcloud Connect Logs Forwarding](/guides/network/ovhcloud-connect/logs-to-customers) |
| Infrastructure solutions - OVHcloud Load Balancer | OVHcloud Control Panel & API | [OVHcloud Load Balancer TCP / HTTP / HTTPS Logs Forwarding](/guides/network/load-balancer/use-api-logs-customers) |
...
On every product compatible with OVHcloud Service Logs you will find a <code className="action">Logs</code> tab in the OVHcloud Control Panel. Once you click this tab, you will see the two main components of OVHcloud Service Logs: a **live-tail** panel and a **subscription** panel.
...
<img className="thumbnail" alt="basic-search" src="/images/manage-and-operate/observability/logs-data-platform/introduction-to-services-logs/basic_search.png" loading="lazy" />
...
If you click on the <code className="action">Subscribe</code> button (or <code className="action">Subscribe to another data stream</code> if you already have some existing subscriptions), you will land on this page:

<img className="thumbnail" alt="create-subscription-page" src="/images/manage-and-operate/observability/logs-data-platform/introduction-to-services-logs/subscribe_page.png" loading="lazy" />
...
The last column contains the <code className="action">Subscribe</code> and <code className="action">Unsubscribe</code> buttons. Clicking on <code className="action">Subscribe</code> will start sending your service logs in the selected data stream, while clicking on <code className="action">Unsubscribe</code> will stop sending them.
...
<img className="thumbnail" alt="manager-with-kind" src="/images/manage-and-operate/observability/logs-data-platform/introduction-to-services-logs/multiple_kind.png" loading="lazy" />
...
<img className="thumbnail" alt="list-from-stream" src="/images/manage-and-operate/observability/logs-data-platform/introduction-to-services-logs/list_from_stream.png" loading="lazy" />
...
<img className="thumbnail" alt="many-to-one-per-env" src="/images/manage-and-operate/observability/logs-data-platform/introduction-to-services-logs/many_to_one_per_env.png" loading="lazy" />
...
<img className="thumbnail" alt="many-to-many" src="/images/manage-and-operate/observability/logs-data-platform/introduction-to-services-logs/many_to_many.png" loading="lazy" />
