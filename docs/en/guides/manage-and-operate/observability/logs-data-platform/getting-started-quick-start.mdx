...
- [Manage IAM Policies](/guides/manage-and-operate/observability/logs-data-platform/overview) to allow other users of the platform to see your beautiful Dashboards or let them explore your Streams instead of doing it for them.
- [Using OpenSearch Dashboards and aliases to unleash the power of OpenSearch](/guides/manage-and-operate/observability/logs-data-platform/opensearch-dashboards)
