...
description: Discover how we handle the security of the OKMS infrastructure
...
Access to the keys is controlled by the [OVHcloud IAM](/guides/account-and-service-management/account-information/iam-policy-ui).
...
<img className="thumbnail" alt="Architecture overview" src="/images/manage-and-operate/kms/architecture-overview/KMS_Overview_1AZ.png" loading="lazy" />
