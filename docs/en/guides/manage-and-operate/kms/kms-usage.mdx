...
You can access the KMS Swagger UI by clicking on the link in your <ManagerLink to="/#/dedicated/security/kms">Key Management Service</ManagerLink> domain dashboard.
