...
description: Discover the steps you need to take to set up your first Key Management Service (KMS), create a key, and access it
...
- **Direct link:** <ManagerLink to="/#/dedicated/security/kms">Key Management Service</ManagerLink>
...
Click the <code className="action">Order an OKMS domain</code> button.

<img className="thumbnail" alt="Access to the KMS menu" src="/images/manage-and-operate/kms/quick-start/access_to_the_KMS_menu_01.png" loading="lazy" />

Enter the region of your KMS.

<img className="thumbnail" alt="Order the KMS" src="/images/manage-and-operate/kms/quick-start/order_kms_01.png" loading="lazy" />

You can then finalize the command in another tab. If it has not opened automatically, the command link is displayed:

<img className="thumbnail" alt="Order the KMS" src="/images/manage-and-operate/kms/quick-start/order_kms_02.png" loading="lazy" />

After a few seconds, the KMS will be available in your Control Panel.

<img className="thumbnail" alt="Order the KMS" src="/images/manage-and-operate/kms/quick-start/order_kms_03.png" loading="lazy" />

### Via the administration console

#### Create an encryption key

In the <code className="action">Service Keys</code> tab, click the <code className="action">Create a Service Key</code> button.

<img className="thumbnail" alt="Create a key" src="/images/manage-and-operate/kms/quick-start/create_key_01.png" loading="lazy" />

A form allows you to configure the key and select its type, size and usage.

<img className="thumbnail" alt="Create a key" src="/images/manage-and-operate/kms/quick-start/create_key_02.png" loading="lazy" />

:::warning
Only key creation through [regionalized APIs](/guides/manage-and-operate/kms/kms-usage) is covered by PCI-DSS certifications.
...
<img className="thumbnail" alt="Create a key" src="/images/manage-and-operate/kms/quick-start/create_key_03.png" loading="lazy" />
...
Necessary steps to create an access certificate are available on the [dedicated documentation](/guides/manage-and-operate/kms/okms-certificate-management).
...
- Using the [Rest API](/guides/manage-and-operate/kms/kms-usage) if you want to manually use the API to encrypt or sign your data.
- Using the [KMIP protocol](/guides/manage-and-operate/kms/kms-kmip) if you want to connect any KMIP compatible product with your OVHcloud KMS.
