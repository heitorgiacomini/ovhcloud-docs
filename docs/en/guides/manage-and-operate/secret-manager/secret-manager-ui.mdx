...
description: Discover how to use the Secret Manager with the graphical interface
...
The Secret Manager is accessible from the <code className="action">Identity, Security & Operations</code> menu in the <code className="action">Security</code> section.
...
To create a secret, click directly on the <code className="action">Create a secret</code> button.
...
To do this, click on <code className="action">Display the value</code> in the secret dashboard.
