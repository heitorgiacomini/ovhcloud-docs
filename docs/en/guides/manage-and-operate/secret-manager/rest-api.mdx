...
You can access the OKMS Swagger UI by clicking on the link in your <ManagerLink to="/#/dedicated/security/kms">OKMS domain dashboard</ManagerLink>.
...
<img className="thumbnail" alt="certificate-identification" src="/images/manage-and-operate/secret-manager/secret-manager-rest-api/firefox-identify-with-certificate.png" loading="lazy" />
