...
- You know how [send IAM policy logs to Logs Data Platform](/guides/manage-and-operate/iam/logs-forwarding).
...
If [transmission of OVHcloud account logs to LDP](/guides/manage-and-operate/iam/logs-forwarding) is enabled, you can find the information in the access policy logs.
