...
description: Find out how to renew your services via the OVHcloud API
...
**This guide explains how to renew your services via the OVHcloud API.**

## Requirements

- You need to be connected to the [OVHcloud API](https://eu.api.ovh.com/).
- You need to have [created your login details for the OVHcloud API](/guides/manage-and-operate/api/first-steps).
