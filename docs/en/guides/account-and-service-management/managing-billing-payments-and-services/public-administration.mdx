...
- Être une administration publique et l'avoir déclaré comme tel dans l'<ManagerLink to="/">espace client OVHcloud</ManagerLink>.
...
À la fin de votre commande, lors de la validation du moyen de paiement, il vous suffit de choisir <code className="action">Payer par mandat administratif</code> :

<img className="thumbnail" alt="Paiement par mandat" src="/images/account-and-service-management/managing-billing-payments-and-services/mandat-administratif/moyen_paiement.png" loading="lazy" />
