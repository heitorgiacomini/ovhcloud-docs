...
description: How to recognise a phishing email, and what should you do if you click on a fraudulent link?
...
First, check whether the email you received is also visible on the <ManagerLink to="/#/communication">My messages</ManagerLink> page. You will find copies of all official emails sent by OVHcloud there.
...
<img className="thumbnail" alt="Difference between an OVHcloud email and a phishing email" src="/images/account-and-service-management/account-information/phishing-care/EN-legit-and-phishing-email.png" loading="lazy" />
...
<summary>**List of legitimate OVHcloud domain names** (click to display)</summary>
...
<summary>**Tips to verify a suspicious link** (click to display)</summary>
...
OVHcloud will **never** send you a link via SMS. The SMS messages we send are usually related to [two-factor authentication in your OVHcloud Control Panel](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
<img className="thumbnail" alt="Fraudulent SMS" src="/images/account-and-service-management/account-information/phishing-care/sms-phishing.png" loading="lazy" />
...
<img className="thumbnail" alt="Outlook Windows - identifying the version" src="/images/account-and-service-management/account-information/phishing-care/outlook-windows-identify01.png" loading="lazy" />

**Classic Outlook:**

1. Select the phishing email in your inbox (do not open it).
2. Click <code className="action">File</code> in the menu bar, then <code className="action">Save As</code>.
3. In the "Save as type" dropdown, select **Outlook Message Format - Unicode (.msg)**.
4. Choose a location on your computer (e.g. your Desktop) and click <code className="action">Save</code>.
...
2. Select <code className="action">Save as</code>, then choose <code className="action">Save as EML</code>.
...
2. Select <code className="action">Save As</code>.
3. The email will be saved as a `.eml` file. Choose a location on your computer and click <code className="action">Save</code>.
...
2. In the menu bar, click <code className="action">File</code> > <code className="action">Save As</code>.
3. Choose the **Raw Message Source** format, select a location on your computer and click <code className="action">Save</code>.
...
3. Select <code className="action">View</code> > <code className="action">View message source</code>.
...
1. Select the phishing email in your inbox.
2. Click <code className="action">More</code> (or the **⋮** icon) in the toolbar.
3. Select <code className="action">Download (.eml)</code>.
...
1. Select the phishing email in your inbox.
2. Click <code className="action">More</code> in the toolbar.
3. Select <code className="action">Show Original</code>. The raw content of the email will open in a new browser tab.
...
3. Select <code className="action">Download message</code>.
...
<summary>**If you have entered your credit card number on a fraudulent website**</summary>
...
<summary>**If you have entered your OVHcloud password on a fraudulent website**</summary>


Open the <ManagerLink to="/#/account/useraccount/security">Account security</ManagerLink> page and change your password.

In our guide [Changing your account password](/guides/account-and-service-management/account-information/manage-ovh-password), you will find instructions for changing your password via the OVHcloud Control Panel, as well as our recommendations for generating a strong password, and saving it in a password manager.

We strongly advise you to enable [two-factor authentication](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) to permanently secure your account.
