...
<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/all-about-username/nichandle09.png" loading="lazy" />
