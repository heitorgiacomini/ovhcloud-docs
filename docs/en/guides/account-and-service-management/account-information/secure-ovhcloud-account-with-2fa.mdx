...
description: Find out how to improve security for your OVHcloud account by enabling two-factor authentication (2FA)
...
- An understanding of the [password management recommendations for accessing your account](/guides/account-and-service-management/account-information/manage-ovh-password)
...
- **Direct link:** <ManagerLink to="/#/account/useraccount/security">Account security</ManagerLink>
...
On the <ManagerLink to="/#/account/useraccount/security">Account security</ManagerLink> page, click <code className="action">Enable two-factor authentication</code>.

**Click on the tab corresponding to the method of your choice:**

<Tabs>
  <Tab label="SMS">
    Choose the SMS method and click <code className="action">Next</code>.
...
Two-factor authentication is now enabled. You can also add other numbers.
  ...
  <Tab label="Mobile App">
    Choose the method by mobile application and click <code className="action">Next</code>.
...
A QR code is generated, scan it via your OTP application. If your OTP application does not offer this option, click <code className="action">Show secret</code> to display a code to enter into the OTP application.<br/>
...
Two-factor authentication is now enabled.
  ...
  <Tab label="Security key">
    Choose the security key method and click <code className="action">Next</code>.
...
Go to the <ManagerLink to="/">login page for the OVHcloud Control Panel</ManagerLink> and enter your ID (or primary email address) and password.

The login screen displays the last two-factor authentication method used or entered. If you would like to use another method, click the <code className="action">Try another method</code> button.
...
To remove a device, go to the <ManagerLink to="/#/account/useraccount/security">Account security</ManagerLink> page and click the <code className="action">...</code> button to the right of the device you want to delete, then click <code className="action">Delete</code>.
...
A final validation code will then be sent to the device you want to delete. Enter this code in the window that opens, then click <code className="action">Confirm</code> to complete the deletion.
...
Once you have removed all your devices, disable the emergency codes by clicking the <code className="action">Disable 2FA codes</code>  button.
...
First, go to <ManagerLink to="/">the login page of the OVHcloud Control Panel</ManagerLink>.

Enter your OVHcloud ID and password to access the two-factor authentication step. Then click the <code className="action">I have lost access to my mobile phone, U2F security key or emergency codes</code> button.<br/>
If you do not see this button, click the <code className="action">Try another method</code> button, then <code className="action">I have lost access to my mobile phone, U2F security key or emergency codes</code>.
...
<summary>Needed documents</summary>
