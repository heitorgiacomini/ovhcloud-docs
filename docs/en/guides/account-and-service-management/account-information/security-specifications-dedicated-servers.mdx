...
Other guides are available in the guide on Dedicated Servers to assist the customer with the transfer
...
To increase access to the customer account, the customer can enable [two-factor authentication (2FA)](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) or single sign-on (SSO) by linking their account to an external Active Directory.
