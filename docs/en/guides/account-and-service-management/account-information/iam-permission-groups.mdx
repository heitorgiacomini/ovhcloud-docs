...
description: Details of permission groups provided by OVHcloud
...
- You know [how to set up IAM policies via the Control Panel](/guides/account-and-service-management/account-information/iam-policy-ui)
- You know [how to implement IAM policies via the API](/guides/account-and-service-management/account-information/iam-policies-api)
