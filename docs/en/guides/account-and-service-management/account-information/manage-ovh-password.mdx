...
description: Find out how to set, change and manage your password for the OVHcloud Control Panel
...
- On the <ManagerLink to="/#/account/useraccount/security">Account security</ManagerLink> page, click <code className="action">Edit</code> to the right of “Password”.
...
- A message will then pop up, confirming that the password has been changed successfully. Click <code className="action">Continue</code> at the bottom of the pop-up to be redirected to the login page, then enter your NIC handle and new password.

<a name="lost-password"></a>

#### If you have forgotten your current password

- Click <code className="action">Forgotten your username or password?</code> when you load the login page for the OVHcloud Control Panel.
...
- Enter your NIC handle, or the primary email address associated with your OVHcloud account, then click <code className="action">Send</code>.
