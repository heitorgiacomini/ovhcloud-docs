...
In your <ManagerLink to="/#/pci/projects">Public Cloud project</ManagerLink>, go to the `Project Management` section and click on <code className="action">Quota & Regions</code>. Click on <code className="action">Contact Support</code>.
