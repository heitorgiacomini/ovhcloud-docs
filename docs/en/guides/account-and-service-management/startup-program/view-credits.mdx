...
description: Check your OVHcloud Startup Program credits to manage your resources and track your balance and usage history
...
In <ManagerLink to="/#/billing/payment/method">My payment methods</ManagerLink>, select the <code className="action">My Vouchers</code> tab. Here, you will see the total amount of allocated credits, the expiration date, remaining credits, and the consumption history.

    <img className="thumbnail" alt="vouchers" src="/images/account-and-service-management/startup-program/04-view-credits/02-vouchers.png" loading="lazy" />
