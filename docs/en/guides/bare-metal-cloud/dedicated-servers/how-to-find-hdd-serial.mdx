...
description: Retrieve the serial number of a hard disk on your dedicated server to identify it for a replacement request.
...
For an in-depth look of these commands and how to test your hard disks, refer to [this guide (LSI raid controller)](/guides/bare-metal-cloud/dedicated-servers/raid-hard).
...
You can refer to [this guide (LSI raid controller)](/guides/bare-metal-cloud/dedicated-servers/raid-hard) to find which hard drive relates to a designated sg device.
...
[Replacing a Defective Disk on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/disk-replacement)
