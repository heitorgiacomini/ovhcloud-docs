...
description: Run hardware diagnostics on your OVHcloud dedicated server using rescue mode to identify disk, RAM, or CPU failures.
...
- [Rescue mode](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) activated
...
[Dedicated Server - Retrieving Databases in Rescue Mode](/guides/bare-metal-cloud/dedicated-servers/restore-bdd-rescue)

[How to verify the BMC firmware version on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/bmc-fw-update)
