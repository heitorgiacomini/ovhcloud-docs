...
description: Enable SME on your ubuntu server and spawn an SEV virtual machine
...
[How to manage Intel SGX on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/sgx-enable-and-use)
