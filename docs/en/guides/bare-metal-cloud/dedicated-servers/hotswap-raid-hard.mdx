...
description: Replace a defective disk on a dedicated server with hardware RAID without downtime using the hot-swap procedure.
...
<img className="thumbnail" alt="MegaRAID background operations showing disk rebuild" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-hard/back.png" loading="lazy" />

The detail will return you this type of result :

<img className="thumbnail" alt="Rebuild progress detail for replaced disk" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-hard/1.png" loading="lazy" />

Also, on the **Logical** tab, we always have the details of RAID and disks.

<img className="thumbnail" alt="Logical tab showing RAID status and disk rebuild" src="/images/bare-metal-cloud/dedicated-servers/hotswap-raid-hard/2.png" loading="lazy" />
