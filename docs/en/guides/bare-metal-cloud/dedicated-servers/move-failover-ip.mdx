...
Next, <ManagerLink to="/">log into your OVHcloud account</ManagerLink>, open the <code className="action">Network</code> menu in the left-hand sidebar and click <code className="action">Public IP Addresses</code>.
