...
description: Find the most frequently asked questions about the wave of attacks targeting ESXi servers
...
If you want to attempt to recover the data on your server, you can rely on the steps in the following documentation: [Enable and use rescue mode - Mounting a datastore](/guides/bare-metal-cloud/dedicated-servers/rescue-mode#mounting-a-datastore).
...
1. Secure access to your dedicated server through [Network Firewall](/guides/bare-metal-cloud/dedicated-servers/firewall-network) or your own firewall system.
2. Install the VMware ESXi 7.0 U3c version available [via your dedicated server administration interface](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server#installing-or-reinstalling-your-dedicated-server).
...
4. [Secure your dedicated server](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server).
...
[How to install VMware ESXi 8 on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/esxi-partitioning)

[Securing Your ESXi Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/esxi-hardening)
