...
Please refer to our guide on [securing a dedicated server](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server) for more information.
...
For more information on accessing this tool, please refer to [this guide](/guides/bare-metal-cloud/dedicated-servers/ipmi).  
:::
