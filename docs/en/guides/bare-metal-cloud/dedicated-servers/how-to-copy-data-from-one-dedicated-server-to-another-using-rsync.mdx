...
description: Copy your data easily from one server to another with rsync
...
To go further, you can Join our [community of users](https://community.ovhcloud.com/community/en).

## Go further

[How to Transfer Files via SFTP on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp)

[Migrate data from one Dedicated Server to another](/guides/bare-metal-cloud/dedicated-servers/migrate-a-server-to-another)
