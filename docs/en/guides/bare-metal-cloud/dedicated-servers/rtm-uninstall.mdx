---
title: Uninstall RTM v2 Monitoring on a Dedicated Server
description: Remove the deprecated RTM v2 monitoring system from your OVHcloud dedicated server on CentOS, Debian, Fedora, or Ubuntu.
