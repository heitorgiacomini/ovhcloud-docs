...
The following payload will install Debian 12 (Bookworm) with SSH key-based authentication, a custom bash post-installation script, and LACP bonding enabled:
