...
<img className="thumbnail" alt="cuda step 1" src="/images/bare-metal-cloud/dedicated-servers/cuda-installation-on-gpu/centos-cuda-install-1.png" loading="lazy" />

And then select all the components to install

<img className="thumbnail" alt="cuda step 2" src="/images/bare-metal-cloud/dedicated-servers/cuda-installation-on-gpu/centos-cuda-install-2.png" loading="lazy" />
...
[OS Installation via the OVHcloud API on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/api-os-installation)
