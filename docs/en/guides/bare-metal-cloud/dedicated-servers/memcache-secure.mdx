...
description: Secure the Memcached service on your dedicated server to prevent unauthorised remote access and data exposure.
...
[Configuring iptables on a Linux Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable)
