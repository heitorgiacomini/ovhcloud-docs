...
<img className="thumbnail" alt="configuration page" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configuring IPv6 in a vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
