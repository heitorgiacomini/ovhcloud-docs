---
title: Upgrade Solidigm D7-P5520 SSD Firmware on a Dedicated Server
description: Upgrade the Solidigm D7-P5520 SSD firmware on your Linux, ESXi, or Windows dedicated server for improved performance.
...
<details>
<summary>**Example result on a server with 3 Solidigm drives to update**</summary>
...
<details>
<summary>**Example result on a server with 4 Solidigm drives to update**</summary>
...
Download the firmware package on your server: [https://last-public-ovh-baremetal.snap.mirrors.ovh.net/hardware/P5520/P5520_FW_to_9CV10490_Win64.zip](https://last-public-ovh-baremetal.snap.mirrors.ovh.net/hardware/P5520/P5520_FW_to_9CV10490_Win64.zip)
