...
<img className="thumbnail" alt="BringYourOwnImage Control Panel 01" src="/images/bare-metal-cloud/dedicated-servers/bring-your-own-image/byoi-controlpanel01.png" loading="lazy" />

In the window that appears, select `Custom` in the menu, then `Bring Your Own Image - byoi`, and click <code className="action">Next</code>.

<img className="thumbnail" alt="BringYourOwnImage Control Panel 03" src="/images/bare-metal-cloud/dedicated-servers/bring-your-own-image/byoi-controlpanel03.png" loading="lazy" />
