...
description: Identify a defective disk on your OVHcloud dedicated server and request a replacement through the Control Panel.
...
If you have a server that uses soft RAID, please refer to the [software RAID](/guides/bare-metal-cloud/dedicated-servers/raid-soft) guide to find the disks installed on your server.
...
If you have a server that uses hard RAID, please refer to the [hardware RAID](/guides/bare-metal-cloud/dedicated-servers/raid-hard) guide, and use the appropriate procedure for your RAID controller type to find the access paths to your disks.
...
If you have an NVMe disk, you will need to put the server into [rescue mode](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) and install the `nvme-cli` tool.
...
:::info
This replacement type is only possible for [dedicated servers](https://www.ovhcloud.com/en-gb/bare-metal/) with a RAID card.
:::
...
If you have a server that uses soft RAID, we recommend that you resync your disks manually. To do this, you can refer to our [software RAID](/guides/bare-metal-cloud/dedicated-servers/raid-soft) guide.
