---
title: Manage Hardware RAID on a Dedicated Server
description: Verify the state of your hardware RAID controller and monitor hard drive health on your OVHcloud dedicated server.
...
- a [dedicated server](https://www.ovhcloud.com/en-gb/bare-metal/) with a hardware RAID configuration
