...
Login credentials (username and password) are sent to you by email at the first installation or when a server is reinstalled in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
