...
description: Upgrade the Samsung NVMe PM9A1 firmware on your Linux, ESXi, or Windows dedicated server for improved reliability.
...
Download the Samsung DC Toolkit via [this link](https://semiconductor.samsung.com/resources/software-resources/Samsung_SSD_DC_Toolkit_for_Windows_1.exe).
