...
description: Upgrade the Micron 7500 PRO NVMe firmware on your Linux, ESXi, or Windows dedicated server for improved stability.
...
Now your NVMe drives should have the firmware version **E3MQ005**.
