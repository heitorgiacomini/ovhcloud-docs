...
description: "Apply essential security measures to your dedicated server: SSH hardening, firewall configuration, and service monitoring."
...
If you are configuring your first OVHcloud dedicated server, we recommend to consult our guide on [getting started with a dedicated server](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server) before continuing.
:::
...
You can learn more about iptables in our [Firewall guide](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).
...
For more information on our backup storage solutions, please see our [backup storage guide](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage).

## Go further

[Configuring the firewall on Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)

[Network Firewall guide](/guides/bare-metal-cloud/dedicated-servers/firewall-network)

[How to set up a web server (LAMP) on Debian or Ubuntu](/guides/bare-metal-cloud/dedicated-servers/installing-lamp-debian9-ubuntu18)
