...
description: Install an OVHcloud SSH key on your dedicated server to grant secure administrative access to OVHcloud support teams.
...
- You must be [logged in via SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) (root access).
...
[Storing Dedicated Server SSH Keys in the Control Panel](/guides/bare-metal-cloud/dedicated-servers/import-keys-control-panel)
