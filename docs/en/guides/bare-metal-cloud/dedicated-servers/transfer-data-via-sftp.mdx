...
You will need the IP address of your server which you can find in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and the name of the user account to use for the SSH connection. Consult our "Getting started" guides if you require further details on this topic:
...
<img className="thumbnail" alt="remote site sftp rescue mode" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_03.png" loading="lazy" />
...
<img className="thumbnail" alt="remote site sftp" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_01.png" loading="lazy" />
...
<img className="thumbnail" alt="sftp transfer progress" src="/images/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp/sftp_sd_02.png" loading="lazy" />
