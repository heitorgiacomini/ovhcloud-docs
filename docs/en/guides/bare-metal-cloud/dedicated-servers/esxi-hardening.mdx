...
description: Discover the various ways you can effectively secure your ESXi dedicated server
...
<img className="thumbnail" alt="Public IP Addresses page in the OVHcloud Control Panel" src="/images/bare-metal-cloud/dedicated-servers/esxi-hardening/firewall_network_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Configure Edge Network Firewall option in the context menu" src="/images/bare-metal-cloud/dedicated-servers/esxi-hardening/firewall_network_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Stopping the TSM-SSH service in ESXi" src="/images/bare-metal-cloud/dedicated-servers/esxi-hardening/stop_service.png" loading="lazy" />
...
<img className="thumbnail" alt="SSH service policy set to Start and stop manually" src="/images/bare-metal-cloud/dedicated-servers/esxi-hardening/ssh_disabled_.png" loading="lazy" />
