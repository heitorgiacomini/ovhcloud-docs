...
description: Configure Proxmox VE network interfaces on High Grade, Scale, and Advance range dedicated servers step by step.
...
If you want to use virtual MACs to configure the network on Proxmox VE on High Grade and Scale servers, you can refer to [Configuring Additional IP in bridge mode on your virtual machines](/guides/bare-metal-cloud/dedicated-servers/network-bridging).
:::
...
- One or more [Additional IP addresses](https://www.ovhcloud.com/en-gb/network/additional-ip/)
...
<Tabs>
  <Tab label="High Grade & Scale ranges">
    <img className="thumbnail" alt="Routed mode network schema for High Grade and Scale ranges" src="/images/bare-metal-cloud/dedicated-servers/proxmox-network-HG-Scale/schema_route.png" loading="lazy" />
  </Tab>
  <Tab label="Advance range">
    <img className="thumbnail" alt="Routed mode network schema for Advance range" src="/images/bare-metal-cloud/dedicated-servers/proxmox-network-HG-Scale/gamme-advance-01.png" loading="lazy" />
  </Tab>
</Tabs>
...
* A [server compatible with vRack](https://www.ovhcloud.com/en-gb/bare-metal/)
* A [vRack service](https://www.ovhcloud.com/en-gb/network/vrack/)
...
First, add your block of Additional IPs to the vRack. To do so, go to the <code className="action">Bare Metal Cloud</code> section of your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> and open the <code className="action">vRack</code> menu.

Select your vRack from the list to view the list of eligible services. Click on the block of Additional IPs you want to add to the vRack, then click the <code className="action">Add</code> button.
...
[Hardware upgrade on a High Grade or Scale Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/hardware-upgrade-hg-scale)

[Dedicated Server - Fixing Proxmox VE Slow Downloads](/guides/bare-metal-cloud/dedicated-servers/proxmox-broadcom-slow-downloads)
