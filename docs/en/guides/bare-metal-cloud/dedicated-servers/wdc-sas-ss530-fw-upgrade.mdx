...
description: Upgrade the Western Digital SS530 SAS SSD firmware on your Linux, ESXi, or Windows dedicated server.
...
[Upgrading WD SS300 SSD Firmware on a Dedicated Server](/guides/bare-metal-cloud/dedicated-servers/wd-sas-fw-upgrade)
