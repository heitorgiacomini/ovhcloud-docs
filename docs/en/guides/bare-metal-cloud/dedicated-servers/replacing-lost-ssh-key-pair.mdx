...
description: Find out how restore server access by replacing an SSH key pair with a new one in case your private key is lost
lastUpdated: 2024-04-04
---

## Objective

If you are [using SSH keys](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys) to connect to your server, losing your private SSH key could mean losing access to your server altogether.
...
Create a new SSH key pair on your device, as described in the first part of the [SSH key guide](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys).
...
Switch the boot mode back to "normal" and restart the server in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. Refer to the [rescue mode guide](#step2) if necessary.
