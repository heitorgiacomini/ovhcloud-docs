---
title: Configure User Accounts and Root Access (Dedicated)
description: Manage user accounts, sudo access, and root login on a GNU/Linux dedicated server for secure system administration.
...
For more detailed instructions on this topic, please refer to our guide "[Getting started with SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)".
