...
description: Enable OVHcloud Link Aggregation in your Debian server (from Debian 9 to Debian 11)
...
If your system's network configuration uses `Netplan` instead, please refer to [this guide](/guides/bare-metal-cloud/dedicated-servers/lacp-enable-netplan).
