...
If you are configuring your first OVHcloud VPS, we recommend to consult our guide on [getting started with a VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) before continuing.
:::


The following examples presume that you are logged in as a [user with elevated permissions](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
- [How to create and use authentication keys for SSH connections to OVHcloud servers](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)
...
Remember that you will have to indicate the new port any time you [establish an SSH connection to your server](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction):
...
If you are locked out of your system, you can use our [rescue mode](/guides/bare-metal-cloud/virtual-private-servers/rescue) environment to revert your changes.

### Creating a user with restricted rights <a name="createuser"></a>

In general, tasks that do not require root privileges should be performed via a standard user. Please refer to the information in [this guide](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds) for details.
...
You can learn more about iptables in our [Firewall guide](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable).
...
Please refer to the [Network Firewall guide](/guides/bare-metal-cloud/dedicated-servers/firewall-network) if you would like to activate it.
...
You can find all information on the available backup solutions for your service on the [product page](https://www.ovhcloud.com/en-gb/vps/options/) and in the [respective guides](/guides/bare-metal-cloud/virtual-private-servers/overview).

## Go further

[Getting started with a VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)

[How to create and use SSH keys](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Configuring the firewall on Windows](/guides/bare-metal-cloud/virtual-private-servers/activate-port-firewall-soft-win)

[Configuring the firewall on Linux with iptables](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable)
