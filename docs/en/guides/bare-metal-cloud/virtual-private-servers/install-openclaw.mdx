...
description: Deploy OpenClaw in production with automatic HTTPS via Traefik and connect it to OVHcloud AI Endpoints on a VPS
...
- An [OVHcloud VPS](https://www.ovhcloud.com/en-gb/vps/) (Debian 11/12 or Ubuntu 22.04+). Refer to our guide "[Getting started with a VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps)".
- SSH access to your VPS
- A domain name pointing to your VPS. Refer to our guide "[Adding a DNS A record](/guides/web-cloud/domains/dns-zone-a-record-creation)" if needed.
...
This means Docker is already installed on your machine. Otherwise, follow the [Docker installation guide](/guides/bare-metal-cloud/virtual-private-servers/install-docker-on-vps).
