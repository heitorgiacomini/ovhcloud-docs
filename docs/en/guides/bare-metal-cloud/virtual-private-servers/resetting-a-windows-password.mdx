...
description: Find out how to reset your Windows Administrator account password on a VPS or a Public Cloud instance using the OVHcloud rescue mode
...
- [Public Cloud instance](/guides/public-cloud/compute/put-an-instance-in-rescue-mode)

### Step 2: Mount the system partition

Connect to your server via SSH. (Consult the [SSH introduction guide](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) if necessary.)

Alternatively, you can open a server connection by using [KVM (VPS)](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps) or the [VNC console (Public Cloud instance)](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#accessvnc).
