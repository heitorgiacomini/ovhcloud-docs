...
description: Find out how to secure a server with iptables
...
Please refer to our guide on [securing a VPS](/guides/bare-metal-cloud/virtual-private-servers/secure-your-vps) for more information.
...
For more information on accessing this tool, please refer to [this guide](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps).  
:::
