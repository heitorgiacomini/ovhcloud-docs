...
Click the <code className="action">DNS zone</code> tab. In the table, identify the row with the value `A`, click on the button <code className="action">...</code> and select <code className="action">Modify record</code>.
