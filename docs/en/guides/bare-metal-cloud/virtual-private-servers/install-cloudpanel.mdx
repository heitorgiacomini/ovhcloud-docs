...
- A [VPS](https://www.ovhcloud.com/en-gb/vps/) or a [Dedicated Server](https://www.ovhcloud.com/en-gb/bare-metal/) with a [recommended configuration](https://www.cloudpanel.io/docs/v2/requirements/) in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
