...
description: Find out how to install an SSL certificate on an OVHcloud VPS
...
1. Download an SSH client like [PuTTY](/guides/web-cloud/web-hosting/ssh-using-putty-on-windows) or use your operating system's built-in terminal.
