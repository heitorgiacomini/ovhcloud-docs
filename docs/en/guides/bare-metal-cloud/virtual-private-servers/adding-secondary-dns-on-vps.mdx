...
- If the domain is managed by OVHcloud as its registrar **and** it uses OVHcloud DNS servers, add the TXT record in the <code className="action">Web Cloud</code> section of your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. You can follow the instructions in our [DNS zone guide](/guides/web-cloud/domains/dns-zone-edit) if you are not familiar with this process.
