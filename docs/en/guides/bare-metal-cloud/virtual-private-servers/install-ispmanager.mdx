...
description: Discover how to install ISPmanager on your OVHcloud VPS or Dedicated Server and manage your websites, databases, and associated services
...
- A [VPS](https://www.ovhcloud.com/en-gb/vps/) or a [Dedicated Server](https://www.ovhcloud.com/en-gb/bare-metal/) in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> with a [recommended configuration for ISPmanager](https://www.ispmanager.com/docs/ispmanager/system-requirements).
