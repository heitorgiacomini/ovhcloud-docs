...
Initiate a server reboot in rescue mode from the Control Panel. Follow our [rescue mode guide](/guides/bare-metal-cloud/virtual-private-servers/rescue) if necessary.
