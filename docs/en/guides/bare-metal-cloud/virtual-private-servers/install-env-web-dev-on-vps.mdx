...
- A [VPS] solution (https://www.ovhcloud.com/en-gb/vps/) or a [dedicated server](https://www.ovhcloud.com/en-gb/bare-metal/) in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>
...
[How to install WordPress with Docker on a VPS or a dedicated server](/guides/bare-metal-cloud/virtual-private-servers/install-wordpress-docker-on-vps)
