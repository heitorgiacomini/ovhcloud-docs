...
- `serviceName`: Enter the internal name of your license (see the section `Licences` in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>).
...
- Download via SFTP: Connect to your VPS with a software client capable of SFTP (for example [FileZilla](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp)), then transfer all files in the system's root directory.
