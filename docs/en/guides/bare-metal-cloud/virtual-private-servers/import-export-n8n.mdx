...
description: Find out how to export and import a complete n8n configuration (workflows and credentials) from an external VPS to an OVHcloud VPS, and vice versa.
...
- Two functional [VPS](https://www.ovhcloud.com/en-gb/vps/) (OVHcloud or others)
- Administrative (sudo) access to your server via SSH

## Instructions

:::tip[Success]
If you are starting from scratch, opt for an [OVHcloud preinstalled n8n VPS](https://www.ovhcloud.com/en-gb/vps/vps-n8n/) to get started quickly.
:::
...
<Tabs>
  <Tab label="Case A - Native CLI Installation">
  ...
  <Tab label="Case B - Installation via Docker">
...
To find out more, read our guide [Modifying an OVHcloud DNS zone](/guides/web-cloud/domains/dns-zone-edit).
