...
description: Cómo configurar un dominio por primera vez en el servicio CDN de OVH
...
- Tener acceso al <ManagerLink to="/">área de cliente</ManagerLink>.
...
Para ello, en el <ManagerLink to="/">área de cliente de OVH</ManagerLink> acceda a la sección <code className="action">Dedicado</code>. En la columna izquierda, haga clic en <code className="action">NAS y CDN</code> y seleccione el servicio CDN correspondiente.

Haga clic en el atajo <code className="action">Añadir un dominio a la CDN</code>.

<img className="thumbnail" alt="Área de cliente CDN" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cdn_customer_panel.png" loading="lazy" />

En el cuadro de diálogo, introduzca el subdominio que quiera añadir a la CDN.

<img className="thumbnail" alt="Añadir un subdominio a la CDN" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_1.png" loading="lazy" />
...
<img className="thumbnail" alt="Añadir un backend" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/add_cdn_domain_step_2.png" loading="lazy" />
...
<img className="thumbnail" alt="Registro CNAME" src="/images/network/content-delivery-network-infrastructure/first-domain-name-configuration/cname_field.png" loading="lazy" />
...
Esta información también puede obtenerse utilizando el navegador. Por ejemplo, en Firefox se encuentra en las herramientas de desarrollo, seleccionando <code className="action">Red</code> (atajo de teclado: F12). Al hacer clic en el archivo que quiera comprobar, podrá ver la respuesta HTTP y sus cabeceras.
