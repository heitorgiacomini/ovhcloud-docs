...
description: Cómo funcionan los límites de tráfico en la solución CDN de OVH
...
Es posible adquirir tráfico adicional directamente desde el <ManagerLink to="/">área de cliente de OVH</ManagerLink>.

<img className="thumbnail" alt="Adquirir tráfico" src="/images/network/content-delivery-network-infrastructure/quota/add_quota.png" loading="lazy" />

Puede consultar el precio de los paquetes de tráfico disponibles en la página de la solución [CDN de OVH](https://www.ovhcloud.com/es-es/network/cdn/).
...
<img className="thumbnail" alt="Utilización del tráfico" src="/images/network/content-delivery-network-infrastructure/quota/quota_used.png" loading="lazy" />
