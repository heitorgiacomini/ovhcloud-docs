...
description: Descubra cómo determinar si una dirección IP está gestionada, suministrada y/o asociada a un servicio de OVHcloud a través del sitio web de la ICANN
...
Una vez que haya introducido la dirección IP, haga clic en el botón azul <code className="action">Lookup</code>.
