...
description: Find out how to set up OVHcloud Connect using OVHcloud APIv6
...
- an [OVHcloud Connect service](https://www.ovhcloud.com/es-es/network/ovhcloud-connect/)
- access to the [OVHcloud APIv6](https://eu.api.ovh.com/) (create your credentials by consulting [this guide](/guides/manage-and-operate/api/first-steps))
...
<Api version="v1" section="/vrack" method="POST" route={"/vrack/\{serviceName\}/ovhCloudConnect"} />
...
<Api version="v1" section="/ovhCloudConnect" method="GET" route={"/ovhCloudConnect/\{serviceName\}/interface/\{id\}"} />
...
<Api version="v1" section="/ovhCloudConnect" method="GET" route={"/ovhCloudConnect/\{serviceName\}/datacenter/\{id\}"} />
