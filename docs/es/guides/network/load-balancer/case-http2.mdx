...
description: Descubra cómo elegir y configurar los frontends de su servicio Load Balancer OVHcloud para utilizarlos con el protocolo HTTP/2
...
- Un servicio [Load Balancer de OVHcloud](https://www.ovhcloud.com/es-es/network/load-balancer/);
...
- Acceso a la [API de OVHcloud](https://eu.api.ovh.com/).
