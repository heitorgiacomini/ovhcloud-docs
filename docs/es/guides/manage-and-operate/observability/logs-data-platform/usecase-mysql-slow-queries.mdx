...
description: Keep your MySQL database at high speed with Logs Data Platform!
...
- [Using Filebeat with Logs Data Platform.](/guides/manage-and-operate/observability/logs-data-platform/filebeat-logs)
...
We cover Filebeat in depth in [another tutorial](/guides/manage-and-operate/observability/logs-data-platform/filebeat-logs). Here is a minimal **filebeat.yml** configuration file.
