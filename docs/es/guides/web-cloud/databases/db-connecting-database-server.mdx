...
:::warning
Si utiliza una solución "Web Cloud Databases"/"SQL Privado", recuerde autorizar su IP utilizando la guía sobre la [configuración de su servidor de bases de datos](/guides/web-cloud/databases/db-configure-optimise-database-server#gerer-vos-acces).
