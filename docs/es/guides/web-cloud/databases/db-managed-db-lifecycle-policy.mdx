...
- Servicios Web Cloud Databases Web Hosting (también conocidos como servicios SQLP Privado), instancias SGBD dedicadas que se pueden acceder a través de la red Web Hosting ([ver los anuncios](/guides/web-cloud/databases/db-eos-eol)).
- Servicios SharedSQL Web Hosting, bases de datos MySQL accesibles a través de la red Web Hosting ([ver los anuncios](/guides/web-cloud/web-hosting/sql-eos-eol)).

### Definiciones y directrices de la política de fin de vida

![timeline](/images/assets/schemas/web-cloud-databases/ovhcloud-eol-policy-for-managed-databases-timeline.png)
