...
Para acceder a los logs de su solución Web Cloud Databases, consulte nuestra guía "[Web Cloud Databases - Cómo recuperar los logs](/guides/web-cloud/databases/db-retrieve-logs)".
