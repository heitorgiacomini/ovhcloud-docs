...
description: Cómo configurar una cuenta Email Pro en Outlook para Mac
...
:::info
Si utiliza Outlook para Windows, consulte nuestra guía [Configurar una cuenta Email Pro en Outlook para Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration).
...
Haga clic en <ManagerLink to="/#/web/email_pro">este enlace</ManagerLink> para acceder a la sección <code className="action">Email Pro</code>. El nombre del servidor aparece en el marco **Conexión** de la pestaña <code className="action">Información general</code>.
...
<img className="thumbnail" alt="Email Pro" src="/images/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016-mac/configuration-outlook-2016-mac-step1.png" loading="lazy" />
...
<img className="thumbnail" alt="Email Pro" src="/images/web-cloud/email-and-collaborative-solutions/email-pro/how-to-configure-outlook-2016-mac/configuration-outlook-2016-mac-step2.png" loading="lazy" />
