...
Para configurar su dirección de correo electrónico Pro en Outlook clásico, consulte nuestro guía "[Email Pro - Configurar una cuenta de correo en Outlook clásico para Windows](/guides/web-cloud/email-and-collaborative-solutions/email-pro/outlook-windows-configuration)".
...
Haga clic en <ManagerLink to="/#/web/email_pro">este enlace</ManagerLink> para acceder a la sección <code className="action">Email Pro</code>.
