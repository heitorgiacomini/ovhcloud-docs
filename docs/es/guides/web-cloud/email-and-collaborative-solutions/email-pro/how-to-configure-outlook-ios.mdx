...
description: Descubra cómo configurar una dirección Email Pro en la aplicación móvil Outlook para iOS
...
Haga clic en <ManagerLink to="/#/web/email_pro">este enlace</ManagerLink> para acceder a la sección <code className="action">Email Pro</code>. El nombre del servidor puede verse en el recuadro **Conexión** de la pestaña <code className="action">Información general</code>.
...
<Tabs>
  ...
  <Tab label="Paso 2">
    ...
    - Si la ventana de configuración de la cuenta muestra "**Exchange**" en la parte superior, pulse el botón `?` en la esquina superior derecha de la pantalla **(1)** y elija <code className="action">Cambiar proveedor de cuenta</code> **(2)**. A continuación, seleccione `IMAP` **(3)** y continúe con el paso 3.
