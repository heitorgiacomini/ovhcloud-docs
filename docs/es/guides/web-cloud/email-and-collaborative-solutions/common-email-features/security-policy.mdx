...
description: Esta guía explica cómo configurar la política de seguridad de un servicio de correo
...
- Tener un [plan de correo en OVHcloud](https://www.ovhcloud.com/es-es/emails/).
...
- reforzar la comprobación de los mensajes entrantes en nuestros servidores destinados a sus direcciones de correo (solo para las cuentas [Exchange](https://www.ovhcloud.com/es-es/emails/hosted-exchange/));
- determinar cómo se mostrarán los mensajes no deseados en sus buzones de correo (solo para las cuentas [Exchange](https://www.ovhcloud.com/es-es/emails/hosted-exchange/)).
...
|---|---|
|Haga clic en la pestaña `Más` y seleccione <code className="action">Editar la política de seguridad</code>.|Haga clic en <code className="action">Seguridad</code>.|
|<img className="thumbnail" alt="Política de seguridad Exchange" src="/images/web-cloud/email-and-collaborative-solutions/common-email-features/security-policy/manage-security01.png" loading="lazy" />|<img className="thumbnail" alt="Política de seguridad Exchange" src="/images/web-cloud/email-and-collaborative-solutions/common-email-features/security-policy/manage-security02.png" loading="lazy" />|

:::info
Si no encuentra la pestaña <code className="action">Más</code> en el panel de control de su solución <code className="action">MX Plan</code>, significa que está en una solución MX Plan histórica. No hay gestión de la política de seguridad en la solución MX Plan histórica.
...
Una vez que haya completado esta información, acepte los cambios haciendo clic en el botón <code className="action">Siguiente</code> y luego en <code className="action">Aceptar</code> para los servicios «Correo electrónico» y «Email Pro». Haga clic en <code className="action">Guardar los cambios</code> para el servicio Exchange.
...
Una vez que haya elegido, acepte los cambios haciendo clic en <code className="action">Guardar los cambios</code>.
