...
<Region zones={['ca']}>
Outlook Web App es una interfaz utilizada para nuestra oferta **Exchange** y una parte de las cuentas **MX Plan**.
</Region>

<Region zones={['apac']}>
Outlook Web App es una interfaz utilizada para una parte de las cuentas **MX Plan**.
</Region>
