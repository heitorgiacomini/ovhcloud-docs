...
- Configure un programa de mensajería en su ordenador, smartphone o tablet. Consulte nuestra página «[Configurar una dirección de correo electrónico de Zimbra en un cliente de correo](/guides/web-cloud/email-and-collaborative-solutions/zimbra/mail-apps)».
