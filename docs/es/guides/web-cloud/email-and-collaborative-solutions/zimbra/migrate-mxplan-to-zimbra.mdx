...
<Tabs>
  <Tab label="Paso 1">
    **Crear un proyecto de migración**
    ...
    Acceda a [OVHcloud Mail Migrator](/links/web/omm) y haga clic en <code className="action">Nueva migración</code>.
    ...
    Haga clic en <code className="action">Crear mi proyecto</code>. Recibirá un correo electrónico de confirmación con el identificador único del proyecto.
  </Tab>
  <Tab label="Paso 2">
    **Conectarse al proyecto y crear la migración**

    Desde la página de inicio de [OMM](/links/web/omm), haga clic en <code className="action">Seguir una migración</code>, introduzca el `Identificador del proyecto` y la `Contraseña del proyecto`, y haga clic en <code className="action">Conectarse al proyecto</code>.

    A continuación, haga clic en <code className="action">Nueva migración</code> para configurar su migración:
    ...
    Haga clic en <code className="action">Migrar mi cuenta</code> para iniciar la migración.
  ...
  <Tab label="Paso 3">
    **Seguir la migración**
    ...
    - Desde la página de inicio de [OMM](/links/web/omm): haga clic en <code className="action">Seguir una migración</code>, introduzca su `Identificador del proyecto` y su `Contraseña del proyecto`, y haga clic en <code className="action">Conectarse al proyecto</code>.
    ...
    - <code className="action">Ver más detalles</code>: Siga el progreso de la migración y consulte el informe una vez finalizada.
    - <code className="action">Cancelar la migración</code>: Cancela la migración en curso. Los elementos ya migrados se conservan en la cuenta de destino.
    - <code className="action">Eliminar mis datos de migración (RGPD)</code>: Activa la eliminación de todos los datos relacionados con la migración. La información sobre los eventos de la migración se conserva.
