...
description: Cómo configurar el servidor Private Exchange
...
- Haber contratado el [plan Private Exchange de OVHcloud](https://www.ovhcloud.com/es-es/emails/private-exchange/).
...
También puede consultar este mensaje de correo electrónico iniciando sesión en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, haciendo clic en su perfil en la esquina superior derecha y seleccionando <code className="action">Emails de servicio</code> y busque el mensaje de correo electrónico con el siguiente asunto:

> **\[xx-11111-ovh] ¡Su servicio Private Exchange 20\_xxx\_ está en proceso de entrega!**
...
Complete los campos según las siguientes indicaciones:

- **Nombre del servidor**: en el menú desplegable, seleccione el subdominio asociado a su dominio. En el campo libre, introduzca el dominio que desea asociar.
...
Cuando aparezca la siguiente ventana, pegue el código en la casilla y, seguidamente, haga clic en <code className="action">«Next»</code>.
...
Un mensaje le informará si el código introducido es válido. En caso afirmativo, haga clic en <code className="action">«Close window»</code>.

### Paso 5: finalización de la entrega
...
> **\[xx-11111-ovh] ¡Su servicio Private Exchange 20\_xxx\_ está listo!**

Para añadir su primer nombre de dominio a su plataforma y configurar las cuentas, consulte nuestra guía [«Añadir un dominio a un servicio Exchange»](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/exchange-adding-domain).
