...
Puede adquirir licencias Outlook en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y licencias Office 365 en la página [Microsoft 365](https://www.ovhcloud.com/es-es/collaborative-tools/microsoft-365/). Le recomendamos una de estas soluciones si desea disfrutar del cliente de correo Outlook o de más programas de la suite Office, según sus necesidades.
