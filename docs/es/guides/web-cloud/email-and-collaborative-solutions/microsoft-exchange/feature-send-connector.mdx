...
description: Cómo añadir un conector de envío SMTP a la plataforma Exchange de OVHcloud
...
- Haber contratado una plataforma [Private Exchange de OVHcloud](https://www.ovhcloud.com/es-es/emails/private-exchange/) o [Trusted Exchange de OVHcloud](https://www.ovhcloud.com/es-es/enterprise/products/trusted-exchange/).
...
:::warning
La adición de un conector de envío está reservada y prevista para las ofertas [Private Exchange OVHcloud](https://www.ovhcloud.com/es-es/emails/private-exchange/) y [Trusted Exchange OVHcloud](https://www.ovhcloud.com/es-es/enterprise/products/trusted-exchange/). Si activa un conector de envío en un servicio Exchange de OVHcloud distinto de los mencionados anteriormente, nuestros administradores pueden desactivarlo en cualquier momento por motivos de seguridad.
:::
...
A continuación, conéctese a la API de OVHcloud con sus claves de acceso. Para más información, consulte nuestra guía [Primeros pasos con la API de OVHcloud](/guides/manage-and-operate/api/first-steps).
...
Haga clic en <code className="action">Execute</code> para iniciar la llamada a la API.
...
[«Editar una zona DNS de OVH»](/guides/web-cloud/domains/dns-zone-edit)
