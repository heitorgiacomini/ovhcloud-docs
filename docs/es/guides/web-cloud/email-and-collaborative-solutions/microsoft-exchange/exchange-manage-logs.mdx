...
:::info
Para más detalles sobre Logs Data Platform, consulte nuestro guía de introducción a [Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/introduction).
...
<Tabs>
  ...
  <Tab label="Caso n°2">
    **Suscribirse a un nuevo flujo de datos en su solución Logs Data Platform**
    ...
    Consulte nuestros guías [Introduction to Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/introduction) y [Quick start for Logs Data Platform (EN)](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start) para realizar esta acción.
