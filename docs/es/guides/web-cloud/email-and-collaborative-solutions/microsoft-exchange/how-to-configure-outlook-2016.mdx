...
Compruebe la configuración del dominio en su servicio Exchange en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, en la pestaña <code className="action">Dominios asociados</code>, en la columna <code className="action">Diagnóstico</code> de la tabla.
