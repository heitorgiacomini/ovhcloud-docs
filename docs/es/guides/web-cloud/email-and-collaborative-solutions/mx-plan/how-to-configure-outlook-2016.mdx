...
<Tabs>
  ...
  <Tab label="Paso 5">
    ...
    <Region zones={['eu']}>
    - **Servidor**: imap.mail.ovh.net **o** ssl0.ovh.net
    - Puerto: **993**
    ...
    <Region zones={['eu']}>
    - **Servidor**: smtp.mail.ovh.net **o** ssl0.ovh.net
    - Puerto: **465**
    - Método de cifrado: **SSL/TLS**
    </Region>
...
Informaciones del servidor

<Region zones={['eu']}>
- **Tipo de cuenta**: seleccione IMAP
- **Servidor de correo entrante**: imap.mail.ovh.net **o** ssl0.ovh.net
- **Servidor de correo saliente (SMTP)**: smtp.mail.ovh.net **o** ssl0.ovh.net
</Region>

<Region zones={['ca', 'apac']}>
- **Tipo de cuenta**: seleccione IMAP
- **Servidor de correo entrante**: imap.mail.ovh.ca
- **Servidor de correo saliente (SMTP)**: smtp.mail.ovh.ca
</Region>
...
La ventana se divide en dos partes, **Correo entrante** y **Correo saliente**. Haga clic en la parte que desee modificar.
    ...
    Encuentre este número en su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, en la sección <code className="action">Web Cloud</code> y luego <code className="action">Email Pro</code>. El nombre del servidor es visible en el marco **Conexión** de la pestaña <code className="action">Información general</code>.
