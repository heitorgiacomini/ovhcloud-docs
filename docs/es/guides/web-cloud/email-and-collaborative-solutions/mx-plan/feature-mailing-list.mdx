...
description: Cómo utilizar las listas de difusión
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_no-modarate.png" loading="lazy" />
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_modarate.png" loading="lazy" />
...
- Disponga al menos de una solución de correo electrónico MX Plan 100 o de un [Web hosting](https://www.ovhcloud.com/es-es/web-hosting/) compatible con las listas de difusión.
...
Acceda a la pestaña <code className="action">Listas de difusión</code> de su servicio de correo electrónico.

<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_01.png" loading="lazy" />
...
Para crear una nueva lista de difusión, haga clic en <code className="action">Añadir una lista de difusión</code>.

<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_02.png" loading="lazy" />
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_03.png" loading="lazy" />
...
Para modificar las opciones de la lista de difusión, haga clic en <code className="action">...</code> a la derecha de esta. Luego, podrá actualizar las opciones, eliminar la lista de difusión e, incluso, compartir la lista de abonados por correo electrónico.

<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_04.png" loading="lazy" />
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_05.png" loading="lazy" />

Aparece la siguiente ventana:

<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_06.png" loading="lazy" />

#### Añadir/eliminar abonados

|Añadir abonados|Eliminar abonados|
|---|---|
|Haga clic en <code className="action">Añadir abonados</code> a la derecha.|Haga clic en <code className="action">Eliminar mediante un archivo</code> a la derecha.|
|<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_07.png" loading="lazy" />|<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_07b.png" loading="lazy" />|

Hay dos métodos para añadir o eliminar abonados:

- Para introducir manualmente las direcciones, haga clic en <code className="action">Añadir una dirección de correo electrónico</code>.
...
Haga clic en <code className="action">Exportar los abonados en formato CSV</code> para generar un archivo CSV con todos sus abonados. En el caso que nos ocupa, esta opción no está disponible porque no se ha añadido ningún abonado.
...
<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_08.png" loading="lazy" />

Aparece la siguiente ventana:

<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_09.png" loading="lazy" />

#### Añadir/eliminar moderadores

|Añadir moderadores|Eliminar moderadores|
|---|---|
|Haga clic en <code className="action">Añadir moderadores</code> a la derecha.|Haga clic en <code className="action">Eliminar mediante un archivo</code> a la derecha.|
|<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_10.png" loading="lazy" />|<img className="thumbnail" alt="emails" src="/images/web-cloud/email-and-collaborative-solutions/mx-plan/feature-mailing-list/manage_mailing-lists_10b.png" loading="lazy" />|
