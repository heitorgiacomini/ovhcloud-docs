...
- Tener una solución MX Plan. Esta está disponible a través de: un plan de hosting [web hosting](https://www.ovhcloud.com/es-es/web-hosting/) o el MX Plan contratado por separado.
