...
<Region zones={['ca']}>
- Haber instalado una solución de correo de OVHcloud [Exchange](https://www.ovhcloud.com/es-es/emails/hosted-exchange/)
</Region>
...
[Delegar permisos en una cuenta de Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/permissions-delegation)
