...
description: Cómo contratar y administrar un servicio Office 365 Reseller (CSP2) de OVHcloud
...
- **Enlace directo:** <ManagerLink to="/#/web-office/license">Microsoft 365</ManagerLink>
...
- Haga clic en <code className="action">Contratar</code> para finalizar.
...
<img className="thumbnail" alt="Office 365" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/csp2-01.png" loading="lazy" />
...
<img className="thumbnail" alt="Office 365" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_services_details.png" loading="lazy" />
...
El icono <i className="icons-pen"></i> permite modificar el número total de licencias de la suscripción. El icono <i className="icons-bin"></i> permite dar de baja la suscripción y todas sus licencias.
...
<img className="thumbnail" alt="Office 365" src="/images/web-cloud/email-and-collaborative-solutions/microsoft-office/office-csp2/sunrise_office365_CSP2_Subscribers.png" loading="lazy" />
