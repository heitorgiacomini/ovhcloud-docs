...
description: Descubra el papel de los servidores DNS, su contenido y cómo funcionan con un dominio
...
Permiten, entre otras cosas, el uso de los [dominios](https://www.ovhcloud.com/es-es/domains/) para acceder a su sitio web preferido sin tener que conservar la dirección IP del servidor en el que está alojado este sitio web.
...
Si necesita realizar esta acción para un dominio registrado con OVHcloud, consulte nuestra guía "[Cambiar los servidores DNS de un dominio en OVHcloud](/guides/web-cloud/domains/dns-server-edit)".
...
:::tip[Success]
- Para más información sobre las zonas DNS, consulte nuestra guía "[Todo sobre la zona DNS](/guides/web-cloud/domains/dns-zone-general-information)".
- Consulte nuestra guía sobre Todo sobre los registros DNS](/guides/web-cloud/domains/dns-zone-records) para una mejor comprensión del conjunto.
...
[Modificar una zona DNS de OVHcloud](/guides/web-cloud/domains/dns-zone-edit).
