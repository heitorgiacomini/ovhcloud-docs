...
- Tener al menos un [nombre de dominio](https://www.ovhcloud.com/es-es/domains/);
- Tener una zona DNS activa para el nombre de dominio. Si lo necesita, consulte nuestra guía "[Crear una zona DNS en OVHcloud](/guides/web-cloud/domains/dns-zone-create)".
...
Un [nombre de dominio](https://www.ovhcloud.com/es-es/domains/) puede asociarse a varios tipos de servicios (correo electrónico, sitio web, etc.).
...
Los [nombres de dominio](https://www.ovhcloud.com/es-es/domains/) necesitan una **zona DNS** para funcionar. La zona DNS se compone de informaciones técnicas, llamadas *registros DNS*. Es como un centro de cambio de agujas.
