---
title: Transferir un nombre de dominio Wix a OVHcloud
description: Descubra diferentes datos relativos a la transferencia de un nombre de dominio Wix a OVHcloud
...
Para transferir un nombre de dominio Wix es necesario seguir un procedimiento específico.

**Descubra cómo transferir un nombre de dominio Wix a OVHcloud**
...
- El nombre de dominio está registrado en el agente registrador Wix.
...
### Desbloquear el nombre de dominio y obtener el código de transferencia

Para desbloquear el nombre de dominio y obtener el código de transferencia, siga los pasos descritos en la [documentación dedicada de Wix](https://support.wix.com/es/article/transferir-tu-dominio-wix-fuera-de-wix).
