...
<Tabs>
  <Tab label="MX">
    **M**ail e**X**changer <br/><br/>
    ...
    Es probable que su proveedor de correo disponga de varios servidores de correo: es necesario crear varios registros MX. Consulte nuestra guía [Añadir un registro MX a la configuración del nombre de dominio](/guides/web-cloud/domains/dns-zone-mx).
