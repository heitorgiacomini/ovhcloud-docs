...
Si lo necesita, consulte nuestra guía relativa a [servidores DNS](/guides/web-cloud/domains/dns-server-general-information) para más información.
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    Abra la pestaña <code className="action">DynHost</code> y seleccione el dominio correspondiente.
  ...
  <Tab label="Etapa 3">
    Haga clic en el botón <code className="action">Gestionar los accesos</code> y luego en el botón <code className="action">Crear un usuario</code>.
  ...
  <Tab label="Etapa 4">
    ...
    :::tip
    Para instalar un DynHost directamente para su dominio, introduzca únicamente `*` en el formulario de entrada denominado <code className="action">Subdominio</code>.
  ...
  <Tab label="Etapa 5">
    Una vez que haya completado todos los campos, haga clic en <code className="action">Aceptar</code>. El usuario aparecerá en la tabla.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Haga clic en el botón <code className="action">Añadir un DynHost</code>.
  ...
  <Tab label="Etapa 4">
    ...
    :::warning
    Para la creación de un registro DNS dinámico (DynHost), el uso de un *wildcard* (colocando únicamente el carácter `*`) en el formulario <code className="action">Subdominio</code> no está disponible.
...
Una vez que haya completado todos los campos, haga clic en <code className="action">Aceptar</code>. El registro aparecerá en la tabla.
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    Compruebe la dirección IP que aparece en la columna <code className="action">Destino</code>.
