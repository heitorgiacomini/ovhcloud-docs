...
<Tabs>
  ...
  <Tab label="Paso 3">
    ...
    Además, si encuentra el mensaje: "**AUTH/INFO code : Authcode is not managed by OVHcloud, contact the registry to claim it**", que significa que el código de transferencia de su nombre de dominio no es recuperable a través de su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
    
    En ambos casos, compruebe que es el contacto **administrador** del nombre de dominio con ayuda de nuestra guía sobre la [gestión de contactos](/guides/account-and-service-management/account-information/managing-contacts) y compruebe que la extensión de su nombre de dominio permite un desbloqueo desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
