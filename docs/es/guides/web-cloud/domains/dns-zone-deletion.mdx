...
:::info
La creación, modificación o eliminación de una zona DNS en el <ManagerLink to="/#/web/zone">área de cliente de OVHcloud</ManagerLink> es totalmente gratuita.
...
<Tabs>
  <Tab label="Etapa 1">
    Acceda a la página <ManagerLink to="/#/billing/autorenew/services">Mis soluciones y servicios</ManagerLink> y, a continuación, haga clic en el botón <code className="action">...</code> a la derecha de la zona DNS que desea cancelar, y luego en <code className="action">Dar de baja mi servicio</code>.
