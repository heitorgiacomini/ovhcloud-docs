...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/web/zone">Zonas DNS</ManagerLink> y seleccione el dominio que utilizó para crear los hosts en la [parte 3](#step3).
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/web/zone">Zonas DNS</ManagerLink> y seleccione el dominio para el que ha personalizado los servidores DNS.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/web-domains/domain">Dominios</ManagerLink> y seleccione *el dominio para el que desea personalizar los servidores DNS*.
