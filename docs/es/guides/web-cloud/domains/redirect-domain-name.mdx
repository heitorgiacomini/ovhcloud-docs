...
- **Desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>**, donde un asistente de configuración permite configurar la redirección.
...
Atención: una redirección creada desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> no permite redirigir una URL en `https://` hacia otro nombre de dominio u otra URL.
...
Además de las redirecciones de "apuntamiento" hacia los registros DNS A, AAAA y CNAME, hay 3 opciones de redirección disponibles desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
