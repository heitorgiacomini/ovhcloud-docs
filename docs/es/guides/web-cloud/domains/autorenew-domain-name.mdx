...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/billing/autorenew/services">Mis soluciones y servicios</ManagerLink>. En la tabla que se abre, identifique el dominio o dominios cuyo modo de renovación desea cambiar.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/billing/autorenew/services">Mis soluciones y servicios</ManagerLink>. En la tabla, identifique el dominio que quiere renovar.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/web-domains/domain">Dominios</ManagerLink> y seleccione el dominio en cuestión.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/billing/autorenew/services">Mis soluciones y servicios</ManagerLink>. En la tabla, identifique el dominio que quiere dar de baja.
...
<Tabs>
  <Tab label="Paso 1">
    Acceda a la página <ManagerLink to="/#/billing/autorenew/services">Mis soluciones y servicios</ManagerLink>. En la tabla, identifique el dominio para el que debe abonar una factura de renovación.
...
[Cómo renovar mis servicios OVHcloud](/guides/account-and-service-management/managing-billing-payments-and-services/automatic-renewal)
