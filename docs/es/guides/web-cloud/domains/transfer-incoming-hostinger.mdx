---
title: Transferir un nombre de dominio Hostinger a OVHcloud
description: Descubra diferentes datos relativos a la transferencia de un nombre de dominio Hostinger a OVHcloud
...
Para transferir un nombre de dominio Hostinger es necesario seguir un procedimiento específico.

**Descubra cómo transferir un nombre de dominio Hostinger a OVHcloud**
...
- El nombre de dominio está registrado en el agente registrador Hostinger.
...
Si, además de la transferencia del nombre de dominio, quiere migrar los servicios asociados al mismo (sitio web, correo electrónico...), consulte en primer lugar nuestra guía "[Migrar un sitio web y los servicios asociados a OVHcloud](/guides/web-cloud/web-hosting/hosting-migrating-to-ovh)" antes de continuar.
...
### Desbloquear el nombre de dominio

:::info
Por seguridad, todos los nombres de dominio de Hostinger están bloqueados **por defecto** para evitar transferencias no autorizadas.

Por lo tanto, antes de transferir su nombre de dominio desde Hostinger, primero debe **desbloquearlo**.
:::


Para los nombres de dominio registrados en Hostinger, puede gestionar el estado de bloqueo de su nombre de dominio abriendo la sección <code className="action">Dominios</code> y seleccionando el nombre de dominio a transferir.
...
Si desea **transferir** su nombre de dominio de Hostinger a otro agente registrador (como OVHcloud), el nuevo agente registrador puede solicitar un código de autorización (código "EPP" o "Auth") para comprobar que tiene derecho a actuar sobre el nombre de dominio.
Para más información sobre el cambio de titular de un nombre de dominio, consulte esta [guía](/guides/web-cloud/domains/trade-domain).

:::warning
Algunos TLD tienen un proceso de transferencia especial. Esto es válido especialmente para los nombres de dominio **.uk** y **.eu**.

Puede ponerse en contacto con Hostinger para conocer los pasos que debe seguir para transferir su nombre de dominio.
:::
...
### Iniciar la transferencia del nombre de dominio a OVHcloud
