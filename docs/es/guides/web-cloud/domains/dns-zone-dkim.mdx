...
Si el dominio está registrado en OVHcloud, puede comprobar si utiliza nuestra configuración de OVHcloud desde el <ManagerLink to="/">área de cliente</ManagerLink>, en la pestaña <code className="action">Zona DNS</code>, después de seleccionar el dominio correspondiente.
:::
...
<img className="thumbnail" alt="Correo electrónico" src="/images/assets/schemas/emails/dns-dkim-send.gif" loading="lazy" />
...
<img className="thumbnail" alt="Correo electrónico" src="/images/assets/schemas/emails/dns-dkim-receive.gif" loading="lazy" />
...
- [E-mail Pro](https://www.ovhcloud.com/es-es/emails/email-pro/).
- [Zimbra](https://www.ovhcloud.com/es-es/emails/zimbra-emails/).
...
<Tabs>
  ...
  <Tab label="Zimbra">
    ...
    **Consejo para crear un registro CNAME**
    ...
    Desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> donde se aloja el nombre de dominio de su servicio de correo electrónico, en la sección <code className="action">Web Cloud</code>, haga clic en <code className="action">Nombres de dominio</code> en la columna de la izquierda y seleccione el nombre de dominio correspondiente.<br/>
    Seleccione la pestaña <code className="action">Zona DNS</code> y haga clic en <code className="action">Añadir una entrada</code> en la ventana que aparece. Elija `CNAME` y complete según los valores que haya anotado.
    :::
  </Tab>
</Tabs>
...
Para configurar el DKIM, vaya a la [página de las API de OVHcloud](/links/api) y inicie sesión:
...
<Tabs>
  ...
  <Tab label="4. Configurar el registro DNS">
    Desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> en el que esté alojado el dominio de su servicio de correo, en la pestaña <code className="action">Web Cloud</code>, haga clic en <code className="action">Nombres de dominio</code> en la columna izquierda y seleccione el dominio correspondiente.<br/>
    Acceda a la pestaña <code className="action">Zona DNS</code> y haga clic en <code className="action">Añadir un registro</code> en la ventana que aparece. Seleccione `CNAME` y cumplimente los valores que haya indicado.
    ...
    Una vez introducidos los valores, haga clic en <code className="action">Siguiente</code> y luego en <code className="action">Validar</code>.
...
<Tabs>
  ...
  <Tab label="4. Configurar el registro DNS">
    ...
    Acceda a la pestaña <code className="action">Zona DNS</code> y haga clic en <code className="action">Añadir un registro</code> en la nueva ventana. Seleccione `CNAME` y complete los valores que haya indicado.<br/>
    ...
    Una vez introducidos los valores, haga clic en <code className="action">Siguiente</code> y luego en <code className="action">Aceptar</code>.
...
<Tabs>
  ...
  <Tab label="4.Configurar el registro DNS">
    ...
    Una vez introducidos los valores, haga clic en <code className="action">Siguiente</code> y luego en <code className="action">Aceptar</code>.<br/>
...
En <ManagerLink to="/">el área de cliente de OVHcloud</ManagerLink>, abra la pestaña <code className="action">Web Cloud</code> y haga clic en <code className="action">Dominios</code> en la columna izquierda y seleccione el dominio correspondiente.

Abra la pestaña <code className="action">Zona DNS</code> y haga clic en <code className="action">Añadir un registro</code>. Existen 3 formas de añadir un registro para configurar el DKIM en la zona DNS:
...
<img className="thumbnail" alt="Correo electrónico" src="/images/assets/screens/control-panel/product-selection/web-cloud/domain-dns/dns-zone/dns-dkim-add.png" loading="lazy" />
