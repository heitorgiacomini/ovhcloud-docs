...
<Tabs>
  <Tab label="Etapa 1">
    Acceda a la página <ManagerLink to="/#/web/zone">Zonas DNS</ManagerLink>, y luego en el botón <code className="action">Contratar</code>.
...
<Tabs>
  <Tab label="Etapa 1">
    Acceda a la página <ManagerLink to="/#/web/zone">Zonas DNS</ManagerLink> y elija el subdominio correspondiente.
