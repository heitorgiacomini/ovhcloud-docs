...
:::info
Al hacer clic en <code className="action">Aceptar</code>, la creación de la base de datos puede tardar hasta **15 minutos**. Recargue la página web de su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> si la base de datos no aparece automáticamente en la tabla que enumera sus bases de datos.
