...
:::info
Si se le solicita, independientemente de cuál sea la base de datos [Start SQL](https://www.ovhcloud.com/es-es/web-hosting/options/start-sql/) añadida o incluida con su alojamiento web OVHcloud, el número de **puerto** que deberá utilizar será el **3306**.
:::
