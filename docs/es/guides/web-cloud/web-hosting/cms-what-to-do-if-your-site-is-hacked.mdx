...
description: Descubra nuestros consejos para reparar su sitio web pirateado
...
- [Cambiar la contraseña de acceso a su ID de cliente de OVHcloud](/guides/account-and-service-management/account-information/manage-ovh-password).
- [Proteger el acceso a su área de cliente de OVHcloud con doble autenticación](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
- [Cambiar la contraseña de acceso al espacio de almacenamiento FTP de su alojamiento web](/guides/web-cloud/web-hosting/ftp-change-password).
- [Cambiar la contraseña de acceso a la base de datos](/guides/web-cloud/web-hosting/sql-change-password).

También le recomendamos que utilice un [gestor de contraseñas](/guides/account-and-service-management/account-information/manage-ovh-password#utilizar-un-gestor-de-contrasenas).
...
Utilice nuestra guía sobre [las estadísticas y logs de su alojamiento web](/guides/web-cloud/web-hosting/logs-and-statistics) para buscar los elementos maliciosos introducidos en su sitio web. Puede consultar la información en los logs "web". 
...
Si está absolutamente seguro de que se trata de una IP maliciosa, puede bloquearle el acceso a su alojamiento siguiendo nuestra documentación sobre las [restricciones de acceso a través del archivo ".htaccess"](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website).
...
- [Restaurar el espacio de almacenamiento FTP de su alojamiento web](/guides/web-cloud/web-hosting/ftp-save-and-backup)
- [Descargar la copia de seguridad SQL de su base de datos](/guides/web-cloud/web-hosting/sql-database-export)
- [Importar la copia de seguridad SQL en la base de datos](/guides/web-cloud/web-hosting/sql-importing-mysql-database)
...
Si el alojamiento está "desactivado", también se desactivarán los robots de restauración automática disponibles desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
>
> Para reactivar el alojamiento web, siga las indicaciones del apartado 4 de esta [guía](/guides/web-cloud/web-hosting/diagnostic-403-forbidden).
>
...
Para conectarse al espacio de almacenamiento de su alojamiento, consulte [nuestra guía](/guides/web-cloud/web-hosting/ftp-connection) sobre el asunto.
...
Para más información sobre los permisos CHMOD, consulte la sección "Información útil" de nuestro [tutorial sobre el uso del cliente FTP Filezilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide#useful-information).
...
Proteja sus formularios de contacto al menos con un sistema de tipo "Captcha", para evitar que robots maliciosos emitan spam por este medio. Si la función "mail()" de PHP también ha sido bloqueada en su alojamiento, consulte [nuestra guía](/guides/web-cloud/web-hosting/mail-function-script-records) sobre este asunto para solucionar el bloqueo.

Consulte nuestra guía sobre cómo proteger su sitio web (/guides/web-cloud/web-hosting/secure-your-website) para reducir al mínimo el riesgo de que se produzca una nueva piratería.

## Más información <a name="go-further"></a>

[Conectarse al espacio de almacenamiento de un alojamiento web](/guides/web-cloud/web-hosting/ftp-connection)

[Modificar la configuración de un alojamiento web](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Activar el firewall de aplicación](/guides/web-cloud/web-hosting/multisites-activating-application-firewall)
