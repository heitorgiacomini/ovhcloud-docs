...
description: Descubra cómo conectarse al espacio de almacenamiento de un alojamiento web de OVHcloud y gestionar los datos alojados con el programa FileZilla
...
Permite subir archivos o su sitio web [conectándose al espacio de almacenamiento](/guides/web-cloud/web-hosting/ftp-connection) de su alojamiento web.
...
<summary>Haga clic aquí para ver el contenido de esta sección.</summary>
...
3. En la nueva página, haga clic en la pestaña <code className="action">FTP - SSH</code>.
...
:::info
Por motivos de seguridad, la contraseña de un usuario no aparece en la pestaña <code className="action">FTP - SSH</code>. Si ha olvidado la contraseña, consulte [esta guía](/guides/web-cloud/web-hosting/ftp-change-password) para modificarla.
...
<summary>Conectarse por SFTP al espacio de almacenamiento de un alojamiento web con FileZilla. <a name="sftp"></a></summary>


El **SFTP** utiliza, al igual que el SSH, el puerto 22 por defecto en lugar del puerto 21. Si utiliza un plan de hosting Cloud Web, deberá utilizar el puerto que aparece en su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. El puerto 22 está desactivado por seguridad en SSH y SFTP para los alojamientos Cloud Web.
...
Para ello, vuelva a la pestaña <code className="action">FTP-SSH</code> de su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, tal y como se indica en la [primera parte](#part-1) de esta guía.
...
- Para los planes Profesional y Performance:
    ...
    - 2: En la nueva ventana, en la sección `Protocolos de conexión`, seleccione la opción <code className="action">FTP y SFTP</code> y haga clic en <code className="action">Siguiente</code>.
    - 3: Compruebe el resumen del cambio solicitado y haga clic en <code className="action">Aceptar</code>.
...
Una vez que haya introducido todo correctamente en el cuadro **1** de la imagen de abajo, haga clic en <code className="action">Conexión rápida</code>.
...
<summary>Conectarse por FTP al espacio de almacenamiento de un alojamiento web con FileZilla.</summary>
...
Compruebe sus claves para asegurarse de que no se ha introducido ningún error. Si lo necesita, puede [cambiar la contraseña del acceso FTP](/guides/web-cloud/web-hosting/ftp-change-password) de su alojamiento web directamente en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
Compruebe que la contraseña del host se corresponde con el nombre del host que haya indicado en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
<summary>Vista de la cola de espera</summary>
...
<summary>Menú contextual del servidor</summary>
...
<summary>Permisos de acceso (Chmod) a archivos y carpetas</summary>


Haga clic derecho en uno de los archivos del servidor y seleccione <code className="action">Permisos de archivo...</code>.
...
<summary>Reapertura del sitio</summary>
...
En ese caso, deberá [proteger sus soluciones](/guides/web-cloud/web-hosting/diagnostic-403-forbidden#step-2) corrigiendo los fallos de seguridad indicados en la notificación de bloqueo recibida por correo electrónico.

:::


A continuación, haga clic en <code className="action">Servidor</code> y seleccione <code className="action">Introducir un comando personalizado</code> (también puede llamarse <code className="action">Introduzca un comando FTP</code>).
...
<summary>Transferencia de archivos binarios</summary>


Para archivos binarios, como archivos de tipo **CGI**, puede ser interesante elegir cómo se realizará la transferencia.

Para cambiar el tipo de transferencia, seleccione <code className="action">Transferencia</code> en el menú principal y luego <code className="action">Tipo de transferencia</code>.
...
<summary>Comparación de directorios</summary>
...
A continuación puede consultar nuestra guía para [resolver los errores recurrentes durante el uso de un programa FTP](/guides/web-cloud/web-hosting/ftp-recurring-ftp-problems).

En términos más generales, consulte [todas nuestras guías relativas a los alojamientos compartidos](/guides/web-cloud/web-hosting/overview).
