...
- **zona 4**: Lista de carpetas/archivos en el directorio seleccionado localmente en su ordenador.
...
Para ello, consulte nuestra guía "[Alojamiento web - Cómo activar el acceso SFTP](/guides/web-cloud/web-hosting/enable-sftp)".
