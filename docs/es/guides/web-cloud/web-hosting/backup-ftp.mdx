...
Para generar el enlace de recuperación, conéctese al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, acceda a la sección <code className="action">Web Cloud</code>, haga clic en <code className="action">Alojamientos</code> y seleccione el Cloud Web correspondiente. 
...
Si la generación de la copia de seguridad se ha iniciado correctamente, aparecerá el siguiente mensaje en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>:
