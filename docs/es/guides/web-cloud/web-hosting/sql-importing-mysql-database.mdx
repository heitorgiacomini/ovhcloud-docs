...
<Tabs>
  ...
  <Tab label="Paso 3">
    ...
    Se mostrarán todas las copias de seguridad disponibles. Haga clic en los tres puntos situados al final de la línea correspondiente al backup que quiera restaurar y seleccione <code className="action">Restaurar la copia de seguridad</code>.
  </Tab>
  <Tab label="Paso 4">
    Asegúrese de que la información es correcta y haga clic en <code className="action">Aceptar</code>. Espere a que se restaure la copia de seguridad.
...
<Tabs>
  ...
  <Tab label="Paso 3">
    Haga clic en los tres puntos situados al final de la línea correspondiente a la base de datos en la que quiera importar datos y seleccione <code className="action">Importar un archivo</code>.
  ...
  <Tab label="Paso 4">
    En la ventana que aparece, marque la opción <code className="action">Importar un nuevo archivo</code> y haga clic en <code className="action">Siguiente</code>.
...
<Tabs>
  ...
  <Tab label="Paso 3">
    Haga clic en los tres puntos situados al final de la línea correspondiente a la base de datos y seleccione <code className="action">Acceder a phpMyAdmin</code>.
