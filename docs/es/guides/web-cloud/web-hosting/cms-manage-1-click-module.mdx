...
No obstante, si necesita ayuda, le recomendamos encarecidamente que utilice la documentación que le ofrezca el editor del CMS o que contacte con un [proveedor especializado](https://partner.ovhcloud.com/es-es/directory/). Nosotros no podremos asistirle. Más información en la sección [Más información](#go-further) de esta guía.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    En caso contrario, vaya a la pestaña <code className="action">Mis sitios</code>. Anote el nombre de la `Carpeta raíz` que aparece en la línea del sitio web correspondiente: se trata del directorio en el que se encuentran los archivos que constituyen su módulo en 1 clic en el servidor FTP.
  </Tab>
</Tabs>

Conéctese al [espacio FTP del alojamiento](/guides/web-cloud/web-hosting/ftp-connection). Abra la `Carpeta raíz` encontrada anteriormente en la pestaña <code className="action">Mis sitios</code> y busque el archivo de configuración de su módulo:
...
Si ya ha creado el número máximo de bases de datos permitido por su [alojamiento web](https://www.ovhcloud.com/es-es/web-hosting/), deberá eliminar la base de datos indicada en [el paso 1](#step1) **ANTES** de poder crear un nuevo módulo en 1 clic.
