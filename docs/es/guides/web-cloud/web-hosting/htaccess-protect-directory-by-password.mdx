...
Si dispone de un alojamiento [Pro](https://www.ovhcloud.com/es-es/web-hosting/professional-offer/) o [Performance](https://www.ovhcloud.com/es-es/web-hosting/performance-offer/), conéctese a su alojamiento web en [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting). Vaya a la carpeta "**raíz*" en la que se encuentra su script "crypt.php".
