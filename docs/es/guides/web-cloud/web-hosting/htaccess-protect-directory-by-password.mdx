...
description: Descubra cómo proteger un repertorio o el acceso a la administración de su sitio web mediante autenticación con los archivos .htaccess y .htpasswd
...
Utilizando dos archivos de configuración (HTTP) Apache que quiere situar en [el espacio FTP](/guides/web-cloud/web-hosting/ftp-connection) de su alojamiento web: 
...
- Disponer de las claves de conexión al [espacio FTP de su alojamiento](/guides/web-cloud/web-hosting/ftp-connection).
...
Si utiliza un CMS WordPress, OVHcloud también pone a su disposición un tutorial sobre [cómo utilizar el archivo htaccess con WordPress](/guides/web-cloud/web-hosting/htaccess-how-to-protect-wordpress).
...
Para ello, contacte con nuestra [comunidad de usuarios](https://community.ovhcloud.com/community/en) o nuestros [partners de OVHcloud](https://partner.ovhcloud.com/es-es/directory/).
:::
...
Para modificar la versión de PHP de sus sitios web en su alojamiento web, consulte nuestra guía "[Web hosting : entorno, versión PHP, .ovhconfig](/guides/web-cloud/web-hosting/configure-your-web-hosting)".
...
Conéctese al [espacio de almacenamiento FTP](/guides/web-cloud/web-hosting/ftp-connection) de su alojamiento web. Abra el ["directorio raíz"](/guides/web-cloud/web-hosting/multisites-configure-multisite) hacia el que apunte su nombre de dominio.
...
Suba a la carpeta raíz en la que creó el archivo "crypt.php". Haga clic en <code className="action">Editar</code> y sitúe las siguientes líneas:
...
Si dispone de un alojamiento **Pro**, **Performance**, **Agency**, **Agency Plus** o **Agency Max**, conéctese a su alojamiento web en [SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting). Vaya a la carpeta "**raíz**" en la que se encuentra su script "crypt.php".
...
:::warning
Por motivos de seguridad, se recomienda el uso del SSH. No obstante, si tiene un producto **Starter**, **Perso** o **Startup** en el que el SSH no está disponible, puede igualmente ejecutar el fichero "crypt.php" a través de su navegador web.
...
- `your_ftp_login` : el login FTP que utiliza para conectarse a su espacio de almacenamiento FTP. Para obtener su login FTP, consulte nuestra guía sobre [conexión a su espacio FTP](/guides/web-cloud/web-hosting/ftp-connection).
...
[Conectarse al espacio FTP de un alojamiento web](/guides/web-cloud/web-hosting/ftp-connection)

[Tutorial - Operaciones viables con un fichero ".htaccess"](/guides/web-cloud/web-hosting/htaccess-what-else-can-you-do)

[Bloquear el acceso a mi sitio web para algunas direcciones IP a través de un archivo .htaccess](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website)

[Reescribir la URL de acceso a mi sitio web gracias al mod_rewrite a través del archivo .htaccess](/guides/web-cloud/web-hosting/htaccess-url-rewriting-using-mod-rewrite)
