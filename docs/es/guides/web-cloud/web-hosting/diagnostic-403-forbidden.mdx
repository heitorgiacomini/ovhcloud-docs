...
:::warning
Antes de cambiar la contraseña de la base de datos de su sitio web desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, actualice el archivo de configuración de su sitio web para que se conecte a la base de datos con la nueva contraseña.
