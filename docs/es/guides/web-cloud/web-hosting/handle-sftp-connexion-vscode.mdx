...
Antes de trabajar en el proyecto, cárguelo en la carpeta local que creó anteriormente. No obstante, en primer lugar, asegúrese de que el archivo "sftp.json" está correctamente configurado. Consulte nuestra guía "[Conectarse al espacio de almacenamiento FTP de su alojamiento web](/guides/web-cloud/web-hosting/ftp-connection)" para encontrar la información útil.
...
<Tabs>
  ...
  <Tab label="Paso 2">
    En la pestaña <code className="action">FTP - SSH</code>, el nombre de host (`host`) aparece bajo el epígrafe `Servidor FTP y SFTP`.
...
<Tabs>
  ...
  <Tab label="Paso 2">
    En la pestaña <code className="action">FTP - SSH</code>, localice el nombre de usuario en la columna `Usuario` de la tabla.
  </Tab>
</Tabs>
...
[Utilizar el acceso SSH de un alojamiento web](/guides/web-cloud/web-hosting/ssh-on-webhosting). Recuerde que para utilizar el SSH, debe disponer de un [plan de hosting](https://www.ovhcloud.com/es-es/web-hosting/) **Pro**, **Performance**, **Agency**, **Agency Plus** o **Agency Max**.
