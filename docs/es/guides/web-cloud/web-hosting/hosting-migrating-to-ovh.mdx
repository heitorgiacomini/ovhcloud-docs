...
Si todavía no es cliente de OVHcloud, haga clic en el botón <code className="action">Contratar</code> de las páginas comerciales anteriores. Siga los pasos del pedido **sin solicitar la transferencia del dominio** (esta acción se realizará en la parte 10 de esta guía).
...
<Region zones={['ca']}>
:::info
Además de la solución MX Plan, OVHcloud ofrece otras soluciones de correo. Por ejemplo, puede combinar con direcciones de correo MX Plan cuentas [Exchange](https://www.ovhcloud.com/es-es/emails/hosted-exchange/).
:::
</Region>
...
**Opción 1**: utilice nuestra herramienta [OVHcloud Mail Migrator (OMM)](https://omm.ovhcloud.com/) que permite copiar el contenido de las direcciones de correo electrónico que tuviera con su anterior proveedor a las creadas en OVHcloud. Para más información, consulte nuestra guía [Migrar cuentas de correo electrónico a través de OVHcloud Mail Migrator](/guides/web-cloud/email-and-collaborative-solutions/migrating/omm-migrate-email-account-to-ovhcloud).
...
Consulte todas nuestras guías de configuración en la sección `Configuración del cliente de correo` de [nuestra documentación sobre la solución Email Pro](/guides/web-cloud/email-and-collaborative-solutions/email-pro/overview).

#### Para las cuentas de correo "Exchange":

Consulte todas nuestras guías de ayuda a la configuración en las secciones `Configuración de Exchange en el ordenador` y `Configuración de Exchange en el smartphone` de [nuestra documentación sobre Exchange](/guides/web-cloud/email-and-collaborative-solutions/microsoft-exchange/overview).
