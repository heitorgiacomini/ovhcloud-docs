...
Si su base de datos se encuentra en una solución [Web Cloud Databases](https://www.ovhcloud.com/es-es/web-cloud/databases/), consulte nuestra guía "[Web Cloud Databases - Conectarse a su base de datos](/guides/web-cloud/databases/db-connecting-database-server) ". A continuación, diríjase directamente al [etapa 1.2](#step1.2) de esta guía.
...
Es posible duplicar el contenido de una base de datos de OVHcloud directamente en otra de sus bases de datos de OVHcloud gracias a la funcionalidad que ofrece su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. Para ello, consulte nuestra guía "[Duplicar el contenido de una base de datos en otra](/guides/web-cloud/web-hosting/copy-database)".
...
- [Primeros pasos con Web Cloud Databasess](/guides/web-cloud/databases/db-getting-started)
- [Importar su antigua base de datos a su solución Web Cloud Databasess](/guides/web-cloud/databases/db-restore-import-database)
