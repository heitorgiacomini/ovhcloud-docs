...
description: Descubra cómo aumentar la seguridad de su sitio web
...
- tener los detalles de [inicio de sesión](/guides/web-cloud/web-hosting/ftp-connection#1-obtener-los-datos-de-conexion) para acceder al espacio de almacenamiento de su plan de alojamiento
...
- cambie regularmente la contraseña de administrador de su puesto (para más información sobre la elección de las contraseñas, siga las instrucciones de esta [guía](/guides/account-and-service-management/account-information/all-about-username#crear-una-contrasena-solida-y-unica).

### Etapa 2 - Proteger el área de cliente de OVHcloud

Para proteger su cuenta de cliente, [active la doble autenticación](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) y siga las instrucciones de este [guía](/guides/account-and-service-management/account-information/all-about-username).

Actualice la [información de su cuenta de cliente](/guides/account-and-service-management/account-information/all-about-username#editar-mis-datos-personales) y añada un **email de seguridad**.<br/>
...
En primer lugar, haga una copia de seguridad de los datos que componen su sitio web conectándose a su [espacio FTP](/guides/web-cloud/web-hosting/ftp-connection) y a su [servidor de bases de datos](/guides/web-cloud/web-hosting/sql-database-export). Importe estos en su equipo o en un soporte externo, de tipo servidor NAS o llave USB.

Los programas de gestión de sitios web (CMS) ofrecen la posibilidad de instalar complementos de backup automático.<br/>
Consulte los foros oficiales de su CMS preferido o contacte con la [comunidad de OVHcloud](https://community.ovhcloud.com/community/en) al respecto.

### Etapa 4 - Aprender a reconocer los mensajes fraudulentos

Los mensajes de phishing constituyen también una amenaza para la seguridad de su sitio web, ya que pueden contener o conducir a la instalación de programas maliciosos. Para saber cómo reconocerlas y protegerlas, consulte esta [guía](/guides/account-and-service-management/account-information/phishing-care).
...
Si su sitio web tiene un lugar preponderante en su actividad profesional, [active la renovación automática](/guides/account-and-service-management/managing-billing-payments-and-services/automatic-renewal#acceder-a-la-configuracion-de-los-servicios) en el conjunto de sus servicios OVHcloud.<br/>
...
También asegúrate de utilizar una versión reciente del [lenguaje de programación PHP](/guides/web-cloud/web-hosting/configure-your-web-hosting) en tu alojamiento.

### Etapa 7 - Activar el HTTPS

Establezca la conexión encriptada a su sitio web a través del protocolo **HTTPS** siguiendo este [guía](/guides/web-cloud/web-hosting/ssl-activate-https-website). La activación de este protocolo permitirá cifrar toda la información que transita por su sitio web (especialmente las entradas efectuadas por los usuarios en sus formularios).
...
Para ello, debe conectarse al [espacio FTP](/guides/web-cloud/web-hosting/ftp-connection). y requiere conocimientos técnicos para reconocer los posibles archivos maliciosos del alojamiento. Si necesita ayuda para realizar esta comprobación, no dude en ponerse en contacto con nuestros [partners](https://partner.ovhcloud.com/es-es/directory/).

Si tiene dudas sobre este asunto, no olvide realizar las comprobaciones que se describen en [el etapa 1 de esta guía](#local) y [cambiar la contraseña](/guides/web-cloud/web-hosting/ftp-change-password) de su espacio FTP.
...
- [bloquear el acceso a su sitio web para determinadas direcciones IP](/guides/web-cloud/web-hosting/htaccess-how-to-block-a-specific-ip-address-from-accessing-your-website);
- [proteger un directorio o la interfaz de administración de su sitio web asociándolo con un archivo ".htpasswd"](/guides/web-cloud/web-hosting/htaccess-protect-directory-by-password);
- [proteger su CMS WordPress](/guides/web-cloud/web-hosting/htaccess-how-to-protect-wordpress).

## Más información <a name="go-further"></a>

[Consejos sobre la piratería de su sitio WordPress](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked)

[Reaccionar en caso de desactivación por seguridad de un alojamiento](/guides/web-cloud/web-hosting/diagnostic-403-forbidden)
