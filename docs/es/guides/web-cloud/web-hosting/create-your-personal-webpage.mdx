...
description: Descubra cómo crear su primera página web en un alojamiento web gratuito
...
- Tener contratado un plan de [hosting de OVHcloud](https://www.ovhcloud.com/es-es/web-hosting/) o un [Alojamiento gratuito](https://www.ovhcloud.com/es-es/domains/free-web-hosting/)
...
<body>
    <h1>Bienvenido a mi página personal</h1>
    <h2>Cree rápida y fácilmente su sitio web</h2>
    <p>OVHcloud le propone, en su producto Alojamiento gratuito, gratuitamente un alojamiento para toda compra de un nombre de dominio.</p>
</body>
```
...
**Ejemplo**: si cada una de tus imágenes pesa 1 MB, estarás limitado a menos de 100 imágenes en tu alojamiento gratuito. Si consigues reducir su tamaño a entre 50kb y 200kb, podrás mostrar hasta varios miles de ellas en tu página web.
...
<img className="thumbnail" alt="Árbol de archivos y carpetas" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-1.png" loading="lazy" />

Consideremos un archivo en formato *PNG*. Sitúcelo en el directorio "Imágenes":

<img className="thumbnail" alt="Árbol de archivos y carpetas con imágenes" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-2.png" loading="lazy" />
...
<img className="thumbnail" alt="Resultado de código HTML en el navegador" src="/images/assets/screens/other/browsers/web-pages/create-your-personal-webpage-3-es.png" loading="lazy" />
...
<img className="thumbnail" alt="Colocación de archivo CSS" src="/images/assets/screens/other/web-tools/vscode/create-your-personal-webpage-4.png" loading="lazy" />
...
<img className="thumbnail" alt="Modelo de la caja CSS" src="/images/assets/schemas/web-hosting/create-your-personal-webpage-5.png" loading="lazy" />
...
Para que sus páginas, y por tanto su sitio web, sean visibles para todo el mundo, debe guardarlas en su alojamiento (debe activar su alojamiento [como se indica en esta guía](/guides/web-cloud/web-hosting/activate-start10m)).
...
Para subir los archivos a su alojamiento, consulte la guía [FileZilla](/guides/web-cloud/web-hosting/ftp-filezilla-user-guide) utilizada.
