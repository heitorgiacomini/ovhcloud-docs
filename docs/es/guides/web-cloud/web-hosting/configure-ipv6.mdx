...
Para comprobar si su sitio web ya utiliza una dirección IPv6, utilice el sitio web [test-ipv6.run](https://test-ipv6.run/domain-checker). Indica si el sitio web responde al nuevo protocolo IP. Si no es el caso, lea más nuestra guía.
