...
description: Descubra cómo analizar la latencia de su sitio web y cómo mejorarla
...
- Un [plan de hospedaje web de OVHcloud](https://www.ovhcloud.com/es-es/web-hosting/)
- Un mensaje de correo electrónico que confirme que su plan de hospedaje web ha sido contratado
- Un [nombre de dominio](https://www.ovhcloud.com/es-es/domains/) que pueda utilizarse para acceder a su sitio web
...
Proporcionamos recomendaciones sobre qué oferta de hospedaje web utilizar para los sistemas de gestión de contenidos antes mencionados en [la página del producto](https://www.ovhcloud.com/es-es/web-hosting/).

Puede encontrar más información sobre qué plan elegir en [esta página](https://www.ovhcloud.com/es-es/web-hosting/uc-best-web-hosting/).
...
Averigüe cómo actualizar el lenguaje PHP en [esta guía](/guides/web-cloud/web-hosting/configure-your-web-hosting).

Para cambiar al uso de PHP-FPM en la versión _estable_ o para obtener información sobre opciones más avanzadas de su hospedaje web, consulte [esta guía](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Puede acceder a sus registros, estadísticas y gráficos directamente desde el panel de control, iniciando sesión en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
<Tabs>
  <Tab label="Etapa 1">
    Acceda a la página <ManagerLink to="/#/web/hosting">Hosting plans</ManagerLink> y seleccione el alojamiento web correspondiente.
  ...
  <Tab label="Etapa 3">
    Haga clic en el botón <code className="action">Ver las estadísticas</code> mostradas para acceder a las estadísticas de visita del sitio web o en <code className="action">Ver los logs</code> para consultar los logs disponibles para su alojamiento web.
    
    <img className="thumbnail" alt="logs" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/tab.png" loading="lazy" />
  </Tab>
</Tabs>
...
1. Haga clic en <code className="action">Alojamiento</code> en la columna de la izquierda y seleccione el alojamiento web correspondiente.
2. En la nueva página, haga clic en la pestaña <code className="action">Estadísticas y logs</code> y desplácese hasta la parte inferior de la página en la que se encuentra el gráfico relativo al uso del alojamiento.
3. Seleccione el **tipo** de información y el **período** de los datos mostrados.

<img className="thumbnail" alt="graphs" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png" loading="lazy" />
...
Descubra nuestra [solución de red de distribución de contenidos (CDN) aquí](https://www.ovhcloud.com/es-es/web-hosting/options/cdn/).
...
Para garantizar que nuestra oferta de hospedaje se adapte a las necesidades de su sistema de gestión de contenidos, puede encontrar una comparativa de nuestros servicios en [la página del producto](https://www.ovhcloud.com/es-es/web-hosting/).
...
**Cómo acceder a la base de datos mediante phpMyAdmin:** A continuación, se detalla el procedimiento para acceder a su base de datos mediante phpMyAdmin, disponible en el panel de control una vez iniciada sesión en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>:

- En la sección <code className="action">Hospedaje</code>, haga clic en su dominio.
- Acceda a la pestaña <code className="action">Base de datos</code>.
- Haga clic en los 3 puntos, <code className="action">...</code>, en el lado derecho de su base de datos para acceder a phpMyAdmin.
...
[Consultar la solución Web Cloud Databases en nuestro sitio web](https://www.ovhcloud.com/es-es/web-cloud/databases/).

## Más información

[Modificar la configuración de un plan de hospedaje web](/guides/web-cloud/web-hosting/configure-your-web-hosting)

[Gestionar una base de datos en un paquete de hospedaje web](/guides/web-cloud/web-hosting/sql-create-database)
