...
<Tabs>
  ...
  <Tab label="Etapa 2">
    En la nueva página, localice la mención **Opción CDN**. Haga clic en <code className="action">...</code> a la derecha y, a continuación, en <code className="action">Contratar una CDN</code> o <code className="action">Activar la opción</code> si la opción CDN ya está incluida en el alojamiento.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    A continuación, haga clic en el botón <code className="action">⁝</code> situado a la derecha del dominio o subdominio correspondiente, y luego en <code className="action">Activar el CDN</code>.
  ...
  <Tab label="Etapa 4">
    En la ventana que se abre, haga clic en <code className="action">Confirmar</code> para activar el CDN.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    A continuación, haga clic en el botón <code className="action">⁝</code> situado a la derecha del dominio o subdominio correspondiente, y luego en <code className="action">Purgar el CDN</code>.
...
<Tabs>
  ...
  <Tab label="Etapa 3">
    ...
    A continuación, haga clic en el botón <code className="action">⁝</code> situado a la derecha del dominio o subdominio correspondiente, y luego en <code className="action">Modificar el CDN</code>.
...
<Tabs>
  ...
  <Tab label="Etapa 4">
    ...
    - **Purga avanzada**: Personalice su purga eligiendo los elementos de la caché a vaciar: todo el sitio web, una carpeta, una URI, una extensión de archivos o utilizando una expresión regular personalizada. 
       ...
       En la pestaña <code className="action">Mis sitios</code>, haga clic en el botón <code className="action">⁝</code> a la derecha del dominio o subdominio correspondiente y luego en <code className="action">Purgar el CDN</code>.
...
Este cambio se realiza automáticamente si la zona DNS activa del dominio también se gestiona desde la <ManagerLink to="/">cuenta de OVHcloud</ManagerLink> que contiene el alojamiento web.
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    Localice la mención **Opción CDN**. Haga clic en <code className="action">...</code> a la derecha y, a continuación, en <code className="action">Anular la CDN</code>.
