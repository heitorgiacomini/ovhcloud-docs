...
:::info
La nueva base de datos no está activada de forma predeterminada cuando la adquiere. No olvide activarlo. Para ello, conéctese a su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y acceda a la sección <code className="action">Web Cloud</code>.
...
- Para una base de datos que estará presente en un servidor Web Cloud Databases, siga nuestra guía "[Crear una base de datos en un servidor Web Cloud Databases](/guides/web-cloud/databases/db-create-databases-users)".
