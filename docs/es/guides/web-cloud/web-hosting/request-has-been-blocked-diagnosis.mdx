...
description: Descubra cómo actuar si su sitio web muestra una página «Your request has been blocked»
...
<details>
<summary>Haga clic aquí para obtener más información sobre cómo actualizar su navegador de Internet</summary>
