...
description: Identifique el origen de la lentitud de su sitio web y descubra cómo solucionar esta situación
...
Para conocer el cluster y el filer donde se encuentra su alojamiento compartido, consulte nuestra guía "[Web hosting - Cómo conocer su cluster y su filer](/guides/web-cloud/web-hosting/how-to-know-cluster-and-filer)".
...
Ponga en la raíz de su sitio web en el[espacio de almacenamiento FTP de su alojamiento compartido](/guides/web-cloud/web-hosting/ftp-connection) un archivo al que denominará "phpinfo.php".
...
Las operaciones en un archivo "**.htaccess**" pueden afectar a la visualización de su sitio web. Si tiene dificultades para realizar lo siguiente, contacte con un [proveedor especializado](https://partner.ovhcloud.com/es-es/directory/).
...
Conéctese a su base de datos siguiendo **el etapa 3** de nuestra guía sobre la [creación de una base de datos compartida](/guides/web-cloud/web-hosting/sql-create-database).

Si utiliza una base de datos en una solución **Web Cloud Databases**, consulte nuestra guía sobre [la conexión a la base de datos de una solución Web Cloud Databases](/guides/web-cloud/databases/db-connecting-database-server).

Si la conexión se ha realizado correctamente, acceda a la siguiente interfaz:

<img className="thumbnail" alt="PHPMyAdmin" src="/images/assets/screens/other/web-tools/phpmyadmin/pma-main-page.png" loading="lazy" />

:::warning
Si se produce un error, consulte nuestra documentación sobre los [errores comunes encontrados con una base de datos](/guides/web-cloud/web-hosting/diagnosis-database-errors). A continuación, utilice la guía para corregir su situación e intente volver a conectarse a la base de datos.
...
:::warning
Si tiene dificultades para realizar las siguientes acciones, puede contactar con uno de nuestros [proveedores especializados](https://partner.ovhcloud.com/es-es/directory/). OVHcloud no ayudará en el desarrollo o la optimización del contenido de su sitio web.
...
Compruebe el motor PHP, la versión PHP y el entorno de ejecución utilizados en su alojamiento web, con ayuda de nuestra guía sobre la [configuración de su alojamiento web](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Para comparar las versiones de PHP disponibles en función del entorno de ejecución utilizado, consulte **el etapa 2** de la guía sobre la [configuración de la versión PHP en su alojamiento](/guides/web-cloud/web-hosting/configure-your-web-hosting).
...
Para analizar las conexiones salientes del alojamiento, consulte los logs **OUT** del mismo. Si necesita ayuda, consulte nuestra guía sobre [la consulta de los logs de su alojamiento](/guides/web-cloud/web-hosting/logs-and-statistics).
...
Para ello, consulte los logs **WEB** de su alojamiento web con nuestra guía sobre [cómo consultar los logs de su alojamiento](/guides/web-cloud/web-hosting/logs-and-statistics).
...
<img className="thumbnail" alt="Análisis de red Firefox" src="/images/assets/screens/other/browsers/diagnostic-tools/F12.png" loading="lazy" />
:::
...
:::info
OVHcloud ofrece varios [productos CDN](https://www.ovhcloud.com/es-es/web-hosting/options/). Si desea utilizar o activar una para su alojamiento web, conéctese a su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y consulte nuestra guía sobre el uso de la CDN de OVHcloud](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn).
...
Consulte nuestra guía sobre la [optimización del rendimiento de su sitio web](/guides/web-cloud/web-hosting/optimise-your-website-performance).
