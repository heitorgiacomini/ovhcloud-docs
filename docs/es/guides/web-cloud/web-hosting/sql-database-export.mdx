...
- Según el método de backup utilizado, tener acceso a la gestión del plan de hosting desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> o disponer de las claves necesarias para conectarse a la base de datos.
...
- **Utilizar la herramienta de backup de OVHcloud** : Esta solución permite recuperar copias de seguridad de sus bases de datos desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. Este método no requiere conocimientos técnicos.
...
<Tabs>
  ...
  <Tab label="Paso 3">
    Haga clic en el botón <code className="action">...</code> a la derecha de la base de datos de la que quiera realizar la copia de seguridad y seleccione <code className="action">Crear una copia de seguridad</code>.
...
<Tabs>
  ...
  <Tab label="Paso 3">
    Haga clic en el botón <code className="action">...</code> a la derecha de la base de datos correspondiente y seleccione <code className="action">Restaurar una copia de seguridad</code>.
  ...
  <Tab label="Paso 4">
    Para descargar una copia de seguridad, haga clic en el botón <code className="action">...</code> a la derecha de la copia de seguridad que desea recuperar y luego en <code className="action">Descargar la copia de seguridad</code>. Acepte y espere a que se descargue la copia de seguridad.
...
<Tabs>
  ...
  <Tab label="Paso 3">
    Haga clic en el botón <code className="action">...</code> a la derecha de la base de datos correspondiente y, seguidamente, en <code className="action">Acceder a phpMyAdmin</code>.
