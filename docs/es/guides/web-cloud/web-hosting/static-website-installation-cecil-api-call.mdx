...
description: Cómo añadir una llamada a una API externa desde la página web estática
...
Este tutorial explica cómo utilizar el generador de sitios web [Cecil](https://cecil.app) para mostrar el contenido de una página dinámica. Llamando a una API para recuperar y mostrar la información en una página generada a través de **Cecil**.
...
- Haber instalado y configurado la aplicación **Cecil** en su alojamiento (consulte nuestro tutorial sobre [la instalación y configuración de Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil)).
...
Prepare su entorno conectándose por SSH a su alojamiento web y consulte el tutorial "[Instalar y configurar Cecil](/guides/web-cloud/web-hosting/static-website-installation-cecil)" para instalar su aplicación **Cecil** en un directorio dedicado.
...
Para este tutorial, utilizaremos una API proporcionada por el sitio web [OpenWeather](https://openweathermap.org/). Permite conocer la información meteorológica en función del nombre de una ciudad.

Cree una cuenta en [https://home.openweathermap.org/users/sign_up](https://home.openweathermap.org/users/sign_up)<br/>
...
Sustituya el valor de la variable `apiKey` por la clave obtenida anteriormente en el sitio [OpenWeather](https://openweathermap.org/)
...
<img className="thumbnail" alt="Página updated" src="/images/assets/screens/other/browsers/web-pages/static-website-installation-cecil-api-call08.png" loading="lazy" />
...
- Algunas API a probar en su sitio web
    ...
    - [Nueva API](https://newsapi.org/)
    - [Polygon.io](https://polygon.io/)
    - una lista de [API públicas](https://github.com/public-api-lists/public-api-lists)
- Las [órdenes de Cecil](https://cecil.app/documentation/commands/).
