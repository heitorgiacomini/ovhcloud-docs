...
Para obtener las claves de conexión a la base de datos creada en una instancia de Web Cloud Databases, consulte [esta guía](/guides/web-cloud/databases/db-getting-started).
...
- La base de datos está [creada en su instancia Web Cloud Databases](/guides/web-cloud/databases/db-create-databases-users): en el menú desplegable. <code className="action">Seleccione la base de datos</code> y elija la opción <code className="action">Base de datos externa al alojamiento web</code> e introduzca la información solicitada. El datacenter en el que se alojan el servicio y el alojamiento web es el mismo.
...
- *Puerto* : sitúe sistemáticamente el número **3306** (puerto por defecto) para una base de datos incluida con su alojamiento web. Para una base de datos de una instancia de Web Cloud Databases, consulte [esta guía](/guides/web-cloud/databases/db-getting-started).

- *Nombre de usuario* : es idéntico al nombre de la base de datos si utiliza una base de datos incluida con su alojamiento web.
Para las bases de datos creadas en un plan de hosting Cloud Databases, consulte la información que se indica en [esta guía](/guides/web-cloud/databases/db-getting-started).
