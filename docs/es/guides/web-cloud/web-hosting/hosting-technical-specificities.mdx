---
title: Particularidades técnicas de los alojamientos web
description: Descubra en esta guía diferentes informaciones y particularidades técnicas relativas a los alojamientos web
...
- Si encuentra el error de acceso "Fallo de la autenticación de conexión 530" al conectarse a su espacio de almacenamiento FTP: Asegúrese de que los datos de acceso a su espacio FTP son correctos. Para ello, conéctese a su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y acceda a la sección <code className="action">Web Cloud</code>. En la columna izquierda, haga clic en <code className="action">Alojamientos</code> y seleccione el alojamiento web correspondiente. A continuación, abra la pestaña <code className="action">FTP - SSH</code>.
...
Para más información, consulte nuestra guía "[Conectarse al espacio de almacenamiento FTP de un alojamiento web](/guides/web-cloud/web-hosting/ftp-connection)".
...
|Productos|Alojamiento gratuito|Starter|Personal|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|---|
|Cantidad máxima de envío de correo por hora y por servicio|10|20|100|100|200|2000|2000|2000|2000|

</Region>

<Region zones={['ca', 'apac']}>

|Productos|Starter|Personal|Startup|Pro|Performance|Agency|Agency Plus|Agency Max|
|---|---|---|---|---|---|---|---|---|
|Cantidad máxima de envío de correo por hora y por servicio|20|100|100|200|2000|2000|2000|2000|
...
- [Seguimiento y gestión de los mensajes de correo automatizados de su alojamiento web](/guides/web-cloud/web-hosting/mail-function-script-records);
- [Casos prácticos - Consejos sobre la piratería de su sitio Web](/guides/web-cloud/web-hosting/cms-what-to-do-if-your-site-is-hacked).
...
Para más información, consulte los detalles de nuestros [planes de hosting](https://www.ovhcloud.com/es-es/web-hosting/) y nuestra guía "[Primeros pasos con su solución Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)".
...
Solo los servidores de bases de datos [Web Cloud Databases](https://www.ovhcloud.com/es-es/web-cloud/databases/) permiten a servidores externos conectarse a ellos. Para ello, debe haber autorizado previamente la dirección IP de su servidor externo en su servidor de bases de datos. Si necesita ayuda, consulte nuestra guía "[Primeros pasos con su solución Web Cloud Databases](/guides/web-cloud/databases/db-getting-started)".
...
Para más información sobre la gestión de las bases de datos y la conexión a la interfaz *phpMyAdmin*, consulte la guía "[Crear una base de datos en un alojamiento web](/guides/web-cloud/web-hosting/sql-create-database)".
...
Para más información, consulte nuestra guía "[Alojamiento web: entorno, versión PHP, ".ovhconfig"](/guides/web-cloud/web-hosting/configure-your-web-hosting)"
...
Una vez conectado al alojamiento web por SSH, el tráfico saliente se bloqueará por motivos de seguridad. Por lo tanto, le recomendamos que utilice scripts PHP. Para más información, consulte nuestra [guía SSH](/guides/web-cloud/web-hosting/ssh-on-webhosting). Puede consultar el apartado "[PHP manual](https://www.php.net/manual/es/function.system.php)" relativo a la ejecución de comandos.
...
Consulte y compruebe las librerías, lenguajes y versiones disponibles para su plan de hosting desde esta página: [https://webhosting-infos.hosting.ovh.net](https://webhosting-infos.hosting.ovh.net)

<Region zones={['eu']}>
Para conocer las especificaciones técnicas de la solución Cloud Web, acceda a la siguiente página: [https://cloudweb-infos.hosting.ovh.net/](https://cloudweb-infos.hosting.ovh.net/).
</Region>
...
Cómo [conectarse al espacio de almacenamiento FTP de un alojamiento web](/guides/web-cloud/web-hosting/ftp-connection) o [restaurar el espacio de almacenamiento FTP de un alojamiento web](/guides/web-cloud/web-hosting/ftp-save-and-backup) en nuestra documentación.
...
Para las bases de datos compartidas (incluidas en su plan de hosting) o los servidores de bases de datos (Web Cloud Databases), que se ofrecen en Gravelines (GRA), Francia y Beauharnois (BHS), Canadá, la copia de seguridad de las bases de datos se realiza todos los días. Puede acceder a estas copias de seguridad (en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> o a través de las [API de OVHcloud](https://eu.api.ovh.com/)). Las copias de seguridad también se almacenan en otra infraestructura. Estos datos se replican en un centro de datos situado en Estrasburgo (SBG). La política de retención de las copias de seguridad es de 30 días.

Esta guía explica cómo consultar nuestra documentación [Descargar la copia de seguridad de la base de datos de un alojamiento web](/guides/web-cloud/web-hosting/sql-database-export).
...
[Habilitar HTTPS en un sitio web con SSL](/guides/web-cloud/web-hosting/ssl-activate-https-website)

[Optimización del rendimiento de su sitio web](/guides/web-cloud/web-hosting/optimise-your-website-performance)

[Restaurar el espacio de almacenamiento FTP de un alojamiento web](/guides/web-cloud/web-hosting/ftp-save-and-backup)

[Recuperar la copia de seguridad de la base de datos de un alojamiento web](/guides/web-cloud/web-hosting/sql-database-export)
