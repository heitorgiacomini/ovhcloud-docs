...
Acceda al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. Haga clic en <code className="action">Web Cloud</code> y seleccione <code className="action">Alojamientos</code>.
