...
<Tabs>
  ...
  <Tab label="Paso 2">
    ...
    Para crear una tarea CRON, haga clic en el botón <code className="action">Añadir una planificación</code> a la derecha.
  </Tab>
  <Tab label="Paso 3">
  ...
  <Tab label="Paso 5">
    El resumen le recuerda los parámetros configurados, incluyendo la notación *crontab* sobre la frecuencia de ejecución. Si todo es correcto, haga clic en <code className="action">Aceptar</code>.
...
Podrá acceder a los logs de su alojamiento web desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y ver la categoría de log denominada "CRON".
