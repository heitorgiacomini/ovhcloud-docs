...
:::tip
Para instalar Joomla! **automáticamente** desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, consulte nuestra documentación sobre la [instalación de un módulo en un clic](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
...
-*Enter the database name*: este nombre se ha establecido al crear la base de datos en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. Es idéntico al nombre de usuario de la base de datos si utiliza una base de datos incluida con su alojamiento web.
