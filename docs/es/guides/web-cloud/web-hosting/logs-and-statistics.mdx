...
<Tabs>
  ...
  <Tab label="Etapa 2">
    En la nueva página, haga clic en la pestaña <code className="action">Estadísticas y logs</code> y acceda a la sección **Estadísticas de la infraestructura**.
  </Tab>
  <Tab label="Etapa 3">
    Puede ver diferentes tipos de gráficos en el menú desplegable de la parte superior izquierda:
    
    <img className="thumbnail" alt="Estadísticas de la infraestructura del alojamiento web" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/infrastructure-statistics-graph.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    En la nueva página, haga clic en la pestaña <code className="action">Estadísticas y logs</code> y acceda a la sección **Administración de los usuarios**.
  </Tab>
  <Tab label="Etapa 3">
    Haga clic en <code className="action">Crear un nuevo usuario</code> y siga las instrucciones para finalizar la creación.
    
    <img className="thumbnail" alt="Creación de un nuevo usuario para las estadísticas" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/create-a-new-user.png" loading="lazy" />
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    En la nueva página, haga clic en la pestaña <code className="action">Estadísticas y logs</code> y acceda a la sección **Estadísticas de visitas**.
  </Tab>
  <Tab label="Etapa 3">
    Pulse el botón <code className="action">Ver las estadísticas</code>.
    
    <img className="thumbnail" alt="Estadísticas de visitas del sitio web" src="/images/assets/screens/control-panel/product-selection/web-cloud/web-hosting/statistics-and-logs/view-statistics.png" loading="lazy" />
...
:::warning
Si ha activado los logs separados en uno de sus [sitios web](/guides/web-cloud/web-hosting/multisites-configure-multisite), los usuarios creados aquí no podrán acceder a las estadísticas de ese sitio web específico.
:::
