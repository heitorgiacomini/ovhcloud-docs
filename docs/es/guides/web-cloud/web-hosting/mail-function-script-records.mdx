...
El seguimiento y la gestión del correo automatizado de su alojamiento web de OVHcloud se realizan desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. 
