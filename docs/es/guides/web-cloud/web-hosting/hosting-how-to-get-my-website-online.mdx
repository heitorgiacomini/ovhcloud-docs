...
Si quiere crear una nueva base de datos en OVHcloud, conéctese al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y, haga clic en <code className="action">Alojamientos</code>. Seleccione el alojamiento correspondiente y abra la pestaña <code className="action">Bases de datos</code>.
