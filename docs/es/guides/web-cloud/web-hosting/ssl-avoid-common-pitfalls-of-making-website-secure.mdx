...
description: Descubra cómo evitar los errores comunes de seguridad de su sitio web con el SSL
...
- Tener un [alojamiento web de OVHcloud](https://www.ovhcloud.com/es-es/web-hosting/).
- Haber registrado al menos un [dominio](https://www.ovhcloud.com/es-es/domains/).
...
:::info
Algunos sitios web utilizan [Content Delivery Network (CDN)](/guides/web-cloud/web-hosting/cdn-how-to-use-cdn) para alojar, por ejemplo, librerías *Javascript* (como *JQuery*). 
