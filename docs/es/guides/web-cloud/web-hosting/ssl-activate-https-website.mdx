...
description: Decubra cómo activar un certificado SSL en un sitio web HTTPS
...
- Tener un [certificado SSL](https://www.ovhcloud.com/es-es/web-hosting/options/ssl/) instalado en su [alojamiento web de OVHcloud](https://www.ovhcloud.com/es-es/web-hosting/).
...
Para activar un certificado SSL en un alojamiento web o comprobar que ya hay un certificado SSL instalado en un sitio web, consulte nuestra guía: "[Gestionar un certificado SSL en un alojamiento web](/guides/web-cloud/web-hosting/ssl-on-webhosting)".
...
Tan pronto como su nombre de dominio tenga un [certificado SSL activo a través de su alojamiento web](/guides/web-cloud/web-hosting/ssl-on-webhosting) y su sitio web esté listo para pasar a *HTTPS*, puede activarlo.

:::warning
Antes de realizar cualquier operación, le recomendamos que guarde una copia de seguridad completa del sitio web. Esta copia de seguridad debe contener no solo los archivos presentes en el [espacio de almacenamiento FTP](/guides/web-cloud/web-hosting/ftp-save-and-backup), sino también los de [la base de datos](/guides/web-cloud/web-hosting/sql-database-export) si el sitio web utiliza una.
