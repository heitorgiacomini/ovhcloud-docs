---
title: Utilizar SVN
description: Descubra cómo utilizar SVN por SSH en un alojamiento web
...
- Conectarse a su alojamiento web por SSH (consulte nuestra guía [Utilizar el acceso SSH de su alojamiento web](/guides/web-cloud/web-hosting/ssh-on-webhosting)).

## Procedimiento

### Creación del repositorio

Una vez conectado en [SSH al alojamiento](/guides/web-cloud/web-hosting/ssh-on-webhosting), cree el directorio raíz de los repositorios SVN y el repositorio.
...
Para más información, consulte la guía [Crear llaves SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys#create-ssh-key).
...
Consulte nuestra guía [Utilizar el acceso SSH de un alojamiento web](/guides/web-cloud/web-hosting/ssh-on-webhosting).
:::
