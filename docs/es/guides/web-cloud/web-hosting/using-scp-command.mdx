...
description: Descubra cómoómo utilizar el comando Secure Copy Protocol (SCP) en SSH para copiar archivos desde o hacia su alojamiento web
...
- Tener contratado un plan de [alojamiento web](https://www.ovhcloud.com/es-es/web-hosting/) con acceso por SSH

## Procedimiento

Esta guía explica en detalle las funcionalidades disponibles con el comando `scp`. No dude en interactuar con nuestra [comunidad de usuarios](https://community.ovhcloud.com/community/en) si desea profundizar sus conocimientos sobre este pedido.

### Etapa 1 - Obtener los accesos SSH de su alojamiento web

Para más información sobre los accesos SSH de un alojamiento web, consulte nuestra guía "[Utilizar el acceso SSH de un alojamiento web](/guides/web-cloud/web-hosting/ssh-on-webhosting)".
...
- `ssh.cluster0XX.hosting.ovh.net`: sustituya los `XX` por el número del cluster en el que se encuentre su alojamiento web. Si lo necesita, consulte nuestra guía "[Utilizar el acceso SSH de un alojamiento web](/guides/web-cloud/web-hosting/ssh-on-webhosting)" para más información.
...
Para comprobar que el contenido local de su ordenador se ha copiado en su alojamiento web, puede [conectarse al espacio de almacenamiento FTP de su alojamiento web](/guides/web-cloud/web-hosting/ftp-connection) y, a continuación, dirigirse al directorio de destino en el que se supone que debe copiarse el contenido.
