...
Conéctese a su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y acceda a <code className="action">Web Cloud</code>. En el menú de la izquierda, haga clic en <code className="action">Sitios web</code>. Se mostrará una tabla que recoge todos sus sitios web y su información principal.
