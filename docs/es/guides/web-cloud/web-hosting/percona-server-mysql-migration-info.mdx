...
description: Descubra las ventajas de migrar MySQL a Percona Server para MySQL
...
- Disponer de un [plan de hosting de OVHcloud](https://www.ovhcloud.com/es-es/web-hosting/) con una base de datos compartida de OVHcloud (MySQL) asociada.
