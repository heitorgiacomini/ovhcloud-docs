...
<Region zones={['eu']}>
- Tener contratado un [plan de hosting de OVHcloud](https://www.ovhcloud.com/es-es/web-hosting/), a excepción de un plan de hosting Cloud Web.
</Region>
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    En la pestaña <code className="action">Información general</code>, busque la versión en *Versión PHP global*.
...
<details>
<summary>Mediante un script</summary>
