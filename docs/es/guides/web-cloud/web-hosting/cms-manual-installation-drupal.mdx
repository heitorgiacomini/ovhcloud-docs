...
:::tip
Para instalar Drupal **automáticamente** desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, consulte nuestra documentación sobre la [instalación de un módulo en un clic](/guides/web-cloud/web-hosting/cms-install-1-click-modules).
