...
description: Descubra cómo contratar e instalar un certificado SSL Sectigo EV en un alojamiento web de OVHcloud
...
Ponemos a su disposición esta guía para ayudarle a realizar las tareas más habituales. No obstante, si tiene alguna duda, le recomendamos que contacte con un [proveedor especializado](https://partner.ovhcloud.com/es-es/directory/). En efecto, no podremos asistirle en **todas las etapas de verificación directamente efectuada con la autoridad de certificación Sectigo**. Más información en la sección [Más información](#go-further) de esta guía.
:::

### 1 - Contratar el certificado SSL Sectigo EV

:::warning
Los certificados SSL Sectigo EV que ofrece OVHcloud solo son válidos para uno de los dos siguientes casos en su alojamiento web:
...
<Tabs>
  ...
  <Tab label="Etapa 4">
    En la nueva ventana, seleccione el dominio o subdominio correspondiente en el menú desplegable y haga clic en <code className="action">Confirmar</code> para redirigirlo a la orden de pedido de su certificado SSL Sectigo EV.
...
Haga clic en <code className="action">Continuar</code> una vez **todos los elementos** correctamente introducidos.
...
Si todavía no ha contratado su dominio y el alojamiento asociado, acceda a nuestra [página de inicio de OVHcloud](https://www.ovhcloud.com/es-es/), introduzca un dominio en el **formulario de búsqueda previsto a tal efecto** y haga clic en <code className="action">Buscar</code> para iniciar el pedido.
...
Seleccione su elección de instalación de <code className="action">módulo en 1 clic</code> y de <code className="action">CDN</code> y descienda al final de la página hasta la sección <code className="action">Proteja su sitio web con nuestros certificados SSL</code>.

<img className="thumbnail" alt="SSL EV order" src="/images/assets/screens/website/order/ssl-ev-selection.png" loading="lazy" />

Seleccione <code className="action">Sectigo EV SSL</code> y haga clic en <code className="action">Siguiente</code>.

Introduzca la información solicitada por **Sectigo** antes de expedir el certificado SSL Sectigo EV en la nueva página.

<img className="thumbnail" alt="SSL EV form" src="/images/assets/screens/website/order/ssl-ev-step-2.png" loading="lazy" />

Haga clic en <code className="action">Siguiente</code> una vez **todos los elementos** correctamente introducidos.
...
### 2 - Verificaciones con la Autoridad de Certificación (AC) Sectigo
...
>
> También le recomendamos que **no** active o deje activo el[firewall de aplicación](/guides/web-cloud/web-hosting/multisites-activating-application-firewall), disponible con nuestros alojamientos web durante toda la instalación de su certificado SSL Sectigo EV.
>
...
### 3 - Instalación del certificado SSL Sectigo EV con su dominio y su alojamiento OVHcloud
...
Solo tendrá que [pasar su sitio web en HTTPS](/guides/web-cloud/web-hosting/ssl-activate-https-website) para utilizar plenamente su certificado SSL Sectigo EV.
...
[Habilitar HTTPS en el sitio web](/guides/web-cloud/web-hosting/ssl-activate-https-website)
