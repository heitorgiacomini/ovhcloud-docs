...
Para más información sobre los caracteres autorizados con codificación de 7 bits, consulte el [anexo](/guides/web-cloud/messaging/sms/send-sms-email#anexo) que encontrará al final de esta guía.
...
<img className="thumbnail" alt="email2sms" src="/images/web-cloud/messaging/sms/send-sms-email/plaintext01.png" loading="lazy" />
:::
...
<img className="thumbnail" alt="email2sms" src="/images/web-cloud/messaging/sms/send-sms-email/send-sms-through-email1.png" loading="lazy" />
...
Para más información sobre los usuarios de SMS, consulte la siguiente guía: [Usuarios de SMS](/guides/web-cloud/messaging/sms/sms-users)
...
<img className="thumbnail" alt="email2sms" src="/images/web-cloud/messaging/sms/send-sms-email/send-sms-through-email3.png" loading="lazy" />
...
<img className="thumbnail" alt="email2sms" src="/images/web-cloud/messaging/sms/send-sms-email/send-sms-through-email4.png" loading="lazy" />

Si se ha producido un error, este aparecerá recogido en el informe, tal y como se muestra a continuación:

<img className="thumbnail" alt="email2sms" src="/images/web-cloud/messaging/sms/send-sms-email/send-sms-through-email5.png" loading="lazy" />
...
<img className="thumbnail" alt="Lista de caracteres de SMS" src="/images/web-cloud/messaging/sms/send-sms-email/smsauthorizedcharacters.png" loading="lazy" />
