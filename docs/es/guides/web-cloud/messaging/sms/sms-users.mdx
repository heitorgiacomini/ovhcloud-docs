...
<img className="thumbnail" alt="Usuarios de SMS" src="/images/web-cloud/messaging/sms/sms-users/smsusers.png" loading="lazy" />
...
<img className="thumbnail" alt="Usuarios API" src="/images/web-cloud/messaging/sms/sms-users/smsusers01e-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="Añadir una cuota a un usuario API" src="/images/web-cloud/messaging/sms/sms-users/smsusers03e-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="Activar una cuota" src="/images/web-cloud/messaging/sms/sms-users/smsusers04-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="Configuración de un límite" src="/images/web-cloud/messaging/sms/sms-users/smsusers05-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="Restricciones por IP" src="/images/web-cloud/messaging/sms/sms-users/smsusers06-2021.png" loading="lazy" />
...
<img className="thumbnail" alt="Indicar URL de callback" src="/images/web-cloud/messaging/sms/sms-users/smsusers07-2021.png" loading="lazy" />
