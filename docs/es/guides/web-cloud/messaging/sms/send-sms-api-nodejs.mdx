...
description: Descubra cómo configurar un entorno Node.js y enviar su primer SMS paso a paso utilizando el wrapper de la API RESTful de OVHcloud
...
[https://auth.eu.ovhcloud.com/api/createToken](https://auth.eu.ovhcloud.com/api/createToken?GET=/sms&GET=/sms/*&GET=/sms/*/jobs&POST=/sms/*/jobs) (si accede desde este enlace, tendrá automáticamente los permisos necesarios para seguir los pasos que se explican en esta guía).

<img className="thumbnail" alt="generar los tokens" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2462.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Obtención de los tokens" src="/images/web-cloud/messaging/sms/send-sms-api-nodejs/img_2463.jpg" loading="lazy" />
