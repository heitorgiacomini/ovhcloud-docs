...
description: Encuentre las respuestas a las preguntas más frecuentes sobre el servicio SMS de OVHcloud
...
<details>
<summary>¿Cómo crear una cuenta SMS en OVHcloud?</summary>


Para crear una cuenta SMS en OVHcloud, acceda a la [página de ofertas SMS de OVHcloud](https://www.ovhcloud.com/es-es/sms/) y elija el pack de créditos que mejor se adapte a sus necesidades. El pedido creará automáticamente una cuenta SMS accesible desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, en la <ManagerLink to="/#/telecom/sms">sección SMS</ManagerLink>. Cada cuenta SMS se identifica con un nombre único (p. ej.: `sms-xx12345-1`). Es posible tener varias cuentas SMS en un mismo identificador de cliente OVHcloud, lo que permite separar los usos (transaccional, marketing, notificaciones internas) y los presupuestos.

</details>


<details>
<summary>¿Cómo funciona el sistema de créditos SMS?</summary>
...
- **El destino:** un SMS hacia Francia metropolitana consume 1 crédito. Los destinos internacionales consumen más créditos (consulte la [tabla de precios de OVHcloud](https://www.ovhcloud.com/es-es/sms/prices/)).
...
Para más información, consulte la guía "[Gestionar los créditos SMS y activar la recarga automática](/guides/web-cloud/messaging/sms/activer-la-recharge-automatique-du-credit-sms)".

</details>


<details>
<summary>¿Cómo activar la recarga automática de créditos SMS?</summary>


La recarga automática permite recargar automáticamente su cuenta SMS cuando el saldo desciende por debajo de un umbral definido. <ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y acceda a <code className="action">Opciones</code> > <code className="action">Recarga automática</code>. Configure el umbral de activación y el importe de la recarga. Es necesario tener un método de pago válido registrado en su cuenta. Esta opción es indispensable para el envío de SMS transaccionales, donde una falta de créditos bloquearía sus notificaciones críticas.
...
<details>
<summary>¿Cómo consultar el historial de mis SMS enviados y recibidos?</summary>


<ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y acceda a la pestaña <code className="action">Mensaje y campaña</code> > <code className="action">Gestión de SMS</code> > <code className="action">Historial de envíos</code> o <code className="action">SMS recibidos</code>. Puede filtrar el historial por fecha, remitente, destinatario o mensaje. El historial se conserva durante 6 meses. También puede exportarse en formato CSV para su análisis.

Para más información, consulte la guía "[Gestionar el historial de SMS](/guides/web-cloud/messaging/sms/sms-history)".

</details>


<details>
<summary>¿Cómo configurar alertas de umbral de créditos SMS?</summary>


Para los **usuarios API**, <ManagerLink to="/#/telecom/sms">acceda a la sección SMS</ManagerLink>, seleccione su cuenta y acceda a <code className="action">Usuarios API</code>. Haga clic en <code className="action">...</code> > <code className="action">Límite</code> para el usuario en cuestión y configure:
...
Para más información, consulte la guía "[Todo sobre los usuarios SMS](/guides/web-cloud/messaging/sms/sms-users)".
...
<details>
<summary>¿Cómo enviar un SMS desde el área de cliente de OVHcloud?</summary>


<ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y haga clic en <code className="action">Enviar un SMS</code>. Complete los siguientes campos:
...
Para más información, consulte la guía "[Enviar SMS desde el área de cliente de OVHcloud](/guides/web-cloud/messaging/sms/send-sms-control-panel)".

</details>


<details>
<summary>¿Cómo enviar SMS a través de una URL (http2sms)?</summary>
...
Para más información, consulte la guía "[Enviar SMS desde una URL - http2sms](/guides/web-cloud/messaging/sms/send-sms-http2sms)".

</details>


<details>
<summary>¿Cómo enviar SMS desde una dirección de correo electrónico?</summary>
...
Para más información, consulte la guía "[Enviar SMS desde una dirección de correo electrónico](/guides/web-cloud/messaging/sms/send-sms-email)".

</details>


<details>
<summary>¿Cómo enviar SMS masivos de forma eficiente a través de la API?</summary>
...
<details>
<summary>¿Cómo crear mi primera campaña SMS?</summary>


<ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y haga clic en <code className="action">Enviar un SMS</code>. Los pasos son:
...
El seguimiento de la campaña está disponible en <code className="action">Mensaje y campaña</code> > <code className="action">Gestión de campañas</code> > <code className="action">Estadísticas e historial</code>.

Para más información, consulte la guía "[Mi primera campaña SMS](/guides/web-cloud/messaging/sms/ma-premiere-campagne-sms)".

</details>


<details>
<summary>¿Cómo gestionar mis listas de destinatarios SMS?</summary>


<ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y acceda a <code className="action">Contactos</code> > <code className="action">Crear una lista de contactos</code>. Puede:
...
Para más información, consulte la guía "[Listas de destinatarios SMS](/guides/web-cloud/messaging/sms/liste-de-destinataire-sms)".

</details>


<details>
<summary>¿Cómo gestionar mis agendas de contactos SMS?</summary>


Las agendas de contactos SMS ofrecen una gestión más completa de los contactos (nombre, apellidos, número). <ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink>, seleccione su cuenta SMS y acceda a <code className="action">Contactos</code> > <code className="action">Agenda de contactos</code>. Puede:
...
Para más información, consulte la guía "[Gestionar mis agendas de contactos SMS](/guides/web-cloud/messaging/sms/sms-address-books)".

</details>


<details>
<summary>¿Cuál es la diferencia entre un SMS estándar (160 caracteres) y un SMS largo?</summary>
...
<details>
<summary>¿Qué caracteres especiales hacen que un SMS cambie a codificación Unicode?</summary>
...
<details>
<summary>¿Cuál es el plazo de entrega de un SMS enviado a través de OVHcloud?</summary>
...
<details>
<summary>Mis SMS no se entregan, ¿cómo diagnosticar el problema?</summary>


Realice las siguientes comprobaciones:

1. **Compruebe su saldo de créditos:** un saldo a cero bloquea inmediatamente todos los envíos.
2. **Consulte el historial de envío:** en <code className="action">Mensaje y campaña</code> > <code className="action">Gestión de SMS</code> > <code className="action">Historial de envíos</code>, compruebe el estado de cada SMS. Un código PTT indica la razón del fallo.
...
<details>
<summary>¿Qué tipos de remitentes SMS puedo utilizar?</summary>
...
Para más información, consulte la guía "[Todo sobre los remitentes SMS](/guides/web-cloud/messaging/sms/sms-senders)".

</details>


<details>
<summary>¿Cómo añadir un remitente alfanumérico personalizado?</summary>


<ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y haga clic en la pestaña <code className="action">Remitentes</code>. Haga clic en <code className="action">Acciones</code> > <code className="action">Añadir</code> y elija "Añadir remitentes manualmente". Complete los siguientes campos:
...
<details>
<summary>¿Por qué no puedo enviar un SMS que contenga una URL con un número corto?</summary>
...
<details>
<summary>¿Qué es un número móvil virtual (VLN) y cómo obtenerlo?</summary>
...
4. La respuesta puede consultarse en su área de cliente de OVHcloud (<code className="action">Mensaje y campaña</code> > <code className="action">Gestión de SMS</code> > <code className="action">SMS recibidos</code>).
...
<details>
<summary>¿Cómo configurar una respuesta automática a los SMS recibidos?</summary>


<ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y acceda a <code className="action">Opciones</code> > <code className="action">Opciones de las respuestas</code>. En la sección "Acción a la recepción", elija "Responder con un texto predefinido" o "Llamar a un CGI" (URL de un script web que se ejecutará con cada respuesta recibida, lo que permite un tratamiento dinámico). También puede configurar notificaciones a la recepción (por correo electrónico o SMS).

</details>


<details>
<summary>¿Cómo gestionar las solicitudes de baja (STOP)?</summary>


Cuando un destinatario responde "STOP" a uno de sus SMS, su número se añade automáticamente a una lista negra por parte de OVHcloud. Los SMS posteriores enviados a ese número desde su cuenta se bloquearán. Puede consultar y gestionar esta lista negra desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, pestaña <code className="action">Opciones</code> > <code className="action">Gestionar los destinatarios en lista negra</code>. Puede:
...
<details>
<summary>¿Cómo crear y gestionar usuarios API para SMS?</summary>


Los usuarios API SMS permiten delegar el envío de SMS a través de la API o la función http2sms sin exponer sus credenciales de cliente de OVHcloud. <ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta SMS y haga clic en <code className="action">Usuarios API</code>. Añada un nuevo usuario definiendo un identificador y una contraseña. A cada usuario se le puede asignar:
...
<details>
<summary>¿Cómo enviar un SMS a través de la API de OVHcloud en PHP?</summary>
...
Para más información, consulte la guía "[Enviar SMS con la API de OVHcloud en PHP](/guides/web-cloud/messaging/sms/send-sms-api-php)".

</details>


<details>
<summary>¿Qué endpoints API están disponibles para el servicio SMS de OVHcloud?</summary>
...
<details>
<summary>¿Cómo recibir los acuses de recibo (DLR) de mis SMS a través de un callback?</summary>


Los acuses de recibo (Delivery Reports / DLR) confirman la correcta entrega de un SMS. Para recibirlos automáticamente, configure una URL de callback en su usuario API. <ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> y luego a <code className="action">Usuarios API</code>, haga clic en <code className="action">...</code> > <code className="action">Callback</code> para el usuario en cuestión. Introduzca la URL de su endpoint web. Con cada actualización de estado, OVHcloud llamará a esta URL con los siguientes parámetros:
...
<details>
<summary>¿Cómo utilizar el protocolo SMPP con OVHcloud?</summary>


El protocolo SMPP (Short Message Peer-to-Peer) es un protocolo industrial para el envío y la recepción de SMS en volumen. <ManagerLink to="/#/telecom/sms">Acceda a la sección SMS</ManagerLink> de su área de cliente de OVHcloud, seleccione su cuenta y acceda a <code className="action">Opciones</code> > <code className="action">Parámetros SMPP</code>. Obtendrá los parámetros de conexión: dirección del servidor SMPP, puerto, system_id y password. El protocolo SMPP ofrece una conexión persistente, un mayor rendimiento de envío y soporte nativo de DLR en modo push.

Para más información, consulte la guía "[Gestión de una cuenta SMS SMPP](/guides/web-cloud/messaging/sms/smpp-control-panel)".

</details>


<details>
<summary>¿Cuáles son las especificaciones técnicas del servicio SMPP de OVHcloud?</summary>
...
Para más información, consulte la guía "[Especificaciones técnicas del SMPP](/guides/web-cloud/messaging/sms/smpp-specification)".

</details>


<details>
<summary>¿Cómo integrar el envío de SMS de OVHcloud en mi aplicación empresarial o CRM?</summary>
...
<details>
<summary>¿Cuáles son los límites de velocidad de envío de SMS?</summary>
...
<details>
<summary>¿Puedo enviar SMS que contengan variables personalizadas?</summary>
...
<details>
<summary>¿Cuáles son las obligaciones legales para el envío de SMS de marketing en Francia?</summary>
...
<details>
<summary>¿Cuál es la diferencia entre un SMS transaccional y un SMS de marketing?</summary>
...
<details>
<summary>¿Cómo optimizar la tasa de entregabilidad de mis SMS?</summary>
...
<details>
<summary>¿Cómo enviar SMS a Estados Unidos?</summary>
...
- Un coste en créditos superior al de un SMS nacional (consulte la [tabla de precios](https://www.ovhcloud.com/es-es/sms/prices/) para conocer la tarifa exacta).

La tasa de entregabilidad puede variar en función de los operadores estadounidenses y de sus filtros antispam.

Para más información, consulte la guía "[Envío de SMS a Estados Unidos](/guides/web-cloud/messaging/sms/envoi-de-sms-aux-etats-unis)".

</details>


<details>
<summary>¿Cuáles son las restricciones geográficas para el envío de SMS con OVHcloud?</summary>
...
- **Precios variables:** el coste en créditos varía según el destino. Las tarifas pueden consultarse en su área de cliente de OVHcloud o en la [página de precios de OVHcloud](https://www.ovhcloud.com/es-es/sms/prices/).
