...
description: Descubra cómo enviar SMS mediante la herramienta Wget y peticiones HTTP directamente desde la barra de direcciones de su navegador web
...
- Haber creado un usuario de SMS desde el área de cliente de OVHcloud o a través de la API. Para ello, puede consultar la guía [Usuarios de SMS](/guides/web-cloud/messaging/sms/sms-users).
- Disponer de una cuenta de SMS en OVHcloud con saldo de SMS.

## Procedimiento

Es posible enviar SMS mediante una petición HTTPS a la siguiente dirección: [https://www.ovh.com/cgi-bin/sms/http2sms.cgi?](https://www.ovh.com/cgi-bin/sms/http2sms.cgi?), seguida de los parámetros obligatorios (y los opcionales que desee).

<img className="thumbnail" alt="URL de envío de sms" src="/images/web-cloud/messaging/sms/send-sms-http2sms/img_4011.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Lista de caracteres de SMS" src="/images/web-cloud/messaging/sms/send-sms-http2sms/smsauthorizedcharacters.png" loading="lazy" />
