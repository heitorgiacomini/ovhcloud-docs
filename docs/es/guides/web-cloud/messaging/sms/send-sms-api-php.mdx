...
description: Descubra cómo configurar un entorno de desarrollo PHP y enviar su primer SMS paso a paso utilizando la API RESTful de OVHcloud
...
<img className="thumbnail" alt="Su proyecto con Composer" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2450.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Crear los tokens" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2451.jpg" loading="lazy" />
...
<img className="thumbnail" alt="Obtención de los tokens" src="/images/web-cloud/messaging/sms/send-sms-api-php/img_2452.jpg" loading="lazy" />
...
En la [consola de la API](https://eu.api.ovh.com/console/) podrá descubrir otras llamadas que le permitirán integrar servicios de SMS, tales como permitir la respuesta a los SMS (solo para las cuentas de OVHcloud Francia), envío masivo con un archivo CSV, envío de publicidad, seguimiento de los acuses de recibo...
