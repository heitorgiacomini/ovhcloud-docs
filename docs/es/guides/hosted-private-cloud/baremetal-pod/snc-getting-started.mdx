...
![Keycloak login page](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/keycloak_login.png)

Once you have entered your credentials to register, you will have access to the product dashboard.

![Dashboard visible once identified](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/dashboard.png)
...
![Location of the shortcut to Horizon](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/dashboard_login_horizon.png)

After logging in, the Horizon OpenStack interface appears as follows:

![Horizon OpenStack interface](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_dashboard.png)
...
![Menu of the OpenStack Horizon interface](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_menu.png)
...
![Screenshot of the Overview section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_project_overview.png)
...
- **Limit Summary**: The quota limits assigned to the project for each type of resource. This also allows you to visualize the level of resource consumption in relation to the available capacity.
    ...
    ![Screenshot of the Limit Summary section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_quota_categories.png)
...
![Screenshot of the Usage Summary section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_quota_historical.png)
...
![Screenshot of the API-Access section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_project_apiaccess.png)
...
![Screenshot of the Instances section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_instance_list.png)
...
![Screenshot of the Images section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_image_list.png)
...
![Screenshot of the Key Pairs section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_sshkey_list.png)
...
![Screenshot of the Network Topology section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_network_topology.png)

##### Networks section

This section contains the list of available networks for the dedicated servers on your **Bare Metal Pod**.

![Screenshot of the Networks section](/images/guides/hosted-private-cloud/baremetal-pod/snc-getting-started/horizon_network_list.png)
