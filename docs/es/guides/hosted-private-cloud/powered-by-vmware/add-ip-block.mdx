...
:::info
Para más información sobre las IP reservadas en su bloque y su utilización, consulte la siguiente guía: [Utilizar el plugin OVHcloud Network](/guides/hosted-private-cloud/powered-by-vmware/plugin-ovh-network).
...
<img className="thumbnail" alt="campo nexthop" src="/images/hosted-private-cloud/powered-by-vmware/ajout-de-bloc-ip/move-api.png" loading="lazy" />

Obtendrá el siguiente resultado:

<img className="thumbnail" alt="campo nexthop" src="/images/hosted-private-cloud/powered-by-vmware/ajout-de-bloc-ip/api-result.png" loading="lazy" />
...
Podrá seguir la migración del bloque de IP desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> en el menú <code className="action">Hosted Private Cloud</code> > <code className="action">Private Cloud</code>. Haga clic en su servicio Hosted Private Cloud y, a continuación, en la pestaña <code className="action">Operaciones</code>.

La referencia de la operación es «removeIpRipeBlock».

<img className="thumbnail" alt="operaciones manager" src="/images/hosted-private-cloud/powered-by-vmware/ajout-de-bloc-ip/operations.png" loading="lazy" />
