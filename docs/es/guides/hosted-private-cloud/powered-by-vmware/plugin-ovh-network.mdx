...
description: Cómo utilizar el plugin OVHcloud Network en la solución Hosted Private Cloud
...
<img className="thumbnail" alt="Información sobre IP y bloques" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_02.png" loading="lazy" />
...
<img className="thumbnail" alt="Botón Edit Reverse" src="/images/hosted-private-cloud/powered-by-vmware/plugin-ovh-network/ovhcloudplugin_03.png" loading="lazy" />
...
:::info
Este proceso de configuración también está disponible desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>. 
