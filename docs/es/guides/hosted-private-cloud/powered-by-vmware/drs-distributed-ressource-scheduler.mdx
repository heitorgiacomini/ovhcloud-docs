...
description: Aprenda a gestionar el balanceo de carga con la función DRS
...
- Tener contratado un [Hosted Private Cloud de OVHcloud](https://www.ovhcloud.com/es-es/enterprise/products/hosted-private-cloud/).
...
<img className="thumbnail" alt="Principio del DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs0.png" loading="lazy" />
...
Si la función DRS no está activa en su cluster, selecciónelo y diríjase a la pestaña <code className="action">Configurar</code>.

Haga clic en el menú <code className="action">Servicios</code> y a continuación seleccione <code className="action">vSphere DRS</code>.

Haga clic en <code className="action">Modificar</code>y active la funcionalidad con el botón `vSphere DRS`.

<img className="thumbnail" alt="Activación del DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs01.png" loading="lazy" />
...
<img className="thumbnail" alt="Automatización DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs02.png" loading="lazy" />
...
<img className="thumbnail" alt="Opciones adicionales DRS" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs03.png" loading="lazy" />
...
<img className="thumbnail" alt="opciones avanzadas drs" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs05.png" loading="lazy" />

### Reglas DRS

Para gestionar las reglas de MV/host, diríjase a la pestaña `Configurar`.

<img className="thumbnail" alt="reglas drs" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs06.png" loading="lazy" />
...
La cuarta regla, «máquinas virtuales a máquinas virtuales», viene explicada en nuestra guía sobre la [funcionalidad HA](/guides/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability).

<img className="thumbnail" alt="creación reglas drs" src="/images/hosted-private-cloud/powered-by-vmware/vmware-drs-distributed-ressource-scheduler-new/drs07.png" loading="lazy" />
