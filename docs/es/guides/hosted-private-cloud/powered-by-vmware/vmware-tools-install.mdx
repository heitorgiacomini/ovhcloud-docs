...
description: Cómo instalar VMware Tools en Linux o Windows
...
Para montar el disco de VMware Tools desde el cliente web Vsphere, haga clic derecho en la MV, luego en <code className="action">Guest OS</code> y, por último, en <code className="action">Install VMware Tools</code>.
