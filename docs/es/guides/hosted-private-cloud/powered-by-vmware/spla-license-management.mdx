...
The <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> now includes a new feature, which allows you to:
...
- You must have activated the **Windows licences** in your <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>. See the "Windows Licence" section of our guide "[Introduction to the Hosted Private Cloud Control Panel](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud)" for more information.
...
If you bring your own licence (BYOL), you do not need to activate anything in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>.
...
<img className="thumbnail" alt="Licence overview" src="/images/hosted-private-cloud/powered-by-vmware/spla-license-management/licence-visibility-EN-b.png" loading="lazy" />

:::info
Activating the licence in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> is only required if you want OVHcloud to provide a Windows SPLA licence for the VM.
...
:::info
Virtual machines deployed from [VMware content libraries](/guides/hosted-private-cloud/powered-by-vmware/how-to-use-content-library) are automatically attached to a corresponding Windows licence.
...
For specialised services (SEO, development, etc.), contact [OVHcloud partners](https://partner.ovhcloud.com/es-es/directory/).
 
If you would like assistance using and configuring your OVHcloud solutions, please refer to our [support offers](https://www.ovhcloud.com/es-es/support-levels/).
