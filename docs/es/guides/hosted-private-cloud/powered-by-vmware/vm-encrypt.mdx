---
title: Activar el cifrado de máquinas virtuales (VM Encryption) (EN)
description: Esta guía explica cómo activar el cifrado de sus máquinas virtuales.
...
- You need to have signed up to a [Hosted Private Cloud](https://www.ovhcloud.com/es-es/hosted-private-cloud/vmware/) offer.
