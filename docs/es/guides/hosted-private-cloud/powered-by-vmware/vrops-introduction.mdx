...
- A user account with access to vSphere and vROPS (created in the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>)
...
<img className="thumbnail" alt="vROPS access" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en01logpage.png" loading="lazy" />

Use your vSphere login or the vROPS local user that you own.

<img className="thumbnail" alt="vROPS access" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en02log.png" loading="lazy" />

You are now on the vROPS Home page with access to all its functionalities.

<img className="thumbnail" alt="vROPS home page" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en03home.png" loading="lazy" />

### Data Sources

The Data Sources section lists the different spaces monitored by vROPS. By default, your OVHcloud infrastructure is added.

<img className="thumbnail" alt="Data sources" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en04datasources.png" loading="lazy" />
...
<img className="thumbnail" alt="environments section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en05environment.png" loading="lazy" />
...
<img className="thumbnail" alt="Visualize section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en06dashboards.png" loading="lazy" />
...
<img className="thumbnail" alt="custom dashboard" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en06dashboardsb.png" loading="lazy" />
...
<img className="thumbnail" alt="troubleshoot section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en07troubleshoot.png" loading="lazy" />
...
<img className="thumbnail" alt="optimize section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en08optimize.png" loading="lazy" />
...
<img className="thumbnail" alt="plan section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en09plan.png" loading="lazy" />
...
<img className="thumbnail" alt="configure section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en10configure.png" loading="lazy" />
...
<img className="thumbnail" alt="automation section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en11automation.png" loading="lazy" />
...
<img className="thumbnail" alt="administration section" src="/images/hosted-private-cloud/powered-by-vmware/vrops-introduction/en12administration.png" loading="lazy" />
