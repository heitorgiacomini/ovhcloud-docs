...
description: Learn how to migrate your on-prem VMware workloads to an OVHcloud Hosted Private Cloud SecNumCloud environment using Veeam Replication
...
- For internet-facing services, request additional public IPs or use the [BYOIP feature](https://www.ovhcloud.com/es-es/network/byoip/).
...
- Follow the [dedicated guide](/guides/hosted-private-cloud/powered-by-vmware/authorise-ip-vcenter-access) to whitelist the IP addresses of your source infrastructure and Veeam components.
- To enable access without triggering 2FA on Veeam components, refer to the *Application access permission* section of [this guide](/guides/hosted-private-cloud/powered-by-vmware/use-2fa).
...
To learn how to set up local users and activate two-factor authentication, follow [this documentation](/guides/hosted-private-cloud/powered-by-vmware/interface-secure).
...
To get started with NSX-T in your HPC, refer to the [NSX first steps guide](/guides/hosted-private-cloud/powered-by-vmware/nsx-first-steps).
...
For step-by-step instructions on how to install and configure Veeam in the cloud, follow [this official guide](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/veeam-veeam-backup-replication).
...
- [Configure IPsec VPN with NSX](/guides/hosted-private-cloud/powered-by-vmware/nsx-configure-ipsec)
...
If you need higher performance and lower latency, you can optionally use [OVHcloud Connect](https://www.ovhcloud.com/es-es/network/ovhcloud-connect/).

:::warning
SNC environments require SPNs (Security Provider Names). Learn more in [this connectivity guide](/guides/hosted-private-cloud/powered-by-vmware/snc-connectivity-concepts-vpn-spn).
:::
...
Learn more in the [Storage vMotion guide](/guides/hosted-private-cloud/powered-by-vmware/storage-vmotion).
...
Follow the steps in our [dedicated backup guide](/guides/storage-and-backup/object-storage/s3-veeam).
