...
description: Cómo reregistrar máquinas virtuales en un nuevo servicio desde datastores antiguos
...
En su [interfaz vSphere](/guides/hosted-private-cloud/powered-by-vmware/vsphere-interface-connexion), sitúese en la vista <code className="action">Almacenamiento</code>.

<img className="thumbnail" alt="vista de almacenamiento" src="/images/hosted-private-cloud/powered-by-vmware/vmware-register-vmx/register-vmx-01.png" loading="lazy" />

Seleccione un datastore de la lista.

<img className="thumbnail" alt="seleccionar datastore" src="/images/hosted-private-cloud/powered-by-vmware/vmware-register-vmx/register-vmx-02.png" loading="lazy" />

En las carpetas de este datastore, seleccione el archivo `.vmx` y haga clic en <code className="action">Register VM</code>.
...
Introduzca la información solicitada y haga clic en <code className="action">Finish</code>
...
Compruebe los parámetros de sus MV (nombre, [portgroup](/guides/hosted-private-cloud/powered-by-vmware/create-vlan), etc.) haciendo clic derecho sobre cada una de ellas y seleccionando <code className="action">Edit Settings</code>.

<img className="thumbnail" alt="modificar parámetros" src="/images/hosted-private-cloud/powered-by-vmware/vmware-register-vmx/register-vmx-06.png" loading="lazy" />

Si se produce un error en la configuración, se mostrará un mensaje de error al reiniciar la máquina virtual.

Para encender una máquina virtual, haga clic derecho sobre ella y seleccione <code className="action">Power On.</code>
