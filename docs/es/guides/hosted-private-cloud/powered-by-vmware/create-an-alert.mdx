...
<img className="thumbnail" alt="Crear una alerta" src="/images/hosted-private-cloud/powered-by-vmware/create-an-alert/alarms01.png" loading="lazy" />
...
<img className="thumbnail" alt="Nombre y objetivo de la alerta" src="/images/hosted-private-cloud/powered-by-vmware/create-an-alert/alarms02.png" loading="lazy" />
...
<img className="thumbnail" alt="Reglas de la alerta" src="/images/hosted-private-cloud/powered-by-vmware/create-an-alert/alarms03.png" loading="lazy" />
...
<img className="thumbnail" alt="Interrupción de la alerta" src="/images/hosted-private-cloud/powered-by-vmware/create-an-alert/alarms04.png" loading="lazy" />
...
<img className="thumbnail" alt="Resumen de la alerta" src="/images/hosted-private-cloud/powered-by-vmware/create-an-alert/alarms05.png" loading="lazy" />
