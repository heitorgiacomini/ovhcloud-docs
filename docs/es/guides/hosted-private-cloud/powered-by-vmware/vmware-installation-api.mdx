...
description: Instrumentación y uso del conjunto de librerías vSphere SDK
...
En esta guía, utilizaremos una máquina virtual instalada en Debian 9, instrumentada a partir de [las plantillas disponibles en su Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
En esta guía, utilizaremos una máquina virtual instalada en Debian 18.04, instrumentada a partir de [las plantillas disponibles en su Private Cloud](/guides/hosted-private-cloud/powered-by-vmware/ovf-template).
...
Una vez leídas las condiciones, acéptelas para continuar, haciendo clic en <code className="action">«Aceptar»</code>.

Al final de la instalación, se instalarán otros módulos. Haga clic en <code className="action">«Aceptar»</code> para continuar con la instalación.
