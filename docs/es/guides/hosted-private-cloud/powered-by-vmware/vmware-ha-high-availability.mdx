...
description: Gestionar la política de reinicio con la función HA
...
Haga clic en <code className="action">Editar</code> y marque la casilla para activar la funcionalidad HA.
...
<img className="thumbnail" alt="activación HA" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HA.png" loading="lazy" />
...
<img className="thumbnail" alt="Fallo del host" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam1.PNG" loading="lazy" />
...
<img className="thumbnail" alt="aislamiento del host" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam2.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Almacén de datos con PDL" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam3.PNG" loading="lazy" />
...
<img className="thumbnail" alt="Almacén de datos con APD" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam4.PNG" loading="lazy" />

##### Supervisión de las MV

La supervisión de las máquinas virtuales está disponible después de instalar las [VMware tools](/guides/hosted-private-cloud/powered-by-vmware/vmware-tools-install).
...
<img className="thumbnail" alt="Supervisión de las MV" src="/images/hosted-private-cloud/powered-by-vmware/vmware-ha-high-availability/HAparam5.PNG" loading="lazy" />
