...
description: Cómo implementar una solución de elusión con el mecanismo VMware DRS
...
- Activar la opción [Veeam Backup Managed](https://www.ovhcloud.com/es-es/enterprise/products/hosted-private-cloud/veeam-backup-managed/).
...
Para implementar esta solución, abra la pestaña <code className="action">Configure</code> y haga clic en el cluster correspondiente. A continuación, abra la pestaña <code className="action">VM/Host Rules</code>.
