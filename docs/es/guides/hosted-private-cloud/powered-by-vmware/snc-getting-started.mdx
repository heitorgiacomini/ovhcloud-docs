...
- You must have a [Hosted Private Cloud SecNumCloud solution](https://www.ovhcloud.com/es-es/hosted-private-cloud/vmware/).
...
- [Authorize IPs to connect to vCenter](/guides/hosted-private-cloud/powered-by-vmware/authorise-ip-vcenter-access)
...
Please refer to our [Introduction to the OVHcloud Hosted Private Cloud Control Panel](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud) guide.
...
<img className="thumbnail" alt="Password lost" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_0.png" loading="lazy" />
...
<img className="thumbnail" alt="Launching the process" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_1.png" loading="lazy" />
...
<img className="thumbnail" alt="User information" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_2.png" loading="lazy" />
...
<img className="thumbnail" alt="User information" src="/images/hosted-private-cloud/powered-by-vmware/snc-getting-started/vsphere_secnumcloud_3.png" loading="lazy" />
...
- [Validate an operation with a token](/guides/hosted-private-cloud/powered-by-vmware/interface-secure#confirm-an-operation-with-a-token)
...
- [Setting up an IPsec tunnel with NSX](/guides/hosted-private-cloud/powered-by-vmware/nsx-configure-ipsec)
...
- [Enable Private Gateway](/guides/hosted-private-cloud/powered-by-vmware/gateway)
...
- [Enabling VM Encryption](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt)
