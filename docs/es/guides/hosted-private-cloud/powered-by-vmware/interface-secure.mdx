...
Es posible asignárselo también a otros usuarios desde el área de cliente de OVHcloud. Para ello, consulte la guía [Presentación del área de cliente del Private Cloud de OVHcloud](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#usuarios).
...
<img className="thumbnail" alt="Primer SMS" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/SMS1.png" loading="lazy" />
...
- Una URL que le permitirá confirmar la operación (atención: si su teléfono no está conectado a una red [cuya IP haya sido autorizada](/guides/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud#seguridad), la página no se cargará).
...
<img className="thumbnail" alt="Confirmación de la operación" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationValidation.png" loading="lazy" />
...
<img className="thumbnail" alt="Token de operación" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/operationIdAndToken.png" loading="lazy" />
...
<img className="thumbnail" alt="Cambiar la contraseña" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/changePassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Establecer la contraseña" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/defineNewPassword.png" loading="lazy" />
...
<img className="thumbnail" alt="Contraseña perdida" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/passwordLost.png" loading="lazy" />
...
<img className="thumbnail" alt="Datos del usuario" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/infoUser.png" loading="lazy" />
...
<img className="thumbnail" alt="Token y contraseña" src="/images/hosted-private-cloud/powered-by-vmware/interface-secure/tokenAndPassword.png" loading="lazy" />
