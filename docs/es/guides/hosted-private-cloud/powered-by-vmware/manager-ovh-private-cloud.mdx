...
- Estar conectado al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, en la sección <code className="action">Servidor</code>, y dentro, en <code className="action">Private Cloud</code>.
...
Una vez en la sección <code className="action">Servidor</code> del <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>, haga clic en <code className="action">Private Cloud</code> y aparecerá la información general de su Private Cloud.

<img className="thumbnail" alt="Información general" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel1.png" loading="lazy" />
...
<img className="thumbnail" alt="Información general" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel2.png" loading="lazy" />
...
<img className="thumbnail" alt="Opciones" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel3.png" loading="lazy" />
...
<img className="thumbnail" alt="Opciones" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel4.png" loading="lazy" />

Si desea más información sobre la cancelación del servicio Private Cloud, consulte nuestra guía [Cómo dar de baja el servicio Private Cloud](/guides/account-and-service-management/managing-billing-payments-and-services/cancel-private-cloud).

#### Datacenters

En esta pestaña aparece un resumen de los datacenters virtuales del servicio Private Cloud:

<img className="thumbnail" alt="Datacenters" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel5.png" loading="lazy" />
...
<img className="thumbnail" alt="Usuarios" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel6.png" loading="lazy" />
...
<img className="thumbnail" alt="Permisos de usuario por datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel7.png" loading="lazy" />
...
<img className="thumbnail" alt="Configuración de seguridad" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel8.png" loading="lazy" />
...
Podrá encontrar más información al respecto en [esta guía](/guides/hosted-private-cloud/powered-by-vmware/vm-encrypt).

#### Operaciones

En esta pestaña, aparecen las operaciones en curso en su infraestructura:

<img className="thumbnail" alt="Operaciones" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel9.png" loading="lazy" />
...
<img className="thumbnail" alt="Licencia SPLA Windows" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel10.png" loading="lazy" />
...
<img className="thumbnail" alt="Visualización del Datacenter" src="/images/hosted-private-cloud/powered-by-vmware/manager-ovh-private-cloud/controlpanel11.png" loading="lazy" />
...
Si desea más información sobre esta opción, puede consultar esta [guía](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service).
