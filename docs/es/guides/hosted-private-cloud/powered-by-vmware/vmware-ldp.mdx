...
description: Find out how to subscribe and enable log forwarder in order to transfer VMware on OVHcloud logs to a Logs Data Platform stream
...
- An a <ManagerLink to="/">OVHcloud customer account</ManagerLink>.
- A [VMware on OVHcloud](https://www.ovhcloud.com/es-es/hosted-private-cloud/vmware/) environnement with a Logs Data Platform active stream. 
...
- You must have followed the guide [Introduction to Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/introduction).
...
For more information on the Logs Data Platform technical specifications (ports, protocols, etc.), read the guide [Quick start for Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).
...
:::info
If you are not familiar with using the OVHcloud APIv6, please refer to our guide on [Getting started with the OVHcloud API](/guides/manage-and-operate/api/first-steps).
...
<Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/securityOptions/compatibilityMatrix"} />
...
Your logs are manipulated for security and observability purposes in the Logs Data Platform private clusters. For more information on LDP pricing, please visit the LDP page available via [this link](https://www.ovhcloud.com/es-es/identity-security-operations/logs-data-platform/).
...
You can refer to this guide to find out how to create a stream via the Logs Data Platform interface: [Quick start for Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).
...
<Api version="v1" section="/dbaas/logs" method="POST" route={"/dbaas/logs/\{serviceName\}/output/graylog/stream"} />
...
You can refer to the [Logs Data Platform documentation](/guides/manage-and-operate/observability/logs-data-platform/getting-started-responsibility-model) for more information on the levels of security and responsibilities available.
...
To retrieve the **streamId** from your LDP account, please refer to the guide [Quick start for Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).

<Api version="v1" section="/dedicatedCloud" method="POST" route={"/dedicatedCloud/\{serviceName\}/log/subscription"} />
...
:::info
If you want to know all the services and features offered by Log Data Platform, go to the dedicated page via [this link](https://www.ovhcloud.com/es-es/identity-security-operations/logs-data-platform/).

:::


You can manage your LDP streams using the OVHcloud API, or using the <code className="action">Bare Metal</code> > <code className="action">Logs Data Platform</code> section of the OVHcloud Control Panel, or via the Graylog UI and the OpenSearch UI.

#### Via the OVHcloud Control Panel

You can refer to this guide to find out how to manage your streams in the <code className="action">Log Data Platform</code> section of the OVHcloud Control Panel: [Quick start for Logs Data Platform](/guides/manage-and-operate/observability/logs-data-platform/getting-started-quick-start).

#### Via the OVHcloud API

**How do I get the `subscriptionId`**?

<Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/log/subscription"} />
...
<Api version="v1" section="/dedicatedCloud" method="GET" route={"/dedicatedCloud/\{serviceName\}/log/kind/\{name\}"} />
...
<Api version="v1" section="/dedicatedCloud" method="DELETE" route={"/dedicatedCloud/\{serviceName\}/log/subscription/\{subscriptionId\}"} />
...
- **Logs Data Platform:** Logs Management Platform, fully managed and secured by OVHcloud. For more information, see [the LDP Solution Overview page](https://www.ovhcloud.com/es-es/identity-security-operations/logs-data-platform/).
...
- [Logs Data Platform - Getting started documentation](/guides/manage-and-operate/observability/logs-data-platform/overview))
- [View your logs in a Grafana dashboard](/guides/manage-and-operate/observability/logs-data-platform/using-grafana-with-logs)
- [Use the "LDP Tail" cli to watch your logs live](/guides/manage-and-operate/observability/logs-data-platform/ldp-tail)
- [Push logs from Apache to LDP](/guides/manage-and-operate/observability/logs-data-platform/apache-logs)
