...
description: Funcionamiento de los snapshots de OVHcloud
...
* Disponer de una [infraestructura Private Cloud](https://www.ovhcloud.com/es/enterprise/products/hosted-private-cloud/) en su cuenta de OVHcloud.
...
Los archivos están presentes ahora. Solo tiene que añadir esta máquina al **inventario** haciendo clic en el archivo `.vmx` y seleccionando <code className="action">MV</code> en la parte superior.
...
Le recomendamos que utilice una solución de backup completa, como nuestro servicio [Veeam Backup](/guides/hosted-private-cloud/powered-by-vmware/veeam-backup-as-a-service) o cualquier otro sistema que realice un backup completo de sus máquinas virtuales.
