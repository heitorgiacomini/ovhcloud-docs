...
description: Find out how to get NSX node logs using the dedicated API and/or Bundle
lastUpdated: 2023-10-20
---

## Objective

NSX is a Software-Defined Networking (SDN) solution provided by VMware. OVHcloud is offering this service in place of NSX-V in its [VMware on OVHcloud](https://www.ovhcloud.com/es-es/hosted-private-cloud/vmware/) solution.
...
<img className="thumbnail" alt="Configuration rules for the Gateway Firewall" src="/images/hosted-private-cloud/powered-by-vmware/nsx-t-get-logs-by-api/01nsx-t_get_logs_by_api.png" loading="lazy" />

The rule settings are then available. Enable the <code className="action">logging</code> option that should switch to green.

<img className="thumbnail" alt="Activation of logs for the rule" src="/images/hosted-private-cloud/powered-by-vmware/nsx-t-get-logs-by-api/02nsx-t_get_logs_by_api.png" loading="lazy" />
...
<img className="thumbnail" alt="infos" src="/images/hosted-private-cloud/powered-by-vmware/nsx-t-get-logs-by-api/export-log-bundle.gif" loading="lazy" />
