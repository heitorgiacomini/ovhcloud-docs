...
description: Find out how to configure and manage a software RAID on an OpenStack Ironic node in OPCP
...
- Access to **[Configured OpenStack CLI](/guides/hosted-private-cloud/opcp/how-to-use-api-and-get-credentials)** with the required permissions (`clouds.yaml` or environment variables).
...
- [OPCP Guide - Node lifecycle](/guides/hosted-private-cloud/opcp/node-lifecycle)
