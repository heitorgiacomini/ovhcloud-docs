...
description: Cómo restaurar la contraseña de la cuenta de administrador de Windows en un VPS o una instancia de Public Cloud utilizando el modo de rescate de OVHcloud
...
- [Instancia Public Cloud](/guides/public-cloud/compute/put-an-instance-in-rescue-mode)

### Paso 2: Montar la partición del sistema

Conéctese al servidor por SSH. (Consulte nuestra [guía de introducción SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) si es necesario.)

También puede abrir una conexión al servidor utilizando [KVM (VPS)](/guides/bare-metal-cloud/virtual-private-servers/using-kvm-for-vps) o la [consola VNC (instancia de Public Cloud)](/guides/public-cloud/compute/first-steps-with-public-cloud-instance#accessvnc).
