...
Si ya tiene un VPS y desea instalar cPanel, puede reinstalar el VPS desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> a través de un [OS compatible con cPanel](https://www.ovhcloud.com/es-es/vps/os/).
