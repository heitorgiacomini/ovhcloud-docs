...
- Si el dominio es gestionado por OVHcloud como agente registrador **y** utiliza los servidores DNS de OVHcloud, añada el registro TXT en la sección <code className="action">Web Cloud</code> de su <ManagerLink to="/">Panel de configuración de OVHcloud</ManagerLink>. Siga las indicaciones que le indicamos en la guía [Editar una zona DNS](/guides/web-cloud/domains/dns-zone-edit) si no está familiarizado con este proceso.
