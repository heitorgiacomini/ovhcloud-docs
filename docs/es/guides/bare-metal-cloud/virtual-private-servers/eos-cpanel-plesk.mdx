...
description: Descubra las fechas de finalización del soporte de los sistemas operativos de su VPS OVHcloud que afectan a las licencias Plesk y cPanel
...
- Tener un producto [VPS](https://www.ovhcloud.com/es-es/vps/) con un [distribution compatible](https://www.ovhcloud.com/es-es/vps/os/).
...
En la pestaña <code className="action">Inicio</code>, consulte los detalles de su sistema operativo en la sección `SO/Distribution` del recuadro `Su VPS`.
...
1. [Haga una copia de seguridad de sus datos](/guides/bare-metal-cloud/virtual-private-servers/using-automated-backups-on-a-vps) (contenido web, base de datos, correo electrónico, etc.).
2. Reinstale un SO compatible desde el área de cliente de OVHcloud, tal y como se indica en la sección `Reinstalar su VPS` de nuestra guía [Primeros pasos con un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
3. [Reinstale cPanel](/guides/bare-metal-cloud/virtual-private-servers/cpanel) o Plesk en el nuevo sistema.
...
Contrate un nuevo VPS con un SO compatible si aún no lo ha hecho. [Instale cPanel](/guides/bare-metal-cloud/virtual-private-servers/cpanel) o Plesk.
...
Para conocer las fechas de fin de vida y de fin de soporte de las imágenes y los sistemas operativos (VPS & Public Cloud), consulte nuestro guía "[Public Cloud & VPS - Ciclo de vida y anuncios de fin de vida y soporte de imágenes y distribuciones](/guides/public-cloud/compute/image-life-cycle)".
