...
description: Cómo desplegar aplicaciones preinstaladas en un VPS
...
Instale <ManagerLink to="/">la aplicación que desee desde el área de cliente de OVHcloud</ManagerLink> o las API de OVHcloud. También puede consultar nuestra guía [Primeros pasos con un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
...
Interactúe con nuestra comunidad de usuarios en [https://community.ovh.com/en/](https://community.ovhcloud.com/community/en).