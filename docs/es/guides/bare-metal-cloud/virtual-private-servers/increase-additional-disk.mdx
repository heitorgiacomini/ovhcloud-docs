...
- Un [disco adicional](/guides/bare-metal-cloud/virtual-private-servers/config-additional-disk) configurado en el VPS.
...
Los pasos que se indican a continuación suponen que ha configurado un disco adicional siguiendo las instrucciones de [esta guía](/guides/bare-metal-cloud/virtual-private-servers/config-additional-disk).

### Cambiar el tamaño del disco <a name="extend"></a>

En la pestaña <code className="action">Inicio</code>, en la sección **Su configuración**, haga clic en <code className="action">...</code> junto a la opción `Discos adicionales` y seleccione <code className="action">Aumentar el tamaño del disco</code>.
...
Seleccione el nuevo tamaño de disco en la ventana que aparece y haga clic en <code className="action">Aumentar</code>.
...
El aumento de la capacidad del disco tardará unos minutos después de la validación del pago. Puede consultar el progreso en la pestaña <code className="action">Discos adicionales</code>: si se muestra el nuevo tamaño seleccionado, el disco está listo.
...
Una vez que se haya conectado, haga clic derecho en el botón <code className="action">Menú Iniciar</code> y abra <code className="action">Gestión de discos</code>.
...
El [disco ampliado](#extend) muestra la capacidad adicional en forma de espacio no asignado. Haga clic derecho en el volumen de su disco adicional y seleccione <code className="action">Ampliar el volumen</code> en el menú contextual.
...
Si lo necesita, podrá modificar el espacio en disco. Haga clic en <code className="action">Siguiente</code>.
