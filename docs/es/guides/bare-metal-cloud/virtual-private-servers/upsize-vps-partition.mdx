...
description: Cómo aumentar el espacio en disco útil después de una actualización
...
- Haber reiniciado el servidor en [modo de rescate](/guides/bare-metal-cloud/virtual-private-servers/rescue) (solo Linux).
...
Si el VPS todavía no está en modo de rescate, actívelo gracias a [nuestra guía](/guides/bare-metal-cloud/virtual-private-servers/rescue).
...
- **bad magic number in superblock**: No continúe. Para solucionar este problema, consulte el apartado [Cómo solucionar los errores «bad magic number in superblock»](/guides/bare-metal-cloud/virtual-private-servers/upsize-vps-partition#como-solucionar-los-errores-bad-magic-number-in-superblock) de esta guía.
...
Haga clic derecho en C: y seleccione <code className="action">Extend Volume...</code>.
...
Escriba el tamaño deseado y haga clic en <code className="action">Aceptar</code>. El volumen se ampliará.
