...
description: Descubra cómo instalar un certificado SSL en un VPS de OVHcloud
...
- Tener un producto [VPS](https://www.ovhcloud.com/es-es/vps/)
...
1. Descargue un cliente SSH como [PuTTY](/guides/web-cloud/web-hosting/ssh-using-putty-on-windows) o utilice el terminal integrado de su sistema operativo.
