...
<br/>Se recomienda pedir un nuevo VPS o reinstalar uno existente desde su <ManagerLink to="/">Panel de configuración de OVHcloud</ManagerLink>, utilizando la última versión disponible de Ubuntu o Debian. Si es necesario, consulte nuestra guía "[Primeros pasos](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps#reinstallvps)". 
