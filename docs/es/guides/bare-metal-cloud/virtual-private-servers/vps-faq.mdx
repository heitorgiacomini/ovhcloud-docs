...
- `serviceName`: Introduce el nombre interno de tu licencia (ver la sección `Licencias` en tu <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>).
...
- Descarga mediante SFTP: Conéctate a tu VPS con un cliente de software capaz de SFTP (por ejemplo [FileZilla](/guides/bare-metal-cloud/dedicated-servers/transfer-data-via-sftp)), y luego transfiere todos los archivos en el directorio raíz del sistema.
