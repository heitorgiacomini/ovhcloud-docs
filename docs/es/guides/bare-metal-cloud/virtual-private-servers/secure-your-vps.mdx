...
description: Esta guía explica cómo aplicar medidas de seguridad básicas para proteger su VPS de ataques y accesos no autorizados
...
Si se trata de su primera configuración de un VPS de OVHcloud, consulte nuestra guía [Primeros pasos con un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps).
:::


Los siguientes ejemplos implican que está conectado como [usuario con permisos muy exigentes](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
### Crear y utilizar una clave SSH <a name="sshkey"></a>

La autenticación mediante clave SSH es uno de los métodos más eficaces para garantizar la seguridad del acceso a su VPS.<br/>
...
- [Cómo crear y utilizar claves de autenticación para conexiones SSH a los servidores OVHcloud](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)
...
Recuerde que deberá indicar el nuevo puerto en cada solicitud de [conexión SSH al servidor](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction):
...
Si no puede acceder a su sistema, puede utilizar nuestro entorno [modo de rescate](/guides/bare-metal-cloud/virtual-private-servers/rescue) para cancelar los cambios.

### Crear un usuario con permisos restringidos <a name="createuser"></a>

Por lo general, las tareas que no requieran privilegios root deben realizarse a través de un usuario estándar. Para más información, consulte [esta guía](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).

### Configurar el firewall interno (iptables) <a name="iptables"></a>
...
Para más información sobre iptables, consulte nuestra [guía dedicada](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable).
...
### Instalar Fail2ban <a name="fail2ban"></a>
...
### Configuración del firewall de red de OVHcloud <a name="networkfirewall"></a>
...
Para activarlo, consulte la guía [Configurar el firewall de red](/guides/bare-metal-cloud/dedicated-servers/firewall-network).

### Guardar copia de seguridad del sistema y los datos <a name="backup"></a>
...
En la [página de producto](https://www.ovhcloud.com/es-es/vps/options/) y en las [respectivas guías](/guides/bare-metal-cloud/virtual-private-servers/overview) encontrará toda la información sobre las soluciones de backup disponibles para su servicio.

## Más información

[Primeros pasos con un VPS](/guides/bare-metal-cloud/virtual-private-servers/starting-with-a-vps) 

[Crear claves SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Configurar el firewall de Windows](/guides/bare-metal-cloud/virtual-private-servers/activate-port-firewall-soft-win)

[Configurar el firewall de Linux con iptables](/guides/bare-metal-cloud/virtual-private-servers/firewall-linux-iptable)
