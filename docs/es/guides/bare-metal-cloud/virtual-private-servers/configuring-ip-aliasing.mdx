...
description: Cómo añadir direcciones Additional IP a su configuración VPS
...
:::warning
Las direcciones Additional IP no están disponibles actualmente para los servidores virtuales en las [Local Zones](https://www.ovhcloud.com/es-es/lp/vps-localzone/).
:::
...
<Tabs>
  ...
  <Tab label="cPanel">
    ...
    **1\. acceder a la sección de gestión de las IP del WHM**
    ...
    En el área de cliente de WHM, haga clic en <code className="action">IP Functions</code> y seleccione <code className="action">Add a New IP Address</code> en el menú de la izquierda.
    ...
    **3\. comprobar la configuración IP actual**
    ...
    Vuelva a la sección <code className="action">IP Functions</code> y haga clic en <code className="action">Show or Delete Current IP Addresses</code> para comprobar que la dirección Additional IP se ha añadido correctamente.
  ...
  <Tab label="Plesk">
    ...
    **1\. acceder a la gestión de IP de Plesk**
    ...
    <img className="thumbnail" alt="acceso a la gestión de las direcciones IP" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/pleskip1.png" loading="lazy" />
    
    Haga clic en <code className="action">IP Addresses</code> bajo **Tools & Settings**.
    
    **2\. añadir la información IP adicional**
    
    En esta sección, haga clic en el botón <code className="action">Add IP Address</code>.
    
    <img className="thumbnail" alt="añadir información IP" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/Plesk-2024-vps.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="añadir información IP" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/Plesk-additional-ip.png" loading="lazy" />
  ...
  <Tab label="**Windows Server**">
    ...
    **1\. comprobar la configuración de red**
    ...
    Haga clic derecho en el botón <code className="action">Start</code> y abra <code className="action">Run</code>.
    
    Pulse `cmd` y haga clic en <code className="action">OK</code> para abrir la aplicación de línea de órdenes.
    ...
    **2\. modificar las propiedades IPv4**
    ...
    1. Vaya al menú <code className="action">Start</code>, luego <code className="action">Control Panel</code>, <code className="action">Network and Internet</code>, <code className="action">Network and Sharing Centre</code> y <code className="action">Change Adapter Settings</code> en la barra de la izquierda.
    2. Haga clic derecho en <code className="action">Ethernet</code>;
    3. Haga clic en <code className="action">Properties</code>;
    4. Seleccione <code className="action">Internet Protocol Version 4 (TCP/IPv4)</code> y haga clic en <code className="action">Properties</code>;
    5. Haga clic en <code className="action">Use the following IP address</code> e introduzca la IP principal del servidor, la máscara de subred y la puerta de enlace por defecto obtenidas con el comando <code className="action">ipconfig</code> anterior. En el cuadro "Preferred DNS Server", escriba `213.186.33.99`.
    ...
    **3\. añadir la dirección Additional IP en los Parámetros TCP/IP avanzados**
    ...
    En la nueva ventana, haga clic en <code className="action">Add...</code> en "IP addresses". Introduzca su dirección Additional IP y la máscara de subred (255.255.255.255).
    
    <img className="thumbnail" alt="sección de configuración avanzada" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/configure-additional-ip.png" loading="lazy" />
    
    Confirme haciendo clic en <code className="action">Add</code>.
    ...
    A continuación, haga clic en <code className="action">OK</code> para aplicar la configuración.
    
    <img className="thumbnail" alt="Configuración del cambio de IP" src="/images/bare-metal-cloud/virtual-private-servers/configuring-ip-aliasing/final-configuration.png" loading="lazy" />
