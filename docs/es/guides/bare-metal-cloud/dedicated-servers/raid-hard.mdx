...
description: Verifique el estado de su controlador RAID de hardware y monitorice la salud de los discos duros en su servidor dedicado de OVHcloud.
...
- a [dedicated server](https://www.ovhcloud.com/es-es/bare-metal/) with a hardware RAID configuration
