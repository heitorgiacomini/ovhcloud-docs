...
Para más información, consulte nuestra guía sobre la [seguridad de un servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/securing-a-dedicated-server).
...
Para más información sobre el acceso a esta herramienta, consulte [esta guía](/guides/bare-metal-cloud/dedicated-servers/ipmi).
:::
