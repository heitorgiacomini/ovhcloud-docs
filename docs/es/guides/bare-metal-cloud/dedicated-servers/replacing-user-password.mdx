...
description: Cómo configurar una nueva contraseña para una cuenta de usuario en un sistema operativo GNU/Linux con el modo de rescate de OVHcloud
...
:::info
Para consultar el acceso a un servidor al que se conecta con una llave SSH, consulte nuestra guía "[Cómo sustituir un par de llaves SSH](/guides/bare-metal-cloud/dedicated-servers/replacing-lost-ssh-key-pair)".
...
:::info
Esta guía no se aplica a las instalaciones de **Windows** Server. Consulte nuestras guías "[Cómo cambiar la contraseña de administrador en un servidor dedicado Windows](/guides/bare-metal-cloud/dedicated-servers/rcw-changing-admin-password-on-windows)" y "[Cómo cambiar la contraseña de administrador en un VPS Windows](/guides/bare-metal-cloud/virtual-private-servers/resetting-a-windows-password)".
...
- [Utilizar el modo de rescate en un servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
- [Utilizar el modo de rescate en un VPS](/guides/bare-metal-cloud/virtual-private-servers/rescue)
...
Recuerde utilizar el modo de arranque **normal** del servidor al reiniciarlo desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
[Crear y utilizar llaves SSH](/guides/bare-metal-cloud/dedicated-servers/creating-ssh-keys)

[Modo de rescate para un servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)

[Modo de rescate para un VPS](/guides/bare-metal-cloud/virtual-private-servers/rescue)
