...
Por supuesto, puede ir un paso más allá configurando el registro SPF para un dominio específico o utilizando la dirección IPv6. Para más información sobre el registro SPF, consulte nuestra guía sobre la [configuración de un registro SPF](/guides/web-cloud/domains/dns-zone-spf).
...
Para más información, consulte nuestra guía sobre la [configuración de un registro DKIM](/guides/web-cloud/domains/dns-zone-dkim).
...
Para más información, consulte nuestra guía sobre la [configuración de un registro DMARC](/guides/web-cloud/domains/dns-zone-dmarc).
...
Si sus servidores DNS son gestionados por OVHcloud, consulte nuestra guía sobre [la edición de una zona DNS en OVHcloud desde el área de cliente](/guides/web-cloud/domains/dns-zone-edit).

Una vez que haya editado la zona DNS del dominio, los cambios tardarán un máximo de 24 horas en propagarse.

Para configurar la ruta del registro DNS inverso en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, consulte [nuestra guía dedicada](/guides/bare-metal-cloud/virtual-private-servers/configuring-reverse-dns).
...
[Mejorar la seguridad del correo electrónico mediante un registro SPF](/guides/web-cloud/domains/dns-zone-spf)

[Mejorar la seguridad del correo electrónico mediante un registro DMARC](/guides/web-cloud/domains/dns-zone-dmarc)
