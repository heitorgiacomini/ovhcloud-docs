...
Las claves de acceso iniciales (identificador y contraseña) se envían por correo electrónico tras la instalación o la reinstalación del servidor desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
