...
description: Instale una clave SSH de OVHcloud en su servidor dedicado para conceder acceso administrativo seguro a los equipos de soporte de OVHcloud
...
- [Estar conectado por SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction) (acceso *root*).
