...
Descubra cómo configurar direcciones Additional IP en un vRack con nuestras guías para [IPv4](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack) y [IPv6](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack).
...
A continuación, <ManagerLink to="/">inicie sesión en su cuenta OVHcloud</ManagerLink>, haga clic en <code className="action">Network</code> en el menú situado a la izquierda de la pantalla y seleccione <code className="action">Direcciones IP públicas</code>.
