...
Fully automating OS installation or reinstallation on a [dedicated server](https://www.ovhcloud.com/es-es/bare-metal/) with the [OVHcloud API](/guides/manage-and-operate/api/first-steps) can be interesting in various situations.
...
You can list all your [dedicated servers](https://www.ovhcloud.com/es-es/bare-metal/) with the following API call:
