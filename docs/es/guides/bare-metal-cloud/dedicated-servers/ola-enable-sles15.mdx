...
- [Haber configurado su ID de cliente para la funcionalidad de OVHcloud Link Aggregation desde el área de cliente de OVHcloud](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager).
...
A continuación, abra la pestaña <code className="action">IPMI</code> (1) y haga clic en el botón <code className="action">Desde un applet Java (KVM)</code> (2).
...
[Configurar la agregación de enlaces OLA en el área de cliente](/guides/bare-metal-cloud/dedicated-servers/ola-enable-manager).

[Cómo configurar el ID de cliente para la agrupación de enlaces OVHcloud en Debian 9](/guides/bare-metal-cloud/dedicated-servers/ola-enable-debian9).

[Cómo configurar el ID de cliente para la agrupación de enlaces OVHcloud en Windows Server 2019](/guides/bare-metal-cloud/dedicated-servers/ola-enable-w2k19).
