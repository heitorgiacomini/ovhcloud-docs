...
description: Sustituya un disco defectuoso en un servidor dedicado en RAID por software sin interrupción gracias al procedimiento de hot-swap
...
- Tener contratado un servidor [mHG, HG o BHG](https://www.ovhcloud.com/es-es/bare-metal/high-grade/).
...
El disco dañado ya puede ser sustituido por un técnico del datacenter. Una vez realizada la intervención, solo tendrá que resincronizar el RAID. Para ello, consulte la guía [RAID por software](/guides/bare-metal-cloud/dedicated-servers/raid-soft).
...
A continuación, el disco dañado ya podrá ser sustituido por un técnico del datacenter. Una vez realizada la intervención, solo tendrá que resincronizar el RAID. Para ello, consulte la guía [RAID por software](/guides/bare-metal-cloud/dedicated-servers/raid-soft).
...
[RAID por hardware](/guides/bare-metal-cloud/dedicated-servers/raid-hard)
