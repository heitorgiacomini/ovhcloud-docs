...
description: Recupere el número de serie de un disco duro en su servidor dedicado para identificarlo durante una solicitud de sustitución
...
:::info
Si se trata de un disco NVMe, será necesario poner el servidor en [modo de rescate](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) y utilizar la herramienta **nvme-cli**, instalada por defecto.
:::
...
Para más información sobre estos comandos y sobre cómo probar los discos duros, consulte nuestra guía [RAID por hardware](/guides/bare-metal-cloud/dedicated-servers/raid-hard).
...
Para determinar qué periférico sg corresponde a cada disco duro, consulte nuestra guía [RAID por hardware](/guides/bare-metal-cloud/dedicated-servers/raid-hard).
