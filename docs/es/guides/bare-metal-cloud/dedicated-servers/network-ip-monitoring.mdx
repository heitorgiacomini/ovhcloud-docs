...
En primer lugar, conéctese al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> y abra la pestaña <code className="action">Bare Metal Cloud</code>. Seleccione el servidor correspondiente en el menú desplegable <code className="action">Servidores dedicados</code>.
