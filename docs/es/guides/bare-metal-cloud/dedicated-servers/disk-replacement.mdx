...
description: Identifique un disco defectuoso en su servidor dedicado OVHcloud y solicite su sustitución a través del área de cliente
...
Si tiene un servidor con RAID por software, consulte la guía [RAID por software](/guides/bare-metal-cloud/dedicated-servers/raid-soft) para identificar los discos instalados en su servidor.
...
Si tiene un servidor con RAID por hardware, consulte la guía [RAID por hardware](/guides/bare-metal-cloud/dedicated-servers/raid-hard) y siga el procedimiento correspondiente a su tipo de controlador RAID para conocer la ruta de acceso a los discos.
...
Si se trata de un disco NVMe, será necesario poner el servidor en [modo de rescate](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) e instalar la herramienta `nvme-cli`.
...
:::info
Este tipo de sustitución solo es posible para los [servidores dedicados](https://www.ovhcloud.com/es-es/bare-metal/) con una tarjeta RAID.
:::
...
Si tiene un servidor con RAID por software, deberá reconstruir el RAID usted mismo. Para ello, no dude en consultar la guía [RAID por software](/guides/bare-metal-cloud/dedicated-servers/raid-soft).
...
[Modo de rescate](/guides/bare-metal-cloud/dedicated-servers/rescue-mode)
