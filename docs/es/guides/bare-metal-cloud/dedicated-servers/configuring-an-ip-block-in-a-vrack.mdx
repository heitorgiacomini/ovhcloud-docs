...
<img className="thumbnail" alt="verificar la segunda interfaz de red" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-1.png" loading="lazy" />
...
<img className="thumbnail" alt="desactivar red" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-6.png" loading="lazy" />

Luego realizamos el proceso de activación:

<img className="thumbnail" alt="activar red" src="/images/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack/win-ip-vrack-7.png" loading="lazy" />
