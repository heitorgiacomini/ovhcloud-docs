...
<Tabs>
  <Tab label="Desde el área de cliente">
    Conéctese al <ManagerLink to="/">Panel de configuración de OVHcloud</ManagerLink>, acceda a la sección <code className="action">Bare Metal Cloud</code> y seleccione el servidor en la sección <code className="action">Servidores dedicados</code>.
...
:::info
Para todos los sistemas operativos y distribuciones, debe configurar su máquina virtual con la dirección MAC virtual creada en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
