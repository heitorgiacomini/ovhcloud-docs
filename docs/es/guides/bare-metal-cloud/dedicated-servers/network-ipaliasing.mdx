...
:::info
Este artículo explica cómo configurar direcciones Additional IPv4 en una interfaz pública. También puede configurar direcciones IPv6 en sus servidores dedicados utilizando [esta guía](/guides/bare-metal-cloud/dedicated-servers/network-ipv6).
...
Cómo configurar direcciones Additional IP en un vRack con nuestras guías para [IPv4](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack) y [IPv6](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack).
:::
...
- Tener una o más direcciones [Additional IP](https://www.ovhcloud.com/es-es/network/additional-ip/).
...
<Tabs>
  ...
  <Tab label="cPanel">
    ...
    **1. Acceder a la sección Gestión IP de WHM**
    ...
    En el área de cliente WHM, haga clic en <code className="action">IP Functions</code> y seleccione <code className="action">Add a New IP Address</code> en el menú de la izquierda.
    
    <img className="thumbnail" alt="Añadir una nueva dirección IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/Cpanel-1.png" loading="lazy" />
    ...
    **2. Añadir la información de las Direcciones IP**
    ...
    Seleccione `255.255.255.255` como máscara de subred y haga clic en <code className="action">Submit</code>.
    
    <img className="thumbnail" alt="Introduzca nueva información sobre la nueva dirección IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/Cpanel-2024.png" loading="lazy" />
    ...
    **3. Comprobar la configuración IP actual**
    ...
    En la sección <code className="action">IP Functions</code>, haga clic en <code className="action">Show or Delete Current IP Addresses</code> para comprobar que la dirección Additional IP se ha añadido correctamente.
    
    <img className="thumbnail" alt="check configurado por IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/Cpanel-2024-1.png" loading="lazy" />
  </Tab>
  <Tab label="Windows Server">
    ...
    <img className="thumbnail" alt="Respuesta del comando ipconfig" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/ipconfig.png" loading="lazy" />
    ...
    **Mediante línea de comandos (recomendado)**
    ...
    :::warning
    Atención: Si introduce información incorrecta, no será posible acceder al servidor. En ese caso, deberá realizar las correcciones oportunas en modo [WinRescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode#windows) o a través del [IPMI](/guides/bare-metal-cloud/dedicated-servers/ipmi).
    :::
    ...
    <details>
    <summary>**A través de la interfaz gráfica**</summary>

    
    1. Vaya a <code className="action">Start</code> > <code className="action">Control Panel</code> > <code className="action">Network and Internet</code> > <code className="action">Network and Sharing Centre</code>. En el menú izquierdo, seleccione <code className="action">Change Adapter Settings</code>.
    
    2. Haga clic derecho en su conexión de red, en el ejemplo <code className="action">Ethernet 2</code>.
    
    3. Haga clic en <code className="action">Properties</code>.
    
    4. Seleccione <code className="action">Internet Protocol Version 4 (TCP/IPv4)</code> y, a continuación, haga clic en el botón <code className="action">Properties</code>.
    
    5. Marque la opción <code className="action">Use the following IP address</code> e introduzca la IP principal del servidor, la máscara de subred y la puerta de enlace predeterminada obtenidas anteriormente con el comando `ipconfig`. En **Preferred DNS Server**, introduzca **213.186.33.99**.
    
    <img className="thumbnail" alt="Propiedades del protocolo de internet versión 4 (TCP/IPv4)" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/configure-main-ip.png" loading="lazy" />
    
    :::warning
    Atención: Si introduce información incorrecta, no será posible acceder al servidor. En ese caso, deberá realizar las correcciones oportunas en modo [WinRescue](/guides/bare-metal-cloud/dedicated-servers/rescue-mode#windows) o a través del [IPMI](/guides/bare-metal-cloud/dedicated-servers/ipmi).
    :::
    
    A continuación, haga clic en <code className="action">Advanced</code> (todavía en las <code className="action">TCP/IP Settings</code>).
    
    <img className="thumbnail" alt="Propiedades del protocolo de internet versión 4 (TCP/IPv4)" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/configure-main-ip-1.png" loading="lazy" />
    
    En la sección **IP Address**, haga clic en <code className="action">Add</code>.
    
    <img className="thumbnail" alt="Opciones avanzadas TCP/IPv4" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/add-additional-ip.png" loading="lazy" />
    
    Introduzca ahí su Additional IP y la máscara de subred **255.255.255.255**. Haga clic en <code className="action">Add</code>.
    
    <img className="thumbnail" alt="Dirección TCP/IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/configure-additional-ip.png" loading="lazy" />
    
    Haga clic en <code className="action">OK</code> para validar la configuración.
  ...
  <Tab label="Plesk">
    ...
    **1. Acceder a la gestión de IP de Plesk**
    ...
    <img className="thumbnail" alt="acceso a la gestión de las direcciones IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/pleskip1.png" loading="lazy" />
    ...
    **2. Añadir la información IP adicional**
    ...
    <img className="thumbnail" alt="añadir información IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/Plesk-2024.png" loading="lazy" />
    ...
    <img className="thumbnail" alt="añadir información IP" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/Plesk-2024-1.png" loading="lazy" />
    
    **3. Comprobar la configuración IP actual**
    
    En la sección "IP Addresses", compruebe que la dirección Additional IP se haya añadido correctamente.
    
    <img className="thumbnail" alt="configuración IP actual" src="/images/bare-metal-cloud/dedicated-servers/network-ipaliasing/Plesk-2024-2.png" loading="lazy" />
  </Tab>
</Tabs>
...
Si no consigue establecer una conexión entre la red pública y su alias IP y si tiene algún problema de red, reinicie el servidor en [modo de rescate](/guides/bare-metal-cloud/dedicated-servers/rescue-mode) y configure el alias directamente en el servidor.
...
[Modo Bridge IP](/guides/bare-metal-cloud/dedicated-servers/network-bridging)
