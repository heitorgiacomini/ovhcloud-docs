...
description: Ejecute diagnósticos de hardware en su servidor dedicado de OVHcloud en modo rescue para identificar fallos de disco, RAM o CPU.
...
- Haber reiniciado el servidor en [modo de rescate](/guides/bare-metal-cloud/dedicated-servers/rescue-mode).
