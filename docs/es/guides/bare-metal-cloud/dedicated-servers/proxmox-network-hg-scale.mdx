...
description: Cómo configurar la red en Proxmox VE
...
- An [OVHcloud dedicated server](https://www.ovhcloud.com/es-es/bare-metal/)
- One or more [Additional IP addresses](https://www.ovhcloud.com/es-es/network/additional-ip/)
...
* A [server compatible with vRack](https://www.ovhcloud.com/es-es/bare-metal/)
* A [vRack service](https://www.ovhcloud.com/es-es/network/vrack/)
