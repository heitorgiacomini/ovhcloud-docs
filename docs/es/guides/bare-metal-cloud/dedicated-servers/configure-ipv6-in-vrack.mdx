...
:::info
El vRack admite el enrutamiento público IPv4 e IPv6 con bloques de direcciones Additional IP. Puede encontrar las instrucciones para configurar bloques IPv4 en esta guía: [Configurar un bloque IP en el vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
...
- Un servicio [vRack](https://www.ovhcloud.com/es-es/network/vrack/) activo en su cuenta
- Un [servidor compatible con vRack](https://www.ovhcloud.com/es-es/network/vrack/) conectado a su red vRack
...
:::warning
Esta funcionalidad puede estar limitada o no disponible en los servidores de [la gama **Eco**](https://eco.ovhcloud.com/es-es/about/).

Consulte nuestra [página de comparación de servidores Eco](https://eco.ovhcloud.com/es-es/compare/) para obtener más información.
...
<summary>Solicitar un nuevo bloque Additional IPv6</summary>
...
<img className="thumbnail" alt="página de configuración" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/500.png" loading="lazy" />
...
<img className="thumbnail" alt="Configurar una IPv6 en un vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-03.png" loading="lazy" />
...
<summary>A través del área de cliente de OVHcloud</summary>


<img className="thumbnail" alt="gestión del vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/700.png" loading="lazy" />
...
<img className="thumbnail" alt="selección del vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/701.png" loading="lazy" />
...
<img className="thumbnail" alt="activar SLAAC" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/702.png" loading="lazy" />
...
<summary>A través de la APIv6 (método alternativo)</summary>
...
Por defecto, los bloques de Additional IP enrutados a través de un vRack disponen de un ancho de banda público estándar de 5 Gbps en Europa y América del Norte, o de 100 Mbps en las regiones APAC. Para más información sobre las opciones disponibles, consulte las opciones de enrutamiento público en nuestra [página del producto vRack](https://www.ovhcloud.com/es-es/network/vrack/).
...
<summary>Al contratar una Additional IP</summary>
...
- Conéctese al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
- Haga clic en el botón <code className="action">Contratar IPs</code> en la parte superior de la página.
...
- En la barra lateral izquierda del área de cliente, abra <code className="action">Network</code>.
- Seleccione <code className="action">Red privada vRack</code>.
- En la columna "IP pública y ancho de banda", haga clic en el botón <code className="action">Gestionar</code> correspondiente al vRack deseado.
...
- En el recuadro de la región correspondiente, haga clic en <code className="action">Modificar el ancho de banda</code>.
- Seleccione la opción deseada en el panel de la derecha y haga clic en <code className="action">Contratar</code> para validar.
...
<summary>Configuración IP estática</summary>
...
<summary>Configuración IP automática (SLAAC)</summary>
...
<img className="thumbnail" alt="Configurar una IPv6 en un vRack para el modo de enrutamiento" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/routed-mode-20240513.png" loading="lazy" />
...
Después de añadir la Additional IP a su vRack, puede gestionar la subred enrutada haciendo clic en el botón <code className="action">Añadir una subred</code>.

<img className="thumbnail" alt="selección vRack" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/600.png" loading="lazy" />
...
<img className="thumbnail" alt="continuar" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/800.png" loading="lazy" />

La subred enrutada `2001:41d0:abcd::ef10::/60` es accesible a través del siguiente salto `2001:41d0:abcd::ef00::2`.

<img className="thumbnail" alt="continuar" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/801.png" loading="lazy" />
...
<summary>Comandos APIv6</summary>
...
<img className="thumbnail" alt="continuar" src="/images/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack/20240418-02.png" loading="lazy" />
...
<summary>Configuración IP estática de un host (recomendado)</summary>
...
<summary>Configuración IP automática (SLAAC) para un host</summary>
...
<summary>Configuración de la subred enrutada en un host y dentro de una máquina virtual</summary>
...
<summary>Configuración de una subred enrutada dentro de una VM</summary>
...
<summary>Local, en un host</summary>
...
<summary>Local, en una VM</summary>
...
<summary>Desde un host remoto</summary>
