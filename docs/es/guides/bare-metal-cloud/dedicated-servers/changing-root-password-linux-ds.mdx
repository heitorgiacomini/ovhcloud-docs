...
description: Gestione las cuentas de usuario, el acceso sudo y la conexión root en un servidor dedicado GNU/Linux para una administración segura
...
Para más información, consulte nuestra guía "[Primeros pasos con SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)".
