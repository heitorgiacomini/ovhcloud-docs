...
- IPv4: [Configurar un bloque de IP en el vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack).
- IPv6: [Configurar un bloque IPv6 en un vRack (EN)](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack).
...
El propósito de esta guía es ayudarle, en la medida de lo posible, con las tareas generales. No obstante, póngase en contacto con un [proveedor especializado](https://partner.ovhcloud.com/es-es/directory/) y/o el editor de *software* del servicio si tiene dificultades. Nosotros no podremos ayudarle al respecto. Puede encontrar información adicional en la sección [«Más información»](#go-further) de esta guía.
...
- Tener conocimientos básicos de redes y de [SSH](/guides/bare-metal-cloud/dedicated-servers/ssh-introduction)
...
<Tabs>
  <Tab label="Desde el área de cliente">
    La pasarela IPv6 asignada a su servidor se muestra en la sección `Red` de la pestaña <code className="action">Información general</code>. Una vez copiado, continúe con la aplicación de configuración IPv6.
    
    <img className="thumbnail" alt="configureipv6" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_information.png" loading="lazy" />
  </Tab>
  <Tab label="A través de las API de OVHcloud">
    Otra forma de recuperar la información de red del servidor es [utilizar la API de OVHcloud](/guides/manage-and-operate/api/first-steps).
...
Como el ifcfg ya no está actualizado, NetworkManager ya no crea nuevos perfiles en este formato de forma predeterminada. El archivo de configuración se encuentra ahora en `/etc/NetworkManager/system-connections/`.
  ...
  <Tab label="Debian 12, Ubuntu 22.04 y posteriores">
  ...
  <Tab label="AlmaLinux (8/9) y Rocky Linux (8/9)">
  ...
  <Tab label="Windows Server 2019 y versiones posteriores">
    **1. Conéctese a su servidor por RDP**
    
    Más información en [esta guía](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).
    
    **2. Abrir la configuración de red de su servidor**
    
    Primero, haga clic derecho en el icono de red en el área de notificaciones para ir a la sección <code className="action">Red y recursos compartidos</code>.
    
    <img className="thumbnail" alt="Red y recursos compartidos" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_network_sharing_center.png" loading="lazy" />

Haga clic en <code className="action">Cambiar configuración del adaptador</code>.
    
    <img className="thumbnail" alt="Cambiar configuración del adaptador" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_change_adapter_settings.png" loading="lazy" />

Haga clic derecho en su adaptador de red, y seleccione <code className="action">Propiedades</code>.
    
    <img className="thumbnail" alt="Propiedades del adaptador de red" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_network_adapter_properties.png" loading="lazy" />

Seleccione <code className="action">Protocolo de internet versión 6</code>, y haga clic en <code className="action">Propiedades</code>.
    
    <img className="thumbnail" alt="Propiedades" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_properties.png" loading="lazy" />

**3. Modificar la configuración de red**
    
    Introduzca su configuración IPv6 (`IPv6 address` y `Default gateway`), marque la casilla `Validar los parámetros al salir` y haga clic en el botón <code className="action">OK</code> para aceptar los cambios.
    
    <img className="thumbnail" alt="Propiedades" src="/images/bare-metal-cloud/dedicated-servers/network-ipv6/ipv6_configuration.png" loading="lazy" />
  </Tab>
</Tabs>
...
En primer lugar, [ponga su servidor en modo de rescate](/guides/bare-metal-cloud/dedicated-servers/rescue-mode).
