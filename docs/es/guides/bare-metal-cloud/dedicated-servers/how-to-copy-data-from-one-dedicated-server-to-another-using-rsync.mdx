...
description: Copie fácilmente los datos de su servidor dedicado a otro gracias a rsync
...
Para más información, interactúe con nuestra comunidad de usuarios en [https://community.ovh.com/en/](https://community.ovh.com/en/).