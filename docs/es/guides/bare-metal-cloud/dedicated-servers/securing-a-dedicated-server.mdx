...
description: "Aplique las medidas de seguridad esenciales en su servidor dedicado: endurecimiento SSH, configuración del firewall y supervisión"
...
Si se trata de su primera configuración de un servidor dedicado de OVHcloud, consulte nuestra guía [Primeros pasos con un servidor dedicado](/guides/bare-metal-cloud/dedicated-servers/getting-started-with-dedicated-server).
:::
...
Para más información sobre iptables, consulte nuestra [guía dedicada](/guides/bare-metal-cloud/dedicated-servers/firewall-linux-iptable).
...
Para más información sobre este espacio de backup, consulte nuestra guía [Backup Storage](/guides/bare-metal-cloud/dedicated-servers/services-backup-storage).

## Más información

[Configurar el firewall de Windows](/guides/bare-metal-cloud/dedicated-servers/activate-port-firewall-soft-win)
