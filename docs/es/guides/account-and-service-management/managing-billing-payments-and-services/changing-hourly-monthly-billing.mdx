...
:::warning
El procedimiento siguiente no funciona para las instancias de tercera generación (por ejemplo, B3-32). Para facturar mensualmente este tipo de instancia, debe crear un [Savings Plan](/guides/public-cloud/cross-functional/savings-plans) para este modelo de instancia.
...
Una vez confirmada su elección, recibirá de inmediato una factura mensual proporcional a la parte restante. La próxima factura incluirá la parte de la tarifa horaria del mes (el 1er del mes hasta el cambio) y la nueva tarifa mensual.
