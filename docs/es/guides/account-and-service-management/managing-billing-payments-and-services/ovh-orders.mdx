...
Al realizar un pedido, puede realizar un seguimiento e interactuar con él desde el <ManagerLink to="/#/billing/orders">área de cliente de OVHcloud</ManagerLink>.
...
En cualquier momento puede consultar la orden de pedido desde la página <ManagerLink to="/#/billing/orders">Mis pedidos</ManagerLink>, tal y como se explica a continuación.
...
Una vez generada la orden de pedido, puede realizar el seguimiento de su pedido desde la página <ManagerLink to="/#/billing/orders">Mis pedidos</ManagerLink>:

* Haga clic en el botón <code className="action">...</code> a la derecha del pedido.
...
:::warning
El derecho de desistimiento solo se aplica a los particulares y solo a los nuevos pedidos. Por lo tanto, no puede hacerlo:
...
Si cumple con los requisitos necesarios para ejercer el derecho de desistimiento, podrá hacerlo directamente desde la página <ManagerLink to="/#/billing/orders">Mis pedidos</ManagerLink>:
