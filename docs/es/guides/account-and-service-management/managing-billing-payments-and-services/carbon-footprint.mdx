...
- **Enlace directo:** <ManagerLink to="/#/account/useraccount/dashboard">Mi cuenta</ManagerLink>
...
1. En el <ManagerLink to="/#/account/useraccount/dashboard">Panel de control de la cuenta</ManagerLink>, en la columna izquierda, desplácese hasta la sección que contiene los **Enlaces útiles** y haga clic en la pestaña <code className="action">Mi huella de carbono</code>.
...
- Se abrirá la interfaz de conexión a su <ManagerLink to="/#/account/useraccount/dashboard">área de cliente de OVHcloud</ManagerLink>.
...
- Una tabla de las emisiones de CO2 por categoría para el mes solicitado.
- Un cuadro de las emisiones de CO2 por categoría entre el comienzo del año natural y el mes solicitado.
- Una tabla que detalla los valores por tipo de producto suscrito.
- Un gráfico que muestra las emisiones de CO2 por categoría.

:::warning
El vínculo generado solo es válido durante 24 horas. Una vez abierto el enlace, asegúrese de descargar el balance de carbono desde su navegador.
