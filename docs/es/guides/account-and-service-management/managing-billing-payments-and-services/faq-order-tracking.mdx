...
<img className="thumbnail" alt="entregado el servicio" src="/images/account-and-service-management/managing-billing-payments-and-services/faq-order-tracking/billing_final_0.gif" loading="lazy" />
