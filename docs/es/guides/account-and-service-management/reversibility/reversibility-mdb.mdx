...
| Integrated monitoring | Performance dashboards integrated into the OVHcloud interface. | N/A | **Inbound**: Metrics Configuration.<br /> **Outbound**: Configuration to recreate in the target environment. | [Analytics - Kafka](/guides/public-cloud/databases/overview) |
