...
| Manual backups | Manual backup generation via external tools (e.g. grr) | JSON, SQLite | **Incoming**: Restoring from a JSON or SQLite file. <br /> **Outgoing**: Manually exporting data for migration outside of an OVHcloud hosting environment. | [Grafana documentation](/guides/public-cloud/databases/overview) |
