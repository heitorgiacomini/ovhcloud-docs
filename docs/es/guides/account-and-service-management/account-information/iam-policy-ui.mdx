...
- **Enlace directo:** <ManagerLink to="/#/iam/policies/myPolicies">IAM Policies</ManagerLink>
...
Abra la página <ManagerLink to="/#/iam/policies/myPolicies">Políticas IAM</ManagerLink>.
