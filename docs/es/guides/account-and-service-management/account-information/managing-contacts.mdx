...
- **Enlace directo:** <ManagerLink to="/#/account/contacts/services">Gestión de contactos</ManagerLink>
...
:::warning
No se recomienda proporcionar a ningún tercero las claves de acceso al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
...
Si su dominio no está asociado a su alojamiento y quiere transferir las operaciones necesarias a su webmaster, concédale también el permiso de "[contacto técnico](#gestion_des_contacts)" en la [zona DNS](/guides/web-cloud/domains/dns-zone-edit) de su nombre de dominio.
