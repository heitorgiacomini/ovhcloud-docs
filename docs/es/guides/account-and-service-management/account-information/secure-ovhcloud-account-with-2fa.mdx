...
description: Cómo mejorar la seguridad de su cuenta de OVHcloud activando la doble autenticación (2FA)
...
- **Enlace directo:** <ManagerLink to="/#/account/useraccount/security">Seguridad</ManagerLink>
...
Para este método, debe disponer de una llave física **U2F** que conecte a un puerto USB de su ordenador cada vez que se conecte a su cuenta de OVHcloud. La autenticación se realiza automáticamente.
  ...
  <Tab label="Códigos de seguridad">
...
En la página <ManagerLink to="/#/account/useraccount/security">Seguridad de la cuenta</ManagerLink>, haga clic en <code className="action">Activar la doble autenticación</code>.

**Haga clic en la ficha correspondiente al método que desee:**

<Tabs>
  <Tab label="SMS">
    Elija el método por SMS y haga clic en <code className="action">Siguiente</code>.
...
La doble autenticación está ahora activada. También es posible añadir otros números.
  ...
  <Tab label="Aplicación móvil">
    Elija el método por aplicación móvil y haga clic en <code className="action">Siguiente</code>.
...
Se genera un código QR, escanearlo a través de su aplicación OTP. Si su aplicación OTP no ofrece esta opción, haga clic en <code className="action">Mostrar el secreto</code> para ver un código que debe introducir en la aplicación OTP.<br/>
...
La doble autenticación está ahora activada.
  ...
  <Tab label="Clave de seguridad">
    Elija el método por llave de seguridad y haga clic en <code className="action">Siguiente</code>.
...
Conéctese al <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> e introduzca su identificador (o dirección de correo electrónico principal) y contraseña.

La pantalla de identificación muestra el último método de doble autenticación utilizado o introducido. Si desea utilizar otro método, haga clic en el botón <code className="action">Probar con otro método</code>.
...
Para eliminar un dispositivo, acceda a la página <ManagerLink to="/#/account/useraccount/security">Seguridad de la cuenta</ManagerLink> y haga clic en los <code className="action">...</code> a la derecha de su dispositivo que quiera eliminar y, por último, en <code className="action">Eliminar</code>.
...
Recibirá el último código de verificación en el dispositivo que quiera eliminar. Introduzca este código en la ventana que se abre y haga clic en <code className="action">Validar</code> para completar la eliminación.
...
Una vez que haya eliminado todos los dispositivos, desactive los códigos de seguridad haciendo clic en el botón <code className="action">Desactivar los códigos 2FA</code>.
...
En primer lugar, acceda a <ManagerLink to="/">la página de autenticación en el área de cliente de OVHcloud</ManagerLink>.

Introduzca su usuario y contraseña de OVHcloud para acceder a la fase de doble autenticación. Haga clic en el botón <code className="action">No tengo acceso a mi móvil, a la llave de seguridad U2F ni a mis códigos de seguridad</code>.<br/>
Si no ve este botón, haga clic en el botón <code className="action">Probar con otro método</code> y luego en <code className="action">No tengo acceso a mi móvil, a la llave de seguridad U2F ni a mis códigos de seguridad</code>.
...
<summary>Lista de justificantes</summary>
