...
description: Cómo establecer, cambiar y gestionar la contraseña de acceso al área de cliente de OVHcloud
...
- En la página <ManagerLink to="/#/account/useraccount/security">Seguridad de la cuenta</ManagerLink>, haga clic en <code className="action">Editar</code> (a la derecha de "Contraseña").
...
- A continuación, aparece un mensaje indicando que la operación se ha realizado satisfactoriamente. Haga clic en el botón <code className="action">Continuar</code> debajo de este mensaje para ser redirigido a la página de identificación. A continuación, introduzca su usuario y su nueva contraseña.

<a name="lost-password"></a>

#### En caso de haber olvidado la contraseña actual

- Haga clic en <code className="action">¿Ha olvidado el identificador o la contraseña?</code> cuando acceda a la ventana de identificación del área de cliente de OVHcloud.
...
- Introduzca su identificador o la dirección de correo electrónico principal asociada a su cuenta de OVHcloud y haga clic en <code className="action">Enviar</code>.
...
- A continuación, aparece un mensaje indicando que la operación se ha realizado satisfactoriamente. Haga clic en el botón <code className="action">Continuar</code> debajo de este mensaje para ser redirigido a la página de identificación. A continuación, introduzca su identificador y su nueva contraseña.
