...
description: ¿Cómo reconocer un correo electrónico de phishing y qué hacer si ha hecho clic en un enlace fraudulento?
...
En primer lugar, verifique si el correo que ha recibido también es visible en la página <ManagerLink to="/#/communication">Mis mensajes</ManagerLink> de su área de cliente de OVHcloud. Allí encontrará copias de los correos oficiales enviados por OVHcloud.
...
<img className="thumbnail" alt="Diferencia entre correo OVHcloud y correo de phishing" src="/images/account-and-service-management/account-information/phishing-care/EN-legit-and-phishing-email.png" loading="lazy" />
...
<summary>**Lista de dominios legítimos de OVHcloud** (haga clic para mostrarla)</summary>
...
<summary>**Consejos para verificar un enlace sospechoso** (haga clic para mostrar)</summary>
...
OVHcloud **nunca** le enviará un enlace por SMS. Los SMS que enviamos suelen estar relacionados con la [autenticación en dos pasos en su área de cliente](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa).
...
<img className="thumbnail" alt="SMS fraudulento" src="/images/account-and-service-management/account-information/phishing-care/sms-phishing.png" loading="lazy" />
...
<summary>**Outlook para Windows**</summary>
...
<img className="thumbnail" alt="Outlook Windows - identificar la versión" src="/images/account-and-service-management/account-information/phishing-care/outlook-windows-identify01.png" loading="lazy" />

**Outlook clásico:**

1. Seleccione el correo de phishing en su bandeja de entrada (no lo abra).
2. Haga clic en <code className="action">Archivo</code> en la barra de menú y luego en <code className="action">Guardar como</code>.
3. En el menú desplegable "Tipo de archivo", seleccione **Formato de mensaje de Outlook - Unicode (.msg)**.
4. Elija una ubicación en su ordenador (por ejemplo el Escritorio) y haga clic en <code className="action">Guardar</code>.
...
2. Seleccione <code className="action">Guardar como</code> y luego elija <code className="action">Guardar como archivo EML</code>.
3. Elija una ubicación en su ordenador y haga clic en <code className="action">Guardar</code>.
...
2. Seleccione <code className="action">Guardar como</code>.
3. El correo se guardará como archivo `.eml`. Elija una ubicación en su ordenador y haga clic en <code className="action">Guardar</code>.
...
2. En la barra de menú, haga clic en <code className="action">Archivo</code> > <code className="action">Guardar como</code>.
3. Elija el formato **Fuente del mensaje sin formato**, seleccione una ubicación en su ordenador y haga clic en <code className="action">Guardar</code>.
...
3. Seleccione <code className="action">Ver</code> > <code className="action">Ver origen del mensaje</code>.
...
1. Seleccione el correo de phishing en su bandeja de entrada.
2. Haga clic en <code className="action">Más</code> (o el icono **⋮**) en la barra de herramientas.
3. Seleccione <code className="action">Descargar (.eml)</code>.
...
1. Seleccione el correo de phishing en su bandeja de entrada.
2. Haga clic en <code className="action">Más</code> en la barra de herramientas.
3. Seleccione <code className="action">Ver original</code>. El contenido sin formato del correo se abrirá en una nueva pestaña del navegador.
...
3. Seleccione <code className="action">Descargar mensaje</code>.
...
<summary>**Si ha introducido su número de tarjeta bancaria en un sitio fraudulento**</summary>
...
<summary>**Si ha introducido su contraseña de OVHcloud en un sitio fraudulento**</summary>


Abra la página <ManagerLink to="/#/account/useraccount/security">Seguridad de la cuenta</ManagerLink> y cambie inmediatamente su contraseña.<br/>

Encontrará en nuestra guía "[Cambiar la contraseña de su cuenta](/guides/account-and-service-management/account-information/manage-ovh-password)" el método para cambiar su contraseña desde su área de cliente, así como nuestras recomendaciones para generar una contraseña eficaz y almacenarla en un gestor de contraseñas.

Le recomendamos encarecidamente que active también la [autenticación en dos pasos](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa) para asegurar de forma duradera su cuenta.
...
[Proteger su cuenta de OVHcloud con la autenticación en dos pasos](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa)
