...
- **Direct link:** <ManagerLink to="/#/iam/policies/myPolicies">IAM Policies</ManagerLink>
...
Add the identities you want to give access to.
...
<img className="thumbnail" alt="Account resourceType" src="/images/account-and-service-management/account-information/iam-control-panel-access/account_ressourceType.png" loading="lazy" />
...
Or add the 4 rights listed above as actions.
