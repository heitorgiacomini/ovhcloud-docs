...
description: Cómo autenticarse en su cuenta de OVHcloud
...
- Haber consultado las [buenas prácticas de seguridad de su cuenta de OVHcloud](/guides/account-and-service-management/account-information/all-about-username).

## Procedimiento

### Conectarse al área de cliente de OVHcloud

Acceda a <ManagerLink to="/">la página de autenticación de OVHcloud</ManagerLink> e introduzca su identificador de cliente (o su dirección de correo electrónico principal) y su contraseña.

<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/ovhcloud-account-login/account-log-in-EN.png" loading="lazy" />

Si ha activado la [doble autenticación](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa), deberá introducir el código único de conexión generado por su periférico (teléfono, tableta o llave U2F).
...
<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/ovhcloud-account-login/customer-id-bill-en.png" loading="lazy" />
...
<img className="thumbnail" alt="identifiant client" src="/images/account-and-service-management/account-information/ovhcloud-account-login/nic-handle.png" loading="lazy" />

### He perdido mi contraseña

Si ha perdido o no recuerda su contraseña, consulte [esta guía, en la que se explican los pasos que deberá seguir para cambiarla](/guides/account-and-service-management/account-information/manage-ovh-password#en-caso-de-haber-olvidado-la-contrasena-actual).
...
Una vez realizada esta operación, deberá [introducir una **nueva** dirección de correo electrónico alternativa](/guides/account-and-service-management/account-information/all-about-username#backup-email) en su cuenta.
...
Debe seguir este [procedimiento](https://www.ovh.es/cgi-bin/es/procedure/procedureChangeEmail.cgi) para que podamos verificar su identidad.
...
Consulte los pasos adecuados en nuestra guía "[Proteger su cuenta de OVHcloud con la doble autenticación](/guides/account-and-service-management/account-information/secure-ovhcloud-account-with-2fa#que-se-debe-hacer-en-caso-de-perdida-o-averia-de-uno-de-los-dispositivos)".
