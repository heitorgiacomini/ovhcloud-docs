...
1. Select the payment method:
    1. At the end of the order, when prompted to choose a payment method, go to the `Voucher` section.
    1. Select the `STARTUP_PROGRAM` voucher by clicking `Apply`.
    1. Add or select a payment method to cover the cost of non-eligible products using the voucher.
1. Proceed to payment: Click `Pay` to finalize the order using your credits.

![Order](/images/guides/account-and-service-management/startup-program/05-pay-bill-with-credits/01-pay-bill.png)
