...
2. From the homepage, click on your name in the top right corner and then click on `My offers and services`.

    ![products and services](/images/guides/account-and-service-management/startup-program/02-sign-agreement/01-products-services.png)

3. In the left-hand menu, click on `My Payment Methods`.

4. On the payment methods page, select the `My Vouchers` tab. Here, you will see the total amount of allocated credits, the expiration date, remaining credits, and the consumption history.

    ![vouchers](/images/guides/account-and-service-management/startup-program/04-view-credits/02-vouchers.png)
