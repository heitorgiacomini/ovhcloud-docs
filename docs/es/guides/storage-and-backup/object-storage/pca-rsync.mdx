...
description: Cómo acceder a los archivos de Public Cloud con Rsync
...
Puede generar su identificador y contraseña OpenStack a través de esta [guía](/guides/public-cloud/cross-functional/create-and-delete-a-user).
