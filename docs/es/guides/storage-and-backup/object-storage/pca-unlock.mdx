...
description: Cómo desbloquear los archivos
...
- Deshielo en python-swiftclient:
    - [Preparar el entorno para utilizar la API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) instalando python-swiftclient.
    - [Cargar las variables de entorno OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables).
...
Haga clic en el menú de la izquierda en <code className="action">Cloud Archive</code>.

Para descongelar un archivo comprimido, haga clic en el botón <code className="action">...</code> a la derecha de este y luego en <code className="action">Descongelar</code> para iniciar el proceso de recuperación.

<img className="thumbnail" alt="desel" src="/images/storage-and-backup/object-storage/pca-unlock/unfreeze.png" loading="lazy" />
...
<img className="thumbnail" alt="plazo antes de desvincular" src="/images/storage-and-backup/object-storage/pca-unlock/unfreeze_result.png" loading="lazy" />

El archivo estará disponible para descarga una vez transcurrido ese plazo. A continuación, podrá realizar la descarga directamente desde el navegador o a través de [un cliente Swift/SFTP/SCP](/guides/storage-and-backup/object-storage/pca-sftp).
