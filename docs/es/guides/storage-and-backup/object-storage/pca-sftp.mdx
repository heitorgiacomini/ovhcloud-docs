...
description: Cómo gestionar y administrar los archivos de Public Cloud de OVH
...
Puede generar su login y password OpenStack siguiendo esta [guía](/guides/public-cloud/cross-functional/create-and-delete-a-user).
...
<img className="thumbnail" alt="conexión" src="/images/storage-and-backup/object-storage/pca-sftp/image2.png" loading="lazy" />
...
<img className="thumbnail" alt="conexión" src="/images/storage-and-backup/object-storage/pca-sftp/image3.png" loading="lazy" />
...
- En la sección <code className="action">Duración</code>, seleccione <code className="action">Desactivar</code>.

<img className="thumbnail" alt="conexión" src="/images/storage-and-backup/object-storage/pca-sftp/conf1.png" loading="lazy" />
...
- En la categoría <code className="action">Transfer</code>, haga clic en <code className="action">Edit...</code>.

<img className="thumbnail" alt="conexión" src="/images/storage-and-backup/object-storage/pca-sftp/conf2.png" loading="lazy" />

- Desmarque <code className="action">Preserve timestamp</code>.

<img className="thumbnail" alt="conexión" src="/images/storage-and-backup/object-storage/pca-sftp/conf3.png" loading="lazy" />

### Obtención de datos
La recuperación de datos está sujeta a la deslocalización previa del objeto. Es necesaria una consulta GET sobre el objeto en cuestión. Si esta operación no se realiza previamente, el cliente SFTP devolverá un mensaje de error al intentar descargar un archivo. Consulte nuestra guía sobre el desbloqueo de sus objetos [aquí](/guides/storage-and-backup/object-storage/pca-unlock).
