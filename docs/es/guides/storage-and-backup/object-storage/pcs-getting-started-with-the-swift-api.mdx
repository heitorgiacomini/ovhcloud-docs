...
description: Empezar con la API Swift
...
La URL se compone de un punto de terminación, disponible a partir de la [interfaz Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security), el nombre del contenedor y el nombre del objeto (incluido el prefijo).
