...
description: Learn how to configure an Object Storage bucket to host a static website
...
Find more information on OVHcloud domain name offers on the [OVHcloud website](https://www.ovhcloud.com/es-es/domains/).
:::


:::warning
- Make sure the region you are hosting your bucket in supports the storage class you choose. You can check the list of supported storage classes by regions [here](/guides/storage-and-backup/object-storage/s3-location).
