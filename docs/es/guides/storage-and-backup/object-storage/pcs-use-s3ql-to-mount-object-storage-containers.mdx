...
- [Crear y eliminar un usuario de OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- [Añadir espacios de almacenamiento](/guides/storage-and-backup/object-storage/pcs-create-container)
...
Puede consultar los datos TENANT_NAME y USERNAME en el archivo OpenRC. La guía «[Acceso y seguridad en Horizon](/guides/public-cloud/cross-functional/compute-horizon-access-security)» explica cómo.
