...
- [Crear un acceso a Horizon](/guides/public-cloud/cross-functional/create-and-delete-a-user#requisitos)
...
- [Cargar las variables de entorno OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#paso-1-obtener-las-variables)
