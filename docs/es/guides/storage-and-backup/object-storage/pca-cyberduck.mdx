...
description: Cómo configurar Cyberduck para gestionar su Public Cloud Archive
...
- Disponer de las claves de usuario (*OS_USERNAME*) y del proyecto (*OS_PROJECT_NAME* o *OS_TENANT_NAME*), que puede obtener descargando el archivo OpenRC en el menú [Users and Roles](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables#paso-1-obtener-las-variables) de su <ManagerLink to="/">área de cliente Public Cloud de OVHcloud</ManagerLink>.
- Disponer de su contraseña de usuario de OpenStack.

Si ya no conoce la contraseña de usuario de OpenStack, puede cambiarla siguiendo [esta guía](/guides/public-cloud/cross-functional/create-and-delete-a-user).
