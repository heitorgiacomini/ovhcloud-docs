...
description: Colocar un contenedor de Object Storage detrás de un nombre de dominio
...
- [Añadir espacios de almacenamiento](/guides/storage-and-backup/object-storage/pcs-create-container) (EN)
