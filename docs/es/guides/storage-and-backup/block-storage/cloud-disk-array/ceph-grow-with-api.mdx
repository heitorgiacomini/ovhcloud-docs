...
description: Learn how to increase the storage capacity of your OVHcloud Cloud Disk Array (CDA) using the OVHcloud API
...
- A [Cloud Disk Array](https://www.ovhcloud.com/es-es/storage-solutions/cloud-disk-array/) solution
...
<summary>**Upgrade Workflow**</summary>
...
<summary>**Step 1. Get you service name (Skip this step if you already know your service name)**</summary>
...
This will return a list of your CDA services. Each service is identified by a UUID, for example 48e5f77f-427b-4261-9799-7861033659fb.
  ...
  <Tab label="Via the OVHcloud Control Panel">
    In your Cloud Disk Array service page, go to the `Details` section and locate the `ID` field. This value is your CDA service name.
...
<summary>**Step 2. Identify Your Plan Code (skip this step if you know which plan you use)**</summary>
