...
description: This guide shows you how to access your cluster using rbd client.
...
- Your client machine’s public or private IP is allowed in the Access Control List (ACL)&#123;&#125; of your Ceph cluster. See our guide "[Cloud Disk Array - IP ACL creation](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-an-ip-acl)".
...
Log in to the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, click <code className="action">Bare Metal Cloud</code>, then <code className="action">Cloud Disk Array</code> and select your service.
...
- "[Cloud Disk Array - User creation](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-create-a-user)"
- "[Change user rights](/guides/storage-and-backup/block-storage/cloud-disk-array/ceph-change-user-rights)"
:::
