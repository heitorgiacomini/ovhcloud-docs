...
:::info
Puede crear un volumen y un snapshot de tipo «manual» gracias a la [API OVHcloud](https://eu.api.ovh.com/) o desde su <ManagerLink to="/">área de cliente OVHcloud</ManagerLink>.
