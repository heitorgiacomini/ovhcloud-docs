...
description: Descubra los principios de funcionamiento de la solución Enterprise File Storage
...
La cuenta OVHcloud es, por defecto, el contacto administrador, técnico y de facturación del servicio. Para más información, consulte nuestra guía [Gestionar los contactos de sus servicios](/guides/account-and-service-management/account-information/managing-contacts).
...
Para más información, consulte la guía [Gestionar los volúmenes](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volumes).
...
Para más información, consulte la guía [Gestionar las ACL de un volumen](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-acl).
...
Para más información, consulte la guía [Gestionar los snapshots de un volumen](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-volume-snapshots).
