...
description: Descubra cómo desplegar la stack de infraestructura NetApp Trident CSI con Enterprise File Storage y Managed Kubernetes Service mediante Terraform.
...
<img className="thumbnail" alt="Arquitectura del módulo Terraform" src="/images/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-terraform/terraform-module-architecture.png" loading="lazy" />
...
Siga la guía [Primeros pasos con las API de OVHcloud](/guides/manage-and-operate/api/first-steps/) para generar su token de API.
...
Tras desplegar la infraestructura con este módulo, configure Trident CSI para utilizar Enterprise File Storage. Siga la guía [Primeros pasos con Trident CSI](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/) para obtener instrucciones detalladas.
...
- [Primeros pasos con Trident CSI](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-trident-csi/)
- [Gestionar Enterprise File Storage con el provider Terraform OVHcloud](/guides/storage-and-backup/file-storage/enterprise-file-storage/netapp-terraform/)
...
Si necesita formación o asistencia técnica para implantar nuestras soluciones, póngase en contacto con su representante de ventas o diríjase a la página [Servicios Profesionales](/links/professional-services) para obtener un presupuesto y solicitar un análisis personalizado de su proyecto a nuestros expertos del equipo de Servicios Profesionales.
