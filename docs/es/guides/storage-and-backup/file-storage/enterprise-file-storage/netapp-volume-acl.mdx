...
description: Cómo gestionar las ACL de un volumen Enterprise File Storage utilizando las API de OVHcloud
...
Todas las rutas API utilizadas en esta guía están disponibles en la sección */storage* : [https://api.ovh.com/console/#/storage](https://api.ovh.com/console/#/storage).
