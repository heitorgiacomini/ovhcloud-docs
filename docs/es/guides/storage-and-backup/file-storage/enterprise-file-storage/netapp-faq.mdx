...
description: FAQ en la solución Entreprise File Storage
...
Sí, puede acceder directamente a este servicio desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, en la sección <code className="action">Bare Metal Cloud</code> y, seguidamente, en la sección <code className="action">Almacenamiento y Backup</code>".
