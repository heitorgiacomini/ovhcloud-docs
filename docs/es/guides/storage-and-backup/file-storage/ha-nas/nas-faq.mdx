...
Sí, puede acceder a este espacio desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>, en la sección <code className="action">Bare Metal Cloud</code> y, seguidamente, en la sección <code className="action">NAS y CDN</code>.
...
Además, en cualquier momento puede crear snapshots manuales, que podrá conservar sin limitación de tiempo o eliminar cuando desee. Esta funcionalidad está disponible en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> o a través de la siguiente llamada a la [API](https://eu.api.ovh.com/):
