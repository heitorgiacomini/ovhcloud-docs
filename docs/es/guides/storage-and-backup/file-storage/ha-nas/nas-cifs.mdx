...
description: Configurar y montar un NAS-HA mediante el protocolo CIFS
...
- Una oferta [NAS-HA](https://www.ovhcloud.com/es-es/storage-solutions/nas-ha/).

## Procedimiento

### Configuración para Microsoft Windows

- **Windows Server 2008**: haga clic en el menú <code className="action">Start</code> > <code className="action">All the programs</code> > <code className="action">Accesories</code> > <code className="action">Command prompt</code>.
- **Windows Server 2012**: haga clic en el icono <code className="action">Windows PowerShell</code> en la barra de tareas.
- **Windows Server 2016/2019/2022/2025**: haga clic en el menú <code className="action">Start</code> y seleccione el icono de <code className="action">Windows PowerShell</code>.
...
[Preguntas frecuentes sobre los NAS](/guides/storage-and-backup/file-storage/ha-nas/nas-faq)
