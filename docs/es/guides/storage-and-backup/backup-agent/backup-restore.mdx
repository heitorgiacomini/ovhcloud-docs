...
- Un servidor Bare Metal en el que Backup Agent esté instalado. Consulta nuestro guía "[Cómo configurar tu primera copia de seguridad](/guides/storage-and-backup/backup-agent/first-configuration)" para más información.
...
Consulta este guía para más información: [Restaurar un servidor Bare Metal con Veeam Backup Agent](/guides/storage-and-backup/backup-and-disaster-recovery-solutions/veeam/agent-bare-metal-recovery).
