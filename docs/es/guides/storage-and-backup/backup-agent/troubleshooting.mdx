...
- Un servidor Bare Metal en el que Backup Agent esté instalado. Consulte nuestro guía "[Cómo configurar su primera copia de seguridad](/guides/storage-and-backup/backup-agent/first-configuration)" para más información.
...
Debe descargar el agente desde su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> e instalarlo en su nuevo sistema operativo.
