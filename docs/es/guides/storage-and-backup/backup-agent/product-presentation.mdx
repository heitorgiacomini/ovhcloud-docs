...
description: Presentación de las funciones y ventajas del producto Backup Agent
...
Descubra cómo navegar en la VSPC a través de [este guía](/guides/storage-and-backup/backup-agent/vspc-presentation).
...
- El almacenamiento se basa en la tecnología [OVHcloud Object Storage](https://www.ovhcloud.com/es-es/public-cloud/object-storage/) que está alojada en los centros de datos de OVHcloud.
