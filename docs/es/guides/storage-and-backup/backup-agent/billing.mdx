...
description: Facturación del producto Backup Agent
...
- El [OVHcloud Object Storage](https://www.ovhcloud.com/es-es/public-cloud/object-storage/).
...
Encontrará el precio del GB por mes en nuestro [sitio web](https://www.ovhcloud.com/es-es/storage-solutions/backup-agent/).

Tiene a su disposición un tableau de bord `Facturación` en su <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> para visualizar su consumo actual y así predecir la factura final al final del mes.
