...
<img className="thumbnail" alt="New connection" src="/images/public-cloud/databases/mongodb-07-connect-compass/new-connection.png" loading="lazy" />

Now you are now interact with your Public Cloud Databases for MongoDB:

<img className="thumbnail" alt="Connected" src="/images/public-cloud/databases/mongodb-07-connect-compass/connected.png" loading="lazy" />
...
```
<img className="thumbnail" alt="Compass Shell" src="/images/public-cloud/databases/mongodb-07-connect-compass/compassShell.png" loading="lazy" />
...
<img className="thumbnail" alt="Compass Aggregation" src="/images/public-cloud/databases/mongodb-07-connect-compass/compassAggregation.png" loading="lazy" />
