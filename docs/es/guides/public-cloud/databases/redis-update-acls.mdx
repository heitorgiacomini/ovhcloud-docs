...
<img className="thumbnail" alt="API path project" src="/images/public-cloud/databases/redis-07-update-acls/redis_07_update_acls_01.png" loading="lazy" />
...
<img className="thumbnail" alt="API path cluster" src="/images/public-cloud/databases/redis-07-update-acls/redis_07_update_acls_02.png" loading="lazy" />
...
<img className="thumbnail" alt="API path user" src="/images/public-cloud/databases/redis-07-update-acls/redis_07_update_acls_03.png" loading="lazy" />
...
<img className="thumbnail" alt="API path user detail" src="/images/public-cloud/databases/redis-07-update-acls/redis_07_update_acls_04.png" loading="lazy" />
...
<img className="thumbnail" alt="API update ACL string arrays" src="/images/public-cloud/databases/redis-07-update-acls/redis_07_update_acls_05.png" loading="lazy" />
...
<img className="thumbnail" alt="API ACL change result" src="/images/public-cloud/databases/redis-07-update-acls/redis_07_update_acls_06.png" loading="lazy" />
