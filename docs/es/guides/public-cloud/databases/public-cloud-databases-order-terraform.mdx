---
title: Public Cloud Databases - Getting started with Terraform (EN)
...
![OVHcloud API rights](/images/guides/public-cloud/databases/databases-09-order-terraform/api-rights.png)
...
![Copy paste service name](/images/guides/public-cloud/databases/databases-09-order-terraform/get-service-name.png)
...
[Managing a MongoDB service from the OVHcloud Control Panel](/guides/public-cloud/databases/mongodb-manage-control-panel)
