---
title: Migrate to OVHcloud Public Cloud Databases for MongoDB
description: Best practices to move from an existing MongoDB instance to an OVHcloud managed MongoDB
...
Contact your sales representative or click on [this link](https://www.ovhcloud.com/es-es/professional-services/) to get a quote and ask our Professional Services.
...
<img className="thumbnail" alt="migration strategy diagram" src="/images/public-cloud/databases/mongodb-19-migrate-to-ovhcloud/diagram_migration_strategy.png" loading="lazy" />
...
- **Create Cluster**: [Set up the new OVHcloud managed MongoDB cluster](/guides/public-cloud/databases/mongodb-getting-started).
