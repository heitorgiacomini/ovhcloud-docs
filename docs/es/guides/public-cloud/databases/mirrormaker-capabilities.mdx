...
This page provides the technical capabilities and limitations of the Public Cloud Analytics for Kafka MirrorMaker offer.
...
The Public Cloud Analytics offer supports the following Kafka versions:

- Kafka MirrorMaker 3.7
- Kafka MirrorMaker 3.8

You can follow Kafka Release Cycle on their official page: [https://kafka.apache.org/downloads](https://kafka.apache.org/downloads)
...
For information on node types and pricing, please refer to the [price page](https://www.ovhcloud.com/es-es/public-cloud/prices/#8763).
...
Logs and metrics are available through the Control Panel, API and can be forwarded to Logs Data Platform. For setup instructions, see the [Analytics - How to setup logs forwarding](/guides/public-cloud/data-analytics/analytics/logs-to-customers).
