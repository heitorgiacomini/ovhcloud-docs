...
description: Unlock the full Potential of LLaMA 2 by fine-tuning it on your own dataset using a single GPU, QLoRA and AI Notebooks
...
You can launch the notebook from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or via the ovhai [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-notebook).
...
*If you do not use our CLI yet, follow [this guide](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) to install it.*
...
- [Analyse sentiments on Tweets](/guides/public-cloud/ai-machine-learning/ai-notebooks-hugging-face-sentiment-analysis)

- [Create a Spam classifier](/guides/public-cloud/ai-machine-learning/ai-notebooks-spam-classifier)

- [Discover speech to text powers and use them to generate video subtitles, meeting scripts and summaries](/guides/public-cloud/ai-machine-learning/ai-notebooks-speech-to-text-recognition)
