...
description: Learn how to use Function Calling with OVHcloud AI Endpoints
...
This documentation provides an overview on how to use function calling with the AI models offered on [AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/).
...
Visit our [Catalog](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/catalog/) to find out which models are compatible with Function Calling.
...
:::info
To obtain an API access key for authenticated access, please follow the instructions given in the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/ai-endpoints-getting-started) guide. Otherwise, you will be rate limited.
:::
...
:::info
To obtain an API access token for authenticated access, please follow the instructions given in the [AI Endpoints - Getting Started](/guides/public-cloud/ai-machine-learning/ai-endpoints-getting-started) guide.
:::


<Tabs>
  <Tab label="Anonymous Mode (Rate-Limited)">
    ```bash
    curl -X 'POST' \
  ...
  <Tab label="Authenticated Mode (No Rate Limit)">
...
In this guide, we have explained how to use Function Calling with the [AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/) models.
