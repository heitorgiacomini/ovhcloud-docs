---
title: AI Endpoints - Using Function Calling with LangChain4J
description: Learn how to use Function Calling with Java, LangChain4j and OVHcloud AI Endpoints
...
void main() throws Exception &#123;
    ...
    // Main chatbot configuration, choose on of the available models on the AI Endpoints catalog (https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/catalog/)
...
![A cut red cat generated by Stable Diffusion](/images/public-cloud/ai-machine-learning/endpoints-tuto-14-function-calling-langchain4j/prompt_result.png)
