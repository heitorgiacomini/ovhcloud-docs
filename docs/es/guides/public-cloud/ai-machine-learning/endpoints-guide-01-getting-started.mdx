...
The objective of this guide is to help developers interested in AI quickly and easily get started with [AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/).

It explains how to obtain an access key, access AI models, and interact with AI APIs on the [AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/) platform. By following this guide, you will learn how to integrate AI capabilities into your applications with ease.
...
Getting an API key enables you to use the models available in our [catalog](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/catalog/) and test their integration into your solutions. To obtain an API access key, please follow the steps below:

**1\. Access the AI Endpoints section**

Click <ManagerLink to="/#/pci/projects">this link</ManagerLink> to access your Public Cloud project, then go to the <code className="action">AI & Machine Learning</code> category in the left menu and choose <code className="action">AI Endpoints</code>.
...
Once your API key has been generated, you can navigate to the [Catalog page](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/catalog/) to choose the AI model you want to interact with.
...
To revoke one of your API access keys, click <ManagerLink to="/#/pci/projects">this link</ManagerLink> to access your Public Cloud project, then click on <code className="action">AI Endpoints</code> underneath **AI & Machine Learning** in the left-hand menu, then on the <code className="action">API key</code> management section.
...
For information on pricing and the models lifecycle of the platform, please refer to the [AI Endpoints - Billing and lifecycle](/guides/public-cloud/ai-machine-learning/ai-endpoints-billing) documentation.

For your convenience, you can monitor your estimated consumption and model usage in the <code className="action">AI Endpoints</code> section of the `AI & Machine Learning` category in your <ManagerLink to="/#/pci/projects">Public Cloud project</ManagerLink> left-hand vertical menu.
...
- [Create your own Audio Summarizer assistant with AI Endpoints](/guides/public-cloud/ai-machine-learning/ai-endpoints-audio-summarizer)
- [Implement chatbot memory management with LangChain and AI Endpoints](/guides/public-cloud/ai-machine-learning/ai-endpoints-chatbot-memory-langchain)
- [Discover how to create a Retrieval Augmented Generation (RAG) system](/guides/public-cloud/ai-machine-learning/ai-endpoints-rag-chatbot-langchain)
- [Discover more about AI Endpoints features and limitations](/guides/public-cloud/ai-machine-learning/ai-endpoints-capabilities)
