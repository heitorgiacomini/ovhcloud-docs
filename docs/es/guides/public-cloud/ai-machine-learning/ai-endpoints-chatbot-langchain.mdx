...
description: Learn how to build a chatbot in Python using LangChain and OVHcloud AI Endpoints
...
In this tutorial, we’ll use LangChain (Python edition) with OVHcloud **[AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/)** to create a **command-line chatbot**, starting with a simple blocking mode, then enabling **streaming** for real-time feedback.
...
<img className="thumbnail" alt="image" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-05-chatbot-langchain-python/llm-streaming.gif" loading="lazy" />
