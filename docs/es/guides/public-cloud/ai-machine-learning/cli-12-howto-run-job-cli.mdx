...
description: Learn how to run an AI Training job using the CLI
lastUpdated: 2023-05-11
---

## Objective

This guide covers the submission of [**jobs**](/guides/public-cloud/ai-machine-learning/ai-training-jobs) through the **ovhai** CLI.
...
-   a working `ovhai` CLI [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client)
...
You can find out more about these ratios in the [capabilities](/guides/public-cloud/ai-machine-learning/ai-training-capabilities).
...
To learn more about data, volumes and permission check out the [data](/guides/public-cloud/ai-machine-learning/ai-data) page.
...
-   `--label` free labels to help you organize your jobs, labels are also used to scope `app_token`, learn more about `app_token` and how to create them [here](/guides/public-cloud/ai-machine-learning/ai-cli-app-token)
...
-   `--ssh-public-keys` allows you to access your job through SSH, it is particularly useful to [setup a VSCode Remote](/guides/public-cloud/ai-machine-learning/ai-solutions-remote-connect)
...
For more information about the job and its lifecycle refer to the [jobs page](/guides/public-cloud/ai-machine-learning/ai-training-jobs).

## Going further

To know more about the CLI and available commands to interact with your job check out the [overview of `ovhai`](/guides/public-cloud/ai-machine-learning/ai-cli-overview)
