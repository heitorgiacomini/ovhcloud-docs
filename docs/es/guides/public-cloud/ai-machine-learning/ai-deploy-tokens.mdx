...
After saving, the added label will be visible in the **Labels** section of the app details. 
  ...
  <Tab label="Using ovhai CLI">
    To follow this section, make sure you have installed the [ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) on your computer or on an instance.
...
An operator token grants read access along with management access for the matching apps. This allows you to manage the AI Deploy app lifecycle (start/stop/delete) using either the CLI (more info [here](/guides/public-cloud/ai-machine-learning/ai-cli-install-client)) or the [AI API](https://gra.ai.cloud.ovh.net/) by providing this token.
...
Additional information about the use of a token to manage AI Solutions using `ovhai` CLI can be found [here](/guides/public-cloud/ai-machine-learning/ai-cli-app-token).
