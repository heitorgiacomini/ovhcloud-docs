...
description: Learn how to manage your object storage data with the ovhai CLI
...
- a working `ovhai` CLI. See our guide on [how to install ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client).
...
At this time, __S3* compatible and Git data stores are supported__. To know more about S3 compatible Object Storage, please read [this documentation](/guides/public-cloud/ai-machine-learning/ai-s3-compliance).
