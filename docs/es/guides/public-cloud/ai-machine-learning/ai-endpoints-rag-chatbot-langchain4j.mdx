...
description: Learn how to build a RAG (Retrieval Augmented Generation) chatbot using Java, LangChain4j and AI Endpoints
...
Note that the chatbot will use the streaming mode, as explained in the [Memory Chatbot with LangChain4j](/guides/public-cloud/ai-machine-learning/ai-endpoints-memory-chatbot-langchain4j) tutorial.

### Test the chatbot without knowledge base

As you can see below, the LLM gives an answer, but not the expected one.

<img className="thumbnail" alt="chatbot-without-rag" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-12-rag-chatbot-langchain4j/without-rag.png" loading="lazy" />
...
<img className="thumbnail" alt="chatbot-with-rag" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-12-rag-chatbot-langchain4j/with-rag.png" loading="lazy" />
