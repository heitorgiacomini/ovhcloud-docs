...
description: Learn how Voxist solution and billing work
...
:::info
To know how to use the **WebSocket API**, please follow this [guide](/guides/public-cloud/ai-machine-learning/ai-ecosystem-voxist-models).
...
To launch an AI Deploy app, there are several possibilities. You can do it from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink> or the CLI `ovhai`.
...
:::info
To know how to launch an app from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, refer to this [guide](/guides/public-cloud/ai-machine-learning/ai-deploy-getting-started).
...
You can also start this app with the `ovhai` [CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) by running the following command:
...
:::info
Replace `<label=name>` by the variables corresponding to your **token**. To know more about the management of the token, refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-tokens).
...
:::info
For more detailed information on Voxist models, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-ecosystem-voxist-models).
...
- transcription configuration - *set up your required configuration, for more information about the features, follow this [documentation](/guides/public-cloud/ai-machine-learning/ai-ecosystem-voxist-models)*
...
The pricing of Voxist differs slightly from the usual AI Deploy offer. In order for you to better understand your invoice, please find more details below about the [price calculation](https://www.ovhcloud.com/es-es/public-cloud/prices/).
...
To learn more about the basic cost of an app launched with AI Deploy, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-billing).
...
:::info
To learn more about the basic cost (resource price) of an app launched with AI Deploy, please refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-deploy-billing).

Please refer to the [OVHcloud Public Cloud website](https://www.ovhcloud.com/es-es/public-cloud/prices/) for all information about resources and partners models prices.
