...
description: Compare 2 models by running 2 jobs in parallel. See which one performs best on your data!
...
If you want to upload it from the <ManagerLink to="/">OVHcloud Control Panel</ManagerLink>, go to the Object Storage section and [create a new object container](/guides/storage-and-backup/object-storage/pcs-create-container) by clicking `Object Storage` > `Create an object container`.
...
:::info
Here we will use the [ovhai CLI](/guides/public-cloud/ai-machine-learning/ai-cli-run-job). If you wish to do this from the OVHcloud Control Panel, refer to this [documentation](/guides/public-cloud/ai-machine-learning/ai-training-submit-job).
...
:::info
To find out more about how jobs work and their status, check this [documentation](/guides/public-cloud/ai-machine-learning/ai-training-jobs).
...
- To build an app to classify audios, refer to this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-sounds-classification).
- Do you want to know how to build and use custom Docker image with AI Training? [Here it is](/guides/public-cloud/ai-machine-learning/ai-training-build-use-custom-image).
