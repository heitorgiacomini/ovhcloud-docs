...
description: How to build and use a custom Docker image containing a Gradio application
...
<img className="thumbnail" alt="Overview" src="/images/public-cloud/ai-machine-learning/deploy-tuto-05-gradio-sketch-recognition/overview-gradio-app.png" loading="lazy" />
...
:::info
Here you will use your trained model, then save it in an Object Storage container. Click [here](/guides/public-cloud/ai-machine-learning/ai-cli-data) to learn more about Object Storage.
:::
...
- You can imagine deploying an AI model with an other tool: **Flask**. Refer to this [tutorial](/guides/public-cloud/ai-machine-learning/ai-deploy-flask-hugging-face-sentiment-analysis).
- Do you want to use **Streamlit** to create a audio classification app? [Here it is](/guides/public-cloud/ai-machine-learning/ai-deploy-streamlit-sounds-classification).
