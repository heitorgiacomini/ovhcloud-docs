...
description: How to build a Java-based chatbot that streams responses from AI Endpoints for a real-time chat experience
...
After exploring how to use [AI Endpoints with LangChain4j](/guides/public-cloud/ai-machine-learning/ai-endpoints-chatbot-langchain4j-quarkus), it's time to level up and build a chatbot that supports **real-time streaming responses**.

In this tutorial, you'll learn how to use **[LangChain4j](https://github.com/langchain4j/langchain4j)** with **[Quarkus](https://github.com/quarkusio/quarkus)** to create a chatbot that streams LLM-generated responses using **[AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/)**.
...
- **[AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/)**: A serverless platform by OVHcloud providing easy access to a variety of world-renowned AI models including Mistral, LLaMA, and more. This platform is designed to be simple, secure, and intuitive, with data privacy as a top priority.
...
<img className="thumbnail" alt="image" src="/images/public-cloud/ai-machine-learning/endpoints-tuto-08-streaming-chatbot-langchain4j-quarkus/llm-streaming.gif" loading="lazy" />

You’ll see the response streamed directly from the AI model, token by token! 🧠⚡

## Conclusion

In just a few steps, you have created your own **streaming AI chatbot** powered by [LangChain4j](https://github.com/langchain4j/langchain4j), [Quarkus](https://github.com/quarkusio/quarkus), and [OVHcloud AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/).
