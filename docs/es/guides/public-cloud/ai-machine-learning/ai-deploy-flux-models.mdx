...
description: How to deploy the FLUX image generation models using ComfyUI
...
- A [user for AI Training & Object Storage](/guides/public-cloud/ai-machine-learning/ai-users)
- [The OVHcloud AI CLI](/guides/public-cloud/ai-machine-learning/ai-cli-install-client) installed on your computer
- [Docker](https://www.docker.com/get-started) installed on your computer, **or** access to a Debian Docker Instance, which is available on the <ManagerLink to="/">Public Cloud</ManagerLink>
...
:::warning
The shared registry should only be used for testing purpose. Please consider attaching your own registry. More information about this can be found [here](/guides/public-cloud/ai-machine-learning/ai-manage-registries). The images pushed to this registry are for AI Tools workloads only, and will not be accessible for external uses.
...
You can now customize the text prompt or parameters as desired. Then, just click the <code className="action">Run</code> button to start the image generation or editing process.

Once the image is generated, you can view and download it directly from the ComfyUI output node.

<video className="thumbnail" autoPlay loop muted playsInline aria-label="FLUX model running on AI Deploy" src="/images/public-cloud/ai-machine-learning/deploy-tuto-19-flux/flux-ai-deploy-demo.mp4" />

## Go further

If you want to deploy a different interface such as [AUTOMATIC1111](https://github.com/AUTOMATIC1111/stable-diffusion-webui) with Stable Diffusion XL, we have a [step-by-step guide](/guides/public-cloud/ai-machine-learning/ai-deploy-stable-diffusion-webui) to deploy this popular Web UI on AI Deploy.
