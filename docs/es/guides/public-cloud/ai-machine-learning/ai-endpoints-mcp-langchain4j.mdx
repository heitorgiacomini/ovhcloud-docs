...
description: Learn how to use Model Context Protocol (MCP) with Java, LangChain4j and OVHcloud AI Endpoints
...
OVHcloud **[AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/)** allows developers to easily add AI features to their day to day developments.
...
Combined with OVHcloud **[AI Endpoints](https://www.ovhcloud.com/es-es/public-cloud/ai-endpoints/)** which offers both LLM and embedding models, it becomes easy to create advanced, production-ready assistants.
...
:::info
ℹ️ The code used to call the <ApiLink>OVHcloud API</ApiLink> is in the [GitHub repository](https://github.com/ovh/public-cloud-examples/tree/main/ai/ai-endpoints/mcp-quarkus-langchain4j) and will not be detailed here.
:::
