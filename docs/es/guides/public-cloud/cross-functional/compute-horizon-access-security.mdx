...
- [Conectarse a Horizon](/guides/public-cloud/cross-functional/introducing-horizon)
...
<img className="thumbnail" alt="horizon - acceso a la API" src="/images/public-cloud/cross-functional/access-and-security-in-horizon/api_access.png" loading="lazy" />
...
<img className="thumbnail" alt="horizon - grupos de seguridad" src="/images/public-cloud/cross-functional/access-and-security-in-horizon/security_groups.png" loading="lazy" />
