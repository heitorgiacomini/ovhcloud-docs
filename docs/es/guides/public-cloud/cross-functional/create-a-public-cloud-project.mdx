...
<img className="thumbnail" alt="crear proyecto" src="/images/public-cloud/cross-functional/create-a-public-cloud-project/firstproject2024.png" loading="lazy" style={{ maxWidth: '400px' }} />
...
<img className="thumbnail" alt="crear proyecto" src="/images/public-cloud/cross-functional/create-a-public-cloud-project/project-creation.png" loading="lazy" style={{ maxWidth: '400px' }} />
...
<img className="thumbnail" alt="Nuevo proyecto creado" src="/images/public-cloud/cross-functional/create-a-public-cloud-project/pci-interface-2025.png" loading="lazy" style={{ maxWidth: '400px' }} />

Ya puede acceder a todo el ecosistema Public Cloud de OVHcloud y consultar nuestra guía "[Conocer la interfaz de Public Cloud](/guides/public-cloud/cross-functional/public-cloud-interface-walk-me)" para conocer esta nueva interfaz en el área de cliente.
...
<img className="thumbnail" alt="activar proyecto" src="/images/public-cloud/cross-functional/create-a-public-cloud-project/activate-project.png" loading="lazy" style={{ maxWidth: '400px' }} />
:::
