...
description: Descubra las nociones básicas útiles para empezar en el entorno Public Cloud
...
- [Abrir una cuenta de OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation)
- [Cree su primer proyecto de Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- [Conocer la interfaz de Public Cloud](/guides/public-cloud/cross-functional/public-cloud-interface-walk-me)
- [Crear la primera instancia](/guides/public-cloud/compute/getting-started)
- [Gestionar los límites](/guides/public-cloud/cross-functional/increasing-public-cloud-quota)
...
Para empezar, necesitará una [cuenta de cliente de OVHcloud](/guides/account-and-service-management/account-information/ovhcloud-account-creation).

A continuación, deberá [crear un proyecto de Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project). Un proyecto es un entorno que va a dedicar a un contexto.
...
Al haber registrado su forma de pago, esta se utilizará para cargar el importe calculado para su [facturación a fin de mes](/guides/public-cloud/cross-functional/analyze-billing). Este cálculo se realiza en función del tiempo de uso de cada recurso, en función del precio de los recursos.
...
<br/>Estas cuotas se asignan por localización (región en el sentido de OpenStack). Así pues, puede que consiga el máximo de recursos posible en su proyecto y que sea necesario [aumentar los límites](/guides/public-cloud/cross-functional/increasing-public-cloud-quota).
...
- Si quiere utilizar las API de OpenStack o Amazon S3, o la interfaz Horizon, deberá [crear usuarios](/guides/public-cloud/cross-functional/create-and-delete-a-user) para ello. Los usuarios pueden tener derechos limitados para proteger los perímetros de acción.
- Si no necesita acceder a las API o a Horizon, puede [asociar otra cuenta de cliente de OVHcloud](/guides/public-cloud/cross-functional/delegate-projects) a su proyecto.
...
|---|---|
|[FAQ](/guides/public-cloud/cross-functional/faq-pci)|Preguntas más frecuentes sobre Public Cloud.|
|[Valor](/guides/public-cloud/cross-functional/introduction-about-instances)|Conceptos y definiciones que necesitará para avanzar.|
|[Disponibilidad de los servicios por localización](https://www.ovhcloud.com/es-es/public-cloud/regions-availability/)|Las tablas de disponibilidad de los servicios a través de las diferentes localizaciones.|
...
|[Uso de la interfaz Horizon](/guides/public-cloud/cross-functional/introducing-horizon)|Horizon es la interfaz clásica de OpenStack, y esta guía explicará cómo acceder a ella.|
|[Instalación de la CLI OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)|OpenStack también puede utilizarse en línea de comandos. Así es como instalar las herramientas.|
...
|Documentación|Detalles|
|---|---|
|[OpenStack CLI](https://docs.openstack.org/python-openstackclient/stein/#using-openstackclient) (EN)|Documentación completa del cliente imprescindible en línea de comandos "openstack". Para consultar la versión Stein, consulte la [tabla de disponibilidad](https://www.ovhcloud.com/es-es/public-cloud/regions-availability/).|
|[APIs OpenStack](https://docs.openstack.org/stein/api/) (EN)|Documentación completa de las API de OpenStack. Para consultar la versión Stein, consulte la [tabla de disponibilidad](https://www.ovhcloud.com/es-es/public-cloud/regions-availability/).|
