...
- Haber creado un usuario de OpenStack. Consulte [la guía dedicada a este tema](/guides/public-cloud/cross-functional/create-and-delete-a-user).
- Haber preparado el entorno para utilizar OpenStack. Para ello, consulte la siguiente guía: [«Preparar el entorno para utilizar la API de OpenStack»](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment).
...
Como indicamos en [esta guía](/guides/public-cloud/cross-functional/create-and-delete-a-user), la contraseña solo se ve una vez, en el momento de su creación.
