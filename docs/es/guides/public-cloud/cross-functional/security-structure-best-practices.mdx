...
<img className="thumbnail" alt="Add user groups" src="/images/public-cloud/cross-functional/securing-and-structuring-projects/Add_user_groups.png" loading="lazy" />
...
<img className="thumbnail" alt="Add Product types & resources" src="/images/public-cloud/cross-functional/securing-and-structuring-projects/Product_types_resources.png" loading="lazy" />
