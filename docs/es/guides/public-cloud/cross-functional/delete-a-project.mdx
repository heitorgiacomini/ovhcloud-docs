...
Si ya no necesita un [proyecto de Public Cloud](https://www.ovhcloud.com/es-es/public-cloud/), puede eliminarlo directamente desde el área de cliente de <ManagerLink to="/">OVHcloud</ManagerLink>.
...
<img className="thumbnail" alt="eliminar el proyecto" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject1.png" loading="lazy" />
...
<img className="thumbnail" alt="eliminar el proyecto" src="/images/public-cloud/cross-functional/delete-a-project/deleteproject2.png" loading="lazy" />
