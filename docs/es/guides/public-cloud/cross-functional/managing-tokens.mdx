...
description: Cómo utilizar los token a través de la API Keystone
...
Para conectarse a Horizon y descargar el archivo, consulte [esta guía](/guides/public-cloud/cross-functional/introducing-horizon).
