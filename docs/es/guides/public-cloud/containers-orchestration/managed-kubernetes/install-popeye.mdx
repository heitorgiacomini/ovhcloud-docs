...
description: Find out how to sanitize your OVHcloud Managed Kubernetes with Popeye and export the generated report on an OVHcloud Object Storage container
...
Moreover, follow the [deploying a Hello World application](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploy-application) documentation in order to have an example application running on your cluster.
...
![Popeye Report](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/popeye-report.png)
...
Copy the original `hello.yml` file (that you can find in the [deploying a Hello World application](/guides/public-cloud/containers-orchestration/managed-kubernetes/deploy-application) guide) into a new one:
...
First, you need to have an Object Storage container, if you don't already had one, you can follow the [Creating an Object Storage container](/guides/storage-and-backup/object-storage/pcs-create-container) guide.

For this guide, our Object Storage container is named `popeye` and its region is `GRA`.

![OVHcloud Object Storage container name](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/set-container-name.png)
...
From your Public Cloud project, click on <code className="action">Users & Roles</code> in the left-hand menu, then click on <code className="action">+ Add user</code>.

<img className="thumbnail" alt="Create OpenStack user" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user1.png" loading="lazy" />

Enter a description for the user you want to create, for example `Popeye` and click on <code className="action">Next</code>.

<img className="thumbnail" alt="Create OpenStack user" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user2.png" loading="lazy" />

Check the `ObjectStore operator` role and click on <code className="action">Confirm</code>.

<img className="thumbnail" alt="Create OpenStack user" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user3.png" loading="lazy" />

Your user is being created.
Username and password will be automatically generated and displayed in your Control Panel.

<img className="thumbnail" alt="Create OpenStack user" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/create_openstack_user4.png" loading="lazy" />
...
Click on <code className="action">Download OpenStack's RC file</code> to retrieve the OpenStack RC file.

<img className="thumbnail" alt="Download OpenStack RC file" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/download-openrc1.png" loading="lazy" />

Then select the region of your Object Storage container (`GRA` for this guide) and click on the <code className="action">Download</code> button.

<img className="thumbnail" alt="Download OpenStack RC file" src="/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/download-openrc2.png" loading="lazy" />
...
![Popeye report stored on OVHcloud Object Storage](/images/public-cloud/containers-orchestration/managed-kubernetes/installing-popeye/report-saved-on-object-storage.png)
