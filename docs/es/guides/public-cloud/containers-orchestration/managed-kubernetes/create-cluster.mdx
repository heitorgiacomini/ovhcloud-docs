...
description: Find out how to create a Kubernetes cluster managed by OVHcloud using the OVHcloud Control Panel, Terraform, Pulumi or CDK
...
<img className="thumbnail" alt="CDKTF" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cdktf_schema.png" loading="lazy" />
...
:::tip
Take advantage of reduced prices by committing to a period of 1 to 36 months on your Public Cloud resources. More information on our [Savings Plans](https://www.ovhcloud.com/es-es/public-cloud/savings-plan/) page.
...
<summary>Via OVHcloud Control Panel</summary>
...
Alternatively, you can enable the <code className="action">Autoscaling</code> feature for the cluster. Define the minimum and maximum pool size in that case.
...
Finally, click the <code className="action">Send</code> button.
...
<img className="thumbnail" alt="Terraform" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/ovh-loves-terraform.png" loading="lazy" />
...
<img className="thumbnail" alt="Kubernetes cluster and node pool" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cluster-and-node-pool.png" loading="lazy" />
...
In order to retrieve this necessary information, please follow [First steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) tutorial.
...
<img className="thumbnail" alt="OVHcloud API rights" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/api-rights.png" loading="lazy" />
...
In the Public Cloud section, you can retrieve your service name ID thanks to the <code className="action">Copy to clipboard</code> button.
...
Now, click on <code className="action">Managed Kubernetes Service</code> in the left-hand menu.
As you can see, your cluster has been successfuly created:

<img className="thumbnail" alt="Cluster created" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cluster-created.png" loading="lazy" />

Now, click on `my_kube_cluster`, then on the `Node pools` tab:

<img className="thumbnail" alt="Node pool created" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/my-pool-node-pool-created.png" loading="lazy" />
...
<summary>Via CDK for Terraform</summary>
...
To retrieve the necessary information, please follow the tutorial [First steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps).
...
In the Public Cloud section, you can retrieve your Public Cloud project ID thanks to the <code className="action">Copy to clipboard</code> button.
...
Click on <code className="action">Managed Kubernetes Service</code> in the left-hand menu.
As you can see, your cluster has been successfuly created:

<img className="thumbnail" alt="Cluster created" src="/images/public-cloud/containers-orchestration/managed-kubernetes/creating-a-cluster/cluster-created.png" loading="lazy" />

Click on `my_desired_cluster`, then on the <code className="action">Node pools</code> tab:
...
In order to retrieve this necessary information, please follow our [first steps with the OVHcloud APIs](/guides/manage-and-operate/api/first-steps) guide.
...
[Increasing Public Cloud quotas](/guides/public-cloud/cross-functional/increasing-public-cloud-quota).
