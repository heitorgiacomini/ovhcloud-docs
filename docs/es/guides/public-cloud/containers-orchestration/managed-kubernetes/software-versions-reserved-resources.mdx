...
If you run a Managed Kubernetes Service using an older version we strongly encourage you to use the [version upgrade feature](/guides/public-cloud/containers-orchestration/managed-kubernetes/upgrading-version) to receive official support for your cluster.

You will find more details about our [End-of-Sale, End-of-Service and End-of-life-Policy in the dedicated section](/guides/public-cloud/containers-orchestration/managed-kubernetes/eos-eol-policies).
