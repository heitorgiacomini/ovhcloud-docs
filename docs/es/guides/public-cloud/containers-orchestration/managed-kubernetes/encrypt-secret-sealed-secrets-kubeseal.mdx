...
description: Find out how to encrypt your Kubernetes Secrets in order to store them in Git with Sealed Secrets (Kubeseal)
...
![Kubernetes Secrets](/images/public-cloud/containers-orchestration/managed-kubernetes/encrypt-secret-with-kubeseal/secrets.jpeg) 
...
![Kubeseal SealedSecret schema](/images/public-cloud/containers-orchestration/managed-kubernetes/encrypt-secret-with-kubeseal/kubeseal-schema.png)
