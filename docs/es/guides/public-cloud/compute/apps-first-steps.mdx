...
description: Cómo desplegar aplicaciones preinstaladas en las instancias de Public Cloud
...
- Una [instancia de Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) en su cuenta de OVHcloud.
...
Utilice el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink> / API o la API de OpenStack Horizon para instalar la aplicación que haya elegido en su instancia de Public Cloud.
...
1. Conéctese a la [consola API](https://eu.api.ovh.com/).
...
Si su dominio está registrado en OVHcloud, puede seguir [esta guía](/guides/web-cloud/domains/dns-zone-edit).
...
<summary>¿Por qué establecer la contraseña root?</summary>
...
<summary>¿Dónde está mi licencia para cPanel?</summary>
...
<summary>¿Dónde está mi licencia Plesk?</summary>
