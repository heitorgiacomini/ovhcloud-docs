...
description: Cómo instalar Plesk en una instancia de Public Cloud
...
- [Crear una instancia desde el área de cliente de OVHcloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project).
- [Tener acceso de administrador](/guides/public-cloud/compute/getting-started#connect-instance).
