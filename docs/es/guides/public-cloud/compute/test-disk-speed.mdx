...
description: Comprobar la velocidad de los discos
...
- Tener una [instancia Public Cloud](https://www.ovhcloud.com/es-es/public-cloud/compute/) en su cuenta de OVHcloud.
...
Para probar la velocidad de un disco adicional, debe montarlo. Para más información, consulte esta [guía](/guides/public-cloud/compute/create-and-configure-an-additional-disk-on-an-instance#en-windows)
