...
description: Cómo compartir imágenes entre proyectos de Public Cloud utilizando OpenStack
lastUpdated: 2025-04-01
---

## Objetivo

En ocasiones, es posible que necesite compartir una imagen de [backup de instancia](/guides/public-cloud/compute/save-an-instance) o una imagen de [backup por volumen](/guides/public-cloud/compute/volume-backup) entre varios proyectos de Public Cloud.
...
- Las imágenes solo se pueden compartir dentro de la misma región. Por ejemplo, una imagen creada en el Proyecto A en la región GRA11 sólo estará disponible para el Proyecto B dentro de la misma región GRA11.
