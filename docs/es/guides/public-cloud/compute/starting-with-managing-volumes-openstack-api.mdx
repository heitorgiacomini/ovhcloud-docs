...
- [Preparar el entorno para utilizar la API OpenStack](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment) instalando python-cinderclient y python-novaclient
...
:::info
También puede consultar la documentación del cliente de OpenStack directamente en [el sitio web de OpenStack](https://docs.openstack.org/python-openstackclient/latest/).
:::
