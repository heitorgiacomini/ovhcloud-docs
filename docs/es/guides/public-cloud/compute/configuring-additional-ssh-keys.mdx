...
description: Cómo configurar llaves SSH adicionales para las cuentas de usuario y añadirlas a su instancia Public Cloud
...
Esta guía explica las tareas más habituales. No obstante, le recomendamos que contacte con un [proveedor de servicios especializado](https://partner.ovhcloud.com/es-es/directory/) o con [nuestra comunidad](https://community.ovhcloud.com/community/en) si tiene algún problema.
:::
...
- [Acceso administrativo a su instancia por SSH](/guides/public-cloud/compute/creating-ssh-keys#login-linux)
...
Si es necesario, utilice nuestra [guía de claves SSH](/guides/public-cloud/compute/creating-ssh-keys) para crear un nuevo par de claves SSH.  
También encontrará información sobre [la gestión de varias claves](/guides/public-cloud/compute/creating-ssh-keys#multiplekeys) en su estación de trabajo local si su instalación lo requiere.

### Paso 2: configurar una nueva cuenta de usuario

[Conéctese a su instancia](/guides/public-cloud/compute/getting-started#connect-instance) y utilice los siguientes comandos para crear una nueva cuenta de usuario y una carpeta `.ssh`:
...
Para más información sobre los permisos de los usuarios y temas relacionados, consulte nuestra [guía de cuentas de usuario](/guides/bare-metal-cloud/dedicated-servers/changing-root-password-linux-ds).
...
Consulte la [guía sobre las claves SSH](/guides/public-cloud/compute/creating-ssh-keys) para saber más sobre el uso de las claves SSH con las instancias Public Cloud.

## Más información

[Cómo crear instancias de Public Cloud](/guides/public-cloud/compute/getting-started)
