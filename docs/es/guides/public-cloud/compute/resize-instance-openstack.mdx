...
description: Descubra cómo adaptar sus recursos para hacer frente a una mayor actividad
...
- Un [usuario de OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)
- Disponga de un [entorno OpenStack preparado para CLI](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
- Haber definido las [variables de entorno OpenStack](/guides/public-cloud/cross-functional/compute-set-openstack-environment-variables)
...
[Redimensionar una instancia de Public Cloud desde el área de cliente de OVHcloud](/guides/public-cloud/compute/resize-instance-manager)
