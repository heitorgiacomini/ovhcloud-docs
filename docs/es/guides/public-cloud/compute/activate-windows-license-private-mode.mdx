...
description: Cómo activar una licencia Windows en una instancia en modo privado
...
- [Haber creado un usuario de OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user)

Le recomendamos que consulte la guía "[Acceder a Horizon](/guides/public-cloud/cross-functional/introducing-horizon)" para familiarizarse con Horizon.
...
Conéctese a la interfaz [Horizon](https://horizon.cloud.ovh.net/auth/login/) utilizando el método que se indica en la [primera parte de esta guía](/guides/public-cloud/network-services/vrack#interfaz-horizon).
...
Acceda a <code className="action">Compute</code> y seleccione <code className="action">Instances</code>:

<img className="thumbnail" alt="procesamiento y instancia" src="/images/public-cloud/compute/activate-windows-license-private-mode/horizon2.png" loading="lazy" />

Para añadir una interfaz, en la columna "Actions", haga clic en la flecha que le permitirá acceder a las acciones que pueda realizar en la instancia. Haga clic en <code className="action">Attach Interface</code>:
...
<img className="thumbnail" alt="interfaz select" src="/images/public-cloud/compute/activate-windows-license-private-mode/attachinterfacehorizon.png" loading="lazy" />
...
Una vez que se haya conectado a la instancia Windows, haga clic en el menú <code className="action">Iniciar</code> y seleccione el icono del <code className="action">Windows PowerShell</code>.
...
<img className="thumbnail" alt="activación de llave windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation1.png" loading="lazy" />
...
<img className="thumbnail" alt="activación de llave windows" src="/images/public-cloud/compute/activate-windows-license-private-mode/windowsactivation2.png" loading="lazy" />

## Más información

[Averigua cómo cambiar la clave de activación de Windows Server](/guides/bare-metal-cloud/dedicated-servers/windows-key).
