...
- Haber creado una instancia de Public Cloud desde el [área de cliente de OVHcloud](/guides/public-cloud/compute/getting-started) o a través de la [interfaz de Horizon](/guides/public-cloud/compute/create-instance-in-horizon).
- [Haber creado una llave SSH](/guides/public-cloud/compute/creating-ssh-keys).
...
- Attach Interface: esta opción permite añadir una o más interfaces privadas a su instancia a través de la VLAN. Para más información, consulte [esta parte](/guides/public-cloud/network-services/vrack#anadir-una-interfaz-privada) de la guía correspondiente.
- Detach Interface: esta opción se utiliza para desvincular una interfaz vinculada a una instancia. Para más información, consulte [esta parte](/guides/public-cloud/network-services/vrack#eliminacion-de-una-interfaz-privada) de la guía correspondiente.
...
Para más información, consulte [esta guía](/guides/public-cloud/compute/getting-started#user-mgmt).
