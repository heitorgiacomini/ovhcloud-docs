...
- Attach Interface: esta opción permite añadir una o más interfaces privadas a su instancia a través de la VLAN. Para más información, consulte [esta parte](/guides/public-cloud/network-services/vrack#adding-a-private-interface) de la guía correspondiente.
- Detach Interface: esta opción se utiliza para desvincular una interfaz vinculada a una instancia. Para más información, consulte [esta parte](/guides/public-cloud/network-services/vrack#removing-a-private-interface) de la guía correspondiente.
