...
description: Descubra las funcionalidades, capacidades y límites actuales de las instancias de Local Zones
lastUpdated: 2026-01-16
---

## Objetivo

Las instancias Local Zone son una extensión de las [regiones](https://www.ovhcloud.com/es-es/public-cloud/regions-availability/) que acercan los servicios de OVHcloud a lugares específicos, ofreciendo una latencia reducida y un rendimiento mejorado para las aplicaciones.
