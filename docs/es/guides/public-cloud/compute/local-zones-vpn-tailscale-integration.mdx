...
description: Learn how to integrate Tailscale into your OVHcloud Local Zone instances, providing a VPN-as-a-Service (VPNaaS) solution
...
- [Two Public Cloud instances](/guides/public-cloud/compute/getting-started) deployed in different [OVHcloud Local Zones](https://www.ovhcloud.com/es-es/public-cloud/local-zone-compute/) (we will use Prague and Madrid for this example).
- [SSH access to your OVHcloud Local Zone Public Cloud Instances](/guides/public-cloud/compute/creating-ssh-keys).
...
- Familiarity with SSH and basic terminal commands. For more information on SSH, read our guide on [how to create and use SSH keys for Public Cloud instances](/guides/public-cloud/compute/creating-ssh-keys).

## Instructions

### Step 1 - Create two instances in OVHcloud Local Zones

[Create two instances](/guides/public-cloud/compute/getting-started) in different OVHcloud Local Zones, such as Prague and Madrid.
...
2\. Go to the <code className="action">Devices</code> tab and click <code className="action">Add Device</code>.<br/>
3\. Select `Linux server` as the device type.

<img className="thumbnail" alt="Tailscale - Add device" src="/images/public-cloud/compute/local-zones-vpn-tailscale-integration/tailscale01.png" loading="lazy" />
...
2\. Log in to the Tailscale admin panel to approve the new node by visiting [https://login.tailscale.com/admin](https://login.tailscale.com/admin).

3\. Approve the node using the menu on the right (with the <code className="action">...</code> button).

<img className="thumbnail" alt="Tailscale - node approval" src="/images/public-cloud/compute/local-zones-vpn-tailscale-integration/tailscale03.png" loading="lazy" style={{ maxWidth: '600px' }} />
...
Visit [https://login.tailscale.com/admin](https://login.tailscale.com/admin) and approve the new node.
...
<img className="thumbnail" alt="Tailscale - Manage key expiry" src="/images/public-cloud/compute/local-zones-vpn-tailscale-integration/tailscale04.png" loading="lazy" style={{ maxWidth: '600px' }} />
