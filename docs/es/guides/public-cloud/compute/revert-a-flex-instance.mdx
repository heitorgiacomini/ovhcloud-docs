...
- Tener una [instancia de Public Cloud de OVHcloud](/guides/public-cloud/compute/getting-started#configuration) de tipo *flex*.
- [Crear un acceso a Horizon](/guides/public-cloud/cross-functional/introducing-horizon).
