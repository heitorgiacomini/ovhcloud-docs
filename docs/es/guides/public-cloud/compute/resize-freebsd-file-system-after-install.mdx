...
description: Cómo redimensionar el sistema de archivos de una instancia de Public Cloud o de un VPS con FreeBSD 12
 ...
 * Haber instalado recientemente la instancia/VPS o [haberla redimensionado.](/guides/public-cloud/compute/resize-of-an-instance)
