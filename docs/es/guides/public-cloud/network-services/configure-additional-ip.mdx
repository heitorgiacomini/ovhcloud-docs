...
:::info
Este artículo explica cómo configurar direcciones Additional IPv4 en una interfaz pública. También puede configurar direcciones IPv6 en sus instancias de Public Cloud utilizando [esta guía](/guides/public-cloud/network-services/ipv6-configuration).
...
- [Configurar un bloque IP en un vRack en una instancia Public Cloud (EN)](/guides/public-cloud/network-services/configure-ip-block-vrack-instance).
- [Configurar un bloque IPv6 en un vRack (EN)](/guides/bare-metal-cloud/dedicated-servers/configure-ipv6-in-vrack).
...
<Tabs>
  ...
  <Tab label="Plesk">
    ...
    **Paso 1: acceder a la gestión de IP de Plesk**
    ...
    <img className="thumbnail" alt="acceso a la gestión de las direcciones IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip1.png" loading="lazy" />
...
Haga clic en <code className="action">IP Addresses</code> bajo **Tools & Resources**.
    ...
    **Paso 2: añadir la información IP adicional**
    ...
    <img className="thumbnail" alt="añadir información IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip2-2.png" loading="lazy" />
...
Introduzca su dirección Additional IP como `xxx.xxx.xxx.xxx/32` en el campo "IP address and subnet mask" y haga clic en <code className="action">OK</code>.
    ...
    <img className="thumbnail" alt="añadir información IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip3-3.png" loading="lazy" />
...
**Paso 3: comprobar la configuración IP actual**
    ...
    <img className="thumbnail" alt="configuración IP actual" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/pleskip4-4.png" loading="lazy" />
  </Tab>
...
Para obtener la configuración de IP actual, introduzca `ipconfig` en la consola de comandos.
    ...
    <img className="thumbnail" alt="comprobar la configuración IP principal" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image1-1.png" loading="lazy" />
...
**Paso 2: modificar las propiedades IPv4**
    ...
    <img className="thumbnail" alt="modificar la configuración IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image2.png" loading="lazy" />
...
En la ventana Propiedades IPv4, seleccione <code className="action">Usar la siguiente dirección IP</code>. Introduzca la dirección IP que haya obtenido en el primer paso y haga clic en <code className="action">Avanzado</code>.
    ...
    **Paso 3: añadir la dirección Additional IP en los Parámetros TCP/IP avanzados**
    ...
    <img className="thumbnail" alt="sección de configuración avanzada" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image4-4.png" loading="lazy" />

Confirme haciendo clic en <code className="action">Añadir</code>.
    
    <img className="thumbnail" alt="Configuración del cambio de IP" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image5-5.png" loading="lazy" />
...
**Paso 4: reiniciar la interfaz de red**
    ...
    <img className="thumbnail" alt="desactivación de la red" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image6.png" loading="lazy" />

Para reiniciarla, haga clic derecho sobre ella y seleccione <code className="action">Activar</code>.
    
    <img className="thumbnail" alt="activación de la red" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image7.png" loading="lazy" />
...
**Paso 5: comprobar la nueva configuración de red**
    ...
    <img className="thumbnail" alt="comprobar la configuración de red actual" src="/images/public-cloud/network-services/getting-started-04-configure-additional-ip-to-instance/image8-8.png" loading="lazy" />
  </Tab>
</Tabs>
...
Para probar la conexión, solo tiene que enviar un ping a su dirección Additional IP desde el exterior. Si responde en modo de rescate, probablemente significa que se ha producido un error de configuración. No obstante, si la IP todavía no funciona, informe a nuestro equipo del soporte creando un tíquet de soporte desde el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.

## Más información

[Importar una Additional IP](/guides/public-cloud/network-services/import-additional-ip)

[Migrar una Additional IP](/guides/public-cloud/network-services/migrate-additional-ip)
