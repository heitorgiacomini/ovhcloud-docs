...
description: Cómo proteger su infraestructura de OVHcloud con Stormshield Network Security desplegado en Public Cloud
...
Si tiene problemas para aplicar estas instrucciones, le recomendamos que contacte con un [proveedor especializado](https://partner.ovhcloud.com/es-es/directory/) o hable del problema con nuestra comunidad. Para obtener más información, consulte la sección [Más información](#gofurther) de este tutorial.
...
- Un [proyecto de Public Cloud](/guides/public-cloud/cross-functional/create-a-public-cloud-project) en su cuenta de OVHcloud.
- Un [usuario OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) (opcional).
- Conocimientos básicos de redes.
- Una cuenta Stormshield creada a través del [sitio Stormshield](https://documentation.stormshield.eu/SNS/v4/en/Content/Installation_and_first_time_configuration/Firewall_license_installation.htm).
...
- Un bloque de direcciones [Additional IP](https://www.ovhcloud.com/es-es/network/additional-ip/) (/29) para permitir el failover y la configuración de la alta disponibilidad.
- Una licencia Stormshield Elastic Virtual Appliance BYOL (**B**ring **Y**our **O**wn **L**icence), obtenida de [partners o revendedores terceros](https://www.stormshield.com/partner/partner-finder/), que deberá proporcionar durante la instalación y la configuración.
...
Consulte la guía «[Configurar un bloque de IP en el vRack](/guides/bare-metal-cloud/dedicated-servers/configuring-an-ip-block-in-a-vrack)» para obtener más información.

A continuación se muestra la arquitectura que vamos a implementar.

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/stormshield-ha-vrack.png" loading="lazy" />
...
Acceda a la sección `download` del [sitio oficial de Stormshield](https://documentation.stormshield.eu/SNS/v4/en/Content/PAYG_Deployment_Guide/Downloading_installation_file.htm). Inicie sesión en su cuenta de Stormshield y siga las instrucciones para descargar la imagen de Stormshield OpenStack.
...
En la sección <code className="action">Public Cloud</code>, seleccione su proyecto. En el menú de la izquierda, haga clic en <code className="action">Instances</code> en la pestaña **Compute** y seleccione las dos instancias SNS EVA.
...
Añada una licencia diferente en las dos instancias SNS EVA siguiendo la [documentación oficial](https://documentation.stormshield.eu/SNS/v4/en/Content/Installation_and_first_time_configuration/Firewall_license_installation.htm).

Cree una regla de firewall similar a la siguiente en los dos SNS EVA en la interfaz gráfica web:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ha-filter.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ha-1.png" loading="lazy" />

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ha-2.png" loading="lazy" />

Una vez completada la configuración de la HA en el primer SNS EVA, únase al grupo de firewall en el segundo:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ha-3.png" loading="lazy" />

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ha-4.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ha-5.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    ...
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/configure-management-1.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 3">
    Limite el acceso a la interfaz gráfica a su dirección IP pública y active el SSH:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/configure-management-2.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 4">
    Limite el acceso al SSH a su dirección IP pública:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/configure-management-3.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/stormshield-gateway.png" loading="lazy" />

- Cree un objeto de red para el VLAN200 siguiendo [esta parte de la documentación oficial de Stormshield](https://documentation.stormshield.eu/SNS/v4/en/Content/Stormshield_Network_SSO_Agent_Linux/Configure_Firewall_Objects.htm).

- [Cree una nueva regla de filtrado](https://documentation.stormshield.com/SNS/v4/en/Content/HowTo_-_IPSec_VPN_-_Authentication_by_certificate/Setup-Main-Site-30-Creating-Filtering-policy.htm) similar a esta para permitir que el tráfico procedente del VLAN200 salga:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/gateway-2.png" loading="lazy" />

- [Cree una regla NAT](https://documentation.stormshield.eu/SNS/v4/en/Content/User_Configuration_Manual_SNS_v4/Filtering_and_NAT/NAT_tab.htm) similar a la siguiente:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/gateway-3.png" loading="lazy" />
...
[Importe su clave pública SSH](https://docs.openstack.org/python-openstackclient/pike/cli/command-objects/keypair.html):
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/stormshield-nat-http.png" loading="lazy" />
...
<Tabs>
  ...
  <Tab label="Etapa 2">
    ...
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/nat-1.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 3">
    Cree una regla NAT similar a la siguiente:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/nat-2.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 4">
    Cree una regla de filtrado similar a la siguiente:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/nat-3.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/stormshield-ipsec.png" loading="lazy" />
...
- [Agregue un objeto host](https://documentation.stormshield.eu/SNS/v4/en/Content/Stormshield_Network_SSO_Agent_Linux/Configure_Firewall_Objects.htm) para el SNS EVA remoto y agregue un objeto de red para la red privada remota VLAN201.

- [Cree un túnel de sitio a sitio estándar](https://documentation.stormshield.eu/SNS/v4/en/Content/User_Configuration_Manual_SNS_v4/IPSec_VPN/Encryption_policy-Tunnels_tab-Site_to_Site-Creating.htm).

<Tabs>
  <Tab label="Etapa 1">
    Añada la red privada local y la red privada remota:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ipsec-3.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 2">
    Cree la puerta de enlace remota:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ipsec-4.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 3">
    Seleccione una clave previamente compartida:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ipsec-5.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 4">
    Cree y active el túnel:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ipsec-7.png" loading="lazy" />
  </Tab>
  <Tab label="Etapa 5">
    Añada una regla de filtrado como la siguiente para autorizar el tráfico a través del túnel:
    
    <img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ipsec-8.png" loading="lazy" />
  </Tab>
</Tabs>
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/stormshield-ssl-vpn.png" loading="lazy" />

##### **Configuración del directorio LDAP**

- [Cree un directorio LDAP interno](https://documentation.stormshield.eu/SNS/v4/en/Content/User_Configuration_Manual_SNS_v4/Directory_configuration/Creating_an_internal_LDAP.htm) para administrar los usuarios de VPN.

En un escenario de producción, este LDAP/AD debe ser remoto en lugar de local.

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-1.png" loading="lazy" />

- Cree el directorio de usuarios:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-2.png" loading="lazy" />

- Añada un usuario a nuestro directorio local:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-3.png" loading="lazy" />

- Elija una contraseña para el nuevo usuario:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-4.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-5.png" loading="lazy" />

Red de cliente TCP:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-6.png" loading="lazy" />

##### **Configuración del servidor VPN SSL**

Configure el servidor VPN SSL:

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-7.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-8.png" loading="lazy" />

Autorizar VPN SSL :

<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-9.png" loading="lazy" />
...
<img className="thumbnail" alt="SNS EVA vrack" src="/images/public-cloud/network-services/tutorial-stormshield-network-security-vrack/ssl-vpn-10.png" loading="lazy" />
...
En este ejemplo, utilizamos el cliente OpenVPN, pero también puede utilizar la [versión empaquetada por Stormshield](https://vpn.stormshield.eu/).
