...
description: Cómo activar y gestionar un vRack Public Cloud utilizando OpenStack CLI
lastUpdated: 2025-01-13
---

## Objetivo

El [vRack](https://www.ovhcloud.com/es-es/network/vrack/) OVHcloud es una solución de red privada que permite configurar el direccionamiento entre varios servidores dedicados de OVHcloud. Al mismo tiempo, le permite agregar [instancias de Public Cloud](/guides/public-cloud/compute/first-steps-with-public-cloud-instance) a su red privada para crear una infraestructura de recursos físicos y virtuales.

**Esta guía explica cómo configurar las instancias de Public Cloud con OpenStack CLI**

## Requisitos

- Tener un [proyecto de Public Cloud.](/guides/public-cloud/cross-functional/create-a-public-cloud-project)
- Haber iniciado sesión en el <ManagerLink to="/">área de cliente de OVHcloud</ManagerLink>.
- Haber [creado un usuario de OpenStack](/guides/public-cloud/cross-functional/create-and-delete-a-user) (opcional).
...
:::info
No se aplicará a los proyectos recién creados que se entreguen automáticamente con un vRack. Para ver el vRack una vez creado el proyecto, acceda al menú <code className="action">Network</code> en la pestaña de la izquierda e haga clic en <code className="action">Red privada vRack</code> para ver el vRack(s).
...
En el menú situado a la izquierda de la pantalla, haga clic en el botón <code className="action">Añadir un servicio</code> (icono de cesta de la compra). Utilice el filtro en la parte superior de la página o desplácese hacia abajo para encontrar el servicio <code className="action">vRack</code>.
...
Una vez activado el servicio, puede consultarlo en el área de cliente, en la sección <code className="action">Network</code> > <code className="action">Red privada vRack</code>. Bajo la denominación «pn-xxxxx».

En la lista de servicios compatibles, seleccione el proyecto que quiera añadir al vRack y haga clic en el botón <code className="action">Añadir</code>.

<img className="thumbnail" alt="agregar proyecto" src="/images/public-cloud/network-services/getting-started-09-creating-vrack-with-openstack/addprojectvrack.png" loading="lazy" />

<a name="ovhcloud-api"></a>

#### Desde la APIv6 de OVHcloud

Para activar y gestionar un vRack desde la APIv6 de OVHcloud, haga clic [aquí](/guides/public-cloud/network-services/vrack-apiv6#step-1-activating-and-managing-a-vrack) (EN), para consultar la guía específica sobre este método.
...
Recuerde también lo siguiente, tal y como se indica en la [guía de uso de la API Nova](/guides/public-cloud/compute/starting-with-nova) (EN):
...
[Configuración del vRack Public Cloud desde las APIv6 de OVHcloud](/guides/public-cloud/network-services/vrack-apiv6) (EN).

[Servidores dedicados - Crear varias VLAN en el vRack](/guides/bare-metal-cloud/dedicated-servers/creating-multiple-vlans-in-a-vrack).
