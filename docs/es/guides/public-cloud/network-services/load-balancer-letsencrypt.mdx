...
description: "Discover how to configure a secure Public Cloud Load Balancer with Let's Encrypt"
...
- [Preparing your environment for using the OpenStack API](/guides/public-cloud/cross-functional/compute-prepare-openstack-api-environment)
...
If you are not yet familiar with creating a Load Balancer, please follow our guide on [Getting started with Load Balancer on Public Cloud](/guides/public-cloud/network-services/getting-started-load-balancer) before you continue with this tutorial.

## Instructions

### Creating an instance for Let's Encrypt

You can create an instance in your project in the region where your Load Balancer is located. Read about the details in our [guide](/guides/public-cloud/compute/getting-started) if necessary. The d2-2 instance type will be sufficient for this operation. We recommend that you use Ubuntu as your operating system. 
...
If you are using DNS servers managed by OVHcloud, please consult this [guide](/guides/web-cloud/domains/dns-zone-edit).
