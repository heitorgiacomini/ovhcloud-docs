...
description: Cómo configurar el protocolo IPv6 en una instancia de Public Cloud
...
:::info
Actualmente las opciones Floating IP y Gateway no permiten la IPv6. La IPv6 solo puede utilizarse con las instancias en [modo público](/guides/public-cloud/network-services/concepts#publicmode).
...
En su proyecto Public Cloud, haga clic en <code className="action">Instancias</code> en el menú de la izquierda. Haga clic en el botón <code className="action">...</code> junto a la instancia correspondiente y haga clic en <code className="action">Detalles de la instancia</code>.

<img className="thumbnail" alt="public-cloud ipv6" src="/images/public-cloud/network-services/configuration-02-how-to-configure-ipv6/pci2022.png" loading="lazy" />

Puede consultar la información en la columna <code className="action">Redes</code>.

<img className="thumbnail" alt="public-cloud ipv6" src="/images/public-cloud/network-services/configuration-02-how-to-configure-ipv6/pci2022.1.png" loading="lazy" />
...
<Tabs>
  <Tab label="Debian (excepto Debian 12)">
  ...
  <Tab label="Windows">
    ...
    Acceda a la sección <code className="action">Conexiones de red</code> de su Windows.
    
    <img className="thumbnail" alt="public-cloud ipv6" src="/images/public-cloud/network-services/configuration-02-how-to-configure-ipv6/pcipv63.png" loading="lazy" />

A continuación, haga clic derecho en su tarjeta de red para acceder a <code className="action">Propiedades</code>.
    
    <img className="thumbnail" alt="public-cloud ipv6" src="/images/public-cloud/network-services/configuration-02-how-to-configure-ipv6/pcipv64.png" loading="lazy" />

Haga clic en <code className="action">Internet Protocol Version 6 (TCP/IPv6)</code> y seleccione el botón <code className="action">Propiedades</code>.
    
    <img className="thumbnail" alt="public-cloud ipv6" src="/images/public-cloud/network-services/configuration-02-how-to-configure-ipv6/pcipv65.png" loading="lazy" />

Introduzca la información de su IPv6.
    
    <img className="thumbnail" alt="public-cloud ipv6" src="/images/public-cloud/network-services/configuration-02-how-to-configure-ipv6/pcipv66.png" loading="lazy" />

Una vez que haya finalizado, marque la casilla `Validar los parámetros a la salida` y haga clic en el botón <code className="action">OK</code> para aceptar los cambios.
  </Tab>
</Tabs>
...
En primer lugar, [ponga su instancia en modo de rescate](/guides/public-cloud/compute/put-an-instance-in-rescue-mode).
